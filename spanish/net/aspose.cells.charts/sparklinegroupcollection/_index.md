...
description: Encapsula una colección deSparklineGroup./sparklinegroup objetos.
type: docs
weight: 890
url: /es/net/aspose.cells.charts/sparklinegroupcollection/
---
## SparklineGroupCollection class

Encapsula una colección de[`SparklineGroup`](../sparklinegroup) objetos.
...
| [Item](../../aspose.cells.charts/sparklinegroupcollection/item) { get; } | Obtiene el[`SparklineGroup`](../sparklinegroup) elemento en el índice especificado. |
...
| Nombre | Descripción |
| --- | --- |
| [Add](../../aspose.cells.charts/sparklinegroupcollection/add)(SparklineType, string, bool, CellArea) | Agrega un[`SparklineGroup`](../sparklinegroup) ítem a la colección. |
...
| [ClearSparklineGroups](../../aspose.cells.charts/sparklinegroupcollection/clearsparklinegroups)(CellArea) | Borra los grupos de minigráficos que se superponen a un área de celdas. |
| [ClearSparklines](../../aspose.cells.charts/sparklinegroupcollection/clearsparklines)(CellArea) | Borra los minigráficos que hay dentro de un área de celdas. |
