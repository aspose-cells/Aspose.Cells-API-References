...
description: Encapsula una colección deSparkline./sparkline objetos.
type: docs
weight: 870
url: /es/net/aspose.cells.charts/sparklinecollection/
---
## SparklineCollection class

Encapsula una colección de[`Sparkline`](../sparkline) objetos.
...
| [Item](../../aspose.cells.charts/sparklinecollection/item) { get; } | Obtiene el[`Sparkline`](../sparkline) elemento en el índice especificado. |
...
| Nombre | Descripción |
| --- | --- |
| [Add](../../aspose.cells.charts/sparklinecollection/add)(string, int, int) | Agrega un minigráfico. |
...
| [Remove](../../aspose.cells.charts/sparklinecollection/remove)(object) | Elimina el minigráfico |
