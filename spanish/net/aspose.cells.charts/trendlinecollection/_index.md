...
description: Representa una colección de todos losTrendline./trendline objetos para la serie de datos especificada.
type: docs
weight: 990
url: /es/net/aspose.cells.charts/trendlinecollection/
---
## TrendlineCollection class

Representa una colección de todos los[`Trendline`](../trendline) objetos para la serie de datos especificada.
...
| [Item](../../aspose.cells.charts/trendlinecollection/item) { get; } | Obtiene un objeto por su index. |
...
| Nombre | Descripción |
| --- | --- |
| [Add](../../aspose.cells.charts/trendlinecollection/add#add)(TrendlineType) | Agrega un objeto a esta colección con el tipo especificado. |
| [Add](../../aspose.cells.charts/trendlinecollection/add#add_1)(TrendlineType, string) | Agrega un objeto a esta colección con el tipo y el nombre especificados. |
