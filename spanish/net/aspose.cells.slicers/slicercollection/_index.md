...
description: Especifica la colección de todos los objetos Slicer en la hoja de trabajo especificada.
type: docs
weight: 5690
url: /es/net/aspose.cells.slicers/slicercollection/
---
...
| [Item](../../aspose.cells.slicers/slicercollection/item) { get; } | Obtiene el Slicer por index. (2 indexers) |
...
| Nombre | Descripción |
| --- | --- |
| [Add](../../aspose.cells.slicers/slicercollection/add#add_8)(ListObject, int, string) | Agregue un nuevo Slicer usando ListObjet como fuente de datos |
| [Add](../../aspose.cells.slicers/slicercollection/add#add_7)(ListObject, ListColumn, string) | Agregue un nuevo Slicer usando ListObjet como fuente de datos |
| [Add](../../aspose.cells.slicers/slicercollection/add#add_4)(PivotTable, string, int) | Agregue una nueva segmentación usando la tabla dinámica como fuente de datos |
| [Add](../../aspose.cells.slicers/slicercollection/add#add_3)(PivotTable, string, PivotField) | Agregue una nueva segmentación usando la tabla dinámica como fuente de datos |
| [Add](../../aspose.cells.slicers/slicercollection/add#add_5)(PivotTable, string, string) | Agregue una nueva segmentación usando la tabla dinámica como fuente de datos |
| [Add](../../aspose.cells.slicers/slicercollection/add#add_6)(ListObject, ListColumn, int, int) | Agregue un nuevo Slicer usando ListObjet como fuente de datos |
| [Add](../../aspose.cells.slicers/slicercollection/add#add_1)(PivotTable, int, int, int) | Agregue una nueva segmentación usando la tabla dinámica como fuente de datos |
| [Add](../../aspose.cells.slicers/slicercollection/add#add)(PivotTable, int, int, PivotField) | Agregue una nueva segmentación usando la tabla dinámica como fuente de datos |
| [Add](../../aspose.cells.slicers/slicercollection/add#add_2)(PivotTable, int, int, string) | Agregue una nueva segmentación usando la tabla dinámica como fuente de datos |
...
| [Remove](../../aspose.cells.slicers/slicercollection/remove)(Slicer) | Eliminar el Slicer especificado |
| [RemoveAt](../../aspose.cells.slicers/slicercollection/removeat#removeat)(int) | Elimina el Slicer en el índice especificado (2 methods) |
