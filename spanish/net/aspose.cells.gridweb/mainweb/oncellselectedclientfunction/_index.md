...
description: Obtiene o establece la función del lado del cliente que se llamará cuando se seleccione una celda. La función del cliente debe declararse así función MyOnSelectCellcelda  GridWeb1.setCellValueByCellcelda prueba  Nota puede usar el puntero este en la función del cliente para señalar el control de cuadrícula que activa el evento.
type: docs
weight: 590
url: /es/net/aspose.cells.gridweb/mainweb/oncellselectedclientfunction/
---
