...
type: docs
weight: 2110
url: /es/net/aspose.cells.drawing/gradientstopcollection/
---
...
| [Item](../../aspose.cells.drawing/gradientstopcollection/item) { get; set; } | Obtiene la parada de gradiente por el índice. (2 indexers) |

## Métodos

| Nombre | Descripción |
| --- | --- |
| [Add](../../aspose.cells.drawing/gradientstopcollection/add#add)(double, CellsColor, int) | Agregar una parada de degradado. |
| [Add](../../aspose.cells.drawing/gradientstopcollection/add#add_1)(double, Color, int) | Agregar una parada de degradado. |
