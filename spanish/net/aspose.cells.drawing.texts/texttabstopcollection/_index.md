...
description: Representa la lista de todas las tabulaciones.
type: docs
weight: 3030
url: /es/net/aspose.cells.drawing.texts/texttabstopcollection/
---
...
| Nombre | Descripción |
| --- | --- |
| [TextTabStopCollection](texttabstopcollection)() | Constructor predeterminado |
...
| [Item](../../aspose.cells.drawing.texts/texttabstopcollection/item) { get; } | Obtiene[`TextTabStop`](../texttabstop) por el índice. |
...
| Nombre | Descripción |
| --- | --- |
| [Add](../../aspose.cells.drawing.texts/texttabstopcollection/add)(TextTabAlignmentType, double) | Agrega una tabulación. |
