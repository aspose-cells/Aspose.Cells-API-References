...
type: docs
weight: 5790
url: /es/net/aspose.cells/svgsaveoptions/
---
...
| Nombre | Descripción |
| --- | --- |
| [SvgSaveOptions](svgsaveoptions#constructor)() | Crea las opciones para guardar el archivo svg. |
| [SvgSaveOptions](svgsaveoptions#constructor_1)(SaveFormat) | Crea las opciones para guardar el archivo svg. |
...
| [ImageOrPrintOptions](../../aspose.cells/imagesaveoptions/imageorprintoptions) { get; } | Opciones adicionales de creación de imágenes |
...
| [SheetIndex](../../aspose.cells/svgsaveoptions/sheetindex) { get; set; } | Obtiene y establece qué hoja de cálculo se debe exportar. Si el valor es -1, se exportará la hoja de cálculo activa. |
...
| [StreamProvider](../../aspose.cells/imagesaveoptions/streamprovider) { get; set; } | Obtiene o establece el IStreamProvider para exportar objetos. |
