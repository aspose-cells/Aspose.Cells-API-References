...
description: Representa una colección de todos losName./name objetos en la hoja de cálculo.
type: docs
weight: 4210
url: /es/net/aspose.cells/namecollection/
---
## NameCollection class

Representa una colección de todos los[`Name`](../name) objetos en la hoja de cálculo.
...
| [Item](../../aspose.cells/namecollection/item) { get; } | Obtiene el[`Name`](../name) elemento en el índice especificado. (2 indexers) |
...
| Nombre | Descripción |
| --- | --- |
| [Add](../../aspose.cells/namecollection/add)(string) | Define un nuevo nombre. |
...
| [Clear](../../aspose.cells/namecollection/clear#clear)() | Eliminar todos los nombres definidos a los que no hacen referencia las fórmulas y la fuente de datos. Si se hace referencia al nombre definido, solo establecemos Name.ReferTo como nulo y los ocultamos. (2 methods) |
...
| [Filter](../../aspose.cells/namecollection/filter)(NameScopeType, int) | Obtiene todos los nombres definidos por alcance. |
...
| [Remove](../../aspose.cells/namecollection/remove#remove)(string) | Eliminar el nombre. |
| [Remove](../../aspose.cells/namecollection/remove#remove_1)(string[]) | Elimina una matriz de name |
| [RemoveAt](../../aspose.cells/namecollection/removeat#removeat)(int) | Eliminar el nombre en el índice específico. (2 methods) |
| [RemoveDuplicateNames](../../aspose.cells/namecollection/removeduplicatenames)() | Eliminar los nombres definidos duplicados |
| [Sort](../../aspose.cells/namecollection/sort)() | Ordena los nombres definidos. |
