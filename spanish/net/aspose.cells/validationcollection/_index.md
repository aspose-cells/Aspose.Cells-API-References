...
description: Representa la recopilación de validación de datos.
type: docs
weight: 6220
url: /es/net/aspose.cells/validationcollection/
---
...
| [Item](../../aspose.cells/validationcollection/item) { get; } | Obtiene el[`Validation`](../validation) elemento en el índice especificado. |
...
| Nombre | Descripción |
| --- | --- |
| [Add](../../aspose.cells/validationcollection/add#add_1)(CellArea) | Agrega una validación de datos a la colección. |
...
| [GetValidationInCell](../../aspose.cells/validationcollection/getvalidationincell)(int, int) | Obtiene la validación aplicada a la celda dada. |
...
| [RemoveACell](../../aspose.cells/validationcollection/removeacell)(int, int) | Elimina toda la configuración de validación en la celda. |
| [RemoveArea](../../aspose.cells/validationcollection/removearea)(CellArea) | Elimina toda la configuración de validación en el rango.. |
