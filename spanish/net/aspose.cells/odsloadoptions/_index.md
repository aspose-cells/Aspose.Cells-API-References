...
type: docs
weight: 4330
url: /es/net/aspose.cells/odsloadoptions/
---
...
| Nombre | Descripción |
| --- | --- |
| [OdsLoadOptions](odsloadoptions#constructor)() | Representa las opciones de carga del archivo ods. |
| [OdsLoadOptions](odsloadoptions#constructor_1)(LoadFormat) | Representa las opciones de carga del archivo ods. |

## Propiedades

| Nombre | Descripción |
| --- | --- |
| [ApplyExcelDefaultStyleToHyperlink](../../aspose.cells/odsloadoptions/applyexceldefaultstyletohyperlink) { get; set; } | Indica si se aplica el estilo por defecto del Excel al hipervínculo. |
...
| [RefreshPivotTables](../../aspose.cells/odsloadoptions/refreshpivottables) { get; set; } | Indica si se actualizan las tablas dinámicas al cargar el archivo. |
