...
description: Representa la lista de escenarios.
type: docs
weight: 5580
url: /es/net/aspose.cells/scenariocollection/
---
...
| Nombre | Descripción |
| --- | --- |
| [ActiveIndex](../../aspose.cells/scenariocollection/activeindex) { get; set; } | Obtiene y establece qué escenario se selecciona. |
| [Capacity](../../aspose.cells/collectionbase`1/capacity) { get; set; } |  |
| [Count](../../aspose.cells/collectionbase`1/count) { get; } |  |
| [Item](../../aspose.cells/scenariocollection/item) { get; } | Obtiene el[`Scenario`](../scenario) objeto por el index. |
| [Item](../../aspose.cells/collectionbase`1/item) { get; set; } |  |
| [LastSelected](../../aspose.cells/scenariocollection/lastselected) { get; set; } | Indica qué escenario seleccionó el usuario por última vez para ejecutar/mostrar. |

## Métodos

| Nombre | Descripción |
| --- | --- |
| [Add](../../aspose.cells/scenariocollection/add)(string) | Agrega un escenario. |
