...
description: Representa las opciones de cargar archivos json
type: docs
weight: 3920
url: /es/net/aspose.cells/jsonloadoptions/
---
...
| Nombre | Descripción |
| --- | --- |
| [JsonLoadOptions](jsonloadoptions)() | Crea una opción de cargar el archivo. |
...
| [LayoutOptions](../../aspose.cells/jsonloadoptions/layoutoptions) { get; set; } | Las opciones de importación json. |
...
| [MultipleWorksheets](../../aspose.cells/jsonloadoptions/multipleworksheets) { get; set; } | Indica si se importa cada atributo del objeto JsonObject como una hoja de cálculo cuando todos los nodos secundarios son nodos de matriz. |
...
| [StartCell](../../aspose.cells/jsonloadoptions/startcell) { get; set; } | Obtiene y establece la celda de inicio. |
