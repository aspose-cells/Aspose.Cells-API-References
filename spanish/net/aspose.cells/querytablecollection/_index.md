...
description: Una colección deQueryTableCollection./querytablecollection objetos que representan la información de la colección QueryTable.
type: docs
weight: 4940
url: /es/net/aspose.cells/querytablecollection/
---
## QueryTableCollection class

Una colección de[`QueryTableCollection`](../querytablecollection) objetos que representan la información de la colección QueryTable.
...
| [Item](../../aspose.cells/querytablecollection/item) { get; } | Obtiene la tabla de consulta por el índice específico. |
