...
description: Representa las opciones de guardado para markdown.
type: docs
weight: 4030
url: /es/net/aspose.cells/markdownsaveoptions/
---
...
| Nombre | Descripción |
| --- | --- |
| [MarkdownSaveOptions](markdownsaveoptions)() | Crea opciones para guardar el documento de descuento |
...
| [Encoding](../../aspose.cells/markdownsaveoptions/encoding) { get; set; } | Obtiene y establece la codificación predeterminada. |
| [FormatStrategy](../../aspose.cells/markdownsaveoptions/formatstrategy) { get; set; } | Obtiene y establece la estrategia de formato al exportar el valor de celda como cadena. |
| [LightCellsDataProvider](../../aspose.cells/markdownsaveoptions/lightcellsdataprovider) { get; set; } | El proveedor de datos para proporcionar datos de celdas para guardar el libro de trabajo en modo ligero. |
| [LineSeparator](../../aspose.cells/markdownsaveoptions/lineseparator) { get; set; } | Obtiene y establece el separador de línea. |
