...
description: Representa la lista de celdas de entrada del escenario.
type: docs
weight: 5600
url: /es/net/aspose.cells/scenarioinputcellcollection/
---
...
| [Item](../../aspose.cells/scenarioinputcellcollection/item) { get; } | Obtiene[`ScenarioInputCell`](../scenarioinputcell) por índice en la lista. |
...
| Nombre | Descripción |
| --- | --- |
| [Add](../../aspose.cells/scenarioinputcellcollection/add)(int, int, string) | Agrega una celda de entrada. |
