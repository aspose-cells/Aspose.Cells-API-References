...
description: Encapsula una colección deVerticalPageBreak./verticalpagebreak objetos.
type: docs
weight: 6320
url: /es/net/aspose.cells/verticalpagebreakcollection/
---
## VerticalPageBreakCollection class

Encapsula una colección de[`VerticalPageBreak`](../verticalpagebreak) objetos.
...
| [Item](../../aspose.cells/verticalpagebreakcollection/item) { get; } | Obtiene el[`VerticalPageBreak`](../verticalpagebreak) elemento en el índice especificado. (2 indexers) |
...
| Nombre | Descripción |
| --- | --- |
| [Add](../../aspose.cells/verticalpagebreakcollection/add#add)(int) | Agrega un salto de página vertical a la colección. |
| [Add](../../aspose.cells/verticalpagebreakcollection/add#add_3)(string) | Agrega un salto de página vertical a la colección. |
| [Add](../../aspose.cells/verticalpagebreakcollection/add#add_1)(int, int) | Agrega un salto de página vertical a la colección. |
| [Add](../../aspose.cells/verticalpagebreakcollection/add#add_2)(int, int, int) | Agrega un salto de página vertical a la colección. |
...
| [RemoveAt](../../aspose.cells/verticalpagebreakcollection/removeat#removeat)(int) | Elimina el elemento VPageBreak en un nombre especificado. (2 methods) |
