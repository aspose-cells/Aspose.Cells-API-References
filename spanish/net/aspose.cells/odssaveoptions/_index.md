...
description: Representa las opciones para guardar el archivo ods.
type: docs
weight: 4340
url: /es/net/aspose.cells/odssaveoptions/
---
## OdsSaveOptions class

Representa las opciones para guardar el archivo ods.
...
| Nombre | Descripción |
| --- | --- |
| [OdsSaveOptions](odssaveoptions#constructor)() | Crea las opciones de guardar archivo ods. |
| [OdsSaveOptions](odssaveoptions#constructor_1)(SaveFormat) | Crea las opciones de guardar archivo ods. |
...
| [GeneratorType](../../aspose.cells/odssaveoptions/generatortype) { get; set; } | Obtiene y establece el generador del archivo ods. |
| [IsStrictSchema11](../../aspose.cells/odssaveoptions/isstrictschema11) { get; set; } | Indica si el archivo ods debe guardarse en formato ODF versión 1.1. El valor predeterminado es falso. |
