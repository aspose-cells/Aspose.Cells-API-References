...
description: Representa la lista de relaciones vinculantes entre un complemento de Office y los datos del documento.
type: docs
weight: 6390
url: /es/net/aspose.cells.webextensions/webextensionbindingcollection/
---
...
| Nombre | Descripción |
| --- | --- |
| [WebExtensionBindingCollection](webextensionbindingcollection)() | Constructor predeterminado |
...
| [Item](../../aspose.cells.webextensions/webextensionbindingcollection/item) { get; } | Obtiene la relación de enlace de la extensión web por el índice específico. |
...
| Nombre | Descripción |
| --- | --- |
| [Add](../../aspose.cells.webextensions/webextensionbindingcollection/add)() | Agrega una relación vinculante entre un complemento de Office y los datos del documento. |
