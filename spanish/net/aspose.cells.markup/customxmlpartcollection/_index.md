...
type: docs
weight: 4050
url: /es/net/aspose.cells.markup/customxmlpartcollection/
---
...
| [Item](../../aspose.cells.markup/customxmlpartcollection/item) { get; } | Obtiene un elemento en el índice especificado. |
...
| Nombre | Descripción |
| --- | --- |
| [Add](../../aspose.cells.markup/customxmlpartcollection/add)(byte[], byte[]) | Agrega un elemento a la colección. |
...
| [SelectByID](../../aspose.cells.markup/customxmlpartcollection/selectbyid)(string) | Obtiene un artículo por id. |
