...
description: Representa todas las propiedades de la etiqueta inteligente de celda.
type: docs
weight: 4100
url: /es/net/aspose.cells.markup/smarttagpropertycollection/
---
...
| Nombre | Descripción |
| --- | --- |
| [SmartTagPropertyCollection](smarttagpropertycollection)() | Constructor predeterminado |
...
| [Item](../../aspose.cells.markup/smarttagpropertycollection/item) { get; } | Obtiene un[`SmartTagProperty`](../smarttagproperty) objeto. (2 indexers) |
...
| Nombre | Descripción |
| --- | --- |
| [Add](../../aspose.cells.markup/smarttagpropertycollection/add)(string, string) | Agrega una propiedad de la etiqueta inteligente de la celda. |
