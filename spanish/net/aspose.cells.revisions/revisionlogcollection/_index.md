...
description: Representa todos los registros de revisión.
type: docs
weight: 5450
url: /es/net/aspose.cells.revisions/revisionlogcollection/
---
...
| [DaysPreservingHistory](../../aspose.cells.revisions/revisionlogcollection/dayspreservinghistory) { get; set; } | Obtiene y establece el número de días que la aplicación de hoja de cálculo mantendrá el historial de cambios para este libro. |
| [Item](../../aspose.cells.revisions/revisionlogcollection/item) { get; } | Obtiene[`RevisionLog`](../revisionlog) por index. |
