...
description: Una colección deCustomProperty./customproperty objetos que representan información adicional.
type: docs
weight: 4850
url: /es/net/aspose.cells.properties/custompropertycollection/
---
## CustomPropertyCollection class

Una colección de[`CustomProperty`](../customproperty) objetos que representan información adicional.
...
| [Item](../../aspose.cells.properties/custompropertycollection/item) { get; } | Obtiene la propiedad personalizada por el índice específico. (2 indexers) |
...
| Nombre | Descripción |
| --- | --- |
| [Add](../../aspose.cells.properties/custompropertycollection/add)(string, string) | Agrega información de propiedad personalizada. |
