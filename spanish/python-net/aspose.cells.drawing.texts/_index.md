...
type: docs
weight: 10
url: /es/python-net/aspose.cells.drawing.texts/
is_root: false
---
 El**Aspose.Cells.Drawing.Texts** El espacio de nombres proporciona clases que dibujan y dan formato a objetos de texto como párrafos, viñetas y más.
...
| [FontSettingCollection](/cells/es/python-net/aspose.cells.drawing.texts/fontsettingcollection) |Representa la lista de [FontSetting](/cells/es/python-net/aspose.cells/fontsetting).|
| [NoneBulletValue](/cells/es/python-net/aspose.cells.drawing.texts/nonebulletvalue) | Representa ninguna bala.|
| [PictureBulletValue](/cells/es/python-net/aspose.cells.drawing.texts/picturebulletvalue) | Representa el valor de la viñeta de la imagen.|
...
| [TextVerticalType](/cells/es/python-net/aspose.cells.drawing.texts/textverticaltype) | Representa el tipo directo de texto.|
