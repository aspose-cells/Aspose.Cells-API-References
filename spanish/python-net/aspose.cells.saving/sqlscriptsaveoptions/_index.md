---
title: SqlScriptSaveOptions clase
second_title: Aspose.Cells for Python via .NET API Referencias
description:
type: docs
weight: 20
url: /es/python-net/aspose.cells.saving/sqlscriptsaveoptions/
is_root: false
---
##  SqlScriptSaveOptions clase
Representa las opciones de guardar sql.



**Herencia:** [SqlScriptSaveOptions](/cells/python-net/aspose.cells.saving/sqlscriptsaveoptions) → 
[SaveOptions](/cells/es/python-net/aspose.cells/saveoptions)



El tipo SqlScriptSaveOptions expone los siguientes miembros:
...
| :- | :- |
| [save_format](/cells/es/python-net/aspose.cells.saving/sqlscriptsaveoptions/save_format) | Obtiene el formato de archivo guardado.|
| [clear_data](/cells/es/python-net/aspose.cells.saving/sqlscriptsaveoptions/clear_data) | Vacíe el libro de trabajo después de guardar el archivo.|
| [cached_file_folder](/cells/es/python-net/aspose.cells.saving/sqlscriptsaveoptions/cached_file_folder) | La carpeta de archivos en caché se utiliza para almacenar algunos datos de gran tamaño.|
| [validate_merged_areas](/cells/es/python-net/aspose.cells.saving/sqlscriptsaveoptions/validate_merged_areas) | Indica si validar las celdas combinadas antes de guardar el archivo.|
...
| [sheet_indexes](/cells/es/python-net/aspose.cells.saving/sqlscriptsaveoptions/sheet_indexes) | Representa los índices de las hojas exportadas.|
| [export_area](/cells/es/python-net/aspose.cells.saving/sqlscriptsaveoptions/export_area) | Obtiene o establece el rango de exportación.|
| [has_header_row](/cells/es/python-net/aspose.cells.saving/sqlscriptsaveoptions/has_header_row) | Indica si el rango contiene una fila de encabezado.|
...
* clase [SqlScriptSaveOptions](/cells/es/python-net/aspose.cells.saving/sqlscriptsaveoptions)
