---
title: JsonLayoutOptions clase
second_title: Aspose.Cells for Python via .NET API Referencias
description:
type: docs
weight: 20
url: /es/python-net/aspose.cells.utility/jsonlayoutoptions/
is_root: false
---
##  JsonLayoutOptions clase
Representa las opciones del tipo de diseño json.



El tipo JsonLayoutOptions expone los siguientes miembros:

###  Constructores
| Constructor| Descripción|
| :- | :- |
| [JsonLayoutOptions()](/cells/es/python-net/aspose.cells.utility/jsonlayoutoptions/__init__/#) | Construye una nueva instancia de JsonLayoutOptions|
