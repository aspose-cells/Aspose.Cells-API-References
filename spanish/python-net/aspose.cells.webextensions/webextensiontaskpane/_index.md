---
title: WebExtensionTaskPane clase
second_title: Aspose.Cells for Python via .NET API Referencias
description:
type: docs
weight: 90
url: /es/python-net/aspose.cells.webextensions/webextensiontaskpane/
is_root: false
---
##  WebExtensionTaskPane clase
Representa un objeto de panel de tareas persistente.



El tipo WebExtensionTaskPane expone los siguientes miembros:

###  Propiedades
| Propiedad| Descripción|
| :- | :- |
| [web_extension](/cells/es/python-net/aspose.cells.webextensions/webextensiontaskpane/web_extension) | Obtiene y establece la parte de la extensión web asociada con la instancia del panel de tareas|
