---
title: ControlMousePointerType enumeración
second_title: Aspose.Cells for Python via .NET API Referencias
description:
type: docs
weight: 200
url: /es/python-net/aspose.cells.drawing.activexcontrols/controlmousepointertype/
is_root: false
---
##  ControlMousePointerType enumeración
Representa el tipo de icono que se muestra como el puntero del mouse para el control.



El tipo ControlMousePointerType expone los siguientes miembros:
...
| SIZE_NWSE | Doble flecha apuntando al noroeste y sureste.|
| SIZE_WE | Doble flecha apuntando al oeste y al este.|
| UP_ARROW | Flecha arriba.|
| HOUR_GLASS | Reloj de arena.|
