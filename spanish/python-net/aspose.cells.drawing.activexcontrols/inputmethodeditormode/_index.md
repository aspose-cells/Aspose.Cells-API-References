...
type: docs
weight: 290
url: /es/python-net/aspose.cells.drawing.activexcontrols/inputmethodeditormode/
is_root: false
---
##  InputMethodEditorMode enumeración
Representa el modo de tiempo de ejecución predeterminado del Editor de métodos de entrada.



El tipo InputMethodEditorMode expone los siguientes miembros:
...
| ALPHA_FULL | IME activado con modo alfanumérico de ancho completo.|
