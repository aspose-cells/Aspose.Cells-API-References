---
title: LoadDataFilterOptions enumeración
second_title: Aspose.Cells for Python via .NET API Referencias
description:
type: docs
weight: 2200
url: /es/python-net/aspose.cells/loaddatafilteroptions/
is_root: false
---
##  LoadDataFilterOptions enumeración
Representa las opciones para filtrar datos al cargar un libro de trabajo desde una plantilla.



El tipo LoadDataFilterOptions expone los siguientes miembros:
...
| CELL_NUMERIC | Cargue celdas cuyo valor sea numérico (incluida la fecha y hora)|
| CELL_ERROR | Celdas de carga cuyo valor es error|
| CELL_BOOL | Células de carga cuyo valor es bool|
| CELL_VALUE | Valor de las celdas de carga (todos los tipos de valor) solamente|
| FORMULA | Fórmulas de celdas de carga.|
...
| PIVOT_TABLE | Cargar tablas dinámicas|
| TABLE | Cargar tablas|
...
| OLE_OBJECT | Cargar OleObjects|
| REVISION | Cargar registros de revisión|
