...
type: docs
weight: 20
url: /es/python-net/aspose.cells/databar/to_image/
is_root: false
---
...
| :- | :- | :- |
| cell | [Cell](/cells/es/python-net/aspose.cells/cell) | Indique la barra de datos en la que se representará la celda|
