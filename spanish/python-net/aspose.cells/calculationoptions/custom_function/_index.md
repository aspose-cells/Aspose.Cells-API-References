...
type: docs
weight: 60
url: /es/python-net/aspose.cells/calculationoptions/custom_function/
is_root: false
---
##  custom_function propiedad

Las funciones de cálculo de fórmula personalizada para ampliar el motor de cálculo.
...
* clase [ICustomFunction](/cells/es/python-net/aspose.cells/icustomfunction)
