---
title: TextAlignmentType enumeración
second_title: Aspose.Cells for Python via .NET API Referencias
description:
type: docs
weight: 2520
url: /es/python-net/aspose.cells/textalignmenttype/
is_root: false
---
##  TextAlignmentType enumeración
Enumera los tipos de alineación de texto.



El tipo TextAlignmentType expone los siguientes miembros:
...
| JUSTIFY | Representa justificar la alineación del texto.|
