---
title: remove_filter método
second_title: Aspose.Cells for Python via .NET API Referencias
description:
type: docs
weight: 160
url: /es/python-net/aspose.cells/autofilter/remove_filter/
is_root: false
---
##  remove_filter(field_index) {#int}
Retire el filtro específico.
...
| :- | :- | :- |
| field_index | int | El índice de filtro específico|
...
| criteria | str | Los criterios especificados (una cadena; por ejemplo, "101").<br/> Solo puede ser nulo o ser uno de los valores de las celdas en esta columna.|
