...
type: docs
weight: 1650
url: /es/python-net/aspose.cells/xlssaveoptions/
is_root: false
---
##  XlsSaveOptions clase
Representa las opciones de guardado para el formato de archivo de Excel 97-2003: xls y xlt.



**Herencia:** [XlsSaveOptions](/cells/python-net/aspose.cells/xlssaveoptions) → 
[SaveOptions](/cells/es/python-net/aspose.cells/saveoptions)



El tipo XlsSaveOptions expone los siguientes miembros:

###  Constructores
| Constructor| Descripción|
| :- | :- |
| [XlsSaveOptions()](/cells/es/python-net/aspose.cells/xlssaveoptions/__init__/#) | Crea opciones para guardar archivos Excel 97-2003 xls/xlt.|
| [XlsSaveOptions(format)](/cells/es/python-net/aspose.cells/xlssaveoptions/__init__/#SaveFormat) | Crea opciones para guardar archivos Excel 97-2003 xls/xlt.|


###  Propiedades
| Propiedad| Descripción|
| :- | :- |
| [save_format](/cells/es/python-net/aspose.cells/xlssaveoptions/save_format) | Obtiene el formato de archivo guardado.|
| [clear_data](/cells/es/python-net/aspose.cells/xlssaveoptions/clear_data) | Vacíe el libro de trabajo después de guardar el archivo.|
| [cached_file_folder](/cells/es/python-net/aspose.cells/xlssaveoptions/cached_file_folder) | La carpeta de archivos en caché se utiliza para almacenar algunos datos de gran tamaño.|
| [validate_merged_areas](/cells/es/python-net/aspose.cells/xlssaveoptions/validate_merged_areas) | Indica si validar las celdas combinadas antes de guardar el archivo.|
...
* clase [XlsSaveOptions](/cells/es/python-net/aspose.cells/xlssaveoptions)
