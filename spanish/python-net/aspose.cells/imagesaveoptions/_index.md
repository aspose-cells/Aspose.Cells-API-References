...
type: docs
weight: 910
url: /es/python-net/aspose.cells/imagesaveoptions/
is_root: false
---
##  ImageSaveOptions clase
Representa las opciones para guardar la imagen.
...
**Herencia:** [ImageSaveOptions](/cells/python-net/aspose.cells/imagesaveoptions) → 
[SaveOptions](/cells/es/python-net/aspose.cells/saveoptions)



El tipo ImageSaveOptions expone los siguientes miembros:
...
| :- | :- |
| [save_format](/cells/es/python-net/aspose.cells/imagesaveoptions/save_format) | Obtiene el formato de archivo guardado.|
| [clear_data](/cells/es/python-net/aspose.cells/imagesaveoptions/clear_data) | Vacíe el libro de trabajo después de guardar el archivo.|
| [cached_file_folder](/cells/es/python-net/aspose.cells/imagesaveoptions/cached_file_folder) | La carpeta de archivos en caché se utiliza para almacenar algunos datos de gran tamaño.|
| [validate_merged_areas](/cells/es/python-net/aspose.cells/imagesaveoptions/validate_merged_areas) | Indica si validar las celdas combinadas antes de guardar el archivo.|
