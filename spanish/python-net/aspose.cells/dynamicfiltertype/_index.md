---
title: DynamicFilterType enumeración
second_title: Aspose.Cells for Python via .NET API Referencias
description:
type: docs
weight: 1980
url: /es/python-net/aspose.cells/dynamicfiltertype/
is_root: false
---
##  DynamicFilterType enumeración
Tipo de filtro dinámico.



El tipo DynamicFilterType expone los siguientes miembros:
...
| LAST_WEEK | Muestra las fechas de la semana pasada.|
| LAST_YEAR | Muestra las fechas del año pasado.|
...
| JUNE | Muestra las fechas que están en junio, independientemente del año.|
| JULY | Muestra las fechas que están en julio, independientemente del año.|
| AUGUST | Muestra las fechas que están en agosto, independientemente del año.|
| SEPTEMBER | Muestra las fechas que están en septiembre, independientemente del año.|
| NEXT_MONTH | Muestra las fechas del próximo mes.|
| NEXT_QUARTER | Muestra las fechas del próximo trimestre.|
| NEXT_WEEK | Muestra las fechas de la próxima semana.|
| NEXT_YEAR | Muestra las fechas del próximo año.|
| NONE | Ninguno.|
...
| THIS_YEAR | Muestra las fechas de este año.|
| TODAY | Muestra las fechas de hoy.|
| TOMORROW | Muestra las fechas de mañana.|
| YEAR_TO_DATE | Muestra las fechas entre el comienzo del año y hoy, inclusive.|
| YESTERDAY | Muestra las fechas de ayer.|
