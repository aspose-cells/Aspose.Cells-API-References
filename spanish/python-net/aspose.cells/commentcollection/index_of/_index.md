...
type: docs
weight: 70
url: /es/python-net/aspose.cells/commentcollection/index_of/
is_root: false
---
##  index_of(item, index) {#Comment-int}
...
| :- | :- | :- |
| item | [Comment](/cells/es/python-net/aspose.cells/comment) | El objeto a ubicar en la lista de matrices. El valor puede ser nulo.|
| index | int | El índice inicial de base cero de la búsqueda. 0 (cero) es válido en una lista vacía.|


##  index_of(item, index, count) {#Comment-int-int}
