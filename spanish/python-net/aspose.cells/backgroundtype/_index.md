...
type: docs
weight: 1780
url: /es/python-net/aspose.cells/backgroundtype/
is_root: false
---
##  BackgroundType enumeración
Enumera los tipos de patrón de fondo de celda.



El tipo BackgroundType expone los siguientes miembros:
...
| HORIZONTAL_STRIPE | Representa el patrón de rayas horizontales.|
...
| VERTICAL_STRIPE | Representa el patrón de rayas verticales.|
