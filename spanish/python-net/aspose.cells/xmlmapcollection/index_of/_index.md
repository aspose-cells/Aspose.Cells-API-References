...
type: docs
weight: 50
url: /es/python-net/aspose.cells/xmlmapcollection/index_of/
is_root: false
---
...
| :- | :- | :- |
| item | [XmlMap](/cells/es/python-net/aspose.cells/xmlmap) | El objeto a ubicar en la lista de matrices. El valor puede ser nulo.|
...
###  Ver también
* módulo [aspose.cells](../../)
* clase [XmlMapCollection](/cells/es/python-net/aspose.cells/xmlmapcollection)
