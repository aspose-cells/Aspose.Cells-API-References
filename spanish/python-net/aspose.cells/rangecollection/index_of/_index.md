...
type: docs
weight: 50
url: /es/python-net/aspose.cells/rangecollection/index_of/
is_root: false
---
...
| :- | :- | :- |
| item | [Range](/cells/es/python-net/aspose.cells/range) | El objeto a ubicar en la lista de matrices. El valor puede ser nulo.|
...
###  Ver también
* módulo [aspose.cells](../../)
* clase [RangeCollection](/cells/es/python-net/aspose.cells/rangecollection)
