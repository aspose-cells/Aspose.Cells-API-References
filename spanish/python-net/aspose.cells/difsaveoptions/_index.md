...
type: docs
weight: 480
url: /es/python-net/aspose.cells/difsaveoptions/
is_root: false
---
...
**Herencia:** [DifSaveOptions](/cells/python-net/aspose.cells/difsaveoptions) → 
[SaveOptions](/cells/es/python-net/aspose.cells/saveoptions)



El tipo DifSaveOptions expone los siguientes miembros:

###  Constructores
| Constructor| Descripción|
| :- | :- |
| [DifSaveOptions()](/cells/es/python-net/aspose.cells/difsaveoptions/__init__/#) | Crea las opciones para guardar el archivo DIF.|


###  Propiedades
| Propiedad| Descripción|
| :- | :- |
| [save_format](/cells/es/python-net/aspose.cells/difsaveoptions/save_format) | Obtiene el formato de archivo guardado.|
| [clear_data](/cells/es/python-net/aspose.cells/difsaveoptions/clear_data) | Vacíe el libro de trabajo después de guardar el archivo.|
| [cached_file_folder](/cells/es/python-net/aspose.cells/difsaveoptions/cached_file_folder) | La carpeta de archivos en caché se utiliza para almacenar algunos datos de gran tamaño.|
| [validate_merged_areas](/cells/es/python-net/aspose.cells/difsaveoptions/validate_merged_areas) | Indica si validar las celdas combinadas antes de guardar el archivo.|
...
###  Ver también
* módulo [aspose.cells](..)
* clase [DifSaveOptions](/cells/es/python-net/aspose.cells/difsaveoptions)
