---
title: MarkdownSaveOptions clase
second_title: Aspose.Cells for Python via .NET API Referencias
description:
type: docs
weight: 1030
url: /es/python-net/aspose.cells/markdownsaveoptions/
is_root: false
---
##  MarkdownSaveOptions clase
Representa las opciones de guardado para Markdown.



**Herencia:** [MarkdownSaveOptions](/cells/python-net/aspose.cells/markdownsaveoptions) → 
...
| :- | :- |
| [save_format](/cells/es/python-net/aspose.cells/markdownsaveoptions/save_format) | Obtiene el formato de archivo guardado.|
| [clear_data](/cells/es/python-net/aspose.cells/markdownsaveoptions/clear_data) | Vacíe el libro de trabajo después de guardar el archivo.|
| [cached_file_folder](/cells/es/python-net/aspose.cells/markdownsaveoptions/cached_file_folder) | La carpeta de archivos en caché se utiliza para almacenar algunos datos de gran tamaño.|
| [validate_merged_areas](/cells/es/python-net/aspose.cells/markdownsaveoptions/validate_merged_areas) | Indica si validar las celdas combinadas antes de guardar el archivo.|
...
###  Ver también
* módulo [aspose.cells](..)
* clase [MarkdownSaveOptions](/cells/es/python-net/aspose.cells/markdownsaveoptions)
