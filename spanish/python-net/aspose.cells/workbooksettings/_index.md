...
type: docs
weight: 1610
url: /es/python-net/aspose.cells/workbooksettings/
is_root: false
---
##  WorkbookSettings clase
Representa todas las configuraciones del libro.



El tipo WorkbookSettings expone los siguientes miembros:
...
| [enable_macros](/cells/es/python-net/aspose.cells/workbooksettings/enable_macros) | Habilitar macros;|
| [date1904](/cells/es/python-net/aspose.cells/workbooksettings/date1904) | Obtiene o establece un valor que representa si el libro usa el sistema de fechas de 1904.|
| [protection_type](/cells/es/python-net/aspose.cells/workbooksettings/protection_type) | Obtiene el tipo de protección del libro.|
| [display_drawing_objects](/cells/es/python-net/aspose.cells/workbooksettings/display_drawing_objects) | Indica si y cómo mostrar objetos en el libro de trabajo.|
| [sheet_tab_bar_width](/cells/es/python-net/aspose.cells/workbooksettings/sheet_tab_bar_width) | Ancho de la barra de pestañas de la hoja de trabajo (en 1/1000 del ancho de la ventana).|
| [show_tabs](/cells/es/python-net/aspose.cells/workbooksettings/show_tabs) | Obtiene o establece un valor si se muestran las pestañas del Libro de trabajo.|
| [first_visible_tab](/cells/es/python-net/aspose.cells/workbooksettings/first_visible_tab) | Obtiene o establece la primera pestaña visible de la hoja de cálculo.|
| [is_h_scroll_bar_visible](/cells/es/python-net/aspose.cells/workbooksettings/is_h_scroll_bar_visible) | Obtiene o establece un valor que indica si la hoja de cálculo generada contendrá una barra de desplazamiento horizontal.|
...
| [is_protected](/cells/es/python-net/aspose.cells/workbooksettings/is_protected) | Obtiene un valor que indica si la estructura o ventana del Workbook está protegida.|
| [is_default_encrypted](/cells/es/python-net/aspose.cells/workbooksettings/is_default_encrypted) | Indica si se cifra el libro de trabajo con la contraseña predeterminada si la Estructura y Windows del libro de trabajo están bloqueados.|
| [is_minimized](/cells/es/python-net/aspose.cells/workbooksettings/is_minimized) | Representa si la hoja de cálculo generada se abrirá Minimizada.|
| [is_hidden](/cells/es/python-net/aspose.cells/workbooksettings/is_hidden) | Indica si este libro está oculto.|
| [auto_compress_pictures](/cells/es/python-net/aspose.cells/workbooksettings/auto_compress_pictures) | Especifica un valor booleano que indica que la aplicación comprimió automáticamente las imágenes del libro.|
| [remove_personal_information](/cells/es/python-net/aspose.cells/workbooksettings/remove_personal_information) | True si la información personal se puede quitar del libro de trabajo especificado.|
| [hide_pivot_field_list](/cells/es/python-net/aspose.cells/workbooksettings/hide_pivot_field_list) | Obtiene y establece si se oculta la lista de campos de la tabla dinámica.|
| [update_links_type](/cells/es/python-net/aspose.cells/workbooksettings/update_links_type) | Obtiene y establece cómo se actualizan los vínculos externos cuando se abre el libro.|
| [max_row](/cells/es/python-net/aspose.cells/workbooksettings/max_row) | Obtiene el índice de fila máximo, basado en cero.|
| [max_column](/cells/es/python-net/aspose.cells/workbooksettings/max_column) | Obtiene el índice de columna máximo, basado en cero.|
| [parsing_formula_on_open](/cells/es/python-net/aspose.cells/workbooksettings/parsing_formula_on_open) | Indica si se analiza la fórmula al leer el archivo.|
| [window_left](/cells/es/python-net/aspose.cells/workbooksettings/window_left) |La distancia desde el borde izquierdo del área del cliente hasta el borde izquierdo de la ventana, en unidad de punto.|
| [window_left_inch](/cells/es/python-net/aspose.cells/workbooksettings/window_left_inch) | La distancia desde el borde izquierdo del área del cliente hasta el borde izquierdo de la ventana.<br/> En unidad de pulgada.|
| [window_left_cm](/cells/es/python-net/aspose.cells/workbooksettings/window_left_cm) | La distancia desde el borde izquierdo del área del cliente hasta el borde izquierdo de la ventana.<br/> En unidad de centimetro.|
...
| [repair_load](/cells/es/python-net/aspose.cells/workbooksettings/repair_load) | Indica si la aplicación abrió por última vez el libro en modo seguro o de reparación.|
...
| [calculation_id](/cells/es/python-net/aspose.cells/workbooksettings/calculation_id) | Especifica la versión del motor de cálculo utilizado para calcular valores en el libro.|
| [calc_stack_size](/cells/es/python-net/aspose.cells/workbooksettings/calc_stack_size) | Especifica el tamaño de pila para calcular celdas recursivamente.<br/>El valor grande para este tamaño brindará un mejor rendimiento cuando haya muchas celdas que se deban calcular recursivamente.<br/>Por otro lado, un valor mayor aumentará el riesgo de StackOverflowException.<br/> Si el usuario obtiene StackOverflowException al calcular fórmulas, este valor debe reducirse.|
| [recalculate_before_save](/cells/es/python-net/aspose.cells/workbooksettings/recalculate_before_save) | Indica si se debe volver a calcular antes de guardar el documento.|


###  Métodos
| Método| Descripción|
| :- | :- |
| [get_theme_font(type)](/cells/es/python-net/aspose.cells/workbooksettings/get_theme_font/#FontSchemeType) | Obtiene el nombre de fuente del tema predeterminado.|
| [set_page_orientation_type(page_orientation_type)](/cells/es/python-net/aspose.cells/workbooksettings/set_page_orientation_type/#PageOrientationType) |Establezca el tipo de orientación de impresión para todo el libro de trabajo.|
