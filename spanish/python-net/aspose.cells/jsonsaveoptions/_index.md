---
title: JsonSaveOptions clase
second_title: Aspose.Cells for Python via .NET API Referencias
description:
type: docs
weight: 970
url: /es/python-net/aspose.cells/jsonsaveoptions/
is_root: false
---
##  JsonSaveOptions clase
Representa las opciones de guardar el libro de trabajo como un archivo json.



**Herencia:** [JsonSaveOptions](/cells/python-net/aspose.cells/jsonsaveoptions) → 
[SaveOptions](/cells/es/python-net/aspose.cells/saveoptions)



El tipo JsonSaveOptions expone los siguientes miembros:
...
| :- | :- |
| [save_format](/cells/es/python-net/aspose.cells/jsonsaveoptions/save_format) | Obtiene el formato de archivo guardado.|
| [clear_data](/cells/es/python-net/aspose.cells/jsonsaveoptions/clear_data) | Vacíe el libro de trabajo después de guardar el archivo.|
| [cached_file_folder](/cells/es/python-net/aspose.cells/jsonsaveoptions/cached_file_folder) | La carpeta de archivos en caché se utiliza para almacenar algunos datos de gran tamaño.|
| [validate_merged_areas](/cells/es/python-net/aspose.cells/jsonsaveoptions/validate_merged_areas) | Indica si validar las celdas combinadas antes de guardar el archivo.|
...
| [sheet_indexes](/cells/es/python-net/aspose.cells/jsonsaveoptions/sheet_indexes) | Representa los índices de las hojas exportadas.|
...
###  Ver también
* módulo [aspose.cells](..)
* clase [JsonSaveOptions](/cells/es/python-net/aspose.cells/jsonsaveoptions)
