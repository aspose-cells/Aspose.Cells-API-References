...
type: docs
weight: 140
url: /es/python-net/aspose.cells/worksheetcollection/index_of/
is_root: false
---
##  index_of(item, index) {#Worksheet-int}
...
| :- | :- | :- |
| item | [Worksheet](/cells/es/python-net/aspose.cells/worksheet) | El objeto a ubicar en la lista de matrices. El valor puede ser nulo.|
| index | int | El índice inicial de base cero de la búsqueda. 0 (cero) es válido en una lista vacía.|


##  index_of(item, index, count) {#Worksheet-int-int}
