...
type: docs
weight: 50
url: /es/python-net/aspose.cells/threadedcommentcollection/index_of/
is_root: false
---
##  index_of(item, index) {#ThreadedComment-int}
...
###  Ver también
* módulo [aspose.cells](../../)
* clase [ThreadedCommentCollection](/cells/es/python-net/aspose.cells/threadedcommentcollection)
