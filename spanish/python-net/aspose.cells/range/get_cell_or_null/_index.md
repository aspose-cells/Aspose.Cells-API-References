...
type: docs
weight: 80
url: /es/python-net/aspose.cells/range/get_cell_or_null/
is_root: false
---
##  get_cell_or_null(row_offset, column_offset) {#int-int}
Obtiene el objeto [Cell](/cells/es/python-net/aspose.cells/cell) o nulo en este rango.


###  Devoluciones

[Cell](/cells/es/python-net/aspose.cells/cell) objeto.
