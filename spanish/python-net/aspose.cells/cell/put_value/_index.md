...
type: docs
weight: 270
url: /es/python-net/aspose.cells/cell/put_value/
is_root: false
---
...
Pone un valor en la celda, si corresponde, el valor se convertirá a otro tipo de datos y el formato de número de la celda se restablecerá.
