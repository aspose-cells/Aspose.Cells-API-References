---
title: CellBorderType enumeración
second_title: Aspose.Cells for Python via .NET API Referencias
description:
type: docs
weight: 1830
url: /es/python-net/aspose.cells/cellbordertype/
is_root: false
---
##  CellBorderType enumeración
Enumera el tipo de borde de una celda.



El tipo CellBorderType expone los siguientes miembros:
