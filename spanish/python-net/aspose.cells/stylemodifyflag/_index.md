...
type: docs
weight: 2500
url: /es/python-net/aspose.cells/stylemodifyflag/
is_root: false
---
##  StyleModifyFlag enumeración
Las banderas modificadas de estilo.



El tipo StyleModifyFlag expone los siguientes miembros:
...
| NUMBER_FORMAT | Indica si se ha modificado el formato de número.|
| HORIZONTAL_ALIGNMENT | Indica si se ha modificado la alineación horizontal.|
| VERTICAL_ALIGNMENT | Indica si se ha modificado la alineación vertical.|
| INDENT | Indica si se ha modificado la propiedad de sangría.|
...
| FOREGROUND_COLOR | Indica si se ha modificado el color de primer plano.|
| BACKGROUND_COLOR | Indica si se ha modificado el color de fondo.|
| CELL_SHADING | Indica si una o más propiedades relacionadas con el sombreado ([StyleModifyFlag.PATTERN](/cells/es/python-net/aspose.cells/stylemodifyflag#PATTERN),<br/> [StyleModifyFlag.FOREGROUND_COLOR](/cells/es/python-net/aspose.cells/stylemodifyflag#FOREGROUND_COLOR), [StyleModifyFlag.BACKGROUND_COLOR](/cells/es/python-net/aspose.cells/stylemodifyflag#BACKGROUND_COLOR)) se han modificado.|
| LOCKED | Indica si se ha modificado la propiedad bloqueada.|
| HIDE_FORMULA | Indica si se ha modificado la fórmula de ocultar.|
| PROTECTION_SETTINGS | Indica si una o más propiedades relacionadas con la protección ([StyleModifyFlag.LOCKED](/cells/es/python-net/aspose.cells/stylemodifyflag#LOCKED),<br/> [StyleModifyFlag.HIDE_FORMULA](/cells/es/python-net/aspose.cells/stylemodifyflag#HIDE_FORMULA)) han sido modificados.|
| FONT_SIZE | Indica si se ha modificado el tamaño de fuente.|
...
| FONT_U_FILL_TX | no usado.|
| FONT_SPACING | no usado.|
| FONT_KERNING | no usado.|
| FONT_EQUALIZE | no usado.|
| FONT_CAP | no usado.|
| FONT | Indica si se han modificado una o más propiedades para la fuente del estilo.|
| ALL | Indica si se han modificado una o más propiedades para el estilo.|
