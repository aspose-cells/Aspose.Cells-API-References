---
title: auto_fit_rows método
second_title: Aspose.Cells for Python via .NET API Referencias
description:
type: docs
weight: 70
url: /es/python-net/aspose.cells/worksheet/auto_fit_rows/
is_root: false
---
##  auto_fit_rows() {#}
...
| start_row | int | Índice de fila de inicio.|
| end_row | int | Índice de fila final.|
| options | [AutoFitterOptions](/cells/es/python-net/aspose.cells/autofitteroptions) | Las opciones de instalador automático.|
