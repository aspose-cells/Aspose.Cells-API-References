...
type: docs
weight: 30
url: /es/python-net/aspose.cells/column/get_style/
is_root: false
---
##  get_style() {#}
...
Tienes que llamar al [Column.apply_style(style, flag)](/cells/es/python-net/aspose.cells/column/apply_style) o al método [Column.set_style(style)](/cells/es/python-net/aspose.cells/column/set_style)
