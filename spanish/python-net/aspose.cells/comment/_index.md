...
type: docs
weight: 280
url: /es/python-net/aspose.cells/comment/
is_root: false
---
##  Comment clase
...
| :- | :- |
| [author](/cells/es/python-net/aspose.cells/comment/author) | Obtiene y establece el nombre del autor del comentario original.|
| [comment_shape](/cells/es/python-net/aspose.cells/comment/comment_shape) | Obtenga un objeto Shape que represente la forma adjunta al comentario especificado.|
| [row](/cells/es/python-net/aspose.cells/comment/row) | Obtiene el índice de fila del comentario.|
...
| [height](/cells/es/python-net/aspose.cells/comment/height) | Representa la Altura del comentario, en unidades de píxeles.|
| [width_inch](/cells/es/python-net/aspose.cells/comment/width_inch) | Representa el ancho del comentario, en unidades de pulgadas.|
| [height_inch](/cells/es/python-net/aspose.cells/comment/height_inch) | Representa la altura del comentario, en unidades de pulgadas.|


###  Métodos
| Método| Descripción|
| :- | :- |
| [format_characters(start_index, length, font, flag)](/cells/es/python-net/aspose.cells/comment/format_characters/#int-int-Font-StyleFlag) | Formatee algunos caracteres con la configuración de fuente.|
| [characters(start_index, length)](/cells/es/python-net/aspose.cells/comment/characters/#int-int) | Devuelve un objeto Characters que representa un rango de caracteres dentro del texto del comentario.|
| [get_characters()](/cells/es/python-net/aspose.cells/comment/get_characters/#) | Devuelve todos los objetos de caracteres.<br/> que representa un rango de caracteres dentro del texto del comentario.|
