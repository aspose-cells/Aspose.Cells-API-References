---
title: XlsbSaveOptions clase
second_title: Aspose.Cells for Python via .NET API Referencias
description:
type: docs
weight: 1660
url: /es/python-net/aspose.cells/xlsbsaveoptions/
is_root: false
---
...
**Herencia:** [XlsbSaveOptions](/cells/python-net/aspose.cells/xlsbsaveoptions) → 
[SaveOptions](/cells/es/python-net/aspose.cells/saveoptions)



El tipo XlsbSaveOptions expone los siguientes miembros:

###  Constructores
| Constructor| Descripción|
| :- | :- |
| [XlsbSaveOptions()](/cells/es/python-net/aspose.cells/xlsbsaveoptions/__init__/#) | Crea opciones para guardar archivos xlsb.|
| [XlsbSaveOptions(save_format)](/cells/es/python-net/aspose.cells/xlsbsaveoptions/__init__/#SaveFormat) | Crea opciones para guardar archivos xlsb.|


###  Propiedades
| Propiedad| Descripción|
| :- | :- |
| [save_format](/cells/es/python-net/aspose.cells/xlsbsaveoptions/save_format) | Obtiene el formato de archivo guardado.|
| [clear_data](/cells/es/python-net/aspose.cells/xlsbsaveoptions/clear_data) | Vacíe el libro de trabajo después de guardar el archivo.|
| [cached_file_folder](/cells/es/python-net/aspose.cells/xlsbsaveoptions/cached_file_folder) | La carpeta de archivos en caché se utiliza para almacenar algunos datos de gran tamaño.|
| [validate_merged_areas](/cells/es/python-net/aspose.cells/xlsbsaveoptions/validate_merged_areas) | Indica si validar las celdas combinadas antes de guardar el archivo.|
...
* clase [XlsbSaveOptions](/cells/es/python-net/aspose.cells/xlsbsaveoptions)
