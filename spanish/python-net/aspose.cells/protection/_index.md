...
type: docs
weight: 1220
url: /es/python-net/aspose.cells/protection/
is_root: false
---
##  Protection clase
...
| [is_using_pivot_tables_allowed](/cells/es/python-net/aspose.cells/protection/is_using_pivot_tables_allowed) | Representa si el usuario puede manipular tablas dinámicas en una hoja de trabajo protegida.|
| [allow_editing_content](/cells/es/python-net/aspose.cells/protection/allow_editing_content) | Representa si el usuario puede editar el contenido de las celdas bloqueadas en una hoja de trabajo protegida.|
| [is_editing_contents_allowed](/cells/es/python-net/aspose.cells/protection/is_editing_contents_allowed) | Representa si el usuario puede editar el contenido de las celdas bloqueadas en una hoja de trabajo protegida.|
| [allow_editing_object](/cells/es/python-net/aspose.cells/protection/allow_editing_object) | Representa si el usuario puede manipular objetos de dibujo en una hoja de cálculo protegida.|
...
| Método| Descripción|
| :- | :- |
| [copy(source)](/cells/es/python-net/aspose.cells/protection/copy/#Protection) | Información de protección contra copia.|
| [get_password_hash()](/cells/es/python-net/aspose.cells/protection/get_password_hash/#) | Obtiene el hash de la contraseña actual.|
| [verify_password(password)](/cells/es/python-net/aspose.cells/protection/verify_password/#str) | Verifica la contraseña.|
