---
title: ErrorCheckType enumeración
second_title: Aspose.Cells for Python via .NET API Referencias
description:
type: docs
weight: 2010
url: /es/python-net/aspose.cells/errorchecktype/
is_root: false
---
##  ErrorCheckType enumeración
Representa todos los tipos de comprobación de errores.



El tipo ErrorCheckType expone los siguientes miembros:
...
| CALCULATED_COLUMN | Ignore los errores cuando las celdas contienen un valor diferente de una fórmula de columna calculada.|
