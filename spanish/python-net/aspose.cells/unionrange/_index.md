...
type: docs
weight: 1530
url: /es/python-net/aspose.cells/unionrange/
is_root: false
---
##  UnionRange clase
...
El tipo UnionRange expone los siguientes miembros:

###  Propiedades
| Propiedad| Descripción|
| :- | :- |
| [first_row](/cells/es/python-net/aspose.cells/unionrange/first_row) | Obtiene el índice de la primera fila del rango.|
| [first_column](/cells/es/python-net/aspose.cells/unionrange/first_column) | Obtiene el índice de la primera columna del rango.|
| [row_count](/cells/es/python-net/aspose.cells/unionrange/row_count) | Obtiene el recuento de filas en el rango.|
| [column_count](/cells/es/python-net/aspose.cells/unionrange/column_count) | Obtiene el recuento de filas en el rango.|
...
| Método| Descripción|
| :- | :- |
| [set_outline_borders(border_styles, border_colors)](/cells/es/python-net/aspose.cells/unionrange/set_outline_borders/#list-aspose.pydrawing.Color[]) | Establece bordes de línea alrededor de un rango de celdas.|
| [set_outline_borders(border_style, border_color)](/cells/es/python-net/aspose.cells/unionrange/set_outline_borders/#CellBorderType-aspose.pydrawing.Color) | Establece los bordes del contorno alrededor de un rango de celdas con el mismo estilo y color de borde.|
| [intersect(range)](/cells/es/python-net/aspose.cells/unionrange/intersect/#str) | Intersecta otro rango.|
| [intersect(union_range)](/cells/es/python-net/aspose.cells/unionrange/intersect/#UnionRange) | Intersecta otro rango.|
| [intersect(ranges)](/cells/es/python-net/aspose.cells/unionrange/intersect/#list) | Intersecta otro rango.|
| [union(range)](/cells/es/python-net/aspose.cells/unionrange/union/#str) | Unión otra gama.|
...
| [copy(range, options)](/cells/es/python-net/aspose.cells/unionrange/copy/#UnionRange-PasteOptions) | Copiando el rango con opciones especiales de pegado.|
| [get_enumerator()](/cells/es/python-net/aspose.cells/unionrange/get_enumerator/#) | Obtiene el enumerador de las celdas de este rango.|
