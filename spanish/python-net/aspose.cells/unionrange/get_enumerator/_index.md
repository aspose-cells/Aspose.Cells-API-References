...
type: docs
weight: 40
url: /es/python-net/aspose.cells/unionrange/get_enumerator/
is_root: false
---
##  get_enumerator() {#}
...
no debe modificarse (como las operaciones que harán que se cree una nueva Cell/Row o que se elimine Cell/Row existente).
