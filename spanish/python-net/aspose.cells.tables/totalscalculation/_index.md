---
title: TotalsCalculation enumeración
second_title: Aspose.Cells for Python via .NET API Referencias
description:
type: docs
weight: 130
url: /es/python-net/aspose.cells.tables/totalscalculation/
is_root: false
---
##  TotalsCalculation enumeración
Determina el tipo de cálculo en la fila Totales de la columna de lista.



El tipo TotalsCalculation expone los siguientes miembros:
