---
title: SlicerCacheCrossFilterType enumeración
second_title: Aspose.Cells for Python via .NET API Referencias
description:
type: docs
weight: 60
url: /es/python-net/aspose.cells.slicers/slicercachecrossfiltertype/
is_root: false
---
##  SlicerCacheCrossFilterType enumeración
Representa el tipo de SlicerCacheCrossFilterType



El tipo SlicerCacheCrossFilterType expone los siguientes miembros:
