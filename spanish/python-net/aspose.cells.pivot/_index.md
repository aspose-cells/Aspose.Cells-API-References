...
type: docs
weight: 10
url: /es/python-net/aspose.cells.pivot/
is_root: false
---
 El**Aspose.Cells.Pivot** El espacio de nombres contiene todas las clases de representación y manipulación de tablas dinámicas en archivos de hoja de cálculo de Excel.
...
| [PivotItem](/cells/es/python-net/aspose.cells.pivot/pivotitem) | Representa un elemento en un informe de PivotField.|
| [PivotItemCollection](/cells/es/python-net/aspose.cells.pivot/pivotitemcollection) | Representa una colección de todos los objetos PivotItem en PivotField.|
| [PivotPageFields](/cells/es/python-net/aspose.cells.pivot/pivotpagefields) | Representa los elementos del campo de la página dinámica.<br/>si la fuente de datos de la tabla dinámica son rangos de consolidación.<br/> Solo puede contener hasta 4 campos.|
| [PivotTable](/cells/es/python-net/aspose.cells.pivot/pivottable) | Descripción resumida de la tabla dinámica.|
| [PivotTableCollection](/cells/es/python-net/aspose.cells.pivot/pivottablecollection) | Representa la colección de todos los objetos de tabla dinámica en la hoja de cálculo especificada.|
| [SxRng](/cells/es/python-net/aspose.cells.pivot/sxrng) | Representa el rango de grupo en un campo dinámico.|
