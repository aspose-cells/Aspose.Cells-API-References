---
title: PivotTableAutoFormatType enumeración
second_title: Aspose.Cells for Python via .NET API Referencias
description:
type: docs
weight: 220
url: /es/python-net/aspose.cells.pivot/pivottableautoformattype/
is_root: false
---
##  PivotTableAutoFormatType enumeración
Representa el tipo de formato automático de tabla dinámica.



El tipo PivotTableAutoFormatType expone los siguientes miembros:
...
| REPORT7 | Representa el tipo de formato Report7.|
...
| TABLE10 | Representa el tipo de formato de la Tabla 10.|
