...
type: docs
weight: 20
url: /es/python-net/aspose.cells.pivot/pivottable/add_calculated_field/
is_root: false
---
...
Agrega un campo calculado al campo dinámico.
...
| name | str | El nombre del campo calculado.|
| formula | str | La fórmula del campo calculado.|
| drag_to_data_area | bool | Cierto, arrastre este campo al área de datos inmediatamente|
