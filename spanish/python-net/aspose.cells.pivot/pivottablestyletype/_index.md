---
title: PivotTableStyleType enumeración
second_title: Aspose.Cells for Python via .NET API Referencias
description:
type: docs
weight: 230
url: /es/python-net/aspose.cells.pivot/pivottablestyletype/
is_root: false
---
##  PivotTableStyleType enumeración
Representa el tipo de estilo de tabla dinámica.



El tipo PivotTableStyleType expone los siguientes miembros:
