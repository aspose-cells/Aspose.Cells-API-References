...
type: docs
weight: 10
url: /es/python-net/aspose.cells.externalconnections/
is_root: false
---
 El**Aspose.Cells.ExternalConnections** El espacio de nombres proporciona clases para conexiones externas para recuperar datos de fuentes externas, como bases de datos y la Web.

###  Clases
| Clase| Descripción|
| :- | :- |
| [ConnectionParameter](/cells/es/python-net/aspose.cells.externalconnections/connectionparameter) | Especifica propiedades sobre cualquier parámetro utilizado con conexiones de datos externas<br/> Los parámetros son válidos para ODBC y consultas web.|
| [ConnectionParameterCollection](/cells/es/python-net/aspose.cells.externalconnections/connectionparametercollection) | Especifica la colección [ConnectionParameter](/cells/es/python-net/aspose.cells.externalconnections/connectionparameter)|
| [DBConnection](/cells/es/python-net/aspose.cells.externalconnections/dbconnection) | Especifica todas las propiedades asociadas con una conexión de datos externa ODBC u OLE DB.|
