---
title: ConnectionDataSourceType enumeración
second_title: Aspose.Cells for Python via .NET API Referencias
description:
type: docs
weight: 80
url: /es/python-net/aspose.cells.externalconnections/connectiondatasourcetype/
is_root: false
---
##  ConnectionDataSourceType enumeración
Especifica el tipo de origen de la base de datos externa



El tipo ConnectionDataSourceType expone los siguientes miembros:
...
| UNKNOWN | Fuente de datos de texto creada por el modelo de datos de hoja de cálculo.|
