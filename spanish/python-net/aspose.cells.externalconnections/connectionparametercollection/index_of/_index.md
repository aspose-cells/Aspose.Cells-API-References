...
type: docs
weight: 40
url: /es/python-net/aspose.cells.externalconnections/connectionparametercollection/index_of/
is_root: false
---
##  index_of(item, index) {#ConnectionParameter-int}
...
| :- | :- | :- |
| item | [ConnectionParameter](/cells/es/python-net/aspose.cells.externalconnections/connectionparameter) | El objeto a ubicar en la lista de matrices. El valor puede ser nulo.|
| index | int | El índice inicial de base cero de la búsqueda. 0 (cero) es válido en una lista vacía.|


##  index_of(item, index, count) {#ConnectionParameter-int-int}
