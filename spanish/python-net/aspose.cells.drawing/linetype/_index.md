...
type: docs
weight: 950
url: /es/python-net/aspose.cells.drawing/linetype/
is_root: false
---
##  LineType enumeración
Enumera el tipo de borde [Picture](/cells/es/python-net/aspose.cells.drawing/picture) o línea [Chart](/cells/es/python-net/aspose.cells.charts/chart).



El tipo LineType expone los siguientes miembros:
