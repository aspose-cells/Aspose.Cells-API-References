---
title: MsoLineFormat clase
second_title: Aspose.Cells for Python via .NET API Referencias
description:
type: docs
weight: 360
url: /es/python-net/aspose.cells.drawing/msolineformat/
is_root: false
---
##  MsoLineFormat clase
...
El tipo MsoLineFormat expone los siguientes miembros:

###  Propiedades
| Propiedad| Descripción|
| :- | :- |
| [is_visible](/cells/es/python-net/aspose.cells.drawing/msolineformat/is_visible) | Indica si el objeto es visible.|
| [style](/cells/es/python-net/aspose.cells.drawing/msolineformat/style) | Devuelve un objeto Style que representa el estilo del rango especificado.|
| [fore_color](/cells/es/python-net/aspose.cells.drawing/msolineformat/fore_color) | Obtiene y establece el color de primer plano de la línea del borde.|
