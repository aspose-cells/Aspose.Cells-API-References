---
title: PresetCameraType enumeración
second_title: Aspose.Cells for Python via .NET API Referencias
description:
type: docs
weight: 1060
url: /es/python-net/aspose.cells.drawing/presetcameratype/
is_root: false
---
##  PresetCameraType enumeración
Representar diferentes métodos algorítmicos para configurar todas las propiedades de la cámara, incluida la posición.



El tipo PresetCameraType expone los siguientes miembros:
