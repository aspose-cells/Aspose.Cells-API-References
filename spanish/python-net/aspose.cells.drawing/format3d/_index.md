...
type: docs
weight: 190
url: /es/python-net/aspose.cells.drawing/format3d/
is_root: false
---
##  Format3D clase
Esta clase especifica las propiedades de forma 3D para un elemento o forma de gráfico.



El tipo Format3D expone los siguientes miembros:
...
| Método| Descripción|
| :- | :- |
| [has_top_bevel_data()](/cells/es/python-net/aspose.cells.drawing/format3d/has_top_bevel_data/#) | Indica si la forma tiene datos de bisel superior.|
