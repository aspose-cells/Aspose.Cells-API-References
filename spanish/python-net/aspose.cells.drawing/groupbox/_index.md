---
title: GroupBox clase
second_title: Aspose.Cells for Python via .NET API Referencias
description:
type: docs
weight: 250
url: /es/python-net/aspose.cells.drawing/groupbox/
is_root: false
---
##  GroupBox clase
...
**Herencia:** [GroupBox](/cells/python-net/aspose.cells.drawing/groupbox) → 
[Shape](/cells/es/python-net/aspose.cells.drawing/shape)



El tipo GroupBox expone los siguientes miembros:

###  Propiedades
| Propiedad| Descripción|
| :- | :- |
| [macro_name](/cells/es/python-net/aspose.cells.drawing/groupbox/macro_name) | Obtiene y establece el nombre de la macro.|
...
| [hyperlink](/cells/es/python-net/aspose.cells.drawing/groupbox/hyperlink) | Obtiene el hipervínculo de la forma.|
...
| [placement](/cells/es/python-net/aspose.cells.drawing/groupbox/placement) | Representa la forma en que el objeto de dibujo se adjunta a las celdas debajo de él.<br/> La propiedad controla la ubicación de un objeto en una hoja de cálculo.|
| [upper_left_row](/cells/es/python-net/aspose.cells.drawing/groupbox/upper_left_row) | Representa el índice de la fila de la esquina superior izquierda.|
| [upper_delta_y](/cells/es/python-net/aspose.cells.drawing/groupbox/upper_delta_y) | Obtiene o establece el desplazamiento vertical de la forma desde la fila de la esquina superior izquierda.|
| [upper_left_column](/cells/es/python-net/aspose.cells.drawing/groupbox/upper_left_column) | Representa el índice de la columna de la esquina superior izquierda.|
| [upper_delta_x](/cells/es/python-net/aspose.cells.drawing/groupbox/upper_delta_x) | Obtiene o establece el desplazamiento horizontal de la forma desde la columna de la esquina superior izquierda.|
| [lower_right_row](/cells/es/python-net/aspose.cells.drawing/groupbox/lower_right_row) | Representa el índice de la fila de la esquina inferior derecha.|
| [lower_delta_y](/cells/es/python-net/aspose.cells.drawing/groupbox/lower_delta_y) | Obtiene o establece el desplazamiento vertical de la forma desde la fila de la esquina inferior derecha.|
...
| [left](/cells/es/python-net/aspose.cells.drawing/groupbox/left) | Representa el desplazamiento horizontal de la forma desde su columna izquierda, en unidades de píxeles.|
...
| [type](/cells/es/python-net/aspose.cells.drawing/groupbox/type) | Obtiene el tipo de forma automática.|
| [has_line](/cells/es/python-net/aspose.cells.drawing/groupbox/has_line) | Obtiene y establece que el borde de línea de la forma sea visible.|
| [is_filled](/cells/es/python-net/aspose.cells.drawing/groupbox/is_filled) | Indica si el formato de relleno es visible.|
| [is_flipped_horizontally](/cells/es/python-net/aspose.cells.drawing/groupbox/is_flipped_horizontally) | Obtiene y establece si la forma se invierte horizontalmente.|
| [is_flipped_vertically](/cells/es/python-net/aspose.cells.drawing/groupbox/is_flipped_vertically) | Obtiene y establece si la forma se invierte verticalmente.|
| [actual_lower_right_row](/cells/es/python-net/aspose.cells.drawing/groupbox/actual_lower_right_row) | Obtenga la fila inferior real.|
| [connection_points](/cells/es/python-net/aspose.cells.drawing/groupbox/connection_points) | Obtener los puntos de conexión|
...
| [text](/cells/es/python-net/aspose.cells.drawing/groupbox/text) | Representa la cadena en este objeto TextBox.|
...
| [text_vertical_alignment](/cells/es/python-net/aspose.cells.drawing/groupbox/text_vertical_alignment) | Obtiene y establece el tipo de alineación vertical del texto de la forma.|
...
| Método| Descripción|
| :- | :- |
| [to_image(stream, image_type)](/cells/es/python-net/aspose.cells.drawing/groupbox/to_image/#io.RawIOBase-ImageType) | Crea la imagen de la forma y la guarda en una secuencia en el formato especificado.|
| [to_image(image_file, options)](/cells/es/python-net/aspose.cells.drawing/groupbox/to_image/#str-aspose.cells.rendering.ImageOrPrintOptions) | Guarda la forma en un archivo.|
| [to_image(stream, options)](/cells/es/python-net/aspose.cells.drawing/groupbox/to_image/#io.RawIOBase-aspose.cells.rendering.ImageOrPrintOptions) | Guarda la forma en una secuencia.|
| [format_characters(start_index, length, font, flag)](/cells/es/python-net/aspose.cells.drawing/groupbox/format_characters/#int-int-Font-StyleFlag) | Da formato a algunos caracteres con la configuración de fuente.|
| [format_characters(start_index, length, font)](/cells/es/python-net/aspose.cells.drawing/groupbox/format_characters/#int-int-Font) | Da formato a algunos caracteres con la configuración de fuente.|
| [get_result_of_smart_art()](/cells/es/python-net/aspose.cells.drawing/groupbox/get_result_of_smart_art/#) | Conversión de arte inteligente en formas agrupadas.|
| [to_front_or_back(orders)](/cells/es/python-net/aspose.cells.drawing/groupbox/to_front_or_back/#int) | Trae la forma al frente o la envía hacia atrás.|
| [get_locked_property(type)](/cells/es/python-net/aspose.cells.drawing/groupbox/get_locked_property/#ShapeLockType) | Obtiene el valor de la propiedad bloqueada.|
| [set_locked_property(type, value)](/cells/es/python-net/aspose.cells.drawing/groupbox/set_locked_property/#ShapeLockType-bool) | Establezca la propiedad bloqueada.|
...
* clase [GroupBox](/cells/es/python-net/aspose.cells.drawing/groupbox)
