...
type: docs
weight: 760
url: /es/python-net/aspose.cells.drawing/autoshapetype/
is_root: false
---
...
El tipo AutoShapeType expone los siguientes miembros:
...
| HORIZONTAL_SCROLL |  |
| CIRCULAR_ARROW |  |
| NOTCHED_CIRCULAR_ARROW | Un valor que NO DEBE utilizarse.|
| U_TURN_ARROW |  |
| CURVED_RIGHT_ARROW |  |
| CURVED_LEFT_ARROW |  |
| CURVED_UP_ARROW |  |
...
| SOUND_ACTION_BUTTON |  |
| MOVIE_ACTION_BUTTON |  |
| HOST_CONTROL | Este valor NO DEBE utilizarse.|
| TEXT_BOX |  |
| HEPTAGON |  |
| DECAGON |  |
| DODECAGON |  |
