---
title: ReflectionEffectType enumeración
second_title: Aspose.Cells for Python via .NET API Referencias
description:
type: docs
weight: 1120
url: /es/python-net/aspose.cells.drawing/reflectioneffecttype/
is_root: false
---
##  ReflectionEffectType enumeración
Representa el tipo de efecto de la reflexión.



El tipo ReflectionEffectType expone los siguientes miembros:

###  Campos
| Campo| Descripción|
| :- | :- |
| NONE | Sin efecto de reflexión.|
| CUSTOM | Efecto de reflejo personalizado.|
