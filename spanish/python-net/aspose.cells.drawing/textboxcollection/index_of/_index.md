...
type: docs
weight: 50
url: /es/python-net/aspose.cells.drawing/textboxcollection/index_of/
is_root: false
---
##  index_of(item, index) {#TextBox-int}
...
##  index_of(item, index, count) {#TextBox-int-int}
...
* clase [TextBoxCollection](/cells/es/python-net/aspose.cells.drawing/textboxcollection)
