---
title: TextOverflowType enumeración
second_title: Aspose.Cells for Python via .NET API Referencias
description:
type: docs
weight: 1170
url: /es/python-net/aspose.cells.drawing/textoverflowtype/
is_root: false
---
##  TextOverflowType enumeración
Representa la forma en que el texto se desborda vertical u horizontalmente.



El tipo TextOverflowType expone los siguientes miembros:
