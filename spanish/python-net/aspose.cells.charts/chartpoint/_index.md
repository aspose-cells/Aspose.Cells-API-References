---
title: ChartPoint clase
second_title: Aspose.Cells for Python via .NET API Referencias
description:
type: docs
weight: 90
url: /es/python-net/aspose.cells.charts/chartpoint/
is_root: false
---
##  ChartPoint clase
...
| :- | :- |
| [explosion](/cells/es/python-net/aspose.cells.charts/chartpoint/explosion) | La distancia de un sector circular abierto desde el centro del gráfico circular se expresa como un porcentaje del diámetro circular.|
| [shadow](/cells/es/python-net/aspose.cells.charts/chartpoint/shadow) | True si el punto de gráfico tiene una sombra.|
| [border](/cells/es/python-net/aspose.cells.charts/chartpoint/border) | Obtiene el [Line](/cells/es/python-net/aspose.cells.drawing/line).|
| [area](/cells/es/python-net/aspose.cells.charts/chartpoint/area) | Obtiene el [ChartPoint.area](/cells/es/python-net/aspose.cells.charts/chartpoint#area).|
...
| [inner_radius_px](/cells/es/python-net/aspose.cells.charts/chartpoint/inner_radius_px) | Obtiene el radio interior del segmento de dona en unidades de píxeles después de llamar al método Chart.Calculate().<br/> Se aplica al gráfico de anillos.|
...
| Método| Descripción|
| :- | :- |
| [get_top_point_count()](/cells/es/python-net/aspose.cells.charts/chartpoint/get_top_point_count/#) | Obtiene el número de puntos principales después de llamar al método Chart.Calculate().|
| [get_top_point_x_px(index)](/cells/es/python-net/aspose.cells.charts/chartpoint/get_top_point_x_px/#int) | Obtiene la coordenada x del punto superior de la forma después de llamar al método Chart.Calculate().<br/> Aplica gráficos 3D: Column3D, Bar3D, Cono, Cilindro, Pirámide y Area3D|
| [get_top_point_y_px(index)](/cells/es/python-net/aspose.cells.charts/chartpoint/get_top_point_y_px/#int) | Obtiene la coordenada y del punto superior de la forma después de llamar al método Chart.Calculate().<br/> Aplica gráficos 3D: Column3D, Bar3D, Cono, Cilindro, Pirámide y Area3D|
