...
type: docs
weight: 130
url: /es/python-net/aspose.cells.charts/chart/to_pdf/
is_root: false
---
...
| h_alignment_type | [PageLayoutAlignmentType](/cells/es/python-net/aspose.cells/pagelayoutalignmenttype) | El tipo de alineación horizontal del gráfico en la página de salida.|
| v_alignment_type | [PageLayoutAlignmentType](/cells/es/python-net/aspose.cells/pagelayoutalignmenttype) | El tipo de alineación vertical del gráfico en la página de salida.|
