...
type: docs
weight: 10
url: /es/python-net/aspose.cells.charts/axis/
is_root: false
---
##  Axis clase
...
| :- | :- |
| [area](/cells/es/python-net/aspose.cells.charts/axis/area) | Obtiene el [Axis.area](/cells/es/python-net/aspose.cells.charts/axis#area).|
| [is_automatic_min_value](/cells/es/python-net/aspose.cells.charts/axis/is_automatic_min_value) | Indica si el valor mínimo se asigna automáticamente.|
| [min_value](/cells/es/python-net/aspose.cells.charts/axis/min_value) | Representa el valor mínimo en el eje de valores.|
| [is_automatic_max_value](/cells/es/python-net/aspose.cells.charts/axis/is_automatic_max_value) | Indica si el valor máximo se asigna automáticamente.|
| [max_value](/cells/es/python-net/aspose.cells.charts/axis/max_value) | Representa el valor máximo en el eje de valores.|
| [is_automatic_major_unit](/cells/es/python-net/aspose.cells.charts/axis/is_automatic_major_unit) | Indica si la unidad principal del eje se asigna automáticamente.|
| [major_unit](/cells/es/python-net/aspose.cells.charts/axis/major_unit) |Representa las unidades principales del eje.|
| [is_automatic_minor_unit](/cells/es/python-net/aspose.cells.charts/axis/is_automatic_minor_unit) | Indica si la unidad menor del eje se asigna automáticamente.|
| [minor_unit](/cells/es/python-net/aspose.cells.charts/axis/minor_unit) | Representa las unidades menores del eje.|
| [axis_line](/cells/es/python-net/aspose.cells.charts/axis/axis_line) | Obtiene la apariencia de un Eje.|
| [major_tick_mark](/cells/es/python-net/aspose.cells.charts/axis/major_tick_mark) | Representa el tipo de marca de graduación principal para el eje especificado.|
| [minor_tick_mark](/cells/es/python-net/aspose.cells.charts/axis/minor_tick_mark) | Representa el tipo de marca de graduación menor para el eje especificado.|
...
| [display_unit_label](/cells/es/python-net/aspose.cells.charts/axis/display_unit_label) | Representa una etiqueta de unidad en un eje en el gráfico especificado.<br/> Las etiquetas de unidades son útiles para graficar valores grandes, por ejemplo, en millones o miles de millones.|
| [is_display_unit_label_shown](/cells/es/python-net/aspose.cells.charts/axis/is_display_unit_label_shown) | Representa si la etiqueta de la unidad de visualización se muestra en el eje especificado.|
| [title](/cells/es/python-net/aspose.cells.charts/axis/title) | Obtiene el título del eje.|
| [category_type](/cells/es/python-net/aspose.cells.charts/axis/category_type) | Representa el tipo de eje de categoría.|
| [base_unit_scale](/cells/es/python-net/aspose.cells.charts/axis/base_unit_scale) | Representa la escala de la unidad base para el eje de categorías.|
| [major_unit_scale](/cells/es/python-net/aspose.cells.charts/axis/major_unit_scale) | Representa la escala de unidad principal para el eje de categorías.|
| [minor_unit_scale](/cells/es/python-net/aspose.cells.charts/axis/minor_unit_scale) | Representa la escala de unidad principal para el eje de categorías.|
| [is_visible](/cells/es/python-net/aspose.cells.charts/axis/is_visible) | Representa si el eje es visible.|
| [major_grid_lines](/cells/es/python-net/aspose.cells.charts/axis/major_grid_lines) | Representa las principales líneas de cuadrícula en un eje de gráfico.|
