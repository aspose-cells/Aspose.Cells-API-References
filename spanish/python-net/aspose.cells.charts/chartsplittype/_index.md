---
title: ChartSplitType enumeración
second_title: Aspose.Cells for Python via .NET API Referencias
description:
type: docs
weight: 430
url: /es/python-net/aspose.cells.charts/chartsplittype/
is_root: false
---
...
El tipo ChartSplitType expone los siguientes miembros:
...
| AUTO | Representa que los puntos de datos se dividirán usando el valor predeterminado<br/> mecanismo para este tipo de gráfico.|
