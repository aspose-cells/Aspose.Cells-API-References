---
title: SeriesLayoutProperties clase
second_title: Aspose.Cells for Python via .NET API Referencias
description:
type: docs
weight: 250
url: /es/python-net/aspose.cells.charts/serieslayoutproperties/
is_root: false
---
##  SeriesLayoutProperties clase
Representa las propiedades del diseño de la serie.



El tipo SeriesLayoutProperties expone los siguientes miembros:

###  Constructores
| Constructor| Descripción|
| :- | :- |
| [SeriesLayoutProperties()](/cells/es/python-net/aspose.cells.charts/serieslayoutproperties/__init__/#) | Construye una nueva instancia de SeriesLayoutProperties|


###  Propiedades
| Propiedad| Descripción|
| :- | :- |
| [show_connector_lines](/cells/es/python-net/aspose.cells.charts/serieslayoutproperties/show_connector_lines) | Indica si se muestran líneas de conexión entre puntos de datos.|
...
| [map_chart_region_type](/cells/es/python-net/aspose.cells.charts/serieslayoutproperties/map_chart_region_type) | Obtiene y establece el tipo de región del mapa.|
| [map_chart_projection_type](/cells/es/python-net/aspose.cells.charts/serieslayoutproperties/map_chart_projection_type) | Obtiene y establece el tipo de proyección del mapa.|
