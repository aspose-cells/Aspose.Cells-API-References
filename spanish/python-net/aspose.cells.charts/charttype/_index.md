---
title: ChartType enumeración
second_title: Aspose.Cells for Python via .NET API Referencias
description:
type: docs
weight: 450
url: /es/python-net/aspose.cells.charts/charttype/
is_root: false
---
##  ChartType enumeración
Enumera todos los tipos de gráficos utilizados en Excel.



El tipo ChartType expone los siguientes miembros:
...
| BUBBLE | Representa el gráfico de burbujas.|
| BUBBLE_3D | Representa el gráfico de burbujas 3D.|
| COLUMN | Representa Gráfico de columnas: Gráfico de columnas agrupadas.|
| COLUMN_STACKED | Representa el gráfico de columnas apiladas.|
| COLUMN_100_PERCENT_STACKED | Representa un gráfico de columnas apiladas al 100 %.|
| COLUMN_3D | Representa el gráfico de columnas 3D.|
| COLUMN_3D_CLUSTERED | Representa el gráfico de columnas agrupadas en 3D.|
| COLUMN_3D_STACKED | Representa el gráfico de columnas apiladas en 3D.|
| COLUMN_3D100_PERCENT_STACKED | Representa un gráfico de columnas apiladas al 100 % en 3D.|
| CONE | Representa el gráfico de conos.|
| CONE_STACKED | Representa el gráfico de conos apilados.|
| CONE_100_PERCENT_STACKED | Representa un gráfico de conos apilados al 100 %.|
...
| DOUGHNUT_EXPLODED | Representa el gráfico de anillos expandido.|
| LINE | Representa el gráfico de líneas.|
| LINE_STACKED | Representa el gráfico de líneas apiladas.|
| LINE_100_PERCENT_STACKED | Representa un gráfico de líneas apiladas al 100 %.|
| LINE_WITH_DATA_MARKERS | Representa el gráfico de líneas con marcadores de datos.|
| LINE_STACKED_WITH_DATA_MARKERS | Representa el gráfico de líneas apiladas con marcadores de datos.|
...
| PYRAMID_100_PERCENT_STACKED | Representa un gráfico piramidal 100 % apilado.|
...
| SCATTER_CONNECTED_BY_CURVES_WITH_DATA_MARKER | Representa el gráfico de dispersión conectado por curvas, con marcadores de datos.|
| SCATTER_CONNECTED_BY_CURVES_WITHOUT_DATA_MARKER | Representa el gráfico de dispersión conectado por curvas, sin marcadores de datos.|
...
| SURFACE_WIREFRAME_3D | Representa el gráfico de superficie 3D de estructura alámbrica.|
| SURFACE_CONTOUR | Representa el gráfico de contorno.|
| SURFACE_CONTOUR_WIREFRAME | Representa el gráfico de contorno de estructura alámbrica.|
