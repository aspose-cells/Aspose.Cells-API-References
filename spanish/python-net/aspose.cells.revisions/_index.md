...
type: docs
weight: 10
url: /es/python-net/aspose.cells.revisions/
is_root: false
---
 El**Aspose.Cells.Revisions** El espacio de nombres proporciona clases para acceder a las revisiones de los archivos de hoja de cálculo de Excel.

###  Clases
| Clase| Descripción|
| :- | :- |
| [Revision](/cells/es/python-net/aspose.cells.revisions/revision) | Representa la revisión.|
| [RevisionAutoFormat](/cells/es/python-net/aspose.cells.revisions/revisionautoformat) | representa un registro de revisión de información sobre un cambio de formato.|
| [RevisionCellChange](/cells/es/python-net/aspose.cells.revisions/revisioncellchange) | Representa la revisión que cambia de celdas.|
| [RevisionCellComment](/cells/es/python-net/aspose.cells.revisions/revisioncellcomment) | Representa un registro de revisión de un cambio de comentario de celda.|
...
| [RevisionRenameSheet](/cells/es/python-net/aspose.cells.revisions/revisionrenamesheet) | Representa una revisión de la hoja de cambio de nombre.|
