---
title: DrawObject clase
second_title: Aspose.Cells for Python via .NET API Referencias
description:
type: docs
weight: 10
url: /es/python-net/aspose.cells.rendering/drawobject/
is_root: false
---
##  DrawObject clase
...
El tipo DrawObject expone los siguientes miembros:
...
| [sheet_index](/cells/es/python-net/aspose.cells.rendering/drawobject/sheet_index) | Indica el índice de hoja actual de DrawObject.|
