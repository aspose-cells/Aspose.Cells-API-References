...
type: docs
weight: 9900
url: /es/cpp/aspose.cells/cells/copyrows/
---
...
```cpp
void Aspose::Cells::Cells::CopyRows(const Cells &sourceCells, int32_t sourceRowIndex, int32_t destinationRowIndex, int32_t rowNumber, const CopyOptions &copyOptions)
```
