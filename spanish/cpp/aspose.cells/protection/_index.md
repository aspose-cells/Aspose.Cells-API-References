...
type: docs
weight: 12200
url: /es/cpp/aspose.cells/protection/
---
## Protection class
...
//Permitiendo a los usuarios seleccionar celdas bloqueadas de la hoja de cálculo
worksheet.GetProtection().SetAllowSelectingLockedCell(true);
//Permitiendo a los usuarios seleccionar celdas desbloqueadas de la hoja de cálculo
