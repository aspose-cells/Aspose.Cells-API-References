...
type: docs
weight: 14400
url: /es/cpp/aspose.cells/systemtimeinterruptmonitor/
---
...
//El siguiente ejemplo muestra cómo monitorizar el procedimiento de carga y guardado con un límite de tiempo especificado:
...
//si el tiempo de carga del archivo de plantilla supera un segundo, se requerirá una interrupción y se lanzará una excepción aquí
//de lo contrario, comienza a monitorizar el procedimiento de guardado
