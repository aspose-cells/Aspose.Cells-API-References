---
title: Aspose::Cells::ProtectedRangeCollection::Add method
linktitle: Add
second_title: Aspose.Cells for C++ API Reference
description: 'Aspose::Cells::ProtectedRangeCollection::Add method. Adds a ProtectedRange item to the collection in C++.'
type: docs
weight: 700
url: /es/cpp/aspose.cells/protectedrangecollection/add/
---
...
| --- | --- | --- |
| name | const U16String\& | [Range](../../range/) title. This is used as a descriptor, not as a named range definition. |
...
| Parameter | Type | Description |
| --- | --- | --- |
| name | const char16_t* | [Range](../../range/) title. This is used as a descriptor, not as a named range definition. |
| startRow | int32_t | Start row index of the range. |
| startColumn | int32_t | Start column index of the range. |
| endRow | int32_t | End row index of the range. |
| endColumn | int32_t | End column index of the range. |
