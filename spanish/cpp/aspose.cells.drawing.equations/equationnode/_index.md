...
type: docs
weight: 800
url: /es/cpp/aspose.cells.drawing.equations/equationnode/
---
## EquationNode class
...
// Agrega un objeto de ecuación a la hoja de cálculo.
TextBox textBox = workbook.GetWorksheets().Get(0).GetShapes().AddEquation(1, 0, 1, 0, 100, 300);

// Obtiene el nodo inicial del objeto de ecuación
EquationNode mathNode = textBox.GetEquationParagraph().GetChild(0);

// Inserta una ecuación fraccionaria.
