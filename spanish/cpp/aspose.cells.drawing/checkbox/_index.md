---
title: Aspose::Cells::Drawing::CheckBox class
linktitle: CheckBox
second_title: Aspose.Cells for C++ API Reference
description: 'Aspose::Cells::Drawing::CheckBox class. Represents a check box object in a worksheet in C++.'
type: docs
weight: 900
url: /es/cpp/aspose.cells.drawing/checkbox/
---
## CheckBox class
...
```cpp
class CheckBox : public Aspose::Cells::Drawing::Shape
```
...
| [operator=(const CheckBox\& src)](./operator_asm/) | operator= |
...
| [SetValue(bool value)](./setvalue/) | Indicates if the checkbox is checked or not. |
