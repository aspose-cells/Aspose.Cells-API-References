---
title: Aspose::Cells::Drawing::ArcShape class
linktitle: ArcShape
second_title: Aspose.Cells for C++ API Reference
description: 'Aspose::Cells::Drawing::ArcShape class. Represents the arc shape in C++.'
type: docs
weight: 100
url: /es/cpp/aspose.cells.drawing/arcshape/
---
## ArcShape class
...
```cpp
class ArcShape : public Aspose::Cells::Drawing::Shape
```
...
| [ArcShape(ArcShape_Impl* impl)](./arcshape/) | Constructs from an implementation object. |
| [ArcShape(const ArcShape\& src)](./arcshape/) | Copy constructor. |
| [ArcShape(const Shape\& src)](./arcshape/) | Constructs from a parent object. |
...
| [operator=(const ArcShape\& src)](./operator_asm/) | operator= |
...
arc1.GetLine().GetSolidFill().SetColor(Color{ 0xff, 0xff, 0, 0 });
...
arc2.GetLine().GetSolidFill().SetColor(Color{ 0xff, 0, 0, 0xff });

//Establecer el estilo de guión del arco.
arc2.GetLine().SetDashStyle(MsoLineDashStyle::Solid);

//Guarde el archivo de Excel.
excelbook.Save(u"tstarcs.xls");
