...
type: docs
weight: 14600
url: /es/cpp/aspose.cells.drawing/shape/setlinkedcell/
---
...
```cpp
//Después de ejecutar el código a continuación, se crea un objeto ScrollBar en el archivo generado. Al arrastrar el control deslizante, el valor se muestra en la celda A12.
