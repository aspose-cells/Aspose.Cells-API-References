...
type: docs
weight: 5200
url: /es/cpp/aspose.cells.drawing/shape/setislocked/
---
...
```cpp
//Establece la forma especificada en estado desbloqueado
if (shape.GetWorksheet().IsProtected() && shape.IsLocked())
{
    shape.SetIsLocked(false);
}

//Establece la forma especificada en un estado bloqueado
if (shape.GetWorksheet().IsProtected() && !shape.IsLocked())
{
