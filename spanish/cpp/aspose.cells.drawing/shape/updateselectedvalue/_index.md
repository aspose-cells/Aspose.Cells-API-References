...
type: docs
weight: 14900
url: /es/cpp/aspose.cells.drawing/shape/updateselectedvalue/
---
...
//Actualizar el valor seleccionado con el valor de la celda vinculada.
listBox.UpdateSelectedValue();

//-1 predeterminado, ninguna opción seleccionada
if (listbx.IsSelected(2))
{
    //La opción 3 del ListBox está seleccionada
}
...
{
    //La opción 4 del ListBox está seleccionada
}
```
