...
type: docs
weight: 6700
url: /es/cpp/aspose.cells.drawing/textbox/
---
## TextBox class
...
//Configura el cuadro de texto para ajustarlo según su contenido.
...
//Obtén el segundo cuadro de texto.
TextBox textbox1 = worksheet.GetTextBoxes().Get(textboxIndex);
//Introduce algo de texto en él.
textbox1.SetText(u"This is another simple text box");
//Establece el tipo de ubicación ya que el cuadro de texto se moverá y
//cambiará de tamaño con las celdas.
