...
description: Une collection deCustomProperty./customproperty objets qui représentent des informations supplémentaires.
type: docs
weight: 4850
url: /fr/net/aspose.cells.properties/custompropertycollection/
---
## CustomPropertyCollection class

Une collection de[`CustomProperty`](../customproperty) objets qui représentent des informations supplémentaires.
...
| [Item](../../aspose.cells.properties/custompropertycollection/item) { get; } | Obtient la propriété personnalisée par l'index spécifique. (2 indexers) |
...
| Nom | La description |
| --- | --- |
| [Add](../../aspose.cells.properties/custompropertycollection/add)(string, string) | Ajoute des informations de propriété personnalisées. |
