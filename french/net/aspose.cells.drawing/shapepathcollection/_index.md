...
description: Représente les informations de collection de chemin dans NotPrimitive autoshape
type: docs
weight: 2700
url: /fr/net/aspose.cells.drawing/shapepathcollection/
---
## ShapePathCollection class

Représente les informations de collection de chemin dans NotPrimitive autoshape
...
| [Count](../../aspose.cells.drawing/shapepathcollection/count) { get; } | Obtient le nombre de chemins |
| [Item](../../aspose.cells.drawing/shapepathcollection/item) { get; } | Obtient un chemin de création. |
...
| Nom | La description |
| --- | --- |
| [Add](../../aspose.cells.drawing/shapepathcollection/add)() | Ajouter un chemin de création. |
