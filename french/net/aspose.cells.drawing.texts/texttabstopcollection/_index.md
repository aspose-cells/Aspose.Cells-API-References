...
description: Représente la liste de tous les taquets de tabulation.
type: docs
weight: 3030
url: /fr/net/aspose.cells.drawing.texts/texttabstopcollection/
---
...
| [Item](../../aspose.cells.drawing.texts/texttabstopcollection/item) { get; } | Obtient[`TextTabStop`](../texttabstop) par l'index. |
...
| Nom | La description |
| --- | --- |
| [Add](../../aspose.cells.drawing.texts/texttabstopcollection/add)(TextTabAlignmentType, double) | Ajoute un taquet de tabulation. |
