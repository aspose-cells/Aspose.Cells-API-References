...
description: Représente la liste du volet des tâches.
type: docs
weight: 6470
url: /fr/net/aspose.cells.webextensions/webextensiontaskpanecollection/
---
## WebExtensionTaskPaneCollection class

Représente la liste du volet des tâches.
...
| [Item](../../aspose.cells.webextensions/webextensiontaskpanecollection/item) { get; } | Obtient le volet des tâches par l'index spécifique. |
...
| Nom | La description |
| --- | --- |
| [Add](../../aspose.cells.webextensions/webextensiontaskpanecollection/add)() | Ajoute un volet de tâches. |
