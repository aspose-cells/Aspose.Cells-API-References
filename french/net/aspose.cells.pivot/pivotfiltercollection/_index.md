...
description: Représente une collection de tous les objets PivotFilter
type: docs
weight: 4590
url: /fr/net/aspose.cells.pivot/pivotfiltercollection/
---
...
| [Item](../../aspose.cells.pivot/pivotfiltercollection/item) { get; } | Obtient l'objet pivotfilter à l'index spécifique. |
...
| Nom | La description |
| --- | --- |
| [Add](../../aspose.cells.pivot/pivotfiltercollection/add)(int, PivotFilterType) | Ajoute un objet PivotFilter au type spécifique |
...
| [ClearFilter](../../aspose.cells.pivot/pivotfiltercollection/clearfilter)(int) | Effacer PivotFilter du PivotField spécifique |
