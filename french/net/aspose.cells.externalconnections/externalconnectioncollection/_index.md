...
description: Spécifie leExternalConnection./externalconnection collection
type: docs
weight: 3300
url: /fr/net/aspose.cells.externalconnections/externalconnectioncollection/
---
## ExternalConnectionCollection class

Spécifie le[`ExternalConnection`](../externalconnection) collection
...
| [Item](../../aspose.cells.externalconnections/externalconnectioncollection/item) { get; set; } | Obtient le[`ExternalConnection`](../externalconnection) élément à l'index spécifié. (2 indexers) |
| [Item](../../aspose.cells.externalconnections/externalconnectioncollection/item) { get; } | Obtient le[`ExternalConnection`](../externalconnection) élément avec le nom spécifié. |
...
| [GetExternalConnectionById](../../aspose.cells.externalconnections/externalconnectioncollection/getexternalconnectionbyid)(int) | Obtient le[`ExternalConnection`](../externalconnection) élément avec l'identifiant spécifié. |
...
for (int i = 0; i < dataConns.Count; i++)
{
    ...
    // obtenir l'identifiant de connexion externe
...
For i = 0 To count Step 1
    dataConn = dataConns(i)
    'obtenir un identifiant de connexion externe
    Console.WriteLine(dataConn.ConnectionId)
Next
```
