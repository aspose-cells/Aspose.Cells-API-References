...
description: Spécifie leConnectionParameter./connectionparameter collection
type: docs
weight: 3250
url: /fr/net/aspose.cells.externalconnections/connectionparametercollection/
---
## ConnectionParameterCollection class

Spécifie le[`ConnectionParameter`](../connectionparameter) collection
...
| [Item](../../aspose.cells.externalconnections/connectionparametercollection/item) { get; set; } | Obtient le[`ConnectionParameter`](../connectionparameter) élément à l'index spécifié. (2 indexers) |
| [Item](../../aspose.cells.externalconnections/connectionparametercollection/item) { get; } | Obtient le[`ConnectionParameter`](../connectionparameter) élément avec le nom spécifié. |
