...
description: Représente toutes les formules de requête de puissance dans les données de mashup.
type: docs
weight: 4970
url: /fr/net/aspose.cells.querytables/powerqueryformulacollection/
---
## PowerQueryFormulaCollection class

Représente toutes les formules de requête de puissance dans les données de mashup.
...
| [Item](../../aspose.cells.querytables/powerqueryformulacollection/item) { get; } | Obtient[`PowerQueryFormula`](../powerqueryformula) par l'index dans la liste. (2 indexers) |
