...
description: Spécifie la collection de tous les objets Slicer sur la feuille de calcul spécifiée.
type: docs
weight: 5690
url: /fr/net/aspose.cells.slicers/slicercollection/
---
...
| [Item](../../aspose.cells.slicers/slicercollection/item) { get; } | Obtient le Slicer par index. (2 indexers) |
...
| Nom | La description |
| --- | --- |
| [Add](../../aspose.cells.slicers/slicercollection/add#add_8)(ListObject, int, string) | Ajouter un nouveau Slicer en utilisant ListObjet comme source de données |
| [Add](../../aspose.cells.slicers/slicercollection/add#add_7)(ListObject, ListColumn, string) | Ajouter un nouveau Slicer en utilisant ListObjet comme source de données |
| [Add](../../aspose.cells.slicers/slicercollection/add#add_4)(PivotTable, string, int) | Ajouter un nouveau segment en utilisant le tableau croisé dynamique comme source de données |
| [Add](../../aspose.cells.slicers/slicercollection/add#add_3)(PivotTable, string, PivotField) | Ajouter un nouveau segment en utilisant le tableau croisé dynamique comme source de données |
| [Add](../../aspose.cells.slicers/slicercollection/add#add_5)(PivotTable, string, string) | Ajouter un nouveau segment en utilisant le tableau croisé dynamique comme source de données |
| [Add](../../aspose.cells.slicers/slicercollection/add#add_6)(ListObject, ListColumn, int, int) | Ajouter un nouveau Slicer en utilisant ListObjet comme source de données |
| [Add](../../aspose.cells.slicers/slicercollection/add#add_1)(PivotTable, int, int, int) | Ajouter un nouveau segment en utilisant le tableau croisé dynamique comme source de données |
| [Add](../../aspose.cells.slicers/slicercollection/add#add)(PivotTable, int, int, PivotField) | Ajouter un nouveau segment en utilisant le tableau croisé dynamique comme source de données |
| [Add](../../aspose.cells.slicers/slicercollection/add#add_2)(PivotTable, int, int, string) | Ajouter un nouveau segment en utilisant le tableau croisé dynamique comme source de données |
...
| [Remove](../../aspose.cells.slicers/slicercollection/remove)(Slicer) | Supprimer le Slicer spécifié |
| [RemoveAt](../../aspose.cells.slicers/slicercollection/removeat#removeat)(int) | Supprime le Slicer à l'index spécifié (2 methods) |
