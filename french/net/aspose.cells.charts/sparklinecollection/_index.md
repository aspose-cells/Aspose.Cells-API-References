...
description: Encapsule une collection deSparkline./sparkline objets.
type: docs
weight: 870
url: /fr/net/aspose.cells.charts/sparklinecollection/
---
## SparklineCollection class

Encapsule une collection de[`Sparkline`](../sparkline) objets.
...
| [Item](../../aspose.cells.charts/sparklinecollection/item) { get; } | Obtient le[`Sparkline`](../sparkline) élément à l'index spécifié. |
...
| Nom | La description |
| --- | --- |
| [Add](../../aspose.cells.charts/sparklinecollection/add)(string, int, int) | Ajouter un sparkline. |
...
| [Remove](../../aspose.cells.charts/sparklinecollection/remove)(object) | Supprime le sparkline |
