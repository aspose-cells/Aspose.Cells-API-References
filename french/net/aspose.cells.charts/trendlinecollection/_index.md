...
description: Représente une collection de tous lesTrendline./trendline objets pour la série de données spécifiée.
type: docs
weight: 990
url: /fr/net/aspose.cells.charts/trendlinecollection/
---
## TrendlineCollection class

Représente une collection de tous les[`Trendline`](../trendline) objets pour la série de données spécifiée.
...
| [Item](../../aspose.cells.charts/trendlinecollection/item) { get; } | Obtient un objet par son index. |
...
| Nom | La description |
| --- | --- |
| [Add](../../aspose.cells.charts/trendlinecollection/add#add)(TrendlineType) | Ajoute un objet à cette collection avec le type spécifié. |
| [Add](../../aspose.cells.charts/trendlinecollection/add#add_1)(TrendlineType, string) | Ajoute un objet à cette collection avec le type et le nom spécifiés. |
