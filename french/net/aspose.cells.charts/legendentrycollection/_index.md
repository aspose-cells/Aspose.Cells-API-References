...
description: Représente une collection de tous lesLegendEntry./legendentry objets dans la légende du graphique spécifié.
type: docs
weight: 710
url: /fr/net/aspose.cells.charts/legendentrycollection/
---
## LegendEntryCollection class

Représente une collection de tous les[`LegendEntry`](../legendentry) objets dans la légende du graphique spécifié.
...
| [Item](../../aspose.cells.charts/legendentrycollection/item) { get; } | Obtient le[`LegendEntry`](../legendentry) élément à l'index spécifié. |
