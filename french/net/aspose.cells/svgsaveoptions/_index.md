...
description: Représente les options de sauvegarde Svg
type: docs
weight: 5790
url: /fr/net/aspose.cells/svgsaveoptions/
---
## SvgSaveOptions class

Représente les options de sauvegarde Svg
...
| Nom | La description |
| --- | --- |
| [SvgSaveOptions](svgsaveoptions#constructor)() | Crée les options d'enregistrement du fichier svg. |
| [SvgSaveOptions](svgsaveoptions#constructor_1)(SaveFormat) | Crée les options d'enregistrement du fichier svg. |
...
| [SheetIndex](../../aspose.cells/svgsaveoptions/sheetindex) { get; set; } | Récupère et définit la feuille de calcul à exporter. Si la valeur est -1, la feuille de calcul active sera exportée. |
