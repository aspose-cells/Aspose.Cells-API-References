...
description: Représente la liste des cellules dentrée du scénario.
type: docs
weight: 5600
url: /fr/net/aspose.cells/scenarioinputcellcollection/
---
...
| [Item](../../aspose.cells/scenarioinputcellcollection/item) { get; } | Obtient[`ScenarioInputCell`](../scenarioinputcell) par index dans la liste. |
...
| Nom | La description |
| --- | --- |
| [Add](../../aspose.cells/scenarioinputcellcollection/add)(int, int, string) | Ajoute une cellule d'entrée. |
