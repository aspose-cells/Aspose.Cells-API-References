...
description: Représente les options denregistrement pour le format de fichier Excel 97-2003  xls et xlt.
type: docs
weight: 6540
url: /fr/net/aspose.cells/xlssaveoptions/
---
...
| Nom | La description |
| --- | --- |
| [XlsSaveOptions](xlssaveoptions#constructor)() | Crée des options pour enregistrer le fichier Excel 97-2003 xls/xlt. |
| [XlsSaveOptions](xlssaveoptions#constructor_1)(SaveFormat) | Crée des options pour enregistrer le fichier Excel 97-2003 xls/xlt. |
...
| [IsTemplate](../../aspose.cells/xlssaveoptions/istemplate) { get; set; } | Indique si l'enregistrement d'un fichier modèle. |
| [LightCellsDataProvider](../../aspose.cells/xlssaveoptions/lightcellsdataprovider) { get; set; } | Le fournisseur de données pour fournir des données de cellules pour enregistrer le classeur en mode léger. |
| [MatchColor](../../aspose.cells/xlssaveoptions/matchcolor) { get; set; } | Indique si la couleur de la police correspond car il y a 56 couleurs dans la palette de couleurs standard. |
