...
description: Une collection deXmlMap./xmlmap objets qui représentent des informations XmlMap.
type: docs
weight: 6600
url: /fr/net/aspose.cells/xmlmapcollection/
---
## XmlMapCollection class

Une collection de[`XmlMap`](../xmlmap) objets qui représentent des informations XmlMap.
...
| [Item](../../aspose.cells/xmlmapcollection/item) { get; } | Obtient la carte xml par l'index spécifique. |
...
| Nom | La description |
| --- | --- |
| [Add](../../aspose.cells/xmlmapcollection/add)(string) | Ajouter un[`XmlMap`](../xmlmap) par l'url/chemin d'un fichier xml/xsd. |
...
| [Clear](../../aspose.cells/xmlmapcollection/clear#clear)() | Supprime tous les XmlMaps. (2 methods) |
