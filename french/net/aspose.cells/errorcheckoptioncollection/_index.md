...
description: Représente toutes les options de vérification des erreurs.
type: docs
weight: 3180
url: /fr/net/aspose.cells/errorcheckoptioncollection/
---
...
| [Item](../../aspose.cells/errorcheckoptioncollection/item) { get; } | Obtient[`ErrorCheckOption`](../errorcheckoption) objet par l'index donné. |
...
| Nom | La description |
| --- | --- |
| [Add](../../aspose.cells/errorcheckoptioncollection/add)() | Ajouter une option de vérification des erreurs. |
