...
description: Représente la liste des scénarios.
type: docs
weight: 5580
url: /fr/net/aspose.cells/scenariocollection/
---
...
| Nom | La description |
| --- | --- |
| [ActiveIndex](../../aspose.cells/scenariocollection/activeindex) { get; set; } | Obtient et définit le scénario sélectionné. |
| [Capacity](../../aspose.cells/collectionbase`1/capacity) { get; set; } |  |
| [Count](../../aspose.cells/collectionbase`1/count) { get; } |  |
| [Item](../../aspose.cells/scenariocollection/item) { get; } | Obtient le[`Scenario`](../scenario) objet par l'index. |
| [Item](../../aspose.cells/collectionbase`1/item) { get; set; } |  |
| [LastSelected](../../aspose.cells/scenariocollection/lastselected) { get; set; } | Indique quel scénario a été sélectionné en dernier par l'utilisateur pour être exécuté/affiché. |

## Méthodes

| Nom | La description |
| --- | --- |
| [Add](../../aspose.cells/scenariocollection/add)(string) | Ajoute un scénario. |
