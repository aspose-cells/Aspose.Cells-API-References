...
description: Représente les options de chargement de xml.
type: docs
weight: 6580
url: /fr/net/aspose.cells/xmlloadoptions/
---
...
| Nom | La description |
| --- | --- |
| [XmlLoadOptions](xmlloadoptions#constructor)() | Représente les options de chargement du fichier ods. |
| [XmlLoadOptions](xmlloadoptions#constructor_1)(LoadFormat) | Représente les options de chargement du fichier ods. |
...
| [ContainsMultipleWorksheets](../../aspose.cells/xmlloadoptions/containsmultipleworksheets) { get; set; } | Indique si l'importation de xml en tant que plusieurs feuilles de calcul. |
...
| [IsXmlMap](../../aspose.cells/xmlloadoptions/isxmlmap) { get; set; } | Indique si le mappage xml vers Excel. La valeur par défaut est false. |
...
| [StartCell](../../aspose.cells/xmlloadoptions/startcell) { get; set; } | Obtient et définit la cellule de départ. |
