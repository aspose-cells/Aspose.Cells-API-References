...
description: Représente les champs dODS.
type: docs
weight: 4260
url: /fr/net/aspose.cells.ods/odscellfieldcollection/
---
...
| [Item](../../aspose.cells.ods/odscellfieldcollection/item) { get; } | Obtient le champ par l'index. (2 indexers) |
...
| Nom | La description |
| --- | --- |
| [Add](../../aspose.cells.ods/odscellfieldcollection/add)(int, int, OdsCellFieldType, string) | Ajoute un champ. |
...
| [UpdateFieldsValue](../../aspose.cells.ods/odscellfieldcollection/updatefieldsvalue)() | Mettre à jour la valeur des champs dans les cellules. |
