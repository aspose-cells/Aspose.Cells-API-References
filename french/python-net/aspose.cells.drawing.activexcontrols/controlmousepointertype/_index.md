---
title: ControlMousePointerType dénombrement
second_title: Aspose.Cells for Python via .NET API Références
description:
type: docs
weight: 200
url: /fr/python-net/aspose.cells.drawing.activexcontrols/controlmousepointertype/
is_root: false
---
##  ControlMousePointerType dénombrement
Représente le type d'icône affichée comme pointeur de souris pour le contrôle.



Le type ControlMousePointerType expose les membres suivants :
...
| SIZE_NWSE | Double flèche pointant vers le nord-ouest et le sud-est.|
| SIZE_WE | Double flèche pointant vers l'ouest et l'est.|
