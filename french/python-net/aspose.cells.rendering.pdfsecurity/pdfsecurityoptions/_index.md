...
type: docs
weight: 10
url: /fr/python-net/aspose.cells.rendering.pdfsecurity/pdfsecurityoptions/
is_root: false
---
...
| :- | :- |
| [PdfSecurityOptions()](/cells/fr/python-net/aspose.cells.rendering.pdfsecurity/pdfsecurityoptions/__init__/#) | Le constructeur de PdfSecurityOptions|
...
| [assemble_document_permission](/cells/fr/python-net/aspose.cells.rendering.pdfsecurity/pdfsecurityoptions/assemble_document_permission) | Autorisation d'insérer, de faire pivoter ou de supprimer des pages et de créer des signets ou des images miniatures même si ModifyDocumentPermission n'est pas défini.|
| [full_quality_print_permission](/cells/fr/python-net/aspose.cells.rendering.pdfsecurity/pdfsecurityoptions/full_quality_print_permission) | Autorisation d'imprimer en haute qualité.|
