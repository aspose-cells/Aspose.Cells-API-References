...
type: docs
weight: 10
url: /fr/python-net/aspose.cells.properties/builtindocumentpropertycollection/
is_root: false
---
##  BuiltInDocumentPropertyCollection classe
Une collection de propriétés de document intégrées.



**Héritage:** [BuiltInDocumentPropertyCollection](/cells/python-net/aspose.cells.properties/builtindocumentpropertycollection) → 
[DocumentPropertyCollection](/cells/fr/python-net/aspose.cells.properties/documentpropertycollection)



Le type BuiltInDocumentPropertyCollection expose les membres suivants :
...
| [characters](/cells/fr/python-net/aspose.cells.properties/builtindocumentpropertycollection/characters) | Représente une estimation du nombre de caractères dans le document.|
| [characters_with_spaces](/cells/fr/python-net/aspose.cells.properties/builtindocumentpropertycollection/characters_with_spaces) | Représente une estimation du nombre de caractères (espaces compris) dans le document.|
| [comments](/cells/fr/python-net/aspose.cells.properties/builtindocumentpropertycollection/comments) | Obtient ou définit les commentaires du document.|
| [category](/cells/fr/python-net/aspose.cells.properties/builtindocumentpropertycollection/category) | Obtient ou définit la catégorie du document.|
...
| [last_saved_universal_time](/cells/fr/python-net/aspose.cells.properties/builtindocumentpropertycollection/last_saved_universal_time) | Obtient ou définit l'heure universelle du dernier enregistrement.|
| [lines](/cells/fr/python-net/aspose.cells.properties/builtindocumentpropertycollection/lines) | Représente une estimation du nombre de lignes dans le document.|
| [manager](/cells/fr/python-net/aspose.cells.properties/builtindocumentpropertycollection/manager) | Obtient ou définit la propriété du gestionnaire.|
| [name_of_application](/cells/fr/python-net/aspose.cells.properties/builtindocumentpropertycollection/name_of_application) | Obtient ou définit le nom de l'application.|
| [pages](/cells/fr/python-net/aspose.cells.properties/builtindocumentpropertycollection/pages) | Représente une estimation du nombre de pages du document.|
...
| [document_version](/cells/fr/python-net/aspose.cells.properties/builtindocumentpropertycollection/document_version) | Représente la version du fichier.|
| [scale_crop](/cells/fr/python-net/aspose.cells.properties/builtindocumentpropertycollection/scale_crop) | Indique le mode d'affichage de la vignette du document.|
| [links_up_to_date](/cells/fr/python-net/aspose.cells.properties/builtindocumentpropertycollection/links_up_to_date) | Indique si les liens hypertexte d'un document sont à jour.|
| [words](/cells/fr/python-net/aspose.cells.properties/builtindocumentpropertycollection/words) | Représente une estimation du nombre de mots dans le document.|


###  Méthodes
| Méthode| Description|
| :- | :- |
| [index_of(name)](/cells/fr/python-net/aspose.cells.properties/builtindocumentpropertycollection/index_of/#str) | Obtient l'index d'une propriété par son nom.|
...
Permet d'accéder aux objets [DocumentProperty](/cells/fr/python-net/aspose.cells.properties/documentproperty) par leurs noms (à l'aide d'un indexeur) et
via un ensemble de propriétés typées qui renvoient des valeurs de types appropriés.
...
* classe [DocumentPropertyCollection](/cells/fr/python-net/aspose.cells.properties/documentpropertycollection)
