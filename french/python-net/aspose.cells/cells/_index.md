...
| :- | :- |
| [ods_cell_fields](/cells/fr/python-net/aspose.cells/cells/ods_cell_fields) | Obtient la liste des champs de cotes.|
...
| [rows](/cells/fr/python-net/aspose.cells/cells/rows) | Obtient la collection d'objets [Row](/cells/fr/python-net/aspose.cells/row) qui représentent les lignes individuelles de cette feuille de calcul.|
...
| [memory_setting](/cells/fr/python-net/aspose.cells/cells/memory_setting) | Obtient ou définit l'option d'utilisation de la mémoire pour cette cellule.|
...
| [standard_width_pixels](/cells/fr/python-net/aspose.cells/cells/standard_width_pixels) | Obtient ou définit la largeur de colonne par défaut dans la feuille de calcul, en unités de pixels.|
...
| [standard_height_pixels](/cells/fr/python-net/aspose.cells/cells/standard_height_pixels) | Obtient ou définit la hauteur de ligne par défaut dans cette feuille de calcul, en unités de pixels.|
...
| [columns](/cells/fr/python-net/aspose.cells/cells/columns) | Obtient la collection d'objets [Column](/cells/fr/python-net/aspose.cells/column) qui représentent les colonnes individuelles de cette feuille de calcul.|
...
| [group_columns(first_index, last_index)](/cells/fr/python-net/aspose.cells/cells/group_columns/#int-int) | Colonnes de groupe.|
| [group_columns(first_index, last_index, is_hidden)](/cells/fr/python-net/aspose.cells/cells/group_columns/#int-int-bool) | Colonnes de groupe.|
| [ungroup_rows(first_index, last_index, is_all)](/cells/fr/python-net/aspose.cells/cells/ungroup_rows/#int-int-bool) | Dissociez les lignes.|
| [ungroup_rows(first_index, last_index)](/cells/fr/python-net/aspose.cells/cells/ungroup_rows/#int-int) | Dissociez les lignes.|
...
| [text_to_columns(row, column, total_rows, options)](/cells/fr/python-net/aspose.cells/cells/text_to_columns/#int-int-int-TxtLoadOptions) | Divise le texte des colonnes en colonnes.|
...
| [unhide_row(row, height)](/cells/fr/python-net/aspose.cells/cells/unhide_row/#int-float) | Afficher une ligne.|
...
| [set_row_height_inch(row, inches)](/cells/fr/python-net/aspose.cells/cells/set_row_height_inch/#int-float) | Définit la hauteur de ligne en unités de pouces.|
...
| [unhide_column(column, width)](/cells/fr/python-net/aspose.cells/cells/unhide_column/#int-float) | Afficher une colonne|
...
| [get_row_height_inch(row)](/cells/fr/python-net/aspose.cells/cells/get_row_height_inch/#int) | Obtient la hauteur d'une ligne spécifiée en unités de pouces.|
| [get_view_row_height_inch(row)](/cells/fr/python-net/aspose.cells/cells/get_view_row_height_inch/#int) | Obtient la hauteur d'une ligne spécifiée en unités de pouces.|
...
| [get_column_width_pixel(column)](/cells/fr/python-net/aspose.cells/cells/get_column_width_pixel/#int) | Obtient la largeur de la colonne spécifiée en mode normal, en unités de pixels.|
...
| [convert_string_to_numeric_value()](/cells/fr/python-net/aspose.cells/cells/convert_string_to_numeric_value/#) |Convertit les données de chaîne dans les cellules en valeurs numériques si possible.|
...
| [get_dependents_in_calculation(row, column, recursive)](/cells/fr/python-net/aspose.cells/cells/get_dependents_in_calculation/#int-int-bool) | Obtient toutes les cellules dont le résultat calculé dépend de cellules spécifiques.|
