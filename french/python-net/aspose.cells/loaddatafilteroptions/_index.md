...
type: docs
weight: 2200
url: /fr/python-net/aspose.cells/loaddatafilteroptions/
is_root: false
---
##  LoadDataFilterOptions dénombrement
Représente les options de filtrage des données lors du chargement du classeur à partir du modèle.



Le type LoadDataFilterOptions expose les membres suivants :
...
| CELL_NUMERIC | Cellules de charge dont la valeur est numérique (y compris la date et l'heure)|
| CELL_ERROR | Cellules de charge dont la valeur est erreur|
| CELL_BOOL | Cellules de charge dont la valeur est bool|
| CELL_VALUE | Valeur des cellules de charge (tous les types de valeur) uniquement|
| FORMULA | Formules de cellule de charge.|
...
| PIVOT_TABLE | Charger les tableaux croisés dynamiques|
...
| OLE_OBJECT | Charger les OleObjects|
| REVISION | Charger les journaux de révision|
