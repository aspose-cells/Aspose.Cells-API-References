...
type: docs
weight: 20
url: /fr/python-net/aspose.cells/protectedrangecollection/add/
is_root: false
---
##  add(name, start_row, start_column, end_row, end_column) {#str-int-int-int-int}
Ajoute un élément [ProtectedRange](/cells/fr/python-net/aspose.cells/protectedrange) à la collection.
