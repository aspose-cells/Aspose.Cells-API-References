---
title: add_icon_filter méthode
second_title: Aspose.Cells for Python via .NET API Références
description:
type: docs
weight: 60
url: /fr/python-net/aspose.cells/autofilter/add_icon_filter/
is_root: false
---
...
| icon_id | int | L'identifiant de l'icône.|
###  Remarques

Ne prend en charge que l'ajout du filtre d'icônes.
Ne prend pas en charge la vérification de la ligne visible si le filtre est un filtre d'icônes.
