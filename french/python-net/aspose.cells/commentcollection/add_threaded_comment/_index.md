---
title: add_threaded_comment méthode
second_title: Aspose.Cells for Python via .NET API Références
description:
type: docs
weight: 30
url: /fr/python-net/aspose.cells/commentcollection/add_threaded_comment/
is_root: false
---
...
[ThreadedComment](/cells/fr/python-net/aspose.cells/threadedcomment) indice d'objet.
...
| author | [ThreadedCommentAuthor](/cells/fr/python-net/aspose.cells/threadedcommentauthor) | L'utilisateur de ce commentaire fileté.|
...
* classe [ThreadedComment](/cells/fr/python-net/aspose.cells/threadedcomment)
