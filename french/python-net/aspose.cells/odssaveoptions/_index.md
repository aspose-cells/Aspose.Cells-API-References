---
title: OdsSaveOptions classe
second_title: Aspose.Cells for Python via .NET API Références
description:
type: docs
weight: 1110
url: /fr/python-net/aspose.cells/odssaveoptions/
is_root: false
---
##  OdsSaveOptions classe
Représente les options d'enregistrement du fichier ods.



**Héritage:** [OdsSaveOptions](/cells/python-net/aspose.cells/odssaveoptions) → 
[SaveOptions](/cells/fr/python-net/aspose.cells/saveoptions)



Le type OdsSaveOptions expose les membres suivants :

###  Constructeurs
| Constructeur| Description|
| :- | :- |
| [OdsSaveOptions()](/cells/fr/python-net/aspose.cells/odssaveoptions/__init__/#) | Crée les options de sauvegarde du fichier ods.|
| [OdsSaveOptions(save_format)](/cells/fr/python-net/aspose.cells/odssaveoptions/__init__/#SaveFormat) | Crée les options de sauvegarde du fichier ods.|


###  Propriétés
| Propriété| Description|
| :- | :- |
| [save_format](/cells/fr/python-net/aspose.cells/odssaveoptions/save_format) | Obtient le format du fichier de sauvegarde.|
| [clear_data](/cells/fr/python-net/aspose.cells/odssaveoptions/clear_data) | Videz le classeur après avoir enregistré le fichier.|
| [cached_file_folder](/cells/fr/python-net/aspose.cells/odssaveoptions/cached_file_folder) | Le dossier de fichiers mis en cache est utilisé pour stocker des données volumineuses.|
| [validate_merged_areas](/cells/fr/python-net/aspose.cells/odssaveoptions/validate_merged_areas) | Indique s'il faut valider les cellules fusionnées avant d'enregistrer le fichier.|
...
###  Voir également
* module [aspose.cells](..)
* classe [OdsSaveOptions](/cells/fr/python-net/aspose.cells/odssaveoptions)
