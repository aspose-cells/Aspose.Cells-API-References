...
type: docs
weight: 2280
url: /fr/python-net/aspose.cells/ooxmlcompressiontype/
is_root: false
---
##  OoxmlCompressionType dénombrement
Le type de compression Ooxml



Le type OoxmlCompressionType expose les membres suivants :

###  Des champs
| Champ| Description|
| :- | :- |
| LEVEL1 | La compression la plus rapide mais la moins efficace.|
| LEVEL2 | Un peu plus lent, mais mieux, que le niveau 1.|
| LEVEL3 | Un peu plus lent, mais mieux, que le niveau 2.|
| LEVEL4 | Un peu plus lent, mais mieux, que le niveau 3.|
