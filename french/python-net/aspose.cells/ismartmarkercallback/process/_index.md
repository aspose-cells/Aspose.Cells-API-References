...
type: docs
weight: 20
url: /fr/python-net/aspose.cells/ismartmarkercallback/process/
is_root: false
---
...
| col_index | int | L'indice de colonne.|
| table_name | str | Le nom de table de smartmarker.|
| column_name | str | Le nom de table de smartmarker.|



###  Voir également
* module [aspose.cells](../../)
* classe [ISmartMarkerCallBack](/cells/fr/python-net/aspose.cells/ismartmarkercallback)
