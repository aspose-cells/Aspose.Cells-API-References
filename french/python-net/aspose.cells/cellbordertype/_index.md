...
type: docs
weight: 1830
url: /fr/python-net/aspose.cells/cellbordertype/
is_root: false
---
##  CellBorderType dénombrement
Énumère le type de bordure d'une cellule.



Le type CellBorderType expose les membres suivants :
...
| DOUBLE | Représente une ligne double.|
| HAIR | Représente la ligne des cheveux.|
