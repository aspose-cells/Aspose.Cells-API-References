...
type: docs
weight: 70
url: /fr/python-net/aspose.cells/worksheet/auto_fit_rows/
is_root: false
---
##  auto_fit_rows() {#}
...
| start_row | int | Index de ligne de début.|
| end_row | int | Index de fin de ligne.|
| options | [AutoFitterOptions](/cells/fr/python-net/aspose.cells/autofitteroptions) | Les options de monteur automatique.|
