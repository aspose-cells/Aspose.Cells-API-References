---
title: select_range méthode
second_title: Aspose.Cells for Python via .NET API Références
description:
type: docs
weight: 240
url: /fr/python-net/aspose.cells/worksheet/select_range/
is_root: false
---
...
| total_rows | int | Le nombre de lignes.|
| total_columns | int | Le nombre de colonnes|
| remove_others | bool | True signifie supprimer une autre plage sélectionnée et sélectionner uniquement cette plage.|
