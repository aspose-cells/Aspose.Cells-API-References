...
type: docs
weight: 1980
url: /fr/python-net/aspose.cells/dynamicfiltertype/
is_root: false
---
##  DynamicFilterType dénombrement
Type de filtre dynamique.



Le type DynamicFilterType expose les membres suivants :
...
| LAST_YEAR | Affiche les dates de l'année dernière.|
...
| JUNE | Affiche les dates qui sont en juin, quelle que soit l'année.|
| JULY | Affiche les dates qui sont en juillet, quelle que soit l'année.|
| AUGUST | Affiche les dates qui sont en août, quelle que soit l'année.|
| SEPTEMBER | Affiche les dates qui sont en septembre, quelle que soit l'année.|
| NEXT_MONTH | Affiche les dates du mois suivant.|
| NEXT_QUARTER | Affiche les dates du prochain trimestre.|
| NEXT_WEEK | Affiche les dates de la semaine prochaine.|
| NEXT_YEAR | Affiche les dates de l'année prochaine.|
| NONE | Aucun.|
...
| THIS_YEAR | Affiche les dates de cette année.|
| TODAY | Affiche les dates d'aujourd'hui.|
| TOMORROW | Affiche les dates de demain.|
| YEAR_TO_DATE | Affiche les dates comprises entre le début de l'année et aujourd'hui, inclus.|
| YESTERDAY | Affiche les dates d'hier.|
