...
type: docs
weight: 730
url: /fr/python-net/aspose.cells/globalizationsettings/
is_root: false
---
...
| :- | :- |
| [GlobalizationSettings()](/cells/fr/python-net/aspose.cells/globalizationsettings/__init__/#) | Construit une nouvelle instance de GlobalizationSettings|
...
| Méthode| Description|
| :- | :- |
| [get_pivot_total_name()](/cells/fr/python-net/aspose.cells/globalizationsettings/get_pivot_total_name/#) | Obtient le nom de l'étiquette "Total" dans le tableau croisé dynamique.<br/> Vous devez remplacer cette méthode lorsque le tableau croisé dynamique contient au moins deux champs croisés dynamiques dans la zone de données.|
...
| [get_data_field_header_name_of_pivot_table()](/cells/fr/python-net/aspose.cells/globalizationsettings/get_data_field_header_name_of_pivot_table/#) | Obtient le nom de l'en-tête de champ de la zone de valeur dans le tableau croisé dynamique.|
...
| [get_local_function_name(standard_name)](/cells/fr/python-net/aspose.cells/globalizationsettings/get_local_function_name/#str) | Obtient le nom de fonction dépendant des paramètres régionaux en fonction du nom de fonction standard donné.|
...
###  Voir également
* module [aspose.cells](..)
* classe [PivotFieldSubtotalType](/cells/fr/python-net/aspose.cells.pivot/pivotfieldsubtotaltype)
