...
| :- | :- |
| [capacity](/cells/fr/python-net/aspose.cells/conditionalformattingiconcollection/capacity) | Obtient ou définit le nombre d'éléments que la liste de tableaux peut contenir.|
