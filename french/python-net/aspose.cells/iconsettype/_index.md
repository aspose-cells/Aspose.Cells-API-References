...
type: docs
weight: 2190
url: /fr/python-net/aspose.cells/iconsettype/
is_root: false
---
...
Le type IconSetType expose les membres suivants :

###  Des champs
| Champ| Description|
| :- | :- |
| ARROWS3 | jeu d'icônes de 3 flèches.|
| ARROWS_GRAY3 | Jeu d'icônes de 3 flèches grises.|
| FLAGS3 | Jeu d'icônes de 3 drapeaux.|
| SIGNS3 | Jeu d'icônes de 3 signes.|
| SYMBOLS3 | Jeu d'icônes de 3 symboles (encerclé).|
| SYMBOLS32 | Jeu d'icônes de 3 symboles (sans cercle).|
| TRAFFIC_LIGHTS31 | Jeu d'icônes de 3 feux de signalisation (sans bordure).|
| TRAFFIC_LIGHTS32 | Icône de 3 feux de circulation avec bordure noire épaisse.|
