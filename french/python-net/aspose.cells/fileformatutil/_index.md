...
type: docs
weight: 600
url: /fr/python-net/aspose.cells/fileformatutil/
is_root: false
---
...
Le type FileFormatUtil expose les membres suivants :

###  Méthodes
| Méthode| Description|
| :- | :- |
| [detect_file_format(stream)](/cells/fr/python-net/aspose.cells/fileformatutil/detect_file_format/#io.RawIOBase) | Détecte et renvoie les informations sur un format d'un fichier Excel stocké dans un flux.|
| [detect_file_format(stream, password)](/cells/fr/python-net/aspose.cells/fileformatutil/detect_file_format/#io.RawIOBase-str) | Détecte et renvoie les informations sur un format d'un fichier Excel stocké dans un flux.|
| [detect_file_format(file_path)](/cells/fr/python-net/aspose.cells/fileformatutil/detect_file_format/#str) | Détecte et renvoie les informations sur un format d'un fichier Excel stocké dans un fichier.|
| [detect_file_format(file_path, password)](/cells/fr/python-net/aspose.cells/fileformatutil/detect_file_format/#str-str) | Détecte et renvoie les informations sur un format d'un fichier Excel stocké dans un fichier.|
