...
type: docs
weight: 50
url: /fr/python-net/aspose.cells/workbookdesigner/set_data_source/
is_root: false
---
##  set_data_source(data_source, cells_data_table) {#str-ICellsDataTable}
Définit la source de données d'un objet [ICellsDataTable](/cells/fr/python-net/aspose.cells/icellsdatatable).
...
| :- | :- | :- |
| data_source | str | Le nom de la source de données.|
| cells_data_table | [ICellsDataTable](/cells/fr/python-net/aspose.cells/icellsdatatable) | tableau de données.|
