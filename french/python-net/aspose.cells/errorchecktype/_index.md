...
type: docs
weight: 2010
url: /fr/python-net/aspose.cells/errorchecktype/
is_root: false
---
...
Le type ErrorCheckType expose les membres suivants :
...
| CALCULATED_COLUMN | Ignorer les erreurs lorsque les cellules contiennent une valeur différente d'une formule de colonne calculée.|
