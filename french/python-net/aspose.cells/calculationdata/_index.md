...
type: docs
weight: 120
url: /fr/python-net/aspose.cells/calculationdata/
is_root: false
---
...
| :- | :- |
| [calculated_value](/cells/fr/python-net/aspose.cells/calculationdata/calculated_value) | Obtient ou définit la valeur calculée pour cette fonction.|
...
| Méthode| Description|
| :- | :- |
| [get_param_value(index)](/cells/fr/python-net/aspose.cells/calculationdata/get_param_value/#int) | Obtient l'objet valeur représenté du paramètre à l'index donné.|
| [get_param_text(index)](/cells/fr/python-net/aspose.cells/calculationdata/get_param_text/#int) | Obtient le texte littéral du paramètre à l'index donné.|
