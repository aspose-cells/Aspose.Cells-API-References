...
type: docs
weight: 350
url: /fr/python-net/aspose.cells/cell/set_table_formula/
is_root: false
---
##  set_table_formula(row_number, column_number, row_input_cell, column_input_cell, values) {#int-int-str-str-list}
Créez une table de données à deux variables pour une plage donnée à partir de cette cellule.
...
Créez une table de données à une variable pour une plage donnée à partir de cette cellule.
