...
type: docs
weight: 1780
url: /fr/python-net/aspose.cells/backgroundtype/
is_root: false
---
##  BackgroundType dénombrement
Énumère les types de motif d'arrière-plan de cellule.
...
| THIN_REVERSE_DIAGONAL_STRIPE | Représente un motif à fines rayures diagonales inversées.|
| THIN_VERTICAL_STRIPE | Représente un motif à fines rayures verticales.|
