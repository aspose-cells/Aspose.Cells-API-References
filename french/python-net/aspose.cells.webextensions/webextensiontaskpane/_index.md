---
title: WebExtensionTaskPane classe
second_title: Aspose.Cells for Python via .NET API Références
description:
type: docs
weight: 90
url: /fr/python-net/aspose.cells.webextensions/webextensiontaskpane/
is_root: false
---
##  WebExtensionTaskPane classe
Représente un objet persistant du volet des tâches.



Le type WebExtensionTaskPane expose les membres suivants :

###  Propriétés
| Propriété| Description|
| :- | :- |
| [web_extension](/cells/fr/python-net/aspose.cells.webextensions/webextensiontaskpane/web_extension) | Obtient et définit le composant d'extension Web associé à l'instance du volet des tâches|
