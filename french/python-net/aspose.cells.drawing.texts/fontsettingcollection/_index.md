...
type: docs
weight: 50
url: /fr/python-net/aspose.cells.drawing.texts/fontsettingcollection/
is_root: false
---
##  FontSettingCollection classe
Représente la liste de [FontSetting](/cells/fr/python-net/aspose.cells/fontsetting).



Le type FontSettingCollection expose les membres suivants :

###  Propriétés
| Propriété| Description|
| :- | :- |
| [text_alignment](/cells/fr/python-net/aspose.cells.drawing.texts/fontsettingcollection/text_alignment) | Représente le paramètre d'alignement du corps du texte.|
