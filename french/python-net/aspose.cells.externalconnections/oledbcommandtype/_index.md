...
type: docs
weight: 120
url: /fr/python-net/aspose.cells.externalconnections/oledbcommandtype/
is_root: false
---
...
Le type OLEDBCommandType expose les membres suivants :

###  Des champs
| Champ| Description|
| :- | :- |
| NONE | Le type de commande n'est pas spécifié.|
| CUBE_NAME | Spécifie un nom de cube|
