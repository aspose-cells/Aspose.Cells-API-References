---
title: PivotGroupByType dénombrement
second_title: Aspose.Cells for Python via .NET API Références
description:
type: docs
weight: 190
url: /fr/python-net/aspose.cells.pivot/pivotgroupbytype/
is_root: false
---
##  PivotGroupByType dénombrement
Représente le type groupby de tableau croisé dynamique.



Le type PivotGroupByType expose les membres suivants :
