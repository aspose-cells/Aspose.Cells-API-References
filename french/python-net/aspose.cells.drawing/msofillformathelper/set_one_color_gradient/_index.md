---
title: set_one_color_gradient méthode
second_title: Aspose.Cells for Python via .NET API Références
description:
type: docs
weight: 20
url: /fr/python-net/aspose.cells.drawing/msofillformathelper/set_one_color_gradient/
is_root: false
---
...
| degree | float | Degré de dégradé. Il peut s'agir d'une valeur comprise entre 0,0 (foncé) et 1,0 (clair).|
...
* classe [MsoFillFormatHelper](/cells/fr/python-net/aspose.cells.drawing/msofillformathelper)
