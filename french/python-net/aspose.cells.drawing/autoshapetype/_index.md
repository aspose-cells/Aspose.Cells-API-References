...
type: docs
weight: 760
url: /fr/python-net/aspose.cells.drawing/autoshapetype/
is_root: false
---
...
Le type AutoShapeType expose les membres suivants :
...
| HORIZONTAL_SCROLL |  |
| CIRCULAR_ARROW |  |
| NOTCHED_CIRCULAR_ARROW | Une valeur qui NE DEVRAIT PAS être utilisée.|
| U_TURN_ARROW |  |
| CURVED_RIGHT_ARROW |  |
| CURVED_LEFT_ARROW |  |
| CURVED_UP_ARROW |  |
...
| TEXT_CASCADE_UP | Une forme de texte en cascade pointée vers le haut.|
| TEXT_CASCADE_DOWN | Une forme de texte en cascade pointée vers le bas.|
| TEXT_WAVE1 | Une forme de texte ondulée.|
...
| SUN |  |
| MOON |  |
| DOUBLE_BRACKET | Une forme entre parenthèses.|
| DOUBLE_BRACE | Une forme entourée d'accolades.|
| STAR4 |  |
| DOUBLE_WAVE |  |
| BLANK_ACTION_BUTTON |  |
| HOME_ACTION_BUTTON |  |
