...
type: docs
weight: 610
url: /fr/python-net/aspose.cells.drawing/shapepropertycollection/
is_root: false
---
##  ShapePropertyCollection classe
Cette classe spécifie les propriétés visuelles de la forme d'un élément ou d'une forme de graphique.



Le type ShapePropertyCollection expose les membres suivants :
...
| [clear_shadow_effect()](/cells/fr/python-net/aspose.cells.drawing/shapepropertycollection/clear_shadow_effect/#) | Efface l'effet d'ombre de l'élément ou de la forme du graphique.|
| [has_shadow_effect()](/cells/fr/python-net/aspose.cells.drawing/shapepropertycollection/has_shadow_effect/#) | Indique si la forme a des données d'effet d'ombre.|
