...
type: docs
weight: 10
url: /fr/python-net/aspose.cells.charts/axis/
is_root: false
---
##  Axis classe
...
| :- | :- |
| [area](/cells/fr/python-net/aspose.cells.charts/axis/area) | Obtient le [Axis.area](/cells/fr/python-net/aspose.cells.charts/axis#area).|
| [is_automatic_min_value](/cells/fr/python-net/aspose.cells.charts/axis/is_automatic_min_value) | Indique si la valeur min est automatiquement attribuée.|
| [min_value](/cells/fr/python-net/aspose.cells.charts/axis/min_value) | Représente la valeur minimale sur l'axe des ordonnées.|
...
| [major_tick_mark](/cells/fr/python-net/aspose.cells.charts/axis/major_tick_mark) | Représente le type de graduation principale pour l'axe spécifié.|
| [minor_tick_mark](/cells/fr/python-net/aspose.cells.charts/axis/minor_tick_mark) | Représente le type de graduation mineure pour l'axe spécifié.|
...
| [display_unit_label](/cells/fr/python-net/aspose.cells.charts/axis/display_unit_label) | Représente une étiquette d'unité sur un axe dans le graphique spécifié.<br/> Les étiquettes d'unité sont utiles pour tracer des valeurs importantes, par exemple, en millions ou en milliards.|
| [is_display_unit_label_shown](/cells/fr/python-net/aspose.cells.charts/axis/is_display_unit_label_shown) | Représente si l'étiquette de l'unité d'affichage est affichée sur l'axe spécifié.|
| [title](/cells/fr/python-net/aspose.cells.charts/axis/title) | Obtient le titre de l'axe.|
| [category_type](/cells/fr/python-net/aspose.cells.charts/axis/category_type) | Représente le type d'axe de catégorie.|
| [base_unit_scale](/cells/fr/python-net/aspose.cells.charts/axis/base_unit_scale) | Représente l'échelle d'unité de base pour l'axe des abscisses.|
| [major_unit_scale](/cells/fr/python-net/aspose.cells.charts/axis/major_unit_scale) | Représente l'échelle des unités principales pour l'axe des abscisses.|
| [minor_unit_scale](/cells/fr/python-net/aspose.cells.charts/axis/minor_unit_scale) | Représente l'échelle des unités principales pour l'axe des abscisses.|
