...
type: docs
weight: 350
url: /fr/python-net/aspose.cells.charts/walls/
is_root: false
---
##  Walls classe
Encapsule l'objet qui représente les parois d'un graphique 3D.



**Héritage:** [Walls](/cells/python-net/aspose.cells.charts/walls) → 
[Floor](/cells/python-net/aspose.cells.charts/floor) → 
[Area](/cells/fr/python-net/aspose.cells.drawing/area)



Le type Walls expose les membres suivants :

###  Propriétés
| Propriété| Description|
| :- | :- |
| [background_color](/cells/fr/python-net/aspose.cells.charts/walls/background_color) | Obtient ou définit la couleur d'arrière-plan du [Area](/cells/fr/python-net/aspose.cells.drawing/area).|
| [foreground_color](/cells/fr/python-net/aspose.cells.charts/walls/foreground_color) | Obtient ou définit la couleur de premier plan.|
| [formatting](/cells/fr/python-net/aspose.cells.charts/walls/formatting) | Représente la mise en forme de la zone.|
| [invert_if_negative](/cells/fr/python-net/aspose.cells.charts/walls/invert_if_negative) | Si la propriété est vraie et que la valeur du point du graphique est un nombre négatif,<br/> la couleur de premier plan et la couleur d'arrière-plan seront échangées.|
| [fill_format](/cells/fr/python-net/aspose.cells.charts/walls/fill_format) | Représente un objet [Area.fill_format](/cells/fr/python-net/aspose.cells.drawing/area#fill_format) qui contient des propriétés de mise en forme de remplissage pour le graphique ou la forme spécifié.|
| [transparency](/cells/fr/python-net/aspose.cells.charts/walls/transparency) | Renvoie ou définit le degré de transparence de la zone sous la forme d'une valeur comprise entre 0,0 (opaque) et 1,0 (clair).|
...
* classe [Area](/cells/fr/python-net/aspose.cells.drawing/area)
* classe [Floor](/cells/fr/python-net/aspose.cells.charts/floor)
* classe [Line](/cells/fr/python-net/aspose.cells.drawing/line)
* classe [Walls](/cells/fr/python-net/aspose.cells.charts/walls)
