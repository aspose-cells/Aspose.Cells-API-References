...
type: docs
weight: 30
url: /fr/python-net/aspose.cells.charts/chart/
is_root: false
---
##  Chart classe
...
| [display_na_as_blank](/cells/fr/python-net/aspose.cells.charts/chart/display_na_as_blank) | Indique si #N/A est affiché comme valeur vide.|
| [name](/cells/fr/python-net/aspose.cells.charts/chart/name) | Obtient et définit le nom du graphique.|
| [size_with_window](/cells/fr/python-net/aspose.cells.charts/chart/size_with_window) | True si Microsoft Excel redimensionne le graphique pour correspondre à la taille de la fenêtre de la feuille de graphique.|
| [worksheet](/cells/fr/python-net/aspose.cells.charts/chart/worksheet) | Obtient la feuille de calcul qui contient ce graphique.|
| [shapes](/cells/fr/python-net/aspose.cells.charts/chart/shapes) | Renvoie toutes les formes de dessin de ce graphique.|
| [print_size](/cells/fr/python-net/aspose.cells.charts/chart/print_size) | Obtient et définit la taille du graphique imprimé.|
...
| [value_axis](/cells/fr/python-net/aspose.cells.charts/chart/value_axis) | Obtient l'axe Y du graphique.|
| [second_value_axis](/cells/fr/python-net/aspose.cells.charts/chart/second_value_axis) | Obtient le deuxième axe Y du graphique.|
| [second_category_axis](/cells/fr/python-net/aspose.cells.charts/chart/second_category_axis) | Obtient le deuxième axe X du graphique.|
| [series_axis](/cells/fr/python-net/aspose.cells.charts/chart/series_axis) | Obtient l'axe des séries du graphique.|
| [legend](/cells/fr/python-net/aspose.cells.charts/chart/legend) | Obtient la légende du graphique.|
| [chart_data_table](/cells/fr/python-net/aspose.cells.charts/chart/chart_data_table) | Représente la table de données du graphique.|
| [show_legend](/cells/fr/python-net/aspose.cells.charts/chart/show_legend) | Obtient ou définit une valeur indiquant si la légende du graphique sera affichée. La valeur par défaut est true.|
...
| [placement](/cells/fr/python-net/aspose.cells.charts/chart/placement) | Représente la manière dont le graphique est attaché aux cellules situées en dessous.|
| [page_setup](/cells/fr/python-net/aspose.cells.charts/chart/page_setup) | Représente la description de la mise en page dans ce graphique.|
| [line](/cells/fr/python-net/aspose.cells.charts/chart/line) | Obtient la ligne.|


###  Méthodes
| Méthode| Description|
| :- | :- |
| [to_image(image_file)](/cells/fr/python-net/aspose.cells.charts/chart/to_image/#str) | Crée l'image du graphique et l'enregistre dans un fichier.<br/> L'extension du nom de fichier détermine le format de l'image.|
| [to_image(image_file, image_type)](/cells/fr/python-net/aspose.cells.charts/chart/to_image/#str-aspose.cells.drawing.ImageType) | Crée l'image du graphique et l'enregistre dans un fichier dans le type d'image spécifié.|
| [to_image(image_file, jpeg_quality)](/cells/fr/python-net/aspose.cells.charts/chart/to_image/#str-int) | Crée l'image du graphique et l'enregistre dans un fichier au format Jpeg.|
| [to_image(stream, jpeg_quality)](/cells/fr/python-net/aspose.cells.charts/chart/to_image/#io.RawIOBase-int) | Crée l'image du graphique et l'enregistre dans un flux au format Jpeg.|
| [to_image(stream, image_type)](/cells/fr/python-net/aspose.cells.charts/chart/to_image/#io.RawIOBase-aspose.cells.drawing.ImageType) |Crée l'image du graphique et l'enregistre dans un flux au format spécifié.|
| [to_image(image_file, options)](/cells/fr/python-net/aspose.cells.charts/chart/to_image/#str-aspose.cells.rendering.ImageOrPrintOptions) | Crée l'image du graphique et l'enregistre dans un fichier.<br/> L'extension du nom de fichier détermine le format de l'image.|
| [to_image(stream, options)](/cells/fr/python-net/aspose.cells.charts/chart/to_image/#io.RawIOBase-aspose.cells.rendering.ImageOrPrintOptions) |Crée l'image du graphique et l'enregistre dans un flux au format spécifié.|
| [to_pdf(file_name)](/cells/fr/python-net/aspose.cells.charts/chart/to_pdf/#str) | Enregistre le graphique dans un fichier pdf.|
| [to_pdf(file_name, desired_page_width, desired_page_height, h_alignment_type, v_alignment_type)](/cells/fr/python-net/aspose.cells.charts/chart/to_pdf/#str-float-float-PageLayoutAlignmentType-PageLayoutAlignmentType) | Enregistre le graphique dans un fichier pdf.|
| [to_pdf(stream)](/cells/fr/python-net/aspose.cells.charts/chart/to_pdf/#io.RawIOBase) | Crée le graphique pdf et l'enregistre dans un flux.|
| [to_pdf(stream, desired_page_width, desired_page_height, h_alignment_type, v_alignment_type)](/cells/fr/python-net/aspose.cells.charts/chart/to_pdf/#io.RawIOBase-float-float-PageLayoutAlignmentType-PageLayoutAlignmentType) | Crée le graphique pdf et l'enregistre dans un flux.|
| [is_chart_data_changed()](/cells/fr/python-net/aspose.cells.charts/chart/is_chart_data_changed/#) | Détecte si la source de données d'un graphique a changé.|
| [refresh_pivot_data()](/cells/fr/python-net/aspose.cells.charts/chart/refresh_pivot_data/#) | Actualise les données du tableau croisé dynamique à partir de sa source de données pivot.|
| [change_template(data)](/cells/fr/python-net/aspose.cells.charts/chart/change_template/#bytes) | Modifiez le type de graphique avec un modèle prédéfini.|
...
* classe [SeriesCollection](/cells/fr/python-net/aspose.cells.charts/seriescollection)
