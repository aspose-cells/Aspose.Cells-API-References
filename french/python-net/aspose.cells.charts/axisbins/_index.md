---
title: AxisBins classe
second_title: Aspose.Cells for Python via .NET API Références
description:
type: docs
weight: 20
url: /fr/python-net/aspose.cells.charts/axisbins/
is_root: false
---
##  AxisBins classe
Représente les bacs d'axe



Le type AxisBins expose les membres suivants :

###  Constructeurs
| Constructeur| Description|
| :- | :- |
| [AxisBins()](/cells/fr/python-net/aspose.cells.charts/axisbins/__init__/#) | Construit une nouvelle instance de AxisBins|
...
| Méthode| Description|
| :- | :- |
| [reset_overflow()](/cells/fr/python-net/aspose.cells.charts/axisbins/reset_overflow/#) | Réinitialiser le débordement|
| [reset_underflow()](/cells/fr/python-net/aspose.cells.charts/axisbins/reset_underflow/#) | Réinitialiser le sous-dépassement|
