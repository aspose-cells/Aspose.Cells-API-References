...
type: docs
weight: 10
url: /fr/python-net/aspose.cells.querytables/
is_root: false
---
 Le**Aspose.Cells.QueryTables** namespace fournit des classes pour accéder et mettre à jour la table de feuille de calcul créée à partir des données renvoyées par une source de données externe, telle qu'un serveur SQL ou une base de données Access Microsoft.

###  Des classes
| Classe| Description|
| :- | :- |
| [DataMashup](/cells/fr/python-net/aspose.cells.querytables/datamashup) | Représente les données de mashup.|
| [PowerQueryFormula](/cells/fr/python-net/aspose.cells.querytables/powerqueryformula) | Représente la définition de la formule de requête de puissance.|
...
| [PowerQueryFormulaItemCollection](/cells/fr/python-net/aspose.cells.querytables/powerqueryformulaitemcollection) | Représente tous les éléments de la formule de requête avancée.|
