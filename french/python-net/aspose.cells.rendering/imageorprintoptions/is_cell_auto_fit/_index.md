---
title: is_cell_auto_fit propriété
second_title: Aspose.Cells for Python via .NET API Références
description:
type: docs
weight: 150
url: /fr/python-net/aspose.cells.rendering/imageorprintoptions/is_cell_auto_fit/
is_root: false
---
##  is_cell_auto_fit propriété

 Indique si la largeur et la hauteur des cellules sont ajustées automatiquement par valeur de cellule.
