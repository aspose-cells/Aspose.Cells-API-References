...
type: docs
weight: 130
url: /fr/python-net/aspose.cells.tables/totalscalculation/
is_root: false
---
...
Le type TotalsCalculation expose les membres suivants :
...
| NONE | Représente Aucun calcul de totaux.|
| CUSTOM | Représente un calcul personnalisé.|
