...
type: docs
weight: 10
url: /fr/python-net/aspose.cells.tables/
is_root: false
---
 Le**Aspose.Cells.Tables** L'espace de noms contient des classes qui représentent des tableaux, des lignes, des cellules et leur mise en forme pour les fichiers de feuille de calcul Excel.

###  Des classes
| Classe| Description|
| :- | :- |
| [ListColumn](/cells/fr/python-net/aspose.cells.tables/listcolumn) | Représente une colonne dans une liste.|
| [ListColumnCollection](/cells/fr/python-net/aspose.cells.tables/listcolumncollection) | Représente une collection de tous les objets [ListColumn](/cells/fr/python-net/aspose.cells.tables/listcolumn) dans l'objet ListObject spécifié.|
| [ListObject](/cells/fr/python-net/aspose.cells.tables/listobject) | Représente un objet de liste dans une feuille de calcul.<br/> L'objet ListObject est membre de la collection ListObjects.<br/> La collection ListObjects contient tous les objets de liste d'une feuille de calcul.|
| [ListObjectCollection](/cells/fr/python-net/aspose.cells.tables/listobjectcollection) | Représente une collection de [ListObject](/cells/fr/python-net/aspose.cells.tables/listobject) objets dans la feuille de calcul.|
