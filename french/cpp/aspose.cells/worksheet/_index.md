...
type: docs
weight: 16600
url: /fr/cpp/aspose.cells/worksheet/
---
## Worksheet class
...
//L'exemple suivant montre comment figer les volets et insérer un lien hypertexte dans la feuille de calcul avec .Net ou VB.
Workbook workbook;

Worksheet sheet = workbook.GetWorksheets().Get(0);

//Figer les volets à "AS40" avec 10 lignes et 10 colonnes
