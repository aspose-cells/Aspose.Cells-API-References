---
title: Aspose::Cells::WorksheetCollection::AddCopy method
linktitle: AddCopy
second_title: Aspose.Cells for C++ API Reference
description: 'Aspose::Cells::WorksheetCollection::AddCopy method. Adds a worksheet to the collection and copies data from an existed worksheet in C++.'
type: docs
weight: 2700
url: /fr/cpp/aspose.cells/worksheetcollection/addcopy/
---
...
| --- | --- | --- |
| sheetName | const U16String\& | [Name](../../name/) of source worksheet. |
...
| Parameter | Type | Description |
| --- | --- | --- |
| sheetName | const char16_t* | [Name](../../name/) of source worksheet. |
