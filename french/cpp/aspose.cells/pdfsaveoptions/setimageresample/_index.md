...
type: docs
weight: 1800
url: /fr/cpp/aspose.cells/pdfsaveoptions/setimageresample/
---
...
//Le code suivant définit le PPI souhaité à 96 et la qualité JPEG à 80 pour les images du PDF de sortie.

//charger le fichier source contenant des images.
Workbook wb(u"Book1.xlsx");

PdfSaveOptions pdfSaveOptions;

//définir le PPI souhaité à 96 et la qualité JPEG à 80.
