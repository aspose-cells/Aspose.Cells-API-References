...
//Insérer une chaîne dans une cellule
Cell cell = cells.Get(0, 0);
cell.PutValue(u"Hello");

U16String first = cell.GetStringValue();

//Insérer un entier dans une cellule
cell = cells.Get(u"B1");
cell.PutValue(12);

int second = cell.GetIntValue();

//Insérer un double dans une cellule
cell = cells.Get(0, 2);
cell.PutValue(-1.234);
...
//Insérer une formule combinée : "sum(average(b1,c1), b1)" dans la cellule b2
cell = cells.Get(u"b2");
