...
type: docs
weight: 14400
url: /fr/cpp/aspose.cells/systemtimeinterruptmonitor/
---
...
//L'exemple suivant montre comment surveiller la procédure de chargement et d'enregistrement avec une limite de temps spécifiée :
...
//si le temps de chargement du fichier modèle dépasse une seconde, une interruption sera requise et une exception sera levée ici
//sinon, commence à surveiller la procédure d'enregistrement
