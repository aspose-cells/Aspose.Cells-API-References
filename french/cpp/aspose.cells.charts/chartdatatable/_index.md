...
type: docs
weight: 700
url: /fr/cpp/aspose.cells.charts/chartdatatable/
---
...
Aspose::Cells::Startup();
    ...
    //Obtention du tableau du graphique
    ChartDataTable chartTable = chart.GetChartDataTable();

    //Définir la couleur de police du tableau du graphique
    chartTable.GetFont().SetColor(Color{ 0xff, 0xff, 0, 0 });

    //Définir les options de visibilité de la clé de légende
