---
title: Aspose::Cells::Charts::ChartFrame::SetBackground method
linktitle: SetBackground
second_title: Aspose.Cells for C++ API Reference
description: 'Aspose::Cells::Charts::ChartFrame::SetBackground method. Gets and sets the display mode of the background. This property is only valid in Excel 2003 or earlier versions in C++.'
type: docs
weight: 1100
url: /fr/cpp/aspose.cells.charts/chartframe/setbackground/
---
## ChartFrame::SetBackground method
...
```cpp
void Aspose::Cells::Charts::ChartFrame::SetBackground(BackgroundMode value)
```
