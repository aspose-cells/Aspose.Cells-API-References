---
title: Aspose::Cells::Charts::PlotArea::GetInnerHeightRatioToChart method
linktitle: GetInnerHeightRatioToChart
second_title: Aspose.Cells for C++ API Reference
description: 'Aspose::Cells::Charts::PlotArea::GetInnerHeightRatioToChart method. Gets or sets the height of plot area in units of ratio of the chart area in C++.'
type: docs
weight: 3400
url: /fr/cpp/aspose.cells.charts/plotarea/getinnerheightratiotochart/
---
## PlotArea::GetInnerHeightRatioToChart method


Gets or sets the height of plot area in units of ratio of the chart area.

```cpp
double Aspose::Cells::Charts::PlotArea::GetInnerHeightRatioToChart()
```
