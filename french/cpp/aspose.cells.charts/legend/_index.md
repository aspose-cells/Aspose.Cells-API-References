...
type: docs
weight: 1900
url: /fr/cpp/aspose.cells.charts/legend/
---
## Legend class
...
//Si la légende est à gauche ou à droite du graphique, la définition de la propriété Legend.X n'aura aucun effet.
//Si la légende est en haut ou en bas du graphique, la définition de la propriété Legend.Y n'aura aucun effet.
legend.SetY(1500);
legend.SetWidth(50);
legend.SetHeight(50);
