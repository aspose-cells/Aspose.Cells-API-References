---
title: Aspose::Cells::Charts::DataLabels class
...
type: docs
weight: 1400
url: /fr/cpp/aspose.cells.charts/datalabels/
---
## DataLabels class


Encapsulates a collection of all the DataLabel objects for the specified [Series](../series/).
...
| [DataLabels(DataLabels_Impl* impl)](./datalabels/) | Constructs from an implementation object. |
| [DataLabels(const DataLabels\& src)](./datalabels/) | Copy constructor. |
| [DataLabels(const ChartTextFrame\& src)](./datalabels/) | Constructs from a parent object. |
...
| [operator=(const DataLabels\& src)](./operator_asm/) | operator= |
...
| [SetNumber(int32_t value)](./setnumber/) | Gets and sets the built-in number format. |
| [SetNumberFormat(const U16String\& value)](./setnumberformat/) | Represents the format string for the [DataLabels](./) object. |
| [SetNumberFormat(const char16_t* value)](./setnumberformat/) | Represents the format string for the [DataLabels](./) object. |
...
Aspose::Cells::Startup();
    //Définir les étiquettes de données dans le graphique
    ...
    for (int i = 0; i < chart.GetNSeries().GetCount(); i++)
    {
        ...
        //Définir la position des étiquettes de données
        datalabels.SetPosition(LabelPositionType::InsideBase);
        //Afficher le nom de catégorie dans les étiquettes de données
        datalabels.SetShowCategoryName(true);
        //Afficher la valeur dans les étiquettes de données
        datalabels.SetShowValue(true);
        //Ne pas afficher le pourcentage dans les étiquettes de données
