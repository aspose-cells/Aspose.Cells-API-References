...
type: docs
weight: 1700
url: /fr/cpp/aspose.cells.charts/floor/
---
## Floor class
...
//Passer uniquement le nom du fichier de licence intégré dans l'assembly
...
//Insérer des valeurs dans les cellules
...
//obtenir le graphique récemment ajouté
Chart chart = charts.Get(index);

//définir nseries du graphique
chart.GetNSeries().Add(u"A1:A3", true);

//Afficher les étiquettes de données
chart.GetNSeries().Get(0).GetDataLabels().SetShowValue(true);

//Obtenir le plan du graphique
Floor floor = chart.GetFloor();

//définir la bordure du plan en rouge
