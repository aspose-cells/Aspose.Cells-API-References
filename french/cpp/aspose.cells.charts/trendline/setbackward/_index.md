---
title: Aspose::Cells::Charts::Trendline::SetBackward method
linktitle: SetBackward
second_title: Aspose.Cells for C++ API Reference
description: 'Aspose::Cells::Charts::Trendline::SetBackward method. Returns or sets the number of periods (or units on a scatter chart) that the trendline extends backward. The number of periods must be greater than or equal to zero. If the chart type is column ,the number of periods must be between 0 and 0.5 in C++.'
type: docs
weight: 1800
url: /fr/cpp/aspose.cells.charts/trendline/setbackward/
---
