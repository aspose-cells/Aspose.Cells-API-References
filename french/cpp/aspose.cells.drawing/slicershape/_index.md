---
title: Aspose::Cells::Drawing::SlicerShape class
linktitle: SlicerShape
second_title: Aspose.Cells for C++ API Reference
description: 'Aspose::Cells::Drawing::SlicerShape class. Represents the slicer shape in C++.'
type: docs
weight: 6300
url: /fr/cpp/aspose.cells.drawing/slicershape/
---
## SlicerShape class
...
```cpp
class SlicerShape : public Aspose::Cells::Drawing::Shape
```
...
| [operator=(const SlicerShape\& src)](./operator_asm/) | operator= |
...
| [SlicerShape(SlicerShape_Impl* impl)](./slicershape/) | Constructs from an implementation object. |
| [SlicerShape(const SlicerShape\& src)](./slicershape/) | Copy constructor. |
| [SlicerShape(const Shape\& src)](./slicershape/) | Constructs from a parent object. |
...
| [~SlicerShape()](./~slicershape/) | Destructor. |
## Fields
