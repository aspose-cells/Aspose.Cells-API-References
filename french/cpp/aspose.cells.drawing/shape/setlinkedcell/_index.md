...
type: docs
weight: 14600
url: /fr/cpp/aspose.cells.drawing/shape/setlinkedcell/
---
...
```cpp
//Après l'exécution du code ci‑dessous, un objet ScrollBar est créé dans le fichier généré. Lorsque vous faites glisser le curseur, la valeur est affichée dans la cellule A12.
