...
type: docs
weight: 14800
url: /fr/cpp/aspose.cells.drawing/shape/setinputrange/
---
...
```cpp
//Après l'exécution du code ci‑dessous, un objet ListBox est créé dans le fichier généré. Lorsque l'option sélectionnée est cliquée, la valeur sélectionnée est affichée dans la cellule A12.
