---
title: Aspose::Cells::Drawing::Button class
linktitle: Button
second_title: Aspose.Cells for C++ API Reference
description: 'Aspose::Cells::Drawing::Button class. Represents the Forms control: Button in C++.'
type: docs
weight: 600
url: /fr/cpp/aspose.cells.drawing/button/
---
## Button class
...
```cpp
class Button : public Aspose::Cells::Drawing::Shape
```
...
| [Button(Button_Impl* impl)](./button/) | Constructs from an implementation object. |
| [Button(const Button\& src)](./button/) | Copy constructor. |
| [Button(const Shape\& src)](./button/) | Constructs from a parent object. |
...
| [operator=(const Button\& src)](./operator_asm/) | operator= |
...
//Mettre la chaîne de légende en gras.
button.GetFont().SetIsBold(true);

//Définir la couleur en bleu.
button.GetFont().SetColor(Color{ 0xff, 0, 0, 0xff });

//Définir le lien hypertexte du bouton.
button.AddHyperlink(u"http://www.aspose.com/");

//Enregistre le fichier.
workbook.Save(u"tstbutton.xls");
