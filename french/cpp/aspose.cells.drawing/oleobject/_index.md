...
type: docs
weight: 3900
url: /fr/cpp/aspose.cells.drawing/oleobject/
---
## OleObject class
...
//Obtenir les données de l'image dans "iconData". par ex. : un fichier .jpg nommé "school.jpg"
//(Remarque : vous devez lire les données dans cette variable.)
Vector<uint8_t> iconData{0};

//Obtenir les données de l'objet OLE dans "objectData". par ex. : un fichier .xls nommé "Book1.xls"
//(Remarque : vous devez lire les données dans cette variable.)
Vector<uint8_t> objectData{0};

//Ajouter un objet OLE dans la feuille de calcul avec l'image
//affichée dans MS Excel.
