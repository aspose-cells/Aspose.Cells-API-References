---
title: Aspose::Cells::Drawing::ComboBox class
linktitle: ComboBox
second_title: Aspose.Cells for C++ API Reference
description: 'Aspose::Cells::Drawing::ComboBox class. Represents the control form ComboBox in C++.'
type: docs
weight: 1200
url: /fr/cpp/aspose.cells.drawing/combobox/
---
## ComboBox class
...
```cpp
class ComboBox : public Aspose::Cells::Drawing::Shape
```
...
| [operator=(const ComboBox\& src)](./operator_asm/) | operator= |
...
| [SetDropDownLines(int32_t value)](./setdropdownlines/) | Gets or sets the number of list lines displayed in the drop-down portion of a combo box. |
...
cells.Get(u"B3").PutValue(u"Employee:");
...
comboBox.SetLinkedCell(u"A1");

//Définissez la plage d’entrée.
comboBox.SetInputRange(u"A2:A7");

//Définir le nombre de lignes de liste affichées dans la zone de liste déroulante
//portion de liste de la zone.
comboBox.SetDropDownLines(5);

//Définir la zone de liste déroulante avec un ombrage 3D.
...
workbook.Save(u"tstcombobox.xls");
