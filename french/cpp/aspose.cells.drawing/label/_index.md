---
title: Aspose::Cells::Drawing::Label class
linktitle: Label
second_title: Aspose.Cells for C++ API Reference
description: 'Aspose::Cells::Drawing::Label class. Encapsulates the object that represents a label in a spreadsheet in C++.'
type: docs
weight: 2700
url: /fr/cpp/aspose.cells.drawing/label/
---
## Label class
...
```cpp
class Label : public Aspose::Cells::Drawing::Shape
```
...
| [Label(Label_Impl* impl)](./label/) | Constructs from an implementation object. |
| [Label(const Label\& src)](./label/) | Copy constructor. |
| [Label(const Shape\& src)](./label/) | Constructs from a parent object. |
...
| [operator=(const Label\& src)](./operator_asm/) | operator= |
...
//Définir la légende du libellé.
label.SetText(u"This is a Label");

//Définir le type de placement, la façon dont le
//libellé est attaché aux cellules.
label.SetPlacement(PlacementType::FreeFloating);

//Définir la couleur de remplissage du libellé.
label.GetFill().SetFillType(FillType::Solid);
label.GetFill().GetSolidFill().SetColor(Color{ 0xff, 0xff, 0xff, 0 });

//Enregistre le fichier.
workbook.Save(u"tstlabel.xls");
