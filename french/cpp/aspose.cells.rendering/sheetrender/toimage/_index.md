...
type: docs
weight: 900
url: /fr/cpp/aspose.cells.rendering/sheetrender/toimage/
---
...
//Le code suivant exporte la première page de la première feuille en image PNG.
...
//Rendre la première feuille.
SheetRender sr(wb.GetWorksheets().Get(0), imgOpt);

//Exporter la première page de la feuille en image.
