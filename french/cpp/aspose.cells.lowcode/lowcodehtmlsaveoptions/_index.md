---
title: Aspose::Cells::LowCode::LowCodeHtmlSaveOptions class
linktitle: LowCodeHtmlSaveOptions
second_title: Aspose.Cells for C++ API Reference
description: 'Aspose::Cells::LowCode::LowCodeHtmlSaveOptions class. Options for saving html in low code way in C++.'
type: docs
weight: 700
url: /fr/cpp/aspose.cells.lowcode/lowcodehtmlsaveoptions/
---
...
| [LowCodeHtmlSaveOptions()](./lowcodehtmlsaveoptions/) | Default constructor. |
| [LowCodeHtmlSaveOptions(LowCodeHtmlSaveOptions_Impl* impl)](./lowcodehtmlsaveoptions/) | Constructs from an implementation object. |
| [LowCodeHtmlSaveOptions(const LowCodeHtmlSaveOptions\& src)](./lowcodehtmlsaveoptions/) | Copy constructor. |
| [LowCodeHtmlSaveOptions(const LowCodeSaveOptions\& src)](./lowcodehtmlsaveoptions/) | Constructs from a parent object. |
...
| [operator=(const LowCodeHtmlSaveOptions\& src)](./operator_asm/) | operator= |
| [operator=(const LowCodeSaveOptions\& src)](../lowcodesaveoptions/operator_asm/) | operator= |
| [SetHtmlOptions(const HtmlSaveOptions\& value)](./sethtmloptions/) | The general options for saving html. |
...
| [SetSaveFormat(SaveFormat value)](./setsaveformat/) | Gets and sets the format of spreadsheet. |
| [~LowCodeHtmlSaveOptions()](./~lowcodehtmlsaveoptions/) | Destructor. |
