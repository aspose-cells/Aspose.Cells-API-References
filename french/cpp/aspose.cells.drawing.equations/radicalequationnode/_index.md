---
title: Aspose::Cells::Drawing::Equations::RadicalEquationNode class
linktitle: RadicalEquationNode
second_title: Aspose.Cells for C++ API Reference
description: 'Aspose::Cells::Drawing::Equations::RadicalEquationNode class. This class specifies the radical equation, consisting of an optional degree deg(EquationNodeType.Degree) and a base in C++.'
type: docs
weight: 1700
url: /fr/cpp/aspose.cells.drawing.equations/radicalequationnode/
---
## RadicalEquationNode class


This class specifies the radical equation, consisting of an optional degree deg([EquationNodeType.Degree](../equationnodetype/)) and a base.
...
| [operator=(const RadicalEquationNode\& src)](./operator_asm/) | operator= |
...
| [RadicalEquationNode(RadicalEquationNode_Impl* impl)](./radicalequationnode/) | Constructs from an implementation object. |
| [RadicalEquationNode(const RadicalEquationNode\& src)](./radicalequationnode/) | Copy constructor. |
| [RadicalEquationNode(const EquationNode\& src)](./radicalequationnode/) | Constructs from a parent object. |
