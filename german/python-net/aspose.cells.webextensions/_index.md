...
type: docs
weight: 10
url: /de/python-net/aspose.cells.webextensions/
is_root: false
---
 Der**Aspose.Cells.WebExtensions** Namespace enthält Klassen für den Zugriff auf das Office-Add-In in Excel-Dateien.
...
| :- | :- |
| [WebExtensionStoreType](/cells/de/python-net/aspose.cells.webextensions/webextensionstoretype) | Stellt den Geschäftstyp der Weberweiterung dar.|
