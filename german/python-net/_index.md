...
| [aspose.cells.metadata](/cells/de/python-net/aspose.cells.metadata) | Der**Aspose.Cells.Metadata** Namespace enthält alle Klassen zum Laden und Speichern von Metadaten von Spreadsheets.|
| [aspose.cells.numbers](/cells/de/python-net/aspose.cells.numbers) | Der**Aspose.Cells.Numbers** Namespace enthält alle Klassen zum Laden und Konvertieren von Apple Numbers-Dateien.|
| [aspose.cells.ods](/cells/de/python-net/aspose.cells.ods) | Der**Aspose.Cells.Ods** Namespace enthält alle Klassen zum Laden und Konvertieren von OpenDocument Spreadsheet-Dateien.|
...
| [aspose.cells.settings](/cells/de/python-net/aspose.cells.settings) | Der**Aspose.Cells.Settings** Namespace enthält Klassen, die Einstellungen für verschiedene Funktionen definieren.|
| [aspose.cells.slicers](/cells/de/python-net/aspose.cells.slicers) | Der**Aspose.Cells.Slicers** namespace stellt alle Klassen für Pivot-Tabellendatenschnittoptionen für Excel-Tabellendateien bereit.|
| [aspose.cells.tables](/cells/de/python-net/aspose.cells.tables) | Der**Aspose.Cells.Tables** Namespace enthält Klassen, die Tabellen, Zeilen, Zellen und deren Formatierung für Excel-Tabellendateien darstellen.|
| [aspose.cells.timelines](/cells/de/python-net/aspose.cells.timelines) | Der**Aspose.Cells.Timelines**Namespace enthält Klassen, die den Zugriff auf und das Zeichnen von Zeitleisten in Excel-Tabellendateien ermöglichen.|
| [aspose.cells.utility](/cells/de/python-net/aspose.cells.utility) | Der**Aspose.Cells.Utility** Namespace enthält Hilfsklassen, die JSON-Formate für Excel-Tabellendateien verarbeiten.|
| [aspose.cells.vba](/cells/de/python-net/aspose.cells.vba) | Der**Aspose.Cells.Vba** namespace enthält Klassen für den Zugriff auf Visual Basic Analysis-Projekte und -Module in Excel-Tabellendateien.|
| [aspose.cells.webextensions](/cells/de/python-net/aspose.cells.webextensions) | Der**Aspose.Cells.WebExtensions** Namespace enthält Klassen für den Zugriff auf das Office-Add-In in Excel-Dateien.|
