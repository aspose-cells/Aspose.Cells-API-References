...
type: docs
weight: 810
url: /de/python-net/aspose.cells.drawing/fillpattern/
is_root: false
---
##  FillPattern Aufzählung
Zählt Formfüllmustertypen auf.



Der Typ FillPattern macht die folgenden Member verfügbar:
...
| GRAY80 | Repräsentiert 80 % graues Muster.|
| GRAY90 | Repräsentiert 90 % graues Muster.|
...
| NARROW_VERTICAL | Stellt ein schmales vertikales Muster dar.|
| NARROW_HORIZONTAL | Stellt ein schmales horizontales Muster dar.|
...
| ZIG_ZAG | Stellt ein Zick-Zack-Muster dar.|
| WAVE | Repräsentiert ein Wellenmuster.|
| DIAGONAL_BRICK | Stellt ein diagonales Ziegelsteinmuster dar.|
