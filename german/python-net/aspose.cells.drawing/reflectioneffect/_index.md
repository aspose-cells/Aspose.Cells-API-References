---
title: ReflectionEffect Klasse
second_title: Aspose.Cells for Python via .NET API Referenzen
description:
type: docs
weight: 490
url: /de/python-net/aspose.cells.drawing/reflectioneffect/
is_root: false
---
##  ReflectionEffect Klasse
Diese Klasse spezifiziert einen Reflexionseffekt.



Der Typ ReflectionEffect macht die folgenden Member verfügbar:
...
| [fade_direction](/cells/de/python-net/aspose.cells.drawing/reflectioneffect/fade_direction) | Ruft die Richtung zum Versetzen der Reflexion ab und legt diese fest.|
| [rot_with_shape](/cells/de/python-net/aspose.cells.drawing/reflectioneffect/rot_with_shape) | Ruft ab und legt fest, ob sich die Reflexion mit der Form drehen soll.|
