---
title: MsoPresetTextEffectShape Aufzählung
second_title: Aspose.Cells for Python via .NET API Referenzen
description:
type: docs
weight: 1040
url: /de/python-net/aspose.cells.drawing/msopresettexteffectshape/
is_root: false
---
##  MsoPresetTextEffectShape Aufzählung
Stellt den voreingestellten Texteffekt-Formtyp von WordArt dar.



Der Typ MsoPresetTextEffectShape macht die folgenden Member verfügbar:
