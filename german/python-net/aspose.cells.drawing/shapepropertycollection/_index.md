---
title: ShapePropertyCollection Klasse
second_title: Aspose.Cells for Python via .NET API Referenzen
description:
type: docs
weight: 610
url: /de/python-net/aspose.cells.drawing/shapepropertycollection/
is_root: false
---
##  ShapePropertyCollection Klasse
Diese Klasse gibt die visuellen Formeigenschaften für ein Diagrammelement oder eine Form an.



Der Typ ShapePropertyCollection macht die folgenden Member verfügbar:
...
| [clear_shadow_effect()](/cells/de/python-net/aspose.cells.drawing/shapepropertycollection/clear_shadow_effect/#) | Hebt den Schatteneffekt des Diagrammelements oder der Form auf.|
| [has_shadow_effect()](/cells/de/python-net/aspose.cells.drawing/shapepropertycollection/has_shadow_effect/#) | Gibt an, ob die Form über Schatteneffektdaten verfügt.|
