---
title: ThreeDFormat Klasse
second_title: Aspose.Cells for Python via .NET API Referenzen
description:
type: docs
weight: 720
url: /de/python-net/aspose.cells.drawing/threedformat/
is_root: false
---
##  ThreeDFormat Klasse
...
Der Typ ThreeDFormat macht die folgenden Member verfügbar:

###  Eigenschaften
| Eigentum| Beschreibung|
| :- | :- |
| [bottom_bevel_width](/cells/de/python-net/aspose.cells.drawing/threedformat/bottom_bevel_width) | Ruft die Breite der unteren Fase ab und legt sie fest, oder wie weit sie in die Form hinein angewendet wird.<br/> In Einheiten von Punkten.|
| [bottom_bevel_height](/cells/de/python-net/aspose.cells.drawing/threedformat/bottom_bevel_height) | Ruft die Höhe der unteren Abschrägung ab und legt sie fest, oder wie weit sie in die Form hinein angewendet wird.<br/> In Einheiten von Punkten.|
...
| [light_angle](/cells/de/python-net/aspose.cells.drawing/threedformat/light_angle) | Ruft den Winkel der Extrusionslichter ab und legt diesen fest.|
| [lighting](/cells/de/python-net/aspose.cells.drawing/threedformat/lighting) | Erhält und setzt den Typ des leichten Rigs.|
| [lighting_direction](/cells/de/python-net/aspose.cells.drawing/threedformat/lighting_direction) | Ruft die Richtung ab, aus der das Licht-Rig in Bezug auf die Szene ausgerichtet ist, und legt diese fest.|
