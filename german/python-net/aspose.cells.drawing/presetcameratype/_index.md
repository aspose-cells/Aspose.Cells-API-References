---
title: PresetCameraType Aufzählung
second_title: Aspose.Cells for Python via .NET API Referenzen
description:
type: docs
weight: 1060
url: /de/python-net/aspose.cells.drawing/presetcameratype/
is_root: false
---
##  PresetCameraType Aufzählung
Repräsentieren verschiedene algorithmische Methoden zum Einstellen aller Kameraeigenschaften, einschließlich der Position.



Der Typ PresetCameraType macht die folgenden Member verfügbar:
