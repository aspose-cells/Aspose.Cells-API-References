---
title: RevisionType Aufzählung
second_title: Aspose.Cells for Python via .NET API Referenzen
description:
type: docs
weight: 190
url: /de/python-net/aspose.cells.revisions/revisiontype/
is_root: false
---
##  RevisionType Aufzählung
Stellt den Revisionstyp dar.



Der Typ RevisionType macht die folgenden Member verfügbar:
