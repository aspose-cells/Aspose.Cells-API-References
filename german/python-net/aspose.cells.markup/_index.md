...
type: docs
weight: 10
url: /de/python-net/aspose.cells.markup/
is_root: false
---
 Der**Aspose.Cells.Markup** namespace enthält Klassen, die kundendefinierte Semantik in einem Dokument darstellen: intelligente Tags, benutzerdefiniertes XML und weitere Markup-Tags.

###  Klassen
| Klasse| Beschreibung|
| :- | :- |
| [CustomXmlPart](/cells/de/python-net/aspose.cells.markup/customxmlpart) | Repräsentiert einen benutzerdefinierten XML-Datenspeicherteil (benutzerdefinierte XML-Daten innerhalb eines Pakets).|
| [CustomXmlPartCollection](/cells/de/python-net/aspose.cells.markup/customxmlpartcollection) | Repräsentiert einen benutzerdefinierten XML-Datenspeicherteil (benutzerdefinierte XML-Daten innerhalb eines Pakets).|
| [SmartTag](/cells/de/python-net/aspose.cells.markup/smarttag) | Stellt ein Smarttag dar.|
