---
title: ExportRangeToJsonOptions Klasse
second_title: Aspose.Cells for Python via .NET API Referenzen
description:
type: docs
weight: 10
url: /de/python-net/aspose.cells.utility/exportrangetojsonoptions/
is_root: false
---
##  ExportRangeToJsonOptions Klasse
Gibt die Optionen an, die beim Exportieren in json reichen.



Der Typ ExportRangeToJsonOptions macht die folgenden Member verfügbar:

###  Konstrukteure
| Konstrukteur| Beschreibung|
| :- | :- |
| [ExportRangeToJsonOptions()](/cells/de/python-net/aspose.cells.utility/exportrangetojsonoptions/__init__/#) | Erstellt eine neue Instanz von ExportRangeToJsonOptions|
