---
title: UnknownControl Klasse
second_title: Aspose.Cells for Python via .NET API Referenzen
description:
type: docs
weight: 140
url: /de/python-net/aspose.cells.drawing.activexcontrols/unknowncontrol/
is_root: false
---
##  UnknownControl Klasse
Unbekannte Kontrolle.



**Nachlass:** [UnknownControl](/cells/python-net/aspose.cells.drawing.activexcontrols/unknowncontrol) → 
...
Der Typ UnknownControl macht die folgenden Member verfügbar:
...
| [shadow](/cells/de/python-net/aspose.cells.drawing.activexcontrols/unknowncontrol/shadow) | Gibt an, ob ein Schatten angezeigt werden soll.|
| [linked_cell](/cells/de/python-net/aspose.cells.drawing.activexcontrols/unknowncontrol/linked_cell) | Ruft die verknüpfte Zelle ab und legt sie fest.|
| [list_fill_range](/cells/de/python-net/aspose.cells.drawing.activexcontrols/unknowncontrol/list_fill_range) | Ruft den Füllbereich der Liste ab und legt ihn fest.|
...
| :- | :- |
| [get_relationship_data(rel_id)](/cells/de/python-net/aspose.cells.drawing.activexcontrols/unknowncontrol/get_relationship_data/#str) | Ruft die zugehörigen Daten ab.|
...
* Klasse [UnknownControl](/cells/de/python-net/aspose.cells.drawing.activexcontrols/unknowncontrol)
