...
type: docs
weight: 10
url: /de/python-net/aspose.cells.tables/
is_root: false
---
 Der**Aspose.Cells.Tables** Namespace enthält Klassen, die Tabellen, Zeilen, Zellen und deren Formatierung für Excel-Tabellendateien darstellen.

###  Klassen
| Klasse| Beschreibung|
| :- | :- |
| [ListColumn](/cells/de/python-net/aspose.cells.tables/listcolumn) | Stellt eine Spalte in einer Liste dar.|
| [ListColumnCollection](/cells/de/python-net/aspose.cells.tables/listcolumncollection) | Stellt eine Auflistung aller [ListColumn](/cells/de/python-net/aspose.cells.tables/listcolumn)-Objekte im angegebenen ListObject-Objekt dar.|
| [ListObject](/cells/de/python-net/aspose.cells.tables/listobject) | Stellt ein Listenobjekt auf einem Arbeitsblatt dar.<br/> Das ListObject-Objekt ist ein Mitglied der ListObjects-Auflistung.<br/> Die ListObjects-Auflistung enthält alle Listenobjekte auf einem Arbeitsblatt.|
| [ListObjectCollection](/cells/de/python-net/aspose.cells.tables/listobjectcollection) | Stellt eine Sammlung von [ListObject](/cells/de/python-net/aspose.cells.tables/listobject)-Objekten im Arbeitsblatt dar.|
