...
type: docs
weight: 10
url: /de/python-net/aspose.cells.querytables/
is_root: false
---
 Der**Aspose.Cells.QueryTables** namespace bietet Klassen für den Zugriff auf und die Aktualisierung von Arbeitsblatttabellen, die aus Daten erstellt wurden, die von einer externen Datenquelle wie einem SQL-Server oder einer Microsoft Access-Datenbank zurückgegeben wurden.

###  Klassen
| Klasse| Beschreibung|
| :- | :- |
| [DataMashup](/cells/de/python-net/aspose.cells.querytables/datamashup) | Stellt Mashup-Daten dar.|
| [PowerQueryFormula](/cells/de/python-net/aspose.cells.querytables/powerqueryformula) | Stellt die Definition der Power-Query-Formel dar.|
