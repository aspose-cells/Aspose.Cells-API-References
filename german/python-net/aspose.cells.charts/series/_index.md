...
type: docs
weight: 230
url: /de/python-net/aspose.cells.charts/series/
is_root: false
---
##  Series Klasse
...
Der Typ Series macht die folgenden Member verfügbar:
...
| [count_of_data_values](/cells/de/python-net/aspose.cells.charts/series/count_of_data_values) | Ruft die Anzahl der Datenwerte ab.|
...
| [has_3d_effect](/cells/de/python-net/aspose.cells.charts/series/has_3d_effect) |True, wenn die Reihe dreidimensional aussieht.<br/> Gilt nur für Blasendiagramme.|
| [bar_3d_shape_type](/cells/de/python-net/aspose.cells.charts/series/bar_3d_shape_type) | Ruft den mit dem 3D-Balken- oder Säulendiagramm verwendeten 3D-Formtyp ab oder legt diesen fest.|
| [bar_shape](/cells/de/python-net/aspose.cells.charts/series/bar_shape) | Ruft den mit dem 3D-Balken- oder Säulendiagramm verwendeten 3D-Formtyp ab oder legt diesen fest.|
| [data_labels](/cells/de/python-net/aspose.cells.charts/series/data_labels) | Repräsentiert das DataLabels-Objekt für die angegebene ASeries.|
| [type](/cells/de/python-net/aspose.cells.charts/series/type) | Ruft den Typ einer Datenreihe ab oder legt ihn fest.|
| [marker](/cells/de/python-net/aspose.cells.charts/series/marker) | Ruft die [Series.marker](/cells/de/python-net/aspose.cells.charts/series#marker) ab.|
| [plot_on_second_axis](/cells/de/python-net/aspose.cells.charts/series/plot_on_second_axis) | Gibt an, ob diese Reihe auf der zweiten Werteachse dargestellt wird.|
| [x_error_bar](/cells/de/python-net/aspose.cells.charts/series/x_error_bar) | Stellt den X-Richtungsfehlerbalken der Serie dar.|
| [y_error_bar](/cells/de/python-net/aspose.cells.charts/series/y_error_bar) | Stellt den Y-Richtungsfehlerbalken der Reihe dar.|
| [has_hi_lo_lines](/cells/de/python-net/aspose.cells.charts/series/has_hi_lo_lines) | True, wenn das Liniendiagramm High-Low-Linien enthält.<br/> Gilt nur für Liniendiagramme.|
| [hi_lo_lines](/cells/de/python-net/aspose.cells.charts/series/hi_lo_lines) | Gibt ein HiLoLines-Objekt zurück, das die Hoch-Tief-Linien für eine Reihe in einem Liniendiagramm darstellt.<br/> Gilt nur für Liniendiagramme.|
| [has_series_lines](/cells/de/python-net/aspose.cells.charts/series/has_series_lines) | True, wenn ein gestapeltes Säulen- oder Balkendiagramm Serienlinien oder aufweist<br/> wenn ein Tortendiagramm oder ein Balkendiagramm Verbindungslinien zwischen den beiden Abschnitten aufweist.<br/> Gilt nur für gestapelte Säulendiagramme, Balkendiagramme, Kreisdiagramme oder Kreisdiagramme.|
| [series_lines](/cells/de/python-net/aspose.cells.charts/series/series_lines) | Gibt ein SeriesLines-Objekt zurück, das die Reihenlinien für ein gestapeltes Balkendiagramm oder ein gestapeltes Säulendiagramm darstellt.<br/> Gilt nur für gestapelte Balken- und gestapelte Säulendiagramme.|
| [has_drop_lines](/cells/de/python-net/aspose.cells.charts/series/has_drop_lines) |True, wenn das Diagramm Falllinien enthält.<br/> Gilt nur für Liniendiagramme oder Flächendiagramme.|
| [drop_lines](/cells/de/python-net/aspose.cells.charts/series/drop_lines) | Gibt ein [Line](/cells/de/python-net/aspose.cells.drawing/line)-Objekt zurück, das die Falllinien für eine Reihe im Linien- oder Flächendiagramm darstellt.<br/> Gilt nur für Liniendiagramme oder Flächendiagramme.|
| [has_up_down_bars](/cells/de/python-net/aspose.cells.charts/series/has_up_down_bars) | True, wenn ein Liniendiagramm Aufwärts- und Abwärtsbalken hat.<br/> Gilt nur für Liniendiagramme.|
| [up_bars](/cells/de/python-net/aspose.cells.charts/series/up_bars) | Gibt ein DropBars-Objekt zurück, das die Aufwärtsbalken in einem Liniendiagramm darstellt.<br/> Gilt nur für Liniendiagramme.|
...
| [split_value](/cells/de/python-net/aspose.cells.charts/series/split_value) | Gibt einen Wert zurück oder setzt ihn, der verwendet werden soll, um zu bestimmen, welche Datenpunkte sich im zweiten Kreis oder Balken befinden<br/> ein Tortendiagramm oder ein Tortendiagramm.|
...
| :- | :- |
| [move(count)](/cells/de/python-net/aspose.cells.charts/series/move/#int) | Verschiebt die Reihe nach oben oder unten.|
...
* Klasse [DropBars](/cells/de/python-net/aspose.cells.charts/dropbars)
