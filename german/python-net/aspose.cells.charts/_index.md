...
type: docs
weight: 10
url: /de/python-net/aspose.cells.charts/
is_root: false
---
 Der**Aspose.Cells.Charts** namespace stellt Klassen bereit, die den Zugriff auf und das Zeichnen von Diagrammen und Sparklines in Microsoft Excel-Tabellen ermöglichen.

###  Klassen
| Klasse| Beschreibung|
| :- | :- |
| [Axis](/cells/de/python-net/aspose.cells.charts/axis) | Kapselt das Objekt, das die Achse eines Diagramms darstellt.|
...
| [DisplayUnitLabel](/cells/de/python-net/aspose.cells.charts/displayunitlabel) | Stellt die Beschriftung der Anzeigeeinheit dar.|
| [DropBars](/cells/de/python-net/aspose.cells.charts/dropbars) | Stellt die Aufwärts-/Abwärtsbalken in einem Diagramm dar.|
| [ErrorBar](/cells/de/python-net/aspose.cells.charts/errorbar) | Stellt den Fehlerbalken der Datenreihe dar.|
| [Floor](/cells/de/python-net/aspose.cells.charts/floor) | Kapselt das Objekt, das den Boden eines 3D-Diagramms darstellt.|
| [Legend](/cells/de/python-net/aspose.cells.charts/legend) | Kapselt das Objekt, das die Diagrammlegende darstellt.|
| [LegendEntry](/cells/de/python-net/aspose.cells.charts/legendentry) | Stellt einen Legendeneintrag in einer Diagrammlegende dar.|
| [LegendEntryCollection](/cells/de/python-net/aspose.cells.charts/legendentrycollection) | Stellt eine Sammlung aller [LegendEntry](/cells/de/python-net/aspose.cells.charts/legendentry)-Objekte in der angegebenen Diagrammlegende dar.|
...
| [Trendline](/cells/de/python-net/aspose.cells.charts/trendline) | Stellt eine Trendlinie in einem Diagramm dar.|
| [TrendlineCollection](/cells/de/python-net/aspose.cells.charts/trendlinecollection) | Stellt eine Sammlung aller [Trendline](/cells/de/python-net/aspose.cells.charts/trendline)-Objekte für die angegebene Datenreihe dar.|
| [Walls](/cells/de/python-net/aspose.cells.charts/walls) | Kapselt das Objekt, das die Wände eines 3D-Diagramms darstellt.|
...
| [ChartMarkerType](/cells/de/python-net/aspose.cells.charts/chartmarkertype) | Stellt den Markierungsstil in einem Liniendiagramm, Streudiagramm oder Netzdiagramm dar.|
| [ChartSplitType](/cells/de/python-net/aspose.cells.charts/chartsplittype) | Stellt dar, wie die beiden Abschnitte entweder eines Tortendiagramms oder eines Balkens eines Tortendiagramms geteilt werden.|
| [ChartTextDirectionType](/cells/de/python-net/aspose.cells.charts/charttextdirectiontype) | Stellt den Textrichtungstyp des Diagramms dar.|
| [ChartType](/cells/de/python-net/aspose.cells.charts/charttype) | Listet alle in Excel verwendeten Diagrammtypen auf.|
| [CrossType](/cells/de/python-net/aspose.cells.charts/crosstype) | Repräsentiert den Achsenkreuztyp.|
| [DataLabelsSeparatorType](/cells/de/python-net/aspose.cells.charts/datalabelsseparatortype) | Stellt den Trennzeichentyp von DataLabels dar.|
...
| [TrendlineType](/cells/de/python-net/aspose.cells.charts/trendlinetype) | Stellt den Trendlinientyp dar.|
