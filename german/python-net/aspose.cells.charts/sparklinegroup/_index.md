...
type: docs
weight: 280
url: /de/python-net/aspose.cells.charts/sparklinegroup/
is_root: false
---
...
Der Typ SparklineGroup macht die folgenden Member verfügbar:
...
| [show_negative_points](/cells/de/python-net/aspose.cells.charts/sparklinegroup/show_negative_points) | Gibt an, ob die negativen Werte in der Sparkline-Gruppe mit einer anderen Farbe oder Markierung hervorgehoben werden sollen.|
| [negative_points_color](/cells/de/python-net/aspose.cells.charts/sparklinegroup/negative_points_color) | Ruft die Farbe der negativen Werte in der Sparkline-Gruppe ab und legt sie fest.|
| [show_first_point](/cells/de/python-net/aspose.cells.charts/sparklinegroup/show_first_point) | Gibt an, ob der erste Datenpunkt in der Sparkline-Gruppe hervorgehoben werden soll.|
...
| [line_weight](/cells/de/python-net/aspose.cells.charts/sparklinegroup/line_weight) | Ruft die Linienstärke in jeder Sparkline-Linie in der Sparkline-Gruppe in Punkteinheiten ab und legt sie fest.|
| [horizontal_axis_color](/cells/de/python-net/aspose.cells.charts/sparklinegroup/horizontal_axis_color) | Ruft die Farbe der horizontalen Achse in der Sparkline-Gruppe ab und legt sie fest.|
| [show_horizontal_axis](/cells/de/python-net/aspose.cells.charts/sparklinegroup/show_horizontal_axis) | Gibt an, ob die horizontale Sparkline-Achse angezeigt werden soll.<br/> Die horizontale Achse wird angezeigt, wenn die Sparkline Daten enthält, die die Nullachse kreuzen.|
| [horizontal_axis_date_range](/cells/de/python-net/aspose.cells.charts/sparklinegroup/horizontal_axis_date_range) | Stellt den Bereich dar, der die Datumswerte für die Sparkline-Daten enthält.|
| [vertical_axis_max_value_type](/cells/de/python-net/aspose.cells.charts/sparklinegroup/vertical_axis_max_value_type) | Stellt den Maximalwerttyp der vertikalen Achse dar.|
| [vertical_axis_max_value](/cells/de/python-net/aspose.cells.charts/sparklinegroup/vertical_axis_max_value) | Ruft den benutzerdefinierten Maximalwert für die vertikale Achse ab und legt ihn fest.|
| [vertical_axis_min_value_type](/cells/de/python-net/aspose.cells.charts/sparklinegroup/vertical_axis_min_value_type) | Stellt den Minimalwerttyp der vertikalen Achse dar.|
| [vertical_axis_min_value](/cells/de/python-net/aspose.cells.charts/sparklinegroup/vertical_axis_min_value) | Ruft den benutzerdefinierten Mindestwert für die vertikale Achse ab und legt ihn fest.|
...
* Klasse [Sparkline](/cells/de/python-net/aspose.cells.charts/sparkline)
