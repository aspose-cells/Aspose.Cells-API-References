...
type: docs
weight: 10
url: /de/python-net/aspose.cells.charts/axis/
is_root: false
---
##  Axis Klasse
...
| :- | :- |
| [area](/cells/de/python-net/aspose.cells.charts/axis/area) | Ruft die [Axis.area](/cells/de/python-net/aspose.cells.charts/axis#area) ab.|
| [is_automatic_min_value](/cells/de/python-net/aspose.cells.charts/axis/is_automatic_min_value) | Gibt an, ob der Mindestwert automatisch zugewiesen wird.|
| [min_value](/cells/de/python-net/aspose.cells.charts/axis/min_value) | Stellt den Mindestwert auf der Werteachse dar.|
...
| [major_tick_mark](/cells/de/python-net/aspose.cells.charts/axis/major_tick_mark) | Repräsentiert den Typ des Hauptteilstrichs für die angegebene Achse.|
| [minor_tick_mark](/cells/de/python-net/aspose.cells.charts/axis/minor_tick_mark) | Stellt den Typ des kleinen Teilstrichs für die angegebene Achse dar.|
...
| [display_unit_label](/cells/de/python-net/aspose.cells.charts/axis/display_unit_label) | Stellt eine Einheitenbeschriftung auf einer Achse im angegebenen Diagramm dar.<br/> Einheitenbeschriftungen sind nützlich, um große Werte grafisch darzustellen, z. B. in Millionen oder Milliarden.|
| [is_display_unit_label_shown](/cells/de/python-net/aspose.cells.charts/axis/is_display_unit_label_shown) | Stellt dar, ob die Bezeichnung der Anzeigeeinheit auf der angegebenen Achse angezeigt wird.|
| [title](/cells/de/python-net/aspose.cells.charts/axis/title) | Ruft den Titel der Achse ab.|
| [category_type](/cells/de/python-net/aspose.cells.charts/axis/category_type) | Stellt den Kategorieachsentyp dar.|
| [base_unit_scale](/cells/de/python-net/aspose.cells.charts/axis/base_unit_scale) | Stellt die Basiseinheitsskala für die Kategorieachse dar.|
| [major_unit_scale](/cells/de/python-net/aspose.cells.charts/axis/major_unit_scale) | Stellt die Haupteinheitsskala für die Kategorieachse dar.|
| [minor_unit_scale](/cells/de/python-net/aspose.cells.charts/axis/minor_unit_scale) | Stellt die Haupteinheitsskala für die Kategorieachse dar.|
