---
title: PivotGlobalizationSettings Klasse
second_title: Aspose.Cells for Python via .NET API Referenzen
description:
type: docs
weight: 10
url: /de/python-net/aspose.cells.settings/pivotglobalizationsettings/
is_root: false
---
##  PivotGlobalizationSettings Klasse
Stellt die Globalisierungseinstellungen für Pivot-Tabellen dar.



Der Typ PivotGlobalizationSettings macht die folgenden Member verfügbar:

###  Konstrukteure
| Konstrukteur| Beschreibung|
| :- | :- |
| [PivotGlobalizationSettings()](/cells/de/python-net/aspose.cells.settings/pivotglobalizationsettings/__init__/#) | Erstellt eine neue Instanz von PivotGlobalizationSettings|
