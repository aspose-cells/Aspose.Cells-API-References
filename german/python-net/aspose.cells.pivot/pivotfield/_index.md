...
type: docs
weight: 10
url: /de/python-net/aspose.cells.pivot/pivotfield/
is_root: false
---
##  PivotField Klasse
...
| [is_auto_sort](/cells/de/python-net/aspose.cells.pivot/pivotfield/is_auto_sort) | Gibt an, ob das angegebene PivotTable-Feld automatisch sortiert wird.|
| [is_ascend_sort](/cells/de/python-net/aspose.cells.pivot/pivotfield/is_ascend_sort) | Gibt an, ob das angegebene PivotTable-Feld automatisch aufsteigend sortiert ist.|
...
| [base_field_index](/cells/de/python-net/aspose.cells.pivot/pivotfield/base_field_index) | Stellt das Basisfeld für eine benutzerdefinierte Berechnung dar.|
| [base_item_position](/cells/de/python-net/aspose.cells.pivot/pivotfield/base_item_position) | Stellt das Element im Basisfeld für eine benutzerdefinierte Berechnung dar.<br/> Gilt nur für Datenfelder.<br/>Da PivotItemPosition.Custom nur zum Lesen dient, müssen Sie PivotItemPosition.Custom festlegen,<br/> Bitte setzen Sie das Attribut PivotField.BaseItemIndex.|
| [base_item_index](/cells/de/python-net/aspose.cells.pivot/pivotfield/base_item_index) | Stellt das Element im Basisfeld für eine benutzerdefinierte Berechnung dar.<br/> Gilt nur für Datenfelder.|
...
| :- | :- |
| [hide_item(index, is_hidden)](/cells/de/python-net/aspose.cells.pivot/pivotfield/hide_item/#int-bool) | Legt fest, ob das bestimmte PivotItem in einem Datenfeld ausgeblendet ist.|
| [hide_item(item_value, is_hidden)](/cells/de/python-net/aspose.cells.pivot/pivotfield/hide_item/#str-bool) | Legt fest, ob das bestimmte PivotItem in einem Datenfeld ausgeblendet ist.|
| [get_pivot_filter_by_type(type)](/cells/de/python-net/aspose.cells.pivot/pivotfield/get_pivot_filter_by_type/#PivotFilterType) | Ruft den Pivot-Filter des Pivot-Felds nach Typ ab|
| [get_pivot_filters()](/cells/de/python-net/aspose.cells.pivot/pivotfield/get_pivot_filters/#) | Ruft die Pivot-Filter des Pivot-Felds ab|
| [init_pivot_items()](/cells/de/python-net/aspose.cells.pivot/pivotfield/init_pivot_items/#) | Initialisieren Sie die Pivot-Elemente des Pivot-Felds|
