---
title: PasteOptions Klasse
second_title: Aspose.Cells for Python via .NET API Referenzen
description:
type: docs
weight: 1170
url: /de/python-net/aspose.cells/pasteoptions/
is_root: false
---
##  PasteOptions Klasse
Stellt die Optionen zum Einfügen von Spezial dar.



Der Typ PasteOptions macht die folgenden Member verfügbar:

###  Konstrukteure
| Konstrukteur| Beschreibung|
| :- | :- |
| [PasteOptions()](/cells/de/python-net/aspose.cells/pasteoptions/__init__/#) | Erstellt eine neue Instanz von PasteOptions|
