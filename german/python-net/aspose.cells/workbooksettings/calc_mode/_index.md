...
type: docs
weight: 90
url: /de/python-net/aspose.cells/workbooksettings/calc_mode/
is_root: false
---
##  calc_mode Eigentum

Es gibt an, ob Formeln manuell berechnet werden sollen,
automatisch oder automatisch, außer bei Operationen mit mehreren Tabellen.
...
###  Siehe auch
* Modul [aspose.cells](../../)
* Klasse [CalcModeType](/cells/de/python-net/aspose.cells/calcmodetype)
