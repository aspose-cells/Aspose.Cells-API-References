...
type: docs
weight: 1610
url: /de/python-net/aspose.cells/workbooksettings/
is_root: false
---
...
Der Typ WorkbookSettings macht die folgenden Member verfügbar:

###  Eigenschaften
| Eigentum| Beschreibung|
| :- | :- |
| [stream_provider](/cells/de/python-net/aspose.cells/workbooksettings/stream_provider) | Ruft den Streamanbieter für externe Ressourcen ab und legt ihn fest.|
| [resource_provider](/cells/de/python-net/aspose.cells/workbooksettings/resource_provider) | Ruft den Streamanbieter für externe Ressourcen ab und legt ihn fest, z. B. das Laden von Bilddaten für ein Bild vom Typ „LinkToFile“.|
| [author](/cells/de/python-net/aspose.cells/workbooksettings/author) | Ruft den Autor der Datei ab und legt ihn fest.|
| [check_custom_number_format](/cells/de/python-net/aspose.cells/workbooksettings/check_custom_number_format) | Gibt an, ob das benutzerdefinierte Zahlenformat beim Festlegen von Style.Custom überprüft wird.|
| [enable_macros](/cells/de/python-net/aspose.cells/workbooksettings/enable_macros) | Makros aktivieren;|
| [date1904](/cells/de/python-net/aspose.cells/workbooksettings/date1904) | Ruft einen Wert ab oder legt einen Wert fest, der angibt, ob die Arbeitsmappe das Datumssystem 1904 verwendet.|
| [protection_type](/cells/de/python-net/aspose.cells/workbooksettings/protection_type) | Ruft den Schutztyp der Arbeitsmappe ab.|
| [display_drawing_objects](/cells/de/python-net/aspose.cells/workbooksettings/display_drawing_objects) | Gibt an, ob und wie Objekte in der Arbeitsmappe angezeigt werden.|
| [sheet_tab_bar_width](/cells/de/python-net/aspose.cells/workbooksettings/sheet_tab_bar_width) | Breite der Registerkartenleiste des Arbeitsblatts (in 1/1000 der Fensterbreite).|
| [show_tabs](/cells/de/python-net/aspose.cells/workbooksettings/show_tabs) | Ruft einen Wert ab oder legt einen Wert fest, ob die Registerkarten der Arbeitsmappe angezeigt werden.|
| [first_visible_tab](/cells/de/python-net/aspose.cells/workbooksettings/first_visible_tab) | Ruft die erste sichtbare Arbeitsblattregisterkarte ab oder legt diese fest.|
| [is_h_scroll_bar_visible](/cells/de/python-net/aspose.cells/workbooksettings/is_h_scroll_bar_visible) | Ruft einen Wert ab, der angibt, ob das generierte Arbeitsblatt eine horizontale Bildlaufleiste enthält, oder legt diesen fest.|
...
| [is_protected](/cells/de/python-net/aspose.cells/workbooksettings/is_protected) | Ruft einen Wert ab, der angibt, ob die Struktur oder das Fenster der Arbeitsmappe geschützt ist.|
| [is_default_encrypted](/cells/de/python-net/aspose.cells/workbooksettings/is_default_encrypted) | Gibt an, ob die Arbeitsmappe mit dem Standardkennwort verschlüsselt wird, wenn Struktur und Windows der Arbeitsmappe gesperrt sind.|
| [is_minimized](/cells/de/python-net/aspose.cells/workbooksettings/is_minimized) | Stellt dar, ob die generierte Tabelle minimiert geöffnet wird.|
| [is_hidden](/cells/de/python-net/aspose.cells/workbooksettings/is_hidden) | Gibt an, ob diese Arbeitsmappe ausgeblendet ist.|
| [auto_compress_pictures](/cells/de/python-net/aspose.cells/workbooksettings/auto_compress_pictures) | Gibt einen booleschen Wert an, der angibt, dass die Anwendung Bilder in der Arbeitsmappe automatisch komprimiert.|
| [remove_personal_information](/cells/de/python-net/aspose.cells/workbooksettings/remove_personal_information) | True, wenn persönliche Informationen aus der angegebenen Arbeitsmappe entfernt werden können.|
| [hide_pivot_field_list](/cells/de/python-net/aspose.cells/workbooksettings/hide_pivot_field_list) | Ruft ab und legt fest, ob die Feldliste für die PivotTable ausgeblendet wird.|
| [update_links_type](/cells/de/python-net/aspose.cells/workbooksettings/update_links_type) | Ruft ab und legt fest, wie externe Links aktualisiert werden, wenn die Arbeitsmappe geöffnet wird.|
| [max_row](/cells/de/python-net/aspose.cells/workbooksettings/max_row) | Ruft den maximalen Zeilenindex ab, nullbasiert.|
| [max_column](/cells/de/python-net/aspose.cells/workbooksettings/max_column) | Ruft den maximalen Spaltenindex ab, nullbasiert.|
| [parsing_formula_on_open](/cells/de/python-net/aspose.cells/workbooksettings/parsing_formula_on_open) | Gibt an, ob die Formel beim Lesen der Datei analysiert wird.|
| [window_left](/cells/de/python-net/aspose.cells/workbooksettings/window_left) |Der Abstand vom linken Rand des Clientbereichs zum linken Rand des Fensters in Punkteinheiten.|
| [window_left_inch](/cells/de/python-net/aspose.cells/workbooksettings/window_left_inch) | Der Abstand vom linken Rand des Clientbereichs zum linken Rand des Fensters.<br/> In Zolleinheit.|
| [window_left_cm](/cells/de/python-net/aspose.cells/workbooksettings/window_left_cm) | Der Abstand vom linken Rand des Clientbereichs zum linken Rand des Fensters.<br/> In der Einheit Zentimeter.|
| [window_top](/cells/de/python-net/aspose.cells/workbooksettings/window_top) | Der Abstand vom oberen Rand des Clientbereichs zum oberen Rand des Fensters in Punkteinheiten.|
...
| [recalculate_before_save](/cells/de/python-net/aspose.cells/workbooksettings/recalculate_before_save) | Gibt an, ob vor dem Speichern des Dokuments neu berechnet werden soll.|


###  Methoden
| Methode| Beschreibung|
| :- | :- |
| [get_theme_font(type)](/cells/de/python-net/aspose.cells/workbooksettings/get_theme_font/#FontSchemeType) | Ruft den Schriftartnamen des Standarddesigns ab.|
| [set_page_orientation_type(page_orientation_type)](/cells/de/python-net/aspose.cells/workbooksettings/set_page_orientation_type/#PageOrientationType) |Legen Sie die Art der Druckausrichtung für die gesamte Arbeitsmappe fest.|
