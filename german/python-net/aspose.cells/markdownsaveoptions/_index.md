...
type: docs
weight: 1030
url: /de/python-net/aspose.cells/markdownsaveoptions/
is_root: false
---
...
**Nachlass:** [MarkdownSaveOptions](/cells/python-net/aspose.cells/markdownsaveoptions) → 
[SaveOptions](/cells/de/python-net/aspose.cells/saveoptions)



Der Typ MarkdownSaveOptions macht die folgenden Member verfügbar:

###  Konstrukteure
| Konstrukteur| Beschreibung|
| :- | :- |
| [MarkdownSaveOptions()](/cells/de/python-net/aspose.cells/markdownsaveoptions/__init__/#) | Erstellt Optionen zum Speichern von Markdown-Dokumenten|


###  Eigenschaften
| Eigentum| Beschreibung|
| :- | :- |
| [save_format](/cells/de/python-net/aspose.cells/markdownsaveoptions/save_format) | Ruft das Sicherungsdateiformat ab.|
| [clear_data](/cells/de/python-net/aspose.cells/markdownsaveoptions/clear_data) | Machen Sie die Arbeitsmappe nach dem Speichern der Datei leer.|
| [cached_file_folder](/cells/de/python-net/aspose.cells/markdownsaveoptions/cached_file_folder) | Der zwischengespeicherte Dateiordner wird verwendet, um einige große Daten zu speichern.|
| [validate_merged_areas](/cells/de/python-net/aspose.cells/markdownsaveoptions/validate_merged_areas) | Gibt an, ob verbundene Zellen vor dem Speichern der Datei validiert werden sollen.|
...
###  Siehe auch
* Modul [aspose.cells](..)
* Klasse [MarkdownSaveOptions](/cells/de/python-net/aspose.cells/markdownsaveoptions)
