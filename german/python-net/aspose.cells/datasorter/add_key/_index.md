...
type: docs
weight: 20
url: /de/python-net/aspose.cells/datasorter/add_key/
is_root: false
---
...
| order | [SortOrder](/cells/de/python-net/aspose.cells/sortorder) | Die Sortierreihenfolge|
...
| :- | :- | :- |
| key | int | Der sortierte Spaltenindex (absolute Position, Spalte A ist 0, B ist 1, ...)|
| type | [SortOnType](/cells/de/python-net/aspose.cells/sortontype) | Der sortierte Werttyp.|
| order | [SortOrder](/cells/de/python-net/aspose.cells/sortorder) | Die Sortierreihenfolge.|
