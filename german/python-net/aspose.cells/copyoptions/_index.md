...
type: docs
weight: 360
url: /de/python-net/aspose.cells/copyoptions/
is_root: false
---
##  CopyOptions Klasse
...
Der Typ CopyOptions macht die folgenden Member verfügbar:

###  Konstrukteure
| Konstrukteur| Beschreibung|
| :- | :- |
| [CopyOptions()](/cells/de/python-net/aspose.cells/copyoptions/__init__/#) | CopyOptions-Konstruktor.|


###  Eigenschaften
| Eigentum| Beschreibung|
| :- | :- |
| [keep_macros](/cells/de/python-net/aspose.cells/copyoptions/keep_macros) | Gibt an, ob Makros beibehalten werden;|
| [extend_to_adjacent_range](/cells/de/python-net/aspose.cells/copyoptions/extend_to_adjacent_range) | Gibt an, ob Bereiche erweitert werden, wenn der Bereich in den benachbarten Bereich kopiert wird.|
