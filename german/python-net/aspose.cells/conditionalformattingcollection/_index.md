...
type: docs
weight: 300
url: /de/python-net/aspose.cells/conditionalformattingcollection/
is_root: false
---
##  ConditionalFormattingCollection Klasse
Kapselt eine Sammlung von [FormatCondition](/cells/de/python-net/aspose.cells/formatcondition)-Objekten.
...
| :- | :- |
| [capacity](/cells/de/python-net/aspose.cells/conditionalformattingcollection/capacity) | Ruft die Anzahl der Elemente ab, die die Arrayliste enthalten kann, oder legt diese fest.|
...
###  Siehe auch
* Modul [aspose.cells](..)
* Klasse [FormatCondition](/cells/de/python-net/aspose.cells/formatcondition)
