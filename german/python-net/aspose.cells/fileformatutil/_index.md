---
title: FileFormatUtil Klasse
second_title: Aspose.Cells for Python via .NET API Referenzen
description:
type: docs
weight: 600
url: /de/python-net/aspose.cells/fileformatutil/
is_root: false
---
##  FileFormatUtil Klasse
Stellt Dienstprogrammmethoden zum Konvertieren von Dateiformataufzählungen in Zeichenfolgen oder Dateierweiterungen und zurück bereit.



Der Typ FileFormatUtil macht die folgenden Member verfügbar:

###  Methoden
| Methode| Beschreibung|
| :- | :- |
| [detect_file_format(stream)](/cells/de/python-net/aspose.cells/fileformatutil/detect_file_format/#io.RawIOBase) | Erkennt und gibt die Informationen über ein Excel-Format zurück, das in einem Stream gespeichert ist.|
| [detect_file_format(stream, password)](/cells/de/python-net/aspose.cells/fileformatutil/detect_file_format/#io.RawIOBase-str) | Erkennt und gibt die Informationen über ein Excel-Format zurück, das in einem Stream gespeichert ist.|
| [detect_file_format(file_path)](/cells/de/python-net/aspose.cells/fileformatutil/detect_file_format/#str) | Erkennt und gibt die Informationen über ein Excel-Format zurück, das in einer Datei gespeichert ist.|
| [detect_file_format(file_path, password)](/cells/de/python-net/aspose.cells/fileformatutil/detect_file_format/#str-str) | Erkennt und gibt die Informationen über ein Excel-Format zurück, das in einer Datei gespeichert ist.|
