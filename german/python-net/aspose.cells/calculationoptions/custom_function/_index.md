...
type: docs
weight: 60
url: /de/python-net/aspose.cells/calculationoptions/custom_function/
is_root: false
---
##  custom_function Eigentum

Die Berechnungsfunktionen für benutzerdefinierte Formeln erweitern die Berechnungs-Engine.
...
* Klasse [ICustomFunction](/cells/de/python-net/aspose.cells/icustomfunction)
