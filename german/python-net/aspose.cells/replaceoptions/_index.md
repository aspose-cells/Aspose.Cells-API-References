---
title: ReplaceOptions Klasse
second_title: Aspose.Cells for Python via .NET API Referenzen
description:
type: docs
weight: 1290
url: /de/python-net/aspose.cells/replaceoptions/
is_root: false
---
##  ReplaceOptions Klasse
Stellt die Ersetzungsoptionen dar.



Der Typ ReplaceOptions macht die folgenden Member verfügbar:

###  Konstrukteure
| Konstrukteur| Beschreibung|
| :- | :- |
| [ReplaceOptions()](/cells/de/python-net/aspose.cells/replaceoptions/__init__/#) | Erstellt eine neue Instanz von ReplaceOptions|
