...
type: docs
weight: 970
url: /de/python-net/aspose.cells/jsonsaveoptions/
is_root: false
---
##  JsonSaveOptions Klasse
Stellt die Optionen zum Speichern der Arbeitsmappe als JSON-Datei dar.



**Nachlass:** [JsonSaveOptions](/cells/python-net/aspose.cells/jsonsaveoptions) → 
[SaveOptions](/cells/de/python-net/aspose.cells/saveoptions)



Der Typ JsonSaveOptions macht die folgenden Member verfügbar:
...
| :- | :- |
| [save_format](/cells/de/python-net/aspose.cells/jsonsaveoptions/save_format) | Ruft das Sicherungsdateiformat ab.|
| [clear_data](/cells/de/python-net/aspose.cells/jsonsaveoptions/clear_data) | Machen Sie die Arbeitsmappe nach dem Speichern der Datei leer.|
| [cached_file_folder](/cells/de/python-net/aspose.cells/jsonsaveoptions/cached_file_folder) | Der zwischengespeicherte Dateiordner wird verwendet, um einige große Daten zu speichern.|
| [validate_merged_areas](/cells/de/python-net/aspose.cells/jsonsaveoptions/validate_merged_areas) | Gibt an, ob verbundene Zellen vor dem Speichern der Datei validiert werden sollen.|
| [merge_areas](/cells/de/python-net/aspose.cells/jsonsaveoptions/merge_areas) | Gibt an, ob die Bereiche der bedingten Formatierung und Validierung vor dem Speichern der Datei zusammengeführt werden sollen.|
| [create_directory](/cells/de/python-net/aspose.cells/jsonsaveoptions/create_directory) | Wenn wahr und das Verzeichnis nicht existiert, wird das Verzeichnis automatisch erstellt, bevor die Datei gespeichert wird.|
...
| [sheet_indexes](/cells/de/python-net/aspose.cells/jsonsaveoptions/sheet_indexes) | Stellt die Indizes der exportierten Blätter dar.|
...
###  Siehe auch
* Modul [aspose.cells](..)
* Klasse [JsonSaveOptions](/cells/de/python-net/aspose.cells/jsonsaveoptions)
