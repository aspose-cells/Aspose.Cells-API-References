---
title: create_cell_area Methode
second_title: Aspose.Cells for Python via .NET API Referenzen
description:
type: docs
weight: 30
url: /de/python-net/aspose.cells/cellarea/create_cell_area/
is_root: false
---
##  create_cell_area(start_cell_name, end_cell_name) {#str-str}
Erstellt einen Zellbereich.


###  Kehrt zurück

Geben Sie eine [CellArea](/cells/de/python-net/aspose.cells/cellarea) zurück.
