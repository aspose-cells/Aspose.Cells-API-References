---
title: get_cell_or_null Methode
second_title: Aspose.Cells for Python via .NET API Referenzen
description:
type: docs
weight: 80
url: /de/python-net/aspose.cells/range/get_cell_or_null/
is_root: false
---
##  get_cell_or_null(row_offset, column_offset) {#int-int}
Ruft [Cell](/cells/de/python-net/aspose.cells/cell) Objekt oder Null in diesem Bereich ab.


###  Kehrt zurück

[Cell](/cells/de/python-net/aspose.cells/cell) Objekt.
