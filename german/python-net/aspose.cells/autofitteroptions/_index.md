---
title: AutoFitterOptions Klasse
second_title: Aspose.Cells for Python via .NET API Referenzen
description:
type: docs
weight: 80
url: /de/python-net/aspose.cells/autofitteroptions/
is_root: false
---
##  AutoFitterOptions Klasse
Repräsentiert alle Autofitter-Optionen.



Der Typ AutoFitterOptions macht die folgenden Member verfügbar:

###  Konstrukteure
| Konstrukteur| Beschreibung|
| :- | :- |
| [AutoFitterOptions()](/cells/de/python-net/aspose.cells/autofitteroptions/__init__/#) | Erstellt eine neue Instanz von AutoFitterOptions|
...
| [auto_fit_wrapped_text_type](/cells/de/python-net/aspose.cells/autofitteroptions/auto_fit_wrapped_text_type) | Ruft den Typ des automatisch angepassten umbrochenen Texts ab und legt ihn fest.|
| [format_strategy](/cells/de/python-net/aspose.cells/autofitteroptions/format_strategy) | Ruft die formatierte Strategie ab und legt sie fest.|
