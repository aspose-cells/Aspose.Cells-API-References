---
title: fit_to_pages_wide Eigentum
second_title: Aspose.Cells for Python via .NET API Referenzen
description:
type: docs
weight: 310
url: /de/python-net/aspose.cells/pagesetup/fit_to_pages_wide/
is_root: false
---
##  fit_to_pages_wide Eigentum
...
Sie müssen FitToPagesTall auf Null setzen, wenn Sie alle Spalten auf einer Seite einpassen möchten.
###  Definition:
```python
@property
