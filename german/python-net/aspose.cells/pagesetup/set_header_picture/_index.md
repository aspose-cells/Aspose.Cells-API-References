---
title: set_header_picture Methode
second_title: Aspose.Cells for Python via .NET API Referenzen
description:
type: docs
weight: 210
url: /de/python-net/aspose.cells/pagesetup/set_header_picture/
is_root: false
---
##  set_header_picture(section, header_picture) {#int-bytes}
Legt ein Bild in der Kopfzeile eines Arbeitsblatts fest.


###  Kehrt zurück

Gibt das Objekt [Picture](/cells/de/python-net/aspose.cells.drawing/picture) zurück.
