---
title: StreamProviderOptions Klasse
second_title: Aspose.Cells for Python via .NET API Referenzen
description:
type: docs
weight: 1380
url: /de/python-net/aspose.cells/streamprovideroptions/
is_root: false
---
##  StreamProviderOptions Klasse
Stellt die Stream-Optionen dar.



Der Typ StreamProviderOptions macht die folgenden Member verfügbar:

###  Konstrukteure
| Konstrukteur| Beschreibung|
| :- | :- |
| [StreamProviderOptions(loading_type, default_path)](/cells/de/python-net/aspose.cells/streamprovideroptions/__init__/#ResourceLoadingType-str) | Initialisiert eine neue Instanz der Klasse [StreamProviderOptions](/cells/de/python-net/aspose.cells/streamprovideroptions).|
| [StreamProviderOptions()](/cells/de/python-net/aspose.cells/streamprovideroptions/__init__/#) | Initialisiert eine neue Instanz der Klasse [StreamProviderOptions](/cells/de/python-net/aspose.cells/streamprovideroptions).|
...
###  Siehe auch
* Modul [aspose.cells](..)
* Klasse [StreamProviderOptions](/cells/de/python-net/aspose.cells/streamprovideroptions)
