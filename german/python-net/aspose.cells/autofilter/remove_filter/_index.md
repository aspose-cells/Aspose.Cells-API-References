---
title: remove_filter Methode
second_title: Aspose.Cells for Python via .NET API Referenzen
description:
type: docs
weight: 160
url: /de/python-net/aspose.cells/autofilter/remove_filter/
is_root: false
---
...
| :- | :- | :- |
| field_index | int | Der spezifische Filterindex|
...
| criteria | str | Die angegebenen Kriterien (eine Zeichenfolge, z. B. „101“).<br/> Es kann nur null oder einer der Werte der Zellen in dieser Spalte sein.|
