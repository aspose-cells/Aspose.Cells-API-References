...
type: docs
weight: 800
url: /de/cpp/aspose.cells.drawing.equations/equationnode/
---
## EquationNode class
...
// Instanziiere ein Workbook‑Objekt, das die Excel‑Datei repräsentiert.
Workbook workbook;

// Fügt ein Gleichungsobjekt zum Arbeitsblatt hinzu.
TextBox textBox = workbook.GetWorksheets().Get(0).GetShapes().AddEquation(1, 0, 1, 0, 100, 300);

// Ermittelt den Startknoten des Gleichungsobjekts
EquationNode mathNode = textBox.GetEquationParagraph().GetChild(0);

// Fügt eine Bruchgleichung ein.
