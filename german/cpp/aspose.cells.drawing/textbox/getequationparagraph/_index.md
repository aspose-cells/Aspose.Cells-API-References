---
title: Aspose::Cells::Drawing::TextBox::GetEquationParagraph method
linktitle: GetEquationParagraph
second_title: Aspose.Cells for C++ API Reference
description: 'Aspose::Cells::Drawing::TextBox::GetEquationParagraph method. Get the specified math paragraph from the TextBody property of the TextBox object. Notice: (1) Returns NULL when the index is out of bounds or not found. (2) Also returns NULL if the specified index position is not a math paragraph in C++.'
type: docs
weight: 600
url: /de/cpp/aspose.cells.drawing/textbox/getequationparagraph/
---
