...
type: docs
weight: 5200
url: /de/cpp/aspose.cells.drawing/shape/setislocked/
---
...
```cpp
//Setzt die angegebene Form in den entsperrten Zustand
if (shape.GetWorksheet().IsProtected() && shape.IsLocked())
{
    shape.SetIsLocked(false);
}

//Setzt die angegebene Form in den gesperrten Zustand
if (shape.GetWorksheet().IsProtected() && !shape.IsLocked())
{
