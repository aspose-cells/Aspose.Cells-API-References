...
type: docs
weight: 14800
url: /de/cpp/aspose.cells.drawing/shape/setinputrange/
---
...
```cpp
//Nach Ausführen des untenstehenden Codes wird ein ListBox-Objekt in der erzeugten Datei erstellt. Wenn die ausgewählte Option angeklickt wird, wird der ausgewählte Wert in Zelle A12 angezeigt.
