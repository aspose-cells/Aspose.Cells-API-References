---
title: Aspose::Cells::HtmlSaveOptions::GetFormatDataIgnoreColumnWidth method
...
type: docs
weight: 11100
url: /de/cpp/aspose.cells/htmlsaveoptions/getformatdataignorecolumnwidth/
---
...
```cpp
bool Aspose::Cells::HtmlSaveOptions::GetFormatDataIgnoreColumnWidth()
```
