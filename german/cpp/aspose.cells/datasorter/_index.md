...
type: docs
weight: 4300
url: /de/cpp/aspose.cells/datasorter/
---
## DataSorter class
...
//Das Workbook-Datasorter-Objekt abrufen.
DataSorter sorter = workbook.GetDataSorter();
//Erste Sortierreihenfolge für das Datasorter-Objekt festlegen.
sorter.SetOrder1(SortOrder::Descending);
//Ersten Schlüssel definieren.
sorter.SetKey1(0);
//Zweite Sortierreihenfolge für das Datasorter-Objekt festlegen.
sorter.SetOrder2(SortOrder::Ascending);
//Zweiten Schlüssel definieren.
sorter.SetKey2(1);
//Erstelle einen Zellenbereich (Range).
CellArea ca;
//Gib den Startzeilenindex an.
ca.StartRow = 0;
...
ca.EndColumn = 1;
//Sortieren Sie Daten im angegebenen Datenbereich (A1:B14)
