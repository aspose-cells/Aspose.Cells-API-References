---
title: Aspose::Cells::Pivot::PivotTable::GetDataFields method
linktitle: GetDataFields
second_title: Aspose.Cells for C++ API Reference
description: 'Aspose::Cells::Pivot::PivotTable::GetDataFields method. Gets a PivotField object that represents all the data fields in a PivotTable. Read-only.It would be init only when there are two or more data fields in the DataPiovtFiels. It only use to add DataPivotField to the PivotTable row/column area . Default is in row area in C++.'
type: docs
weight: 2600
url: /de/cpp/aspose.cells.pivot/pivottable/getdatafields/
---
