...
type: docs
weight: 1900
url: /de/cpp/aspose.cells.charts/legend/
---
## Legend class
...
//Wenn die Legende links oder rechts vom Diagramm ist, hat das Festlegen der Eigenschaft Legend.X keine Wirkung.
//Wenn die Legende oben oder unten vom Diagramm ist, hat das Festlegen der Eigenschaft Legend.Y keine Wirkung.
legend.SetY(1500);
legend.SetWidth(50);
legend.SetHeight(50);
