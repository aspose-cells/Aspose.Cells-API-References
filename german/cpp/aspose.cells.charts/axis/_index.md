...
type: docs
weight: 100
url: /de/cpp/aspose.cells.charts/axis/
---
## Axis class
...
//Haupteinheit festlegen.
chart.GetValueAxis().SetMajorUnit(25);
//Die Kategorie‑(X‑)Achse schneidet bei dem Maximalwert.
chart.GetValueAxis().SetCrossType(CrossType::Maximum);
//Setze die Anzahl der Kategorien oder Serien zwischen den Tick‑Marken‑Beschriftungen.
