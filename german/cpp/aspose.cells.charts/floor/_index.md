...
type: docs
weight: 1700
url: /de/cpp/aspose.cells.charts/floor/
---
## Floor class
...
//Instanziieren der License‑Klasse
License license;

//Nur den Namen der in der Assembly eingebetteten Lizenzdatei übergeben
license.SetLicense(u"Aspose.Cells.lic");

//Instanziieren des Arbeitsmappen‑Objekts
Workbook workbook;
...
//das neu hinzugefügte Diagramm abrufen
Chart chart = charts.Get(index);

//Diagramme nSeries festlegen
chart.GetNSeries().Add(u"A1:A3", true);

//Datenbeschriftungen anzeigen
chart.GetNSeries().Get(0).GetDataLabels().SetShowValue(true);

//Boden des Diagramms abrufen
Floor floor = chart.GetFloor();

//Bodenrand auf Rot setzen
