...
type: docs
weight: 1400
url: /de/cpp/aspose.cells.charts/datalabels/
---
## DataLabels class
...
Aspose::Cells::Startup();
    //Datenbeschriftungen im Diagramm festlegen
    ...
    for (int i = 0; i < chart.GetNSeries().GetCount(); i++)
    {
        ...
        //Position der Datenbeschriftungen festlegen
        datalabels.SetPosition(LabelPositionType::InsideBase);
        //Kategorienamen in den Datenbeschriftungen anzeigen
        datalabels.SetShowCategoryName(true);
        //Wert in den Datenbeschriftungen anzeigen
        datalabels.SetShowValue(true);
        //Prozentsatz in den Datenbeschriftungen nicht anzeigen
        datalabels.SetShowPercentage(false);
        //Legenden-Schlüssel nicht anzeigen.
