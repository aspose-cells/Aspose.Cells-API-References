...
type: docs
weight: 8300
url: /de/cpp/aspose.cells.charts/chart/toimage/
---
...
//Speichert als Tiff mit 300 dpi und CCITT4‑Kompression.
...
```cpp
Aspose::Cells::Startup();
//Liefert ein Bitmap‑Objekt mit 200 dpi in x‑Richtung und 300 dpi in y‑Richtung.
