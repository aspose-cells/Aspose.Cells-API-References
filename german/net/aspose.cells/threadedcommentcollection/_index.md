...
description: Repräsentiert die Liste der Thread-Kommentare.
type: docs
weight: 6050
url: /de/net/aspose.cells/threadedcommentcollection/
---
## ThreadedCommentCollection class

Repräsentiert die Liste der Thread-Kommentare.
...
| [Item](../../aspose.cells/threadedcommentcollection/item) { get; } | Ruft den Thread-Kommentar nach dem spezifischen Index ab. |
...
| Name | Beschreibung |
| --- | --- |
| [Add](../../aspose.cells/threadedcommentcollection/add)(string, ThreadedCommentAuthor) | Fügt einen Thread-Kommentar hinzu; |
