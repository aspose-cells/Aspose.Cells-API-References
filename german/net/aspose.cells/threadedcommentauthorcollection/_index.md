...
description: Stellt alle Personen dar die .
type: docs
weight: 6040
url: /de/net/aspose.cells/threadedcommentauthorcollection/
---
...
| [CurrentPerson](../../aspose.cells/threadedcommentauthorcollection/currentperson) { get; set; } | Ruft den aktuellen Benutzer ab und legt ihn fest. |
| [Item](../../aspose.cells/threadedcommentauthorcollection/item) { get; } | Ruft die Person ab, die Thread-Kommentare erstellt. (2 indexers) |
...
| Name | Beschreibung |
| --- | --- |
| [Add](../../aspose.cells/threadedcommentauthorcollection/add)(string, string, string) | Fügt eine Thread-Kommentarperson hinzu. |
...
| [IndexOf](../../aspose.cells/threadedcommentauthorcollection/indexof#indexof)(ThreadedCommentAuthor) | Ruft den Index von ThreadedCommentAuthor object ab (2 methods) |
