...
description: Stellt die Speicheroptionen für das Excel 97-2003-Dateiformat dar xls und xlt.
type: docs
weight: 6540
url: /de/net/aspose.cells/xlssaveoptions/
---
...
| Name | Beschreibung |
| --- | --- |
| [XlsSaveOptions](xlssaveoptions#constructor)() | Erstellt Optionen zum Speichern von Excel 97-2003 xls/xlt-Dateien. |
| [XlsSaveOptions](xlssaveoptions#constructor_1)(SaveFormat) | Erstellt Optionen zum Speichern von Excel 97-2003 xls/xlt-Dateien. |
...
| [IsTemplate](../../aspose.cells/xlssaveoptions/istemplate) { get; set; } | Gibt an, ob eine Vorlagendatei gespeichert wird. |
| [LightCellsDataProvider](../../aspose.cells/xlssaveoptions/lightcellsdataprovider) { get; set; } | Der Datenanbieter zum Bereitstellen von Zellendaten zum Speichern von Arbeitsmappen im Light-Modus. |
| [MatchColor](../../aspose.cells/xlssaveoptions/matchcolor) { get; set; } | Gibt an, ob die Schriftfarbe übereinstimmt, da die Standardfarbpalette 56 Farben enthält. |
