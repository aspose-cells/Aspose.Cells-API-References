...
description: Repräsentiert die Optionen zum Speichern der XLSB-Datei.
type: docs
weight: 6550
url: /de/net/aspose.cells/xlsbsaveoptions/
---
## XlsbSaveOptions class

Repräsentiert die Optionen zum Speichern der XLSB-Datei.
...
| Name | Beschreibung |
| --- | --- |
| [XlsbSaveOptions](xlsbsaveoptions#constructor)() | Erstellt Optionen zum Speichern von XLSB-Dateien. |
...
| [CompressionType](../../aspose.cells/xlsbsaveoptions/compressiontype) { get; set; } | Ruft den Komprimierungstyp für die ooxml-Datei ab und legt ihn fest. |
...
| [ExportAllColumnIndexes](../../aspose.cells/xlsbsaveoptions/exportallcolumnindexes) { get; set; } | Gibt an, ob alle Spaltenindizes für Zellen exportiert werden. |
