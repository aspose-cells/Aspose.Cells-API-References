...
description: Kapselt eine Sammlung vonProtectedRange./protectedrange Objekte.
type: docs
weight: 4900
url: /de/net/aspose.cells/protectedrangecollection/
---
## ProtectedRangeCollection class

Kapselt eine Sammlung von[`ProtectedRange`](../protectedrange) Objekte.
...
| [Item](../../aspose.cells/protectedrangecollection/item) { get; } | Ruft die ab[`ProtectedRange`](../protectedrange) Element am angegebenen Index. |
...
| Name | Beschreibung |
| --- | --- |
| [Add](../../aspose.cells/protectedrangecollection/add)(string, int, int, int, int) | Fügt ein hinzu[`ProtectedRange`](../protectedrange) Artikel zur Sammlung. |
