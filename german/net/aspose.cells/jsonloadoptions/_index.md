...
description: Repräsentiert die Optionen zum Laden von JSON-Dateien
type: docs
weight: 3920
url: /de/net/aspose.cells/jsonloadoptions/
---
## JsonLoadOptions class

Repräsentiert die Optionen zum Laden von JSON-Dateien
...
| Name | Beschreibung |
| --- | --- |
| [JsonLoadOptions](jsonloadoptions)() | Erstellt Optionen zum Laden der Datei. |
...
| [LayoutOptions](../../aspose.cells/jsonloadoptions/layoutoptions) { get; set; } | Die Importoptionen von json. |
...
| [MultipleWorksheets](../../aspose.cells/jsonloadoptions/multipleworksheets) { get; set; } | Gibt an, ob jedes Attribut des JsonObject-Objekts als ein Arbeitsblatt importiert wird, wenn alle untergeordneten Knoten Array-Knoten sind. |
...
| [StartCell](../../aspose.cells/jsonloadoptions/startcell) { get; set; } | Ruft die Startzelle ab und setzt sie. |
