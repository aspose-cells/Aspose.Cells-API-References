...
description: Eine Sammlung von Filterobjekten die alle Filter in einem automatisch gefilterten Bereich darstellen.
type: docs
weight: 3440
url: /de/net/aspose.cells/filtercolumncollection/
---
## FilterColumnCollection class

Eine Sammlung von Filterobjekten, die alle Filter in einem automatisch gefilterten Bereich darstellen.
...
| [Item](../../aspose.cells/filtercolumncollection/item) { get; } | erhält[`FilterColumn`](../filtercolumn) Objekt am Sonderfeld. |
...
| [GetByIndex](../../aspose.cells/filtercolumncollection/getbyindex)(int) | Gibt ein einzelnes Filterobjekt aus einer Sammlung zurück. |
