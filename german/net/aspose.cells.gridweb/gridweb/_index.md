...
type: docs
weight: 800
url: /de/net/aspose.cells.gridweb/gridweb/
---
## GridWeb class
...
| [SelectCells](../../aspose.cells.gridweb/gridweb/selectcells) { get; } | Ruft die ausgewählte Zellensammlung ab. |
...
| [ImportExcelFile](../../aspose.cells.gridweb/mainweb/importexcelfile)(Stream) | Importe aus einem Excel-Datei-Stream, einschließlich Disk-Datei-Stream oder Speicher-Stream. |
| [ImportExcelFile](../../aspose.cells.gridweb/mainweb/importexcelfile)(string) | Importiert aus einer Excel-Datei. |
| [LoadCSVFile](../../aspose.cells.gridweb/mainweb/loadcsvfile)(Stream) | Lädt Daten aus einem CSV-Dateistream. |
| [LoadCSVFile](../../aspose.cells.gridweb/mainweb/loadcsvfile)(string) | Lädt Daten aus einer CSV-Datei. |
| [LoadHTMLFile](../../aspose.cells.gridweb/mainweb/loadhtmlfile)(Stream) | Lädt Daten aus einem HTML-Dateistream. |
| [LoadHTMLFile](../../aspose.cells.gridweb/mainweb/loadhtmlfile)(string) | Lädt Daten aus einer HTML-Datei. |
| [LoadSpreadSheetMLFile](../../aspose.cells.gridweb/mainweb/loadspreadsheetmlfile)(Stream) | Lädt Daten aus einem SpreadSheetML-Dateistream. |
| [LoadSpreadSheetMLFile](../../aspose.cells.gridweb/mainweb/loadspreadsheetmlfile)(string) | Lädt Daten aus einer SpreadSheetML-Datei. |
...
| [SaveCSVFile](../../aspose.cells.gridweb/mainweb/savecsvfile)(Stream) | Speichert Daten in einem CSV-Dateistream. |
| [SaveCSVFile](../../aspose.cells.gridweb/mainweb/savecsvfile)(string) | Speichert Daten in einer CSV-Datei. |
| [SaveCustomStyleFile](../../aspose.cells.gridweb/gridweb/savecustomstylefile#savecustomstylefile)(string) | Speichert aktuelle Stildaten des Steuerelements in einer XML-Datei. Kann verwendet werden, um Ihre benutzerdefinierte Stildatei zu erstellen. (2 methods) |
| [SaveHTMLFile](../../aspose.cells.gridweb/mainweb/savehtmlfile)(Stream) | Speichert Daten in einem HTML-Dateistream. |
| [SaveHTMLFile](../../aspose.cells.gridweb/mainweb/savehtmlfile)(string) | Speichert Daten in einer HTML-Datei. |
| [SaveSpreadSheetMLFile](../../aspose.cells.gridweb/mainweb/savespreadsheetmlfile)(Stream) | Speichert Daten in einem SpreadSheetML-Dateistream. |
| [SaveSpreadSheetMLFile](../../aspose.cells.gridweb/mainweb/savespreadsheetmlfile)(string) | Speichert Daten in einer SpreadSheetML-Datei. |
| [SaveToExcelFile](../../aspose.cells.gridweb/mainweb/savetoexcelfile)(Stream) | Speichert die Arbeitsblätter in einer Excel-Datei. |
| [SaveToExcelFile](../../aspose.cells.gridweb/mainweb/savetoexcelfile)(string) | Speichert die Arbeitsblätter in einer Excel-Datei im Excel 2003-Format. |
| [SaveToExcelFile](../../aspose.cells.gridweb/mainweb/savetoexcelfile)(Stream, GridSaveFormat) | Speichert die Arbeitsblätter in einer Excel-Datei. |
| [SaveToExcelFile](../../aspose.cells.gridweb/mainweb/savetoexcelfile)(Stream, GridSaveOptions) | Speichert die Arbeitsblätter in einer Excel-Datei. |
| [SaveToExcelFile](../../aspose.cells.gridweb/mainweb/savetoexcelfile)(string, GridSaveFormat) | Speichert die Arbeitsblätter in einer Excel-Datei. |
| [SaveToExcelFile](../../aspose.cells.gridweb/mainweb/savetoexcelfile)(string, GridSaveOptions) | Speichert die Arbeitsblätter in einer Excel-Datei. |
...
| static [GetVersion](../../aspose.cells.gridweb/gridweb/getversion)() | Holen Sie sich die Release-Version. |
| static [SetFontFolder](../../aspose.cells.gridweb/gridweb/setfontfolder)(string, bool) | Legt den Schriftartenordner fest |
| static [SetFontFolders](../../aspose.cells.gridweb/gridweb/setfontfolders)(string[], bool) | Legt die Schriftartenordner fest |
