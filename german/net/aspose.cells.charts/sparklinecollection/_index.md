...
description: Kapselt eine Sammlung vonSparkline./sparkline Objekte.
type: docs
weight: 870
url: /de/net/aspose.cells.charts/sparklinecollection/
---
## SparklineCollection class

Kapselt eine Sammlung von[`Sparkline`](../sparkline) Objekte.
...
| [Item](../../aspose.cells.charts/sparklinecollection/item) { get; } | Ruft die ab[`Sparkline`](../sparkline) Element am angegebenen Index. |
...
| Name | Beschreibung |
| --- | --- |
| [Add](../../aspose.cells.charts/sparklinecollection/add)(string, int, int) | Sparkline hinzufügen. |
...
| [Remove](../../aspose.cells.charts/sparklinecollection/remove)(object) | Entfernt die Sparkline |
