...
description: Gibt die anConnectionParameter./connectionparameter Sammlung
type: docs
weight: 3250
url: /de/net/aspose.cells.externalconnections/connectionparametercollection/
---
## ConnectionParameterCollection class

Gibt die an[`ConnectionParameter`](../connectionparameter) Sammlung
...
| [Item](../../aspose.cells.externalconnections/connectionparametercollection/item) { get; set; } | Ruft die ab[`ConnectionParameter`](../connectionparameter) Element am angegebenen Index. (2 indexers) |
| [Item](../../aspose.cells.externalconnections/connectionparametercollection/item) { get; } | Ruft die ab[`ConnectionParameter`](../connectionparameter) Element mit dem angegebenen Namen. |
