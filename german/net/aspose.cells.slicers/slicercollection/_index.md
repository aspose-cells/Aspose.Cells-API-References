...
description: Gibt die Sammlung aller Slicer-Objekte auf dem angegebenen Arbeitsblatt an.
type: docs
weight: 5690
url: /de/net/aspose.cells.slicers/slicercollection/
---
## SlicerCollection class

Gibt die Sammlung aller Slicer-Objekte auf dem angegebenen Arbeitsblatt an.
...
| [Item](../../aspose.cells.slicers/slicercollection/item) { get; } | Ruft den Slicer nach Index ab. (2 indexers) |
...
| Name | Beschreibung |
| --- | --- |
| [Add](../../aspose.cells.slicers/slicercollection/add#add_8)(ListObject, int, string) | Neuen Slicer mit ListObjet als Datenquelle hinzufügen |
| [Add](../../aspose.cells.slicers/slicercollection/add#add_7)(ListObject, ListColumn, string) | Neuen Slicer mit ListObjet als Datenquelle hinzufügen |
| [Add](../../aspose.cells.slicers/slicercollection/add#add_4)(PivotTable, string, int) | Hinzufügen eines neuen Datenschnitts mit PivotTable als Datenquelle |
| [Add](../../aspose.cells.slicers/slicercollection/add#add_3)(PivotTable, string, PivotField) | Hinzufügen eines neuen Datenschnitts mit PivotTable als Datenquelle |
| [Add](../../aspose.cells.slicers/slicercollection/add#add_5)(PivotTable, string, string) | Hinzufügen eines neuen Datenschnitts mit PivotTable als Datenquelle |
| [Add](../../aspose.cells.slicers/slicercollection/add#add_6)(ListObject, ListColumn, int, int) | Neuen Slicer mit ListObjet als Datenquelle hinzufügen |
| [Add](../../aspose.cells.slicers/slicercollection/add#add_1)(PivotTable, int, int, int) | Hinzufügen eines neuen Datenschnitts mit PivotTable als Datenquelle |
| [Add](../../aspose.cells.slicers/slicercollection/add#add)(PivotTable, int, int, PivotField) | Hinzufügen eines neuen Datenschnitts mit PivotTable als Datenquelle |
| [Add](../../aspose.cells.slicers/slicercollection/add#add_2)(PivotTable, int, int, string) | Hinzufügen eines neuen Datenschnitts mit PivotTable als Datenquelle |
...
| [Remove](../../aspose.cells.slicers/slicercollection/remove)(Slicer) | Entfernen Sie den angegebenen Slicer |
| [RemoveAt](../../aspose.cells.slicers/slicercollection/removeat#removeat)(int) | Löscht den Slicer am angegebenen Index (2 methods) |
