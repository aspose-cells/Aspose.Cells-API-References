...
description: Stellt die Sammlung aller PivotTable-Objekte auf dem angegebenen Arbeitsblatt dar.
type: docs
weight: 4710
url: /de/net/aspose.cells.pivot/pivottablecollection/
---
## PivotTableCollection class

Stellt die Sammlung aller PivotTable-Objekte auf dem angegebenen Arbeitsblatt dar.
...
| [Item](../../aspose.cells.pivot/pivottablecollection/item) { get; } | Ruft den PivotTable-Bericht nach Index ab. (3 indexers) |
...
| Name | Beschreibung |
| --- | --- |
| [Add](../../aspose.cells.pivot/pivottablecollection/add#add_1)(PivotTable, string, string) | Fügt der Sammlung ein neues PivotTable-Objekt aus einer anderen PivotTable hinzu. |
| [Add](../../aspose.cells.pivot/pivottablecollection/add#add_4)(string, string, string) | Fügt einer PivotCaches-Sammlung einen neuen PivotTable-Cache hinzu. |
| [Add](../../aspose.cells.pivot/pivottablecollection/add#add)(PivotTable, int, int, string) | Fügt der Sammlung ein neues PivotTable-Objekt aus einer anderen PivotTable hinzu. |
| [Add](../../aspose.cells.pivot/pivottablecollection/add#add_2)(string, int, int, string) | Fügt einer PivotCaches-Sammlung einen neuen PivotTable-Cache hinzu. |
| [Add](../../aspose.cells.pivot/pivottablecollection/add#add_5)(string, string, string, bool) | Fügt einer PivotCaches-Sammlung einen neuen PivotTable-Cache hinzu. |
| [Add](../../aspose.cells.pivot/pivottablecollection/add#add_3)(string, int, int, string, bool) | Fügt einer PivotCaches-Sammlung einen neuen PivotTable-Cache hinzu. |
| [Add](../../aspose.cells.pivot/pivottablecollection/add#add_7)(string[], bool, PivotPageFields, string, string) | Fügt der Sammlung ein neues PivotTable-Objekt mit mehreren Konsolidierungsbereichen als Datenquelle hinzu. |
| [Add](../../aspose.cells.pivot/pivottablecollection/add#add_6)(string[], bool, PivotPageFields, int, int, string) | Fügt der Sammlung ein neues PivotTable-Objekt mit mehreren Konsolidierungsbereichen als Datenquelle hinzu. |
...
| [Clear](../../aspose.cells.pivot/pivottablecollection/clear#clear)() | Alle Pivot-Tabellen löschen. (2 methods) |
...
| [Dispose](../../aspose.cells.pivot/pivottablecollection/dispose)() | Führt anwendungsdefinierte Aufgaben aus, die mit dem Freigeben, Freigeben oder Zurücksetzen nicht verwalteter Ressourcen verbunden sind. |
...
| [Remove](../../aspose.cells.pivot/pivottablecollection/remove#remove)(PivotTable) | Löscht die angegebene PivotTable und löscht die PivotTable data |
| [Remove](../../aspose.cells.pivot/pivottablecollection/remove#remove_1)(PivotTable, bool) | Löscht die angegebene PivotTable |
| [RemoveAt](../../aspose.cells.pivot/pivottablecollection/removeat#removeat)(int) | Löscht die PivotTable am angegebenen Index und löscht die PivotTable data (2 methods) |
| [RemoveAt](../../aspose.cells.pivot/pivottablecollection/removeat#removeat_2)(int, bool) | Löscht die PivotTable am angegebenen Index |
