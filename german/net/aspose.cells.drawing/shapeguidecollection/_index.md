...
description: Kapselt eine Sammlung von Formleitfäden
type: docs
weight: 2670
url: /de/net/aspose.cells.drawing/shapeguidecollection/
---
## ShapeGuideCollection class

Kapselt eine Sammlung von Formleitfäden
...
| [Item](../../aspose.cells.drawing/shapeguidecollection/item) { get; } | Ruft eine Formhilfe nach index ab |
...
| Name | Beschreibung |
| --- | --- |
| [Add](../../aspose.cells.drawing/shapeguidecollection/add)(string, double) | Fügt eine Formhilfe hinzu. (Wichtig: Diese Funktion ist derzeit nur für Excel07 und höher verfügbar) |
