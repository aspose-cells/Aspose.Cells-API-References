...
description: Kapselt eine Sammlung vonTextBox./textbox Objekte.
type: docs
weight: 2820
url: /de/net/aspose.cells.drawing/textboxcollection/
---
## TextBoxCollection class

Kapselt eine Sammlung von[`TextBox`](../textbox) Objekte.
...
| [Item](../../aspose.cells.drawing/textboxcollection/item) { get; } | Ruft die ab[`TextBox`](../textbox) Element am angegebenen Index. (2 indexers) |
...
| Name | Beschreibung |
| --- | --- |
| [Add](../../aspose.cells.drawing/textboxcollection/add)(int, int, int, int) | Fügt der Sammlung ein Textfeld hinzu. |
...
| [Clear](../../aspose.cells.drawing/textboxcollection/clear#clear)() | Alle Textfelder löschen. (2 methods) |
...
| [RemoveAt](../../aspose.cells.drawing/textboxcollection/removeat#removeat)(int) | Entfernen Sie ein Textfeld aus der Datei. (2 methods) |
