...
description: Repräsentiert alle Power-Query-Formeln in den Mashup-Daten.
type: docs
weight: 4970
url: /de/net/aspose.cells.querytables/powerqueryformulacollection/
---
## PowerQueryFormulaCollection class

Repräsentiert alle Power-Query-Formeln in den Mashup-Daten.
...
| [Item](../../aspose.cells.querytables/powerqueryformulacollection/item) { get; } | erhält[`PowerQueryFormula`](../powerqueryformula) nach dem Index in der Liste. (2 indexers) |
