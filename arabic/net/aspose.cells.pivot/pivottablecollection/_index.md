...
description: يمثل مجموعة كل كائنات PivotTable في ورقة العمل المحددة.
type: docs
weight: 4710
url: /ar/net/aspose.cells.pivot/pivottablecollection/
---
...
| [Item](../../aspose.cells.pivot/pivottablecollection/item) { get; } | الحصول على تقرير PivotTable حسب الفهرس. (3 indexers) |
...
| اسم | وصف |
| --- | --- |
| [Add](../../aspose.cells.pivot/pivottablecollection/add#add_1)(PivotTable, string, string) | إضافة كائن PivotTable جديد إلى المجموعة من PivotTable آخر. |
| [Add](../../aspose.cells.pivot/pivottablecollection/add#add_4)(string, string, string) | إضافة ذاكرة تخزين مؤقت PivotTable جديدة إلى مجموعة PivotCaches. |
| [Add](../../aspose.cells.pivot/pivottablecollection/add#add)(PivotTable, int, int, string) | إضافة كائن PivotTable جديد إلى المجموعة من PivotTable آخر. |
| [Add](../../aspose.cells.pivot/pivottablecollection/add#add_2)(string, int, int, string) | إضافة ذاكرة تخزين مؤقت PivotTable جديدة إلى مجموعة PivotCaches. |
| [Add](../../aspose.cells.pivot/pivottablecollection/add#add_5)(string, string, string, bool) | إضافة ذاكرة تخزين مؤقت PivotTable جديدة إلى مجموعة PivotCaches. |
| [Add](../../aspose.cells.pivot/pivottablecollection/add#add_3)(string, int, int, string, bool) | إضافة ذاكرة تخزين مؤقت PivotTable جديدة إلى مجموعة PivotCaches. |
| [Add](../../aspose.cells.pivot/pivottablecollection/add#add_7)(string[], bool, PivotPageFields, string, string) | إضافة كائن PivotTable جديد إلى المجموعة ذات نطاقات الدمج المتعددة كمصدر بيانات. |
| [Add](../../aspose.cells.pivot/pivottablecollection/add#add_6)(string[], bool, PivotPageFields, int, int, string) | إضافة كائن PivotTable جديد إلى المجموعة ذات نطاقات الدمج المتعددة كمصدر بيانات. |
...
| [Clear](../../aspose.cells.pivot/pivottablecollection/clear#clear)() | مسح كافة الجداول المحورية . (2 methods) |
...
| [Dispose](../../aspose.cells.pivot/pivottablecollection/dispose)() | يؤدي مهام محددة بواسطة التطبيق مرتبطة بتحرير الموارد غير المُدارة أو تحريرها أو إعادة تعيينها. |
...
| [Remove](../../aspose.cells.pivot/pivottablecollection/remove#remove)(PivotTable) | حذف PivotTable المحدد وحذف بيانات PivotTable |
| [Remove](../../aspose.cells.pivot/pivottablecollection/remove#remove_1)(PivotTable, bool) | حذف جدول PivotTable المحدد |
| [RemoveAt](../../aspose.cells.pivot/pivottablecollection/removeat#removeat)(int) | حذف PivotTable في الفهرس المحدد وحذف بيانات PivotTable (2 methods) |
| [RemoveAt](../../aspose.cells.pivot/pivottablecollection/removeat#removeat_2)(int, bool) | حذف PivotTable عند الفهرس المحدد |
