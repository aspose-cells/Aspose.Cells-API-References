...
description: لتغليف مجموعة منSparklineGroup./sparklinegroup الكائنات .
type: docs
weight: 890
url: /ar/net/aspose.cells.charts/sparklinegroupcollection/
---
## SparklineGroupCollection class

لتغليف مجموعة من[`SparklineGroup`](../sparklinegroup) الكائنات .
...
| [Item](../../aspose.cells.charts/sparklinegroupcollection/item) { get; } | يحصل على ملف[`SparklineGroup`](../sparklinegroup) عنصر في الفهرس المحدد. |
...
| اسم | وصف |
| --- | --- |
| [Add](../../aspose.cells.charts/sparklinegroupcollection/add)(SparklineType, string, bool, CellArea) | يضيف ملف[`SparklineGroup`](../sparklinegroup) عنصر للمجموعة. |
...
| [ClearSparklineGroups](../../aspose.cells.charts/sparklinegroupcollection/clearsparklinegroups)(CellArea) | يمسح مجموعات خط المؤشر التي تتداخل مع منطقة من الخلايا. |
| [ClearSparklines](../../aspose.cells.charts/sparklinegroupcollection/clearsparklines)(CellArea) | يمسح خطوط المؤشرات الموجودة داخل منطقة من الخلايا . |
