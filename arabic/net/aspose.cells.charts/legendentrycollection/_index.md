...
description: يمثل مجموعة من كافة ملفاتLegendEntry./legendentry الكائنات في وسيلة إيضاح الرسم البياني المحددة.
type: docs
weight: 710
url: /ar/net/aspose.cells.charts/legendentrycollection/
---
## LegendEntryCollection class

يمثل مجموعة من كافة ملفات[`LegendEntry`](../legendentry) الكائنات في وسيلة إيضاح الرسم البياني المحددة.
...
| [Item](../../aspose.cells.charts/legendentrycollection/item) { get; } | يحصل على ملف[`LegendEntry`](../legendentry) عنصر في الفهرس المحدد. |
