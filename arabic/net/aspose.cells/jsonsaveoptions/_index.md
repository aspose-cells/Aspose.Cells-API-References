...
description: يمثل خيارات حفظ المصنف كملف json.
type: docs
weight: 3930
url: /ar/net/aspose.cells/jsonsaveoptions/
---
...
| اسم | وصف |
| --- | --- |
| [JsonSaveOptions](jsonsaveoptions)() | ينشئ خيارات لحفظ ملف json . |
...
| [ExportArea](../../aspose.cells/jsonsaveoptions/exportarea) { get; set; } | الحصول على أو تحديد نطاق التصدير. |
| [ExportAsString](../../aspose.cells/jsonsaveoptions/exportasstring) { get; set; } | يصدر قيمة سلسلة الخلايا إلى json. |
| [HasHeaderRow](../../aspose.cells/jsonsaveoptions/hasheaderrow) { get; set; } | يشير إلى ما إذا كان النطاق يحتوي على صف الرأس. |
| [Indent](../../aspose.cells/jsonsaveoptions/indent) { get; set; } | يشير إلى المسافة البادئة . |
...
| [SheetIndexes](../../aspose.cells/jsonsaveoptions/sheetindexes) { get; set; } | يمثل فهارس الأوراق المصدرة. |
