...
description: يمثل خيارات حفظ ملف Excel 2003.
type: docs
weight: 5730
url: /ar/net/aspose.cells/spreadsheetml2003saveoptions/
---
## SpreadsheetML2003SaveOptions class

يمثل خيارات حفظ ملف Excel 2003.
...
| اسم | وصف |
| --- | --- |
| [SpreadsheetML2003SaveOptions](spreadsheetml2003saveoptions#constructor)() | ينشئ الخيارات الخاصة بحفظ ملف Excel 2003. |
...
| [ExportColumnIndexOfCell](../../aspose.cells/spreadsheetml2003saveoptions/exportcolumnindexofcell) { get; set; } | القيمة الافتراضية خاطئة ، فهذا يعني أنه سيتم تجاهل فهرس العمود إذا كانت الخلية قريبة من الخلية السابقة. |
| [IsIndentedFormatting](../../aspose.cells/spreadsheetml2003saveoptions/isindentedformatting) { get; set; } | يتسبب في وضع مسافة بادئة للعناصر الفرعية . |
| [LimitAsXls](../../aspose.cells/spreadsheetml2003saveoptions/limitasxls) { get; set; } | حد xls ، يكون الحد الأقصى لمؤشر الصف 65535 وفهرس العمود الأقصى هو 255. |
