...
description: مجموعة منXmlMap./xmlmap كائنات تمثل معلومات XmlMap.
type: docs
weight: 6600
url: /ar/net/aspose.cells/xmlmapcollection/
---
## XmlMapCollection class

مجموعة من[`XmlMap`](../xmlmap) كائنات تمثل معلومات XmlMap.
...
| [Item](../../aspose.cells/xmlmapcollection/item) { get; } | يحصل على خريطة xml من خلال الفهرس المحدد . |
...
| اسم | وصف |
| --- | --- |
| [Add](../../aspose.cells/xmlmapcollection/add)(string) | أضف أ[`XmlMap`](../xmlmap) بواسطة عنوان url / مسار ملف xml / xsd. |
...
| [Clear](../../aspose.cells/xmlmapcollection/clear#clear)() | يزيل كل XmlMaps. (2 methods) |
