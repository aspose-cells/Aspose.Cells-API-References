...
description: يمثل مجموعة من كافة ملفاتName./name كائنات في جدول البيانات.
type: docs
weight: 4210
url: /ar/net/aspose.cells/namecollection/
---
## NameCollection class

يمثل مجموعة من كافة ملفات[`Name`](../name) كائنات في جدول البيانات.
...
| [Item](../../aspose.cells/namecollection/item) { get; } | يحصل على ملف[`Name`](../name) عنصر في الفهرس المحدد. (2 indexers) |
...
| اسم | وصف |
| --- | --- |
| [Add](../../aspose.cells/namecollection/add)(string) | يحدد اسمًا جديدًا . |
...
| [Clear](../../aspose.cells/namecollection/clear#clear)() | قم بإزالة جميع الأسماء المحددة التي لم تتم الإشارة إليها بواسطة الصيغ ومصدر البيانات. إذا تمت الإشارة إلى الاسم المحدد ، فإننا نعين الاسم فقط. (2 methods) |
...
| [Filter](../../aspose.cells/namecollection/filter)(NameScopeType, int) | يحصل على كل الاسم المحدد حسب النطاق . |
...
| [Remove](../../aspose.cells/namecollection/remove#remove)(string) | إزالة الاسم. |
| [Remove](../../aspose.cells/namecollection/remove#remove_1)(string[]) | إزالة مصفوفة من name |
| [RemoveAt](../../aspose.cells/namecollection/removeat#removeat)(int) | قم بإزالة الاسم من الفهرس المحدد . (2 methods) |
| [RemoveDuplicateNames](../../aspose.cells/namecollection/removeduplicatenames)() | إزالة الأسماء المعرفة المكررة |
| [Sort](../../aspose.cells/namecollection/sort)() | فرز الأسماء المعرفة . |
