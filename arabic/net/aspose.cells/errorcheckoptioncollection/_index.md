...
description: يمثل خيار فحص كافة الأخطاء.
type: docs
weight: 3180
url: /ar/net/aspose.cells/errorcheckoptioncollection/
---
## ErrorCheckOptionCollection class

يمثل خيار فحص كافة الأخطاء.
...
| [Item](../../aspose.cells/errorcheckoptioncollection/item) { get; } | يحصل[`ErrorCheckOption`](../errorcheckoption) كائن من خلال الفهرس المحدد. |
...
| اسم | وصف |
| --- | --- |
| [Add](../../aspose.cells/errorcheckoptioncollection/add)() | أضف خيار التحقق من الخطأ . |
