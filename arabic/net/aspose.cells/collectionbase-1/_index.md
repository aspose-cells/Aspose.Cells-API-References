...
description: يوفر فئة أساسية مجردة لمجموعة مكتوبة بقوة.
type: docs
weight: 1020
url: /ar/net/aspose.cells/collectionbase-1/
---
## CollectionBase&lt;T&gt; class

يوفر فئة أساسية مجردة لمجموعة مكتوبة بقوة.
...
| اسم | وصف |
| --- | --- |
| [Capacity](../../aspose.cells/collectionbase`1/capacity) { get; set; } | الحصول على أو تحديد عدد العناصر التي يمكن أن تحتويها القائمة. |
| [Count](../../aspose.cells/collectionbase`1/count) { get; } | الحصول على عدد العناصر . |
| [Item](../../aspose.cells/collectionbase`1/item) { get; set; } | الحصول على العنصر أو تحديده عند الفهرس المحدد. |
...
| [Clear](../../aspose.cells/collectionbase`1/clear)() | قم بإزالة كافة العناصر . |
...
| [RemoveAt](../../aspose.cells/collectionbase`1/removeat)(int) | يزيل العنصر في الفهرس المحدد . |
