...
description: لتغليف مجموعة منProtectedRange./protectedrange الكائنات .
type: docs
weight: 4900
url: /ar/net/aspose.cells/protectedrangecollection/
---
## ProtectedRangeCollection class

لتغليف مجموعة من[`ProtectedRange`](../protectedrange) الكائنات .
...
| [Item](../../aspose.cells/protectedrangecollection/item) { get; } | يحصل على ملف[`ProtectedRange`](../protectedrange) عنصر في الفهرس المحدد. |
...
| اسم | وصف |
| --- | --- |
| [Add](../../aspose.cells/protectedrangecollection/add)(string, int, int, int, int) | يضيف أ[`ProtectedRange`](../protectedrange) عنصر للمجموعة. |
