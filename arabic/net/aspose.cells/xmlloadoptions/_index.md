...
description: يمثل خيارات تحميل xml.
type: docs
weight: 6580
url: /ar/net/aspose.cells/xmlloadoptions/
---
...
| اسم | وصف |
| --- | --- |
| [XmlLoadOptions](xmlloadoptions#constructor)() | يمثل خيارات تحميل ملف ods. |
| [XmlLoadOptions](xmlloadoptions#constructor_1)(LoadFormat) | يمثل خيارات تحميل ملف ods. |
...
| [ContainsMultipleWorksheets](../../aspose.cells/xmlloadoptions/containsmultipleworksheets) { get; set; } | يشير إلى ما إذا كان استيراد xml كأوراق عمل متعددة. |
...
| [IsXmlMap](../../aspose.cells/xmlloadoptions/isxmlmap) { get; set; } | يشير إلى ما إذا كان تعيين xml إلى Excel . القيمة الافتراضية هي false . |
...
| [StartCell](../../aspose.cells/xmlloadoptions/startcell) { get; set; } | الحصول على خلية البدء وتعيينها . |
