...
description: لتغليف مجموعة منHorizontalPageBreak./horizontalpagebreak الكائنات .
type: docs
weight: 3670
url: /ar/net/aspose.cells/horizontalpagebreakcollection/
---
## HorizontalPageBreakCollection class

لتغليف مجموعة من[`HorizontalPageBreak`](../horizontalpagebreak) الكائنات .
...
| [Item](../../aspose.cells/horizontalpagebreakcollection/item) { get; } | يحصل على ملف[`HorizontalPageBreak`](../horizontalpagebreak) عنصر في الفهرس المحدد. (2 indexers) |
...
| اسم | وصف |
| --- | --- |
| [Add](../../aspose.cells/horizontalpagebreakcollection/add#add)(int) | يضيف فاصل صفحات أفقيًا إلى المجموعة. |
| [Add](../../aspose.cells/horizontalpagebreakcollection/add#add_3)(string) | يضيف فاصل صفحات أفقيًا إلى المجموعة. |
| [Add](../../aspose.cells/horizontalpagebreakcollection/add#add_1)(int, int) | يضيف فاصل صفحات أفقيًا إلى المجموعة. |
| [Add](../../aspose.cells/horizontalpagebreakcollection/add#add_2)(int, int, int) | يضيف فاصل صفحات أفقيًا إلى المجموعة. |
...
| [RemoveAt](../../aspose.cells/horizontalpagebreakcollection/removeat#removeat)(int) | يزيل عنصر HPageBreak باسم محدد. (2 methods) |
