...
description: يمثل خيارات حفظ ملف xlsb .
type: docs
weight: 6550
url: /ar/net/aspose.cells/xlsbsaveoptions/
---
...
| اسم | وصف |
| --- | --- |
| [XlsbSaveOptions](xlsbsaveoptions#constructor)() | ينشئ خيارات حفظ ملف xlsb . |
...
| [CompressionType](../../aspose.cells/xlsbsaveoptions/compressiontype) { get; set; } | الحصول على وتعيين نوع الضغط لملف ooxml . |
...
| [ExportAllColumnIndexes](../../aspose.cells/xlsbsaveoptions/exportallcolumnindexes) { get; set; } | يشير إلى ما إذا كان سيتم تصدير كافة فهارس الأعمدة للخلايا. |
