...
description: مجموعة كائنات عامل التصفية التي تمثل جميع المرشحات في نطاق تمت تصفيته تلقائيًا.
type: docs
weight: 3440
url: /ar/net/aspose.cells/filtercolumncollection/
---
## FilterColumnCollection class

مجموعة كائنات عامل التصفية التي تمثل جميع المرشحات في نطاق تمت تصفيته تلقائيًا.
...
| [Item](../../aspose.cells/filtercolumncollection/item) { get; } | يحصل[`FilterColumn`](../filtercolumn) الكائن في الحقل الخاص. |
...
| [GetByIndex](../../aspose.cells/filtercolumncollection/getbyindex)(int) | إرجاع كائن تصفية واحد من مجموعة. |
