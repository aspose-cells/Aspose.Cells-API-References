...
description: يحدد مجموعة كل كائنات Slicer في ورقة العمل المحددة.
type: docs
weight: 5690
url: /ar/net/aspose.cells.slicers/slicercollection/
---
...
| [Item](../../aspose.cells.slicers/slicercollection/item) { get; } | يحصل على القطاعة حسب الفهرس . (2 indexers) |
...
| اسم | وصف |
| --- | --- |
| [Add](../../aspose.cells.slicers/slicercollection/add#add_8)(ListObject, int, string) | إضافة أداة تقطيع جديدة باستخدام ListObjet كمصدر بيانات |
| [Add](../../aspose.cells.slicers/slicercollection/add#add_7)(ListObject, ListColumn, string) | إضافة أداة تقطيع جديدة باستخدام ListObjet كمصدر بيانات |
| [Add](../../aspose.cells.slicers/slicercollection/add#add_4)(PivotTable, string, int) | إضافة أداة تقطيع جديدة باستخدام PivotTable كمصدر بيانات |
| [Add](../../aspose.cells.slicers/slicercollection/add#add_3)(PivotTable, string, PivotField) | إضافة أداة تقطيع جديدة باستخدام PivotTable كمصدر بيانات |
| [Add](../../aspose.cells.slicers/slicercollection/add#add_5)(PivotTable, string, string) | إضافة أداة تقطيع جديدة باستخدام PivotTable كمصدر بيانات |
| [Add](../../aspose.cells.slicers/slicercollection/add#add_6)(ListObject, ListColumn, int, int) | إضافة أداة تقطيع جديدة باستخدام ListObjet كمصدر بيانات |
| [Add](../../aspose.cells.slicers/slicercollection/add#add_1)(PivotTable, int, int, int) | إضافة أداة تقطيع جديدة باستخدام PivotTable كمصدر بيانات |
| [Add](../../aspose.cells.slicers/slicercollection/add#add)(PivotTable, int, int, PivotField) | إضافة أداة تقطيع جديدة باستخدام PivotTable كمصدر بيانات |
| [Add](../../aspose.cells.slicers/slicercollection/add#add_2)(PivotTable, int, int, string) | إضافة أداة تقطيع جديدة باستخدام PivotTable كمصدر بيانات |
...
| [Remove](../../aspose.cells.slicers/slicercollection/remove)(Slicer) | إزالة Slicer المحدد |
| [RemoveAt](../../aspose.cells.slicers/slicercollection/removeat#removeat)(int) | حذف أداة تقطيع الشرائح في الفهرس المحدد (2 methods) |
