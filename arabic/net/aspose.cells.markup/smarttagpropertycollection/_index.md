...
description: يمثل جميع خصائص العلامة الذكية للخلية.
type: docs
weight: 4100
url: /ar/net/aspose.cells.markup/smarttagpropertycollection/
---
## SmartTagPropertyCollection class

يمثل جميع خصائص العلامة الذكية للخلية.
...
| [Item](../../aspose.cells.markup/smarttagpropertycollection/item) { get; } | يحصل على أ[`SmartTagProperty`](../smarttagproperty) الكائن . (2 indexers) |
...
| اسم | وصف |
| --- | --- |
| [Add](../../aspose.cells.markup/smarttagpropertycollection/add)(string, string) | يضيف خاصية العلامة الذكية للخلية. |
