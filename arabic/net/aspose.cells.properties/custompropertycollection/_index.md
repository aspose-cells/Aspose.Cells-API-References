...
description: مجموعة منCustomProperty./customproperty كائنات تمثل معلومات إضافية.
type: docs
weight: 4850
url: /ar/net/aspose.cells.properties/custompropertycollection/
---
## CustomPropertyCollection class

مجموعة من[`CustomProperty`](../customproperty) كائنات تمثل معلومات إضافية.
...
| [Item](../../aspose.cells.properties/custompropertycollection/item) { get; } | يحصل على الخاصية المخصصة من خلال الفهرس المحدد . (2 indexers) |
...
| اسم | وصف |
| --- | --- |
| [Add](../../aspose.cells.properties/custompropertycollection/add)(string, string) | إضافة معلومات خاصية مخصصة . |
