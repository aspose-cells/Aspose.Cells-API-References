...
description: يحدد ملفConnectionParameter./connectionparameter collection
type: docs
weight: 3250
url: /ar/net/aspose.cells.externalconnections/connectionparametercollection/
---
## ConnectionParameterCollection class

يحدد ملف[`ConnectionParameter`](../connectionparameter) collection
...
| [Item](../../aspose.cells.externalconnections/connectionparametercollection/item) { get; set; } | يحصل على ملف[`ConnectionParameter`](../connectionparameter) عنصر في الفهرس المحدد. (2 indexers) |
| [Item](../../aspose.cells.externalconnections/connectionparametercollection/item) { get; } | يحصل على ملف[`ConnectionParameter`](../connectionparameter) عنصر بالاسم المحدد. |
