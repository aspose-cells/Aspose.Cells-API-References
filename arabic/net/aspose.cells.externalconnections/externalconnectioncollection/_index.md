...
description: يحدد ملفExternalConnection./externalconnection collection
type: docs
weight: 3300
url: /ar/net/aspose.cells.externalconnections/externalconnectioncollection/
---
## ExternalConnectionCollection class

يحدد ملف[`ExternalConnection`](../externalconnection) collection
...
| [Item](../../aspose.cells.externalconnections/externalconnectioncollection/item) { get; set; } | يحصل على ملف[`ExternalConnection`](../externalconnection) عنصر في الفهرس المحدد. (2 indexers) |
| [Item](../../aspose.cells.externalconnections/externalconnectioncollection/item) { get; } | يحصل على ملف[`ExternalConnection`](../externalconnection) عنصر بالاسم المحدد. |
...
| [GetExternalConnectionById](../../aspose.cells.externalconnections/externalconnectioncollection/getexternalconnectionbyid)(int) | يحصل على ملف[`ExternalConnection`](../externalconnection) عنصر بالمعرف المحدد. |
