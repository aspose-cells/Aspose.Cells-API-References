...
description: يمثل مجموعة من كافة ملفاتListColumn./listcolumn كائنات في كائن ListObject المحدد.
type: docs
weight: 5810
url: /ar/net/aspose.cells.tables/listcolumncollection/
---
## ListColumnCollection class

يمثل مجموعة من كافة ملفات[`ListColumn`](../listcolumn) كائنات في كائن ListObject المحدد.
...
| [Item](../../aspose.cells.tables/listcolumncollection/item) { get; } | الحصول على ListColumn بواسطة الفهرس . (2 indexers) |
