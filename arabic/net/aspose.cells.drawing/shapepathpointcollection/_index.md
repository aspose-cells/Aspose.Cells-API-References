...
description: يمثل جميع نقاط مسار الشكل .
type: docs
weight: 2720
url: /ar/net/aspose.cells.drawing/shapepathpointcollection/
---
...
| [Item](../../aspose.cells.drawing/shapepathpointcollection/item) { get; } | يحصل على نقطة مسار الشكل بالفهرس . |
...
| اسم | وصف |
| --- | --- |
| [Add](../../aspose.cells.drawing/shapepathpointcollection/add)(int, int) | يضيف نقطة مسار . |
