...
type: docs
weight: 2110
url: /ar/net/aspose.cells.drawing/gradientstopcollection/
---
...
| [Item](../../aspose.cells.drawing/gradientstopcollection/item) { get; set; } | يحصل على نقطة توقف التدرج بالفهرس . (2 indexers) |

## طُرق

| اسم | وصف |
| --- | --- |
| [Add](../../aspose.cells.drawing/gradientstopcollection/add#add)(double, CellsColor, int) | إضافة نقطة توقف التدرج . |
| [Add](../../aspose.cells.drawing/gradientstopcollection/add#add_1)(double, Color, int) | إضافة نقطة توقف التدرج . |
