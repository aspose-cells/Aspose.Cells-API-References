...
type: docs
weight: 1900
url: /ar/cpp/aspose.cells.charts/legend/
---
## Legend class
...
//تعيين عرض وارتفاع وسيلة الإيضاح
Legend legend = chart.GetLegend();

//وسيلة الإيضاح تكون على الجانب الأيمن من المخطط افتراضيًا.
//إذا كانت وسيلة الإيضاح على الجانب الأيسر أو الأيمن من المخطط، فإن تعيين خاصية Legend.X لن يكون له تأثير.
//إذا كانت وسيلة الإيضاح على الجزء العلوي أو السفلي من المخطط، فإن تعيين خاصية Legend.Y لن يكون له تأثير.
legend.SetY(1500);
legend.SetWidth(50);
legend.SetHeight(50);
//تعيين موضع وسيلة الإيضاح
