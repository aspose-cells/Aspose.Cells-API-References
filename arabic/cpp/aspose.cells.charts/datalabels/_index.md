...
type: docs
weight: 1400
url: /ar/cpp/aspose.cells.charts/datalabels/
---
## DataLabels class
...
Aspose::Cells::Startup();
    //تعيين تسميات البيانات في المخطط
    ...
    for (int i = 0; i < chart.GetNSeries().GetCount(); i++)
    {
        ...
        //تعيين موضع تسميات البيانات
        datalabels.SetPosition(LabelPositionType::InsideBase);
        //إظهار اسم الفئة في تسميات البيانات
        datalabels.SetShowCategoryName(true);
        //إظهار القيمة في تسميات البيانات
        datalabels.SetShowValue(true);
        //عدم إظهار النسبة المئوية في تسميات البيانات
        datalabels.SetShowPercentage(false);
        //عدم إظهار مفتاح الأسطورة.
