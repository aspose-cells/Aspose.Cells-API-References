...
type: docs
weight: 8300
url: /ar/cpp/aspose.cells.charts/chart/toimage/
---
...
//يحفظ كملف Tiff بدقة 300 نقطة في البوصة وضغط CCITT4.
...
//يحفظ كملف Jpeg بدقة 300 نقطة في البوصة وجودة صورة 80.
...
```cpp
Aspose::Cells::Startup();
//يحصل على كائن bitmap بدقة 200 نقطة في البوصة أفقياً و300 نقطة في البوصة رأسياً.
