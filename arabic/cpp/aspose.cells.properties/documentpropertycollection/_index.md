...
type: docs
weight: 800
url: /ar/cpp/aspose.cells.properties/documentpropertycollection/
---
...
//إنشاء كائن Workbook عن طريق استدعاء المُنشئ الفارغ الخاص به
Workbook workbook(u"book1.xls");

//استرجاع قائمة بجميع خصائص المستند المخصصة لملف Excel
DocumentPropertyCollection customProperties = workbook.GetWorksheets().GetCustomDocumentProperties();

//الوصول إلى خاصية مستند مخصصة باستخدام فهرس الخاصية
