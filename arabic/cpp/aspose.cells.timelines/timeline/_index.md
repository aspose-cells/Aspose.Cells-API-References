...
type: docs
weight: 100
url: /ar/cpp/aspose.cells.timelines/timeline/
---
## Timeline class
...
//تحديث بيانات الجدول المحوري
pivot.RefreshData();
pivot.CalculateData();

//إضافة مخطط زمني جديد باستخدام الجدول المحوري كمصدر للبيانات
sheet.GetTimelines().Add(pivot, 10, 5, u"date");

//الحصول على كائن المخطط الزمني
