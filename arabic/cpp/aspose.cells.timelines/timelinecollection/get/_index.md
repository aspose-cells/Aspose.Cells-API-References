---
title: Aspose::Cells::Timelines::TimelineCollection::Get method
linktitle: Get
second_title: Aspose.Cells for C++ API Reference
description: 'Aspose::Cells::Timelines::TimelineCollection::Get method. Gets the Timeline by index in C++.'
type: docs
weight: 600
url: /ar/cpp/aspose.cells.timelines/timelinecollection/get/
---
...
```cpp
//الحصول على الـ Timeline حسب الفهرس.
...
```cpp
//الحصول على الـ Timeline حسب اسم الـ Timeline.
