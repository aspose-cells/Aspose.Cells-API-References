---
title: Aspose::Cells::LowCode::LowCodeSaveOptionsProviderOfAssembling class
linktitle: LowCodeSaveOptionsProviderOfAssembling
second_title: Aspose.Cells for C++ API Reference
description: 'Aspose::Cells::LowCode::LowCodeSaveOptionsProviderOfAssembling class. Implementation to provide save options which save split parts to files and the path of resultant file are named as(it may contains directories): PathHeader+SheetPrefix+SheetIndex(or SheetName) +SplitPartPrefix+SplitPartIndex+PathTail in C++.'
type: docs
weight: 1300
url: /ar/cpp/aspose.cells.lowcode/lowcodesaveoptionsproviderofassembling/
---
