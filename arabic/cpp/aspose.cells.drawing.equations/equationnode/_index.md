...
type: docs
weight: 800
url: /ar/cpp/aspose.cells.drawing.equations/equationnode/
---
## EquationNode class
...
// إنشاء كائن Workbook يمثل ملف Excel.
Workbook workbook;

// يضيف كائن معادلة إلى ورقة العمل.
TextBox textBox = workbook.GetWorksheets().Get(0).GetShapes().AddEquation(1, 0, 1, 0, 100, 300);

// يحصل على العقدة البداية لكائن المعادلة
