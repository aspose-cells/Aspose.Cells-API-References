---
title: Aspose::Cells::HtmlSaveOptions::GetHiddenColDisplayType method
linktitle: GetHiddenColDisplayType
second_title: Aspose.Cells for C++ API Reference
description: 'Aspose::Cells::HtmlSaveOptions::GetHiddenColDisplayType method. Hidden column(the width of this column is 0) in excel,before save this into html format, if HtmlHiddenColDisplayType is "Remove",the hidden column would not been output, if the value is "Hidden", the column would been output,but was hidden,the default value is "Hidden" in C++.'
type: docs
weight: 4600
url: /ar/cpp/aspose.cells/htmlsaveoptions/gethiddencoldisplaytype/
---
## HtmlSaveOptions::GetHiddenColDisplayType method
...
```cpp
HtmlHiddenColDisplayType Aspose::Cells::HtmlSaveOptions::GetHiddenColDisplayType()
```
