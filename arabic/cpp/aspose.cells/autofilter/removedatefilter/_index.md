---
title: Aspose::Cells::AutoFilter::RemoveDateFilter method
linktitle: RemoveDateFilter
second_title: Aspose.Cells for C++ API Reference
description: 'Aspose::Cells::AutoFilter::RemoveDateFilter method. Removes a date filter in C++.'
type: docs
weight: 1200
url: /ar/cpp/aspose.cells/autofilter/removedatefilter/
---
...
```cpp
void Aspose::Cells::AutoFilter::RemoveDateFilter(int32_t fieldIndex, DateTimeGroupingType dateTimeGroupingType, int32_t year, int32_t month, int32_t day, int32_t hour, int32_t minute, int32_t second)
```
