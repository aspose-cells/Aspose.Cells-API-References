...
type: docs
weight: 17400
url: /ar/cpp/aspose.cells/xmlmapcollection/
---
...
//الكود التالي يضيف خريطتين XmlMaps باستخدام ملف xsd وملف xml.
Workbook wb;

XmlMapCollection xmlMapCollection = wb.GetWorksheets().GetXmlMaps();

//إضافة XmlMap باستخدام ملف xsd.
xmlMapCollection.Add(u"schema.xsd");

//إضافة XmlMap باستخدام ملف xml.
