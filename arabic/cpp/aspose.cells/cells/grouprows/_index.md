---
title: Aspose::Cells::Cells::GroupRows method
linktitle: GroupRows
second_title: Aspose.Cells for C++ API Reference
description: 'Aspose::Cells::Cells::GroupRows method. Groups rows in C++.'
type: docs
weight: 10700
url: /ar/cpp/aspose.cells/cells/grouprows/
---
...
| --- | --- | --- |
| firstIndex | int32_t | The first row index to be grouped. |
| lastIndex | int32_t | The last row index to be grouped. |
| isHidden | bool | Specifies if the grouped rows are hidden. |
