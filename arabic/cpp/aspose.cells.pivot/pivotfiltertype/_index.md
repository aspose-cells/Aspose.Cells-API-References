...
description: 'Aspose::Cells::Pivot::PivotFilterType enum. Represents the filter type of the pivot table in C++.'
type: docs
weight: 3600
url: /ar/cpp/aspose.cells.pivot/pivotfiltertype/
---
...
| DateBefore | 21 | <br>Indicates the "before" filter for date values. |
...
| Quarter1 | 44 | <br>Indicates the "first quarter" filter for date values. |
