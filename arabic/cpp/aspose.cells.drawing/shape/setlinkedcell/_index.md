...
type: docs
weight: 14600
url: /ar/cpp/aspose.cells.drawing/shape/setlinkedcell/
---
...
```cpp
//بعد تنفيذ الشيفرة أدناه، يتم إنشاء كائن ScrollBar في الملف المُنشأ. عند سحب المنزلق، يتم عرض القيمة في الخلية A12.
