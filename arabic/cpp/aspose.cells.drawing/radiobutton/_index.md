---
title: Aspose::Cells::Drawing::RadioButton class
linktitle: RadioButton
second_title: Aspose.Cells for C++ API Reference
description: 'Aspose::Cells::Drawing::RadioButton class. Represents a radio button in C++.'
type: docs
weight: 4600
url: /ar/cpp/aspose.cells.drawing/radiobutton/
---
## RadioButton class
...
```cpp
class RadioButton : public Aspose::Cells::Drawing::Shape
```
...
| [GetGroupBox()](./getgroupbox/) | Gets the [GroupBox](../groupbox/) that contains this [RadioButton](./). |
...
| [GetOptionIndex()](./getoptionindex/) | Gets the option index (one-based) in all the radio buttons of the [GroupBox](../groupbox/) which contains this radio button. |
...
| [operator=(const RadioButton\& src)](./operator_asm/) | operator= |
| [operator=(const Shape\& src)](../shape/operator_asm/) | operator= |
| [RadioButton(RadioButton_Impl* impl)](./radiobutton/) | Constructs from an implementation object. |
| [RadioButton(const RadioButton\& src)](./radiobutton/) | Copy constructor. |
| [RadioButton(const Shape\& src)](./radiobutton/) | Constructs from a parent object. |
...
| [SetIsChecked(bool value)](./setischecked/) | Indicates if the radiobutton is checked or not. |
...
| [~RadioButton()](./~radiobutton/) | Destructor. |
