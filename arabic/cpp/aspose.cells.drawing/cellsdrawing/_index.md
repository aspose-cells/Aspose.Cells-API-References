---
title: Aspose::Cells::Drawing::CellsDrawing class
linktitle: CellsDrawing
second_title: Aspose.Cells for C++ API Reference
description: 'Aspose::Cells::Drawing::CellsDrawing class. Represents the auto shape and drawing object in C++.'
type: docs
weight: 700
url: /ar/cpp/aspose.cells.drawing/cellsdrawing/
---
## CellsDrawing class
...
```cpp
class CellsDrawing : public Aspose::Cells::Drawing::Shape
```
...
| [CellsDrawing(CellsDrawing_Impl* impl)](./cellsdrawing/) | Constructs from an implementation object. |
...
| [operator=(const CellsDrawing\& src)](./operator_asm/) | operator= |
...
| [~CellsDrawing()](./~cellsdrawing/) | Destructor. |
