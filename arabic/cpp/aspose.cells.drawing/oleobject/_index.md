...
type: docs
weight: 3900
url: /ar/cpp/aspose.cells.drawing/oleobject/
---
## OleObject class
...
//احصل على بيانات الصورة في المتغيّر "iconData". مثال: ملف .jpg اسمه "school.jpg"
//(ملاحظة: تحتاج إلى قراءة البيانات في هذا المتغيّر.)
Vector<uint8_t> iconData{0};

//احصل على بيانات كائن OLE في المتغيّر "objectData". مثال: ملف .xls اسمه "Book1.xls"
//(ملاحظة: تحتاج إلى قراءة البيانات في هذا المتغيّر.)
Vector<uint8_t> objectData{0};

//أضف كائن OLE إلى ورقة العمل مع الصورة
//المعروضة في MS Excel.
sheet.GetOleObjects().Add(14, 3, 200, 220, iconData);
//عيّن بيانات كائن OLE المضمن.
