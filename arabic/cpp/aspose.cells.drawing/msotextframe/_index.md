---
title: Aspose::Cells::Drawing::MsoTextFrame class
linktitle: MsoTextFrame
second_title: Aspose.Cells for C++ API Reference
description: 'Aspose::Cells::Drawing::MsoTextFrame class. Represents the text frame in a Shape object in C++.'
type: docs
weight: 3700
url: /ar/cpp/aspose.cells.drawing/msotextframe/
---
## MsoTextFrame class


Represents the text frame in a [Shape](../shape/) object.
...
| [MsoTextFrame(MsoTextFrame_Impl* impl)](./msotextframe/) | Constructs from an implementation object. |
| [MsoTextFrame(const MsoTextFrame\& src)](./msotextframe/) | Copy constructor. |
| explicit [operator bool()](./operator_bool/) const | operator bool() |
| [operator=(const MsoTextFrame\& src)](./operator_asm/) | operator= |
...
| [SetIsAutoMargin(bool value)](./setisautomargin/) | Indicates whether the margin is auto calculated. |
...
| [~MsoTextFrame()](./~msotextframe/) | Destructor. |
## Fields
