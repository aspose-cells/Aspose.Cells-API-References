...
type: docs
weight: 150
url: /ar/python-net/aspose.cells.properties/builtindocumentpropertycollection/content_status/
is_root: false
---
##  content_status الملكية

الحصول على أو تحديد حالة محتوى المستند.
###  تعريف:
```python
@property
