...
يعيّن مجموعات الحقول اليدوية بواسطة PivotTable.
...
| group_by_list | list | يحدد قائمة نوع التجميع.|
...
| group_by_list | list | يحدد قائمة نوع التجميع.|
| interval_num | int | تحديد مجموعة أرقام الفاصل الزمني حسب تجميع الأيام. يجب أن يكون عدد الأيام عددًا صحيحًا موجبًا غير صفري|
