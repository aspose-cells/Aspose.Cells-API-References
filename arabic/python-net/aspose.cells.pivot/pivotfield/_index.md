...
type: docs
weight: 10
url: /ar/python-net/aspose.cells.pivot/pivotfield/
is_root: false
---
##  PivotField الدرجة
...
يكشف نوع PivotField الأعضاء التالية:
...
| [is_auto_sort](/cells/ar/python-net/aspose.cells.pivot/pivotfield/is_auto_sort) | الإشارة إلى ما إذا كان سيتم فرز حقل PivotTable المحدد تلقائيًا.|
| [is_ascend_sort](/cells/ar/python-net/aspose.cells.pivot/pivotfield/is_ascend_sort) | الإشارة إلى ما إذا كان حقل PivotTable المحدد يتم فرزه تلقائيًا بشكل تصاعدي.|
...
| [base_item_position](/cells/ar/python-net/aspose.cells.pivot/pivotfield/base_item_position) | يمثل العنصر في الحقل الأساسي لحساب مخصص.<br/> صالحة فقط لحقول البيانات.<br/>لأن PivotItemPosition.Custom للقراءة فقط ، إذا كنت بحاجة إلى تعيين PivotItemPosition.Custom ،<br/> يرجى تعيين سمة PivotField.BaseItemIndex.|
| [base_item_index](/cells/ar/python-net/aspose.cells.pivot/pivotfield/base_item_index) | يمثل العنصر في الحقل الأساسي لحساب مخصص.<br/> صالحة فقط لحقول البيانات.|
...
| طريقة| وصف|
| :- | :- |
| [hide_item(index, is_hidden)](/cells/ar/python-net/aspose.cells.pivot/pivotfield/hide_item/#int-bool) | تعيين ما إذا كان PivotItem المحدد في حقل البيانات مخفيًا.|
| [hide_item(item_value, is_hidden)](/cells/ar/python-net/aspose.cells.pivot/pivotfield/hide_item/#str-bool) | تعيين ما إذا كان PivotItem المحدد في حقل البيانات مخفيًا.|
| [get_pivot_filter_by_type(type)](/cells/ar/python-net/aspose.cells.pivot/pivotfield/get_pivot_filter_by_type/#PivotFilterType) | يحصل على عامل التصفية المحوري للحقل المحوري حسب النوع|
| [get_pivot_filters()](/cells/ar/python-net/aspose.cells.pivot/pivotfield/get_pivot_filters/#) | يحصل على المرشحات المحورية للحقل المحوري|
| [init_pivot_items()](/cells/ar/python-net/aspose.cells.pivot/pivotfield/init_pivot_items/#) | ابدأ العناصر المحورية للحقل المحوري|
