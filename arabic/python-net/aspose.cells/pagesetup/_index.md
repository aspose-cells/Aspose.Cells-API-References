---
title: PageSetup الدرجة
second_title: Aspose.Cells for Python via .NET API المراجع
description:
type: docs
weight: 1140
url: /ar/python-net/aspose.cells/pagesetup/
is_root: false
---
##  PageSetup الدرجة
 لتغليف الكائن الذي يمثل وصف إعداد الصفحة.
يحتوي العنصر PageSetup على كافة اختيارات إعداد الصفحة.



يكشف نوع PageSetup الأعضاء التالية:
...
| [paper_height](/cells/ar/python-net/aspose.cells/pagesetup/paper_height) | الحصول على ارتفاع الورقة بوحدة البوصة ، مع مراعاة اتجاه الصفحة.|
| [orientation](/cells/ar/python-net/aspose.cells/pagesetup/orientation) | يمثل اتجاه طباعة الصفحة.|
| [print_comments](/cells/ar/python-net/aspose.cells/pagesetup/print_comments) | يمثل طريقة طباعة التعليقات بالورقة.|
| [print_errors](/cells/ar/python-net/aspose.cells/pagesetup/print_errors) | يحدد نوع خطأ الطباعة المعروض.|
| [print_headings](/cells/ar/python-net/aspose.cells/pagesetup/print_headings) | يمثل حالة طباعة عناوين الصفوف والأعمدة بهذه الصفحة.|
| [print_gridlines](/cells/ar/python-net/aspose.cells/pagesetup/print_gridlines) | يمثل حالة طباعة خطوط شبكة الخلية على الصفحة.|
| [zoom](/cells/ar/python-net/aspose.cells/pagesetup/zoom) | يمثل عامل التحجيم بالنسبة المئوية. يجب أن يكون بين 10 و 400.|
| [is_auto_first_page_number](/cells/ar/python-net/aspose.cells/pagesetup/is_auto_first_page_number) | يشير إلى ما إذا كان قد تم تعيين رقم الصفحة الأول تلقائيًا.|
...
| طريقة| وصف|
| :- | :- |
| [get_picture(is_header, section)](/cells/ar/python-net/aspose.cells/pagesetup/get_picture/#bool-int) | الحصول على عنصر [Picture](/cells/ar/python-net/aspose.cells.drawing/picture) للرأس / التذييل.|
