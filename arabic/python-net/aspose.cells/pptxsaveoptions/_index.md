...
type: docs
weight: 1190
url: /ar/python-net/aspose.cells/pptxsaveoptions/
is_root: false
---
...
| البناء| وصف|
| :- | :- |
| [PptxSaveOptions()](/cells/ar/python-net/aspose.cells/pptxsaveoptions/__init__/#) | يمثل خيارات حفظ pptx.|
| [PptxSaveOptions(save_as_image)](/cells/ar/python-net/aspose.cells/pptxsaveoptions/__init__/#bool) | يمثل خيارات حفظ ملف .pptx.|


###  ملكيات
| ملكية| وصف|
| :- | :- |
| [save_format](/cells/ar/python-net/aspose.cells/pptxsaveoptions/save_format) | يحصل على تنسيق ملف الحفظ.|
| [clear_data](/cells/ar/python-net/aspose.cells/pptxsaveoptions/clear_data) | اجعل المصنف فارغًا بعد حفظ الملف.|
| [cached_file_folder](/cells/ar/python-net/aspose.cells/pptxsaveoptions/cached_file_folder) | يتم استخدام مجلد الملف المخزن مؤقتًا لتخزين بعض البيانات الكبيرة.|
| [validate_merged_areas](/cells/ar/python-net/aspose.cells/pptxsaveoptions/validate_merged_areas) | يشير إلى ما إذا كان يجب التحقق من صحة الخلايا المدمجة قبل حفظ الملف.|
...
| [output_blank_page_when_nothing_to_print](/cells/ar/python-net/aspose.cells/pptxsaveoptions/output_blank_page_when_nothing_to_print) | يشير إلى ما إذا كان سيتم إخراج صفحة فارغة في حالة عدم وجود شيء للطباعة.|
| [page_index](/cells/ar/python-net/aspose.cells/pptxsaveoptions/page_index) | الحصول على أو تحديد الفهرس الذي يستند إلى 0 للصفحة الأولى لحفظها.|
| [page_count](/cells/ar/python-net/aspose.cells/pptxsaveoptions/page_count) | الحصول على أو تحديد عدد الصفحات المراد حفظها.|
| [printing_page_type](/cells/ar/python-net/aspose.cells/pptxsaveoptions/printing_page_type) | يشير إلى الصفحات التي لن تتم طباعتها.|
| [gridline_type](/cells/ar/python-net/aspose.cells/pptxsaveoptions/gridline_type) | الحصول على نوع خط الشبكة أو تعيينه.|
| [text_cross_type](/cells/ar/python-net/aspose.cells/pptxsaveoptions/text_cross_type) | الحصول على عرض نوع النص أو تعيينه عندما يكون عرض النص أكبر من عرض الخلية.|
