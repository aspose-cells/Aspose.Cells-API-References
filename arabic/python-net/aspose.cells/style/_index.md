...
type: docs
weight: 1390
url: /ar/python-net/aspose.cells/style/
is_root: false
---
##  Style الدرجة
...
| البناء| وصف|
| :- | :- |
| [Style()](/cells/ar/python-net/aspose.cells/style/__init__/#) | يقوم بتهيئة نسخة جديدة من الفئة [Style](/cells/ar/python-net/aspose.cells/style).|


###  ملكيات
| ملكية| وصف|
| :- | :- |
| [background_theme_color](/cells/ar/python-net/aspose.cells/style/background_theme_color) | الحصول على لون سمة الخلفية وتعيينه.|
| [foreground_theme_color](/cells/ar/python-net/aspose.cells/style/foreground_theme_color) | الحصول على لون المظهر الأمامي وتعيينه.|
| [name](/cells/ar/python-net/aspose.cells/style/name) | الحصول على اسم النمط أو تحديده.|
| [pattern](/cells/ar/python-net/aspose.cells/style/pattern) |الحصول على نوع نمط خلفية الخلية أو تعيينه.|
| [borders](/cells/ar/python-net/aspose.cells/style/borders) | يحصل على [BorderCollection](/cells/ar/python-net/aspose.cells/bordercollection) من النمط.|
| [background_color](/cells/ar/python-net/aspose.cells/style/background_color) | الحصول على لون خلفية النمط أو تعيينه.|
| [background_argb_color](/cells/ar/python-net/aspose.cells/style/background_argb_color) | الحصول على لون الخلفية وتعيينه بقيمة ARGB 32 بت.|
| [foreground_color](/cells/ar/python-net/aspose.cells/style/foreground_color) | الحصول على لون مقدمة النمط أو تعيينه.|
...
| [invariant_custom](/cells/ar/python-net/aspose.cells/style/invariant_custom) | يحصل على سلسلة نمط الثقافة المستقلة لتنسيق الأرقام.<br/>إذا لم يتم تعيين تنسيق رقمي لهذا الكائن ، فسيتم إرجاع قيمة خالية.<br/> إذا كان تنسيق الأرقام مدمجًا ، فسيتم إرجاع سلسلة النمط المقابلة للرقم المضمن.|
| [is_formula_hidden](/cells/ar/python-net/aspose.cells/style/is_formula_hidden) | يمثل ما إذا كانت الصيغة ستكون مخفية عندما تكون ورقة العمل محمية.|
...
| طريقة| وصف|
| :- | :- |
| [set_border(border_type, border_style, border_color)](/cells/ar/python-net/aspose.cells/style/set_border/#BorderType-CellBorderType-aspose.pydrawing.Color) | يضبط حدود النمط.|
| [set_border(border_type, border_style, border_color)](/cells/ar/python-net/aspose.cells/style/set_border/#BorderType-CellBorderType-CellsColor) | يضبط حدود النمط.|
| [set_pattern_color(pattern, color1, color2)](/cells/ar/python-net/aspose.cells/style/set_pattern_color/#BackgroundType-aspose.pydrawing.Color-aspose.pydrawing.Color) | يضبط لون الخلفية.|
| [copy(style)](/cells/ar/python-net/aspose.cells/style/copy/#Style) | ينسخ البيانات من كائن نمط آخر|
| [update()](/cells/ar/python-net/aspose.cells/style/update/#) | قم بتطبيق النمط المسمى على أنماط الخلايا التي تستخدم هذا النمط المسمى.<br/>يعمل مثل النقر فوق الزر "موافق" بعد الانتهاء من تعديل النمط.<br/> ينطبق فقط على النمط المسمى.|
| [is_modified(modify_flag)](/cells/ar/python-net/aspose.cells/style/is_modified/#StyleModifyFlag) | للتحقق مما إذا كانت الخصائص المحددة للنمط قد تم تعديلها.<br/> يستخدم لنمط ConditionalFormattings للتحقق مما إذا كان يجب استخدام الخصائص المحددة لهذا النمط عند تطبيق ConditionalFormattings على خلية.|
| [set_custom(custom, builtin_preference)](/cells/ar/python-net/aspose.cells/style/set_custom/#str-bool) | يعيّن سلسلة تنسيق الأرقام المخصص لخلية.|
| [set_two_color_gradient(color1, color2, gradient_style_type, variant)](/cells/ar/python-net/aspose.cells/style/set_two_color_gradient/#aspose.pydrawing.Color-aspose.pydrawing.Color-aspose.cells.drawing.GradientStyleType-int) | يضبط التعبئة المحددة على تدرج لوني ثنائي اللون.|
| [get_two_color_gradient(color1, color2, gradient_style_type, variant)](/cells/ar/python-net/aspose.cells/style/get_two_color_gradient/#aspose.pydrawing.Color&-aspose.pydrawing.Color&-any-any) | احصل على إعداد التدرج ثنائي اللون.|
| [get_two_color_gradient_setting()](/cells/ar/python-net/aspose.cells/style/get_two_color_gradient_setting/#) | احصل على إعداد التدرج ثنائي اللون.|
| [to_json()](/cells/ar/python-net/aspose.cells/style/to_json/#) | تحويل [Style](/cells/ar/python-net/aspose.cells/style) إلى JSON بيانات هيكلية.|
