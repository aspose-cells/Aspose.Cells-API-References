...
type: docs
weight: 1630
url: /ar/python-net/aspose.cells/worksheetcollection/
is_root: false
---
##  WorksheetCollection الدرجة
لتغليف مجموعة من [Worksheet](/cells/ar/python-net/aspose.cells/worksheet) عنصر.
...
| ملكية| وصف|
| :- | :- |
| [web_extension_task_panes](/cells/ar/python-net/aspose.cells/worksheetcollection/web_extension_task_panes) | يحصل على قائمة أجزاء المهام.|
| [web_extensions](/cells/ar/python-net/aspose.cells/worksheetcollection/web_extensions) | يحصل على قائمة أجزاء المهام.|
| [threaded_comment_authors](/cells/ar/python-net/aspose.cells/worksheetcollection/threaded_comment_authors) | يحصل على قائمة مؤلفي التعليقات المترابطة.|
| [is_refresh_all_connections](/cells/ar/python-net/aspose.cells/worksheetcollection/is_refresh_all_connections) | يشير إلى ما إذا كان يتم تحديث جميع الاتصالات عند فتح الملف في MS Excel.|
| [names](/cells/ar/python-net/aspose.cells/worksheetcollection/names) | الحصول على مجموعة كل كائنات الاسم في جدول البيانات.|
| [active_sheet_name](/cells/ar/python-net/aspose.cells/worksheetcollection/active_sheet_name) | يمثل اسم ورقة العمل النشطة عند فتح جدول البيانات.|
| [active_sheet_index](/cells/ar/python-net/aspose.cells/worksheetcollection/active_sheet_index) | يمثل فهرس ورقة العمل النشطة عند فتح جدول البيانات.|
| [dxfs](/cells/ar/python-net/aspose.cells/worksheetcollection/dxfs) | الحصول على سجلات التنسيق التفاضلي الرئيسية.|
| [xml_maps](/cells/ar/python-net/aspose.cells/worksheetcollection/xml_maps) | الحصول على خرائط XML وتعيينها في المصنف.|
| [built_in_document_properties](/cells/ar/python-net/aspose.cells/worksheetcollection/built_in_document_properties) | تقوم بارجاع مجموعة [DocumentProperty](/cells/ar/python-net/aspose.cells.properties/documentproperty) التي تمثل كل خصائص الوثيقة المضمنة لجدول حسابي.|
| [custom_document_properties](/cells/ar/python-net/aspose.cells/worksheetcollection/custom_document_properties) | تقوم بارجاع مجموعة [DocumentProperty](/cells/ar/python-net/aspose.cells.properties/documentproperty) التي تمثل كل خصائص الوثيقة المهيأة للجدول الحسابي.|
...
| [add(sheet_name)](/cells/ar/python-net/aspose.cells/worksheetcollection/add/#str) | يضيف ورقة عمل إلى المجموعة.|
| [register_add_in_function(add_in_file, function_name, lib)](/cells/ar/python-net/aspose.cells/worksheetcollection/register_add_in_function/#str-str-bool) | يضيف وظيفة الوظيفة الإضافية في المصنف|
| [register_add_in_function(id, function_name)](/cells/ar/python-net/aspose.cells/worksheetcollection/register_add_in_function/#int-str) | يضيف وظيفة الوظيفة الإضافية في المصنف|
| [add_copy(sheet_name)](/cells/ar/python-net/aspose.cells/worksheetcollection/add_copy/#str) | يضيف ورقة عمل إلى المجموعة ونسخ البيانات من ورقة عمل موجودة.|
| [add_copy(sheet_index)](/cells/ar/python-net/aspose.cells/worksheetcollection/add_copy/#int) | يضيف ورقة عمل إلى المجموعة ونسخ البيانات من ورقة عمل موجودة.|
...
| [sort_names()](/cells/ar/python-net/aspose.cells/worksheetcollection/sort_names/#) | يفرز الأسماء المعرفة.|
| [swap_sheet(sheet_index1, sheet_index2)](/cells/ar/python-net/aspose.cells/worksheetcollection/swap_sheet/#int-int) | مقايضة الورقتين.|
| [remove_at(name)](/cells/ar/python-net/aspose.cells/worksheetcollection/remove_at/#str) | يزيل العنصر باسم محدد.|
| [get_named_ranges()](/cells/ar/python-net/aspose.cells/worksheetcollection/get_named_ranges/#) | يحصل على جميع النطاقات المسماة المحددة مسبقًا في جدول البيانات.|
