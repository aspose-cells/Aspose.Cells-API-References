...
type: docs
weight: 30
url: /ar/python-net/aspose.cells/paginatedsaveoptions/all_columns_in_one_page_per_sheet/
is_root: false
---
##  all_columns_in_one_page_per_sheet الملكية
 ...
 سيتم تجاهل عرض حجم الورق الخاص بإعداد الصفحات والإعدادات الأخرى لإعداد الصفحات
ستظل نافذة المفعول.
###  تعريف:
```python
@property
