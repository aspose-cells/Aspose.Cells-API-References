...
type: docs
weight: 120
url: /ar/python-net/aspose.cells/calculationdata/
is_root: false
---
##  CalculationData الدرجة
يمثل البيانات المطلوبة عند حساب دالة واحدة ، مثل اسم الوظيفة ، المعلمات ، ... إلخ.



يكشف نوع CalculationData الأعضاء التالية:

###  ملكيات
| ملكية| وصف|
| :- | :- |
| [calculated_value](/cells/ar/python-net/aspose.cells/calculationdata/calculated_value) | الحصول على أو تحديد القيمة المحسوبة لهذه الوظيفة.|
