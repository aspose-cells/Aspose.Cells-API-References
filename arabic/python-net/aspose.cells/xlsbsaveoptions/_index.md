---
title: XlsbSaveOptions الدرجة
second_title: Aspose.Cells for Python via .NET API المراجع
description:
type: docs
weight: 1660
url: /ar/python-net/aspose.cells/xlsbsaveoptions/
is_root: false
---
...
يكشف نوع XlsbSaveOptions الأعضاء التالية:

###  المنشئون
| البناء| وصف|
| :- | :- |
| [XlsbSaveOptions()](/cells/ar/python-net/aspose.cells/xlsbsaveoptions/__init__/#) | ينشئ خيارات حفظ ملف xlsb.|
| [XlsbSaveOptions(save_format)](/cells/ar/python-net/aspose.cells/xlsbsaveoptions/__init__/#SaveFormat) | ينشئ خيارات حفظ ملف xlsb.|


###  ملكيات
| ملكية| وصف|
| :- | :- |
| [save_format](/cells/ar/python-net/aspose.cells/xlsbsaveoptions/save_format) | يحصل على تنسيق ملف الحفظ.|
| [clear_data](/cells/ar/python-net/aspose.cells/xlsbsaveoptions/clear_data) | اجعل المصنف فارغًا بعد حفظ الملف.|
| [cached_file_folder](/cells/ar/python-net/aspose.cells/xlsbsaveoptions/cached_file_folder) | يتم استخدام مجلد الملف المخزن مؤقتًا لتخزين بعض البيانات الكبيرة.|
| [validate_merged_areas](/cells/ar/python-net/aspose.cells/xlsbsaveoptions/validate_merged_areas) | يشير إلى ما إذا كان يجب التحقق من صحة الخلايا المدمجة قبل حفظ الملف.|
...
* فئة [XlsbSaveOptions](/cells/ar/python-net/aspose.cells/xlsbsaveoptions)
