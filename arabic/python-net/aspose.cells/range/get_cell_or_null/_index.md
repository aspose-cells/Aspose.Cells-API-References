...
type: docs
weight: 80
url: /ar/python-net/aspose.cells/range/get_cell_or_null/
is_root: false
---
##  get_cell_or_null(row_offset, column_offset) {#int-int}
الحصول على عنصر [Cell](/cells/ar/python-net/aspose.cells/cell) أو الحصول على قيمة خالية في هذا النطاق.


###  عائدات

[Cell](/cells/ar/python-net/aspose.cells/cell) كائن.
