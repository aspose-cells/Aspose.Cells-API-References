...
type: docs
weight: 1030
url: /ar/python-net/aspose.cells/markdownsaveoptions/
is_root: false
---
##  MarkdownSaveOptions الدرجة
يمثل خيارات الحفظ لعملية تخفيض السعر.



**ميراث:** [MarkdownSaveOptions](/cells/python-net/aspose.cells/markdownsaveoptions) → 
[SaveOptions](/cells/ar/python-net/aspose.cells/saveoptions)



يكشف نوع MarkdownSaveOptions الأعضاء التالية:
...
| ملكية| وصف|
| :- | :- |
| [save_format](/cells/ar/python-net/aspose.cells/markdownsaveoptions/save_format) | يحصل على تنسيق ملف الحفظ.|
| [clear_data](/cells/ar/python-net/aspose.cells/markdownsaveoptions/clear_data) | اجعل المصنف فارغًا بعد حفظ الملف.|
| [cached_file_folder](/cells/ar/python-net/aspose.cells/markdownsaveoptions/cached_file_folder) | يتم استخدام مجلد الملف المخزن مؤقتًا لتخزين بعض البيانات الكبيرة.|
| [validate_merged_areas](/cells/ar/python-net/aspose.cells/markdownsaveoptions/validate_merged_areas) | يشير إلى ما إذا كان يجب التحقق من صحة الخلايا المدمجة قبل حفظ الملف.|
...
###  أنظر أيضا
* وحدة [aspose.cells](..)
* فئة [MarkdownSaveOptions](/cells/ar/python-net/aspose.cells/markdownsaveoptions)
