...
| NOT_CONTAINS_BLANKS | تبرز قاعدة التنسيق الشرطي هذه الخلايا التي<br/>ليست فارغة. ما يعادل استخدام LEN (TRIM ()).<br/>يعني أنه إذا كانت الخلية تحتوي فقط على أحرف<br/>سيتم إزالة TRIM () ، ثم يتم اعتباره فارغًا.<br/> تعتبر الخلايا الفارغة أيضًا فارغة.|
