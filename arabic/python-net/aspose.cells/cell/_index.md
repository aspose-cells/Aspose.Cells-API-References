...
type: docs
weight: 140
url: /ar/python-net/aspose.cells/cell/
is_root: false
---
##  Cell الدرجة
...
يكشف نوع Cell الأعضاء التالية:

###  ملكيات
| ملكية| وصف|
| :- | :- |
| [worksheet](/cells/ar/python-net/aspose.cells/cell/worksheet) | يحصل على ورقة العمل الأصل.|
| [date_time_value](/cells/ar/python-net/aspose.cells/cell/date_time_value) | الحصول على قيمة DateTime الموجودة في الخلية.|
| [row](/cells/ar/python-net/aspose.cells/cell/row) | الحصول على رقم صف الخلية (على أساس الصفر).|
| [column](/cells/ar/python-net/aspose.cells/cell/column) | الحصول على رقم العمود (على أساس الصفر) للخلية.|
| [is_formula](/cells/ar/python-net/aspose.cells/cell/is_formula) | يمثل إذا كانت الخلية المحددة تحتوي على صيغة.|
| [type](/cells/ar/python-net/aspose.cells/cell/type) | يمثل نوع قيمة الخلية.|
...
| [float_value](/cells/ar/python-net/aspose.cells/cell/float_value) | الحصول على القيمة العائمة الموجودة في الخلية.|
| [bool_value](/cells/ar/python-net/aspose.cells/cell/bool_value) | الحصول على القيمة المنطقية الموجودة في الخلية.|
| [has_custom_style](/cells/ar/python-net/aspose.cells/cell/has_custom_style) | الإشارة إلى ما إذا كانت هذه الخلية تحتوي على إعدادات نمط مخصصة (تختلف عن الإعدادات الافتراضية الموروثة<br/> من الصف أو العمود أو المصنف المقابل).|
| [shared_style_index](/cells/ar/python-net/aspose.cells/cell/shared_style_index) | الحصول على فهرس النمط المشترك للخلية في تجمع الأنماط.|
...
| طريقة| وصف|
| :- | :- |
| [calculate(options)](/cells/ar/python-net/aspose.cells/cell/calculate/#CalculationOptions) | تحسب صيغة الخلية.|
...
| [set_shared_formula(shared_formula, row_number, column_number)](/cells/ar/python-net/aspose.cells/cell/set_shared_formula/#str-int-int) | يضبط الصيغ المشتركة على نطاق من الخلايا.|
| [set_shared_formula(shared_formula, row_number, column_number, options)](/cells/ar/python-net/aspose.cells/cell/set_shared_formula/#str-int-int-FormulaParseOptions) | يضبط الصيغ المشتركة على نطاق من الخلايا.|
...
| [set_table_formula(row_number, column_number, row_index_of_input_cell, column_index_of_input_cell, is_row_input, values)](/cells/ar/python-net/aspose.cells/cell/set_table_formula/#int-int-int-int-bool-list) | قم بإنشاء جدول بيانات ذو متغير واحد لنطاق معين يبدأ من هذه الخلية.|
