...
type: docs
weight: 30
url: /ar/python-net/aspose.cells/calculationoptions/calc_stack_size/
is_root: false
---
...
في مثل هذه الحالات ، يجب على المستخدم تحديد القيمة المناسبة لهذه الخاصية وفقًا للصيغ والبيانات الفعلية.
قد تتسبب القيم الصغيرة جدًا في تدهور الأداء لحساب الصيغة.
###  تعريف:
```python
@property
