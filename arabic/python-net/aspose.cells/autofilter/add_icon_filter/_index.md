---
title: طريقة add_icon_filter
second_title: Aspose.Cells for Python via .NET API المراجع
description:
type: docs
weight: 60
url: /ar/python-net/aspose.cells/autofilter/add_icon_filter/
is_root: false
---
...
| icon_set_type | [IconSetType](/cells/ar/python-net/aspose.cells/iconsettype) | نوع مجموعة الأيقونات.|
| icon_id | int | معرف الرمز.|
###  ملاحظات

يدعم فقط إضافة عامل تصفية الأيقونة.
لا يدعم التحقق من الصف المرئي إذا كان المرشح هو عامل تصفية الرموز.
