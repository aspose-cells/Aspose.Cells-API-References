...
type: docs
weight: 700
url: /ar/python-net/aspose.cells/worksheet/protection/
is_root: false
---
##  protection الملكية
...
يمكن لهذه الخاصية حماية ورقة العمل في جميع إصدارات ملف Excel ودعم خيارات protection المتقدمة في ExcelXP والإصدار الأعلى.
###  تعريف:
```python
@property
def protection(self):
