...
type: docs
weight: 310
url: /ar/python-net/aspose.cells/worksheet/xml_map_query/
is_root: false
---
...
قائمة [CellArea](/cells/ar/python-net/aspose.cells/cellarea) التي تم تعيينها / ربطها بالمسار المحدد لخريطة xml ، يتم إرجاع قائمة فارغة إذا لم يتم تعيين / ربط أي شيء.
