...
type: docs
weight: 390
url: /ar/python-net/aspose.cells/htmlsaveoptions/hidden_col_display_type/
is_root: false
---
##  hidden_col_display_type الملكية
...
إذا كانت القيمة "مخفية" ، فسيتم إخراج العمود ، ولكن تم إخفاؤه ، والقيمة الافتراضية هي "مخفي"
###  تعريف:
```python
@property
...
###  أنظر أيضا
* وحدة [aspose.cells](../../)
* فئة [HtmlHiddenColDisplayType](/cells/ar/python-net/aspose.cells/htmlhiddencoldisplaytype)
