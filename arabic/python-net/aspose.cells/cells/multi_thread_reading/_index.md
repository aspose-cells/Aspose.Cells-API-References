...
type: docs
weight: 1200
url: /ar/python-net/aspose.cells/cells/multi_thread_reading/
is_root: false
---
...
يجب تعيين هذه الخاصية على أنها true ، وإلا فقد تظهر نتائج غير متوقعة.
...
مثل قيم التنسيق (بواسطة [Cell.string_value](/cells/ar/python-net/aspose.cells/cell#string_value) ، [Cell.display_string_value](/cells/ar/python-net/aspose.cells/cell#display_string_value) ، إلخ.).
لذلك ، حتى مع تعيين هذه الخاصية على أنها صحيحة ، قد لا تزال واجهات برمجة التطبيقات (API) هذه تعطي نتائج غير متوقعة لقراءة Multi-Thread.
###  تعريف:
```python
@property
