...
| [sort_external_names](/cells/ar/python-net/aspose.cells/odssaveoptions/sort_external_names) |يشير إلى ما إذا كان يتم فرز الأسماء المعرفة الخارجية قبل حفظ الملف.|
...
| [warning_callback](/cells/ar/python-net/aspose.cells/odssaveoptions/warning_callback) | يحصل أو يحدد رد الاتصال التحذيري.|
...
| [is_strict_schema11](/cells/ar/python-net/aspose.cells/odssaveoptions/is_strict_schema11) | يشير إلى ما إذا كان يجب حفظ ملف ods كإصدار 1.1 بتنسيق ODF. الافتراضي هو خطأ.|
