...
type: docs
weight: 470
url: /ar/python-net/aspose.cells/workbooksettings/precision_as_displayed/
is_root: false
---
##  precision_as_displayed الملكية

صواب إذا كانت العمليات الحسابية في هذا المصنف ستتم باستخدام دقة الأرقام فقط أثناء عرضها

###  ملاحظات

ملاحظة: هذا العضو قد عفا عليه الزمن الآن. بدلاً من ذلك ، يرجى استخدام FormulaSettings.PrecisionAsDisplayed.
