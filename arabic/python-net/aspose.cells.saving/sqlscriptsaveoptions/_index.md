---
title: SqlScriptSaveOptions الدرجة
second_title: Aspose.Cells for Python via .NET API المراجع
description:
type: docs
weight: 20
url: /ar/python-net/aspose.cells.saving/sqlscriptsaveoptions/
is_root: false
---
##  SqlScriptSaveOptions الدرجة
يمثل خيارات حفظ ملفات SQL.



**ميراث:** [SqlScriptSaveOptions](/cells/python-net/aspose.cells.saving/sqlscriptsaveoptions) → 
[SaveOptions](/cells/ar/python-net/aspose.cells/saveoptions)



يكشف نوع SqlScriptSaveOptions الأعضاء التالية:
...
| ملكية| وصف|
| :- | :- |
| [save_format](/cells/ar/python-net/aspose.cells.saving/sqlscriptsaveoptions/save_format) | يحصل على تنسيق ملف الحفظ.|
| [clear_data](/cells/ar/python-net/aspose.cells.saving/sqlscriptsaveoptions/clear_data) | اجعل المصنف فارغًا بعد حفظ الملف.|
| [cached_file_folder](/cells/ar/python-net/aspose.cells.saving/sqlscriptsaveoptions/cached_file_folder) | يتم استخدام مجلد الملف المخزن مؤقتًا لتخزين بعض البيانات الكبيرة.|
| [validate_merged_areas](/cells/ar/python-net/aspose.cells.saving/sqlscriptsaveoptions/validate_merged_areas) | يشير إلى ما إذا كان يجب التحقق من صحة الخلايا المدمجة قبل حفظ الملف.|
