...
type: docs
weight: 810
url: /ar/python-net/aspose.cells.drawing/fillpattern/
is_root: false
---
##  العد FillPattern
...
| WIDE_UPWARD_DIAGONAL | يمثل نمطًا قطريًا عريضًا صاعدًا.|
...
| DASHED_UPWARD_DIAGONAL | يمثل نمطًا قطريًا متقطعًا صاعدًا.|
...
| UNKNOWN | يمثل أنماطًا غير معروفة.|
