...
type: docs
weight: 760
url: /ar/python-net/aspose.cells.drawing/autoshapetype/
is_root: false
---
##  العد AutoShapeType
...
| SUN |  |
| MOON |  |
| DOUBLE_BRACKET | شكل محاط بأقواس.|
| DOUBLE_BRACE | شكل محاط بأقواس.|
| STAR4 |  |
| DOUBLE_WAVE |  |
| BLANK_ACTION_BUTTON |  |
| HOME_ACTION_BUTTON |  |
...
| FRAME |  |
| MODEL_3D |  |
| ROUND_CALLOUT | لا يوجد مثل هذا النوع في Excel|
| TEXT_ARCH_LEFT_POUR | لا يوجد مثل هذا النوع في Excel|
| TEXT_ARCH_RIGHT_POUR | لا يوجد مثل هذا النوع في Excel|
| TEXT_ARCH_LEFT_CURVE | لا يوجد مثل هذا النوع في Excel|
| TEXT_ARCH_RIGHT_CURVE | لا يوجد مثل هذا النوع في Excel|
| UNKNOWN |  |
