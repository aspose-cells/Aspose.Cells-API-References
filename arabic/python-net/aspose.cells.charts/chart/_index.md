...
type: docs
weight: 30
url: /ar/python-net/aspose.cells.charts/chart/
is_root: false
---
##  Chart الدرجة
...
يكشف نوع Chart الأعضاء التالية:
...
| [display_na_as_blank](/cells/ar/python-net/aspose.cells.charts/chart/display_na_as_blank) | يشير إلى ما إذا كان يتم عرض # N / A كقيمة فارغة.|
| [name](/cells/ar/python-net/aspose.cells.charts/chart/name) | الحصول على اسم المخطط وتعيينه.|
| [size_with_window](/cells/ar/python-net/aspose.cells.charts/chart/size_with_window) | إجابة صحيحة إذا قام Microsoft Excel بتغيير حجم المخطط ليطابق حجم نافذة ورقة المخطط.|
| [worksheet](/cells/ar/python-net/aspose.cells.charts/chart/worksheet) | يحصل على ورقة العمل التي تحتوي على هذا المخطط.|
| [shapes](/cells/ar/python-net/aspose.cells.charts/chart/shapes) | إرجاع كافة أشكال الرسم في هذا المخطط.|
...
| [category_axis](/cells/ar/python-net/aspose.cells.charts/chart/category_axis) | الحصول على المحور "س" في الرسم البياني.|
| [value_axis](/cells/ar/python-net/aspose.cells.charts/chart/value_axis) | الحصول على المحور ص للمخطط.|
| [second_value_axis](/cells/ar/python-net/aspose.cells.charts/chart/second_value_axis) | الحصول على المحور ص الثاني للمخطط.|
| [second_category_axis](/cells/ar/python-net/aspose.cells.charts/chart/second_category_axis) | الحصول على المحور X الثاني للمخطط.|
...
| [walls](/cells/ar/python-net/aspose.cells.charts/chart/walls) | إرجاع عنصر [Chart.walls](/cells/ar/python-net/aspose.cells.charts/chart#walls) يمثل جدران مخطط ثلاثي الأبعاد.|
| [back_wall](/cells/ar/python-net/aspose.cells.charts/chart/back_wall) |إرجاع عنصر [Chart.walls](/cells/ar/python-net/aspose.cells.charts/chart#walls) يمثل الجدار الخلفي لمخطط ثلاثي الأبعاد.|
| [side_wall](/cells/ar/python-net/aspose.cells.charts/chart/side_wall) | إرجاع عنصر [Chart.walls](/cells/ar/python-net/aspose.cells.charts/chart#walls) يمثل الجدار الجانبي لمخطط ثلاثي الأبعاد.|
...
| [right_angle_axes](/cells/ar/python-net/aspose.cells.charts/chart/right_angle_axes) | صحيح إذا كانت محاور المخطط في زوايا قائمة. ينطبق فقط على المخططات ثلاثية الأبعاد (باستثناء المخططات الدائرية العمودية ثلاثية الأبعاد وثلاثية الأبعاد).|
...
| طريقة| وصف|
| :- | :- |
| [to_image(image_file)](/cells/ar/python-net/aspose.cells.charts/chart/to_image/#str) | ينشئ صورة المخطط ويحفظها في ملف.<br/> يحدد امتداد اسم الملف تنسيق الصورة.|
| [to_image(image_file, image_type)](/cells/ar/python-net/aspose.cells.charts/chart/to_image/#str-aspose.cells.drawing.ImageType) | ينشئ صورة المخطط ويحفظها في ملف في نوع الصورة المحدد.|
| [to_image(image_file, jpeg_quality)](/cells/ar/python-net/aspose.cells.charts/chart/to_image/#str-int) | ينشئ صورة المخطط ويحفظها في ملف بتنسيق Jpeg.|
| [to_image(stream, jpeg_quality)](/cells/ar/python-net/aspose.cells.charts/chart/to_image/#io.RawIOBase-int) | ينشئ صورة المخطط ويحفظها في دفق بتنسيق Jpeg.|
| [to_image(stream, image_type)](/cells/ar/python-net/aspose.cells.charts/chart/to_image/#io.RawIOBase-aspose.cells.drawing.ImageType) |ينشئ صورة المخطط ويحفظها في دفق بالتنسيق المحدد.|
| [to_image(image_file, options)](/cells/ar/python-net/aspose.cells.charts/chart/to_image/#str-aspose.cells.rendering.ImageOrPrintOptions) | ينشئ صورة المخطط ويحفظها في ملف.<br/> يحدد امتداد اسم الملف تنسيق الصورة.|
| [to_image(stream, options)](/cells/ar/python-net/aspose.cells.charts/chart/to_image/#io.RawIOBase-aspose.cells.rendering.ImageOrPrintOptions) |ينشئ صورة المخطط ويحفظها في دفق بالتنسيق المحدد.|
| [to_pdf(file_name)](/cells/ar/python-net/aspose.cells.charts/chart/to_pdf/#str) | يحفظ الرسم البياني في ملف pdf.|
| [to_pdf(file_name, desired_page_width, desired_page_height, h_alignment_type, v_alignment_type)](/cells/ar/python-net/aspose.cells.charts/chart/to_pdf/#str-float-float-PageLayoutAlignmentType-PageLayoutAlignmentType) | يحفظ الرسم البياني في ملف pdf.|
| [to_pdf(stream)](/cells/ar/python-net/aspose.cells.charts/chart/to_pdf/#io.RawIOBase) | ينشئ مخطط pdf ويحفظه في دفق.|
| [to_pdf(stream, desired_page_width, desired_page_height, h_alignment_type, v_alignment_type)](/cells/ar/python-net/aspose.cells.charts/chart/to_pdf/#io.RawIOBase-float-float-PageLayoutAlignmentType-PageLayoutAlignmentType) | ينشئ مخطط pdf ويحفظه في دفق.|
...
| [set_chart_data_range(area, is_vertical)](/cells/ar/python-net/aspose.cells.charts/chart/set_chart_data_range/#str-bool) | يحدد نطاق البيانات للرسم البياني.|
