...
type: docs
weight: 130
url: /ar/python-net/aspose.cells.charts/chart/to_pdf/
is_root: false
---
...
| desired_page_height | float | ارتفاع الصفحة المطلوب بالبوصة.|
| h_alignment_type | [PageLayoutAlignmentType](/cells/ar/python-net/aspose.cells/pagelayoutalignmenttype) | نوع المحاذاة الأفقية للمخطط في صفحة الإخراج.|
| v_alignment_type | [PageLayoutAlignmentType](/cells/ar/python-net/aspose.cells/pagelayoutalignmenttype) | نوع المحاذاة الرأسية للمخطط في صفحة الإخراج.|
