...
type: docs
weight: 330
url: /ar/python-net/aspose.cells.charts/chartpoint/shape_properties/
is_root: false
---
##  shape_properties الملكية

الحصول على العنصر [ShapePropertyCollection](/cells/ar/python-net/aspose.cells.drawing/shapepropertycollection) الذي يحتفظ بخصائص الشكل المرئي لـ ChartPoint.
###  تعريف:
```python
@property
