...
| BAR_3D_CLUSTERED | يمثل مخطط شريطي ثلاثي الأبعاد متفاوت المسافات.|
...
| CONE_STACKED | يمثل مخطط مخروطي مكدس.|
...
| DOUGHNUT_EXPLODED | يمثل مخطط دائري مجوف.|
...
| PIE_3D | يمثل مخططات دائرية ثلاثية الأبعاد.|
...
| SCATTER_CONNECTED_BY_CURVES_WITHOUT_DATA_MARKER | يمثل مخطط مبعثر متصل بمنحنيات ، بدون علامات بيانات.|
...
| RADIAL_HISTOGRAM | تم وضع السلسلة كمدرج تكراري شعاعي.|
