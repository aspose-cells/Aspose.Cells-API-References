...
type: docs
weight: 410
url: /ar/python-net/aspose.cells.charts/series/shape_properties/
is_root: false
---
##  shape_properties الملكية

الحصول على العنصر [ShapePropertyCollection](/cells/ar/python-net/aspose.cells.drawing/shapepropertycollection) الذي يحمل خصائص الشكل المرئي للسلسلة.
###  تعريف:
```python
@property
