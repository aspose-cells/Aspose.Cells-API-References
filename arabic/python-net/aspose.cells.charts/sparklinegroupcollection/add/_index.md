...
type: docs
weight: 20
url: /ar/python-net/aspose.cells.charts/sparklinegroupcollection/add/
is_root: false
---
##  add(type, data_range, is_vertical, location_range) {#SparklineType-str-bool-CellArea}
لاضافة عنصر [SparklineGroup](/cells/ar/python-net/aspose.cells.charts/sparklinegroup) للمجموعة.


###  عائدات

[SparklineGroup](/cells/ar/python-net/aspose.cells.charts/sparklinegroup) فهرس العنصر.
...
| is_vertical | bool | يحدد ما إذا كان سيتم رسم خطوط المؤشرات من نطاق البيانات حسب الصف أو العمود.|
| location_range | [CellArea](/cells/ar/python-net/aspose.cells/cellarea) | يحدد مكان وضع خطوط المؤشرات.|
