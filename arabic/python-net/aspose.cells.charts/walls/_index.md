...
type: docs
weight: 350
url: /ar/python-net/aspose.cells.charts/walls/
is_root: false
---
##  Walls الدرجة
...
يكشف نوع Walls الأعضاء التالية:

###  ملكيات
| ملكية| وصف|
| :- | :- |
| [background_color](/cells/ar/python-net/aspose.cells.charts/walls/background_color) | الحصول على او تحديد لون خلفية [Area](/cells/ar/python-net/aspose.cells.drawing/area).|
| [foreground_color](/cells/ar/python-net/aspose.cells.charts/walls/foreground_color) | الحصول على او تحديد لون المقدمة.|
| [formatting](/cells/ar/python-net/aspose.cells.charts/walls/formatting) | يمثل تنسيق المنطقة.|
| [invert_if_negative](/cells/ar/python-net/aspose.cells.charts/walls/invert_if_negative) | إذا كانت الخاصية صحيحة وكانت قيمة نقطة المخطط رقمًا سالبًا ،<br/> سيتم استبدال لون المقدمة ولون الخلفية.|
| [fill_format](/cells/ar/python-net/aspose.cells.charts/walls/fill_format) | يمثل عنصر [Area.fill_format](/cells/ar/python-net/aspose.cells.drawing/area#fill_format) يحتوي على خصائص تنسيق التعبئة للشكل أو الرسم البياني المحدد.|
| [transparency](/cells/ar/python-net/aspose.cells.charts/walls/transparency) | إرجاع أو تعيين درجة شفافية المنطقة كقيمة من 0.0 (معتم) إلى 1.0 (واضح).|
...
* فئة [Walls](/cells/ar/python-net/aspose.cells.charts/walls)
