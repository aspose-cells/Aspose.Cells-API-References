...
type: docs
weight: 120
url: /ar/python-net/aspose.cells.charts/trendline/display_equation/
is_root: false
---
##  display_equation الملكية

يمثل ما إذا كانت معادلة خط الاتجاه معروضة على الرسم البياني (في نفس تسمية البيانات مثل قيمة R التربيعية).
###  تعريف:
```python
@property
