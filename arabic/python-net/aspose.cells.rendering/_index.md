...
is_root: false
---
 ال**Aspose.Cells.Rendering** يوفر مساحة الاسم فئات لعرض الصورة وقوات الدفاع الشعبي.
...
| [PdfBookmarkEntry](/cells/ar/python-net/aspose.cells.rendering/pdfbookmarkentry) | PdfBookmarkEntry هو إدخال في إشارة مرجعية pdf.<br/>إذا كانت خاصية Text للمثيل الحالي خالية أو "" ،<br/> سيتم إخفاء المثيل الحالي وسيتم إدراج الأطفال في المستوى الحالي.|
...
| [PdfCompliance](/cells/ar/python-net/aspose.cells.rendering/pdfcompliance) | السماح للمستخدم بتعيين توافق التحويل PDF|
