...
type: docs
weight: 290
url: /ar/python-net/aspose.cells.rendering/imageorprintoptions/sheet_set/
is_root: false
---
##  sheet_set الملكية
...
يتم تجاهل المجموعة عند استخدامها في [SheetRender](/cells/ar/python-net/aspose.cells.rendering/sheetrender)
###  تعريف:
```python
@property
def sheet_set(self):
