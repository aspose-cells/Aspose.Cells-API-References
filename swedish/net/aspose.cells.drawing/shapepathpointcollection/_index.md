...
description: Representerar alla formvägspunkter.
type: docs
weight: 2720
url: /sv/net/aspose.cells.drawing/shapepathpointcollection/
---
...
| [Item](../../aspose.cells.drawing/shapepathpointcollection/item) { get; } | Hämtar formväg punkt för index. |
...
| namn | Beskrivning |
| --- | --- |
| [Add](../../aspose.cells.drawing/shapepathpointcollection/add)(int, int) | Lägger till en sökvägspunkt. |
