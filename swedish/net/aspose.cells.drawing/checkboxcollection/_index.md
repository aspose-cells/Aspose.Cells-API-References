...
description: Representerar en samling avCheckBox./checkbox objekt i ett kalkylblad.
type: docs
weight: 1870
url: /sv/net/aspose.cells.drawing/checkboxcollection/
---
## CheckBoxCollection class

Representerar en samling av[`CheckBox`](../checkbox) objekt i ett kalkylblad.
...
| [Item](../../aspose.cells.drawing/checkboxcollection/item) { get; } | Får[`CheckBox`](../checkbox) element vid angivet index. |
...
| namn | Beskrivning |
| --- | --- |
| [Add](../../aspose.cells.drawing/checkboxcollection/add)(int, int, int, int) | Lägger till en kryssruta i samlingen. |
