...
description: Representerar listan över webbtilläggsegenskaper.
type: docs
weight: 6420
url: /sv/net/aspose.cells.webextensions/webextensionpropertycollection/
---
...
| [Item](../../aspose.cells.webextensions/webextensionpropertycollection/item) { get; } | Får egenskapen för webbtillägg genom index. (2 indexers) |
...
| namn | Beskrivning |
| --- | --- |
| [Add](../../aspose.cells.webextensions/webextensionpropertycollection/add)(string, string) | Lägger till egendom för webbtillägg. |
...
| [RemoveAt](../../aspose.cells.webextensions/webextensionpropertycollection/removeat#removeat_1)(string) | Ta bort egenskapen med namnet. |
