...
description: Representerar en samling av allaTrendline./trendline objekt för den angivna dataserien.
type: docs
weight: 990
url: /sv/net/aspose.cells.charts/trendlinecollection/
---
## TrendlineCollection class

Representerar en samling av alla[`Trendline`](../trendline) objekt för den angivna dataserien.
...
| [Item](../../aspose.cells.charts/trendlinecollection/item) { get; } | Får en objekt efter dess index. |
...
| namn | Beskrivning |
| --- | --- |
| [Add](../../aspose.cells.charts/trendlinecollection/add#add)(TrendlineType) | Lägger till en invända mot denna samling med angiven typ. |
| [Add](../../aspose.cells.charts/trendlinecollection/add#add_1)(TrendlineType, string) | Lägger till en invända mot denna samling med angiven typ och namn. |
