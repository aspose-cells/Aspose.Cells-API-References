...
description: Kapslar in en samling avSparkline./sparkline objekt.
type: docs
weight: 870
url: /sv/net/aspose.cells.charts/sparklinecollection/
---
## SparklineCollection class

Kapslar in en samling av[`Sparkline`](../sparkline) objekt.
...
| [Item](../../aspose.cells.charts/sparklinecollection/item) { get; } | Får[`Sparkline`](../sparkline) element vid angivet index. |
...
| namn | Beskrivning |
| --- | --- |
| [Add](../../aspose.cells.charts/sparklinecollection/add)(string, int, int) | Lägg till en sparkline. |
...
| [Remove](../../aspose.cells.charts/sparklinecollection/remove)(object) | Tar bort sparkline |
