...
description: Anger samlingen av alla Slicer-objekt på det angivna kalkylbladet.
type: docs
weight: 5690
url: /sv/net/aspose.cells.slicers/slicercollection/
---
...
| [Item](../../aspose.cells.slicers/slicercollection/item) { get; } | Hämtar skivaren efter index. (2 indexers) |
...
| namn | Beskrivning |
| --- | --- |
| [Add](../../aspose.cells.slicers/slicercollection/add#add_8)(ListObject, int, string) | Lägg till en ny Slicer med ListObjet som datakälla |
| [Add](../../aspose.cells.slicers/slicercollection/add#add_7)(ListObject, ListColumn, string) | Lägg till en ny Slicer med ListObjet som datakälla |
| [Add](../../aspose.cells.slicers/slicercollection/add#add_4)(PivotTable, string, int) | Lägg till en ny Slicer med pivottabell som datakälla |
| [Add](../../aspose.cells.slicers/slicercollection/add#add_3)(PivotTable, string, PivotField) | Lägg till en ny Slicer med pivottabell som datakälla |
| [Add](../../aspose.cells.slicers/slicercollection/add#add_5)(PivotTable, string, string) | Lägg till en ny Slicer med pivottabell som datakälla |
| [Add](../../aspose.cells.slicers/slicercollection/add#add_6)(ListObject, ListColumn, int, int) | Lägg till en ny Slicer med ListObjet som datakälla |
| [Add](../../aspose.cells.slicers/slicercollection/add#add_1)(PivotTable, int, int, int) | Lägg till en ny Slicer med pivottabell som datakälla |
| [Add](../../aspose.cells.slicers/slicercollection/add#add)(PivotTable, int, int, PivotField) | Lägg till en ny Slicer med pivottabell som datakälla |
| [Add](../../aspose.cells.slicers/slicercollection/add#add_2)(PivotTable, int, int, string) | Lägg till en ny Slicer med pivottabell som datakälla |
...
| [Remove](../../aspose.cells.slicers/slicercollection/remove)(Slicer) | Ta bort den angivna Slicer |
| [RemoveAt](../../aspose.cells.slicers/slicercollection/removeat#removeat)(int) | Tar bort skivaren vid angivet index (2 methods) |
