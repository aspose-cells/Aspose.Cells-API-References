...
type: docs
weight: 4050
url: /sv/net/aspose.cells.markup/customxmlpartcollection/
---
...
| [Item](../../aspose.cells.markup/customxmlpartcollection/item) { get; } | Hämtar ett objekt vid angivet index. |
...
| namn | Beskrivning |
| --- | --- |
| [Add](../../aspose.cells.markup/customxmlpartcollection/add)(byte[], byte[]) | Lägger till ett objekt i samlingen. |
...
| [SelectByID](../../aspose.cells.markup/customxmlpartcollection/selectbyid)(string) | Hämtar ett objekt med id. |
