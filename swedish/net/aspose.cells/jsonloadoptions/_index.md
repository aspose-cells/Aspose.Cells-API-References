...
description: Representerar alternativen för att ladda json files
type: docs
weight: 3920
url: /sv/net/aspose.cells/jsonloadoptions/
---
## JsonLoadOptions class

Representerar alternativen för att ladda json files
...
| namn | Beskrivning |
| --- | --- |
| [JsonLoadOptions](jsonloadoptions)() | Skapar ett alternativ för att ladda filen. |
...
| [LayoutOptions](../../aspose.cells/jsonloadoptions/layoutoptions) { get; set; } | Alternativen för import json. |
...
| [MultipleWorksheets](../../aspose.cells/jsonloadoptions/multipleworksheets) { get; set; } | Indikerar om varje attribut för JsonObject-objekt importeras som ett kalkylblad när alla underordnade noder är matrisnoder. |
...
| [StartCell](../../aspose.cells/jsonloadoptions/startcell) { get; set; } | Hämtar och ställer in startcellen. |
