...
description: Representerar listan med scenarier.
type: docs
weight: 5580
url: /sv/net/aspose.cells/scenariocollection/
---
## ScenarioCollection class

Representerar listan med scenarier.
...
| namn | Beskrivning |
| --- | --- |
| [ActiveIndex](../../aspose.cells/scenariocollection/activeindex) { get; set; } | Hämtar och ställer in vilket scenario som väljs. |
| [Capacity](../../aspose.cells/collectionbase`1/capacity) { get; set; } |  |
| [Count](../../aspose.cells/collectionbase`1/count) { get; } |  |
| [Item](../../aspose.cells/scenariocollection/item) { get; } | Får[`Scenario`](../scenario) objekt av index. |
| [Item](../../aspose.cells/collectionbase`1/item) { get; set; } |  |
| [LastSelected](../../aspose.cells/scenariocollection/lastselected) { get; set; } | Indikerar vilket scenario som senast valdes av användaren för att köras/visas. |

## Metoder

| namn | Beskrivning |
| --- | --- |
| [Add](../../aspose.cells/scenariocollection/add)(string) | Lägger till ett scenario. |
