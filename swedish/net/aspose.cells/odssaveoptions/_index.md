...
description: Representerar alternativen för att spara ods-fil.
type: docs
weight: 4340
url: /sv/net/aspose.cells/odssaveoptions/
---
...
| namn | Beskrivning |
| --- | --- |
| [OdsSaveOptions](odssaveoptions#constructor)() | Skapar alternativen för att spara ods-fil. |
| [OdsSaveOptions](odssaveoptions#constructor_1)(SaveFormat) | Skapar alternativen för att spara ods-fil. |
...
| [GeneratorType](../../aspose.cells/odssaveoptions/generatortype) { get; set; } | Hämtar och ställer in generatorn för ods-filen. |
| [IsStrictSchema11](../../aspose.cells/odssaveoptions/isstrictschema11) { get; set; } | Indikerar om ods-filen ska sparas som ODF-format version 1.1. Standard är false. |
