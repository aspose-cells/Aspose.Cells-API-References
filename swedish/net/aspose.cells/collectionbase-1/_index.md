...
description: Tillhandahåller den abstrakta basklassen för en starkt skriven samling.
type: docs
weight: 1020
url: /sv/net/aspose.cells/collectionbase-1/
---
...
| namn | Beskrivning |
| --- | --- |
| [Capacity](../../aspose.cells/collectionbase`1/capacity) { get; set; } | Hämtar eller ställer in antalet element som listan kan innehålla. |
| [Count](../../aspose.cells/collectionbase`1/count) { get; } | Hämtar antalet element. |
| [Item](../../aspose.cells/collectionbase`1/item) { get; set; } | Hämtar eller ställer in elementet på angivet index. |
...
| [Clear](../../aspose.cells/collectionbase`1/clear)() | Ta bort alla element. |
...
| [RemoveAt](../../aspose.cells/collectionbase`1/removeat)(int) | Tar bort elementet vid det angivna indexet. |
