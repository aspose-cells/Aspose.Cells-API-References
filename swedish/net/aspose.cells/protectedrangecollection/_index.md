...
description: Kapslar in en samling avProtectedRange./protectedrange objekt.
type: docs
weight: 4900
url: /sv/net/aspose.cells/protectedrangecollection/
---
## ProtectedRangeCollection class

Kapslar in en samling av[`ProtectedRange`](../protectedrange) objekt.
...
| [Item](../../aspose.cells/protectedrangecollection/item) { get; } | Får[`ProtectedRange`](../protectedrange) element vid angivet index. |
...
| namn | Beskrivning |
| --- | --- |
| [Add](../../aspose.cells/protectedrangecollection/add)(string, int, int, int, int) | Lägger till en[`ProtectedRange`](../protectedrange) föremål till samlingen. |
