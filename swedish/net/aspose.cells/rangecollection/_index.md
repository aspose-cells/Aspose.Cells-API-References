...
description: Kapslar in en samling avRange./range objekt.
type: docs
weight: 5040
url: /sv/net/aspose.cells/rangecollection/
---
## RangeCollection class

Kapslar in en samling av[`Range`](../range) objekt.
...
| [Item](../../aspose.cells/rangecollection/item) { get; } | Får[`Range`](../range) element vid angivet index. |
...
| namn | Beskrivning |
| --- | --- |
| [Add](../../aspose.cells/rangecollection/add)(Range) | Lägger till en[`Range`](../range) föremål till samlingen. |
