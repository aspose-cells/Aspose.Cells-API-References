...
description: Beskriver en samling av CFValueObject. Använd endast för ikonuppsättningar.
type: docs
weight: 1150
url: /sv/net/aspose.cells/conditionalformattingvaluecollection/
---
## ConditionalFormattingValueCollection class

Beskriver en samling av CFValueObject. Använd endast för ikonuppsättningar.
...
| [Item](../../aspose.cells/conditionalformattingvaluecollection/item) { get; } | Hämta CFValueObject-elementet vid det angivna indexet. |
...
| namn | Beskrivning |
| --- | --- |
| [Add](../../aspose.cells/conditionalformattingvaluecollection/add)(FormatConditionValueType, string) | Lägger till[`ConditionalFormattingValue`](../conditionalformattingvalue) objekt. |
