...
description: Representerar alternativen för att ladda xml.
type: docs
weight: 6580
url: /sv/net/aspose.cells/xmlloadoptions/
---
...
| namn | Beskrivning |
| --- | --- |
| [XmlLoadOptions](xmlloadoptions#constructor)() | Representerar alternativen för att ladda ods-filen. |
| [XmlLoadOptions](xmlloadoptions#constructor_1)(LoadFormat) | Representerar alternativen för att ladda ods-filen. |
...
| [ContainsMultipleWorksheets](../../aspose.cells/xmlloadoptions/containsmultipleworksheets) { get; set; } | Anger om xml importeras som flera kalkylblad. |
...
| [IsXmlMap](../../aspose.cells/xmlloadoptions/isxmlmap) { get; set; } | Indikerar om xml mappas till Excel. Standardvärdet är false. |
...
| [StartCell](../../aspose.cells/xmlloadoptions/startcell) { get; set; } | Hämtar och ställer in startcellen. |
