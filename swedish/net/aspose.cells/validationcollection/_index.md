...
description: Representerar insamling av datavalidering.
type: docs
weight: 6220
url: /sv/net/aspose.cells/validationcollection/
---
...
| [Item](../../aspose.cells/validationcollection/item) { get; } | Får[`Validation`](../validation) element vid angivet index. |
...
| namn | Beskrivning |
| --- | --- |
| [Add](../../aspose.cells/validationcollection/add#add_1)(CellArea) | Lägger till en datavalidering till samlingen. |
...
| [GetValidationInCell](../../aspose.cells/validationcollection/getvalidationincell)(int, int) | Får valideringen tillämpad på given cell. |
...
| [RemoveACell](../../aspose.cells/validationcollection/removeacell)(int, int) | Tar bort alla valideringsinställningar på cellen. |
| [RemoveArea](../../aspose.cells/validationcollection/removearea)(CellArea) | Tar bort alla valideringsinställningar på intervallet.. |
