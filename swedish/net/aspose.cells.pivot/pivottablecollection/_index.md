...
description: Representerar samlingen av alla pivottabellobjekt på det angivna kalkylbladet.
type: docs
weight: 4710
url: /sv/net/aspose.cells.pivot/pivottablecollection/
---
...
| [Item](../../aspose.cells.pivot/pivottablecollection/item) { get; } | Hämtar pivottabellrapporten efter index. (3 indexers) |
...
| namn | Beskrivning |
| --- | --- |
| [Add](../../aspose.cells.pivot/pivottablecollection/add#add_1)(PivotTable, string, string) | Lägger till ett nytt pivottabellobjekt till samlingen från en annan pivottabell. |
| [Add](../../aspose.cells.pivot/pivottablecollection/add#add_4)(string, string, string) | Lägger till en ny PivotTable-cache till en PivotCaches-samling. |
| [Add](../../aspose.cells.pivot/pivottablecollection/add#add)(PivotTable, int, int, string) | Lägger till ett nytt pivottabellobjekt till samlingen från en annan pivottabell. |
| [Add](../../aspose.cells.pivot/pivottablecollection/add#add_2)(string, int, int, string) | Lägger till en ny PivotTable-cache till en PivotCaches-samling. |
| [Add](../../aspose.cells.pivot/pivottablecollection/add#add_5)(string, string, string, bool) | Lägger till en ny PivotTable-cache till en PivotCaches-samling. |
| [Add](../../aspose.cells.pivot/pivottablecollection/add#add_3)(string, int, int, string, bool) | Lägger till en ny PivotTable-cache till en PivotCaches-samling. |
| [Add](../../aspose.cells.pivot/pivottablecollection/add#add_7)(string[], bool, PivotPageFields, string, string) | Lägger till ett nytt pivottabellobjekt till samlingen med flera konsolideringsintervall som datakälla. |
| [Add](../../aspose.cells.pivot/pivottablecollection/add#add_6)(string[], bool, PivotPageFields, int, int, string) | Lägger till ett nytt pivottabellobjekt till samlingen med flera konsolideringsintervall som datakälla. |
...
| [Clear](../../aspose.cells.pivot/pivottablecollection/clear#clear)() | Rensa alla pivottabeller. (2 methods) |
...
| [Dispose](../../aspose.cells.pivot/pivottablecollection/dispose)() | Utför programdefinierade uppgifter associerade med att frigöra, frigöra eller återställa ohanterade resurser. |
...
| [Remove](../../aspose.cells.pivot/pivottablecollection/remove#remove)(PivotTable) | Tar bort den angivna pivottabellen och tar bort pivottabellens data |
| [Remove](../../aspose.cells.pivot/pivottablecollection/remove#remove_1)(PivotTable, bool) | Tar bort den angivna pivottabellen |
| [RemoveAt](../../aspose.cells.pivot/pivottablecollection/removeat#removeat)(int) | Tar bort pivottabellen vid det angivna indexet och tar bort pivottabellens data (2 methods) |
| [RemoveAt](../../aspose.cells.pivot/pivottablecollection/removeat#removeat_2)(int, bool) | Tar bort pivottabellen vid det angivna index |
