...
description: AngerExternalConnection./externalconnection samling
type: docs
weight: 3300
url: /sv/net/aspose.cells.externalconnections/externalconnectioncollection/
---
## ExternalConnectionCollection class

Anger[`ExternalConnection`](../externalconnection) samling
...
| [Item](../../aspose.cells.externalconnections/externalconnectioncollection/item) { get; set; } | Får[`ExternalConnection`](../externalconnection) element vid angivet index. (2 indexers) |
| [Item](../../aspose.cells.externalconnections/externalconnectioncollection/item) { get; } | Får[`ExternalConnection`](../externalconnection) element med det angivna namnet. |
...
| [GetExternalConnectionById](../../aspose.cells.externalconnections/externalconnectioncollection/getexternalconnectionbyid)(int) | Får[`ExternalConnection`](../externalconnection) element med angivet id. |
