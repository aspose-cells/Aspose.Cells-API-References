---
title: ControlScrollOrientation uppräkning
second_title: Aspose.Cells for Python via .NET API Referenser
description:
type: docs
weight: 250
url: /sv/python-net/aspose.cells.drawing.activexcontrols/controlscrollorientation/
is_root: false
---
...
Typen ControlScrollOrientation avslöjar följande medlemmar:
