---
title: ActiveXPersistenceType uppräkning
second_title: Aspose.Cells for Python via .NET API Referenser
description:
type: docs
weight: 150
url: /sv/python-net/aspose.cells.drawing.activexcontrols/activexpersistencetype/
is_root: false
---
...
Typen ActiveXPersistenceType avslöjar följande medlemmar:
