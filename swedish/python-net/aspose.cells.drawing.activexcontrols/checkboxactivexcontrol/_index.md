...
type: docs
weight: 30
url: /sv/python-net/aspose.cells.drawing.activexcontrols/checkboxactivexcontrol/
is_root: false
---
##  CheckBoxActiveXControl klass
Representerar en CheckBox ActiveX-kontroll.



**Arv:** [CheckBoxActiveXControl](/cells/python-net/aspose.cells.drawing.activexcontrols/checkboxactivexcontrol) → 
...
Typen CheckBoxActiveXControl avslöjar följande medlemmar:
...
| [shadow](/cells/sv/python-net/aspose.cells.drawing.activexcontrols/checkboxactivexcontrol/shadow) | Indikerar om en skugga ska visas.|
| [linked_cell](/cells/sv/python-net/aspose.cells.drawing.activexcontrols/checkboxactivexcontrol/linked_cell) | Hämtar och ställer in den länkade cellen.|
| [list_fill_range](/cells/sv/python-net/aspose.cells.drawing.activexcontrols/checkboxactivexcontrol/list_fill_range) | Hämtar och ställer in listfyllningsintervallet.|
...
| [alignment](/cells/sv/python-net/aspose.cells.drawing.activexcontrols/checkboxactivexcontrol/alignment) | Hämtar och ställer in bildtextens position i förhållande till kontrollen.|
| [is_word_wrapped](/cells/sv/python-net/aspose.cells.drawing.activexcontrols/checkboxactivexcontrol/is_word_wrapped) | Indikerar om innehållet i kontrollen automatiskt lindas i slutet av en rad.|
...
* klass [CheckBoxActiveXControl](/cells/sv/python-net/aspose.cells.drawing.activexcontrols/checkboxactivexcontrol)
