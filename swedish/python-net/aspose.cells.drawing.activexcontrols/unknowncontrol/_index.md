---
title: UnknownControl klass
second_title: Aspose.Cells for Python via .NET API Referenser
description:
type: docs
weight: 140
url: /sv/python-net/aspose.cells.drawing.activexcontrols/unknowncontrol/
is_root: false
---
##  UnknownControl klass
Okänd kontroll.



**Arv:** [UnknownControl](/cells/python-net/aspose.cells.drawing.activexcontrols/unknowncontrol) → 
...
Typen UnknownControl avslöjar följande medlemmar:
...
| [shadow](/cells/sv/python-net/aspose.cells.drawing.activexcontrols/unknowncontrol/shadow) | Indikerar om en skugga ska visas.|
| [linked_cell](/cells/sv/python-net/aspose.cells.drawing.activexcontrols/unknowncontrol/linked_cell) | Hämtar och ställer in den länkade cellen.|
| [list_fill_range](/cells/sv/python-net/aspose.cells.drawing.activexcontrols/unknowncontrol/list_fill_range) | Hämtar och ställer in listfyllningsintervallet.|
...
| Metod| Beskrivning|
| :- | :- |
| [get_relationship_data(rel_id)](/cells/sv/python-net/aspose.cells.drawing.activexcontrols/unknowncontrol/get_relationship_data/#str) | Hämtar relaterade data.|
...
* klass [UnknownControl](/cells/sv/python-net/aspose.cells.drawing.activexcontrols/unknowncontrol)
