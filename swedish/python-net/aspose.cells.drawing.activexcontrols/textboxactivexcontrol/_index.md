...
type: docs
weight: 120
url: /sv/python-net/aspose.cells.drawing.activexcontrols/textboxactivexcontrol/
is_root: false
---
##  TextBoxActiveXControl klass
Representerar en ActiveX-kontroll i textrutan.



**Arv:** [TextBoxActiveXControl](/cells/python-net/aspose.cells.drawing.activexcontrols/textboxactivexcontrol) → 
...
Typen TextBoxActiveXControl avslöjar följande medlemmar:
...
| [shadow](/cells/sv/python-net/aspose.cells.drawing.activexcontrols/textboxactivexcontrol/shadow) | Indikerar om en skugga ska visas.|
| [linked_cell](/cells/sv/python-net/aspose.cells.drawing.activexcontrols/textboxactivexcontrol/linked_cell) | Hämtar och ställer in den länkade cellen.|
| [list_fill_range](/cells/sv/python-net/aspose.cells.drawing.activexcontrols/textboxactivexcontrol/list_fill_range) | Hämtar och ställer in listfyllningsintervallet.|
...
| [is_word_wrapped](/cells/sv/python-net/aspose.cells.drawing.activexcontrols/textboxactivexcontrol/is_word_wrapped) | Indikerar om innehållet i kontrollen automatiskt lindas i slutet av en rad.|
| [text](/cells/sv/python-net/aspose.cells.drawing.activexcontrols/textboxactivexcontrol/text) | Hämtar och ställer in text för kontrollen.|
| [drop_button_style](/cells/sv/python-net/aspose.cells.drawing.activexcontrols/textboxactivexcontrol/drop_button_style) | Anger symbolen som visas på släppknappen|
| [show_drop_button_type_when](/cells/sv/python-net/aspose.cells.drawing.activexcontrols/textboxactivexcontrol/show_drop_button_type_when) | Anger symbolen som visas på släppknappen|
...
* klass [TextBoxActiveXControl](/cells/sv/python-net/aspose.cells.drawing.activexcontrols/textboxactivexcontrol)
