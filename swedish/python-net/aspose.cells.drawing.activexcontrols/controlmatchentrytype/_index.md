---
title: ControlMatchEntryType uppräkning
second_title: Aspose.Cells for Python via .NET API Referenser
description:
type: docs
weight: 190
url: /sv/python-net/aspose.cells.drawing.activexcontrols/controlmatchentrytype/
is_root: false
---
...
Typen ControlMatchEntryType avslöjar följande medlemmar:
