...
type: docs
weight: 10
url: /sv/python-net/aspose.cells.querytables/
is_root: false
---
 De**Aspose.Cells.QueryTables** namnrymden tillhandahåller klasser för att komma åt och uppdatera kalkylbladstabeller byggda från data som returneras från en extern datakälla, till exempel en SQL-server eller en Microsoft Access-databas.

###  Klasser
| Klass| Beskrivning|
| :- | :- |
| [DataMashup](/cells/sv/python-net/aspose.cells.querytables/datamashup) | Representerar mashup-data.|
| [PowerQueryFormula](/cells/sv/python-net/aspose.cells.querytables/powerqueryformula) | Representerar definitionen av kraftfrågeformel.|
