---
title: TextAlignmentType uppräkning
second_title: Aspose.Cells for Python via .NET API Referenser
description:
type: docs
weight: 2520
url: /sv/python-net/aspose.cells/textalignmenttype/
is_root: false
---
##  TextAlignmentType uppräkning
Räknar upp typer av textjustering.



Typen TextAlignmentType avslöjar följande medlemmar:
...
| FILL | Representerar fyllningstextjustering.|
