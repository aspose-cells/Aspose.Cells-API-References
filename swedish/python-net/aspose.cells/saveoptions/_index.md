...
type: docs
weight: 1320
url: /sv/python-net/aspose.cells/saveoptions/
is_root: false
---
##  SaveOptions klass
...
Typen SaveOptions avslöjar följande medlemmar:

###  Egenskaper
| Fast egendom| Beskrivning|
| :- | :- |
| [save_format](/cells/sv/python-net/aspose.cells/saveoptions/save_format) | Hämtar spara filformatet.|
| [clear_data](/cells/sv/python-net/aspose.cells/saveoptions/clear_data) | Gör arbetsboken tom efter att du har sparat filen.|
| [cached_file_folder](/cells/sv/python-net/aspose.cells/saveoptions/cached_file_folder) | Den cachade filmappen används för att lagra en del stora data.|
| [validate_merged_areas](/cells/sv/python-net/aspose.cells/saveoptions/validate_merged_areas) | Anger om sammanslagna celler ska valideras innan filen sparas.|
