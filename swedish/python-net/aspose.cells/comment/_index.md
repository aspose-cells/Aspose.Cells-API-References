...
type: docs
weight: 280
url: /sv/python-net/aspose.cells/comment/
is_root: false
---
##  Comment klass
...
| :- | :- |
| [author](/cells/sv/python-net/aspose.cells/comment/author) | Hämtar och sätter Namn på den ursprungliga kommentarsförfattaren|
| [comment_shape](/cells/sv/python-net/aspose.cells/comment/comment_shape) | Skaffa ett Shape-objekt som representerar formen som är kopplad till den angivna kommentaren.|
| [row](/cells/sv/python-net/aspose.cells/comment/row) | Hämtar radindex för kommentaren.|
...
| Metod| Beskrivning|
| :- | :- |
| [format_characters(start_index, length, font, flag)](/cells/sv/python-net/aspose.cells/comment/format_characters/#int-int-Font-StyleFlag) | Formatera några tecken med teckensnittsinställningen.|
| [characters(start_index, length)](/cells/sv/python-net/aspose.cells/comment/characters/#int-int) | Returnerar ett teckenobjekt som representerar ett antal tecken i kommentarstexten.|
| [get_characters()](/cells/sv/python-net/aspose.cells/comment/get_characters/#) | Returnerar alla teckenobjekt<br/> som representerar ett antal tecken i kommentarstexten.|
