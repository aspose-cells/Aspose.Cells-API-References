...
| [hyperlinks](/cells/sv/python-net/aspose.cells/range/hyperlinks) | Får alla hyperlänkar i sortimentet.|
...
| [cell_count](/cells/sv/python-net/aspose.cells/range/cell_count) | Får alla cellantal i intervallet.|
...
| [worksheet](/cells/sv/python-net/aspose.cells/range/worksheet) | Hämtar objektet [Range.worksheet](/cells/sv/python-net/aspose.cells/range#worksheet) som innehåller detta intervall.|


###  Metoder
| Metod| Beskrivning|
| :- | :- |
| [auto_fill(target)](/cells/sv/python-net/aspose.cells/range/auto_fill/#Range) | Automatisk alla fyller målområdet.|
| [auto_fill(target, auto_fill_type)](/cells/sv/python-net/aspose.cells/range/auto_fill/#Range-AutoFillType) | Automatisk alla fyller målområdet.|
...
| [set_outline_borders(border_style, border_color)](/cells/sv/python-net/aspose.cells/range/set_outline_borders/#CellBorderType-CellsColor) | Ställer in konturkanterna runt ett cellintervall med samma ramstil och färg.|
| [set_outline_borders(border_style, border_color)](/cells/sv/python-net/aspose.cells/range/set_outline_borders/#CellBorderType-aspose.pydrawing.Color) | Ställer in konturkanterna runt ett cellintervall med samma ramstil och färg.|
...
| [set_inside_borders(border_edge, line_style, border_color)](/cells/sv/python-net/aspose.cells/range/set_inside_borders/#BorderType-CellBorderType-CellsColor) | Ställ in gränserna för området.|
| [move_to(dest_row, dest_column)](/cells/sv/python-net/aspose.cells/range/move_to/#int-int) | Flytta det aktuella området till målområdet.|
