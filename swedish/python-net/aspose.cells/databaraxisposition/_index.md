---
title: DataBarAxisPosition uppräkning
second_title: Aspose.Cells for Python via .NET API Referenser
description:
type: docs
weight: 1900
url: /sv/python-net/aspose.cells/databaraxisposition/
is_root: false
---
##  DataBarAxisPosition uppräkning
Anger axelpositionen för ett cellintervall med villkorlig formatering som datafält.



Typen DataBarAxisPosition avslöjar följande medlemmar:
