...
type: docs
weight: 80
url: /sv/python-net/aspose.cells/namecollection/last_index_of/
is_root: false
---
...
| :- | :- | :- |
| item | [Name](/cells/sv/python-net/aspose.cells/name) | Objektet som ska lokaliseras i arraylistan. Värdet kan vara null.|
...
###  Se även
* modul [aspose.cells](../../)
* klass [NameCollection](/cells/sv/python-net/aspose.cells/namecollection)
