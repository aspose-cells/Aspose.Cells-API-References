...
type: docs
weight: 60
url: /sv/python-net/aspose.cells/rangecollection/last_index_of/
is_root: false
---
...
| :- | :- | :- |
| item | [Range](/cells/sv/python-net/aspose.cells/range) | Objektet som ska lokaliseras i arraylistan. Värdet kan vara null.|
...
###  Se även
* modul [aspose.cells](../../)
* klass [RangeCollection](/cells/sv/python-net/aspose.cells/rangecollection)
