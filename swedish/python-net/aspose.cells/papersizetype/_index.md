...
type: docs
weight: 2330
url: /sv/python-net/aspose.cells/papersizetype/
is_root: false
---
##  PaperSizeType uppräkning
Representerar pappersstorlekskonstanter.



Typen PaperSizeType avslöjar följande medlemmar:

###  Fält
| Fält| Beskrivning|
| :- | :- |
| PAPER_LETTER | Letter (8-1/2 tum x 11 tum)|
| PAPER_LETTER_SMALL | Letter Small (8-1/2 tum x 11 tum)|
| PAPER_TABLOID |Tabloid (11 tum x 17 tum)|
| PAPER_LEDGER | Ledger (17 tum x 11 tum)|
| PAPER_LEGAL | Legal (8-1/2 tum x 14 tum)|
| PAPER_STATEMENT | Statement (5-1/2 tum x 8-1/2 tum)|
| PAPER_EXECUTIVE | Executive (7-1/4 tum x 10-1/2 tum)|
...
| PAPER_FOLIO | Folio (8-1/2 tum x 13 tum)|
| PAPER_QUARTO | Quarto (215 mm x 275 mm)|
| PAPER_10X14 | 10 tum x 14 tum.|
| PAPER_11X17 | 11 tum x 17 tum.|
| PAPER_NOTE | Obs (8-1/2 tum x 11 tum)|
| PAPER_ENVELOPE9 | Kuvert #9 (3-7/8 tum x 8-7/8 tum)|
| PAPER_ENVELOPE10 | Kuvert #10 (4-1/8 tum x 9-1/2 tum)|
| PAPER_ENVELOPE11 | Kuvert #11 (4-1/2 tum x 10-3/8 tum)|
| PAPER_ENVELOPE12 | Kuvert #12 (4-1/2 tum x 11 tum)|
| PAPER_ENVELOPE14 | Kuvert #14 (5 tum x 11-1/2 tum)|
| PAPER_C_SHEET | C storlek blad|
| PAPER_D_SHEET | D storlek blad|
| PAPER_E_SHEET | E-storlek ark|
| PAPER_ENVELOPE_DL | Kuvert DL (110 mm x 220 mm)|
| PAPER_ENVELOPE_C5 | Kuvert C5 (162 mm x 229 mm)|
| PAPER_ENVELOPE_C3 | Kuvert C3 (324 mm x 458 mm)|
| PAPER_ENVELOPE_C4 | Kuvert C4 (229 mm x 324 mm)|
| PAPER_ENVELOPE_C6 | Kuvert C6 (114 mm x 162 mm)|
| PAPER_ENVELOPE_C65 |Kuvert C65 (114 mm x 229 mm)|
| PAPER_ENVELOPE_B4 | Kuvert B4 (250 mm x 353 mm)|
| PAPER_ENVELOPE_B5 | Kuvert B5 (176 mm x 250 mm)|
| PAPER_ENVELOPE_B6 | Kuvert B6 (176 mm x 125 mm)|
| PAPER_ENVELOPE_ITALY | Kuvert Italien (110 mm x 230 mm)|
| PAPER_ENVELOPE_MONARCH | Envelope Monarch (3-7/8 tum x 7-1/2 tum)|
| PAPER_ENVELOPE_PERSONAL | Kuvert (3-5/8 tum x 6-1/2 tum)|
| PAPER_FANFOLD_US | US Standard Fanfold (14-7/8 tum x 11 tum)|
| PAPER_FANFOLD_STD_GERMAN | German Standard Fanfold (8-1/2 tum x 12 tum)|
| PAPER_FANFOLD_LEGAL_GERMAN | German Legal Fanfold (8-1/2 tum x 13 tum)|
| PAPER_ISOB4 | B4 (ISO) 250 x 353 mm|
| PAPER_JAPANESE_POSTCARD | Japanskt vykort (100 mm × 148 mm)|
| PAPER_9X11 | 9? × 11? |
| PAPER_10X11 | 10? × 11? |
| PAPER_15X11 | 15? × 11? |
...
| PAPER_JAPANESE_DOUBLE_POSTCARD_ROTATED | Dubbelt japanskt vykort roterat 148 x 200 mm|
| PAPER_A6_ROTATED | A6 Roterad 148 x 105 mm|
| PAPER_JAPANESE_ENVELOPE_KAKU_2_ROTATED | Japanskt kuvert Kaku #2 roterat|
| PAPER_JAPANESE_ENVELOPE_KAKU_3_ROTATED | Japanskt kuvert Kaku #3 roterat|
| PAPER_JAPANESE_ENVELOPE_CHOU_3_ROTATED | Japanskt kuvert Chou #3 roterat|
| PAPER_JAPANESE_ENVELOPE_CHOU_4_ROTATED | Japanskt kuvert Chou #4 roterat|
| PAPER_JISB6 | B6 (JIS) 128 x 182 mm|
| PAPER_JISB6_ROTATED | B6 (JIS) Roterad 182 x 128 mm|
| PAPER_12X11 | 12 x 11 tum|
| PAPER_JAPANESE_ENVELOPE_YOU4 |Japanskt kuvert Du #4|
