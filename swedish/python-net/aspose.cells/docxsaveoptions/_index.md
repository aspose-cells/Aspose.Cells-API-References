...
type: docs
weight: 490
url: /sv/python-net/aspose.cells/docxsaveoptions/
is_root: false
---
...
| :- | :- |
| [save_format](/cells/sv/python-net/aspose.cells/docxsaveoptions/save_format) | Hämtar spara filformatet.|
| [clear_data](/cells/sv/python-net/aspose.cells/docxsaveoptions/clear_data) | Gör arbetsboken tom efter att du har sparat filen.|
| [cached_file_folder](/cells/sv/python-net/aspose.cells/docxsaveoptions/cached_file_folder) | Den cachade filmappen används för att lagra en del stora data.|
| [validate_merged_areas](/cells/sv/python-net/aspose.cells/docxsaveoptions/validate_merged_areas) | Anger om sammanslagna celler ska valideras innan filen sparas.|
...
###  Se även
* modul [aspose.cells](..)
* klass [DocxSaveOptions](/cells/sv/python-net/aspose.cells/docxsaveoptions)
