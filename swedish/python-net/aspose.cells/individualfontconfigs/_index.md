---
title: IndividualFontConfigs klass
second_title: Aspose.Cells for Python via .NET API Referenser
description:
type: docs
weight: 930
url: /sv/python-net/aspose.cells/individualfontconfigs/
is_root: false
---
##  IndividualFontConfigs klass
Teckensnittskonfigurationer för varje [Workbook](/cells/sv/python-net/aspose.cells/workbook)-objekt.



Typen IndividualFontConfigs avslöjar följande medlemmar:
...
| [set_font_sources(sources)](/cells/sv/python-net/aspose.cells/individualfontconfigs/set_font_sources/#list) | Ställer in teckensnittskällorna.|
| [get_font_sources()](/cells/sv/python-net/aspose.cells/individualfontconfigs/get_font_sources/#) | Får en kopia av arrayen som innehåller källlistan|
