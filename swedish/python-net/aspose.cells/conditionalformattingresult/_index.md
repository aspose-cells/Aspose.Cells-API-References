---
title: ConditionalFormattingResult klass
second_title: Aspose.Cells for Python via .NET API Referenser
description:
type: docs
weight: 330
url: /sv/python-net/aspose.cells/conditionalformattingresult/
is_root: false
---
##  ConditionalFormattingResult klass
Representerar resultatet av villkorlig formatering som gäller för en cell.



Typen ConditionalFormattingResult avslöjar följande medlemmar:
