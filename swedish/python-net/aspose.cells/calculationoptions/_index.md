---
title: CalculationOptions klass
second_title: Aspose.Cells for Python via .NET API Referenser
description:
type: docs
weight: 130
url: /sv/python-net/aspose.cells/calculationoptions/
is_root: false
---
##  CalculationOptions klass
Representerar alternativ för beräkning.



Typen CalculationOptions avslöjar följande medlemmar:

###  Konstruktörer
| Konstruktör| Beskrivning|
| :- | :- |
| [CalculationOptions()](/cells/sv/python-net/aspose.cells/calculationoptions/__init__/#) | Konstruerar en ny instans av CalculationOptions|
