...
type: docs
weight: 1590
url: /sv/python-net/aspose.cells/workbook/
is_root: false
---
##  Workbook klass
...
| :- | :- |
| [Workbook()](/cells/sv/python-net/aspose.cells/workbook/__init__/#) | Initierar en ny instans av klassen [Workbook](/cells/sv/python-net/aspose.cells/workbook).|
| [Workbook(file_format_type)](/cells/sv/python-net/aspose.cells/workbook/__init__/#FileFormatType) | Initierar en ny instans av klassen [Workbook](/cells/sv/python-net/aspose.cells/workbook).|
| [Workbook(file)](/cells/sv/python-net/aspose.cells/workbook/__init__/#str) | Initierar en ny instans av klassen [Workbook](/cells/sv/python-net/aspose.cells/workbook) och öppnar en fil.|
| [Workbook(stream)](/cells/sv/python-net/aspose.cells/workbook/__init__/#io.RawIOBase) | Initierar en ny instans av klassen [Workbook](/cells/sv/python-net/aspose.cells/workbook) och öppnar en ström.|
| [Workbook(file, load_options)](/cells/sv/python-net/aspose.cells/workbook/__init__/#str-LoadOptions) | Initierar en ny instans av klassen [Workbook](/cells/sv/python-net/aspose.cells/workbook) och öppnar en fil.|
| [Workbook(stream, load_options)](/cells/sv/python-net/aspose.cells/workbook/__init__/#io.RawIOBase-LoadOptions) | Initierar en ny instans av klassen [Workbook](/cells/sv/python-net/aspose.cells/workbook) och öppen ström.|


###  Egenskaper
| Fast egendom| Beskrivning|
| :- | :- |
| [settings](/cells/sv/python-net/aspose.cells/workbook/settings) | Representerar arbetsboksinställningarna.|
| [worksheets](/cells/sv/python-net/aspose.cells/workbook/worksheets) | Hämtar [WorksheetCollection](/cells/sv/python-net/aspose.cells/worksheetcollection)-samlingen i kalkylarket.|
| [is_licensed](/cells/sv/python-net/aspose.cells/workbook/is_licensed) | Indikerar om licensen är inställd.|
| [colors](/cells/sv/python-net/aspose.cells/workbook/colors) | Returnerar färger i paletten för kalkylarket.|
...
| [data_mashup](/cells/sv/python-net/aspose.cells/workbook/data_mashup) | Får mashup-data.|
| [ribbon_xml](/cells/sv/python-net/aspose.cells/workbook/ribbon_xml) | Hämtar och ställer in XML-filen som definierar Ribbon UI.|
| [absolute_path](/cells/sv/python-net/aspose.cells/workbook/absolute_path) | Hämtar och ställer in den absoluta sökvägen till filen.|
| [data_connections](/cells/sv/python-net/aspose.cells/workbook/data_connections) | Får samlingen [ExternalConnection](/cells/sv/python-net/aspose.cells.externalconnections/externalconnection).|


###  Metoder
| Metod| Beskrivning|
| :- | :- |
| [save(file_name, save_format)](/cells/sv/python-net/aspose.cells/workbook/save/#str-SaveFormat) | Sparar arbetsboken på disken.|
| [save(file_name)](/cells/sv/python-net/aspose.cells/workbook/save/#str) | Spara arbetsboken på disken.|
| [save(file_name, save_options)](/cells/sv/python-net/aspose.cells/workbook/save/#str-SaveOptions) | Sparar arbetsboken på disken.|
...
| [calculate_formula(options)](/cells/sv/python-net/aspose.cells/workbook/calculate_formula/#CalculationOptions) | Beräkna formler i denna arbetsbok.|
| [refresh_dynamic_array_formulas(calculate)](/cells/sv/python-net/aspose.cells/workbook/refresh_dynamic_array_formulas/#bool) | Uppdaterar dynamiska matrisformler (spill in i ett nytt intervall av närliggande celler enligt aktuella data)<br/> Andra formler i arbetsboken kommer inte att beräknas rekursivt även om de användes av dynamiska matrisformler.|
| [refresh_dynamic_array_formulas(calculate, copts)](/cells/sv/python-net/aspose.cells/workbook/refresh_dynamic_array_formulas/#bool-CalculationOptions) | Uppdaterar dynamiska matrisformler (spill in i ett nytt intervall av närliggande celler enligt aktuella data)|
| [import_xml(url, sheet_name, row, col)](/cells/sv/python-net/aspose.cells/workbook/import_xml/#str-str-int-int) | Importerar/uppdaterar en XML-datafil till arbetsboken.|
| [import_xml(stream, sheet_name, row, col)](/cells/sv/python-net/aspose.cells/workbook/import_xml/#io.RawIOBase-str-int-int) | Importerar/uppdaterar en XML-datafil till arbetsboken.|
...
| [get_style_in_pool(index)](/cells/sv/python-net/aspose.cells/workbook/get_style_in_pool/#int) | Får stilen i stilpoolen.<br/>Alla stilar i arbetsboken kommer att samlas i en pool.<br/> Det finns bara ett enkelt referensindex i cellerna.|
| [get_fonts()](/cells/sv/python-net/aspose.cells/workbook/get_fonts/#) | Får alla typsnitt i stilpoolen.|
| [get_named_style(name)](/cells/sv/python-net/aspose.cells/workbook/get_named_style/#str) | Får den namngivna stilen i stilpoolen.|
| [change_palette(color, index)](/cells/sv/python-net/aspose.cells/workbook/change_palette/#aspose.pydrawing.Color-int) | Ändrar paletten för kalkylarket i det angivna indexet.|
| [is_color_in_palette(color)](/cells/sv/python-net/aspose.cells/workbook/is_color_in_palette/#aspose.pydrawing.Color) | Kontrollerar om en färg finns i paletten för kalkylarket.|
| [get_matching_color(raw_color)](/cells/sv/python-net/aspose.cells/workbook/get_matching_color/#aspose.pydrawing.Color) | Hitta bäst matchande färg i aktuell palett.|
| [set_encryption_options(encryption_type, key_length)](/cells/sv/python-net/aspose.cells/workbook/set_encryption_options/#EncryptionType-int) | Ställ in krypteringsalternativ.|
| [protect(protection_type, password)](/cells/sv/python-net/aspose.cells/workbook/protect/#ProtectionType-str) | Skyddar en arbetsbok.|
| [protect_shared_workbook(password)](/cells/sv/python-net/aspose.cells/workbook/protect_shared_workbook/#str) | Skyddar en delad arbetsbok.|
| [unprotect(password)](/cells/sv/python-net/aspose.cells/workbook/unprotect/#str) | Tar bort skyddet av en arbetsbok.|
| [unprotect_shared_workbook(password)](/cells/sv/python-net/aspose.cells/workbook/unprotect_shared_workbook/#str) | Tar bort skyddet för en delad arbetsbok.|
...
| [remove_personal_information()](/cells/sv/python-net/aspose.cells/workbook/remove_personal_information/#) | Tar bort personlig information.|
...
###  Se även
* modul [aspose.cells](..)
* klass [CellsColor](/cells/sv/python-net/aspose.cells/cellscolor)
* klass [ContentTypeProperty](/cells/sv/python-net/aspose.cells.properties/contenttypeproperty)
...
* klass [Style](/cells/sv/python-net/aspose.cells/style)
* klass [Workbook](/cells/sv/python-net/aspose.cells/workbook)
* klass [WorksheetCollection](/cells/sv/python-net/aspose.cells/worksheetcollection)
