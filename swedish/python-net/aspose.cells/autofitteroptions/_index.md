---
title: AutoFitterOptions klass
second_title: Aspose.Cells for Python via .NET API Referenser
description:
type: docs
weight: 80
url: /sv/python-net/aspose.cells/autofitteroptions/
is_root: false
---
##  AutoFitterOptions klass
Representerar alla alternativ för automontör.



Typen AutoFitterOptions avslöjar följande medlemmar:

###  Konstruktörer
| Konstruktör| Beskrivning|
| :- | :- |
| [AutoFitterOptions()](/cells/sv/python-net/aspose.cells/autofitteroptions/__init__/#) | Konstruerar en ny instans av AutoFitterOptions|


###  Egenskaper
| Fast egendom| Beskrivning|
| :- | :- |
| [default_edit_language](/cells/sv/python-net/aspose.cells/autofitteroptions/default_edit_language) | Hämtar eller ställer in standardspråk för redigering.|
| [auto_fit_merged_cells](/cells/sv/python-net/aspose.cells/autofitteroptions/auto_fit_merged_cells) | Anger om radhöjden automatiskt anpassas när cellerna slås samman i en rad.<br/> Standardvärdet är falskt.|
