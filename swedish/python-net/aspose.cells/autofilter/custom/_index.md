...
type: docs
weight: 70
url: /sv/python-net/aspose.cells/autofilter/custom/
is_root: false
---
##  custom(field_index, operator_type1, criteria1) {#int-FilterOperatorType-any}
Filtrerar en lista med ett custom-kriterie.
...
| criteria1 | any | De anpassade kriterierna|
...
Filtrerar en lista med custom kriterier.
...
| criteria1 | any | De anpassade kriterierna|
| is_and | bool |  |
| operator_type2 | [FilterOperatorType](/cells/sv/python-net/aspose.cells/filteroperatortype) | Filteroperatortypen|
| criteria2 | any | De anpassade kriterierna|
