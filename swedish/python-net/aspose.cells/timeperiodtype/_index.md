...
type: docs
weight: 2590
url: /sv/python-net/aspose.cells/timeperiodtype/
is_root: false
---
##  TimePeriodType uppräkning
 Används i en FormatConditionType.TimePeriod villkorlig formateringsregel.
Dessa är dynamiska tidsperioder, som förändras baserat på
det datum då den villkorliga formateringen uppdateras/tillämpas.



Typen TimePeriodType avslöjar följande medlemmar:
...
| NEXT_YEAR | Ett datum som inträffar nästa år.<br/> Endast för .ods.|
