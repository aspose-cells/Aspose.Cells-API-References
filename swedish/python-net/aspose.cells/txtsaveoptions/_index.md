...
type: docs
weight: 1520
url: /sv/python-net/aspose.cells/txtsaveoptions/
is_root: false
---
...
| :- | :- |
| [TxtSaveOptions()](/cells/sv/python-net/aspose.cells/txtsaveoptions/__init__/#) | Skapar alternativ för att spara textfiler.|
| [TxtSaveOptions(format)](/cells/sv/python-net/aspose.cells/txtsaveoptions/__init__/#SaveFormat) | Skapar alternativ för att spara textfiler.|


###  Egenskaper
| Fast egendom| Beskrivning|
| :- | :- |
| [save_format](/cells/sv/python-net/aspose.cells/txtsaveoptions/save_format) | Hämtar spara filformatet.|
| [clear_data](/cells/sv/python-net/aspose.cells/txtsaveoptions/clear_data) | Gör arbetsboken tom efter att du har sparat filen.|
| [cached_file_folder](/cells/sv/python-net/aspose.cells/txtsaveoptions/cached_file_folder) | Den cachade filmappen används för att lagra en del stora data.|
| [validate_merged_areas](/cells/sv/python-net/aspose.cells/txtsaveoptions/validate_merged_areas) | Anger om sammanslagna celler ska valideras innan filen sparas.|
...
* klass [TxtSaveOptions](/cells/sv/python-net/aspose.cells/txtsaveoptions)
