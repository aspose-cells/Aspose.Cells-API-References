---
title: get_instance metod
second_title: Aspose.Cells for Python via .NET API Referenser
description:
type: docs
weight: 20
url: /sv/python-net/aspose.cells/cellsdatatablefactory/get_instance/
is_root: false
---
...
Skapar ICellsDataTable från en given sekvens av int-värden.
...
##  get_instance(vals, column_names) {#list-list}
Skapar ICellsDataTable från en given sekvens av dubbla värden.
...
##  get_instance(vals, column_names) {#list-list}
Skapar ICellsDataTable från en given sekvens av objekt.
...
###  Se även
* modul [aspose.cells](../../)
* klass [CellsDataTableFactory](/cells/sv/python-net/aspose.cells/cellsdatatablefactory)
