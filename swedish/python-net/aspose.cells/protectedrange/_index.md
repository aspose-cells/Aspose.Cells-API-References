---
title: ProtectedRange klass
second_title: Aspose.Cells for Python via .NET API Referenser
description:
type: docs
weight: 1200
url: /sv/python-net/aspose.cells/protectedrange/
is_root: false
---
##  ProtectedRange klass
Ett specificerat område som ska tillåtas redigera när arkskyddet är PÅ.



Typen ProtectedRange avslöjar följande medlemmar:
...
| Metod| Beskrivning|
| :- | :- |
| [get_areas()](/cells/sv/python-net/aspose.cells/protectedrange/get_areas/#) | Får alla hänvisade områden.|
| [add_area(start_row, start_column, end_row, end_column)](/cells/sv/python-net/aspose.cells/protectedrange/add_area/#int-int-int-int) | Lägger till ett refererat område till detta|
