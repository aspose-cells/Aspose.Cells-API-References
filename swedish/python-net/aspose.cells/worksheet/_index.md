---
title: Worksheet klass
second_title: Aspose.Cells for Python via .NET API Referenser
description:
type: docs
weight: 1620
url: /sv/python-net/aspose.cells/worksheet/
is_root: false
---
##  Worksheet klass
...
Typen Worksheet avslöjar följande medlemmar:
...
| [query_tables](/cells/sv/python-net/aspose.cells/worksheet/query_tables) | Får [QueryTableCollection](/cells/sv/python-net/aspose.cells/querytablecollection) i arbetsbladet.|
| [pivot_tables](/cells/sv/python-net/aspose.cells/worksheet/pivot_tables) | Hämtar alla pivottabeller i detta kalkylblad.|
| [type](/cells/sv/python-net/aspose.cells/worksheet/type) | Representerar kalkylbladstyp.|
...
| [is_selected](/cells/sv/python-net/aspose.cells/worksheet/is_selected) | Anger om detta kalkylblad är valt när arbetsboken öppnas.|
| [list_objects](/cells/sv/python-net/aspose.cells/worksheet/list_objects) | Hämtar alla ListObjects i detta kalkylblad.|
| [tab_id](/cells/sv/python-net/aspose.cells/worksheet/tab_id) | Anger den interna identifieraren för arket.|
| [horizontal_page_breaks](/cells/sv/python-net/aspose.cells/worksheet/horizontal_page_breaks) | Får samlingen [HorizontalPageBreakCollection](/cells/sv/python-net/aspose.cells/horizontalpagebreakcollection).|
| [vertical_page_breaks](/cells/sv/python-net/aspose.cells/worksheet/vertical_page_breaks) | Får samlingen [VerticalPageBreakCollection](/cells/sv/python-net/aspose.cells/verticalpagebreakcollection).|
...
| [error_check_options](/cells/sv/python-net/aspose.cells/worksheet/error_check_options) | Får felkontrollinställning tillämpad på vissa intervall.|
...
| Metod| Beskrivning|
| :- | :- |
| [freeze_panes(row, column, freezed_rows, freezed_columns)](/cells/sv/python-net/aspose.cells/worksheet/freeze_panes/#int-int-int-int) | Fryser rutor vid den angivna cellen i kalkylbladet.|
| [freeze_panes(cell_name, freezed_rows, freezed_columns)](/cells/sv/python-net/aspose.cells/worksheet/freeze_panes/#str-int-int) | Fryser rutor vid den angivna cellen i kalkylbladet.|
| [copy(source_sheet)](/cells/sv/python-net/aspose.cells/worksheet/copy/#Worksheet) | Kopierar innehåll och format från ett annat kalkylblad.|
| [copy(source_sheet, copy_options)](/cells/sv/python-net/aspose.cells/worksheet/copy/#Worksheet-CopyOptions) | Kopierar innehåll och format från ett annat kalkylblad.|
| [auto_fit_column(column_index, first_row, last_row)](/cells/sv/python-net/aspose.cells/worksheet/auto_fit_column/#int-int-int) | Anpassar kolumnbredden automatiskt.|
...
| [auto_fit_row(row_index)](/cells/sv/python-net/aspose.cells/worksheet/auto_fit_row/#int) | Autopassar radhöjden.|
...
| [remove_all_drawing_objects()](/cells/sv/python-net/aspose.cells/worksheet/remove_all_drawing_objects/#) | Tar bort alla ritobjekt i detta kalkylblad.|
| [clear_comments()](/cells/sv/python-net/aspose.cells/worksheet/clear_comments/#) | Rensar alla kommentarer i designerkalkylarket.|
| [move_to(index)](/cells/sv/python-net/aspose.cells/worksheet/move_to/#int) | Flyttar arket till en annan plats i kalkylarket.|
...
###  Se även
* modul [aspose.cells](..)
* klass [Chart](/cells/sv/python-net/aspose.cells.charts/chart)
* klass [CheckBox](/cells/sv/python-net/aspose.cells.drawing/checkbox)
* klass [Comment](/cells/sv/python-net/aspose.cells/comment)
* klass [HorizontalPageBreakCollection](/cells/sv/python-net/aspose.cells/horizontalpagebreakcollection)
* klass [HyperlinkCollection](/cells/sv/python-net/aspose.cells/hyperlinkcollection)
...
* klass [QueryTableCollection](/cells/sv/python-net/aspose.cells/querytablecollection)
* klass [Scenario](/cells/sv/python-net/aspose.cells/scenario)
* klass [SmartTagCollection](/cells/sv/python-net/aspose.cells.markup/smarttagcollection)
* klass [TextBox](/cells/sv/python-net/aspose.cells.drawing/textbox)
* klass [VerticalPageBreakCollection](/cells/sv/python-net/aspose.cells/verticalpagebreakcollection)
