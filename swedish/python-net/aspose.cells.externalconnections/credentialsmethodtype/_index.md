---
title: CredentialsMethodType uppräkning
second_title: Aspose.Cells for Python via .NET API Referenser
description:
type: docs
weight: 100
url: /sv/python-net/aspose.cells.externalconnections/credentialsmethodtype/
is_root: false
---
...
Typen CredentialsMethodType avslöjar följande medlemmar:
