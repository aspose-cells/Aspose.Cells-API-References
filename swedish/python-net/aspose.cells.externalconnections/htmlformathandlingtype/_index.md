---
title: HtmlFormatHandlingType uppräkning
second_title: Aspose.Cells for Python via .NET API Referenser
description:
type: docs
weight: 110
url: /sv/python-net/aspose.cells.externalconnections/htmlformathandlingtype/
is_root: false
---
...
Typen HtmlFormatHandlingType avslöjar följande medlemmar:
