...
type: docs
weight: 30
url: /sv/python-net/aspose.cells.markup/smarttag/
is_root: false
---
##  SmartTag klass
...
Typen SmartTag avslöjar följande medlemmar:
...
| Metod| Beskrivning|
| :- | :- |
| [set_link(uri, name)](/cells/sv/python-net/aspose.cells.markup/smarttag/set_link/#str-str) | Ändra namnet och namnutrymmets URI för smarttaggen.|
