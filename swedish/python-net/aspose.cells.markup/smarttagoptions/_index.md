---
title: SmartTagOptions klass
second_title: Aspose.Cells for Python via .NET API Referenser
description:
type: docs
weight: 50
url: /sv/python-net/aspose.cells.markup/smarttagoptions/
is_root: false
---
##  SmartTagOptions klass
Representerar alternativen för den smarta taggen.



Typen SmartTagOptions avslöjar följande medlemmar:

###  Konstruktörer
| Konstruktör| Beskrivning|
| :- | :- |
| [SmartTagOptions()](/cells/sv/python-net/aspose.cells.markup/smarttagoptions/__init__/#) | Konstruerar en ny instans av SmartTagOptions|
