---
title: PivotFieldSubtotalType uppräkning
second_title: Aspose.Cells for Python via .NET API Referenser
description:
type: docs
weight: 160
url: /sv/python-net/aspose.cells.pivot/pivotfieldsubtotaltype/
is_root: false
---
##  PivotFieldSubtotalType uppräkning
Sammanfattande beskrivning för PivotFieldSubtotalType.



Typen PivotFieldSubtotalType avslöjar följande medlemmar:
...
| MAX | Representerar Max subtotal typ.|
