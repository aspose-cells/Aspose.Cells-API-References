---
title: PivotConditionFormatRuleType uppräkning
second_title: Aspose.Cells for Python via .NET API Referenser
description:
type: docs
weight: 130
url: /sv/python-net/aspose.cells.pivot/pivotconditionformatruletype/
is_root: false
---
...
Typen PivotConditionFormatRuleType avslöjar följande medlemmar:
