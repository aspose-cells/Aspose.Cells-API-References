...
type: docs
weight: 230
url: /sv/python-net/aspose.cells.charts/series/
is_root: false
---
##  Series klass
...
Typen Series avslöjar följande medlemmar:
...
| [count_of_data_values](/cells/sv/python-net/aspose.cells.charts/series/count_of_data_values) | Hämtar antalet datavärden.|
...
| [shadow](/cells/sv/python-net/aspose.cells.charts/series/shadow) | Sant om serien har en skugga.|
| [has_3d_effect](/cells/sv/python-net/aspose.cells.charts/series/has_3d_effect) |Sant om serien har ett tredimensionellt utseende.<br/> Gäller endast bubbeldiagram.|
| [bar_3d_shape_type](/cells/sv/python-net/aspose.cells.charts/series/bar_3d_shape_type) | Hämtar eller ställer in 3D-formtypen som används med 3D-stapel- eller kolumndiagrammet.|
| [bar_shape](/cells/sv/python-net/aspose.cells.charts/series/bar_shape) | Hämtar eller ställer in 3D-formtypen som används med 3D-stapel- eller kolumndiagrammet.|
| [data_labels](/cells/sv/python-net/aspose.cells.charts/series/data_labels) | Representerar DataLabels-objektet för den angivna ASerien.|
| [type](/cells/sv/python-net/aspose.cells.charts/series/type) | Hämtar eller ställer in en dataseries typ.|
| [marker](/cells/sv/python-net/aspose.cells.charts/series/marker) | Får [Series.marker](/cells/sv/python-net/aspose.cells.charts/series#marker).|
| [plot_on_second_axis](/cells/sv/python-net/aspose.cells.charts/series/plot_on_second_axis) | Indikerar om denna serie är plottad på andra värdeaxeln.|
| [x_error_bar](/cells/sv/python-net/aspose.cells.charts/series/x_error_bar) | Representerar X-riktningsfelstapeln i serien.|
...
| [has_up_down_bars](/cells/sv/python-net/aspose.cells.charts/series/has_up_down_bars) | Sant om ett linjediagram har staplar upp och ner.<br/> Gäller endast linjediagram.|
| [up_bars](/cells/sv/python-net/aspose.cells.charts/series/up_bars) | Returnerar ett DropBars-objekt som representerar uppstaplarna på ett linjediagram.<br/> Gäller endast linjediagram.|
...
| [split_value](/cells/sv/python-net/aspose.cells.charts/series/split_value) | Returnerar eller ställer in ett värde som ska användas för att bestämma vilka datapunkter som finns i den andra cirkeln eller stapeln<br/> en paj eller ett stapeldiagram.|
| [is_auto_split](/cells/sv/python-net/aspose.cells.charts/series/is_auto_split) | Indikerar om tröskelvärdet är automatiskt.|
| [bubble_scale](/cells/sv/python-net/aspose.cells.charts/series/bubble_scale) | Hämtar eller ställer in skalfaktorn för bubblor i den angivna diagramgruppen.<br/> Det kan vara ett heltalsvärde från 0 (noll) till 300,<br/>motsvarande en procentandel av standardstorleken.<br/> Gäller endast bubbeldiagram.|
| [size_represents](/cells/sv/python-net/aspose.cells.charts/series/size_represents) | Hämtar eller ställer in vad bubbelstorleken representerar på ett bubbeldiagram.|
...
| Metod| Beskrivning|
| :- | :- |
| [move(count)](/cells/sv/python-net/aspose.cells.charts/series/move/#int) | Flyttar serien uppåt eller nedåt.|
...
* klass [DropBars](/cells/sv/python-net/aspose.cells.charts/dropbars)
