...
type: docs
weight: 270
url: /sv/python-net/aspose.cells.charts/plotarea/x/
is_root: false
---
##  x fastighet

Hämtar eller hämtar x-koordinaten för det övre vänstra hörnet av markeringsrutan för plot-area i enheter på 1/4000 av kartytan.
