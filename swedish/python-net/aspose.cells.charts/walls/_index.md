...
type: docs
weight: 350
url: /sv/python-net/aspose.cells.charts/walls/
is_root: false
---
##  Walls klass
...
**Arv:** [Walls](/cells/python-net/aspose.cells.charts/walls) → 
[Floor](/cells/python-net/aspose.cells.charts/floor) → 
[Area](/cells/sv/python-net/aspose.cells.drawing/area)



Typen Walls avslöjar följande medlemmar:

###  Egenskaper
| Fast egendom| Beskrivning|
| :- | :- |
| [background_color](/cells/sv/python-net/aspose.cells.charts/walls/background_color) | Hämtar eller ställer in bakgrundsfärgen för [Area](/cells/sv/python-net/aspose.cells.drawing/area).|
| [foreground_color](/cells/sv/python-net/aspose.cells.charts/walls/foreground_color) | Får eller ställer in förgrundsfärgen.|
| [formatting](/cells/sv/python-net/aspose.cells.charts/walls/formatting) | Representerar formateringen av området.|
| [invert_if_negative](/cells/sv/python-net/aspose.cells.charts/walls/invert_if_negative) | Om egenskapen är sann och värdet på diagrampunkten är ett negativt tal,<br/> förgrundsfärgen och bakgrundsfärgen kommer att bytas ut.|
| [fill_format](/cells/sv/python-net/aspose.cells.charts/walls/fill_format) | Representerar ett [Area.fill_format](/cells/sv/python-net/aspose.cells.drawing/area#fill_format)-objekt som innehåller fyllningsformateringsegenskaper för det angivna diagrammet eller formen.|
| [transparency](/cells/sv/python-net/aspose.cells.charts/walls/transparency) | Returnerar eller ställer in graden av transparens för området som ett värde från 0,0 (opak) till 1,0 (ren).|
...
* klass [Area](/cells/sv/python-net/aspose.cells.drawing/area)
* klass [Floor](/cells/sv/python-net/aspose.cells.charts/floor)
* klass [Line](/cells/sv/python-net/aspose.cells.drawing/line)
* klass [Walls](/cells/sv/python-net/aspose.cells.charts/walls)
