...
type: docs
weight: 30
url: /sv/python-net/aspose.cells.charts/chart/
is_root: false
---
##  Chart klass
...
| [size_with_window](/cells/sv/python-net/aspose.cells.charts/chart/size_with_window) | Sant om Microsoft Excel ändrar storleken på diagrammet för att matcha storleken på diagrambladets fönster.|
| [worksheet](/cells/sv/python-net/aspose.cells.charts/chart/worksheet) | Hämtar arbetsbladet som innehåller detta diagram.|
| [shapes](/cells/sv/python-net/aspose.cells.charts/chart/shapes) | Returnerar alla ritningsformer i det här diagrammet.|
| [print_size](/cells/sv/python-net/aspose.cells.charts/chart/print_size) | Hämtar och ställer in den utskrivna diagramstorleken.|
...
| [value_axis](/cells/sv/python-net/aspose.cells.charts/chart/value_axis) | Hämtar diagrammets Y-axel.|
| [second_value_axis](/cells/sv/python-net/aspose.cells.charts/chart/second_value_axis) | Hämtar diagrammets andra Y-axel.|
| [second_category_axis](/cells/sv/python-net/aspose.cells.charts/chart/second_category_axis) | Hämtar diagrammets andra X-axel.|
| [series_axis](/cells/sv/python-net/aspose.cells.charts/chart/series_axis) | Hämtar diagrammets serieaxel.|
| [legend](/cells/sv/python-net/aspose.cells.charts/chart/legend) | Får diagramlegenden.|
| [chart_data_table](/cells/sv/python-net/aspose.cells.charts/chart/chart_data_table) | Representerar diagramdatatabellen.|
...
| [page_setup](/cells/sv/python-net/aspose.cells.charts/chart/page_setup) | Representerar sidkonfigurationsbeskrivningen i det här diagrammet.|
| [line](/cells/sv/python-net/aspose.cells.charts/chart/line) | Får linjen.|


###  Metoder
| Metod| Beskrivning|
| :- | :- |
| [to_image(image_file)](/cells/sv/python-net/aspose.cells.charts/chart/to_image/#str) | Skapar diagrambilden och sparar den i en fil.<br/> Förlängningen av filnamnet bestämmer formatet på bilden.|
| [to_image(image_file, image_type)](/cells/sv/python-net/aspose.cells.charts/chart/to_image/#str-aspose.cells.drawing.ImageType) | Skapar diagrambilden och sparar den i en fil i angiven bildtyp.|
| [to_image(image_file, jpeg_quality)](/cells/sv/python-net/aspose.cells.charts/chart/to_image/#str-int) | Skapar diagrambilden och sparar den i en fil i Jpeg-format.|
| [to_image(stream, jpeg_quality)](/cells/sv/python-net/aspose.cells.charts/chart/to_image/#io.RawIOBase-int) | Skapar diagrambilden och sparar den i en ström i Jpeg-format.|
| [to_image(stream, image_type)](/cells/sv/python-net/aspose.cells.charts/chart/to_image/#io.RawIOBase-aspose.cells.drawing.ImageType) |Skapar diagrambilden och sparar den i en ström i det angivna formatet.|
| [to_image(image_file, options)](/cells/sv/python-net/aspose.cells.charts/chart/to_image/#str-aspose.cells.rendering.ImageOrPrintOptions) | Skapar diagrambilden och sparar den i en fil.<br/> Förlängningen av filnamnet bestämmer formatet på bilden.|
