---
title: SparklineAxisMinMaxType uppräkning
second_title: Aspose.Cells for Python via .NET API Referenser
description:
type: docs
weight: 610
url: /sv/python-net/aspose.cells.charts/sparklineaxisminmaxtype/
is_root: false
---
...
Typen SparklineAxisMinMaxType avslöjar följande medlemmar:
