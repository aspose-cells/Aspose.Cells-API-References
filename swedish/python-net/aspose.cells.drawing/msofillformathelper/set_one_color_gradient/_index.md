---
title: set_one_color_gradient metod
second_title: Aspose.Cells for Python via .NET API Referenser
description:
type: docs
weight: 20
url: /sv/python-net/aspose.cells.drawing/msofillformathelper/set_one_color_gradient/
is_root: false
---
...
| degree | float | Gradientgraden. Kan vara ett värde från 0,0 (mörkt) till 1,0 (ljus).|
