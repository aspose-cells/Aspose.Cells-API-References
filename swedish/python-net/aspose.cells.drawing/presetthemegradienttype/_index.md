---
title: PresetThemeGradientType uppräkning
second_title: Aspose.Cells for Python via .NET API Referenser
description:
type: docs
weight: 1090
url: /sv/python-net/aspose.cells.drawing/presetthemegradienttype/
is_root: false
---
...
Typen PresetThemeGradientType avslöjar följande medlemmar:
