---
title: MsoPresetTextEffectShape uppräkning
second_title: Aspose.Cells for Python via .NET API Referenser
description:
type: docs
weight: 1040
url: /sv/python-net/aspose.cells.drawing/msopresettexteffectshape/
is_root: false
---
##  MsoPresetTextEffectShape uppräkning
Representerar förinställd texteffektformtyp för WordArt.



Typen MsoPresetTextEffectShape avslöjar följande medlemmar:
