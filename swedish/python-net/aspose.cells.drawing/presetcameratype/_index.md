---
title: PresetCameraType uppräkning
second_title: Aspose.Cells for Python via .NET API Referenser
description:
type: docs
weight: 1060
url: /sv/python-net/aspose.cells.drawing/presetcameratype/
is_root: false
---
##  PresetCameraType uppräkning
Representera olika algoritmiska metoder för att ställa in alla kameraegenskaper, inklusive position.



Typen PresetCameraType avslöjar följande medlemmar:
