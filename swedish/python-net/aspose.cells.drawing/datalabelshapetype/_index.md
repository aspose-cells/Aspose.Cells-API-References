---
title: DataLabelShapeType uppräkning
second_title: Aspose.Cells for Python via .NET API Referenser
description:
type: docs
weight: 800
url: /sv/python-net/aspose.cells.drawing/datalabelshapetype/
is_root: false
---
##  DataLabelShapeType uppräkning
Anger den förinställda formgeometrin som ska användas för ett diagram.



Typen DataLabelShapeType avslöjar följande medlemmar:
