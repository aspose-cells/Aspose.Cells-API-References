...
type: docs
weight: 760
url: /sv/python-net/aspose.cells.drawing/autoshapetype/
is_root: false
---
...
Typen AutoShapeType avslöjar följande medlemmar:
...
| HORIZONTAL_SCROLL |  |
| CIRCULAR_ARROW |  |
| NOTCHED_CIRCULAR_ARROW | Ett värde som INTE BÖR användas.|
| U_TURN_ARROW |  |
| CURVED_RIGHT_ARROW |  |
| CURVED_LEFT_ARROW |  |
| CURVED_UP_ARROW |  |
...
| FRAME |  |
| MODEL_3D |  |
| ROUND_CALLOUT | Det finns ingen sådan typ i Excel|
| TEXT_ARCH_LEFT_POUR | Det finns ingen sådan typ i Excel|
| TEXT_ARCH_RIGHT_POUR | Det finns ingen sådan typ i Excel|
| TEXT_ARCH_LEFT_CURVE | Det finns ingen sådan typ i Excel|
| TEXT_ARCH_RIGHT_CURVE | Det finns ingen sådan typ i Excel|
| UNKNOWN |  |
