...
type: docs
weight: 3900
url: /sv/cpp/aspose.cells.drawing/oleobject/
---
## OleObject class
...
//Hämta bilddata till "iconData". t.ex.: En .jpg‑fil med namnet "school.jpg"
//(Obs: Du måste läsa in data i den här variabeln.)
Vector<uint8_t> iconData{0};

//Hämta OLE‑objektsdata till "objectData". t.ex.: En .xls‑fil med namnet "Book1.xls"
//(Obs: Du måste läsa in data i den här variabeln.)
...
//Ställ in inbäddad OLE‑objektsdata.
