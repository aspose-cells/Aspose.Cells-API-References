...
type: docs
weight: 6700
url: /sv/cpp/aspose.cells.drawing/textbox/
---
## TextBox class
...
//Ställ in textrutan så att den anpassas efter dess innehåll.
...
//Ställ in teckensnittsstorleken.
...
//Ställ in streckstilen till fyrkantig punkt.
lineformat.SetDashStyle(MsoLineDashStyle::SquareDot);
//Lägg till en annan textruta.
...
//Mata in lite text i den.
textbox1.SetText(u"This is another simple text box");
//Ställ in placerings typen så att textrutan kommer att flytta och
