...
type: docs
weight: 14600
url: /sv/cpp/aspose.cells.drawing/shape/setlinkedcell/
---
...
```cpp
//Efter att ha kört koden nedan skapas ett ScrollBar-objekt i den genererade filen. När du drar i reglaget visas värdet i cell A12.
