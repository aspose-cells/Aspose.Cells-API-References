...
type: docs
weight: 100
url: /sv/cpp/aspose.cells.digitalsignatures/digitalsignature/digitalsignature/
---
...
//signatursamling innehåller en eller flera signaturer som behövs för att signera
...
dsc.Add(ds);
Workbook wb;
//sätt alla signaturer till arbetsbok
