...
type: docs
weight: 200
url: /sv/cpp/aspose.cells.digitalsignatures/digitalsignaturecollection/
---
...
//arbetsbok från en signerad källfil
Workbook signedWorkbook(u"signedFile.xlsx");
//wb.IsDigitallySigned är true när arbetsboken redan är signerad.
std::cout<<signedWorkbook.IsDigitallySigned() << std::endl;
//hämta digitalSignature-samling från arbetsbok
