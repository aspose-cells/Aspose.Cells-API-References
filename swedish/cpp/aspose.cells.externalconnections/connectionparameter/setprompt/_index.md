---
title: Aspose::Cells::ExternalConnections::ConnectionParameter::SetPrompt method
linktitle: SetPrompt
second_title: Aspose.Cells for C++ API Reference
description: 'Aspose::Cells::ExternalConnections::ConnectionParameter::SetPrompt method. Prompt string for the parameter. Presented to the spreadsheet user along with input UI to collect the parameter value before refreshing the external data. Used only when parameterType = prompt in C++.'
type: docs
weight: 1100
url: /sv/cpp/aspose.cells.externalconnections/connectionparameter/setprompt/
---
