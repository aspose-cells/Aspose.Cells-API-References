...
type: docs
weight: 1900
url: /sv/cpp/aspose.cells.charts/legend/
---
## Legend class
...
//Ange legendens bredd och höjd
Legend legend = chart.GetLegend();

//Legenden är som standard på diagrammets högra sida.
//Om legenden är på vänster eller högra sidan av diagrammet, kommer inställning av egenskapen Legend.X inte att ha någon effekt.
//Om legenden är på över- eller undersidan av diagrammet, kommer inställning av egenskapen Legend.Y inte att ha någon effekt.
legend.SetY(1500);
legend.SetWidth(50);
legend.SetHeight(50);
//Ange legendens position
