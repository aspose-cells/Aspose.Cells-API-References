...
type: docs
weight: 2100
url: /sv/cpp/aspose.cells.charts/series/getcategoryvalues/
---
...
// XValues kan vara som "[External.xlsx]Sheet1!$B$2:$C$6" vilket är komplicerat
// för användaren att få de faktiska värdena (värdena kan vara länkade till en annan arbetsbok,
// eller cachade i den aktuella arbetsboken). Här kan du använda egenskapen CategoryValues
// för att hämta kategorivärdena som faktiskt visas i Excel-gränssnittet
// i form av en tvådimensionell matris.
