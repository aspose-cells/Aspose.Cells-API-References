...
type: docs
weight: 1400
url: /sv/cpp/aspose.cells.charts/datalabels/
---
## DataLabels class
...
Aspose::Cells::Startup();
    //Ställ in datamärkningarna i diagrammet
    ...
    for (int i = 0; i < chart.GetNSeries().GetCount(); i++)
    {
        ...
        //Ställ in positionen för datamärkningarna
        datalabels.SetPosition(LabelPositionType::InsideBase);
        //Visa kategorinamnet i datamärkningarna
        datalabels.SetShowCategoryName(true);
        //Visa värdet i datamärkningarna
        datalabels.SetShowValue(true);
        //Visa inte procentandelen i datamärkningarna
        datalabels.SetShowPercentage(false);
        //Visa inte förklaringsnyckeln.
