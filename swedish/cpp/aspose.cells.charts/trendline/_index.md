...
type: docs
weight: 3400
url: /sv/cpp/aspose.cells.charts/trendline/
---
## Trendline class
...
//lägger till en linjär trendlinje
...
//Ställer in det anpassade namnet på trendlinjen.
trendline.SetName(u"Linear");
//Visar ekvationen på diagrammet
trendline.SetDisplayEquation(true);
//Visar R‑kvadrerat‑värdet på diagrammet
