...
type: docs
weight: 100
url: /sv/cpp/aspose.cells.charts/axis/
---
## Axis class
...
//Ange huvudintervallet
chart.GetValueAxis().SetMajorUnit(25);
//Kategorix‑axeln korsar vid det maximala värdet.
chart.GetValueAxis().SetCrossType(CrossType::Maximum);
//Ange antalet kategorier eller serier mellan tick‑märkesetiketter.
