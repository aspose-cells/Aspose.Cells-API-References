...
type: docs
weight: 700
url: /sv/cpp/aspose.cells.charts/chartdatatable/
---
...
Aspose::Cells::Startup();
    ...
    //Hämtar diagramtabell
    ChartDataTable chartTable = chart.GetChartDataTable();

    //Ställer in diagramtabellens teckensnittsfärg
    chartTable.GetFont().SetColor(Color{ 0xff, 0xff, 0, 0 });

    //Ställer in legendnyckelns synlighetsalternativ
