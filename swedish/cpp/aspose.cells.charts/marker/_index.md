---
title: Aspose::Cells::Charts::Marker class
linktitle: Marker
...
type: docs
weight: 2100
url: /sv/cpp/aspose.cells.charts/marker/
---
## Marker class
...
| [operator=(const Marker\& src)](./operator_asm/) | operator= |
| [SetBackgroundColor(const Aspose::Cells::Color\& value)](./setbackgroundcolor/) | Represents the marker background color in a line chart, scatter chart, or radar chart. |
| [SetBackgroundColorSetType(FormattingType value)](./setbackgroundcolorsettype/) | Gets or sets the marker background color set type. |
