...
type: docs
weight: 3300
url: /sv/cpp/aspose.cells/conditionalformattingiconcollection/
---
...
//Hämta villkorsformatering
ConditionalFormattingCollection cformattings = sheet.GetConditionalFormattings();

//Lägger till en tom villkorsformatering
int index = cformattings.Add();

//Hämta nyss tillagd villkorsformatering
FormatConditionCollection fcs = cformattings.Get(index);

//Ställer in området för villkorsformatering.
CellArea ca;
ca.StartRow = 0;
ca.EndRow = 0;
ca.StartColumn = 0;
