...
description: 'Aspose::Cells::U16String::Trim method. Removes all leading and trailing white-space characters from the current string in C++.'
type: docs
weight: 2400
url: /sv/cpp/aspose.cells/u16string/trim/
---
...
| --- | --- | --- |
| trimChar | char16_t | A character to remove. |
...
| Parameter | Type | Description |
| --- | --- | --- |
| trimChars | const Vector \<char16_t\>\& | An array of characters to remove. |
