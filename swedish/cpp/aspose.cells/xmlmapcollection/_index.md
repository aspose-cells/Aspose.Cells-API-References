...
type: docs
weight: 17400
url: /sv/cpp/aspose.cells/xmlmapcollection/
---
...
//Följande kod lägger till två XmlMaps med en xsd-fil och en xml-fil.
Workbook wb;

XmlMapCollection xmlMapCollection = wb.GetWorksheets().GetXmlMaps();

//Lägg till en XmlMap med en xsd-fil.
xmlMapCollection.Add(u"schema.xsd");

//Lägg till en XmlMap med en xml-fil.
