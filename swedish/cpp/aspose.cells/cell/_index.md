...
//Sätt in ett heltal i en cell
cell = cells.Get(u"B1");
cell.PutValue(12);

int second = cell.GetIntValue();

//Sätt in ett dubbelvärde i en cell
cell = cells.Get(0, 2);
cell.PutValue(-1.234);
...
//Sätt in en kombinerad formel: "sum(average(b1,c1), b1)" i cellen b2
cell = cells.Get(u"b2");
cell.SetFormula(u"=sum(average(b1,c1), b1)");

//Ställ in stil för en cell
Style style = cell.GetStyle();
//Ställ in bakgrundsfärg
style.SetBackgroundColor(Color{ 0xff, 0xff, 0xff, 0 });
//Ställ in format för en cell
