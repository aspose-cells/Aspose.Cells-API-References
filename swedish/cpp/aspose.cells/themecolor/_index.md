...
type: docs
weight: 14500
url: /sv/cpp/aspose.cells/themecolor/
---
## ThemeColor class
...
//Ställ in färgtyp för ThemeColorType.Text2 med 40 % ljusare som teckensnittsfärg.
style.GetFont().SetThemeColor(ThemeColor(ThemeColorType::Text2, 0.4));
style.SetPattern(BackgroundType::Solid);
//Ställ in färgtyp för ThemeColorType.Background2 med 75 % mörkare som förgrundsfärg.
