...
type: docs
weight: 800
url: /sv/cpp/aspose.cells.drawing.equations/equationnode/
---
## EquationNode class
...
// Instansiera ett Workbook-objekt som representerar en Excel-fil.
Workbook workbook;

// Lägger till ett ekvationsobjekt i kalkylbladet.
TextBox textBox = workbook.GetWorksheets().Get(0).GetShapes().AddEquation(1, 0, 1, 0, 100, 300);

// Hämtar startnoden för ekvationsobjektet
EquationNode mathNode = textBox.GetEquationParagraph().GetChild(0);

// Infogar en bråkekvation.
