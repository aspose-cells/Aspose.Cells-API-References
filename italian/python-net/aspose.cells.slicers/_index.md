...
type: docs
weight: 10
url: /it/python-net/aspose.cells.slicers/
is_root: false
---
 IL**Aspose.Cells.Slicers** namespace fornisce tutte le classi per le opzioni di Slicer tabella pivot per i file del foglio di calcolo di Excel.
