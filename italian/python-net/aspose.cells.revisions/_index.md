...
type: docs
weight: 10
url: /it/python-net/aspose.cells.revisions/
is_root: false
---
 IL**Aspose.Cells.Revisions** namespace fornisce le classi per accedere alle revisioni dei file del foglio di calcolo di Excel.

###  Classi
| Classe| Descrizione|
| :- | :- |
| [Revision](/cells/it/python-net/aspose.cells.revisions/revision) | Rappresenta la revisione.|
| [RevisionAutoFormat](/cells/it/python-net/aspose.cells.revisions/revisionautoformat) | rappresenta un record di revisione delle informazioni su una modifica di formattazione.|
| [RevisionCellChange](/cells/it/python-net/aspose.cells.revisions/revisioncellchange) | Rappresenta la revisione che cambia le celle.|
| [RevisionCellComment](/cells/it/python-net/aspose.cells.revisions/revisioncellcomment) | Rappresenta un record di revisione di una modifica del commento di cella.|
