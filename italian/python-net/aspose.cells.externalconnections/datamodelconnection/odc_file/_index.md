...
type: docs
weight: 130
url: /it/python-net/aspose.cells.externalconnections/datamodelconnection/odc_file/
is_root: false
---
##  odc_file proprietà

 Specifica il percorso completo del file di connessione esterno da cui proveniva questa connessione
 Se una connessione non riesce durante un tentativo di aggiornamento dei dati e reconnectionMethod=1,
