...
type: docs
weight: 30
url: /it/python-net/aspose.cells.webextensions/webextensioncollection/add_web_video_player/
is_root: false
---
...
| start_time | int | L'ora di inizio in unità di secondi.|
| end_time | int | L'ora di fine in unità di secondi.|
