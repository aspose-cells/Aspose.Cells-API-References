---
title: classe WebExtensionTaskPane
second_title: Aspose.Cells for Python via .NET API Referenze
description:
type: docs
weight: 90
url: /it/python-net/aspose.cells.webextensions/webextensiontaskpane/
is_root: false
---
##  classe WebExtensionTaskPane
Rappresenta un oggetto taskpane persistente.



Il tipo WebExtensionTaskPane espone i membri seguenti:

###  Proprietà
| Proprietà| Descrizione|
| :- | :- |
| [web_extension](/cells/it/python-net/aspose.cells.webextensions/webextensiontaskpane/web_extension) | Ottiene e imposta la parte dell'estensione Web associata all'istanza del riquadro delle attività|
