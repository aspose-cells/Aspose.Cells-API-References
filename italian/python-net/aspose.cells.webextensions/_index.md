...
type: docs
weight: 10
url: /it/python-net/aspose.cells.webextensions/
is_root: false
---
 IL**Aspose.Cells.WebExtensions** lo spazio dei nomi contiene le classi per accedere al componente aggiuntivo di Office nei file Excel.

###  Classi
| Classe| Descrizione|
| :- | :- |
| [WebExtension](/cells/it/python-net/aspose.cells.webextensions/webextension) | Rappresenta un'istanza del componente aggiuntivo di Office.|
| [WebExtensionBinding](/cells/it/python-net/aspose.cells.webextensions/webextensionbinding) | Rappresenta una relazione vincolante tra un componente aggiuntivo di Office e i dati nel documento.|
| [WebExtensionBindingCollection](/cells/it/python-net/aspose.cells.webextensions/webextensionbindingcollection) | Rappresenta l'elenco delle relazioni di associazione tra un componente aggiuntivo di Office e i dati nel documento.|
...
| :- | :- |
| [WebExtensionStoreType](/cells/it/python-net/aspose.cells.webextensions/webextensionstoretype) |Rappresenta il tipo di negozio dell'estensione web.|
