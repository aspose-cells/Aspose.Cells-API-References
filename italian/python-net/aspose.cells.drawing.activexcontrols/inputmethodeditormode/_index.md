---
title: InputMethodEditorMode enumerazione
second_title: Aspose.Cells for Python via .NET API Referenze
description:
type: docs
weight: 290
url: /it/python-net/aspose.cells.drawing.activexcontrols/inputmethodeditormode/
is_root: false
---
##  InputMethodEditorMode enumerazione
Rappresenta la modalità di runtime predefinita dell'Input Method Editor.



Il tipo InputMethodEditorMode espone i membri seguenti:
...
| ALPHA_FULL | IME attivo con modalità alfanumerica a larghezza intera.|
