...
type: docs
weight: 200
url: /it/python-net/aspose.cells.drawing.activexcontrols/controlmousepointertype/
is_root: false
---
##  ControlMousePointerType enumerazione
Rappresenta il tipo di icona visualizzata come puntatore del mouse per il controllo.



Il tipo ControlMousePointerType espone i membri seguenti:
...
| SIZE_NWSE | Doppia freccia che punta a nord-ovest e sud-est.|
