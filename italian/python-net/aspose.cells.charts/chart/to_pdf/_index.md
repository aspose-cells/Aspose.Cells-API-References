...
type: docs
weight: 130
url: /it/python-net/aspose.cells.charts/chart/to_pdf/
is_root: false
---
...
| h_alignment_type | [PageLayoutAlignmentType](/cells/it/python-net/aspose.cells/pagelayoutalignmenttype) | Il tipo di allineamento orizzontale del grafico nella pagina di output.|
| v_alignment_type | [PageLayoutAlignmentType](/cells/it/python-net/aspose.cells/pagelayoutalignmenttype) | Il tipo di allineamento verticale del grafico nella pagina di output.|
