---
title: classe PlotArea
second_title: Aspose.Cells for Python via .NET API Referenze
description:
type: docs
weight: 220
url: /it/python-net/aspose.cells.charts/plotarea/
is_root: false
---
##  classe PlotArea
...
**Eredità:** [PlotArea](/cells/python-net/aspose.cells.charts/plotarea) → 
[ChartFrame](/cells/it/python-net/aspose.cells.charts/chartframe)



Il tipo PlotArea espone i membri seguenti:

###  Proprietà
| Proprietà| Descrizione|
| :- | :- |
| [is_inner_mode](/cells/it/python-net/aspose.cells.charts/plotarea/is_inner_mode) | Indica se la dimensione dell'area del tracciato include i segni di graduazione e le etichette degli assi.<br/> False specifica che la dimensione determinerà la dimensione dell'area del tracciato, i segni di graduazione e le etichette degli assi.|
| [border](/cells/it/python-net/aspose.cells.charts/plotarea/border) | Ottiene lo [Line](/cells/it/python-net/aspose.cells.drawing/line).|
| [area](/cells/it/python-net/aspose.cells.charts/plotarea/area) | Ottiene lo [ChartFrame.area](/cells/it/python-net/aspose.cells.charts/chartframe#area).|
...
| [is_default_pos_be_set](/cells/it/python-net/aspose.cells.charts/plotarea/is_default_pos_be_set) | Indica se la posizione predefinita (DefaultX, DefaultY, DefaultWidth e DefaultHeight) è impostata.|
| [default_x](/cells/it/python-net/aspose.cells.charts/plotarea/default_x) | Rappresenta x della posizione predefinita|
| [default_y](/cells/it/python-net/aspose.cells.charts/plotarea/default_y) | Rappresenta y della posizione predefinita|
| [default_width](/cells/it/python-net/aspose.cells.charts/plotarea/default_width) | Rappresenta la larghezza della posizione predefinita|
| [default_height](/cells/it/python-net/aspose.cells.charts/plotarea/default_height) | Rappresenta l'altezza della posizione predefinita|
| [inner_x](/cells/it/python-net/aspose.cells.charts/plotarea/inner_x) | Ottiene o ottiene la coordinata x dell'angolo superiore superiore dell'area del grafico in unità di 1/4000 dell'area del grafico.|
| [inner_y](/cells/it/python-net/aspose.cells.charts/plotarea/inner_y) | Ottiene o ottiene la coordinata x dell'angolo superiore superiore dell'area del grafico in unità di 1/4000 dell'area del grafico.|
| [inner_height](/cells/it/python-net/aspose.cells.charts/plotarea/inner_height) | Ottiene o imposta l'altezza dell'area del tracciato in unità di 1/4000 dell'area del grafico.|
| [inner_width](/cells/it/python-net/aspose.cells.charts/plotarea/inner_width) | Ottiene o imposta la larghezza dell'area del tracciato in unità di 1/4000 dell'area del grafico.|


###  Metodi
| Metodo| Descrizione|
| :- | :- |
| [set_position_auto()](/cells/it/python-net/aspose.cells.charts/plotarea/set_position_auto/#) | Impostare la posizione dell'area del tracciato su automatico|
