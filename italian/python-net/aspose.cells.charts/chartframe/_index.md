---
title: classe ChartFrame
second_title: Aspose.Cells for Python via .NET API Referenze
description:
type: docs
weight: 70
url: /it/python-net/aspose.cells.charts/chartframe/
is_root: false
---
##  classe ChartFrame
Incapsula l'oggetto che rappresenta l'oggetto frame in un grafico.



Il tipo ChartFrame espone i membri seguenti:

###  Proprietà
| Proprietà| Descrizione|
| :- | :- |
| [is_inner_mode](/cells/it/python-net/aspose.cells.charts/chartframe/is_inner_mode) | Indica se la dimensione dell'area del tracciato include i segni di graduazione e le etichette degli assi.<br/> False specifica che la dimensione determinerà la dimensione dell'area del tracciato, i segni di graduazione e le etichette degli assi.|
| [border](/cells/it/python-net/aspose.cells.charts/chartframe/border) | Ottiene lo [Line](/cells/it/python-net/aspose.cells.drawing/line).|
| [area](/cells/it/python-net/aspose.cells.charts/chartframe/area) | Ottiene lo [ChartFrame.area](/cells/it/python-net/aspose.cells.charts/chartframe#area).|
...
| [default_x](/cells/it/python-net/aspose.cells.charts/chartframe/default_x) | Rappresenta x della posizione predefinita|
| [default_y](/cells/it/python-net/aspose.cells.charts/chartframe/default_y) | Rappresenta y della posizione predefinita|
| [default_width](/cells/it/python-net/aspose.cells.charts/chartframe/default_width) | Rappresenta la larghezza della posizione predefinita|
| [default_height](/cells/it/python-net/aspose.cells.charts/chartframe/default_height) | Rappresenta l'altezza della posizione predefinita|


###  Metodi
| Metodo| Descrizione|
| :- | :- |
| [set_position_auto()](/cells/it/python-net/aspose.cells.charts/chartframe/set_position_auto/#) | Imposta la posizione della cornice su automatico|
