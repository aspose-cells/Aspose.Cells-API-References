...
type: docs
weight: 170
url: /it/python-net/aspose.cells.charts/legend/
is_root: false
---
##  classe Legend
...
**Eredità:** [Legend](/cells/python-net/aspose.cells.charts/legend) → 
...
Il tipo Legend espone i membri seguenti:

###  Proprietà
| Proprietà| Descrizione|
| :- | :- |
| [is_inner_mode](/cells/it/python-net/aspose.cells.charts/legend/is_inner_mode) | Indica se la dimensione dell'area del tracciato include i segni di graduazione e le etichette degli assi.<br/> False specifica che la dimensione determinerà la dimensione dell'area del tracciato, i segni di graduazione e le etichette degli assi.|
| [border](/cells/it/python-net/aspose.cells.charts/legend/border) | Ottiene lo [Line](/cells/it/python-net/aspose.cells.drawing/line).|
| [area](/cells/it/python-net/aspose.cells.charts/legend/area) | Ottiene lo [ChartFrame.area](/cells/it/python-net/aspose.cells.charts/chartframe#area).|
...
| [x](/cells/it/python-net/aspose.cells.charts/legend/x) | Ottiene o imposta la coordinata x dell'angolo superiore sinistro in unità di 1/4000 dell'area del grafico.|
| [y](/cells/it/python-net/aspose.cells.charts/legend/y) | Ottiene o imposta la coordinata y dell'angolo superiore sinistro in unità di 1/4000 dell'area del grafico.|
| [height](/cells/it/python-net/aspose.cells.charts/legend/height) | Ottiene o imposta l'altezza del frame in unità di 1/4000 dell'area del grafico.|
| [width](/cells/it/python-net/aspose.cells.charts/legend/width) |Ottiene o imposta la larghezza del frame in unità di 1/4000 dell'area del grafico.|
| [shadow](/cells/it/python-net/aspose.cells.charts/legend/shadow) | Vero se la cornice ha un'ombra.|
| [shape_properties](/cells/it/python-net/aspose.cells.charts/legend/shape_properties) | Ottiene l'oggetto [ChartFrame.shape_properties](/cells/it/python-net/aspose.cells.charts/chartframe#shape_properties).|
| [is_default_pos_be_set](/cells/it/python-net/aspose.cells.charts/legend/is_default_pos_be_set) | Indica se la posizione predefinita (DefaultX, DefaultY, DefaultWidth e DefaultHeight) è impostata.|
| [default_x](/cells/it/python-net/aspose.cells.charts/legend/default_x) | Rappresenta x della posizione predefinita|
...
| [rotation_angle](/cells/it/python-net/aspose.cells.charts/legend/rotation_angle) | Rappresenta l'angolo di rotazione del testo.|
| [is_automatic_rotation](/cells/it/python-net/aspose.cells.charts/legend/is_automatic_rotation) | Indica se il testo del grafico viene ruotato automaticamente.|
| [text](/cells/it/python-net/aspose.cells.charts/legend/text) | Ottiene o imposta il testo del titolo di un frame.|
| [linked_source](/cells/it/python-net/aspose.cells.charts/legend/linked_source) |Ottiene e imposta un riferimento al foglio di lavoro.|
| [text_direction](/cells/it/python-net/aspose.cells.charts/legend/text_direction) | Rappresenta l'ordine di lettura del testo.|
...
| [is_over_lay](/cells/it/python-net/aspose.cells.charts/legend/is_over_lay) | Ottiene o imposta se altri elementi del grafico possono sovrapporsi a questo elemento del grafico.|


###  Metodi
| Metodo| Descrizione|
| :- | :- |
| [set_position_auto()](/cells/it/python-net/aspose.cells.charts/legend/set_position_auto/#) | Imposta la posizione della cornice su automatico|
| [characters(start_index, length)](/cells/it/python-net/aspose.cells.charts/legend/characters/#int-int) |Restituisce un oggetto Characters che rappresenta un intervallo di caratteri all'interno del testo.|
...
* classe [Legend](/cells/it/python-net/aspose.cells.charts/legend)
