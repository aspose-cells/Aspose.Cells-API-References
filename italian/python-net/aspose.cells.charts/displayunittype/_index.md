---
title: DisplayUnitType enumerazione
second_title: Aspose.Cells for Python via .NET API Referenze
description:
type: docs
weight: 490
url: /it/python-net/aspose.cells.charts/displayunittype/
is_root: false
---
##  DisplayUnitType enumerazione
Rappresenta il tipo di unità di visualizzazione.



Il tipo DisplayUnitType espone i membri seguenti:

###  Campi
| Campo| Descrizione|
| :- | :- |
| NONE | L'unità di visualizzazione è Nessuno.|
| HUNDREDS | Specifica che i valori sul grafico devono essere divisi per 100.|
| THOUSANDS | Specifica che i valori sul grafico devono essere divisi per 1.000.|
| TEN_THOUSANDS | Specifica che i valori sul grafico devono essere divisi per 10.000.|
