...
type: docs
weight: 200
url: /it/python-net/aspose.cells.charts/marker/
is_root: false
---
##  classe Marker
Rappresenta l'indicatore in un grafico a linee, a dispersione o radar.



Il tipo Marker espone i membri seguenti:
...
| [background_color](/cells/it/python-net/aspose.cells.charts/marker/background_color) | Rappresenta il colore di sfondo dell'indicatore in un grafico a linee, a dispersione o radar.|
| [background_color_set_type](/cells/it/python-net/aspose.cells.charts/marker/background_color_set_type) | Ottiene o imposta il tipo di set di colori di sfondo dell'indicatore.|
