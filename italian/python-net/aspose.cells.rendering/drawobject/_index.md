---
title: classe DrawObject
second_title: Aspose.Cells for Python via .NET API Referenze
description:
type: docs
weight: 10
url: /it/python-net/aspose.cells.rendering/drawobject/
is_root: false
---
##  classe DrawObject
...
Il tipo DrawObject espone i membri seguenti:
...
| [sheet_index](/cells/it/python-net/aspose.cells.rendering/drawobject/sheet_index) | Indica l'indice del foglio corrente di DrawObject.|
