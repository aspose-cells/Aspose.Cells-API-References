...
type: docs
weight: 280
url: /it/python-net/aspose.cells.rendering/imageorprintoptions/save_format/
is_root: false
---
##  save_format proprietà

Ottiene o imposta il tipo di formato del file di output
Supporto Tiff/XPS
...
* classe [SaveFormat](/cells/it/python-net/aspose.cells/saveformat)
