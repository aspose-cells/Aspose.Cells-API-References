...
type: docs
weight: 180
url: /it/python-net/aspose.cells.rendering/imageorprintoptions/one_page_per_sheet/
is_root: false
---
##  one_page_per_sheet proprietà
 ...
 Il formato carta di pagesetup non sarà valido e le altre impostazioni di pagesetup
avrà ancora effetto.
###  Definizione:
```python
@property
