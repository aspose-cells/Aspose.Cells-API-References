...
type: docs
weight: 70
url: /it/python-net/aspose.cells.rendering/pagestartsavingargs/
is_root: false
---
##  classe PageStartSavingArgs
Le informazioni per una pagina avviano il processo di salvataggio.



**Eredità:** [PageStartSavingArgs](/cells/python-net/aspose.cells.rendering/pagestartsavingargs) → 
[PageSavingArgs](/cells/it/python-net/aspose.cells.rendering/pagesavingargs)



Il tipo PageStartSavingArgs espone i membri seguenti:
...
* classe [PageSavingArgs](/cells/it/python-net/aspose.cells.rendering/pagesavingargs)
* classe [PageStartSavingArgs](/cells/it/python-net/aspose.cells.rendering/pagestartsavingargs)
