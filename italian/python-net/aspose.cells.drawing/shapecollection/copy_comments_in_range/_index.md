...
type: docs
weight: 370
url: /it/python-net/aspose.cells.drawing/shapecollection/copy_comments_in_range/
is_root: false
---
...
| :- | :- | :- |
| shapes | [ShapeCollection](/cells/it/python-net/aspose.cells.drawing/shapecollection) | Le forme di origine.|
| ca | [CellArea](/cells/it/python-net/aspose.cells/cellarea) | L'intervallo di origine.|
| dest_row | int | La riga iniziale dell'intervallo dest.|
| dest_column | int | La colonna di inizio dell'intervallo di destinazione.|
