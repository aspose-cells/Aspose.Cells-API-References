---
title: classe ThreeDFormat
second_title: Aspose.Cells for Python via .NET API Referenze
description:
type: docs
weight: 720
url: /it/python-net/aspose.cells.drawing/threedformat/
is_root: false
---
##  classe ThreeDFormat
...
Il tipo ThreeDFormat espone i membri seguenti:

###  Proprietà
| Proprietà| Descrizione|
| :- | :- |
| [bottom_bevel_width](/cells/it/python-net/aspose.cells.drawing/threedformat/bottom_bevel_width) | Ottiene e imposta la larghezza della smussatura inferiore o la distanza di applicazione nella forma.<br/> In unità di punti.|
| [bottom_bevel_height](/cells/it/python-net/aspose.cells.drawing/threedformat/bottom_bevel_height) | Ottiene e imposta l'altezza della smussatura inferiore o la distanza di applicazione nella forma.<br/> In unità di punti.|
...
| [light_angle](/cells/it/python-net/aspose.cells.drawing/threedformat/light_angle) | Ottiene e imposta l'angolo delle luci di estrusione.|
| [lighting](/cells/it/python-net/aspose.cells.drawing/threedformat/lighting) | Ottiene e imposta il tipo di impianto luci.|
| [lighting_direction](/cells/it/python-net/aspose.cells.drawing/threedformat/lighting_direction) | Ottiene e imposta la direzione da cui è orientato l'impianto luci rispetto alla scena.|
