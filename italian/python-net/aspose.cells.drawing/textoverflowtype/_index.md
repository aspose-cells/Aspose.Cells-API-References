---
title: TextOverflowType enumerazione
second_title: Aspose.Cells for Python via .NET API Referenze
description:
type: docs
weight: 1170
url: /it/python-net/aspose.cells.drawing/textoverflowtype/
is_root: false
---
##  TextOverflowType enumerazione
Rappresenta il modo in cui il testo trabocca in verticale o in orizzontale.



Il tipo TextOverflowType espone i membri seguenti:
