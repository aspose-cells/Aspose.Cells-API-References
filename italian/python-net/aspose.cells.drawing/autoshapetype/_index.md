...
type: docs
weight: 760
url: /it/python-net/aspose.cells.drawing/autoshapetype/
is_root: false
---
...
| HORIZONTAL_SCROLL |  |
| CIRCULAR_ARROW |  |
| NOTCHED_CIRCULAR_ARROW | Un valore che NON DOVREBBE essere utilizzato.|
| U_TURN_ARROW |  |
| CURVED_RIGHT_ARROW |  |
| CURVED_LEFT_ARROW |  |
| CURVED_UP_ARROW |  |
...
| SUN |  |
| MOON |  |
| DOUBLE_BRACKET | Una forma racchiusa tra parentesi.|
| DOUBLE_BRACE | Una forma racchiusa tra parentesi graffe.|
| STAR4 |  |
| DOUBLE_WAVE |  |
| BLANK_ACTION_BUTTON |  |
| HOME_ACTION_BUTTON |  |
