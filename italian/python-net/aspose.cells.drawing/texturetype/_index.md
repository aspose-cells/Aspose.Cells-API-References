---
title: TextureType enumerazione
second_title: Aspose.Cells for Python via .NET API Referenze
description:
type: docs
weight: 1180
url: /it/python-net/aspose.cells.drawing/texturetype/
is_root: false
---
##  TextureType enumerazione
Rappresenta il tipo di trama preimpostato.



Il tipo TextureType espone i membri seguenti:
...
| SAND | Rappresenta il tipo di texture Sabbia.|
| STATIONERY | Rappresenta il tipo di trama Cancelleria.|
| WALNUT | Rappresenta il tipo di texture Walnut Droplets.|
| WATER_DROPLETS | Rappresenta il tipo di texture Gocce d'acqua.|
| WHITE_MARBLE | Rappresenta il tipo di texture Marmo bianco.|
| WOVEN_MAT | Rappresenta il tipo di trama Tappetino intrecciato.|
| UNKNOWN | Rappresenta il tipo di texture sconosciuto.|
