...
type: docs
weight: 810
url: /it/python-net/aspose.cells.drawing/fillpattern/
is_root: false
---
##  FillPattern enumerazione
Enumera i tipi di motivo di riempimento forma.



Il tipo FillPattern espone i membri seguenti:
...
| GRAY80 | Rappresenta l'80% del motivo grigio.|
| GRAY90 | Rappresenta il motivo grigio al 90%.|
...
| LIGHT_VERTICAL | Rappresenta un motivo verticale chiaro.|
| LIGHT_HORIZONTAL | Rappresenta un motivo orizzontale chiaro.|
| NARROW_VERTICAL | Rappresenta uno schema verticale stretto.|
