---
title: classe PivotGlobalizationSettings
second_title: Aspose.Cells for Python via .NET API Referenze
description:
type: docs
weight: 10
url: /it/python-net/aspose.cells.settings/pivotglobalizationsettings/
is_root: false
---
##  classe PivotGlobalizationSettings
Rappresenta le impostazioni di globalizzazione per le tabelle pivot.



Il tipo PivotGlobalizationSettings espone i membri seguenti:

###  Costruttori
| Costruttore| Descrizione|
| :- | :- |
| [PivotGlobalizationSettings()](/cells/it/python-net/aspose.cells.settings/pivotglobalizationsettings/__init__/#) | Costruisce una nuova istanza di PivotGlobalizationSettings|
