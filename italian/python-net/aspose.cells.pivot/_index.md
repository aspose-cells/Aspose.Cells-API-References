...
type: docs
weight: 10
url: /it/python-net/aspose.cells.pivot/
is_root: false
---
 IL**Aspose.Cells.Pivot** namespace contiene tutte le classi di rendering e manipolazione della tabella pivot nei file del foglio di calcolo di Excel.
...
| [PivotFormatCondition](/cells/it/python-net/aspose.cells.pivot/pivotformatcondition) | Rappresenta una condizione di formato tabella pivot nella raccolta PivotFormatCondition.|
| [PivotFormatConditionCollection](/cells/it/python-net/aspose.cells.pivot/pivotformatconditioncollection) | Rappresenta le condizioni del formato tabella pivot.|
| [PivotItem](/cells/it/python-net/aspose.cells.pivot/pivotitem) | Rappresenta un elemento in un rapporto PivotField.|
| [PivotItemCollection](/cells/it/python-net/aspose.cells.pivot/pivotitemcollection) | Rappresenta una raccolta di tutti gli oggetti PivotItem nei PivotField|
| [PivotPageFields](/cells/it/python-net/aspose.cells.pivot/pivotpagefields) | Rappresenta gli elementi del campo della pagina pivot<br/>se l'origine dati della tabella pivot è costituita da intervalli di consolidamento.<br/> Può contenere solo fino a 4 campi.|
| [PivotTable](/cells/it/python-net/aspose.cells.pivot/pivottable) | Descrizione di riepilogo per la tabella pivot.|
| [PivotTableCollection](/cells/it/python-net/aspose.cells.pivot/pivottablecollection) | Rappresenta la raccolta di tutti gli oggetti tabella pivot nel foglio di lavoro specificato.|
| [SxRng](/cells/it/python-net/aspose.cells.pivot/sxrng) | Rappresenta l'intervallo di gruppi in un campo pivot.|
