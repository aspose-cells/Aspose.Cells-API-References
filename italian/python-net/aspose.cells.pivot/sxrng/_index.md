...
type: docs
weight: 120
url: /it/python-net/aspose.cells.pivot/sxrng/
is_root: false
---
##  classe SxRng
Rappresenta l'intervallo di gruppi in un campo pivot.



Il tipo SxRng espone i membri seguenti:
...
| [by](/cells/it/python-net/aspose.cells.pivot/sxrng/by) | Rappresenta l'oggetto intervallo per l'intervallo di gruppo.|
| [group_by_types](/cells/it/python-net/aspose.cells.pivot/sxrng/group_by_types) | Rappresenta il tipo di gruppo per l'intervallo di gruppi.<br/> rangeofvalue Secondi Minuti Ore Giorni Mesi Trimestre Anni|
