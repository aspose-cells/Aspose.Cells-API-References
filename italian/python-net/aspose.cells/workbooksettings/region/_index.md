...
type: docs
weight: 520
url: /it/python-net/aspose.cells/workbooksettings/region/
is_root: false
---
##  region proprietà

Ottiene o imposta le impostazioni internazionali per le cartelle di lavoro.
...
i) Per un file XLS, sono presenti campi definiti per le impostazioni regionali e MS Excel salva i dati delle impostazioni regionali nel file durante il salvataggio del file XLS.
...
ii) Per altri formati di file, come XLSX, XLSB...ecc., non esiste alcun campo definito per le impostazioni regionali nella specifica del formato di file.
...
###  Guarda anche
* modulo [aspose.cells](../../)
* classe [CountryCode](/cells/it/python-net/aspose.cells/countrycode)
* classe [WorkbookSettings](/cells/it/python-net/aspose.cells/workbooksettings)
