...
type: docs
weight: 1610
url: /it/python-net/aspose.cells/workbooksettings/
is_root: false
---
...
Il tipo WorkbookSettings espone i membri seguenti:
...
| [enable_macros](/cells/it/python-net/aspose.cells/workbooksettings/enable_macros) | Abilita le macro;|
| [date1904](/cells/it/python-net/aspose.cells/workbooksettings/date1904) | Ottiene o imposta un valore che indica se la cartella di lavoro utilizza il sistema di data 1904.|
| [protection_type](/cells/it/python-net/aspose.cells/workbooksettings/protection_type) | Ottiene il tipo di protezione della cartella di lavoro.|
| [display_drawing_objects](/cells/it/python-net/aspose.cells/workbooksettings/display_drawing_objects) | Indica se e come mostrare gli oggetti nella cartella di lavoro.|
| [sheet_tab_bar_width](/cells/it/python-net/aspose.cells/workbooksettings/sheet_tab_bar_width) | Larghezza della barra delle schede del foglio di lavoro (in 1/1000 della larghezza della finestra).|
| [show_tabs](/cells/it/python-net/aspose.cells/workbooksettings/show_tabs) |Ottenere o impostare un valore se vengono visualizzate le schede della cartella di lavoro.|
| [first_visible_tab](/cells/it/python-net/aspose.cells/workbooksettings/first_visible_tab) | Ottiene o imposta la prima scheda visibile del foglio di lavoro.|
| [is_h_scroll_bar_visible](/cells/it/python-net/aspose.cells/workbooksettings/is_h_scroll_bar_visible) | Ottiene o imposta un valore che indica se il foglio di calcolo generato conterrà una barra di scorrimento orizzontale.|
...
| [is_protected](/cells/it/python-net/aspose.cells/workbooksettings/is_protected) | Ottiene un valore che indica se la struttura o la finestra della cartella di lavoro è protetta.|
| [is_default_encrypted](/cells/it/python-net/aspose.cells/workbooksettings/is_default_encrypted) | Indica se crittografare la cartella di lavoro con la password predefinita se Struttura e Windows della cartella di lavoro sono bloccati.|
| [is_minimized](/cells/it/python-net/aspose.cells/workbooksettings/is_minimized) | Indica se il foglio di calcolo generato verrà aperto ridotto a icona.|
| [is_hidden](/cells/it/python-net/aspose.cells/workbooksettings/is_hidden) | Indica se questa cartella di lavoro è nascosta.|
| [auto_compress_pictures](/cells/it/python-net/aspose.cells/workbooksettings/auto_compress_pictures) | Specifica un valore booleano che indica che l'applicazione ha compresso automaticamente le immagini nella cartella di lavoro.|
| [remove_personal_information](/cells/it/python-net/aspose.cells/workbooksettings/remove_personal_information) | True se le informazioni personali possono essere rimosse dalla cartella di lavoro specificata.|
| [hide_pivot_field_list](/cells/it/python-net/aspose.cells/workbooksettings/hide_pivot_field_list) | Ottiene e imposta se nascondere l'elenco dei campi per la tabella pivot.|
| [update_links_type](/cells/it/python-net/aspose.cells/workbooksettings/update_links_type) | Ottiene e imposta la modalità di aggiornamento dei collegamenti esterni all'apertura della cartella di lavoro.|
| [max_row](/cells/it/python-net/aspose.cells/workbooksettings/max_row) | Ottiene l'indice di riga massimo, in base zero.|
| [max_column](/cells/it/python-net/aspose.cells/workbooksettings/max_column) | Ottiene l'indice di colonna massimo, in base zero.|
| [parsing_formula_on_open](/cells/it/python-net/aspose.cells/workbooksettings/parsing_formula_on_open) | Indica se analizzare la formula durante la lettura del file.|
| [window_left](/cells/it/python-net/aspose.cells/workbooksettings/window_left) | La distanza dal bordo sinistro dell'area client al bordo sinistro della finestra, in unità di punto.|
| [window_left_inch](/cells/it/python-net/aspose.cells/workbooksettings/window_left_inch) |La distanza dal bordo sinistro dell'area client al bordo sinistro della finestra.<br/> In unità di pollice.|
| [window_left_cm](/cells/it/python-net/aspose.cells/workbooksettings/window_left_cm) |La distanza dal bordo sinistro dell'area client al bordo sinistro della finestra.<br/> In unità di centimetri.|
...
| [window_height_inch](/cells/it/python-net/aspose.cells/workbooksettings/window_height_inch) | L'altezza della finestra, in unità di pollici.|
...
| [re_calculate_on_open](/cells/it/python-net/aspose.cells/workbooksettings/re_calculate_on_open) | Indica se ricalcolare tutte le formule all'apertura del file.|
| [create_calc_chain](/cells/it/python-net/aspose.cells/workbooksettings/create_calc_chain) | Indica se crea una catena di formule calcolate. L'impostazione predefinita è false.|
| [force_full_calculate](/cells/it/python-net/aspose.cells/workbooksettings/force_full_calculate) | Calcola completamente ogni volta che viene attivato un calcolo.|
| [iteration](/cells/it/python-net/aspose.cells/workbooksettings/iteration) | Indica se abilitare il calcolo iterativo per risolvere i riferimenti circolari.|
| [max_iteration](/cells/it/python-net/aspose.cells/workbooksettings/max_iteration) | Restituisce o imposta il numero massimo di iterazioni per risolvere un riferimento circolare.|
| [max_change](/cells/it/python-net/aspose.cells/workbooksettings/max_change) | Restituisce o imposta il numero massimo di modifiche per risolvere un riferimento circolare.|
| [calc_mode](/cells/it/python-net/aspose.cells/workbooksettings/calc_mode) | Specifica se calcolare le formule manualmente,<br/> automaticamente o automaticamente ad eccezione delle operazioni con più tabelle.|
| [calculation_id](/cells/it/python-net/aspose.cells/workbooksettings/calculation_id) |Specifica la versione del motore di calcolo utilizzato per calcolare i valori nella cartella di lavoro.|
| [calc_stack_size](/cells/it/python-net/aspose.cells/workbooksettings/calc_stack_size) | Specifica la dimensione dello stack per il calcolo delle celle in modo ricorsivo.<br/>Il valore elevato per questa dimensione darà prestazioni migliori quando ci sono molte celle che devono essere calcolate in modo ricorsivo.<br/>D'altra parte, un valore maggiore aumenterà il rischio di StackOverflowException.<br/> Se l'utente ottiene StackOverflowException durante il calcolo delle formule, questo valore deve essere ridotto.|
| [recalculate_before_save](/cells/it/python-net/aspose.cells/workbooksettings/recalculate_before_save) | Indica se ricalcolare prima di salvare il documento.|


###  Metodi
| Metodo| Descrizione|
| :- | :- |
| [get_theme_font(type)](/cells/it/python-net/aspose.cells/workbooksettings/get_theme_font/#FontSchemeType) | Ottiene il nome del carattere del tema predefinito.|
| [set_page_orientation_type(page_orientation_type)](/cells/it/python-net/aspose.cells/workbooksettings/set_page_orientation_type/#PageOrientationType) | Imposta il tipo di orientamento di stampa per l'intera cartella di lavoro.|
