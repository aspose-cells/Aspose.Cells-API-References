...
type: docs
weight: 930
url: /it/python-net/aspose.cells/individualfontconfigs/
is_root: false
---
##  classe IndividualFontConfigs
Configurazioni dei caratteri per ogni oggetto [Workbook](/cells/it/python-net/aspose.cells/workbook).



Il tipo IndividualFontConfigs espone i membri seguenti:
...
| [set_font_sources(sources)](/cells/it/python-net/aspose.cells/individualfontconfigs/set_font_sources/#list) | Imposta le origini dei caratteri.|
| [get_font_sources()](/cells/it/python-net/aspose.cells/individualfontconfigs/get_font_sources/#) | Ottiene una copia della matrice che contiene l'elenco delle origini|
