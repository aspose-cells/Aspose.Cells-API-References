---
title: OperatorType enumerazione
second_title: Aspose.Cells for Python via .NET API Referenze
description:
type: docs
weight: 2290
url: /it/python-net/aspose.cells/operatortype/
is_root: false
---
##  OperatorType enumerazione
Rappresenta il tipo di operatore del formato condizionale e la convalida dei dati.



Il tipo OperatorType espone i membri seguenti:
