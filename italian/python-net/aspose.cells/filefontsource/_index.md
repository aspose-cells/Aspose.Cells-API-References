...
type: docs
weight: 580
url: /it/python-net/aspose.cells/filefontsource/
is_root: false
---
...
**Eredità:** [FileFontSource](/cells/python-net/aspose.cells/filefontsource) → 
[FontSourceBase](/cells/it/python-net/aspose.cells/fontsourcebase)



Il tipo FileFontSource espone i membri seguenti:
...
###  Guarda anche
* modulo [aspose.cells](..)
* classe [FileFontSource](/cells/it/python-net/aspose.cells/filefontsource)
