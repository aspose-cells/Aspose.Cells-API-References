...
type: docs
weight: 360
url: /it/python-net/aspose.cells/htmlsaveoptions/export_worksheet_css_separately/
is_root: false
---
##  export_worksheet_css_separately proprietà

Indica se esportare il css del foglio di lavoro separatamente. Il valore predefinito è false.
###  Definizione:
```python
@property
