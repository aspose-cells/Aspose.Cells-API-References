...
| [export_formula](/cells/it/python-net/aspose.cells/htmlsaveoptions/export_formula) | Indica se esportare la formula durante il salvataggio del file in html. Il valore predefinito è true.<br/> Se desideri importare l'output html in Excel, mantieni il valore predefinito.|
