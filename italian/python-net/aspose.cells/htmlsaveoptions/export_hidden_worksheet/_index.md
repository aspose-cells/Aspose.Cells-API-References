...
type: docs
weight: 260
url: /it/python-net/aspose.cells/htmlsaveoptions/export_hidden_worksheet/
is_root: false
---
##  export_hidden_worksheet proprietà

Indica se esportare il contenuto nascosto del foglio di lavoro. Il valore predefinito è true.
###  Definizione:
```python
@property
