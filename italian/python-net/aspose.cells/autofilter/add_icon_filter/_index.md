...
type: docs
weight: 60
url: /it/python-net/aspose.cells/autofilter/add_icon_filter/
is_root: false
---
...
| icon_id | int | L'icona id.|
###  Osservazioni

Supporta solo l'aggiunta del filtro icona.
Non supporta il controllo di quale riga è visibile se il filtro è filtro icona.
