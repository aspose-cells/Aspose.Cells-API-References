...
| type | [FormatConditionType](/cells/it/python-net/aspose.cells/formatconditiontype) | Tipo di formattazione condizionale. Potrebbe essere uno dei membri di FormatConditionType.|
