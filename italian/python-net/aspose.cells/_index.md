...
type: docs
weight: 10
url: /it/python-net/aspose.cells/
is_root: false
---
 IL**Aspose.Cells** namespace fornisce classi fondamentali e di base per la generazione, la conversione, la modifica, il rendering e la stampa di fogli di calcolo senza utilizzare Microsoft Excel.
Ad esempio, la classe [Workbook](/cells/it/python-net/aspose.cells/workbook) è la voce principale per creare o caricare e quindi manipolare un file di foglio di calcolo,
[Cells](/cells/it/python-net/aspose.cells/cells) class è la classe principale per manipolare tutti i dati e le proprietà in un foglio, ... ecc.

###  Classi
| Classe| Descrizione|
| :- | :- |
| [AboveAverage](/cells/it/python-net/aspose.cells/aboveaverage) | Descrivi la regola di formattazione condizionale Sopra la media.<br/>Questa regola di formattazione condizionale evidenzia le celle che<br/> sono al di sopra o al di sotto della media per tutti i valori nell'intervallo.|
...
| [Border](/cells/it/python-net/aspose.cells/border) | Incapsula l'oggetto che rappresenta il bordo della cella.|
| [BorderCollection](/cells/it/python-net/aspose.cells/bordercollection) | Incapsula una raccolta di oggetti [Border](/cells/it/python-net/aspose.cells/border).|
| [CalculationCell](/cells/it/python-net/aspose.cells/calculationcell) | Rappresenta i dati rilevanti per il calcolo su una cella che viene calcolata.|
| [CalculationData](/cells/it/python-net/aspose.cells/calculationdata) | Rappresenta i dati richiesti durante il calcolo di una funzione, come il nome della funzione, i parametri, ...ecc.|
| [CalculationOptions](/cells/it/python-net/aspose.cells/calculationoptions) | Rappresenta le opzioni per il calcolo.|
| [Cell](/cells/it/python-net/aspose.cells/cell) | Incapsula l'oggetto che rappresenta una singola cella della cartella di lavoro.|
| [CellArea](/cells/it/python-net/aspose.cells/cellarea) | Rappresenta un'area di celle.|
| [CellWatch](/cells/it/python-net/aspose.cells/cellwatch) | Rappresenta Cell Watch Item nella 'finestra di controllo'.|
| [CellWatchCollection](/cells/it/python-net/aspose.cells/cellwatchcollection) | Rappresenta la raccolta di celle di questo foglio di lavoro che viene osservata nella "finestra di controllo".|
| [Cells](/cells/it/python-net/aspose.cells/cells) | Incapsula una raccolta di oggetti rilevanti per la cella, come [Cell](/cells/it/python-net/aspose.cells/cell), [Row](/cells/it/python-net/aspose.cells/row), ...ecc.|
| [CellsColor](/cells/it/python-net/aspose.cells/cellscolor) | Rappresenta tutti i tipi di colore.|
| [CellsDataTableFactory](/cells/it/python-net/aspose.cells/cellsdatatablefactory) |Utilità per creare ICellsDataTable da oggetti personalizzati per comodità dell'utente.|
| [CellsException](/cells/it/python-net/aspose.cells/cellsexception) | L'eccezione generata quando si verifica l'errore specificato Aspose.Cells.|
...
| [ConditionalFormattingIcon](/cells/it/python-net/aspose.cells/conditionalformattingicon) | Rappresenta l'icona personalizzata della regola di formattazione condizionale.|
...
| [DataSorterKeyCollection](/cells/it/python-net/aspose.cells/datasorterkeycollection) | Rappresenta l'elenco delle chiavi del selezionatore di dati.|
...
| [ErrorCheckOptionCollection](/cells/it/python-net/aspose.cells/errorcheckoptioncollection) | Rappresenta tutte le opzioni di controllo degli errori.|
...
| [FontConfigs](/cells/it/python-net/aspose.cells/fontconfigs) | Specifica le impostazioni dei caratteri|
| [FontSetting](/cells/it/python-net/aspose.cells/fontsetting) |Rappresenta un intervallo di caratteri all'interno del testo della cella.|
| [FontSourceBase](/cells/it/python-net/aspose.cells/fontsourcebase) | Questa è una classe base astratta per le classi che consentono all'utente di specificare varie fonti di font|
...
| [IStreamProvider](/cells/it/python-net/aspose.cells/istreamprovider) | Rappresenta il provider del flusso esportato.|
| [IWarningCallback](/cells/it/python-net/aspose.cells/iwarningcallback) | Interfaccia di richiamata di avviso.|
| [IconFilter](/cells/it/python-net/aspose.cells/iconfilter) | Rappresenta il filtro icona.|
| [IconSet](/cells/it/python-net/aspose.cells/iconset) | Descrivi la regola di formattazione condizionale di IconSet.<br/>Questa regola di formattazione condizionale applica le icone alle celle<br/> secondo i loro valori.|
| [ImageSaveOptions](/cells/it/python-net/aspose.cells/imagesaveoptions) | Rappresenta le opzioni di salvataggio dell'immagine.<br/> Per un utilizzo avanzato, utilizzare [WorkbookRender](/cells/it/python-net/aspose.cells.rendering/workbookrender) o [SheetRender](/cells/it/python-net/aspose.cells.rendering/sheetrender).|
| [ImportTableOptions](/cells/it/python-net/aspose.cells/importtableoptions) | Rappresenta le opzioni di importazione dei dati nelle celle.|
| [IndividualFontConfigs](/cells/it/python-net/aspose.cells/individualfontconfigs) | Configurazioni dei caratteri per ogni oggetto [Workbook](/cells/it/python-net/aspose.cells/workbook).|
| [InsertOptions](/cells/it/python-net/aspose.cells/insertoptions) | Rappresenta le opzioni di inserimento.|
| [InterruptMonitor](/cells/it/python-net/aspose.cells/interruptmonitor) | Rappresenta tutti gli operatori sull'interrupt.|
| [JsonLoadOptions](/cells/it/python-net/aspose.cells/jsonloadoptions) | Rappresenta le opzioni di caricamento dei file json|
| [JsonSaveOptions](/cells/it/python-net/aspose.cells/jsonsaveoptions) | Rappresenta le opzioni di salvataggio della cartella di lavoro come file json.|
| [License](/cells/it/python-net/aspose.cells/license) | Fornisce i metodi per concedere in licenza il componente.|
| [LightCellsDataHandler](/cells/it/python-net/aspose.cells/lightcellsdatahandler) | Rappresenta il gestore dati delle celle per la lettura di file di fogli di calcolo di grandi dimensioni in modalità leggera.|
| [LightCellsDataProvider](/cells/it/python-net/aspose.cells/lightcellsdataprovider) | Rappresenta il fornitore di dati per il salvataggio di file di fogli di calcolo di grandi dimensioni in modalità leggera.|
| [LoadFilter](/cells/it/python-net/aspose.cells/loadfilter) | Rappresenta il filtro che fornisce le opzioni per il caricamento dei dati durante il caricamento della cartella di lavoro dal modello.|
...
| [NegativeBarFormat](/cells/it/python-net/aspose.cells/negativebarformat) | Rappresenta le impostazioni del colore delle barre dei dati per i valori negativi definiti da una regola di formattazione condizionale della barra dei dati.|
| [OdsLoadOptions](/cells/it/python-net/aspose.cells/odsloadoptions) | Rappresenta le opzioni di caricamento del file ods.|
| [OdsSaveOptions](/cells/it/python-net/aspose.cells/odssaveoptions) | Rappresenta le opzioni di salvataggio del file ods.|
| [OoxmlSaveOptions](/cells/it/python-net/aspose.cells/ooxmlsaveoptions) | Rappresenta le opzioni di salvataggio del file xml aperto in ufficio.|
| [Outline](/cells/it/python-net/aspose.cells/outline) | Rappresenta una struttura in un foglio di lavoro.|
| [PageSetup](/cells/it/python-net/aspose.cells/pagesetup) | Incapsula l'oggetto che rappresenta la descrizione della configurazione della pagina.<br/> L'oggetto PageSetup contiene tutte le opzioni di impostazione della pagina.|
...
| [Protection](/cells/it/python-net/aspose.cells/protection) | Rappresenta i vari tipi di opzioni di protezione disponibili per un foglio di lavoro.|
| [QueryTable](/cells/it/python-net/aspose.cells/querytable) | Rappresenta le informazioni di QueryTable.|
| [QueryTableCollection](/cells/it/python-net/aspose.cells/querytablecollection) | Raccolta di oggetti [QueryTableCollection](/cells/it/python-net/aspose.cells/querytablecollection) che rappresentano le informazioni sulla raccolta QueryTable.|
| [Range](/cells/it/python-net/aspose.cells/range) | Incapsula l'oggetto che rappresenta un intervallo di celle all'interno di un foglio di calcolo.|
| [RangeCollection](/cells/it/python-net/aspose.cells/rangecollection) | Incapsula una raccolta di oggetti [Range](/cells/it/python-net/aspose.cells/range).|
| [ReferredArea](/cells/it/python-net/aspose.cells/referredarea) | Rappresenta un'area indicata dalla formula.|
| [ReferredAreaCollection](/cells/it/python-net/aspose.cells/referredareacollection) | Rappresenta tutte le celle e le aree di riferimento.|
| [ReplaceOptions](/cells/it/python-net/aspose.cells/replaceoptions) | Rappresenta le opzioni di sostituzione.|
| [Row](/cells/it/python-net/aspose.cells/row) | Rappresenta una singola riga in un foglio di lavoro.|
| [RowCollection](/cells/it/python-net/aspose.cells/rowcollection) | Raccoglie gli oggetti [Row](/cells/it/python-net/aspose.cells/row) che rappresentano le singole righe in un foglio di lavoro.|
| [SaveOptions](/cells/it/python-net/aspose.cells/saveoptions) | Rappresenta tutte le opzioni di salvataggio|
| [Scenario](/cells/it/python-net/aspose.cells/scenario) | Rappresenta uno scenario individuale.|
...
| [SubtotalSetting](/cells/it/python-net/aspose.cells/subtotalsetting) | Rappresenta l'impostazione del subtotale.|
| [SvgSaveOptions](/cells/it/python-net/aspose.cells/svgsaveoptions) | Rappresenta le opzioni di salvataggio Svg.<br/> Per un utilizzo avanzato, utilizzare [WorkbookRender](/cells/it/python-net/aspose.cells.rendering/workbookrender) o [SheetRender](/cells/it/python-net/aspose.cells.rendering/sheetrender).|
...
| [Workbook](/cells/it/python-net/aspose.cells/workbook) | Rappresenta un oggetto radice per creare un foglio di calcolo Excel.|
| [WorkbookDesigner](/cells/it/python-net/aspose.cells/workbookdesigner) | Incapsula l'oggetto che rappresenta un foglio di lavoro di progettazione.|
| [WorkbookSettings](/cells/it/python-net/aspose.cells/workbooksettings) | Rappresenta tutte le impostazioni della cartella di lavoro.|
| [Worksheet](/cells/it/python-net/aspose.cells/worksheet) | Incapsula l'oggetto che rappresenta un singolo foglio di lavoro.|
...
| [XmlMap](/cells/it/python-net/aspose.cells/xmlmap) | Rappresenta le informazioni sulla mappa XML.|
| [XmlMapCollection](/cells/it/python-net/aspose.cells/xmlmapcollection) | Raccolta di oggetti [XmlMap](/cells/it/python-net/aspose.cells/xmlmap) che rappresentano informazioni XmlMap.|
| [XmlSaveOptions](/cells/it/python-net/aspose.cells/xmlsaveoptions) | Rappresenta le opzioni di salvataggio della cartella di lavoro come file xml.|
| [XpsSaveOptions](/cells/it/python-net/aspose.cells/xpssaveoptions) | Rappresenta le opzioni aggiuntive durante il salvataggio del file come Xps.|
...
| [BackgroundType](/cells/it/python-net/aspose.cells/backgroundtype) | Enumera i tipi di pattern di sfondo delle celle.|
...
| [ColorType](/cells/it/python-net/aspose.cells/colortype) | Rappresenta tutti i tipi di colore|
| [ConsolidationFunction](/cells/it/python-net/aspose.cells/consolidationfunction) | Rappresenta la funzione di consolidamento.|
| [CopyFormatType](/cells/it/python-net/aspose.cells/copyformattype) | Rappresenta il tipo di formato di copia quando si inseriscono le righe.|
| [CountryCode](/cells/it/python-net/aspose.cells/countrycode) | Rappresenta gli identificatori di paese di Excel.|
| [DataBarAxisPosition](/cells/it/python-net/aspose.cells/databaraxisposition) |Specifica la posizione dell'asse per un intervallo di celle con formattazione condizionale come barre dei dati.|
| [DataBarBorderType](/cells/it/python-net/aspose.cells/databarbordertype) | Specifica il tipo di bordo di una barra dei dati.|
| [DataBarFillType](/cells/it/python-net/aspose.cells/databarfilltype) | Specifica in che modo una barra dei dati viene riempita di colore.|
| [DataBarNegativeColorType](/cells/it/python-net/aspose.cells/databarnegativecolortype) | Specifica se utilizzare lo stesso bordo e lo stesso colore di riempimento delle barre dei dati positivi.|
| [DateTimeGroupingType](/cells/it/python-net/aspose.cells/datetimegroupingtype) | Specifica come raggruppare i valori dateTime.|
| [DefaultEditLanguage](/cells/it/python-net/aspose.cells/defaulteditlanguage) | Rappresenta la lingua di modifica predefinita.|
| [DirectoryType](/cells/it/python-net/aspose.cells/directorytype) | Rappresenta il tipo di directory del nome file.|
| [DisplayDrawingObjects](/cells/it/python-net/aspose.cells/displaydrawingobjects) | Rappresenta se e come mostrare gli oggetti nella cartella di lavoro.|
| [DynamicFilterType](/cells/it/python-net/aspose.cells/dynamicfiltertype) | Tipo di filtro dinamico.|
| [EmfRenderSetting](/cells/it/python-net/aspose.cells/emfrendersetting) | Impostazione per il rendering del metafile EMF.|
| [EncryptionType](/cells/it/python-net/aspose.cells/encryptiontype) | Tipo di crittografia.<br/>Utilizzato solo da excel2003.<br/> Crittograferemo la cartella di lavoro 2007/2010 utilizzando SHA AES come fa Excel e questo EncryptionType verrà ignorato.|
| [ErrorCheckType](/cells/it/python-net/aspose.cells/errorchecktype) | Rappresenta tutti i tipi di controllo degli errori.|
| [ExceptionType](/cells/it/python-net/aspose.cells/exceptiontype) | Rappresenta il codice del tipo di eccezione personalizzato.|
| [ExternalLinkType](/cells/it/python-net/aspose.cells/externallinktype) | Rappresenta il tipo di collegamento esterno.|
...
| [IconSetType](/cells/it/python-net/aspose.cells/iconsettype) | Tipo di set di icone per la formattazione condizionale.<br/>I valori di soglia per l'attivazione delle diverse icone all'interno di un set sono<br/> configurabile e l'ordine delle icone è reversibile.|
| [LoadDataFilterOptions](/cells/it/python-net/aspose.cells/loaddatafilteroptions) | Rappresenta le opzioni per filtrare i dati durante il caricamento della cartella di lavoro dal modello.|
| [LoadFormat](/cells/it/python-net/aspose.cells/loadformat) | Rappresenta il formato del file di caricamento.|
| [LookAtType](/cells/it/python-net/aspose.cells/lookattype) | Rappresenta guardare il tipo.|
| [LookInType](/cells/it/python-net/aspose.cells/lookintype) | Rappresenta l'aspetto nel tipo.|
| [MemorySetting](/cells/it/python-net/aspose.cells/memorysetting) | Opzioni di utilizzo della memoria.|
| [NameScopeType](/cells/it/python-net/aspose.cells/namescopetype) | Rappresenta il tipo di ambito dei nomi definiti.|
| [NumberCategoryType](/cells/it/python-net/aspose.cells/numbercategorytype) | Rappresenta il tipo di categoria della formattazione del numero della cella.|
| [OoxmlCompliance](/cells/it/python-net/aspose.cells/ooxmlcompliance) |Consente di specificare quale specifica OOXML verrà utilizzata durante il salvataggio nel formato Xlsx.|
| [OoxmlCompressionType](/cells/it/python-net/aspose.cells/ooxmlcompressiontype) | Il tipo di compressione Ooxml|
| [OperatorType](/cells/it/python-net/aspose.cells/operatortype) | Rappresenta il tipo di operatore del formato condizionale e la convalida dei dati.|
| [PageLayoutAlignmentType](/cells/it/python-net/aspose.cells/pagelayoutalignmenttype) | Enumera i tipi di allineamento del layout di pagina.|
| [PageOrientationType](/cells/it/python-net/aspose.cells/pageorientationtype) | Rappresenta le costanti di orientamento della stampa.|
| [PaneStateType](/cells/it/python-net/aspose.cells/panestatetype) | Rappresenta lo stato del riquadro del foglio.|
| [PaperSizeType](/cells/it/python-net/aspose.cells/papersizetype) | Rappresenta le costanti del formato carta.|
| [ParameterType](/cells/it/python-net/aspose.cells/parametertype) | Rappresenta il tipo di tutti i parametri o il tipo di valore restituito della funzione.|
...
| [ProtectionType](/cells/it/python-net/aspose.cells/protectiontype) | Rappresenta il tipo di protezione della cartella di lavoro/foglio di lavoro.|
| [RenameStrategy](/cells/it/python-net/aspose.cells/renamestrategy) | Opzione strategica per i nomi duplicati delle colonne.|
| [ResourceLoadingType](/cells/it/python-net/aspose.cells/resourceloadingtype) | Rappresenta come caricare la risorsa collegata.|
| [SaveFormat](/cells/it/python-net/aspose.cells/saveformat) | Rappresenta il formato in cui viene salvata la cartella di lavoro.|
| [SheetType](/cells/it/python-net/aspose.cells/sheettype) | Specifica il tipo di foglio di lavoro.|
| [ShiftType](/cells/it/python-net/aspose.cells/shifttype) |Rappresenta le opzioni di spostamento durante l'eliminazione di un intervallo di celle.|
| [SortOnType](/cells/it/python-net/aspose.cells/sortontype) | Tipo di valore ordinato.|
| [SortOrder](/cells/it/python-net/aspose.cells/sortorder) | Rappresenta l'ordinamento per l'intervallo di dati.|
| [StyleModifyFlag](/cells/it/python-net/aspose.cells/stylemodifyflag) | Lo stile ha modificato le bandiere.|
| [TargetModeType](/cells/it/python-net/aspose.cells/targetmodetype) | Rappresenta il tipo di modalità di destinazione.|
| [TextAlignmentType](/cells/it/python-net/aspose.cells/textalignmenttype) | Enumera i tipi di allineamento del testo.|
| [TextCapsType](/cells/it/python-net/aspose.cells/textcapstype) | Questo tipo specifica i tipi di maiuscole del testo.|
| [TextCrossType](/cells/it/python-net/aspose.cells/textcrosstype) | Enumera la visualizzazione del tipo di testo quando la larghezza del testo è maggiore della larghezza della cella.|
| [TextDirectionType](/cells/it/python-net/aspose.cells/textdirectiontype) | Rappresenta la direzione del flusso di testo per questo paragrafo.|
| [TextOrientationType](/cells/it/python-net/aspose.cells/textorientationtype) | Enumera i tipi di orientamento del testo.|
| [TextStrikeType](/cells/it/python-net/aspose.cells/textstriketype) | Questo tipo specifica il tipo di sciopero.|
| [ThemeColorType](/cells/it/python-net/aspose.cells/themecolortype) | Enumera i tipi di colore del tema.|
| [TimePeriodType](/cells/it/python-net/aspose.cells/timeperiodtype) | Utilizzato in una regola di formattazione condizionale FormatConditionType.TimePeriod.<br/>Questi sono periodi di tempo dinamici, che cambiano in base a<br/> la data in cui la formattazione condizionale viene aggiornata/applicata.|
| [TxtLoadStyleStrategy](/cells/it/python-net/aspose.cells/txtloadstylestrategy) | Specifica come applicare lo stile per i valori analizzati durante la conversione del valore stringa in numero o data/ora.|
| [TxtValueQuoteType](/cells/it/python-net/aspose.cells/txtvaluequotetype) | Specifica il tipo di utilizzo delle virgolette per i valori nei file in formato testo.|
| [UpdateLinksType](/cells/it/python-net/aspose.cells/updatelinkstype) |Rappresenta come aggiornare i collegamenti ad altre cartelle di lavoro quando la cartella di lavoro viene aperta.|
| [ValidationAlertType](/cells/it/python-net/aspose.cells/validationalerttype) | Rappresenta lo stile di avviso di convalida dei dati.|
| [ValidationType](/cells/it/python-net/aspose.cells/validationtype) | Rappresenta il tipo di convalida dei dati.|
| [ViewType](/cells/it/python-net/aspose.cells/viewtype) | Rappresenta il tipo di visualizzazione del foglio di lavoro.|
| [VisibilityType](/cells/it/python-net/aspose.cells/visibilitytype) | Rappresenta gli stati per la visibilità del foglio.|
| [WarningType](/cells/it/python-net/aspose.cells/warningtype) | WaringType|
