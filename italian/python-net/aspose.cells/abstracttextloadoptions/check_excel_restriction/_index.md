...
type: docs
weight: 70
url: /it/python-net/aspose.cells/abstracttextloadoptions/check_excel_restriction/
is_root: false
---
...
non dovresti salvare la cartella di lavoro come formato di file excel in un secondo momento.
###  Definizione:
```python
@property
