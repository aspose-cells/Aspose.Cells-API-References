...
type: docs
weight: 1120
url: /it/python-net/aspose.cells/ooxmlsaveoptions/
is_root: false
---
##  classe OoxmlSaveOptions
Rappresenta le opzioni di salvataggio del file xml aperto in ufficio.
...
Il tipo OoxmlSaveOptions espone i membri seguenti:

###  Costruttori
| Costruttore| Descrizione|
| :- | :- |
| [OoxmlSaveOptions()](/cells/it/python-net/aspose.cells/ooxmlsaveoptions/__init__/#) | Crea le opzioni per il salvataggio del file xml aperto in ufficio.|
| [OoxmlSaveOptions(save_format)](/cells/it/python-net/aspose.cells/ooxmlsaveoptions/__init__/#SaveFormat) | Crea le opzioni per il salvataggio del file xml aperto in ufficio.|


###  Proprietà
| Proprietà| Descrizione|
| :- | :- |
| [save_format](/cells/it/python-net/aspose.cells/ooxmlsaveoptions/save_format) | Ottiene il formato del file di salvataggio.|
| [clear_data](/cells/it/python-net/aspose.cells/ooxmlsaveoptions/clear_data) | Rendi vuota la cartella di lavoro dopo aver salvato il file.|
| [cached_file_folder](/cells/it/python-net/aspose.cells/ooxmlsaveoptions/cached_file_folder) | La cartella dei file memorizzati nella cache viene utilizzata per archiviare alcuni dati di grandi dimensioni.|
| [validate_merged_areas](/cells/it/python-net/aspose.cells/ooxmlsaveoptions/validate_merged_areas) | Indica se convalidare le celle unite prima di salvare il file.|
...
###  Guarda anche
* modulo [aspose.cells](..)
* classe [OoxmlSaveOptions](/cells/it/python-net/aspose.cells/ooxmlsaveoptions)
