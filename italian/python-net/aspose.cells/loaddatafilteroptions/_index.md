...
type: docs
weight: 2200
url: /it/python-net/aspose.cells/loaddatafilteroptions/
is_root: false
---
##  LoadDataFilterOptions enumerazione
Rappresenta le opzioni per filtrare i dati durante il caricamento della cartella di lavoro dal modello.



Il tipo LoadDataFilterOptions espone i membri seguenti:

###  Campi
| Campo| Descrizione|
| :- | :- |
| NONE | Non caricare nulla per i dati del foglio|
| ALL | Carica tutto|
| CELL_BLANK | Carica le celle il cui valore è vuoto|
| CELL_STRING | Carica le celle il cui valore è stringa|
| CELL_NUMERIC | Carica celle il cui valore è numerico (incluso datetime)|
| CELL_ERROR | Celle di carico il cui valore è errore|
| CELL_BOOL | Carica celle il cui valore è bool|
| CELL_VALUE | Carica solo il valore delle celle (tutti i tipi di valore).|
| FORMULA | Formule della cella di carico.|
...
| OLE_OBJECT | Carica OleObjects|
| REVISION | Carica i registri di revisione|
