...
type: docs
weight: 2010
url: /it/python-net/aspose.cells/errorchecktype/
is_root: false
---
##  ErrorCheckType enumerazione
Rappresenta tutti i tipi di controllo degli errori.



Il tipo ErrorCheckType espone i membri seguenti:

###  Campi
| Campo| Descrizione|
| :- | :- |
| CALC | verificare la presenza di errori di calcolo|
...
| CALCULATED_COLUMN | Ignora gli errori quando le celle contengono un valore diverso da una formula di colonna calcolata.|
