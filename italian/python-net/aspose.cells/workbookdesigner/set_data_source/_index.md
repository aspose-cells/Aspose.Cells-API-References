---
title: metodo set_data_source
second_title: Aspose.Cells for Python via .NET API Referenze
description:
type: docs
weight: 50
url: /it/python-net/aspose.cells/workbookdesigner/set_data_source/
is_root: false
---
##  set_data_source(data_source, cells_data_table) {#str-ICellsDataTable}
Imposta l'origine dati di un oggetto [ICellsDataTable](/cells/it/python-net/aspose.cells/icellsdatatable).
...
Imposta l'associazione dati a una variabile.
