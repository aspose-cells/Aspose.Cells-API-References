...
type: docs
weight: 1110
url: /it/python-net/aspose.cells/odssaveoptions/
is_root: false
---
##  classe OdsSaveOptions
Rappresenta le opzioni di salvataggio del file ods.



**Eredità:** [OdsSaveOptions](/cells/python-net/aspose.cells/odssaveoptions) → 
[SaveOptions](/cells/it/python-net/aspose.cells/saveoptions)



Il tipo OdsSaveOptions espone i membri seguenti:

###  Costruttori
| Costruttore| Descrizione|
| :- | :- |
| [OdsSaveOptions()](/cells/it/python-net/aspose.cells/odssaveoptions/__init__/#) | Crea le opzioni di salvataggio del file ods.|
| [OdsSaveOptions(save_format)](/cells/it/python-net/aspose.cells/odssaveoptions/__init__/#SaveFormat) | Crea le opzioni di salvataggio del file ods.|


###  Proprietà
| Proprietà| Descrizione|
| :- | :- |
| [save_format](/cells/it/python-net/aspose.cells/odssaveoptions/save_format) | Ottiene il formato del file di salvataggio.|
| [clear_data](/cells/it/python-net/aspose.cells/odssaveoptions/clear_data) | Rendi vuota la cartella di lavoro dopo aver salvato il file.|
| [cached_file_folder](/cells/it/python-net/aspose.cells/odssaveoptions/cached_file_folder) | La cartella dei file memorizzati nella cache viene utilizzata per archiviare alcuni dati di grandi dimensioni.|
| [validate_merged_areas](/cells/it/python-net/aspose.cells/odssaveoptions/validate_merged_areas) | Indica se convalidare le celle unite prima di salvare il file.|
...
###  Guarda anche
* modulo [aspose.cells](..)
* classe [OdsSaveOptions](/cells/it/python-net/aspose.cells/odssaveoptions)
