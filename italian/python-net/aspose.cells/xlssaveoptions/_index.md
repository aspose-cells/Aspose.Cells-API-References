---
title: classe XlsSaveOptions
second_title: Aspose.Cells for Python via .NET API Referenze
description:
type: docs
weight: 1650
url: /it/python-net/aspose.cells/xlssaveoptions/
is_root: false
---
##  classe XlsSaveOptions
Rappresenta le opzioni di salvataggio per il formato di file Excel 97-2003: xls e xlt.



**Eredità:** [XlsSaveOptions](/cells/python-net/aspose.cells/xlssaveoptions) → 
[SaveOptions](/cells/it/python-net/aspose.cells/saveoptions)



Il tipo XlsSaveOptions espone i membri seguenti:
...
| :- | :- |
| [save_format](/cells/it/python-net/aspose.cells/xlssaveoptions/save_format) | Ottiene il formato del file di salvataggio.|
| [clear_data](/cells/it/python-net/aspose.cells/xlssaveoptions/clear_data) | Rendi vuota la cartella di lavoro dopo aver salvato il file.|
| [cached_file_folder](/cells/it/python-net/aspose.cells/xlssaveoptions/cached_file_folder) | La cartella dei file memorizzati nella cache viene utilizzata per archiviare alcuni dati di grandi dimensioni.|
| [validate_merged_areas](/cells/it/python-net/aspose.cells/xlssaveoptions/validate_merged_areas) | Indica se convalidare le celle unite prima di salvare il file.|
...
* classe [XlsSaveOptions](/cells/it/python-net/aspose.cells/xlssaveoptions)
