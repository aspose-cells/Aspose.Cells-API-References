...
type: docs
weight: 30
url: /it/python-net/aspose.cells/column/get_style/
is_root: false
---
##  get_style() {#}
...
Devi chiamare il metodo [Column.apply_style(style, flag)](/cells/it/python-net/aspose.cells/column/apply_style) o [Column.set_style(style)](/cells/it/python-net/aspose.cells/column/set_style)
