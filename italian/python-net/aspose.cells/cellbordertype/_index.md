...
type: docs
weight: 1830
url: /it/python-net/aspose.cells/cellbordertype/
is_root: false
---
##  CellBorderType enumerazione
Enumera il tipo di bordo di una cella.



Il tipo CellBorderType espone i membri seguenti:
...
| MEDIUM_DASH_DOT_DOT | Rappresenta la linea tratteggiata-punto-punteggiata media.|
...
| THICK | Rappresenta la linea spessa.|
