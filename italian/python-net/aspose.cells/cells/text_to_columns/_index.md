...
type: docs
weight: 930
url: /it/python-net/aspose.cells/cells/text_to_columns/
is_root: false
---
##  text_to_columns(row, column, total_rows, options) {#int-int-int-TxtLoadOptions}
Divide il testo nelle colonne in colonne.
...
| options | [TxtLoadOptions](/cells/it/python-net/aspose.cells/txtloadoptions) | Le opzioni divise.|
