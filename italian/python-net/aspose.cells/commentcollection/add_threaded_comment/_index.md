---
title: metodo add_threaded_comment
second_title: Aspose.Cells for Python via .NET API Referenze
description:
type: docs
weight: 30
url: /it/python-net/aspose.cells/commentcollection/add_threaded_comment/
is_root: false
---
...
[ThreadedComment](/cells/it/python-net/aspose.cells/threadedcomment) indice oggetto.
...
| author | [ThreadedCommentAuthor](/cells/it/python-net/aspose.cells/threadedcommentauthor) | L'utente di questo commento in thread.|
...
* classe [ThreadedComment](/cells/it/python-net/aspose.cells/threadedcomment)
