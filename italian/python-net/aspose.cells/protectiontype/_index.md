---
title: ProtectionType enumerazione
second_title: Aspose.Cells for Python via .NET API Referenze
description:
type: docs
weight: 2420
url: /it/python-net/aspose.cells/protectiontype/
is_root: false
---
##  ProtectionType enumerazione
Rappresenta il tipo di protezione della cartella di lavoro/foglio di lavoro.



Il tipo ProtectionType espone i membri seguenti:

###  Campi
| Campo| Descrizione|
| :- | :- |
| ALL | Rappresenta per proteggere tutti.|
