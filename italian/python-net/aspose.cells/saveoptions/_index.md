...
type: docs
weight: 1320
url: /it/python-net/aspose.cells/saveoptions/
is_root: false
---
##  classe SaveOptions
...
Il tipo SaveOptions espone i membri seguenti:

###  Proprietà
| Proprietà| Descrizione|
| :- | :- |
| [save_format](/cells/it/python-net/aspose.cells/saveoptions/save_format) | Ottiene il formato del file di salvataggio.|
| [clear_data](/cells/it/python-net/aspose.cells/saveoptions/clear_data) | Rendi vuota la cartella di lavoro dopo aver salvato il file.|
| [cached_file_folder](/cells/it/python-net/aspose.cells/saveoptions/cached_file_folder) | La cartella dei file memorizzati nella cache viene utilizzata per archiviare alcuni dati di grandi dimensioni.|
| [validate_merged_areas](/cells/it/python-net/aspose.cells/saveoptions/validate_merged_areas) | Indica se convalidare le celle unite prima di salvare il file.|
