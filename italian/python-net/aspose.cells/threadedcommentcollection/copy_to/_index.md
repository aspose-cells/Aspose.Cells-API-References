...
type: docs
weight: 40
url: /it/python-net/aspose.cells/threadedcommentcollection/copy_to/
is_root: false
---
##  copy_to(array) {#list}
...
###  Guarda anche
* modulo [aspose.cells](../../)
* classe [ThreadedCommentCollection](/cells/it/python-net/aspose.cells/threadedcommentcollection)
