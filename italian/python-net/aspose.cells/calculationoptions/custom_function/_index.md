---
title: custom_function proprietà
second_title: Aspose.Cells for Python via .NET API Referenze
description:
type: docs
weight: 60
url: /it/python-net/aspose.cells/calculationoptions/custom_function/
is_root: false
---
##  custom_function proprietà

Il calcolo della formula personalizzata funziona per estendere il motore di calcolo.
...
* classe [ICustomFunction](/cells/it/python-net/aspose.cells/icustomfunction)
