...
type: docs
weight: 970
url: /it/python-net/aspose.cells/jsonsaveoptions/
is_root: false
---
##  classe JsonSaveOptions
Rappresenta le opzioni di salvataggio della cartella di lavoro come file json.



**Eredità:** [JsonSaveOptions](/cells/python-net/aspose.cells/jsonsaveoptions) → 
[SaveOptions](/cells/it/python-net/aspose.cells/saveoptions)



Il tipo JsonSaveOptions espone i membri seguenti:
...
| :- | :- |
| [save_format](/cells/it/python-net/aspose.cells/jsonsaveoptions/save_format) | Ottiene il formato del file di salvataggio.|
| [clear_data](/cells/it/python-net/aspose.cells/jsonsaveoptions/clear_data) | Rendi vuota la cartella di lavoro dopo aver salvato il file.|
| [cached_file_folder](/cells/it/python-net/aspose.cells/jsonsaveoptions/cached_file_folder) | La cartella dei file memorizzati nella cache viene utilizzata per archiviare alcuni dati di grandi dimensioni.|
| [validate_merged_areas](/cells/it/python-net/aspose.cells/jsonsaveoptions/validate_merged_areas) | Indica se convalidare le celle unite prima di salvare il file.|
...
| [sheet_indexes](/cells/it/python-net/aspose.cells/jsonsaveoptions/sheet_indexes) | Rappresenta gli indici dei fogli esportati.|
...
###  Guarda anche
* modulo [aspose.cells](..)
* classe [JsonSaveOptions](/cells/it/python-net/aspose.cells/jsonsaveoptions)
