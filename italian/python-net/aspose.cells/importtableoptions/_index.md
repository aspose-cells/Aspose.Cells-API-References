---
title: classe ImportTableOptions
second_title: Aspose.Cells for Python via .NET API Referenze
description:
type: docs
weight: 920
url: /it/python-net/aspose.cells/importtableoptions/
is_root: false
---
##  classe ImportTableOptions
Rappresenta le opzioni di importazione dei dati nelle celle.



Il tipo ImportTableOptions espone i membri seguenti:
...
| :- | :- |
| [convert_grid_style](/cells/it/python-net/aspose.cells/importtableoptions/convert_grid_style) | Indica se applicare lo stile della vista griglia alle celle.|
| [convert_numeric_data](/cells/it/python-net/aspose.cells/importtableoptions/convert_numeric_data) | Ottiene o imposta un valore che indica se il valore stringa deve essere convertito in un valore numerico o data.|
| [insert_rows](/cells/it/python-net/aspose.cells/importtableoptions/insert_rows) | Indica se devono essere aggiunte nuove righe per l'importazione dei record di dati.|
| [shift_first_row_down](/cells/it/python-net/aspose.cells/importtableoptions/shift_first_row_down) | Indica se spostare la prima riga verso il basso durante l'inserimento di righe.|
| [is_field_name_shown](/cells/it/python-net/aspose.cells/importtableoptions/is_field_name_shown) |Indica se il nome del campo deve essere importato.|
| [export_caption_as_field_name](/cells/it/python-net/aspose.cells/importtableoptions/export_caption_as_field_name) | Indica se esportare la didascalia come nome campo|
...
| [check_merged_cells](/cells/it/python-net/aspose.cells/importtableoptions/check_merged_cells) | Indica se controllare le celle unite.|
