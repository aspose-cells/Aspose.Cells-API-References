...
type: docs
weight: 300
url: /it/python-net/aspose.cells/worksheet/unprotect/
is_root: false
---
##  unprotect() {#}
...
Se il foglio di lavoro è protetto senza password, è possibile impostare un valore nullo o una stringa vuota nel parametro password.
