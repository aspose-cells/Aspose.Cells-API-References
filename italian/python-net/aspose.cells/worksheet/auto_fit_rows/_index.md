...
type: docs
weight: 70
url: /it/python-net/aspose.cells/worksheet/auto_fit_rows/
is_root: false
---
##  auto_fit_rows() {#}
...
| start_row | int | Inizia l'indice della riga.|
| end_row | int | Indice di fine riga.|
| options | [AutoFitterOptions](/cells/it/python-net/aspose.cells/autofitteroptions) | Le opzioni dell'installatore automatico.|
