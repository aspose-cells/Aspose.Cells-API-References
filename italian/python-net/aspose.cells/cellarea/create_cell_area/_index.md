---
title: metodo create_cell_area
second_title: Aspose.Cells for Python via .NET API Referenze
description:
type: docs
weight: 30
url: /it/python-net/aspose.cells/cellarea/create_cell_area/
is_root: false
---
...
Restituisci un [CellArea](/cells/it/python-net/aspose.cells/cellarea).
...
| end_row | int | L'ultima fila.|
| end_column | int | La colonna finale.|
