---
title: classe ProtectedRange
second_title: Aspose.Cells for Python via .NET API Referenze
description:
type: docs
weight: 1200
url: /it/python-net/aspose.cells/protectedrange/
is_root: false
---
##  classe ProtectedRange
Un intervallo specificato che può essere modificato quando la protezione del foglio è attiva.



Il tipo ProtectedRange espone i membri seguenti:
...
| Metodo| Descrizione|
| :- | :- |
| [get_areas()](/cells/it/python-net/aspose.cells/protectedrange/get_areas/#) | Ottiene tutte le aree di riferimento.|
| [add_area(start_row, start_column, end_row, end_column)](/cells/it/python-net/aspose.cells/protectedrange/add_area/#int-int-int-int) | Aggiunge un'area di riferimento a questo|
