...
type: docs
weight: 1030
url: /it/python-net/aspose.cells/markdownsaveoptions/
is_root: false
---
##  classe MarkdownSaveOptions
Rappresenta le opzioni di salvataggio per markdown.



**Eredità:** [MarkdownSaveOptions](/cells/python-net/aspose.cells/markdownsaveoptions) → 
[SaveOptions](/cells/it/python-net/aspose.cells/saveoptions)



Il tipo MarkdownSaveOptions espone i membri seguenti:
...
| :- | :- |
| [save_format](/cells/it/python-net/aspose.cells/markdownsaveoptions/save_format) | Ottiene il formato del file di salvataggio.|
| [clear_data](/cells/it/python-net/aspose.cells/markdownsaveoptions/clear_data) | Rendi vuota la cartella di lavoro dopo aver salvato il file.|
| [cached_file_folder](/cells/it/python-net/aspose.cells/markdownsaveoptions/cached_file_folder) | La cartella dei file memorizzati nella cache viene utilizzata per archiviare alcuni dati di grandi dimensioni.|
| [validate_merged_areas](/cells/it/python-net/aspose.cells/markdownsaveoptions/validate_merged_areas) | Indica se convalidare le celle unite prima di salvare il file.|
...
###  Guarda anche
* modulo [aspose.cells](..)
* classe [MarkdownSaveOptions](/cells/it/python-net/aspose.cells/markdownsaveoptions)
