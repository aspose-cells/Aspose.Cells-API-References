...
type: docs
weight: 20
url: /it/python-net/aspose.cells.properties/customdocumentpropertycollection/add/
is_root: false
---
...
##  add(name, value) {#str-int}
 Crea una nuova proprietà del documento personalizzata di**TipoProprietà.Numero** tipo di dati.
