---
title: Aspose::Cells::LowCode::LowCodeSaveOptions::SetSaveFormat method
linktitle: SetSaveFormat
second_title: Aspose.Cells for C++ API Reference
description: 'Aspose::Cells::LowCode::LowCodeSaveOptions::SetSaveFormat method. Gets and sets the save format for the output. Generally, for specific process in low code way, only some specific formats are allowed. Please specify the correct format for corresponding process, otherwise unexpected result or even exception may be caused in C++.'
type: docs
weight: 1100
url: /it/cpp/aspose.cells.lowcode/lowcodesaveoptions/setsaveformat/
---
## LowCodeSaveOptions::SetSaveFormat method
...
```cpp
void Aspose::Cells::LowCode::LowCodeSaveOptions::SetSaveFormat(SaveFormat value)
```
