---
title: Aspose::Cells::Drawing::OleObject class
linktitle: OleObject
second_title: Aspose.Cells for C++ API Reference
description: 'Aspose::Cells::Drawing::OleObject class. Represents an OleObject in a worksheet in C++.'
type: docs
weight: 3900
url: /it/cpp/aspose.cells.drawing/oleobject/
---
## OleObject class
...
//Ottieni i dati dell'immagine in "iconData". es.: un file .jpg chiamato "school.jpg"
//(Nota: è necessario leggere i dati in questa variabile.)
Vector<uint8_t> iconData{0};

//Ottieni i dati dell'oggetto ole in "objectData". es.: un file .xls chiamato "Book1.xls"
//(Nota: è necessario leggere i dati in questa variabile.)
Vector<uint8_t> objectData{0};

//Aggiungi un oggetto Ole nel foglio di lavoro con l'immagine
//mostrata in MS Excel.
