...
type: docs
weight: 800
url: /it/cpp/aspose.cells.drawing.equations/equationnode/
---
## EquationNode class
...
// Istanzia un oggetto Workbook che rappresenta un file Excel.
Workbook workbook;

// Aggiunge un oggetto equazione al foglio di lavoro.
TextBox textBox = workbook.GetWorksheets().Get(0).GetShapes().AddEquation(1, 0, 1, 0, 100, 300);

// Ottiene il nodo iniziale dell'oggetto equazione
EquationNode mathNode = textBox.GetEquationParagraph().GetChild(0);

// Inserisce un'equazione frazionaria.
