...
type: docs
weight: 1400
url: /it/cpp/aspose.cells.charts/datalabels/
---
## DataLabels class
...
Aspose::Cells::Startup();
    //Imposta le etichette dati nel grafico
    ...
    for (int i = 0; i < chart.GetNSeries().GetCount(); i++)
    {
        ...
        //Mostra il nome della categoria nelle etichette dati
        datalabels.SetShowCategoryName(true);
        //Mostra il valore nelle etichette dati
        datalabels.SetShowValue(true);
        //Non mostrare la percentuale nelle etichette dati
        datalabels.SetShowPercentage(false);
        //Non mostrare la chiave della legenda.
