...
type: docs
weight: 3400
url: /it/cpp/aspose.cells.charts/title/
---
## Title class
...
//Impostare il titolo di un grafico
...
//Impostare il titolo dell'asse delle categorie del grafico
chart.GetCategoryAxis().GetTitle().SetText(u"Category");
//Impostare il titolo dell'asse dei valori del grafico
