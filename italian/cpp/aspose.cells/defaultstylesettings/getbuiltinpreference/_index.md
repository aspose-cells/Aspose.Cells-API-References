---
title: Aspose::Cells::DefaultStyleSettings::GetBuiltInPreference method
linktitle: GetBuiltInPreference
second_title: Aspose.Cells for C++ API Reference
description: 'Aspose::Cells::DefaultStyleSettings::GetBuiltInPreference method. Indicates whether property for number format is preferable when the style defines both built-in number and custom pattern. Default value is false, that means by default custom pattern will be used to format values as long as it is not empty for one style in C++.'
type: docs
weight: 600
url: /it/cpp/aspose.cells/defaultstylesettings/getbuiltinpreference/
---
