---
title: Aspose::Cells::HtmlSaveOptions::SetCellNameAttribute method
linktitle: SetCellNameAttribute
second_title: Aspose.Cells for C++ API Reference
description: 'Aspose::Cells::HtmlSaveOptions::SetCellNameAttribute method. Specifies the attribute that indicates the CellName to be written. (e.g. If the value is "id", then for cell "A1", the output will be:<td id=''A1''>). The default value is null in C++.'
type: docs
weight: 13000
url: /it/cpp/aspose.cells/htmlsaveoptions/setcellnameattribute/
---
