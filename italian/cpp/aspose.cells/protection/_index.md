...
type: docs
weight: 12200
url: /it/cpp/aspose.cells/protection/
---
## Protection class
...
//Consente agli utenti di selezionare le celle bloccate del foglio di lavoro
worksheet.GetProtection().SetAllowSelectingLockedCell(true);
//Consente agli utenti di selezionare le celle sbloccate del foglio di lavoro
