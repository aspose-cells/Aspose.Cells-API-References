...
//Inserisci una stringa in una cella
Cell cell = cells.Get(0, 0);
cell.PutValue(u"Hello");

U16String first = cell.GetStringValue();

//Inserisci un intero in una cella
cell = cells.Get(u"B1");
cell.PutValue(12);

int second = cell.GetIntValue();

//Inserisci un double in una cella
cell = cells.Get(0, 2);
cell.PutValue(-1.234);

double third = cell.GetDoubleValue();

//Inserisci una formula in una cella
cell = cells.Get(u"D1");
cell.SetFormula(u"=B1 + C1");

//Inserisci una formula combinata: "sum(average(b1,c1), b1)" nella cella b2
cell = cells.Get(u"b2");
