...
//Il seguente esempio mostra come bloccare i riquadri e inserire un collegamento ipertestuale nel foglio di lavoro con .Net o VB.
Workbook workbook;

Worksheet sheet = workbook.GetWorksheets().Get(0);

//Blocca i riquadri in "AS40" con 10 righe e 10 colonne
sheet.FreezePanes(u"AS40", 10, 10);

//Aggiungi un collegamento ipertestuale nella cella A1
