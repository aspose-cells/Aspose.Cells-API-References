...
type: docs
weight: 12300
url: /it/cpp/aspose.cells/querytable/
---
## QueryTable class
...
//Recupero della prima tabella di query nel foglio di lavoro, se esiste
...
if(!qts.IsNull() && qts.GetCount() != 0)
{
    ...
    //Recupero dell'indirizzo di visualizzazione della tabella di query.
