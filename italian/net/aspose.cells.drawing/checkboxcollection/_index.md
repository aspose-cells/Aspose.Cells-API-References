...
description: Rappresenta una raccolta diCheckBox./checkbox oggetti in un foglio di lavoro.
type: docs
weight: 1870
url: /it/net/aspose.cells.drawing/checkboxcollection/
---
## CheckBoxCollection class

Rappresenta una raccolta di[`CheckBox`](../checkbox) oggetti in un foglio di lavoro.
...
| [Item](../../aspose.cells.drawing/checkboxcollection/item) { get; } | Ottiene il[`CheckBox`](../checkbox) elemento all'indice specificato. |
...
| Nome | Descrizione |
| --- | --- |
| [Add](../../aspose.cells.drawing/checkboxcollection/add)(int, int, int, int) | Aggiunge una casella di controllo alla raccolta. |
