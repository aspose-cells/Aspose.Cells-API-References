...
description: Rappresenta tutti i punti del percorso forma.
type: docs
weight: 2720
url: /it/net/aspose.cells.drawing/shapepathpointcollection/
---
...
| Nome | Descrizione |
| --- | --- |
| [ShapePathPointCollection](shapepathpointcollection)() | Default_Costruttore |
...
| [Item](../../aspose.cells.drawing/shapepathpointcollection/item) { get; } | Ottiene il punto del percorso della forma in base all'indice. |
...
| Nome | Descrizione |
| --- | --- |
| [Add](../../aspose.cells.drawing/shapepathpointcollection/add)(int, int) | Aggiunge un punto di percorso. |
