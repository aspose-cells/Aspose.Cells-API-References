...
description: Rappresenta le opzioni di caricamento di xml.
type: docs
weight: 6580
url: /it/net/aspose.cells/xmlloadoptions/
---
...
| Nome | Descrizione |
| --- | --- |
| [XmlLoadOptions](xmlloadoptions#constructor)() | Rappresenta le opzioni di caricamento del file ods. |
| [XmlLoadOptions](xmlloadoptions#constructor_1)(LoadFormat) | Rappresenta le opzioni di caricamento del file ods. |
...
| [ContainsMultipleWorksheets](../../aspose.cells/xmlloadoptions/containsmultipleworksheets) { get; set; } | Indica se si importa xml come fogli di lavoro multipli. |
...
| [IsXmlMap](../../aspose.cells/xmlloadoptions/isxmlmap) { get; set; } | Indica se mappare xml su Excel. Il valore predefinito è false. |
...
| [StartCell](../../aspose.cells/xmlloadoptions/startcell) { get; set; } | Ottiene e imposta la cella iniziale. |
