...
description: Descrive una raccolta di CFValueObject. Utilizzare solo per set di icone.
type: docs
weight: 1150
url: /it/net/aspose.cells/conditionalformattingvaluecollection/
---
## ConditionalFormattingValueCollection class

Descrive una raccolta di CFValueObject. Utilizzare solo per set di icone.
...
| [Item](../../aspose.cells/conditionalformattingvaluecollection/item) { get; } | Ottieni l'elemento CFValueObject all'indice specificato. |
...
| Nome | Descrizione |
| --- | --- |
| [Add](../../aspose.cells/conditionalformattingvaluecollection/add)(FormatConditionValueType, string) | Aggiunge[`ConditionalFormattingValue`](../conditionalformattingvalue) oggetto. |
