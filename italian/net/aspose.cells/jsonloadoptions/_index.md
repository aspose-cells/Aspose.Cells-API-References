...
description: Rappresenta le opzioni di caricamento dei file json
type: docs
weight: 3920
url: /it/net/aspose.cells/jsonloadoptions/
---
...
| Nome | Descrizione |
| --- | --- |
| [JsonLoadOptions](jsonloadoptions)() | Crea un'opzione per caricare il file. |
...
| [LayoutOptions](../../aspose.cells/jsonloadoptions/layoutoptions) { get; set; } | Le opzioni di importazione json. |
...
| [MultipleWorksheets](../../aspose.cells/jsonloadoptions/multipleworksheets) { get; set; } | Indica se importare ciascun attributo dell'oggetto JsonObject come un foglio di lavoro quando tutti i nodi figlio sono nodi dell'array. |
...
| [StartCell](../../aspose.cells/jsonloadoptions/startcell) { get; set; } | Ottiene e imposta la cella iniziale. |
