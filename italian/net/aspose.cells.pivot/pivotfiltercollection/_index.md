...
description: Rappresenta una raccolta di tutti gli oggetti PivotFilter
type: docs
weight: 4590
url: /it/net/aspose.cells.pivot/pivotfiltercollection/
---
...
| [Item](../../aspose.cells.pivot/pivotfiltercollection/item) { get; } | Ottiene l'oggetto pivotfilter in corrispondenza dell'indice specifico. |
...
| Nome | Descrizione |
| --- | --- |
| [Add](../../aspose.cells.pivot/pivotfiltercollection/add)(int, PivotFilterType) | Aggiunge un oggetto PivotFilter al tipo specifico |
...
| [ClearFilter](../../aspose.cells.pivot/pivotfiltercollection/clearfilter)(int) | Cancella PivotFilter dal campo pivot specifico |
