...
description: Incapsula una raccolta diSparklineGroup./sparklinegroup oggetti.
type: docs
weight: 890
url: /it/net/aspose.cells.charts/sparklinegroupcollection/
---
## SparklineGroupCollection class

Incapsula una raccolta di[`SparklineGroup`](../sparklinegroup) oggetti.
...
| [Item](../../aspose.cells.charts/sparklinegroupcollection/item) { get; } | Ottiene il[`SparklineGroup`](../sparklinegroup) elemento all'indice specificato. |
...
| Nome | Descrizione |
| --- | --- |
| [Add](../../aspose.cells.charts/sparklinegroupcollection/add)(SparklineType, string, bool, CellArea) | Aggiunge un[`SparklineGroup`](../sparklinegroup) articolo alla collezione. |
...
| [ClearSparklineGroups](../../aspose.cells.charts/sparklinegroupcollection/clearsparklinegroups)(CellArea) | Cancella i gruppi sparkline che si sovrappongono a un'area di celle. |
| [ClearSparklines](../../aspose.cells.charts/sparklinegroupcollection/clearsparklines)(CellArea) | Cancella i grafici sparkline che si trovano all'interno di un'area di celle. |
