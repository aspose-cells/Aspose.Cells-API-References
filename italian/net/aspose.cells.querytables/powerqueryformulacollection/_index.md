...
description: Rappresenta tutte le formule di query di alimentazione nei dati mashup.
type: docs
weight: 4970
url: /it/net/aspose.cells.querytables/powerqueryformulacollection/
---
## PowerQueryFormulaCollection class

Rappresenta tutte le formule di query di alimentazione nei dati mashup.
...
| [Item](../../aspose.cells.querytables/powerqueryformulacollection/item) { get; } | Ottiene[`PowerQueryFormula`](../powerqueryformula) dall'indice nell'elenco. (2 indexers) |
