...
description: Rappresenta tutti i registri di revisione.
type: docs
weight: 5450
url: /it/net/aspose.cells.revisions/revisionlogcollection/
---
...
| [DaysPreservingHistory](../../aspose.cells.revisions/revisionlogcollection/dayspreservinghistory) { get; set; } | Ottiene e imposta il numero di giorni in cui l'applicazione del foglio di calcolo conserverà la cronologia delle modifiche per questa cartella di lavoro. |
| [Item](../../aspose.cells.revisions/revisionlogcollection/item) { get; } | Ottiene[`RevisionLog`](../revisionlog) per indice. |
