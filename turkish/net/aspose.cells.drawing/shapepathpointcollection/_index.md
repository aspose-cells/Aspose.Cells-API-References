...
description: Tüm şekil yolu noktalarını temsil eder.
type: docs
weight: 2720
url: /tr/net/aspose.cells.drawing/shapepathpointcollection/
---
...
| [Item](../../aspose.cells.drawing/shapepathpointcollection/item) { get; } | Dizine göre şekil yol noktasını alır. |
...
| İsim | Tanım |
| --- | --- |
| [Add](../../aspose.cells.drawing/shapepathpointcollection/add)(int, int) | Bir yol noktası ekler. |
