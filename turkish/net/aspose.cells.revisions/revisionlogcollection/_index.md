...
description: Tüm revizyon günlüklerini temsil eder.
type: docs
weight: 5450
url: /tr/net/aspose.cells.revisions/revisionlogcollection/
---
...
| [DaysPreservingHistory](../../aspose.cells.revisions/revisionlogcollection/dayspreservinghistory) { get; set; } | Elektronik tablo uygulamasının bu çalışma kitabı için değişiklik geçmişini tutacağı gün sayısını alır ve ayarlar. |
| [Item](../../aspose.cells.revisions/revisionlogcollection/item) { get; } | Alır[`RevisionLog`](../revisionlog) index. ile |
