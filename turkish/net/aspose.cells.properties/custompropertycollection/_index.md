...
description: Bir koleksiyonCustomProperty./customproperty ek bilgileri temsil eden nesneler.
type: docs
weight: 4850
url: /tr/net/aspose.cells.properties/custompropertycollection/
---
## CustomPropertyCollection class

Bir koleksiyon[`CustomProperty`](../customproperty) ek bilgileri temsil eden nesneler.
...
| [Item](../../aspose.cells.properties/custompropertycollection/item) { get; } | Belirli bir dizine göre özel özelliği alır. (2 indexers) |
...
| İsim | Tanım |
| --- | --- |
| [Add](../../aspose.cells.properties/custompropertycollection/add)(string, string) | Özel özellik bilgilerini ekler. |
