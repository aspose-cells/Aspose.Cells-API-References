...
description: Bir Office Eklentisi ile belgedeki veriler arasındaki bağlama ilişkilerinin listesini temsil eder.
type: docs
weight: 6390
url: /tr/net/aspose.cells.webextensions/webextensionbindingcollection/
---
...
| [Item](../../aspose.cells.webextensions/webextensionbindingcollection/item) { get; } | Belirli bir dizine göre web uzantısı bağlama ilişkisini alır. |
...
| İsim | Tanım |
| --- | --- |
| [Add](../../aspose.cells.webextensions/webextensionbindingcollection/add)() | Bir Office Eklentisi ile belgedeki veriler arasına bağlayıcı bir ilişki ekler. |
