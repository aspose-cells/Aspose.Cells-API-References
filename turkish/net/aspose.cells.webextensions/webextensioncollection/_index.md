...
description: Web uzantısının listesini temsil eder.
type: docs
weight: 6400
url: /tr/net/aspose.cells.webextensions/webextensioncollection/
---
...
| [Item](../../aspose.cells.webextensions/webextensioncollection/item) { get; } | Belirli bir dizine göre web uzantısını alır. |
...
| İsim | Tanım |
| --- | --- |
| [Add](../../aspose.cells.webextensions/webextensioncollection/add)() | Bir web uzantısı ekler. |
...
| [RemoveAt](../../aspose.cells.webextensions/webextensioncollection/removeat#removeat)(int) | Web uzantısını dizine göre kaldırın. (2 methods) |
