...
type: docs
weight: 820
url: /tr/net/aspose.cells.griddesktop/formatconditiontype/
---
...
| NotContainsText | `9` | Bu koşullu biçimlendirme kuralı, boş olmayan hücreleri vurgular. LEN(TRIM()) kullanımına eşdeğerdir. This , hücrenin yalnızca TRIM()'in kaldıracağı karakterleri içermesi durumunda boş olarak kabul edildiği anlamına gelir. An boş hücre de boş olarak kabul edilir. |
