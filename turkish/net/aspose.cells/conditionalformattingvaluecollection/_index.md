...
description: CFValueObject koleksiyonunu açıklar. Yalnızca simge kümeleri için kullanın.
type: docs
weight: 1150
url: /tr/net/aspose.cells/conditionalformattingvaluecollection/
---
## ConditionalFormattingValueCollection class

CFValueObject koleksiyonunu açıklar. Yalnızca simge kümeleri için kullanın.
...
| [Item](../../aspose.cells/conditionalformattingvaluecollection/item) { get; } | Belirtilen dizindeki CFValueObject öğesini alın. |
...
| İsim | Tanım |
| --- | --- |
| [Add](../../aspose.cells/conditionalformattingvaluecollection/add)(FormatConditionValueType, string) | Ekler[`ConditionalFormattingValue`](../conditionalformattingvalue) nesne. |
