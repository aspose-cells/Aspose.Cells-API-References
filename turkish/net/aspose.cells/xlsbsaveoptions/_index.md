...
description: xlsb dosyasını kaydetme seçeneklerini temsil eder.
type: docs
weight: 6550
url: /tr/net/aspose.cells/xlsbsaveoptions/
---
...
| İsim | Tanım |
| --- | --- |
| [XlsbSaveOptions](xlsbsaveoptions#constructor)() | xlsb dosyası kaydetme seçenekleri oluşturur. |
...
| [CompressionType](../../aspose.cells/xlsbsaveoptions/compressiontype) { get; set; } | ooxml dosyası için sıkıştırma türünü alır ve ayarlar. |
...
| [ExportAllColumnIndexes](../../aspose.cells/xlsbsaveoptions/exportallcolumnindexes) { get; set; } | Hücreler için tüm sütun dizinlerinin dışa aktarılıp aktarılmayacağını gösterir. |
