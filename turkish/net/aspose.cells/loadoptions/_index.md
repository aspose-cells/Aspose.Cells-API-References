...
description: Dosyayı yükleme seçeneklerini temsil eder.
type: docs
weight: 4000
url: /tr/net/aspose.cells/loadoptions/
---
## LoadOptions class
...
| İsim | Tanım |
| --- | --- |
| [LoadOptions](loadoptions#constructor)() | Dosyayı yükleme seçenekleri oluşturur. |
| [LoadOptions](loadoptions#constructor_1)(LoadFormat) | Dosyayı yükleme seçenekleri oluşturur. |
