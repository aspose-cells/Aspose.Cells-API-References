...
description: json dosyalarını yükleme seçeneklerini temsil eder
type: docs
weight: 3920
url: /tr/net/aspose.cells/jsonloadoptions/
---
...
| İsim | Tanım |
| --- | --- |
| [JsonLoadOptions](jsonloadoptions)() | Dosyayı yükleme seçenekleri oluşturur. |
...
| [LayoutOptions](../../aspose.cells/jsonloadoptions/layoutoptions) { get; set; } | json. içe aktarma seçenekleri |
...
| [MultipleWorksheets](../../aspose.cells/jsonloadoptions/multipleworksheets) { get; set; } | Tüm alt düğümler dizi düğümleri olduğunda JsonObject nesnesinin her özniteliğinin tek bir çalışma sayfası olarak içe aktarılıp aktarılmayacağını gösterir. |
...
| [StartCell](../../aspose.cells/jsonloadoptions/startcell) { get; set; } | Başlangıç hücresini alır ve ayarlar. |
