...
description: . olan tüm kişileri temsil eder.
type: docs
weight: 6040
url: /tr/net/aspose.cells/threadedcommentauthorcollection/
---
...
| [CurrentPerson](../../aspose.cells/threadedcommentauthorcollection/currentperson) { get; set; } | Geçerli kullanıcıyı alır ve ayarlar. |
| [Item](../../aspose.cells/threadedcommentauthorcollection/item) { get; } | Dizili yorumlar oluşturan kişiyi alır. (2 indexers) |
...
| İsim | Tanım |
| --- | --- |
| [Add](../../aspose.cells/threadedcommentauthorcollection/add)(string, string, string) | Bir ileti dizisi yorumu kişisi ekler. |
...
| [IndexOf](../../aspose.cells/threadedcommentauthorcollection/indexof#indexof)(ThreadedCommentAuthor) | ThreadedCommentAuthor object dizinini alır (2 methods) |
