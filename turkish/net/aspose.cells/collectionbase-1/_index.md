...
description: Kesin olarak yazılan bir koleksiyon için soyut temel sınıfı sağlar.
type: docs
weight: 1020
url: /tr/net/aspose.cells/collectionbase-1/
---
...
| İsim | Tanım |
| --- | --- |
| [Capacity](../../aspose.cells/collectionbase`1/capacity) { get; set; } | Listenin içerebileceği öğe sayısını alır veya ayarlar. |
| [Count](../../aspose.cells/collectionbase`1/count) { get; } | Öğe sayısını alır. |
| [Item](../../aspose.cells/collectionbase`1/item) { get; set; } | Belirtilen dizindeki öğeyi alır veya ayarlar. |
...
| [Clear](../../aspose.cells/collectionbase`1/clear)() | Tüm öğeleri kaldırın. |
...
| [RemoveAt](../../aspose.cells/collectionbase`1/removeat)(int) | Belirtilen dizindeki öğeyi kaldırır. |
