...
description: Bir koleksiyonu kapsüllerSparkline./sparkline nesneler.
type: docs
weight: 870
url: /tr/net/aspose.cells.charts/sparklinecollection/
---
## SparklineCollection class

Bir koleksiyonu kapsüller[`Sparkline`](../sparkline) nesneler.
...
| [Item](../../aspose.cells.charts/sparklinecollection/item) { get; } | [`Sparkline`](../sparkline) belirtilen dizindeki öğe. |
...
| İsim | Tanım |
| --- | --- |
| [Add](../../aspose.cells.charts/sparklinecollection/add)(string, int, int) | Bir mini grafik ekleyin. |
...
| [Remove](../../aspose.cells.charts/sparklinecollection/remove)(object) | Sparkline'ı kaldırır |
