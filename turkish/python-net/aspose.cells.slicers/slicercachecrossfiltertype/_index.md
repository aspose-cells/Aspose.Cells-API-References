---
title: SlicerCacheCrossFilterType numaralandırma
second_title: Aspose.Cells for Python via .NET API Referanslar
description:
type: docs
weight: 60
url: /tr/python-net/aspose.cells.slicers/slicercachecrossfiltertype/
is_root: false
---
##  SlicerCacheCrossFilterType numaralandırma
SlicerCacheCrossFilterType tipini temsil eder



SlicerCacheCrossFilterType türü aşağıdaki üyeleri gösterir:
