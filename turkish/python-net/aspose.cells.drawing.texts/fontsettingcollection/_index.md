...
FontSettingCollection türü aşağıdaki üyeleri gösterir:

###  Özellikler
| Mülk| Tanım|
| :- | :- |
| [text_alignment](/cells/tr/python-net/aspose.cells.drawing.texts/fontsettingcollection/text_alignment) | Metin gövdesinin hizalama ayarını temsil eder.|
| [text_paragraphs](/cells/tr/python-net/aspose.cells.drawing.texts/fontsettingcollection/text_paragraphs) | Tüm paragrafları alır.|
| [text](/cells/tr/python-net/aspose.cells.drawing.texts/fontsettingcollection/text) | Şeklin metnini alır ve ayarlar.|
| [html_string](/cells/tr/python-net/aspose.cells.drawing.texts/fontsettingcollection/html_string) | Bu şekildeki verileri ve bazı biçimleri içeren html dizesini alır ve ayarlar.|
| [capacity](/cells/tr/python-net/aspose.cells.drawing.texts/fontsettingcollection/capacity) | Dizi listesinin içerebileceği öğe sayısını alır veya ayarlar.|
