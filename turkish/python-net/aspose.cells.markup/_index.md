...
type: docs
weight: 10
url: /tr/python-net/aspose.cells.markup/
is_root: false
---
 bu**Aspose.Cells.Markup** ad alanı, bir belgede müşteri tanımlı semantiği temsil eden sınıflar içerir: akıllı etiketler, özel XML ve daha fazla biçimlendirme etiketi.

###  sınıflar
| Sınıf| Tanım|
| :- | :- |
| [CustomXmlPart](/cells/tr/python-net/aspose.cells.markup/customxmlpart) | Bir Özel XML Veri Depolama Bölümünü (bir paket içindeki özel XML verileri) temsil eder.|
| [CustomXmlPartCollection](/cells/tr/python-net/aspose.cells.markup/customxmlpartcollection) | Bir Özel XML Veri Depolama Bölümünü (bir paket içindeki özel XML verileri) temsil eder.|
| [SmartTag](/cells/tr/python-net/aspose.cells.markup/smarttag) | Bir akıllı etiketi temsil eder.|
