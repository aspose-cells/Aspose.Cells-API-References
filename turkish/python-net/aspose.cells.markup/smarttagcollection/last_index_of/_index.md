...
type: docs
weight: 60
url: /tr/python-net/aspose.cells.markup/smarttagcollection/last_index_of/
is_root: false
---
##  last_index_of(item) {#SmartTag}
...
| Parametre| Tip| Tanım|
| :- | :- | :- |
| item | [SmartTag](/cells/tr/python-net/aspose.cells.markup/smarttag) | Dizi listesinde bulunacak nesne. Değer null olabilir.|


##  last_index_of(item, index) {#SmartTag-int}
...
##  last_index_of(item, index, count) {#SmartTag-int-int}
