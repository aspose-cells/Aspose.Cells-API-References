...
type: docs
weight: 140
url: /tr/python-net/aspose.cells.externalconnections/sqldatatype/
is_root: false
---
...
SqlDataType türü aşağıdaki üyeleri gösterir:
...
| SQL_UNKNOWN_TYPE | sql türü bilinmiyor|
| SQL_CHAR | sql karakteri|
| SQL_NUMERIC | sql sayısal|
| SQL_DECIMAL | sql ondalık|
| SQL_INTEGER | sql tamsayı|
| SQL_SMALL_INT | sql küçük int|
| SQL_FLOAT | sql şamandırası|
| SQL_REAL | gerçek sql|
| SQL_DOUBLE | sql çift|
| SQL_TYPE_DATE | sql tarih türü|
| SQL_TYPE_TIME | sql zaman türü|
| SQL_TYPE_TIMESTAMP | sql zaman damgası türü|
| SQL_VAR_CHAR | sql değişken karakteri|
| SQL_INTERVAL_YEAR | sql aralık yılı|
| SQL_INTERVAL_MONTH | sql aralığı ayı|
| SQL_INTERVAL_DAY | sql aralık günü|
| SQL_INTERVAL_HOUR | sql aralığı saat|
| SQL_INTERVAL_MINUTE | sql aralığı dakika|
| SQL_INTERVAL_SECOND | sql aralığı saniye|
