...
type: docs
weight: 10
url: /tr/python-net/aspose.cells.externalconnections/
is_root: false
---
 bu**Aspose.Cells.ExternalConnections** ad alanı, Veritabanları ve Web gibi dış kaynaklardan veri almak için dış bağlantılar için sınıflar sağlar.

###  sınıflar
| Sınıf| Tanım|
| :- | :- |
| [ConnectionParameter](/cells/tr/python-net/aspose.cells.externalconnections/connectionparameter) | Harici veri bağlantılarıyla kullanılan tüm parametrelerle ilgili özellikleri belirtir<br/> Parametreler ODBC ve web sorguları için geçerlidir.|
| [ConnectionParameterCollection](/cells/tr/python-net/aspose.cells.externalconnections/connectionparametercollection) | [ConnectionParameter](/cells/tr/python-net/aspose.cells.externalconnections/connectionparameter) koleksiyonunu belirtir|
| [DBConnection](/cells/tr/python-net/aspose.cells.externalconnections/dbconnection) | Bir ODBC veya OLE DB dış veri bağlantısıyla ilişkili tüm özellikleri belirtir.|
...
| :- | :- |
| [ConnectionDataSourceType](/cells/tr/python-net/aspose.cells.externalconnections/connectiondatasourcetype) |Harici veritabanı kaynak türünü belirtir|
| [ConnectionParameterType](/cells/tr/python-net/aspose.cells.externalconnections/connectionparametertype) | Harici bağlantının parametre tipini belirtir|
| [CredentialsMethodType](/cells/tr/python-net/aspose.cells.externalconnections/credentialsmethodtype) | Sunucu erişimi için kullanılan Kimlik Bilgileri yöntemini belirtir.|
