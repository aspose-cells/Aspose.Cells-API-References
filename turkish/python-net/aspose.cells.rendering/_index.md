...
| Sınıf| Tanım|
| :- | :- |
| [DrawObject](/cells/tr/python-net/aspose.cells.rendering/drawobject) | DrawObject, oluşturulurken başlatılacak ve döndürülecektir.|
| [DrawObjectEventHandler](/cells/tr/python-net/aspose.cells.rendering/drawobjecteventhandler) |İşleme sırasında DrawObject ve Bound'u almak için arayüz.|
| [IPageSavingCallback](/cells/tr/python-net/aspose.cells.rendering/ipagesavingcallback) |Sayfa kaydetme işleminin ilerleyişini kontrol edin/gösterin.|
| [ImageOrPrintOptions](/cells/tr/python-net/aspose.cells.rendering/imageorprintoptions) | Çalışma sayfasını görüntülere dönüştürürken, çalışma sayfasını yazdırırken veya tabloyu görüntüye dönüştürürken seçenekleri belirlemeye izin verir.|
...
| [WorkbookPrintingPreview](/cells/tr/python-net/aspose.cells.rendering/workbookprintingpreview) | Çalışma kitabı yazdırma önizlemesi.|
| [WorkbookRender](/cells/tr/python-net/aspose.cells.rendering/workbookrender) | Bir Çalışma Kitabı işlemesini temsil eder.<br/> Bu sınıfın yapıcısı, sayfa düzeni, hücre stili değiştirildikten sonra kullanılmalıdır.|
...
| [PdfOptimizationType](/cells/tr/python-net/aspose.cells.rendering/pdfoptimizationtype) | Bir optimizasyon türü belirtir.|
| [TiffCompression](/cells/tr/python-net/aspose.cells.rendering/tiffcompression) |Görüntüleri TIFF biçimindeki dosyaya kaydederken ne tür sıkıştırma uygulanacağını belirtir.|
