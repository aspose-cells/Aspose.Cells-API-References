...
type: docs
weight: 20
url: /tr/python-net/aspose.cells.drawing.activexcontrols/activexcontrolbase/
is_root: false
---
##  ActiveXControlBase sınıfı
ActiveX denetimini temsil eder.



ActiveXControlBase türü aşağıdaki üyeleri gösterir:
...
| [back_ole_color](/cells/tr/python-net/aspose.cells.drawing.activexcontrols/activexcontrolbase/back_ole_color) | Arka planın ole rengini alır ve ayarlar.|
| [is_visible](/cells/tr/python-net/aspose.cells.drawing.activexcontrols/activexcontrolbase/is_visible) | Bu kontrolün görünür olup olmadığını gösterir.|
| [shadow](/cells/tr/python-net/aspose.cells.drawing.activexcontrols/activexcontrolbase/shadow) | Gölge gösterilip gösterilmeyeceğini belirtir.|
| [linked_cell](/cells/tr/python-net/aspose.cells.drawing.activexcontrols/activexcontrolbase/linked_cell) | Bağlı hücreyi alır ve ayarlar.|
| [list_fill_range](/cells/tr/python-net/aspose.cells.drawing.activexcontrols/activexcontrolbase/list_fill_range) | Liste doldurma aralığını alır ve ayarlar.|
| [data](/cells/tr/python-net/aspose.cells.drawing.activexcontrols/activexcontrolbase/data) | Denetimin ikili verilerini alır ve ayarlar.|
