...
**Miras:** [TextBox](/cells/python-net/aspose.cells.drawing/textbox) → 
[Shape](/cells/tr/python-net/aspose.cells.drawing/shape)



TextBox türü aşağıdaki üyeleri gösterir:

###  Özellikler
| Mülk| Tanım|
| :- | :- |
| [macro_name](/cells/tr/python-net/aspose.cells.drawing/textbox/macro_name) | Makronun adını alır ve ayarlar.|
...
| [hyperlink](/cells/tr/python-net/aspose.cells.drawing/textbox/hyperlink) | Şeklin hiper bağlantısını alır.|
...
| [placement](/cells/tr/python-net/aspose.cells.drawing/textbox/placement) | Çizim nesnesinin altındaki hücrelere iliştirilme şeklini temsil eder.<br/> Özellik, bir nesnenin çalışma sayfasındaki yerleşimini kontrol eder.|
| [upper_left_row](/cells/tr/python-net/aspose.cells.drawing/textbox/upper_left_row) | Sol üst köşe satır dizinini temsil eder.|
| [upper_delta_y](/cells/tr/python-net/aspose.cells.drawing/textbox/upper_delta_y) | Şeklin sol üst köşe satırından dikey uzaklığını alır veya ayarlar.|
| [upper_left_column](/cells/tr/python-net/aspose.cells.drawing/textbox/upper_left_column) | Sol üst köşe sütun indeksini temsil eder.|
| [upper_delta_x](/cells/tr/python-net/aspose.cells.drawing/textbox/upper_delta_x) | Şeklin yatay uzaklığını sol üst köşe sütunundan alır veya ayarlar.|
| [lower_right_row](/cells/tr/python-net/aspose.cells.drawing/textbox/lower_right_row) | Sağ alt köşe satır dizinini temsil eder.|
| [lower_delta_y](/cells/tr/python-net/aspose.cells.drawing/textbox/lower_delta_y) | Şeklin sağ alt köşe satırından dikey uzaklığını alır veya ayarlar.|
...
| [has_line](/cells/tr/python-net/aspose.cells.drawing/textbox/has_line) | Görünür şeklin çizgi kenarlığını alır ve ayarlar.|
| [is_filled](/cells/tr/python-net/aspose.cells.drawing/textbox/is_filled) | Dolgu formatının görünür olup olmadığını gösterir.|
| [is_flipped_horizontally](/cells/tr/python-net/aspose.cells.drawing/textbox/is_flipped_horizontally) | Şeklin yatay olarak çevrilip çevrilmediğini alır ve ayarlar.|
| [is_flipped_vertically](/cells/tr/python-net/aspose.cells.drawing/textbox/is_flipped_vertically) | Şeklin dikey olarak çevrilip çevrilmediğini alır ve ayarlar.|
| [actual_lower_right_row](/cells/tr/python-net/aspose.cells.drawing/textbox/actual_lower_right_row) | Gerçek alt sırayı alın.|
| [connection_points](/cells/tr/python-net/aspose.cells.drawing/textbox/connection_points) | Bağlantı noktalarını alın|
...
| [text](/cells/tr/python-net/aspose.cells.drawing/textbox/text) | Bu TextBox nesnesindeki dizeyi temsil eder.|
...
| [text_vertical_alignment](/cells/tr/python-net/aspose.cells.drawing/textbox/text_vertical_alignment) | Şeklin metin dikey hizalama türünü alır ve ayarlar.|
...
| Yöntem| Tanım|
| :- | :- |
| [to_image(stream, image_type)](/cells/tr/python-net/aspose.cells.drawing/textbox/to_image/#io.RawIOBase-ImageType) | Şekil görüntüsünü oluşturur ve belirtilen biçimde bir akışa kaydeder.|
| [to_image(image_file, options)](/cells/tr/python-net/aspose.cells.drawing/textbox/to_image/#str-aspose.cells.rendering.ImageOrPrintOptions) | Şekli bir dosyaya kaydeder.|
| [to_image(stream, options)](/cells/tr/python-net/aspose.cells.drawing/textbox/to_image/#io.RawIOBase-aspose.cells.rendering.ImageOrPrintOptions) | Şekli bir akışa kaydeder.|
| [format_characters(start_index, length, font, flag)](/cells/tr/python-net/aspose.cells.drawing/textbox/format_characters/#int-int-Font-StyleFlag) | Yazı tipi ayarıyla bazı karakterleri biçimlendirir.|
| [format_characters(start_index, length, font)](/cells/tr/python-net/aspose.cells.drawing/textbox/format_characters/#int-int-Font) | Yazı tipi ayarıyla bazı karakterleri biçimlendirir.|
| [get_result_of_smart_art()](/cells/tr/python-net/aspose.cells.drawing/textbox/get_result_of_smart_art/#) | Akıllı sanatı gruplandırılmış şekillere dönüştürme.|
| [to_front_or_back(orders)](/cells/tr/python-net/aspose.cells.drawing/textbox/to_front_or_back/#int) | Şekli öne getirir veya şekli arkaya gönderir.|
| [get_locked_property(type)](/cells/tr/python-net/aspose.cells.drawing/textbox/get_locked_property/#ShapeLockType) | Lock özelliğinin değerini alır.|
| [set_locked_property(type, value)](/cells/tr/python-net/aspose.cells.drawing/textbox/set_locked_property/#ShapeLockType-bool) | Kilitli özelliğini ayarlayın.|
