...
type: docs
weight: 760
url: /tr/python-net/aspose.cells.drawing/autoshapetype/
is_root: false
---
...
| SOUND_ACTION_BUTTON |  |
| MOVIE_ACTION_BUTTON |  |
| HOST_CONTROL | Bu değer KULLANILMAMALIDIR.|
| TEXT_BOX |  |
| HEPTAGON |  |
| DECAGON |  |
| DODECAGON |  |
...
| FRAME |  |
| MODEL_3D |  |
| ROUND_CALLOUT | Excel'de böyle bir tür yok|
| TEXT_ARCH_LEFT_POUR | Excel'de böyle bir tür yok|
| TEXT_ARCH_RIGHT_POUR | Excel'de böyle bir tür yok|
| TEXT_ARCH_LEFT_CURVE | Excel'de böyle bir tür yok|
| TEXT_ARCH_RIGHT_CURVE | Excel'de böyle bir tür yok|
| UNKNOWN |  |
