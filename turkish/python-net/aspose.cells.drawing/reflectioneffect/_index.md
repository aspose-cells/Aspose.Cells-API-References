---
title: ReflectionEffect sınıf
second_title: Aspose.Cells for Python via .NET API Referanslar
description:
type: docs
weight: 490
url: /tr/python-net/aspose.cells.drawing/reflectioneffect/
is_root: false
---
##  ReflectionEffect sınıf
Bu sınıf bir yansıma efektini belirtir.



ReflectionEffect türü aşağıdaki üyeleri gösterir:
...
| [rot_with_shape](/cells/tr/python-net/aspose.cells.drawing/reflectioneffect/rot_with_shape) | Yansımanın şekille birlikte dönmesi gerekip gerekmediğini alır ve ayarlar.|
