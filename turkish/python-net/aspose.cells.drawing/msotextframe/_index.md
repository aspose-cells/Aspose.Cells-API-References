---
title: MsoTextFrame sınıf
second_title: Aspose.Cells for Python via .NET API Referanslar
description:
type: docs
weight: 380
url: /tr/python-net/aspose.cells.drawing/msotextframe/
is_root: false
---
##  MsoTextFrame sınıf
...
MsoTextFrame türü aşağıdaki üyeleri gösterir:

###  Özellikler
| Mülk| Tanım|
| :- | :- |
| [auto_size](/cells/tr/python-net/aspose.cells.drawing/msotextframe/auto_size) | Şeklin boyutunun içeriğine göre otomatik olarak ayarlanıp ayarlanmadığını gösterir.|
| [is_auto_margin](/cells/tr/python-net/aspose.cells.drawing/msotextframe/is_auto_margin) | Kenar boşluğunun otomatik olarak hesaplanıp hesaplanmadığını gösterir.|
