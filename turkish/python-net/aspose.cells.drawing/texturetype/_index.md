...
type: docs
weight: 1180
url: /tr/python-net/aspose.cells.drawing/texturetype/
is_root: false
---
##  TextureType numaralandırma
Önceden ayarlanmış doku tipini temsil eder.



TextureType türü aşağıdaki üyeleri gösterir:

###  alanlar
| Alan| Tanım|
| :- | :- |
| BLUE_TISSUE_PAPER | Mavi Doku Kağıdı doku türünü temsil eder.|
| BOUQUET | Buket doku tipini temsil eder.|
...
| SAND | Kum doku tipini temsil eder.|
| STATIONERY | İleti örneği doku türünü temsil eder.|
| WALNUT | Ceviz Damlacıkları doku tipini temsil eder.|
| WATER_DROPLETS | Su Damlacıkları doku tipini temsil eder.|
| WHITE_MARBLE | Beyaz Mermer doku tipini temsil eder.|
| WOVEN_MAT | Dokuma Mat doku tipini temsil eder.|
| UNKNOWN | Bilinmeyen doku tipini temsil eder.|
