...
type: docs
weight: 810
url: /tr/python-net/aspose.cells.drawing/fillpattern/
is_root: false
---
##  FillPattern numaralandırma
Şekil doldurma deseni türlerini numaralandırır.



FillPattern türü aşağıdaki üyeleri gösterir:

###  alanlar
| Alan| Tanım|
| :- | :- |
| NONE | Arka planı temsil etmez.|
| SOLID | Katı modeli temsil eder.|
| GRAY5 |%5 gri modeli temsil eder.|
| GRAY10 | %10 gri deseni temsil eder.|
| GRAY20 | %20 gri deseni temsil eder.|
| GRAY30 | %30 gri deseni temsil eder.|
| GRAY40 | %40 gri deseni temsil eder.|
| GRAY50 | %50 gri deseni temsil eder.|
| GRAY60 | %60 gri deseni temsil eder.|
| GRAY70 | %70 gri deseni temsil eder.|
| GRAY75 | %75 gri deseni temsil eder.|
| GRAY80 | %80 gri deseni temsil eder.|
| GRAY90 | %90 gri deseni temsil eder.|
| GRAY25 | %25 gri deseni temsil eder.|
| LIGHT_DOWNWARD_DIAGONAL | Hafif aşağı çapraz deseni temsil eder.|
...
| LARGE_CONFETTI | Büyük konfeti desenini temsil eder.|
