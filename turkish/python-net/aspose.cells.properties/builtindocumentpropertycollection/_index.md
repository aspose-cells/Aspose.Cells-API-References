...
**Miras:** [BuiltInDocumentPropertyCollection](/cells/python-net/aspose.cells.properties/builtindocumentpropertycollection) → 
[DocumentPropertyCollection](/cells/tr/python-net/aspose.cells.properties/documentpropertycollection)



BuiltInDocumentPropertyCollection türü aşağıdaki üyeleri gösterir:

###  Özellikler
| Mülk| Tanım|
| :- | :- |
| [capacity](/cells/tr/python-net/aspose.cells.properties/builtindocumentpropertycollection/capacity) | Dizi listesinin içerebileceği öğe sayısını alır veya ayarlar.|
| [language](/cells/tr/python-net/aspose.cells.properties/builtindocumentpropertycollection/language) | Belgenin dilini alır veya ayarlar.|
| [author](/cells/tr/python-net/aspose.cells.properties/builtindocumentpropertycollection/author) | Belgenin yazarının adını alır veya ayarlar.|
| [bytes](/cells/tr/python-net/aspose.cells.properties/builtindocumentpropertycollection/bytes) | Belgedeki tahmini bayt sayısını temsil eder.|
| [characters](/cells/tr/python-net/aspose.cells.properties/builtindocumentpropertycollection/characters) | Belgedeki karakter sayısının tahminini temsil eder.|
| [characters_with_spaces](/cells/tr/python-net/aspose.cells.properties/builtindocumentpropertycollection/characters_with_spaces) | Belgedeki tahmini karakter sayısını (boşluklar dahil) temsil eder.|
| [comments](/cells/tr/python-net/aspose.cells.properties/builtindocumentpropertycollection/comments) | Belge yorumlarını alır veya ayarlar.|
| [category](/cells/tr/python-net/aspose.cells.properties/builtindocumentpropertycollection/category) | Belgenin kategorisini alır veya ayarlar.|
...
| [last_saved_universal_time](/cells/tr/python-net/aspose.cells.properties/builtindocumentpropertycollection/last_saved_universal_time) | Son kaydetmenin evrensel zamanını alır veya ayarlar.|
| [lines](/cells/tr/python-net/aspose.cells.properties/builtindocumentpropertycollection/lines) | Belgedeki satır sayısının tahminini temsil eder.|
| [manager](/cells/tr/python-net/aspose.cells.properties/builtindocumentpropertycollection/manager) | Manager özelliğini alır veya ayarlar.|
| [name_of_application](/cells/tr/python-net/aspose.cells.properties/builtindocumentpropertycollection/name_of_application) | Uygulamanın adını alır veya ayarlar.|
| [pages](/cells/tr/python-net/aspose.cells.properties/builtindocumentpropertycollection/pages) | Belgedeki tahmini sayfa sayısını temsil eder.|
...
| [document_version](/cells/tr/python-net/aspose.cells.properties/builtindocumentpropertycollection/document_version) | Dosyanın sürümünü temsil eder.|
| [scale_crop](/cells/tr/python-net/aspose.cells.properties/builtindocumentpropertycollection/scale_crop) | Belge küçük resminin görüntüleme modunu belirtir.|
| [links_up_to_date](/cells/tr/python-net/aspose.cells.properties/builtindocumentpropertycollection/links_up_to_date) | Bir belgedeki köprülerin güncel olup olmadığını gösterir.|
| [words](/cells/tr/python-net/aspose.cells.properties/builtindocumentpropertycollection/words) | Belgedeki sözcük sayısının tahminini temsil eder.|


###  Yöntemler
| Yöntem| Tanım|
| :- | :- |
| [index_of(name)](/cells/tr/python-net/aspose.cells.properties/builtindocumentpropertycollection/index_of/#str) | Ada göre bir özelliğin dizinini alır.|
...
[DocumentProperty](/cells/tr/python-net/aspose.cells.properties/documentproperty) nesnelerine adlarına göre erişim sağlar (bir indeksleyici kullanarak) ve
uygun türlerin değerlerini döndüren bir dizi yazılı özellik aracılığıyla.

###  Ayrıca bakınız
* modül [aspose.cells.properties](..)
* sınıf [BuiltInDocumentPropertyCollection](/cells/tr/python-net/aspose.cells.properties/builtindocumentpropertycollection)
