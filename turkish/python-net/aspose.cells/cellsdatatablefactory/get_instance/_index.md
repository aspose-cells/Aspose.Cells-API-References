...
type: docs
weight: 20
url: /tr/python-net/aspose.cells/cellsdatatablefactory/get_instance/
is_root: false
---
...
Verilen int değerleri dizisinden ICellsDataTable oluşturur.
...
##  get_instance(vals, column_names) {#list-list}
Verilen çift değer dizisinden ICellsDataTable oluşturur.
...
##  get_instance(vals, column_names) {#list-list}
Verilen nesne dizisinden ICellsDataTable oluşturur.
...
###  Ayrıca bakınız
* modül [aspose.cells](../../)
* sınıf [CellsDataTableFactory](/cells/tr/python-net/aspose.cells/cellsdatatablefactory)
