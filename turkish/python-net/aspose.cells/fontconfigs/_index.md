...
FontConfigs türü aşağıdaki üyeleri gösterir:

###  İnşaatçılar
| Yapıcı| Tanım|
| :- | :- |
| [FontConfigs()](/cells/tr/python-net/aspose.cells/fontconfigs/__init__/#) | FontConfigs'in yeni bir örneğini oluşturur|
...
| [set_font_sources(sources)](/cells/tr/python-net/aspose.cells/fontconfigs/set_font_sources/#list) | Yazı tipi kaynaklarını ayarlar.|
| [get_font_sources()](/cells/tr/python-net/aspose.cells/fontconfigs/get_font_sources/#) | Kaynakların listesini içeren dizinin bir kopyasını alır|
