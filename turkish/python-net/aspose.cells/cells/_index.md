...
Cells türü aşağıdaki üyeleri gösterir:
...
| [is_default_row_hidden](/cells/tr/python-net/aspose.cells/cells/is_default_row_hidden) | Satırın varsayılan olarak gizli olup olmadığını gösterir.|
| [columns](/cells/tr/python-net/aspose.cells/cells/columns) | Bu çalışma sayfasındaki tek tek sütunları temsil eden [Column](/cells/tr/python-net/aspose.cells/column) nesnelerinin koleksiyonunu alır.|
| [ranges](/cells/tr/python-net/aspose.cells/cells/ranges) | Çalışma zamanında oluşturulan [Range](/cells/tr/python-net/aspose.cells/range) nesne koleksiyonunu alır.|
| [last_cell](/cells/tr/python-net/aspose.cells/cells/last_cell) | Bu çalışma sayfasındaki son hücreyi alır.|
| [max_display_range](/cells/tr/python-net/aspose.cells/cells/max_display_range) | Verileri, birleştirilmiş hücreleri ve şekilleri içeren maksimum aralığı alır.|
| [first_cell](/cells/tr/python-net/aspose.cells/cells/first_cell) | Bu çalışma sayfasındaki ilk hücreyi alır.|



Çalışma sayfasında [Cell](/cells/tr/python-net/aspose.cells/cell) öğeyi alır
###  İndeksleyici
| İsim| Tanım|
| :- | :- |
...
| Yöntem| Tanım|
| :- | :- |
| [create_range(upper_left_cell, lower_right_cell)](/cells/tr/python-net/aspose.cells/cells/create_range/#str-str) | Bir dizi hücreden bir [Range](/cells/tr/python-net/aspose.cells/range) nesnesi oluşturur.|
...
| [import_csv(stream, options, first_row, first_column)](/cells/tr/python-net/aspose.cells/cells/import_csv/#io.RawIOBase-TxtLoadOptions-int-int) | CSV dosyasını hücrelere aktarın.|
| [merge(first_row, first_column, total_rows, total_columns)](/cells/tr/python-net/aspose.cells/cells/merge/#int-int-int-int) | Belirli bir hücre aralığını tek bir hücrede birleştirir.|
| [merge(first_row, first_column, total_rows, total_columns, merge_conflict)](/cells/tr/python-net/aspose.cells/cells/merge/#int-int-int-int-bool) | Belirli bir hücre aralığını tek bir hücrede birleştirir.|
| [merge(first_row, first_column, total_rows, total_columns, check_conflict, merge_conflict)](/cells/tr/python-net/aspose.cells/cells/merge/#int-int-int-int-bool-bool) | Belirli bir hücre aralığını tek bir hücrede birleştirir.|
| [copy_columns(source_cells0, source_column_index, destination_column_index, column_number, paste_options)](/cells/tr/python-net/aspose.cells/cells/copy_columns/#Cells-int-int-int-PasteOptions) | Tüm sütunun verilerini ve biçimlerini kopyalar.|
| [copy_columns(source_cells0, source_column_index, destination_column_index, column_number)](/cells/tr/python-net/aspose.cells/cells/copy_columns/#Cells-int-int-int) | Tüm sütunun verilerini ve biçimlerini kopyalar.|
| [copy_columns(source_cells, source_column_index, source_total_columns, destination_column_index, destination_total_columns)](/cells/tr/python-net/aspose.cells/cells/copy_columns/#Cells-int-int-int-int) | Tüm sütunların verilerini ve biçimlerini kopyalar.|
| [copy_rows(source_cells, source_row_index, destination_row_index, row_number)](/cells/tr/python-net/aspose.cells/cells/copy_rows/#Cells-int-int-int) | Bazı tam satırların verilerini ve biçimlerini kopyalar.|
| [copy_rows(source_cells0, source_row_index, destination_row_index, row_number, copy_options)](/cells/tr/python-net/aspose.cells/cells/copy_rows/#Cells-int-int-int-CopyOptions) | Bazı tam satırların verilerini ve biçimlerini kopyalar.|
...
| [delete_column(column_index)](/cells/tr/python-net/aspose.cells/cells/delete_column/#int) | Bir sütunu siler.|
| [delete_rows(row_index, total_rows)](/cells/tr/python-net/aspose.cells/cells/delete_rows/#int-int) | Birkaç satırı siler.|
...
| [clear_range(range)](/cells/tr/python-net/aspose.cells/cells/clear_range/#CellArea) | Bir aralığın içeriğini ve biçimlendirmesini temizler.|
| [clear_range(start_row, start_column, end_row, end_column)](/cells/tr/python-net/aspose.cells/cells/clear_range/#int-int-int-int) | Bir aralığın içeriğini ve biçimlendirmesini temizler.|
| [clear_contents(range)](/cells/tr/python-net/aspose.cells/cells/clear_contents/#CellArea) | Bir aralığın içeriğini temizler.|
| [clear_contents(start_row, start_column, end_row, end_column)](/cells/tr/python-net/aspose.cells/cells/clear_contents/#int-int-int-int) | Bir aralığın içeriğini temizler.|
| [clear_formats(range)](/cells/tr/python-net/aspose.cells/cells/clear_formats/#CellArea) | Bir aralığın biçimlendirmesini temizler.|
| [clear_formats(start_row, start_column, end_row, end_column)](/cells/tr/python-net/aspose.cells/cells/clear_formats/#int-int-int-int) | Bir aralığın biçimlendirmesini temizler.|
| [find(what, previous_cell)](/cells/tr/python-net/aspose.cells/cells/find/#any-Cell) | Giriş nesnesini içeren hücreyi bulur.|
| [find(what, previous_cell, find_options)](/cells/tr/python-net/aspose.cells/cells/find/#any-Cell-FindOptions) | Giriş nesnesini içeren hücreyi bulur.|
| [end_cell_in_row(row_index)](/cells/tr/python-net/aspose.cells/cells/end_cell_in_row/#int) | Bu satırdaki son hücreyi alır.|
| [end_cell_in_row(start_row, end_row, start_column, end_column)](/cells/tr/python-net/aspose.cells/cells/end_cell_in_row/#int-int-int-int) | Bu aralıktaki maksimum satır indeksine sahip son hücreyi alır.|
| [end_cell_in_column(column_index)](/cells/tr/python-net/aspose.cells/cells/end_cell_in_column/#int) | Bu sütundaki son hücreyi alır.|
| [end_cell_in_column(start_row, end_row, start_column, end_column)](/cells/tr/python-net/aspose.cells/cells/end_cell_in_column/#int-int-int-int) | Bu aralıktaki maksimum sütun indeksine sahip son hücreyi alır.|
| [insert_range(area, shift_number, shift_type, update_reference)](/cells/tr/python-net/aspose.cells/cells/insert_range/#CellArea-int-ShiftType-bool) | Bir hücre aralığı ekler ve kaydırma seçeneğine göre hücreleri kaydırır.|
| [insert_range(area, shift_type)](/cells/tr/python-net/aspose.cells/cells/insert_range/#CellArea-ShiftType) | Bir hücre aralığı ekler ve kaydırma seçeneğine göre hücreleri kaydırır.|
| [insert_range(area, shift_number, shift_type)](/cells/tr/python-net/aspose.cells/cells/insert_range/#CellArea-int-ShiftType) | Bir hücre aralığı ekler ve kaydırma seçeneğine göre hücreleri kaydırır.|
| [import_custom_objects(list, property_names, is_property_name_shown, first_row, first_column, row_number, insert_rows, date_format_string, convert_string_to_number)](/cells/tr/python-net/aspose.cells/cells/import_custom_objects/#list-list-bool-int-int-int-bool-str-bool) | Özel nesneleri içe aktarır.|
| [import_custom_objects(list, first_row, first_column, options)](/cells/tr/python-net/aspose.cells/cells/import_custom_objects/#list-int-int-ImportTableOptions) | Özel nesneleri içe aktarır.|
| [subtotal(ca, group_by, function, total_list)](/cells/tr/python-net/aspose.cells/cells/subtotal/#CellArea-int-ConsolidationFunction-list) | Aralık için alt toplamlar oluşturur.|
| [subtotal(ca, group_by, function, total_list, replace, page_breaks, summary_below_data)](/cells/tr/python-net/aspose.cells/cells/subtotal/#CellArea-int-ConsolidationFunction-list-bool-bool-bool) | Aralık için alt toplamlar oluşturur.|
| [remove_duplicates()](/cells/tr/python-net/aspose.cells/cells/remove_duplicates/#) | Sayfadaki yinelenen satırları kaldırır.|
| [remove_duplicates(start_row, start_column, end_row, end_column)](/cells/tr/python-net/aspose.cells/cells/remove_duplicates/#int-int-int-int) | Aralıktaki yinelenen değerleri kaldırır.|
...
| [add_range(range_object)](/cells/tr/python-net/aspose.cells/cells/add_range/#Range) | Hücrelere bir aralık nesnesi referansı ekler|
...
| [set_row_height_inch(row, inches)](/cells/tr/python-net/aspose.cells/cells/set_row_height_inch/#int-float) | Satır yüksekliğini inç cinsinden ayarlar.|
...
| [get_row_height_inch(row)](/cells/tr/python-net/aspose.cells/cells/get_row_height_inch/#int) | Belirli bir satırın yüksekliğini inç cinsinden alır.|
| [get_view_row_height_inch(row)](/cells/tr/python-net/aspose.cells/cells/get_view_row_height_inch/#int) | Belirli bir satırın yüksekliğini inç cinsinden alır.|
...
| [show_group_detail(is_vertical, index)](/cells/tr/python-net/aspose.cells/cells/show_group_detail/#bool-int) | Gruplandırılmış satırları/sütunları genişletir.|
| [hide_group_detail(is_vertical, index)](/cells/tr/python-net/aspose.cells/cells/hide_group_detail/#bool-int) | Gruplandırılmış satırları/sütunları daraltır.|
| [ungroup_columns(first_index, last_index)](/cells/tr/python-net/aspose.cells/cells/ungroup_columns/#int-int) | Sütunların grubunu çözer.|
| [delete_columns(column_index, total_columns, update_reference)](/cells/tr/python-net/aspose.cells/cells/delete_columns/#int-int-bool) | Birkaç sütunu siler.|
| [is_deleting_range_enabled(start_row, start_column, total_rows, total_columns)](/cells/tr/python-net/aspose.cells/cells/is_deleting_range_enabled/#int-int-int-int) | Aralığın silinip silinemeyeceğini kontrol edin.|
| [delete_row(row_index)](/cells/tr/python-net/aspose.cells/cells/delete_row/#int) | Bir satırı siler.|
| [is_blank_column(column_index)](/cells/tr/python-net/aspose.cells/cells/is_blank_column/#int) | Verilen sütunun boş olup olmadığını kontrol eder (herhangi bir veri içermez).|
| [insert_row(row_index)](/cells/tr/python-net/aspose.cells/cells/insert_row/#int) | Çalışma sayfasına yeni bir satır ekler.|
| [link_to_xml_map(map_name, row, column, path)](/cells/tr/python-net/aspose.cells/cells/link_to_xml_map/#str-int-int-str) | Bir xml haritasına bağlantı.|
| [find_formula(formula, previous_cell)](/cells/tr/python-net/aspose.cells/cells/find_formula/#str-Cell) | Giriş dizesine sahip hücreyi bulur.|
| [find_formula_contains(formula, previous_cell)](/cells/tr/python-net/aspose.cells/cells/find_formula_contains/#str-Cell) | Giriş dizesini içeren formülü içeren hücreyi bulur.|
| [move_range(source_area, dest_row, dest_column)](/cells/tr/python-net/aspose.cells/cells/move_range/#CellArea-int-int) | Aralığı hareket ettirir.|
...
###  Ayrıca bakınız
* modül [aspose.cells](..)
* sınıf [Cell](/cells/tr/python-net/aspose.cells/cell)
* sınıf [Column](/cells/tr/python-net/aspose.cells/column)
* sınıf [Range](/cells/tr/python-net/aspose.cells/range)
