---
title: find_formula_contains yöntemi
second_title: Aspose.Cells for Python via .NET API Referanslar
description:
type: docs
weight: 310
url: /tr/python-net/aspose.cells/cells/find_formula_contains/
is_root: false
---
##  find_formula_contains(formula, previous_cell) {#str-Cell}
Giriş dizesini içeren formülü içeren hücreyi bulur.
...
lütfen Cells.Find(object,Cell,FindOptions) yöntemini LookInType ile LookInType.OnlyFormulas olarak kullanın
 ve LookAtType.Contains olarak LookAtType.
