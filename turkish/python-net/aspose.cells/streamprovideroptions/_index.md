...
StreamProviderOptions türü aşağıdaki üyeleri gösterir:

###  İnşaatçılar
| Yapıcı| Tanım|
| :- | :- |
| [StreamProviderOptions(loading_type, default_path)](/cells/tr/python-net/aspose.cells/streamprovideroptions/__init__/#ResourceLoadingType-str) | [StreamProviderOptions](/cells/tr/python-net/aspose.cells/streamprovideroptions) sınıfının yeni bir örneğini başlatır.|
| [StreamProviderOptions()](/cells/tr/python-net/aspose.cells/streamprovideroptions/__init__/#) | [StreamProviderOptions](/cells/tr/python-net/aspose.cells/streamprovideroptions) sınıfının yeni bir örneğini başlatır.|
...
###  Ayrıca bakınız
* modül [aspose.cells](..)
* sınıf [StreamProviderOptions](/cells/tr/python-net/aspose.cells/streamprovideroptions)
