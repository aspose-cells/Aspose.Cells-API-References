...
Workbook türü aşağıdaki üyeleri gösterir:

###  İnşaatçılar
| Yapıcı| Tanım|
| :- | :- |
| [Workbook()](/cells/tr/python-net/aspose.cells/workbook/__init__/#) | [Workbook](/cells/tr/python-net/aspose.cells/workbook) sınıfının yeni bir örneğini başlatır.|
| [Workbook(file_format_type)](/cells/tr/python-net/aspose.cells/workbook/__init__/#FileFormatType) | [Workbook](/cells/tr/python-net/aspose.cells/workbook) sınıfının yeni bir örneğini başlatır.|
| [Workbook(file)](/cells/tr/python-net/aspose.cells/workbook/__init__/#str) | [Workbook](/cells/tr/python-net/aspose.cells/workbook) sınıfının yeni bir örneğini başlatır ve bir dosya açar.|
| [Workbook(stream)](/cells/tr/python-net/aspose.cells/workbook/__init__/#io.RawIOBase) | [Workbook](/cells/tr/python-net/aspose.cells/workbook) sınıfının yeni bir örneğini başlatır ve bir akış açar.|
| [Workbook(file, load_options)](/cells/tr/python-net/aspose.cells/workbook/__init__/#str-LoadOptions) | [Workbook](/cells/tr/python-net/aspose.cells/workbook) sınıfının yeni bir örneğini başlatır ve bir dosya açar.|
| [Workbook(stream, load_options)](/cells/tr/python-net/aspose.cells/workbook/__init__/#io.RawIOBase-LoadOptions) | [Workbook](/cells/tr/python-net/aspose.cells/workbook) sınıfının ve açık akışın yeni bir örneğini başlatır.|


###  Özellikler
| Mülk| Tanım|
| :- | :- |
| [settings](/cells/tr/python-net/aspose.cells/workbook/settings) | Çalışma kitabı ayarlarını temsil eder.|
| [worksheets](/cells/tr/python-net/aspose.cells/workbook/worksheets) | Elektronik tablodaki [WorksheetCollection](/cells/tr/python-net/aspose.cells/worksheetcollection) koleksiyonunu alır.|
| [is_licensed](/cells/tr/python-net/aspose.cells/workbook/is_licensed) | Lisansın ayarlanıp ayarlanmadığını gösterir.|
| [colors](/cells/tr/python-net/aspose.cells/workbook/colors) | Elektronik tablo için paletteki renkleri döndürür.|
...
| [data_mashup](/cells/tr/python-net/aspose.cells/workbook/data_mashup) | Mashup verilerini alır.|
| [ribbon_xml](/cells/tr/python-net/aspose.cells/workbook/ribbon_xml) | Şerit Kullanıcı Arabirimini tanımlayan XML dosyasını alır ve ayarlar.|
| [absolute_path](/cells/tr/python-net/aspose.cells/workbook/absolute_path) | Dosyanın mutlak yolunu alır ve ayarlar.|
| [data_connections](/cells/tr/python-net/aspose.cells/workbook/data_connections) | [ExternalConnection](/cells/tr/python-net/aspose.cells.externalconnections/externalconnection) koleksiyonunu alır.|


###  Yöntemler
| Yöntem| Tanım|
| :- | :- |
| [save(file_name, save_format)](/cells/tr/python-net/aspose.cells/workbook/save/#str-SaveFormat) | Çalışma kitabını diske kaydeder.|
| [save(file_name)](/cells/tr/python-net/aspose.cells/workbook/save/#str) | Çalışma kitabını diskete kaydedin.|
| [save(file_name, save_options)](/cells/tr/python-net/aspose.cells/workbook/save/#str-SaveOptions) | Çalışma kitabını diske kaydeder.|
...
| [calculate_formula(options)](/cells/tr/python-net/aspose.cells/workbook/calculate_formula/#CalculationOptions) | Bu çalışma kitabında formüllerin hesaplanması.|
| [refresh_dynamic_array_formulas(calculate)](/cells/tr/python-net/aspose.cells/workbook/refresh_dynamic_array_formulas/#bool) | Dinamik dizi formüllerini yeniler (mevcut verilere göre yeni komşu hücre aralığına taşar)<br/> Çalışma kitabındaki diğer formüller, dinamik dizi formülleri tarafından kullanılmış olsalar bile yinelemeli olarak hesaplanmayacaktır.|
| [refresh_dynamic_array_formulas(calculate, copts)](/cells/tr/python-net/aspose.cells/workbook/refresh_dynamic_array_formulas/#bool-CalculationOptions) | Dinamik dizi formüllerini yeniler (mevcut verilere göre yeni komşu hücre aralığına taşar)|
| [import_xml(url, sheet_name, row, col)](/cells/tr/python-net/aspose.cells/workbook/import_xml/#str-str-int-int) | Bir XML veri dosyasını çalışma kitabına aktarır/günceller.|
| [import_xml(stream, sheet_name, row, col)](/cells/tr/python-net/aspose.cells/workbook/import_xml/#io.RawIOBase-str-int-int) | Bir XML veri dosyasını çalışma kitabına aktarır/günceller.|
...
| [get_style_in_pool(index)](/cells/tr/python-net/aspose.cells/workbook/get_style_in_pool/#int) | Stil havuzundaki stili alır.<br/>Çalışma kitabındaki tüm stiller bir havuzda toplanacaktır.<br/> Hücrelerde sadece basit bir referans dizini vardır.|
| [get_fonts()](/cells/tr/python-net/aspose.cells/workbook/get_fonts/#) | Stil havuzundaki tüm yazı tiplerini alır.|
| [get_named_style(name)](/cells/tr/python-net/aspose.cells/workbook/get_named_style/#str) | Stil havuzunda belirtilen stili alır.|
| [change_palette(color, index)](/cells/tr/python-net/aspose.cells/workbook/change_palette/#aspose.pydrawing.Color-int) | Belirtilen dizindeki elektronik tablonun paletini değiştirir.|
| [is_color_in_palette(color)](/cells/tr/python-net/aspose.cells/workbook/is_color_in_palette/#aspose.pydrawing.Color) | Elektronik tablo için palette bir renk olup olmadığını kontrol eder.|
| [get_matching_color(raw_color)](/cells/tr/python-net/aspose.cells/workbook/get_matching_color/#aspose.pydrawing.Color) | Mevcut palette en iyi eşleşen Rengi bulun.|
| [set_encryption_options(encryption_type, key_length)](/cells/tr/python-net/aspose.cells/workbook/set_encryption_options/#EncryptionType-int) | Şifreleme Seçeneklerini Ayarlayın.|
| [protect(protection_type, password)](/cells/tr/python-net/aspose.cells/workbook/protect/#ProtectionType-str) | Bir çalışma kitabını korur.|
| [protect_shared_workbook(password)](/cells/tr/python-net/aspose.cells/workbook/protect_shared_workbook/#str) | Paylaşılan bir çalışma kitabını korur.|
| [unprotect(password)](/cells/tr/python-net/aspose.cells/workbook/unprotect/#str) | Bir çalışma kitabının korumasını kaldırır.|
| [unprotect_shared_workbook(password)](/cells/tr/python-net/aspose.cells/workbook/unprotect_shared_workbook/#str) | Paylaşılan bir çalışma kitabının korumasını kaldırır.|
...
| [remove_personal_information()](/cells/tr/python-net/aspose.cells/workbook/remove_personal_information/#) | Kişisel bilgileri kaldırır.|
...
###  Ayrıca bakınız
* modül [aspose.cells](..)
* sınıf [CellsColor](/cells/tr/python-net/aspose.cells/cellscolor)
...
* sınıf [Style](/cells/tr/python-net/aspose.cells/style)
* sınıf [Workbook](/cells/tr/python-net/aspose.cells/workbook)
* sınıf [WorksheetCollection](/cells/tr/python-net/aspose.cells/worksheetcollection)
