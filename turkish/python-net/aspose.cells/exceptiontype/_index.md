...
type: docs
weight: 2020
url: /tr/python-net/aspose.cells/exceptiontype/
is_root: false
---
##  ExceptionType numaralandırma
...
| DATA_TYPE | Geçersiz veri türü ayarı.|
| DATA_VALIDATION | Geçersiz veri doğrulama ayarı.|
| CONDITIONAL_FORMATTING | Geçersiz veri doğrulama ayarı.|
| FILE_FORMAT | Geçersiz dosya formatı.|
