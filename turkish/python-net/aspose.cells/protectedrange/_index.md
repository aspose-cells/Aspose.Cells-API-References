...
ProtectedRange türü aşağıdaki üyeleri gösterir:
...
| Yöntem| Tanım|
| :- | :- |
| [get_areas()](/cells/tr/python-net/aspose.cells/protectedrange/get_areas/#) | Yönlendirilen tüm alanları alır.|
| [add_area(start_row, start_column, end_row, end_column)](/cells/tr/python-net/aspose.cells/protectedrange/add_area/#int-int-int-int) | Buna yönlendirilen bir alan ekler|
