...
type: docs
weight: 60
url: /tr/python-net/aspose.cells/conditionalformattingcollection/last_index_of/
is_root: false
---
##  last_index_of(item) {#FormatConditionCollection}
...
| Parametre| Tip| Tanım|
| :- | :- | :- |
| item | [FormatConditionCollection](/cells/tr/python-net/aspose.cells/formatconditioncollection) | Dizi listesinde bulunacak nesne. Değer null olabilir.|
...
###  Ayrıca bakınız
* modül [aspose.cells](../../)
* sınıf [ConditionalFormattingCollection](/cells/tr/python-net/aspose.cells/conditionalformattingcollection)
