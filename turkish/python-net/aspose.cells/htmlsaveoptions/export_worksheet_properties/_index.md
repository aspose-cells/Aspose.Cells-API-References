---
title: export_worksheet_properties mülk
second_title: Aspose.Cells for Python via .NET API Referanslar
description:
type: docs
weight: 370
url: /tr/python-net/aspose.cells/htmlsaveoptions/export_worksheet_properties/
is_root: false
---
##  export_worksheet_properties mülk

 Çalışma sayfası özelliklerinin dışa aktarılıp aktarılmadığını belirtir.Varsayılan değer true'dur.İçe aktarmak istiyorsanız
