...
type: docs
weight: 50
url: /tr/python-net/aspose.cells/dxfcollection/last_index_of/
is_root: false
---
##  last_index_of(item) {#Style}
...
| Parametre| Tip| Tanım|
| :- | :- | :- |
| item | [Style](/cells/tr/python-net/aspose.cells/style) | Dizi listesinde bulunacak nesne. Değer null olabilir.|
...
##  last_index_of(item, index, count) {#Style-int-int}
...
###  Ayrıca bakınız
* modül [aspose.cells](../../)
* sınıf [DxfCollection](/cells/tr/python-net/aspose.cells/dxfcollection)
