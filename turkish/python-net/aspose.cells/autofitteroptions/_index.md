...
AutoFitterOptions türü aşağıdaki üyeleri gösterir:

###  İnşaatçılar
| Yapıcı| Tanım|
| :- | :- |
| [AutoFitterOptions()](/cells/tr/python-net/aspose.cells/autofitteroptions/__init__/#) | AutoFitterOptions'ın yeni bir örneğini oluşturur|


###  Özellikler
| Mülk| Tanım|
| :- | :- |
| [default_edit_language](/cells/tr/python-net/aspose.cells/autofitteroptions/default_edit_language) | Varsayılan düzenleme dilini alır veya ayarlar.|
| [auto_fit_merged_cells](/cells/tr/python-net/aspose.cells/autofitteroptions/auto_fit_merged_cells) | Hücreler bir satırda birleştirildiğinde satır yüksekliğinin otomatik sığdırılıp sığdırılmayacağını belirtir.<br/> Varsayılan değer yanlıştır.|
