...
type: docs
weight: 280
url: /tr/python-net/aspose.cells/worksheet/start_access_cache/
is_root: false
---
##  start_access_cache(opts) {#AccessCacheOptions}
Bu çalışma sayfasındaki verilere erişmek için önbellekleri kullanan oturumu başlatır.
...
Verilere erişimi bitirdikten sonra [Worksheet.close_access_cache(opts)](/cells/tr/python-net/aspose.cells/worksheet/close_access_cache)
