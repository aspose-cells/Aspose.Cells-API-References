...
type: docs
weight: 10
url: /tr/python-net/aspose.cells/
is_root: false
---
 bu**Aspose.Cells** ad alanı, Microsoft Excel'i kullanmadan Elektronik Tabloları oluşturmak, dönüştürmek, değiştirmek, işlemek ve yazdırmak için temel ve temel sınıflar sağlar.
Örneğin, [Workbook](/cells/tr/python-net/aspose.cells/workbook) sınıfı, bir elektronik tablo dosyası oluşturmak veya yüklemek ve ardından işlemek için ana giriştir.
[Cells](/cells/tr/python-net/aspose.cells/cells) sınıfı, bir sayfadaki tüm verileri ve özellikleri işlemek için ana sınıftır, ...vb.
...
| [Border](/cells/tr/python-net/aspose.cells/border) | Hücre kenarlığını temsil eden nesneyi kapsüller.|
| [BorderCollection](/cells/tr/python-net/aspose.cells/bordercollection) | [Border](/cells/tr/python-net/aspose.cells/border) nesne koleksiyonunu kapsüller.|
| [CalculationCell](/cells/tr/python-net/aspose.cells/calculationcell) | Hesaplanmakta olan bir hücreyle ilgili hesaplamayla ilgili verileri temsil eder.|
| [CalculationData](/cells/tr/python-net/aspose.cells/calculationdata) | Fonksiyon adı, parametreler, ...vb. gibi bir fonksiyonu hesaplarken gerekli verileri temsil eder.|
| [CalculationOptions](/cells/tr/python-net/aspose.cells/calculationoptions) | Hesaplama seçeneklerini temsil eder.|
| [Cell](/cells/tr/python-net/aspose.cells/cell) | Tek bir Çalışma Kitabı hücresini temsil eden nesneyi kapsüller.|
| [CellArea](/cells/tr/python-net/aspose.cells/cellarea) | Bir hücre alanını temsil eder.|
| [CellWatch](/cells/tr/python-net/aspose.cells/cellwatch) | 'İzleme penceresinde' Cell İzleme Öğesini temsil eder.|
| [CellWatchCollection](/cells/tr/python-net/aspose.cells/cellwatchcollection) | Bu çalışma sayfasındaki 'izleme penceresinde' izlenen hücre koleksiyonunu temsil eder.|
| [Cells](/cells/tr/python-net/aspose.cells/cells) | [Cell](/cells/tr/python-net/aspose.cells/cell), [Row](/cells/tr/python-net/aspose.cells/row), ...vb. gibi hücreyle ilgili nesnelerin bir koleksiyonunu kapsüller.|
| [CellsColor](/cells/tr/python-net/aspose.cells/cellscolor) | Her türlü rengi temsil eder.|
| [CellsDataTableFactory](/cells/tr/python-net/aspose.cells/cellsdatatablefactory) |Kullanıcının rahatlığı için özel nesnelerden ICellsDataTable oluşturmak için yardımcı program.|
| [CellsException](/cells/tr/python-net/aspose.cells/cellsexception) | Aspose.Cells belirtilen hata oluştuğunda atılan istisna.|
| [CellsFactory](/cells/tr/python-net/aspose.cells/cellsfactory) | Cells modelinin sınıflarını başlatmak için yardımcı program.|
| [CellsHelper](/cells/tr/python-net/aspose.cells/cellshelper) | Yardımcı işlevler sağlar.|
...
| [CustomImplementationFactory](/cells/tr/python-net/aspose.cells/customimplementationfactory) | Özel amaçlar için kullanıcı tarafından yeniden uygulanabilecek bazı örnekler oluşturmak için fabrika.|
| [DataBar](/cells/tr/python-net/aspose.cells/databar) | DataBar koşullu biçimlendirme kuralını açıklayın.<br/>Bu koşullu biçimlendirme kuralı, derecelendirilmiş bir<br/> hücre aralığındaki veri çubuğu.|
| [DataBarBorder](/cells/tr/python-net/aspose.cells/databarborder) | Koşullu biçimlendirme kuralı tarafından belirtilen veri çubuklarının kenarlığını temsil eder.|
| [DataSorter](/cells/tr/python-net/aspose.cells/datasorter) | DataSorter için özet açıklama.|
| [DataSorterKey](/cells/tr/python-net/aspose.cells/datasorterkey) | Veri sıralayıcının anahtarını temsil eder.|
| [DataSorterKeyCollection](/cells/tr/python-net/aspose.cells/datasorterkeycollection) | Veri sıralayıcının anahtar listesini temsil eder.|
...
| [ExternalLinkCollection](/cells/tr/python-net/aspose.cells/externallinkcollection) | Bir çalışma kitabındaki dış bağlantılar koleksiyonunu temsil eder.|
...
| [Font](/cells/tr/python-net/aspose.cells/font) | Elektronik tabloda kullanılan yazı tipi nesnesini kapsüller.|
| [FontConfigs](/cells/tr/python-net/aspose.cells/fontconfigs) | Yazı tipi ayarlarını belirtir|
| [FontSetting](/cells/tr/python-net/aspose.cells/fontsetting) |Hücre metni içindeki bir karakter aralığını temsil eder.|
| [FontSourceBase](/cells/tr/python-net/aspose.cells/fontsourcebase) | Bu, kullanıcının çeşitli yazı tipi kaynakları belirtmesine izin veren sınıflar için soyut bir temel sınıftır.|
...
| [IStreamProvider](/cells/tr/python-net/aspose.cells/istreamprovider) | Dışa aktarılan akış sağlayıcısını temsil eder.|
| [IWarningCallback](/cells/tr/python-net/aspose.cells/iwarningcallback) | Uyarının geri arama arayüzü.|
| [IconFilter](/cells/tr/python-net/aspose.cells/iconfilter) | Simge filtresini temsil eder.|
| [IconSet](/cells/tr/python-net/aspose.cells/iconset) | IconSet koşullu biçimlendirme kuralını açıklayın.<br/>Bu koşullu biçimlendirme kuralı, simgeleri hücrelere uygular<br/> değerlerine göre.|
| [ImageSaveOptions](/cells/tr/python-net/aspose.cells/imagesaveoptions) | Görüntü kaydetme seçeneklerini temsil eder.<br/> Gelişmiş kullanım için lütfen [WorkbookRender](/cells/tr/python-net/aspose.cells.rendering/workbookrender) veya [SheetRender](/cells/tr/python-net/aspose.cells.rendering/sheetrender)'i kullanın.|
...
| [LightCellsDataHandler](/cells/tr/python-net/aspose.cells/lightcellsdatahandler) | Büyük elektronik tablo dosyalarını hafif ağırlık modunda okumak için hücre veri işleyicisini temsil eder.|
| [LightCellsDataProvider](/cells/tr/python-net/aspose.cells/lightcellsdataprovider) | Büyük elektronik tablo dosyalarını hafif ağırlık modunda kaydetmek için Veri sağlayıcıyı temsil eder.|
| [LoadFilter](/cells/tr/python-net/aspose.cells/loadfilter) | Çalışma kitabını şablondan yüklerken veri yüklemek için seçenekler sağlayan filtreyi temsil eder.|
...
| [NegativeBarFormat](/cells/tr/python-net/aspose.cells/negativebarformat) | Veri çubuğu koşullu biçimlendirme kuralı tarafından tanımlanan negatif değerler için veri çubuklarının renk ayarlarını temsil eder.|
| [OdsLoadOptions](/cells/tr/python-net/aspose.cells/odsloadoptions) | ods dosyası yükleme seçeneklerini temsil eder.|
| [OdsSaveOptions](/cells/tr/python-net/aspose.cells/odssaveoptions) | Ods dosyasını kaydetme seçeneklerini temsil eder.|
| [OoxmlSaveOptions](/cells/tr/python-net/aspose.cells/ooxmlsaveoptions) | Office açık xml dosyasını kaydetme seçeneklerini temsil eder.|
| [Outline](/cells/tr/python-net/aspose.cells/outline) | Bir çalışma sayfasındaki bir taslağı temsil eder.|
| [PageSetup](/cells/tr/python-net/aspose.cells/pagesetup) | Sayfa düzeni açıklamasını temsil eden nesneyi kapsüller.<br/> PageSetup nesnesi, tüm sayfa yapısı seçeneklerini içerir.|
...
| [Protection](/cells/tr/python-net/aspose.cells/protection) | Bir çalışma sayfası için kullanılabilen çeşitli koruma seçenekleri türlerini temsil eder.|
| [QueryTable](/cells/tr/python-net/aspose.cells/querytable) | QueryTable bilgilerini temsil eder.|
| [QueryTableCollection](/cells/tr/python-net/aspose.cells/querytablecollection) | QueryTable koleksiyon bilgilerini temsil eden [QueryTableCollection](/cells/tr/python-net/aspose.cells/querytablecollection) nesne koleksiyonu.|
| [Range](/cells/tr/python-net/aspose.cells/range) | Bir elektronik tablodaki bir hücre aralığını temsil eden nesneyi kapsüller.|
| [RangeCollection](/cells/tr/python-net/aspose.cells/rangecollection) | [Range](/cells/tr/python-net/aspose.cells/range) nesne koleksiyonunu kapsüller.|
| [ReferredArea](/cells/tr/python-net/aspose.cells/referredarea) | Belirtilen bir alanı formülle temsil eder.|
| [ReferredAreaCollection](/cells/tr/python-net/aspose.cells/referredareacollection) | Başvurulan tüm hücreleri ve alanları temsil eder.|
| [ReplaceOptions](/cells/tr/python-net/aspose.cells/replaceoptions) | Değiştirme seçeneklerini temsil edin.|
| [Row](/cells/tr/python-net/aspose.cells/row) | Çalışma sayfasındaki tek bir satırı temsil eder.|
| [RowCollection](/cells/tr/python-net/aspose.cells/rowcollection) | Bir çalışma sayfasındaki tek tek satırları temsil eden [Row](/cells/tr/python-net/aspose.cells/row) nesnelerini toplar.|
| [SaveOptions](/cells/tr/python-net/aspose.cells/saveoptions) | Tüm kaydetme seçeneklerini temsil eder|
| [Scenario](/cells/tr/python-net/aspose.cells/scenario) | Tek bir senaryoyu temsil eder.|
...
| [SubtotalSetting](/cells/tr/python-net/aspose.cells/subtotalsetting) | Ara toplamın ayarını temsil eder.|
| [SvgSaveOptions](/cells/tr/python-net/aspose.cells/svgsaveoptions) | Svg kaydetme seçeneklerini temsil eder.<br/> Gelişmiş kullanım için lütfen [WorkbookRender](/cells/tr/python-net/aspose.cells.rendering/workbookrender) veya [SheetRender](/cells/tr/python-net/aspose.cells.rendering/sheetrender)'i kullanın.|
| [ThemeColor](/cells/tr/python-net/aspose.cells/themecolor) | Bir tema rengini temsil eder.|
| [ThreadedComment](/cells/tr/python-net/aspose.cells/threadedcomment) | Zincirleme açıklamayı temsil eder.|
...
| [Workbook](/cells/tr/python-net/aspose.cells/workbook) | Bir Excel elektronik tablosu oluşturmak için bir kök nesneyi temsil eder.|
| [WorkbookDesigner](/cells/tr/python-net/aspose.cells/workbookdesigner) | Bir tasarımcı elektronik tablosunu temsil eden nesneyi kapsüller.|
| [WorkbookSettings](/cells/tr/python-net/aspose.cells/workbooksettings) | Çalışma kitabının tüm ayarlarını temsil eder.|
| [Worksheet](/cells/tr/python-net/aspose.cells/worksheet) | Tek bir çalışma sayfasını temsil eden nesneyi kapsüller.|
...
| [XmlMap](/cells/tr/python-net/aspose.cells/xmlmap) | Xml eşleme bilgilerini temsil eder.|
| [XmlMapCollection](/cells/tr/python-net/aspose.cells/xmlmapcollection) | XmlMap bilgilerini temsil eden [XmlMap](/cells/tr/python-net/aspose.cells/xmlmap) nesne koleksiyonu.|
| [XmlSaveOptions](/cells/tr/python-net/aspose.cells/xmlsaveoptions) | Çalışma kitabını xml dosyası olarak kaydetme seçeneklerini temsil eder.|
| [XpsSaveOptions](/cells/tr/python-net/aspose.cells/xpssaveoptions) | Dosyayı Xps olarak kaydederken ek seçenekleri temsil eder.|
...
| [ColorType](/cells/tr/python-net/aspose.cells/colortype) | Tüm renk türlerini temsil eder|
| [ConsolidationFunction](/cells/tr/python-net/aspose.cells/consolidationfunction) | Konsolidasyon fonksiyonunu temsil eder.|
| [CopyFormatType](/cells/tr/python-net/aspose.cells/copyformattype) | Satır eklerken kopyalama biçiminin türünü temsil eder.|
| [CountryCode](/cells/tr/python-net/aspose.cells/countrycode) | Excel ülke tanımlayıcılarını temsil eder.|
| [DataBarAxisPosition](/cells/tr/python-net/aspose.cells/databaraxisposition) |Veri çubukları olarak koşullu biçimlendirmeye sahip bir hücre aralığı için eksen konumunu belirtir.|
| [DataBarBorderType](/cells/tr/python-net/aspose.cells/databarbordertype) | Bir veri çubuğunun kenarlık türünü belirtir.|
| [DataBarFillType](/cells/tr/python-net/aspose.cells/databarfilltype) | Bir veri çubuğunun renkle nasıl doldurulacağını belirtir.|
| [DataBarNegativeColorType](/cells/tr/python-net/aspose.cells/databarnegativecolortype) | Pozitif veri çubukları olarak aynı kenarlık ve dolgu renginin kullanılıp kullanılmayacağını belirtir.|
| [DateTimeGroupingType](/cells/tr/python-net/aspose.cells/datetimegroupingtype) | dateTime değerlerinin nasıl gruplanacağını belirtir.|
| [DefaultEditLanguage](/cells/tr/python-net/aspose.cells/defaulteditlanguage) | Varsayılan düzenleme dilini temsil eder.|
| [DirectoryType](/cells/tr/python-net/aspose.cells/directorytype) | Dosya adının dizin türünü temsil eder.|
| [DisplayDrawingObjects](/cells/tr/python-net/aspose.cells/displaydrawingobjects) | Çalışma kitabında nesnelerin gösterilip gösterilmeyeceğini ve nasıl gösterileceğini temsil eder.|
...
| [FilterOperatorType](/cells/tr/python-net/aspose.cells/filteroperatortype) | Özel Filtre operatör tipi.|
| [FilterType](/cells/tr/python-net/aspose.cells/filtertype) | Filtre türü.|
| [FontSchemeType](/cells/tr/python-net/aspose.cells/fontschemetype) | Yazı tipinin şema türünü temsil eder.|
| [FontSourceType](/cells/tr/python-net/aspose.cells/fontsourcetype) | Yazı tipi kaynağının türünü belirtir.|
...
| [LookInType](/cells/tr/python-net/aspose.cells/lookintype) | Görünüm tipini temsil eder.|
| [MemorySetting](/cells/tr/python-net/aspose.cells/memorysetting) | Bellek kullanım seçenekleri.|
| [NameScopeType](/cells/tr/python-net/aspose.cells/namescopetype) | Tanımlı adların kapsam türünü temsil eder.|
| [NumberCategoryType](/cells/tr/python-net/aspose.cells/numbercategorytype) | Hücrenin sayı biçimlendirmesinin kategori türünü temsil eder.|
| [OoxmlCompliance](/cells/tr/python-net/aspose.cells/ooxmlcompliance) |Xlsx biçiminde kaydederken hangi OOXML spesifikasyonunun kullanılacağını belirlemeye izin verir.|
| [OoxmlCompressionType](/cells/tr/python-net/aspose.cells/ooxmlcompressiontype) | Ooxml sıkıştırma türü|
| [OperatorType](/cells/tr/python-net/aspose.cells/operatortype) | Koşullu biçim ve veri doğrulama işleç türünü temsil eder.|
| [PageLayoutAlignmentType](/cells/tr/python-net/aspose.cells/pagelayoutalignmenttype) | Sayfa düzeni hizalama türlerini numaralandırır.|
| [PageOrientationType](/cells/tr/python-net/aspose.cells/pageorientationtype) | Yazdırma yönü sabitlerini temsil eder.|
| [PaneStateType](/cells/tr/python-net/aspose.cells/panestatetype) | Sayfa bölmesinin durumunu temsil eder.|
| [PaperSizeType](/cells/tr/python-net/aspose.cells/papersizetype) | Kağıt boyutu sabitlerini temsil eder.|
| [ParameterType](/cells/tr/python-net/aspose.cells/parametertype) | Tüm parametrelerin tipini veya dönüş değeri fonksiyon tipini temsil eder.|
...
| [ProtectionType](/cells/tr/python-net/aspose.cells/protectiontype) | Çalışma kitabı/çalışma sayfası koruma türünü temsil eder.|
| [RenameStrategy](/cells/tr/python-net/aspose.cells/renamestrategy) | Yinelenen sütun adları için strateji seçeneği.|
| [ResourceLoadingType](/cells/tr/python-net/aspose.cells/resourceloadingtype) | Bağlantılı kaynağın nasıl yükleneceğini temsil eder.|
| [SaveFormat](/cells/tr/python-net/aspose.cells/saveformat) | Çalışma kitabının kaydedildiği biçimi temsil eder.|
| [SheetType](/cells/tr/python-net/aspose.cells/sheettype) | Çalışma sayfası türünü belirtir.|
| [ShiftType](/cells/tr/python-net/aspose.cells/shifttype) |Bir hücre aralığını silerken kaydırma seçeneklerini temsil edin.|
| [SortOnType](/cells/tr/python-net/aspose.cells/sortontype) | Sıralanmış değer türü.|
| [SortOrder](/cells/tr/python-net/aspose.cells/sortorder) | Veri aralığı için sıralama düzenini temsil eder.|
| [StyleModifyFlag](/cells/tr/python-net/aspose.cells/stylemodifyflag) | Stil değiştirilmiş bayraklar.|
| [TargetModeType](/cells/tr/python-net/aspose.cells/targetmodetype) | Hedef modun türünü temsil eder.|
| [TextAlignmentType](/cells/tr/python-net/aspose.cells/textalignmenttype) | Metin hizalama türlerini numaralandırır.|
| [TextCapsType](/cells/tr/python-net/aspose.cells/textcapstype) | Bu tür, metnin büyük harf türlerini belirtir.|
| [TextCrossType](/cells/tr/python-net/aspose.cells/textcrosstype) | Metin genişliği hücre genişliğinden büyük olduğunda görüntülenen metin türünü numaralandırır.|
| [TextDirectionType](/cells/tr/python-net/aspose.cells/textdirectiontype) | Bu paragraf için metin akışının yönünü temsil eder.|
| [TextOrientationType](/cells/tr/python-net/aspose.cells/textorientationtype) | Metin yönü türlerini numaralandırır.|
| [TextStrikeType](/cells/tr/python-net/aspose.cells/textstriketype) | Bu tip, grev tipini belirtir.|
| [ThemeColorType](/cells/tr/python-net/aspose.cells/themecolortype) | Tema renk türlerini numaralandırır.|
| [TimePeriodType](/cells/tr/python-net/aspose.cells/timeperiodtype) | FormatConditionType.TimePeriod koşullu biçimlendirme kuralında kullanılır.<br/>Bunlar, zamana bağlı olarak değişen dinamik zaman dilimleridir.<br/> koşullu biçimlendirmenin yenilendiği / uygulandığı tarih.|
| [TxtLoadStyleStrategy](/cells/tr/python-net/aspose.cells/txtloadstylestrategy) | Dize değerini sayıya veya tarih saatine dönüştürürken ayrıştırılan değerler için stilin nasıl uygulanacağını belirtir.|
| [TxtValueQuoteType](/cells/tr/python-net/aspose.cells/txtvaluequotetype) | Metin biçimi dosyalarındaki değerler için tırnak işaretleri kullanma türünü belirtir.|
| [UpdateLinksType](/cells/tr/python-net/aspose.cells/updatelinkstype) |Çalışma kitabı açıldığında diğer çalışma kitaplarına olan bağlantıların nasıl güncelleştirileceğini temsil eder.|
| [ValidationAlertType](/cells/tr/python-net/aspose.cells/validationalerttype) | Veri doğrulama uyarı stilini temsil eder.|
| [ValidationType](/cells/tr/python-net/aspose.cells/validationtype) | Veri doğrulama türünü temsil eder.|
| [ViewType](/cells/tr/python-net/aspose.cells/viewtype) | Çalışma sayfasının görünüm türünü temsil eder.|
| [VisibilityType](/cells/tr/python-net/aspose.cells/visibilitytype) | Sayfa görünürlüğü için durumları temsil eder.|
| [WarningType](/cells/tr/python-net/aspose.cells/warningtype) | WaringType|
