...
type: docs
weight: 1660
url: /tr/python-net/aspose.cells/xlsbsaveoptions/
is_root: false
---
...
**Miras:** [XlsbSaveOptions](/cells/python-net/aspose.cells/xlsbsaveoptions) → 
[SaveOptions](/cells/tr/python-net/aspose.cells/saveoptions)



XlsbSaveOptions türü aşağıdaki üyeleri gösterir:

###  İnşaatçılar
| Yapıcı| Tanım|
| :- | :- |
| [XlsbSaveOptions()](/cells/tr/python-net/aspose.cells/xlsbsaveoptions/__init__/#) | xlsb dosyası kaydetme seçeneklerini oluşturur.|
| [XlsbSaveOptions(save_format)](/cells/tr/python-net/aspose.cells/xlsbsaveoptions/__init__/#SaveFormat) | xlsb dosyası kaydetme seçeneklerini oluşturur.|


###  Özellikler
| Mülk| Tanım|
| :- | :- |
| [save_format](/cells/tr/python-net/aspose.cells/xlsbsaveoptions/save_format) | Kayıt dosyası formatını alır.|
| [clear_data](/cells/tr/python-net/aspose.cells/xlsbsaveoptions/clear_data) | Dosyayı kaydettikten sonra çalışma kitabını boşaltın.|
| [cached_file_folder](/cells/tr/python-net/aspose.cells/xlsbsaveoptions/cached_file_folder) | Önbelleğe alınmış dosya klasörü, bazı büyük verileri depolamak için kullanılır.|
| [validate_merged_areas](/cells/tr/python-net/aspose.cells/xlsbsaveoptions/validate_merged_areas) | Dosyayı kaydetmeden önce birleştirilmiş hücrelerin doğrulanıp doğrulanmadığını gösterir.|
...
* sınıf [XlsbSaveOptions](/cells/tr/python-net/aspose.cells/xlsbsaveoptions)
