---
title: custom_function mülk
second_title: Aspose.Cells for Python via .NET API Referanslar
description:
type: docs
weight: 60
url: /tr/python-net/aspose.cells/calculationoptions/custom_function/
is_root: false
---
##  custom_function mülk

Özel formül hesaplama, hesaplama motorunu genişletmek için çalışır.
...
* sınıf [ICustomFunction](/cells/tr/python-net/aspose.cells/icustomfunction)
