...
type: docs
weight: 130
url: /tr/python-net/aspose.cells/calculationoptions/
is_root: false
---
##  CalculationOptions sınıfı
Hesaplama seçeneklerini temsil eder.



CalculationOptions türü aşağıdaki üyeleri gösterir:

###  İnşaatçılar
| Yapıcı| Tanım|
| :- | :- |
| [CalculationOptions()](/cells/tr/python-net/aspose.cells/calculationoptions/__init__/#) | CalculationOptions'ın yeni bir örneğini oluşturur|
