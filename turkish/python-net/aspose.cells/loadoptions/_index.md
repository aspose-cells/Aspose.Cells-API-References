...
| Yapıcı| Tanım|
| :- | :- |
| [LoadOptions()](/cells/tr/python-net/aspose.cells/loadoptions/__init__/#) | Dosyayı yükleme seçeneği oluşturur.|
| [LoadOptions(load_format)](/cells/tr/python-net/aspose.cells/loadoptions/__init__/#LoadFormat) | Dosyayı yükleme seçeneği oluşturur.|
...
| [keep_unparsed_data](/cells/tr/python-net/aspose.cells/loadoptions/keep_unparsed_data) | Şablon dosyasından yüklendiğinde Çalışma Kitabı için ayrıştırılmamış verilerin bellekte tutulup tutulmadığı. Varsayılan değer true'dur.|
...
| [warning_callback](/cells/tr/python-net/aspose.cells/loadoptions/warning_callback) | Uyarı geri aramalarını alır veya ayarlar.|
...
| Yöntem| Tanım|
| :- | :- |
| [set_paper_size(type)](/cells/tr/python-net/aspose.cells/loadoptions/set_paper_size/#PaperSizeType) | Varsayılan yazıcının ayarından varsayılan yazdırma kağıdı boyutunu ayarlar.|
