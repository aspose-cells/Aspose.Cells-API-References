---
title: OoxmlSaveOptions sınıf
second_title: Aspose.Cells for Python via .NET API Referanslar
description:
type: docs
weight: 1120
url: /tr/python-net/aspose.cells/ooxmlsaveoptions/
is_root: false
---
##  OoxmlSaveOptions sınıf
Office açık xml dosyasını kaydetme seçeneklerini temsil eder.



**Miras:** [OoxmlSaveOptions](/cells/python-net/aspose.cells/ooxmlsaveoptions) → 
[SaveOptions](/cells/tr/python-net/aspose.cells/saveoptions)



OoxmlSaveOptions türü aşağıdaki üyeleri gösterir:

###  İnşaatçılar
| Yapıcı| Tanım|
| :- | :- |
| [OoxmlSaveOptions()](/cells/tr/python-net/aspose.cells/ooxmlsaveoptions/__init__/#) | Office açık xml dosyasını kaydetme seçeneklerini oluşturur.|
| [OoxmlSaveOptions(save_format)](/cells/tr/python-net/aspose.cells/ooxmlsaveoptions/__init__/#SaveFormat) | Office açık xml dosyasını kaydetme seçeneklerini oluşturur.|


###  Özellikler
| Mülk| Tanım|
| :- | :- |
| [save_format](/cells/tr/python-net/aspose.cells/ooxmlsaveoptions/save_format) | Kayıt dosyası formatını alır.|
| [clear_data](/cells/tr/python-net/aspose.cells/ooxmlsaveoptions/clear_data) | Dosyayı kaydettikten sonra çalışma kitabını boşaltın.|
| [cached_file_folder](/cells/tr/python-net/aspose.cells/ooxmlsaveoptions/cached_file_folder) | Önbelleğe alınmış dosya klasörü, bazı büyük verileri depolamak için kullanılır.|
| [validate_merged_areas](/cells/tr/python-net/aspose.cells/ooxmlsaveoptions/validate_merged_areas) | Dosyayı kaydetmeden önce birleştirilmiş hücrelerin doğrulanıp doğrulanmadığını gösterir.|
...
###  Ayrıca bakınız
* modül [aspose.cells](..)
* sınıf [OoxmlSaveOptions](/cells/tr/python-net/aspose.cells/ooxmlsaveoptions)
