...
FileFormatUtil türü aşağıdaki üyeleri gösterir:

###  Yöntemler
| Yöntem| Tanım|
| :- | :- |
| [detect_file_format(stream)](/cells/tr/python-net/aspose.cells/fileformatutil/detect_file_format/#io.RawIOBase) | Bir akışta saklanan bir excel biçimi hakkındaki bilgileri algılar ve döndürür.|
| [detect_file_format(stream, password)](/cells/tr/python-net/aspose.cells/fileformatutil/detect_file_format/#io.RawIOBase-str) | Bir akışta saklanan bir excel biçimi hakkındaki bilgileri algılar ve döndürür.|
| [detect_file_format(file_path)](/cells/tr/python-net/aspose.cells/fileformatutil/detect_file_format/#str) | Bir dosyada saklanan bir excel biçimi hakkındaki bilgileri algılar ve döndürür.|
| [detect_file_format(file_path, password)](/cells/tr/python-net/aspose.cells/fileformatutil/detect_file_format/#str-str) | Bir dosyada saklanan bir excel biçimi hakkındaki bilgileri algılar ve döndürür.|
