...
CopyOptions türü aşağıdaki üyeleri gösterir:

###  İnşaatçılar
| Yapıcı| Tanım|
| :- | :- |
| [CopyOptions()](/cells/tr/python-net/aspose.cells/copyoptions/__init__/#) | CopyOptions yapıcısı.|


###  Özellikler
| Mülk| Tanım|
| :- | :- |
| [keep_macros](/cells/tr/python-net/aspose.cells/copyoptions/keep_macros) | Makroların tutulup tutulmadığını gösterir;|
| [extend_to_adjacent_range](/cells/tr/python-net/aspose.cells/copyoptions/extend_to_adjacent_range) | Aralığı bitişik aralığa kopyalarken aralıkların genişletilip genişletilmediğini gösterir.|
