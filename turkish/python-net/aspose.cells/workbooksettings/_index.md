---
title: WorkbookSettings sınıf
second_title: Aspose.Cells for Python via .NET API Referanslar
description:
type: docs
weight: 1610
url: /tr/python-net/aspose.cells/workbooksettings/
is_root: false
---
##  WorkbookSettings sınıf
Çalışma kitabının tüm ayarlarını temsil eder.



WorkbookSettings türü aşağıdaki üyeleri gösterir:
...
| [enable_macros](/cells/tr/python-net/aspose.cells/workbooksettings/enable_macros) | makroları etkinleştir;|
| [date1904](/cells/tr/python-net/aspose.cells/workbooksettings/date1904) | Çalışma kitabının 1904 tarih sistemini kullanıp kullanmadığını temsil eden bir değer alır veya ayarlar.|
| [protection_type](/cells/tr/python-net/aspose.cells/workbooksettings/protection_type) | Çalışma kitabının koruma türünü alır.|
| [display_drawing_objects](/cells/tr/python-net/aspose.cells/workbooksettings/display_drawing_objects) | Çalışma kitabında nesnelerin gösterilip gösterilmeyeceğini ve nasıl gösterileceğini belirtir.|
| [sheet_tab_bar_width](/cells/tr/python-net/aspose.cells/workbooksettings/sheet_tab_bar_width) | Çalışma sayfası sekme çubuğunun genişliği (pencere genişliğinin 1/1000'i olarak).|
| [show_tabs](/cells/tr/python-net/aspose.cells/workbooksettings/show_tabs) | Çalışma Kitabı sekmelerinin görüntülenip görüntülenmeyeceğine dair bir değer alın veya ayarlar.|
| [first_visible_tab](/cells/tr/python-net/aspose.cells/workbooksettings/first_visible_tab) | İlk görünür çalışma sayfası sekmesini alır veya ayarlar.|
| [is_h_scroll_bar_visible](/cells/tr/python-net/aspose.cells/workbooksettings/is_h_scroll_bar_visible) | Oluşturulan elektronik tablonun yatay bir kaydırma çubuğu içerip içermeyeceğini gösteren bir değer alır veya ayarlar.|
...
| [is_protected](/cells/tr/python-net/aspose.cells/workbooksettings/is_protected) | Çalışma Kitabının yapısının mı yoksa penceresinin mi korunduğunu gösteren bir değer alır.|
| [is_default_encrypted](/cells/tr/python-net/aspose.cells/workbooksettings/is_default_encrypted) | Çalışma kitabının Yapısı ve Windows'i kilitliyse, çalışma kitabının varsayılan parola ile şifrelenip şifrelenmediğini gösterir.|
| [is_minimized](/cells/tr/python-net/aspose.cells/workbooksettings/is_minimized) | Oluşturulan elektronik tablonun Küçültülmüş olarak açılıp açılmayacağını temsil eder.|
| [is_hidden](/cells/tr/python-net/aspose.cells/workbooksettings/is_hidden) | Bu çalışma kitabının gizli olup olmadığını gösterir.|
| [auto_compress_pictures](/cells/tr/python-net/aspose.cells/workbooksettings/auto_compress_pictures) | Uygulamanın çalışma kitabındaki resimleri otomatik olarak sıkıştırdığını gösteren bir boole değeri belirtir.|
| [remove_personal_information](/cells/tr/python-net/aspose.cells/workbooksettings/remove_personal_information) | Kişisel bilgiler belirtilen çalışma kitabından kaldırılabiliyorsa doğrudur.|
| [hide_pivot_field_list](/cells/tr/python-net/aspose.cells/workbooksettings/hide_pivot_field_list) | PivotTable için alan listesinin gizlenip gizlenmeyeceğini alır ve ayarlar.|
| [update_links_type](/cells/tr/python-net/aspose.cells/workbooksettings/update_links_type) | Çalışma kitabı açıldığında dış bağlantıların nasıl güncelleneceğini alır ve ayarlar.|
| [max_row](/cells/tr/python-net/aspose.cells/workbooksettings/max_row) | Sıfır tabanlı maksimum satır dizinini alır.|
| [max_column](/cells/tr/python-net/aspose.cells/workbooksettings/max_column) | Sıfır tabanlı maksimum sütun dizinini alır.|
| [parsing_formula_on_open](/cells/tr/python-net/aspose.cells/workbooksettings/parsing_formula_on_open) | Dosyayı okurken formülün ayrıştırılıp ayrıştırılmadığını gösterir.|
| [window_left](/cells/tr/python-net/aspose.cells/workbooksettings/window_left) |Nokta birimi cinsinden istemci alanının sol kenarından pencerenin sol kenarına olan mesafe.|
| [window_left_inch](/cells/tr/python-net/aspose.cells/workbooksettings/window_left_inch) | İstemci alanının sol kenarından pencerenin sol kenarına olan mesafe.<br/> inç biriminde.|
| [window_left_cm](/cells/tr/python-net/aspose.cells/workbooksettings/window_left_cm) | İstemci alanının sol kenarından pencerenin sol kenarına olan mesafe.<br/> Santimetre biriminde.|
...
| [calculation_id](/cells/tr/python-net/aspose.cells/workbooksettings/calculation_id) | Çalışma kitabındaki değerleri hesaplamak için kullanılan hesaplama motorunun sürümünü belirtir.|
| [calc_stack_size](/cells/tr/python-net/aspose.cells/workbooksettings/calc_stack_size) | Hücreleri yinelemeli olarak hesaplamak için yığın boyutunu belirtir.<br/>Bu boyut için büyük değer, yinelemeli olarak hesaplanması gereken çok sayıda hücre olduğunda daha iyi performans verecektir.<br/>Öte yandan, daha büyük değer StackOverflowException riskini artıracaktır.<br/> Kullanıcı formülleri hesaplarken StackOverflowException alırsa, bu değer azaltılmalıdır.|
| [recalculate_before_save](/cells/tr/python-net/aspose.cells/workbooksettings/recalculate_before_save) | Belgeyi kaydetmeden önce yeniden hesaplanıp hesaplanmayacağını belirtir.|


###  Yöntemler
| Yöntem| Tanım|
| :- | :- |
| [get_theme_font(type)](/cells/tr/python-net/aspose.cells/workbooksettings/get_theme_font/#FontSchemeType) | Varsayılan tema yazı tipi adını alır.|
| [set_page_orientation_type(page_orientation_type)](/cells/tr/python-net/aspose.cells/workbooksettings/set_page_orientation_type/#PageOrientationType) |Çalışma kitabının tamamı için yazdırma yönü türünü ayarlayın.|
