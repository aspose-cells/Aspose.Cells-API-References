...
type: docs
weight: 520
url: /tr/python-net/aspose.cells/workbooksettings/region/
is_root: false
---
##  region mülk

Çalışma kitaplarının bölgesel ayarlarını alır veya ayarlar.

###  Notlar

1. Şablon dosyasından yüklenen bir çalışma kitabı için Aspose.Cells bileşeni tarafından kullanılan bölgesel ayarlar:
i) Bir XLS dosyası için, bölgesel ayarlar için tanımlanmış alanlar vardır ve MS Excel, XLS dosyasını kaydederken bölgesel ayarlar verilerini dosyaya kaydeder.
...
###  Ayrıca bakınız
* modül [aspose.cells](../../)
* sınıf [CountryCode](/cells/tr/python-net/aspose.cells/countrycode)
