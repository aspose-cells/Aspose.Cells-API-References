...
**Miras:** [DocxSaveOptions](/cells/python-net/aspose.cells/docxsaveoptions) → 
[SaveOptions](/cells/tr/python-net/aspose.cells/saveoptions)



DocxSaveOptions türü aşağıdaki üyeleri gösterir:
...
| Mülk| Tanım|
| :- | :- |
| [save_format](/cells/tr/python-net/aspose.cells/docxsaveoptions/save_format) | Kayıt dosyası formatını alır.|
| [clear_data](/cells/tr/python-net/aspose.cells/docxsaveoptions/clear_data) | Dosyayı kaydettikten sonra çalışma kitabını boşaltın.|
| [cached_file_folder](/cells/tr/python-net/aspose.cells/docxsaveoptions/cached_file_folder) | Önbelleğe alınmış dosya klasörü, bazı büyük verileri depolamak için kullanılır.|
| [validate_merged_areas](/cells/tr/python-net/aspose.cells/docxsaveoptions/validate_merged_areas) | Dosyayı kaydetmeden önce birleştirilmiş hücrelerin doğrulanıp doğrulanmadığını gösterir.|
...
###  Ayrıca bakınız
* modül [aspose.cells](..)
* sınıf [DocxSaveOptions](/cells/tr/python-net/aspose.cells/docxsaveoptions)
