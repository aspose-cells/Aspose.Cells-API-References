...
type: docs
weight: 1740
url: /tr/python-net/aspose.cells/accesscacheoptions/
is_root: false
---
##  AccessCacheOptions numaralandırma
Veri erişimi için önbellek seçenekleri Birden fazla seçeneğin bir arada olması için | operatörü ile birleştirilebilir.
...
Farklı seçenekler için farklı veri kümelerinin "salt okunur" olması gerekebileceğini lütfen unutmayın.
Verilere erişim performansı, önbelleğe alma mekanizmasının kullanılması gibi pek çok konuya bağlıdır.
performansının iyileştirileceğini garanti etmez.
