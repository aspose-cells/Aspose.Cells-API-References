...
[AbstractInterruptMonitor](/cells/tr/python-net/aspose.cells/abstractinterruptmonitor)



InterruptMonitor türü aşağıdaki üyeleri gösterir:

###  İnşaatçılar
| Yapıcı| Tanım|
| :- | :- |
| [InterruptMonitor()](/cells/tr/python-net/aspose.cells/interruptmonitor/__init__/#) | InterruptMonitor'un yeni bir örneğini oluşturur|
...
| Yöntem| Tanım|
| :- | :- |
| [interrupt()](/cells/tr/python-net/aspose.cells/interruptmonitor/interrupt/#) | Mevcut operatörü kes.|
