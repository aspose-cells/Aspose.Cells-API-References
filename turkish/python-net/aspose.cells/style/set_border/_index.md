...
type: docs
weight: 60
url: /tr/python-net/aspose.cells/style/set_border/
is_root: false
---
...
Geçerli kenarlık ayarlarının değiştirilip değiştirilmediği.
...
###  Ayrıca bakınız
* modül [aspose.cells](../../)
* sınıf [BorderType](/cells/tr/python-net/aspose.cells/bordertype)
