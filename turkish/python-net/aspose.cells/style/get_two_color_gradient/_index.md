---
title: get_two_color_gradient yöntemi
second_title: Aspose.Cells for Python via .NET API Referanslar
description:
type: docs
weight: 30
url: /tr/python-net/aspose.cells/style/get_two_color_gradient/
is_root: false
---
...
Bunun yerine lütfen Style.GetTwoColorGradientSetting() yöntemini kullanın.
