...
| Yapıcı| Tanım|
| :- | :- |
| [Style()](/cells/tr/python-net/aspose.cells/style/__init__/#) | [Style](/cells/tr/python-net/aspose.cells/style) sınıfının yeni bir örneğini başlatır.|
...
| [foreground_color](/cells/tr/python-net/aspose.cells/style/foreground_color) | Bir stilin ön plan rengini alır veya ayarlar.|
...
| [shrink_to_fit](/cells/tr/python-net/aspose.cells/style/shrink_to_fit) | Metnin otomatik olarak mevcut sütun genişliğine sığacak şekilde küçülüp küçülmediğini gösterir.|
| [text_direction](/cells/tr/python-net/aspose.cells/style/text_direction) | Metin okuma sırasını temsil eder.|
...
| Yöntem| Tanım|
| :- | :- |
| [set_border(border_type, border_style, border_color)](/cells/tr/python-net/aspose.cells/style/set_border/#BorderType-CellBorderType-aspose.pydrawing.Color) | Stilin sınırlarını ayarlar.|
| [set_border(border_type, border_style, border_color)](/cells/tr/python-net/aspose.cells/style/set_border/#BorderType-CellBorderType-CellsColor) | Stilin sınırlarını ayarlar.|
| [set_pattern_color(pattern, color1, color2)](/cells/tr/python-net/aspose.cells/style/set_pattern_color/#BackgroundType-aspose.pydrawing.Color-aspose.pydrawing.Color) | Arka plan rengini ayarlar.|
| [copy(style)](/cells/tr/python-net/aspose.cells/style/copy/#Style) | Verileri başka bir stil nesnesinden kopyalar|
| [update()](/cells/tr/python-net/aspose.cells/style/update/#) | Adlandırılmış stili, bu adlandırılmış stili kullanan hücrelerin stillerine uygulayın.<br/>Stili değiştirmeyi bitirdikten sonra "tamam" düğmesine tıklamak gibi çalışır.<br/> Yalnızca adlandırılmış stil için geçerlidir.|
| [is_modified(modify_flag)](/cells/tr/python-net/aspose.cells/style/is_modified/#StyleModifyFlag) | Stilin belirtilen özelliklerinin değiştirilip değiştirilmediğini kontrol eder.<br/> Bir hücreye ConditionalFormattings uygulanırken bu stilin belirtilen özelliklerinin kullanılıp kullanılmayacağını kontrol etmek için ConditionalFormattings stili için kullanılır.|
| [set_custom(custom, builtin_preference)](/cells/tr/python-net/aspose.cells/style/set_custom/#str-bool) | Bir hücrenin Özel sayı biçimi dizesini ayarlar.|
| [set_two_color_gradient(color1, color2, gradient_style_type, variant)](/cells/tr/python-net/aspose.cells/style/set_two_color_gradient/#aspose.pydrawing.Color-aspose.pydrawing.Color-aspose.cells.drawing.GradientStyleType-int) | Belirtilen dolguyu iki renkli bir degradeye ayarlar.|
| [get_two_color_gradient(color1, color2, gradient_style_type, variant)](/cells/tr/python-net/aspose.cells/style/get_two_color_gradient/#aspose.pydrawing.Color&-aspose.pydrawing.Color&-any-any) | İki renkli gradyan ayarını alın.|
| [get_two_color_gradient_setting()](/cells/tr/python-net/aspose.cells/style/get_two_color_gradient_setting/#) | İki renkli gradyan ayarını alın.|
| [to_json()](/cells/tr/python-net/aspose.cells/style/to_json/#) | [Style](/cells/tr/python-net/aspose.cells/style)'i JSON yapı verisine dönüştürün.|
...
###  Ayrıca bakınız
* modül [aspose.cells](..)
* sınıf [BorderCollection](/cells/tr/python-net/aspose.cells/bordercollection)
