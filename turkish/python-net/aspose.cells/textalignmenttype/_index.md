---
title: TextAlignmentType numaralandırma
second_title: Aspose.Cells for Python via .NET API Referanslar
description:
type: docs
weight: 2520
url: /tr/python-net/aspose.cells/textalignmenttype/
is_root: false
---
...
TextAlignmentType türü aşağıdaki üyeleri gösterir:
...
| JUSTIFY | Yaslanmış metin hizalamasını temsil eder.|
