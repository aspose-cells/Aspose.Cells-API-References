...
ChartFrame türü aşağıdaki üyeleri gösterir:

###  Özellikler
| Mülk| Tanım|
| :- | :- |
| [is_inner_mode](/cells/tr/python-net/aspose.cells.charts/chartframe/is_inner_mode) | Çizim alanı boyutunun, onay işaretlerini ve eksen etiketlerini içerip içermediğini gösterir.<br/> False, boyutun çizim alanının boyutunu, onay işaretlerini ve eksen etiketlerini belirleyeceğini belirtir.|
| [border](/cells/tr/python-net/aspose.cells.charts/chartframe/border) | [Line](/cells/tr/python-net/aspose.cells.drawing/line)'i alır.|
| [area](/cells/tr/python-net/aspose.cells.charts/chartframe/area) | [ChartFrame.area](/cells/tr/python-net/aspose.cells.charts/chartframe#area)'i alır.|
...
| [default_x](/cells/tr/python-net/aspose.cells.charts/chartframe/default_x) | Varsayılan konumun x'ini temsil eder|
| [default_y](/cells/tr/python-net/aspose.cells.charts/chartframe/default_y) | Varsayılan konumun y'sini temsil eder|
| [default_width](/cells/tr/python-net/aspose.cells.charts/chartframe/default_width) | Varsayılan konumun genişliğini temsil eder|
| [default_height](/cells/tr/python-net/aspose.cells.charts/chartframe/default_height) | Varsayılan konumun yüksekliğini temsil eder|


###  Yöntemler
| Yöntem| Tanım|
| :- | :- |
| [set_position_auto()](/cells/tr/python-net/aspose.cells.charts/chartframe/set_position_auto/#) | Çerçevenin konumunu otomatik olarak ayarlayın|
