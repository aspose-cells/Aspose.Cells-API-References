...
type: docs
weight: 250
url: /tr/python-net/aspose.cells.charts/serieslayoutproperties/
is_root: false
---
##  SeriesLayoutProperties sınıfı
Seri düzeninin özelliklerini temsil eder.



SeriesLayoutProperties türü aşağıdaki üyeleri gösterir:

###  İnşaatçılar
| Yapıcı| Tanım|
| :- | :- |
| [SeriesLayoutProperties()](/cells/tr/python-net/aspose.cells.charts/serieslayoutproperties/__init__/#) | SeriesLayoutProperties'in yeni bir örneğini oluşturur|


###  Özellikler
| Mülk| Tanım|
| :- | :- |
| [show_connector_lines](/cells/tr/python-net/aspose.cells.charts/serieslayoutproperties/show_connector_lines) | Veri noktaları arasında bağlantı çizgilerinin gösterilip gösterilmediğini belirtir.|
...
| [map_chart_region_type](/cells/tr/python-net/aspose.cells.charts/serieslayoutproperties/map_chart_region_type) | Haritanın bölge türünü alır ve ayarlar.|
| [map_chart_projection_type](/cells/tr/python-net/aspose.cells.charts/serieslayoutproperties/map_chart_projection_type) | Haritanın projeksiyon türünü alır ve ayarlar.|
