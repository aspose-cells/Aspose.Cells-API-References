...
**Miras:** [PlotArea](/cells/python-net/aspose.cells.charts/plotarea) → 
[ChartFrame](/cells/tr/python-net/aspose.cells.charts/chartframe)



PlotArea türü aşağıdaki üyeleri gösterir:

###  Özellikler
| Mülk| Tanım|
| :- | :- |
| [is_inner_mode](/cells/tr/python-net/aspose.cells.charts/plotarea/is_inner_mode) | Çizim alanı boyutunun, onay işaretlerini ve eksen etiketlerini içerip içermediğini gösterir.<br/> False, boyutun çizim alanının boyutunu, onay işaretlerini ve eksen etiketlerini belirleyeceğini belirtir.|
| [border](/cells/tr/python-net/aspose.cells.charts/plotarea/border) | [Line](/cells/tr/python-net/aspose.cells.drawing/line)'i alır.|
| [area](/cells/tr/python-net/aspose.cells.charts/plotarea/area) | [ChartFrame.area](/cells/tr/python-net/aspose.cells.charts/chartframe#area)'i alır.|
...
| [is_default_pos_be_set](/cells/tr/python-net/aspose.cells.charts/plotarea/is_default_pos_be_set) | Varsayılan konumun (DefaultX, DefaultY, DefaultWidth ve DefaultHeight) ayarlanıp ayarlanmadığını gösterir.|
| [default_x](/cells/tr/python-net/aspose.cells.charts/plotarea/default_x) | Varsayılan konumun x'ini temsil eder|
| [default_y](/cells/tr/python-net/aspose.cells.charts/plotarea/default_y) | Varsayılan konumun y'sini temsil eder|
| [default_width](/cells/tr/python-net/aspose.cells.charts/plotarea/default_width) | Varsayılan konumun genişliğini temsil eder|
| [default_height](/cells/tr/python-net/aspose.cells.charts/plotarea/default_height) | Varsayılan konumun yüksekliğini temsil eder|
| [inner_x](/cells/tr/python-net/aspose.cells.charts/plotarea/inner_x) | Grafik alanının 1/4000'lik birimlerinde çizim alanının üst üst köşesinin x koordinatını alır veya alır.|
| [inner_y](/cells/tr/python-net/aspose.cells.charts/plotarea/inner_y) | Grafik alanının 1/4000'lik birimlerinde çizim alanının üst üst köşesinin x koordinatını alır veya alır.|
| [inner_height](/cells/tr/python-net/aspose.cells.charts/plotarea/inner_height) | Grafik alanının 1/4000'lik birimlerinde çizim alanının yüksekliğini alır veya ayarlar.|
| [inner_width](/cells/tr/python-net/aspose.cells.charts/plotarea/inner_width) | Grafik alanının 1/4000'lik birimlerinde çizim alanının genişliğini alır veya ayarlar.|


###  Yöntemler
| Yöntem| Tanım|
| :- | :- |
| [set_position_auto()](/cells/tr/python-net/aspose.cells.charts/plotarea/set_position_auto/#) | Çizim alanının konumunu otomatik olarak ayarlayın|
...
* sınıf [PlotArea](/cells/tr/python-net/aspose.cells.charts/plotarea)
