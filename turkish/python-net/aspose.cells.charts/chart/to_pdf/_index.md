---
title: to_pdf yöntemi
second_title: Aspose.Cells for Python via .NET API Referanslar
description:
type: docs
weight: 130
url: /tr/python-net/aspose.cells.charts/chart/to_pdf/
is_root: false
---
...
| h_alignment_type | [PageLayoutAlignmentType](/cells/tr/python-net/aspose.cells/pagelayoutalignmenttype) | Çıktı sayfasındaki grafik yatay hizalama türü.|
| v_alignment_type | [PageLayoutAlignmentType](/cells/tr/python-net/aspose.cells/pagelayoutalignmenttype) | Çıktı sayfasındaki grafik dikey hizalama türü.|
