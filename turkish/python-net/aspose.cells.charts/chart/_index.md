...
Chart türü aşağıdaki üyeleri gösterir:
...
| [display_na_as_blank](/cells/tr/python-net/aspose.cells.charts/chart/display_na_as_blank) | #YOK'un boş değer olarak görüntülenip görüntülenmediğini belirtir.|
| [name](/cells/tr/python-net/aspose.cells.charts/chart/name) | Grafiğin adını alır ve ayarlar.|
| [size_with_window](/cells/tr/python-net/aspose.cells.charts/chart/size_with_window) | Microsoft Excel grafiği, grafik sayfası penceresinin boyutuyla eşleşecek şekilde yeniden boyutlandırırsa doğrudur.|
| [worksheet](/cells/tr/python-net/aspose.cells.charts/chart/worksheet) | Bu grafiği içeren çalışma sayfasını alır.|
| [shapes](/cells/tr/python-net/aspose.cells.charts/chart/shapes) | Bu tablodaki tüm çizim şekillerini döndürür.|
| [print_size](/cells/tr/python-net/aspose.cells.charts/chart/print_size) | Basılı grafik boyutunu alır ve ayarlar.|
...
| [value_axis](/cells/tr/python-net/aspose.cells.charts/chart/value_axis) | Grafiğin Y eksenini alır.|
| [second_value_axis](/cells/tr/python-net/aspose.cells.charts/chart/second_value_axis) | Grafiğin ikinci Y eksenini alır.|
| [second_category_axis](/cells/tr/python-net/aspose.cells.charts/chart/second_category_axis) | Grafiğin ikinci X eksenini alır.|
...
| [page_setup](/cells/tr/python-net/aspose.cells.charts/chart/page_setup) | Bu grafikteki sayfa yapısı açıklamasını temsil eder.|
| [line](/cells/tr/python-net/aspose.cells.charts/chart/line) | Çizgiyi alır.|


###  Yöntemler
| Yöntem| Tanım|
| :- | :- |
| [to_image(image_file)](/cells/tr/python-net/aspose.cells.charts/chart/to_image/#str) | Grafik görüntüsünü oluşturur ve bir dosyaya kaydeder.<br/> Dosya adının uzantısı görüntünün biçimini belirler.|
| [to_image(image_file, image_type)](/cells/tr/python-net/aspose.cells.charts/chart/to_image/#str-aspose.cells.drawing.ImageType) | Grafik görüntüsünü oluşturur ve belirtilen görüntü tipinde bir dosyaya kaydeder.|
| [to_image(image_file, jpeg_quality)](/cells/tr/python-net/aspose.cells.charts/chart/to_image/#str-int) | Grafik görüntüsünü oluşturur ve onu Jpeg formatında bir dosyaya kaydeder.|
| [to_image(stream, jpeg_quality)](/cells/tr/python-net/aspose.cells.charts/chart/to_image/#io.RawIOBase-int) | Grafik görüntüsünü oluşturur ve onu Jpeg biçiminde bir akışa kaydeder.|
| [to_image(stream, image_type)](/cells/tr/python-net/aspose.cells.charts/chart/to_image/#io.RawIOBase-aspose.cells.drawing.ImageType) |Grafik görüntüsünü oluşturur ve belirtilen biçimde bir akışa kaydeder.|
| [to_image(image_file, options)](/cells/tr/python-net/aspose.cells.charts/chart/to_image/#str-aspose.cells.rendering.ImageOrPrintOptions) | Grafik görüntüsünü oluşturur ve bir dosyaya kaydeder.<br/> Dosya adının uzantısı görüntünün biçimini belirler.|
| [to_image(stream, options)](/cells/tr/python-net/aspose.cells.charts/chart/to_image/#io.RawIOBase-aspose.cells.rendering.ImageOrPrintOptions) |Grafik görüntüsünü oluşturur ve belirtilen biçimde bir akışa kaydeder.|
| [to_pdf(file_name)](/cells/tr/python-net/aspose.cells.charts/chart/to_pdf/#str) | Grafiği bir pdf dosyasına kaydeder.|
| [to_pdf(file_name, desired_page_width, desired_page_height, h_alignment_type, v_alignment_type)](/cells/tr/python-net/aspose.cells.charts/chart/to_pdf/#str-float-float-PageLayoutAlignmentType-PageLayoutAlignmentType) | Grafiği bir pdf dosyasına kaydeder.|
| [to_pdf(stream)](/cells/tr/python-net/aspose.cells.charts/chart/to_pdf/#io.RawIOBase) | Grafik pdf'sini oluşturur ve bir akışa kaydeder.|
| [to_pdf(stream, desired_page_width, desired_page_height, h_alignment_type, v_alignment_type)](/cells/tr/python-net/aspose.cells.charts/chart/to_pdf/#io.RawIOBase-float-float-PageLayoutAlignmentType-PageLayoutAlignmentType) | Grafik pdf'sini oluşturur ve bir akışa kaydeder.|
| [is_chart_data_changed()](/cells/tr/python-net/aspose.cells.charts/chart/is_chart_data_changed/#) | Bir grafiğin veri kaynağının değişip değişmediğini algılar.|
| [refresh_pivot_data()](/cells/tr/python-net/aspose.cells.charts/chart/refresh_pivot_data/#) | Pivot grafiğinin verilerini pivot veri kaynağından yeniler.|
| [change_template(data)](/cells/tr/python-net/aspose.cells.charts/chart/change_template/#bytes) | Önceden ayarlanmış şablonla grafik türünü değiştirin.|
...
* sınıf [SeriesCollection](/cells/tr/python-net/aspose.cells.charts/seriescollection)
