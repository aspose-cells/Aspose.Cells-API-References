...
PivotItem türü aşağıdaki üyeleri gösterir:

###  Özellikler
| Mülk| Tanım|
| :- | :- |
| [is_hidden](/cells/tr/python-net/aspose.cells.pivot/pivotitem/is_hidden) | Pivot öğesinin gizli olup olmadığını alır ve ayarlar.|
| [is_hide_detail](/cells/tr/python-net/aspose.cells.pivot/pivotitem/is_hide_detail) | Pivot öğesinin ayrıntıyı gizleyip gizlemediğini alır ve ayarlar.|
| [value](/cells/tr/python-net/aspose.cells.pivot/pivotitem/value) | Pivot öğesinin değerini alır|
| [name](/cells/tr/python-net/aspose.cells.pivot/pivotitem/name) | Pivot öğesinin adını alır.|
| [index](/cells/tr/python-net/aspose.cells.pivot/pivotitem/index) | Pivot alanındaki pivot öğesinin dizinini alır|
