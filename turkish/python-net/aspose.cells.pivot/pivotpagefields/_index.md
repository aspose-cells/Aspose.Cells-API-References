...
PivotPageFields türü aşağıdaki üyeleri gösterir:

###  İnşaatçılar
| Yapıcı| Tanım|
| :- | :- |
| [PivotPageFields()](/cells/tr/python-net/aspose.cells.pivot/pivotpagefields/__init__/#) | Pivot sayfa alanı öğelerini temsil eder.|


###  Özellikler
| Mülk| Tanım|
| :- | :- |
| [page_field_count](/cells/tr/python-net/aspose.cells.pivot/pivotpagefields/page_field_count) | Sayfa alanlarının sayısını alır.|
