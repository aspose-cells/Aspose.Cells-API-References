...
type: docs
weight: 10
url: /tr/python-net/aspose.cells.pivot/
is_root: false
---
 bu**Aspose.Cells.Pivot** ad alanı, Excel Elektronik Tablo dosyalarında PivotTable oluşturma ve işleme ile ilgili tüm sınıfları içerir.
...
| [PivotPageFields](/cells/tr/python-net/aspose.cells.pivot/pivotpagefields) | Pivot sayfa alanı öğelerini temsil eder<br/>pivot tablo veri kaynağı birleştirme aralıklarıysa.<br/> En fazla 4 alan içerebilir.|
| [PivotTable](/cells/tr/python-net/aspose.cells.pivot/pivottable) | PivotTable için özet açıklama.|
| [PivotTableCollection](/cells/tr/python-net/aspose.cells.pivot/pivottablecollection) | Belirtilen çalışma sayfasındaki tüm PivotTable nesnelerinin koleksiyonunu temsil eder.|
| [SxRng](/cells/tr/python-net/aspose.cells.pivot/sxrng) | Bir PivotField'daki Grup Aralığını temsil eder.|
