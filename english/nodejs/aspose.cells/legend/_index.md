...
type: docs
weight: 2000
url: /nodejs/aspose.cells/legend/
---
...
| [getLegendEntries()](#getlegendentries) | Gets a collection of all the LegendEntry objects in the specified chart legend. Setting the legend entries of the surfac |
| [getLegendEntriesLabels()](#getlegendentrieslabels) | Gets the labels of the legend entries after call Chart.Calculate() method. NOTE: This member is now obsolete. Instead, p |
...
| [getPosition()](#getposition) | Gets or sets the legend position type. The value of the property is LegendPositionType integer constant.Default position |
...
| [setOverLay()](#setoverlay) | Gets or sets whether showing the legend without overlapping the chart. |
| [setPosition()](#setposition) | Gets or sets the legend position type. The value of the property is LegendPositionType integer constant.Default position |
