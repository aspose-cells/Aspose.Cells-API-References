...
type: docs
weight: 4640
url: /nodejs/aspose.cells/webextensiontaskpane/
---
...
| [getRow()](./getrow/) | Gets and sets the index, enumerating from the outside to the inside, of this taskpane among other persisted taskpanes do |
...
| [setLocked()](./setlocked/) | Indicates whether the taskpane is locked to the document in the UI and cannot be closed by the user. |
| [setRow()](./setrow/) | Gets and sets the index, enumerating from the outside to the inside, of this taskpane among other persisted taskpanes do |
| [setVisible()](./setvisible/) | Indicates whether the Task Pane shows as visible by default when the document opens. |
