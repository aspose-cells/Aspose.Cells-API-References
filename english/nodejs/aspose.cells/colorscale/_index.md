...
type: docs
weight: 670
url: /nodejs/aspose.cells/colorscale/
---
...
| [getMaxCfvo()](./getmaxcfvo/) | Get or set this ColorScale's max value object. Cannot set null or CFValueObject with type FormatConditionValueType.Min t |
| [getMaxColor()](./getmaxcolor/) | Get or set the gradient color for the maximum value in the range. |
| [getMidCfvo()](./getmidcfvo/) | Get or set this ColorScale's mid value object. Cannot set CFValueObject with type FormatConditionValueType.Max or Format |
| [getMidColor()](./getmidcolor/) | Get or set the gradient color for the middle value in the range. |
| [getMinCfvo()](./getmincfvo/) | Get or set this ColorScale's min value object. Cannot set null or CFValueObject with type FormatConditionValueType.Max t |
