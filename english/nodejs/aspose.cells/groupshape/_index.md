...
type: docs
weight: 1750
url: /nodejs/aspose.cells/groupshape/
---
...
| [get(index)](#get) | Gets the child shape by index. |
...
| [ungroup()](#ungroup) | Ungroups the shape items. If the group shape is grouped by another group shape,nothing will be done. |
...
| Parameter | Type | Description |
| --- | --- | --- |
| index | Number | the child shape index. |

**Returns:** Shape — `Shape` return the child shape.
