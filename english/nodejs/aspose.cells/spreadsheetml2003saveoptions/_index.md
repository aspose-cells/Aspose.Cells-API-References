...
type: docs
weight: 3910
url: /nodejs/aspose.cells/spreadsheetml2003saveoptions/
---
...
| Name | Description |
| --- | --- |
| [constructor_overload$1(saveFormat)](./constructor-overload1/) | Creates the options for saving Excel 2003 spreadml file. NOTE: This constructor is now obsolete. Instead, please use Spr |
...
| [isIndentedFormatting()](./isindentedformatting/) | Causes child elements to be indented. The default value is true. If the value is false, it will reduce the size of the x |
...
| [setIndentedFormatting()](./setindentedformatting/) | Causes child elements to be indented. The default value is true. If the value is false, it will reduce the size of the x |
