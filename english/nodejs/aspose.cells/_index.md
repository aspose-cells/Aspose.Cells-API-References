...
description: "The aspose.cells namespace aggregates core spreadsheet classes, enums, and utilities for creating, editing, calculating, and rendering Excel files."
type: docs
weight: 10
url: /nodejs/aspose.cells/
---

It serves as the central entry point for Aspose.Cells for Node.js via Java, offering a comprehensive set of objects—such as calculation monitors, globalization settings, and worksheet components—to programmatically manage workbook content, formulas, and document features.
...
| [BuiltInDocumentPropertyCollection](./builtindocumentpropertycollection/) | A collection of built-in document properties. Provides access to DocumentProperty objects by their names (using an index |
...
| [CalculationCell](./calculationcell/) | Represents the calculation relevant data about one cell which is being calculated. All objects provided by this class ar |
| [CalculationData](./calculationdata/) | Represents the required data when calculating one function, such as function name, parameters, ...etc. All objects provi |
...
| [CustomDocumentPropertyCollection](./customdocumentpropertycollection/) | A collection of custom document properties. Each DocumentProperty object represents a custom property of a container doc |
...
| [LoadFilter](./loadfilter/) | Represents the filter that provides options for loading data when loading workbook from template. User may specify the f |
...
| [Range](./range/) | Encapsulates the object that represents a range of cells within a spreadsheet. The Range class denotes a region of Excel |
...
| [ScrollBar](./scrollbar/) | Represents a scroll bar object. Scroll value must be between 0 and 30000. |
...
| [SlicerShape](./slicershape/) | Represents the slicer msodrawing object. |
...
| [Spinner](./spinner/) | Represents the Forms control: Spinner. Scroll value must be between 0 and 30000. |
...
| [SvgSaveOptions](./svgsaveoptions/) | Represents Svg save options. For advanced usage, please use WorkbookRender or SheetRender. NOTE: This class is now obsol |
| [SxRng](./sxrng/) | Represents Group Range in a PivotField. NOTE: This class is now obsolete. Instead, please use PivotFieldGroupSettings cl |
...
| [Workbook](./workbook/) | Represents a root object to create an Excel spreadsheet. The Workbook class denotes an Excel spreadsheet. Each spreadshe |
