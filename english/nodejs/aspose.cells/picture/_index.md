...
type: docs
weight: 2620
url: /nodejs/aspose.cells/picture/
---
...
| [copy(source, options)](#copy) | Copy the picture. |
...
| [getBorderLineColor()](#getborderlinecolor) | Represents the com.aspose.cells.Color of the border line of a picture. |
...
| [getImageType()](#getimagetype) | Gets the image format of the picture. The value of the property is ImageType integer constant. |
...
| [getSourceFullName()](#getsourcefullname) | Gets or sets the path and name of the source file for the linked image. The default value is an empty string. If SourceF |
...
| [move(upperLeftRow, upperLeftColumn)](#move) | Moves the picture to a specified location. |
...
| [setBorderLineColor()](#setborderlinecolor) | Represents the com.aspose.cells.Color of the border line of a picture. |
...
| [setData()](#setdata) | Gets the data of the picture. |
...
| [setDynamicDataExchange()](#setdynamicdataexchange) | Gets or sets whether dynamic data exchange |
...
| [setFormula()](#setformula) | Gets and sets the data of the formula. |
...
| [setLink()](#setlink) | Returns true if the picture is linked to a file. |
...
| [setPlacedInCell()](#setplacedincell) |  |
...
| [setSourceFullName()](#setsourcefullname) | Gets or sets the path and name of the source file for the linked image. The default value is an empty string. If SourceF |
...
### move(upperLeftRow, upperLeftColumn) {#move}
...
### setBorderLineColor() {#setborderlinecolor}
...
### setDynamicDataExchange() {#setdynamicdataexchange}
...
### setSignatureLine() {#setsignatureline}
...
### setSourceFullName() {#setsourcefullname}
