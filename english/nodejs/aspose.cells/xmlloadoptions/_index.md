...
type: docs
weight: 4790
url: /nodejs/aspose.cells/xmlloadoptions/
---
...
| Name | Description |
| --- | --- |
| [constructor_overload$1(type)](#constructor-overload1) | Represents the options of loading xml file. |
...
| [getStartCell()](#getstartcell) | Gets and sets the start cell. Only works when the file is not speadsheetML or mapping xml to Excel. |
...
| [setStartCell()](#setstartcell) | Gets and sets the start cell. Only works when the file is not speadsheetML or mapping xml to Excel. |
| [setWarningCallback()](#setwarningcallback) | Gets or sets warning callback. |
| [setXmlMap()](#setxmlmap) | Indicates whether mapping xml to Excel. The default value is false. |
...
### setContainsMultipleWorksheets() {#setcontainsmultipleworksheets}

Indicates whether importing xml as multiple worksheets.

### setConvertNumericOrDate() {#setconvertnumericordate}
...
### setIgnoreRootAttributes() {#setignorerootattributes}
