...
type: docs
weight: 3120
url: /nodejs/aspose.cells/radiobuttonactivexcontrol/
---
...
| [getAlignment()](#getalignment) | Gets and set the position of the Caption relative to the control. The value of the property is ControlCaptionAlignmentTy |
...
| [getPicturePosition()](#getpictureposition) | Gets and set the location of the control's picture relative to its caption. The value of the property is ControlPictureP |
...
| [getValue()](#getvalue) | Indicates if the control is checked or not. The value of the property is CheckValueType integer constant. |
...
| [isTripleState()](#istriplestate) | Indicates how the specified control will display Null values. SettingDescriptionTrueThe control will cycle through state |
...
| [setAlignment()](#setalignment) | Gets and set the position of the Caption relative to the control. The value of the property is ControlCaptionAlignmentTy |
...
| [setGroupName()](#setgroupname) | Gets and sets the group's name. |
...
| [setPicturePosition()](#setpictureposition) | Gets and set the location of the control's picture relative to its caption. The value of the property is ControlPictureP |
...
| [setTripleState()](#settriplestate) | Indicates how the specified control will display Null values. SettingDescriptionTrueThe control will cycle through state |
| [setValue()](#setvalue) | Indicates if the control is checked or not. The value of the property is CheckValueType integer constant. |
