...
type: docs
weight: 4770
url: /nodejs/aspose.cells/xlsbsaveoptions/
---
...
| Name | Description |
| --- | --- |
| [constructor_overload$1(saveFormat)](./constructor-overload1/) | Creates xlsb file save options. NOTE: This constructor is now obsolete. Instead, please use XlsbSaveOptions() constructo |
...
| [getExportAllColumnIndexes()](./getexportallcolumnindexes/) | Indicates whether exporting all column indexes for cells. The default value is true. |
...
| [setExportAllColumnIndexes()](./setexportallcolumnindexes/) | Indicates whether exporting all column indexes for cells. The default value is true. |
