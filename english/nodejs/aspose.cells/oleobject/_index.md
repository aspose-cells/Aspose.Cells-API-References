...
type: docs
weight: 2440
url: /nodejs/aspose.cells/oleobject/
---
...
| [getAutoLoad()](#getautoload) | Specifies whether the host application for the embedded object shall be called to load the object data automatically whe |
...
| [getFileFormatType()](#getfileformattype) | Gets and sets the file type of the embedded ole object data The value of the property is FileFormatType integer constant |
...
| [getImageSourceFullName()](#getimagesourcefullname) | Gets or sets the path and name of the source file for the linked image. The default value is an empty string. If SourceF |
| [getImageType()](#getimagetype) | Gets the image format of the ole object. The value of the property is ImageType integer constant. |
...
| [isAutoSize()](#isautosize) | True indicates that the size of the ole object will be auto changed as the size of snapshot of the embedded content when |
...
| [setAutoLoad()](#setautoload) | Specifies whether the host application for the embedded object shall be called to load the object data automatically whe |
...
| [setAutoSize()](#setautosize) | True indicates that the size of the ole object will be auto changed as the size of snapshot of the embedded content when |
...
| [setDisplayAsIcon()](#setdisplayasicon) | True if the specified object is displayed as an icon and the image will not be auto changed. |
| [setEmbeddedObject(linkToFile, objectData, sourceFileName, displayAsIcon, label)](#setembeddedobject) | Sets embedded object data. |
| [setEmbeddedObject(linkToFile, objectData, sourceFileName, displayAsIcon, label, updateIcon)](#setembeddedobject-1) | Sets embedded object data. As Aspose can update embedd all file icons, so it's better that you can add correct icon with |
| [setFileFormatType()](#setfileformattype) | Gets and sets the file type of the embedded ole object data The value of the property is FileFormatType integer constant |
...
| [setImageSourceFullName()](#setimagesourcefullname) | Gets or sets the path and name of the source file for the linked image. The default value is an empty string. If SourceF |
...
| [setLink()](#setlink) | Returns true if the OleObject links to the file. |
...
| [setNativeSourceFullName(sourceFullName)](#setnativesourcefullname) | Sets the ole native source full file name with path. |
...
### setClassIdentifier() {#setclassidentifier}
...
### setDisplayAsIcon() {#setdisplayasicon}

True if the specified object is displayed as an icon and the image will not be auto changed.

### setEmbeddedObject(linkToFile, objectData, sourceFileName, displayAsIcon, label) {#setembeddedobject}
...
| objectData | Array of byte | The embedded object data. |
...
### setEmbeddedObject(linkToFile, objectData, sourceFileName, displayAsIcon, label, updateIcon) {#setembeddedobject-1}
...
### setImageSourceFullName() {#setimagesourcefullname}
