...
type: docs
weight: 2370
url: /nodejs/aspose.cells/numbersloadoptions/
---
...
| [getLoadTableType()](#getloadtabletype) | Gets and sets the type of loading multiple tables in one worksheet. The value of the property is LoadNumbersTableType in |
...
| [setLoadTableType()](#setloadtabletype) | Gets and sets the type of loading multiple tables in one worksheet. The value of the property is LoadNumbersTableType in |
...
| [setPreserveTableName()](#setpreservetablename) |  |
...
### setLoadTableType() {#setloadtabletype}
