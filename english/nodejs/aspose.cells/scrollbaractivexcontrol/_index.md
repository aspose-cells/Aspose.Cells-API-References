...
type: docs
weight: 3470
url: /nodejs/aspose.cells/scrollbaractivexcontrol/
---
...
| [getOrientation()](./getorientation/) | Gets and sets whether the SpinButton or ScrollBar is oriented vertically or horizontally. The value of the property is C |
...
| [setLargeChange()](./setlargechange/) | Gets and sets the amount by which the Position property changes |
...
| [setMax()](./setmax/) | Gets and sets the maximum acceptable value. |
| [setMin()](./setmin/) | Gets and sets the minimum acceptable value. |
...
| [setOrientation()](./setorientation/) | Gets and sets whether the SpinButton or ScrollBar is oriented vertically or horizontally. The value of the property is C |
| [setPosition()](./setposition/) | Gets and sets the value. |
| [setShadow()](./setshadow/) | Indicates whether to show a shadow. |
| [setSmallChange()](./setsmallchange/) | Gets and sets the amount by which the Position property changes |
