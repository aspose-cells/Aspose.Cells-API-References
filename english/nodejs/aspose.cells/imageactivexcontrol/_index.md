...
type: docs
weight: 1880
url: /nodejs/aspose.cells/imageactivexcontrol/
---
...
| [getPictureAlignment()](./getpicturealignment/) | Gets and sets the alignment of the picture inside the Form or Image. The value of the property is ControlPictureAlignmen |
| [getPictureSizeMode()](./getpicturesizemode/) | Gets and sets how to display the picture. The value of the property is ControlPictureSizeMode integer constant. |
...
| [setPictureAlignment()](./setpicturealignment/) | Gets and sets the alignment of the picture inside the Form or Image. The value of the property is ControlPictureAlignmen |
| [setPictureSizeMode()](./setpicturesizemode/) | Gets and sets how to display the picture. The value of the property is ControlPictureSizeMode integer constant. |
...
| [setTiled()](./settiled/) | Indicates whether the picture is tiled across the background. |
