...
type: docs
weight: 4070
url: /nodejs/aspose.cells/textbox/
---
...
| [getEquationParagraph(index)](#getequationparagraph) | Get the specified math paragraph from the TextBody property of the TextBox object. Notice: (1) Returns NULL when the ind |
| [getEquationParagraph()](#getequationparagraph-1) | Gets the first math paragraph from the TextBody property of the TextBox object. |
...
### getEquationParagraph(index) {#getequationparagraph}
...
| Parameter | Type | Description |
| --- | --- | --- |
| index | Number | The position index of the math paragraph, starting from 0. |

**Returns:** EquationNode — `EquationNode` Returns the math paragraph specified by index.

### getEquationParagraph() {#getequationparagraph-1}

Gets the first math paragraph from the TextBody property of the TextBox object.

**Returns:** EquationNode — `EquationNode` If there has math paragraph, returns the first one, otherwise returns null.
