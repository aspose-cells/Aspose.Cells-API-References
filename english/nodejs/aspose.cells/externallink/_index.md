...
type: docs
weight: 1390
url: /nodejs/aspose.cells/externallink/
---
...
| Name | Description |
| --- | --- |
| [addExternalName(text, referTo)](./addexternalname/) | Adds an external name. |
...
| [getType()](./gettype/) | Gets the type of external link. The value of the property is ExternalLinkType integer constant. |
