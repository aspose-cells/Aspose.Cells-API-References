...
type: docs
weight: 2420
url: /nodejs/aspose.cells/odssaveoptions/
---
...
| Name | Description |
| --- | --- |
| [constructor_overload$1(saveFormat)](./constructor-overload1/) | Creates the options of saving ods file. |
...
| [getGeneratorType()](./getgeneratortype/) | Gets and sets the generator of the ods file. The value of the property is OdsGeneratorType integer constant. |
...
| [getOdfStrictVersion()](./getodfstrictversion/) | Gets and sets the ODF version. The value of the property is OpenDocumentFormatVersionType integer constant. |
...
| [isStrictSchema11()](./isstrictschema11/) | Indicates whether the ods file should be saved as ODF format version 1.1. Default is false. NOTE: This member is now obs |
...
| [setGeneratorType()](./setgeneratortype/) | Gets and sets the generator of the ods file. The value of the property is OdsGeneratorType integer constant. |
| [setIgnorePivotTables()](./setignorepivottables/) |  |
...
| [setOdfStrictVersion()](./setodfstrictversion/) | Gets and sets the ODF version. The value of the property is OpenDocumentFormatVersionType integer constant. |
...
| [setStrictSchema11()](./setstrictschema11/) | Indicates whether the ods file should be saved as ODF format version 1.1. Default is false. NOTE: This member is now obs |
