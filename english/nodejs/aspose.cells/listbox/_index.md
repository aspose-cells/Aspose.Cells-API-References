...
type: docs
weight: 2080
url: /nodejs/aspose.cells/listbox/
---
...
| [getPageChange()](#getpagechange) | Specifies the amount by which the control's value is changed when the user clicks on the scrollbar's page up or page dow |
...
| [getSelectionType()](#getselectiontype) | Gets or sets the selection mode of the specified list box. The value of the property is SelectionType integer constant. |
...
| [isSelected(itemIndex)](#isselected) | Indicates whether the item is selected. |
...
| [selectedItem(itemIndex, isSelected)](#selecteditem) | Sets whether the item is selected |
...
| [setPageChange()](#setpagechange) | Specifies the amount by which the control's value is changed when the user clicks on the scrollbar's page up or page dow |
...
| [setSelectionType()](#setselectiontype) | Gets or sets the selection mode of the specified list box. The value of the property is SelectionType integer constant. |
...
**Returns:** boolean — `boolean` whether the item is selected.
