...
type: docs
weight: 3460
url: /nodejs/aspose.cells/scrollbar/
---
...
| [setCurrentValue()](#setcurrentvalue) | Gets or sets the current value. |
...
| [setHorizontal()](#sethorizontal) | Indicates whether this is a horizontal scroll bar. |
| [setHtmlText()](#sethtmltext) | Gets and sets the html string which contains data and some formats in this textbox. |
| [setIncrementalChange()](#setincrementalchange) | Gets or sets the amount that the scroll bar or spinner is incremented a line scroll. |
...
| [setMax()](#setmax) | Gets or sets the maximum value of a scroll bar or spinner range. |
| [setMin()](#setmin) | Gets or sets the minimum value of a scroll bar or spinner range. |
| [setName()](#setname) | Gets and sets the name of the shape. |
| [setPageChange()](#setpagechange) | Gets or sets page change |
...
| [setShadow()](#setshadow) | Indicates whether the shape has 3-D shading. |
...
### setIncrementalChange() {#setincrementalchange}
