...
type: docs
weight: 3040
url: /nodejs/aspose.cells/pptxsaveoptions/
---
...
| Name | Description |
| --- | --- |
| [constructor_overload$1(saveAsImage)](#constructor-overload1) | Represents options of saving .pptx file. |
| [getAdjustFontSizeForRowType()](#getadjustfontsizeforrowtype) | Represents what type of line needs to be adjusted size of font if height of row is small. The value of the property is A |
...
| [getExportViewType()](#getexportviewtype) | Gets and sets the display type when exporting to PowerPoint. The default exporting type is working as printing. The valu |
...
| [setAdjustFontSizeForRowType()](#setadjustfontsizeforrowtype) | Represents what type of line needs to be adjusted size of font if height of row is small. The value of the property is A |
...
| [setEmbedXlsxAsChartDataSource()](#setembedxlsxaschartdatasource) |  |
...
| [setExportViewType()](#setexportviewtype) | Gets and sets the display type when exporting to PowerPoint. The default exporting type is working as printing. The valu |
...
| [setIgnoreHiddenRows()](#setignorehiddenrows) | Inidicates whether ignoring hidden rows when converting Excel to PowerPoint. |
...
| [setSaveAsEditableShapes()](#setsaveaseditableshapes) |  |
...
### constructor_overload$1(saveAsImage) {#constructor-overload1}
...
### setAdjustFontSizeForRowType() {#setadjustfontsizeforrowtype}
...
### setExportViewType() {#setexportviewtype}
...
### setIgnoreHiddenRows() {#setignorehiddenrows}
