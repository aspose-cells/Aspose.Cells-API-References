...
type: docs
weight: 4630
url: /nodejs/aspose.cells/webextensionshape/
---
...
| [setWebExtension()](#setwebextension) | Gets and set the web extension. |
...
| [toImage(stream, imageFormat)](#toimage) | Creates the shape image and saves it to a stream in the specified format. The following formats are supported: .bmp, .gi |
| [toImage()](#toimage-1) | Saves the shape to a file. |
| [toImage()](#toimage-2) | Saves the shape to a stream. |
...
### setWebExtension() {#setwebextension}
...
### toImage(stream, imageFormat) {#toimage}
