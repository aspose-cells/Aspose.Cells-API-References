...
| [toImageStream(shape, stream, options)](#toimagestream) *(static)* | Saves the shape to a stream. |
| [toImageStream(shape, stream, imageFormat)](#toimagestream-1) *(static)* | Creates the shape image and saves it to a stream in the specified format. The following formats are supported: .bmp, .gi |
...
### toImageStream(shape, stream, imageFormat) (static) {#toimagestream-1}
