...
type: docs
weight: 3110
url: /nodejs/aspose.cells/radiobutton/
---
...
| [getOptionIndex()](#getoptionindex) | Gets the option index (one-based) in all the radio buttons of the GroupBox which contains this radio button. If this rad |
...
| [setChecked()](#setchecked) | Indicates if the radiobutton is checked or not. |
