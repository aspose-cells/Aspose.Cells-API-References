...
type: docs
weight: 1310
url: /nodejs/aspose.cells/equationnode/
---
...
| [toLaTeX()](#tolatex) |  |
| [toMathML()](#tomathml) |  |
| [createNode(equationType, workbook, parent)](#createnode) *(static)* | Create a node of the specified type. |
...
### createNode(equationType, workbook, parent) (static) {#createnode}
