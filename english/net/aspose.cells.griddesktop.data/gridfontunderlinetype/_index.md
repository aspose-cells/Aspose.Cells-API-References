---
title: Enum GridFontUnderlineType
second_title: Aspose.Cells for .NET API Reference
description: Aspose.Cells.GridDesktop.Data.GridFontUnderlineType enum. Enumerates the font underline types
type: docs
url: /net/aspose.cells.griddesktop.data/gridfontunderlinetype/
---
## GridFontUnderlineType enumeration

Enumerates the font underline types.

```csharp
public enum GridFontUnderlineType
```
