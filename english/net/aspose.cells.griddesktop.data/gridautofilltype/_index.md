---
title: Enum GridAutoFillType
second_title: Aspose.Cells for .NET API Reference
description: Aspose.Cells.GridDesktop.Data.GridAutoFillType enum. Represents the auto fill type
type: docs
url: /net/aspose.cells.griddesktop.data/gridautofilltype/
---
## GridAutoFillType enumeration

Represents the auto fill type.

```csharp
public enum GridAutoFillType
```
