---
title: GridExportTableOptions.CheckMixedValueType
second_title: Aspose.Cells for .NET API Reference
description: GridExportTableOptions property. False Aspose.Cells will set the DataColumns type by the value type of the first row for performance. True Aspose.Cells will check whether the value type in the column are mixed before set the DataColumns type And the value type are mixed the DataColumns type will be string
type: docs
url: /net/aspose.cells.griddesktop.data/gridexporttableoptions/checkmixedvaluetype/
---
## GridExportTableOptions.CheckMixedValueType property
