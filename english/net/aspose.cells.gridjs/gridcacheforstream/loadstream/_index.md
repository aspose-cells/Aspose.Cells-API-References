---
title: GridCacheForStream.LoadStream
second_title: Aspose.Cells for .NET API Reference
description: GridCacheForStream method. Implements this method to load cache with the key uidreturn the stream from the cache
type: docs
