...
description: Aspose.Cells.GridJs.GridCalculationData class. Represents the required data when calculating one function such as function name parameters ...etc
type: docs
...
| [Value](../../aspose.cells.gridjs/gridcalculationdata/value/) { get; } | Gets the Cell value where the function is in. |
