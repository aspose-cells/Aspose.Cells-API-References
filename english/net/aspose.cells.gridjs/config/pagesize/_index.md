---
title: Config.PageSize
second_title: Aspose.Cells for .NET API Reference
description: Config property. Gets/Sets whether to do pagination GridJs will limit the row size based on the PageSizeif PageSize is 1it will not do pagination the default value is 1
type: docs
