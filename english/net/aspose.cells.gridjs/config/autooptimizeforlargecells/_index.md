...
description: Config property. Sets whether to automatically optimize the load performance for worksheet with large cells ignore some style /borders to reduce the load time the default value is true
type: docs
