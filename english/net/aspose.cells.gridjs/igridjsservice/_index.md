...
| [CheckAndSyncForCollaborative](../../aspose.cells.gridjs/igridjsservice/checkandsyncforcollaborative/)(string) | Check wether workbook instance is in memory cache and need to sync with history operations .this method is apply for Collaborative mode only. |
