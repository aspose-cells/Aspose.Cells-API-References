---
title: IGridJsService.LazyLoadingStreamJson
second_title: Aspose.Cells for .NET API Reference
description: IGridJsService method. Writes the JSON string of the specified sheet in the file from the cache using the specified unique id to the stream
type: docs
url: /net/aspose.cells.gridjs/igridjsservice/lazyloadingstreamjson/
---
