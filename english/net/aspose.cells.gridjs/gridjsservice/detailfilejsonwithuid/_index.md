---
title: GridJsService.DetailFileJsonWithUid
second_title: Aspose.Cells for .NET API Reference
description: GridJsService method. Gets JSON string for the file by the specified unique id. 
type: docs
url: /net/aspose.cells.gridjs/gridjsservice/detailfilejsonwithuid/
---
## DetailFileJsonWithUid(string, string) {#detailfilejsonwithuid_1}
...
## DetailFileJsonWithUid(Workbook, string, string) {#detailfilejsonwithuid}
