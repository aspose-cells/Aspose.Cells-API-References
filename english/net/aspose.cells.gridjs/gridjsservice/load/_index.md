---
title: GridJsService.Load
second_title: Aspose.Cells for .NET API Reference
description: GridJsService method. Gets the JSON string of the file from the cache using the specified unique idset the output filename in the JSON
type: docs
url: /net/aspose.cells.gridjs/gridjsservice/load/
---
## GridJsService.Load method
