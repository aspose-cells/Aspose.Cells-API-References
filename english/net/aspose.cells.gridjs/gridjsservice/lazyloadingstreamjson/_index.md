---
title: GridJsService.LazyLoadingStreamJson
second_title: Aspose.Cells for .NET API Reference
description: GridJsService method. Writes the JSON string of the specified sheet in the file from the cache using the specified unique id to the stream
type: docs
url: /net/aspose.cells.gridjs/gridjsservice/lazyloadingstreamjson/
---
## GridJsService.LazyLoadingStreamJson method
