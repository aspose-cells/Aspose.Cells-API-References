---
title: RowFilterSettings.EndColumn
second_title: Aspose.Cells for .NET API Reference
description: RowFilterSettings property. The end row number of the filter range. If this value is set to 1 the last row number of the sheet is used
type: docs
