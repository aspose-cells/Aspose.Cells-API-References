---
title: GridTxtLoadOptions.TreatQuotePrefixAsValue
second_title: Aspose.Cells for .NET API Reference
description: GridTxtLoadOptions property. Indicates whether the leading single quote sign should be taken as part of the value of one cell. Default is true. If it is false the leading single quote will be removed from corresponding cells value and QuotePrefix will be set as true for the cell
type: docs
