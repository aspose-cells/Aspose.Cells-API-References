---
title: PivotCaches.Add
second_title: Aspose.Cells for .NET API Reference
description: PivotCaches method. Adds a PivotCache from DataTable
type: docs
...
## Add(WebWorksheet, WebCellArea) {#add}
...
## Add(WebWorksheet, WebCellArea, string) {#add_1}
