---
title: TextParagraph.LeftMargin
second_title: Aspose.Cells for .NET API Reference
description: TextParagraph property. Specifies the left margin of the paragraph
type: docs
...
```csharp
namespace AsposeCellsExamples.TextParagraphPropertyLeftMarginDemo
{
    using Aspose.Cells;
