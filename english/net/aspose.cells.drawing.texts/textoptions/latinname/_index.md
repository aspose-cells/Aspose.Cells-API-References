---
title: TextOptions.LatinName
second_title: Aspose.Cells for .NET API Reference
description: TextOptions property. Gets and sets the latin name
type: docs
...
```csharp
namespace AsposeCellsExamples.TextOptionsPropertyLatinNameDemo
{
    using Aspose.Cells;
