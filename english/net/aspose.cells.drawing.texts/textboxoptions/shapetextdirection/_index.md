---
title: TextBoxOptions.ShapeTextDirection
second_title: Aspose.Cells for .NET API Reference
description: TextBoxOptions property. Gets or sets the text display direction within a given text body. It corresponds to Format Shape  Text Options  Text Box  Text direction in Excel
type: docs
url: /net/aspose.cells.drawing.texts/textboxoptions/shapetextdirection/
---
