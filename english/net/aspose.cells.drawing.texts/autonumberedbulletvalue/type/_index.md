---
title: AutoNumberedBulletValue.Type
second_title: Aspose.Cells for .NET API Reference
description: AutoNumberedBulletValue property. Gets the type of the bullet
type: docs
...
```csharp
namespace AsposeCellsExamples.AutoNumberedBulletValuePropertyTypeDemo
{
    using Aspose.Cells;
