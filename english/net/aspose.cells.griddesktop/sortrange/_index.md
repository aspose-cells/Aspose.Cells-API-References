---
title: Class SortRange
second_title: Aspose.Cells for .NET API Reference
description: Aspose.Cells.GridDesktop.SortRange class. Indicates a range of a Worksheet and provide method to sort the range datas by row or column
type: docs
...
| Name | Description |
| --- | --- |
| [SortRange](sortrange/)(Worksheet, int, int, int, int, SortOrientation, bool) | Intializes a new instance of the `SortRange` class by specifing a worksheet range and sort orientation. |
