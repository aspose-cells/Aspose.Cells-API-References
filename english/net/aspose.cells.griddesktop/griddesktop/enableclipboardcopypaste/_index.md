...
description: Indicates whether to copy/paste based on clipboardso that it can copy/paste with MS-EXCEL. It only copys/pastes cell value It does not copy any other setting of the cell like formatborder style and so on The default value is false.
type: docs
weight: 110
