---
title: GridDesktop.EnableClipboardCopyPaste
second_title: Aspose.Cells for .NET API Reference
description: GridDesktop property. Indicates whether to copy/paste based on clipboardso that it can copy/paste with MSEXCEL. It only copys/pastes cell value It does not copy any other setting of the cell like formatborder style and so on The default value is false
type: docs
