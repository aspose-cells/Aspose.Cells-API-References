...
description: Walls property. Gets the depth front to back in units of 1/4000 of charts width after calls Chart.Calculate method
type: docs
...
```csharp
// Called: Console.WriteLine("Depth: " + walls.Depth);
public static void Walls_Property_Depth()
        {
