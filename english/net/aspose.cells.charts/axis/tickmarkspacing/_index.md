---
title: Axis.TickMarkSpacing
second_title: Aspose.Cells for .NET API Reference
description: Axis property. Returns or sets the number of categories or series between tick marks. Applies only to category and series axes
type: docs
...
```csharp
// Called: AssertHelper.AreEqual(cAxisSrc.TickMarkSpacing, cAxisDest.TickMarkSpacing, info + &amp;quot;.TickMarkSpacing&amp;quot;);
public static void Property_TickMarkSpacing(Axis cAxisSrc, Axis cAxisDest, string info)
        {
            if (AssertHelper.checkNull(cAxisSrc, cAxisDest, info))
            {
                return;
            }
            TitleTest.Property_TickMarkSpacing(cAxisSrc.Title, cAxisDest.Title, info + &quot;.Title&quot;);
            ...
            if (cAxisSrc.IsVisible &amp;&amp; cAxisDest.IsVisible)
            {
                ...
                {
                    DisplayUnitLabelTest.Property_TickMarkSpacing(cAxisSrc.DisplayUnitLabel, cAxisDest.DisplayUnitLabel, info + &quot;.DisplayUnitLabel&quot;);
                }
                ...
                //==============compare patterns==============//
                LineTest.Property_TickMarkSpacing(cAxisSrc.AxisLine, cAxisDest.AxisLine, info + &quot;.AxisLine&quot;);

                //==============compare font================//
                FontTest.Property_TickMarkSpacing(cAxisSrc.TickLabels.Font, cAxisDest.TickLabels.Font, info + &quot;.TickLabels.Font&quot;);
            ...
            LineTest.Property_TickMarkSpacing(cAxisSrc.MajorGridLines, cAxisDest.MajorGridLines, info+&quot;.MajorGridLines&quot;);
            LineTest.Property_TickMarkSpacing(cAxisSrc.MinorGridLines, cAxisDest.MinorGridLines, info+&quot;.MinorGridLines&quot;);
            //AssertHelper.AreEqual(cAxisSrc.CategoryType, cAxisDest.CategoryType, info + &quot;.CategoryType&quot;);
        }
```
