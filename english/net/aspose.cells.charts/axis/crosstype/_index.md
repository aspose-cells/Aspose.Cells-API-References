---
title: Axis.CrossType
second_title: Aspose.Cells for .NET API Reference
description: Axis property. Represents the CrossType on the specified axis where the other axis crosses
type: docs
...
```csharp
// Called: switch (cAxisSrc.CrossType)
public static void Property_CrossType(Axis cAxisSrc, Axis cAxisDest, string info)
        {
            if (AssertHelper.checkNull(cAxisSrc, cAxisDest, info))
            {
                return;
            }
            TitleTest.Property_CrossType(cAxisSrc.Title, cAxisDest.Title, info + &quot;.Title&quot;);
            ...
            if (cAxisSrc.IsVisible &amp;&amp; cAxisDest.IsVisible)
            {
                ...
                {
                    DisplayUnitLabelTest.Property_CrossType(cAxisSrc.DisplayUnitLabel, cAxisDest.DisplayUnitLabel, info + &quot;.DisplayUnitLabel&quot;);
                }
                ...
                //==============compare patterns==============//
                LineTest.Property_CrossType(cAxisSrc.AxisLine, cAxisDest.AxisLine, info + &quot;.AxisLine&quot;);

                //==============compare font================//
                FontTest.Property_CrossType(cAxisSrc.TickLabels.Font, cAxisDest.TickLabels.Font, info + &quot;.TickLabels.Font&quot;);
            ...
            LineTest.Property_CrossType(cAxisSrc.MajorGridLines, cAxisDest.MajorGridLines, info+&quot;.MajorGridLines&quot;);
            LineTest.Property_CrossType(cAxisSrc.MinorGridLines, cAxisDest.MinorGridLines, info+&quot;.MinorGridLines&quot;);
            //AssertHelper.AreEqual(cAxisSrc.CategoryType, cAxisDest.CategoryType, info + &quot;.CategoryType&quot;);
        }
```
