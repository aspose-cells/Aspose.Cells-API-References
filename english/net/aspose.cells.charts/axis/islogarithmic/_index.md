---
title: Axis.IsLogarithmic
second_title: Aspose.Cells for .NET API Reference
description: Axis property. Represents if the value axis scale type is logarithmic or not
type: docs
...
```csharp
// Called: ActualChart.CategoryAxis.IsLogarithmic = true;
//http://www.aspose.com/community/forums/thread/223664.aspx
public void Axis_Property_IsLogarithmic()
{
    Console.WriteLine("Axis_Property_IsLogarithmic()");
