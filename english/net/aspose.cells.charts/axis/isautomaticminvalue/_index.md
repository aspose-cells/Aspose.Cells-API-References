---
title: Axis.IsAutomaticMinValue
second_title: Aspose.Cells for .NET API Reference
description: Axis property. Indicates whether the min value is automatically assigned
type: docs
...
```csharp
// Called: AssertHelper.AreEqual(cAxisSrc.IsAutomaticMinValue, cAxisDest.IsAutomaticMinValue, info + ".IsAutomaticMinValue");
public static void Property_IsAutomaticMinValue(Axis cAxisSrc, Axis cAxisDest, string info)
        {
            if (AssertHelper.checkNull(cAxisSrc, cAxisDest, info))
            {
                return;
            }
            TitleTest.Property_IsAutomaticMinValue(cAxisSrc.Title, cAxisDest.Title, info + ".Title");
            ...
            if (cAxisSrc.IsVisible && cAxisDest.IsVisible)
            {
                ...
                {
                    DisplayUnitLabelTest.Property_IsAutomaticMinValue(cAxisSrc.DisplayUnitLabel, cAxisDest.DisplayUnitLabel, info + ".DisplayUnitLabel");
                }
                ...
                //==============compare patterns==============//
                LineTest.Property_IsAutomaticMinValue(cAxisSrc.AxisLine, cAxisDest.AxisLine, info + ".AxisLine");

                //==============compare font================//
                FontTest.Property_IsAutomaticMinValue(cAxisSrc.TickLabels.Font, cAxisDest.TickLabels.Font, info + ".TickLabels.Font");
            ...
            LineTest.Property_IsAutomaticMinValue(cAxisSrc.MajorGridLines, cAxisDest.MajorGridLines, info+".MajorGridLines");
            LineTest.Property_IsAutomaticMinValue(cAxisSrc.MinorGridLines, cAxisDest.MinorGridLines, info+".MinorGridLines");
            //AssertHelper.AreEqual(cAxisSrc.CategoryType, cAxisDest.CategoryType, info + ".CategoryType");
        }
```
