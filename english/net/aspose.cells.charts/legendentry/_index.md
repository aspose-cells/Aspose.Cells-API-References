...
| [Background](../../aspose.cells.charts/legendentry/background) { get; set; } | Gets and sets the display mode of the background |
...
| virtual [TextFont](../../aspose.cells.charts/legendentry/textfont) { get; } | Gets a [`Font`](./font) object of the specified LegendEntry object. |
