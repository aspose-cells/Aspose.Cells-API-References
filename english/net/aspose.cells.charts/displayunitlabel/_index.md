...
| Name | Description |
| --- | --- |
| override [AutoScaleFont](autoscalefont) { get; set; } | True if the text in the object changes font size when the object size changes. The default value is True. |
| override [Font](font) { get; } | Gets a [`Font`](./font) object of the specified ChartFrame object. |
