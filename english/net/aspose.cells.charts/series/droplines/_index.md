---
title: Series.DropLines
second_title: Aspose.Cells for .NET API Reference
description: Series property. Returns a Line object that represents the drop lines for a series on the line chart or area chart. Applies only to line charts or area charts
type: docs
url: /net/aspose.cells.charts/series/droplines/
---
## Series.DropLines property

Returns a [`Line`](../../../aspose.cells.drawing/line/) object that represents the drop lines for a series on the line chart or area chart. Applies only to line charts or area charts.
