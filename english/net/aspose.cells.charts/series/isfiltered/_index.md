...
description: Series property. Indicates whether the series is selected or filtered. True indicates that this series is filtered and it will not be displayed on the chart
type: docs
