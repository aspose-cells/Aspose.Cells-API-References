---
title: Series.HasHiLoLines
second_title: Aspose.Cells for .NET API Reference
description: Series property. True if the line chart has highlow lines. Applies only to line charts
type: docs
...
```csharp
// Called: AssertHelper.AreEqual(aseriesSrc.HasHiLoLines, aseriesDest.HasHiLoLines, info + ".HasHiLoLines");
public static void Property_HasHiLoLines(Series aseriesSrc, Series aseriesDest, string info)
        {
            ...
            //===============compare patterns================//
            LineTest.Property_HasHiLoLines(aseriesSrc.Border, aseriesDest.Border, info + ".Line");
            AreaTest.Property_HasHiLoLines(aseriesSrc.Area, aseriesDest.Area, info + ".Area");
            ...
            if (aseriesSrc.Marker.MarkerStyle != ChartMarkerType.Automatic && aseriesSrc.Marker.MarkerStyle != ChartMarkerType.None)
            {
                ...
                {
                    AssertHelper.Property_HasHiLoLines(aseriesSrc.Marker.Border.Color, aseriesDest.Marker.Border.Color, info + ".MarkerForegroundColor");
                }
                ...
                {
                    AssertHelper.Property_HasHiLoLines(aseriesSrc.Marker.Area.ForegroundColor, aseriesDest.Marker.Area.ForegroundColor, info + ".MarkerBackgroundColor");
                }
            ...
            //================compare YError Bar=================//            
            ErrorBarTest.Property_HasHiLoLines(aseriesSrc.YErrorBar, aseriesDest.YErrorBar, info + ".YErrorBar");
            DataLabelsTest.Property_HasHiLoLines(aseriesSrc.DataLabels, aseriesDest.DataLabels, info + ".DataLabels");
            //================compare options====================//
            //for column chart
