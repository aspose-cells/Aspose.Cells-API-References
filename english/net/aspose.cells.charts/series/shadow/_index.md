...
public static void Property_Shadow(Series aseriesSrc, Series aseriesDest, string info)
        {
            ...
            //===============compare patterns================//
            LineTest.Property_Shadow(aseriesSrc.Border, aseriesDest.Border, info + &quot;.Line&quot;);
            AreaTest.Property_Shadow(aseriesSrc.Area, aseriesDest.Area, info + &quot;.Area&quot;);
            ...
            if (aseriesSrc.Marker.MarkerStyle != ChartMarkerType.Automatic &amp;&amp; aseriesSrc.Marker.MarkerStyle != ChartMarkerType.None)
            {
                ...
                {
                    AssertHelper.Property_Shadow(aseriesSrc.Marker.Border.Color, aseriesDest.Marker.Border.Color, info + &quot;.MarkerForegroundColor&quot;);
                }
                ...
                {
                    AssertHelper.Property_Shadow(aseriesSrc.Marker.Area.ForegroundColor, aseriesDest.Marker.Area.ForegroundColor, info + &quot;.MarkerBackgroundColor&quot;);
                }
            ...
            //================compare YError Bar=================//            
            ErrorBarTest.Property_Shadow(aseriesSrc.YErrorBar, aseriesDest.YErrorBar, info + &quot;.YErrorBar&quot;);
            DataLabelsTest.Property_Shadow(aseriesSrc.DataLabels, aseriesDest.DataLabels, info + &quot;.DataLabels&quot;);
            //================compare options====================//
            //for column chart
