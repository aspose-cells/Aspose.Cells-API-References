---
title: Enum DisplayUnitType
second_title: Aspose.Cells for .NET API Reference
description: Aspose.Cells.Charts.DisplayUnitType enum. Represents the type of display unit of charts axis
type: docs
...
| Hundreds | `1` | Specifies that the values on the chart shall be divided by 100. |
| Thousands | `2` | Specifies the values on the chart shall be divided by 1,000. |
| TenThousands | `3` | Specifies that the values on the chart shall be divided by 10,000. |
| HundredThousands | `4` | Specifies the values on the chart shall be divided by 100,000. |
| Millions | `5` | Specifies that the values on the chart shall be divided by 1,000,000. |
| TenMillions | `6` | Specifies the values on the chart shall be divided by 10,000,000. |
| HundredMillions | `7` | Specifies that the values on the chart shall be divided by 100,000,000. |
| Billions | `8` | Specifies the values on the chart shall be divided by 1,000,000,000. |
| Trillions | `9` | Specifies that the values on the chart shall be divided by 1,000,000,000,000. |
