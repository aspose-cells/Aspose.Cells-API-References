---
title: ChartPoint.InnerArcEndPointYPx
second_title: Aspose.Cells for .NET API Reference
description: ChartPoint property. Gets the y coordinate of ending point for the pie section after calls Chart.Calculate method. Applies to Doughnut chart
type: docs
...
```csharp
namespace AsposeCellsExamples.ChartPointPropertyInnerArcEndPointYPxDemo
{
    using Aspose.Cells;
