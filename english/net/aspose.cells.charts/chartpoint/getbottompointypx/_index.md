---
title: ChartPoint.GetBottomPointYPx
second_title: Aspose.Cells for .NET API Reference
description: ChartPoint method. Gets ycoordinate of the bottom point of shape after calls Chart.Calculate method. Applies 3D charts Column3D Bar3D Cone Cylinder Pyramid
type: docs
...
```csharp
namespace AsposeCellsExamples.ChartPointMethodGetBottomPointYPxDemo
{
    using Aspose.Cells;
