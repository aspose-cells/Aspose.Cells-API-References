...
description: ChartPoint property. Gets the starting angle for the pie section measured in degrees clockwise from the xaxis after calling the Chart.Calculate method. Applies to Pie chart
type: docs
