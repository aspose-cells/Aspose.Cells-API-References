---
title: ChartPoint.StartAngle
second_title: Aspose.Cells for .NET API Reference
description: ChartPoint property. Gets the starting angle for the pie section measured in degrees clockwise from the xaxis after calls Chart.Calculate method. Applies to Pie chart
type: docs
...
```csharp
namespace AsposeCellsExamples.ChartPointPropertyStartAngleDemo
{
    using Aspose.Cells;
