...
description: ChartPoint property. Gets the x coordinate of the ending point for the pie section after calling the Chart.Calculate method. Applies to Pie and Doughnut charts
type: docs
