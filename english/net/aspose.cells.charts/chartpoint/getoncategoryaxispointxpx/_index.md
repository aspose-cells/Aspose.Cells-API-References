---
title: ChartPoint.GetOnCategoryAxisPointXPx
second_title: Aspose.Cells for .NET API Reference
description: ChartPoint method. Gets xcoordinate of the point on category axis after calls Chart.Calculate method. Only applies to Area chart
type: docs
...
```csharp
namespace AsposeCellsExamples.ChartPointMethodGetOnCategoryAxisPointXPxWithInt32Demo
{
    using Aspose.Cells;
