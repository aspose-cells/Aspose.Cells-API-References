---
title: ChartPoint.YValueType
second_title: Aspose.Cells for .NET API Reference
description: ChartPoint property. Gets Y value type of the chart point
type: docs
...
```csharp
namespace AsposeCellsExamples.ChartPointPropertyYValueTypeDemo
{
    using Aspose.Cells;
