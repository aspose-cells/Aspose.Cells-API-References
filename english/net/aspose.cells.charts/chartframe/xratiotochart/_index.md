---
title: ChartFrame.XRatioToChart
second_title: Aspose.Cells for .NET API Reference
description: ChartFrame property. Gets or sets the x coordinate of the upper left corner in units of ratio of the chart area
type: docs
url: /net/aspose.cells.charts/chartframe/xratiotochart/
---
...
```csharp
namespace AsposeCellsExamples.ChartFramePropertyXRatioToChartDemo
{
    using Aspose.Cells;
