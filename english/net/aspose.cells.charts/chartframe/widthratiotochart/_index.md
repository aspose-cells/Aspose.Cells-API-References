---
title: ChartFrame.WidthRatioToChart
second_title: Aspose.Cells for .NET API Reference
description: ChartFrame property. Gets or sets the width of frame in units of ratio of the chart area
type: docs
url: /net/aspose.cells.charts/chartframe/widthratiotochart/
---
...
```csharp
namespace AsposeCellsExamples.ChartFramePropertyWidthRatioToChartDemo
{
    using Aspose.Cells;
