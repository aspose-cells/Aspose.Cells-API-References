...
description: Aspose.Cells.Charts.Title class. Encapsulates the object that represents the title of chart or axis
type: docs
...
| [OverLay](../../aspose.cells.charts/title/overlay/) { get; set; } | Represents an overlay centered title on a chart without resizing the chart. |
...
| override [Text](../../aspose.cells.charts/title/text/) { get; set; } | Gets or sets the text of the display unit label. |
...
| override [X](../../aspose.cells.charts/title/x/) { get; set; } | (**Obsolete.**) Gets or sets the X coordinate of the upper left corner in units of 1/4000 of the chart area. |
...
| override [XRatioToChart](../../aspose.cells.charts/title/xratiotochart/) { get; set; } | Gets or sets the x coordinate of the upper left corner in units of Fraction of the chart area. X In Pixels = XRatioToChart * Chart.ChartObject.Width; |
| override [Y](../../aspose.cells.charts/title/y/) { get; set; } | (**Obsolete.**) Gets or sets the y coordinate of the upper left corner in units of 1/4000 of the chart area. |
...
| override [YRatioToChart](../../aspose.cells.charts/title/yratiotochart/) { get; set; } | Gets or sets the y coordinate of the upper left corner in units of Fraction of the chart area. Y In Pixels = YRatioToChart * Chart.ChartObject.Width; |
