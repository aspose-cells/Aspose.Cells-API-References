---
title: Class DataLabels
second_title: Aspose.Cells for .NET API Reference
description: Aspose.Cells.Charts.DataLabels class. Encapsulates a collection of all the DataLabel objects for the specified Series
type: docs
...
| [DefaultHeight](../../aspose.cells.charts/chartframe/defaultheight/) { get; } | (**Obsolete.**) Represents height of the default position in units of 1/4000 of the chart area.(Inherited from [`ChartFrame`](../chartframe/).) |
| [DefaultHeightRatioToChart](../../aspose.cells.charts/chartframe/defaultheightratiotochart/) { get; } | Represents height of the default position in units of the fraction of the chart area.(Inherited from [`ChartFrame`](../chartframe/).) |
...
| [DefaultY](../../aspose.cells.charts/chartframe/defaulty/) { get; } | (**Obsolete.**) Represents the y of the default position in units of 1/4000 of the chart area.(Inherited from [`ChartFrame`](../chartframe/).) |
| [DefaultYRatioToChart](../../aspose.cells.charts/chartframe/defaultyratiotochart/) { get; } | Represents y of the default position in units of the fraction of the chart area.(Inherited from [`ChartFrame`](../chartframe/).) |
...
| virtual [Height](../../aspose.cells.charts/chartframe/height/) { get; set; } | (**Obsolete.**) Gets or sets the height of the frame in units of 1/4000 of the chart area.(Inherited from [`ChartFrame`](../chartframe/).) |
| virtual [HeightPixel](../../aspose.cells.charts/chartframe/heightpixel/) { get; set; } | Gets or sets the height of the frame in units of pixels.(Inherited from [`ChartFrame`](../chartframe/).) |
| virtual [HeightRatioToChart](../../aspose.cells.charts/chartframe/heightratiotochart/) { get; set; } | Gets or sets the height of the frame in units of the ratio of the chart area.(Inherited from [`ChartFrame`](../chartframe/).) |
...
| [IsDefaultPosBeSet](../../aspose.cells.charts/chartframe/isdefaultposbeset/) { get; } | Indicates whether default position (DefaultX, DefaultY, DefaultWidth and DefaultHeight) is set.(Inherited from [`ChartFrame`](../chartframe/).) |
| [IsDeleted](../../aspose.cells.charts/charttextframe/isdeleted/) { get; set; } | Indicates whether this data label is deleted.(Inherited from [`ChartTextFrame`](../charttextframe/).) |
...
| [IsNeverOverlap](../../aspose.cells.charts/datalabels/isneveroverlap/) { get; set; } | Indicates whether Datalabels never overlap when performing a Pie Chart to image. Note: this property is only meaningful when a Pie Chart to image. |
...
| [ShowBubbleSize](../../aspose.cells.charts/datalabels/showbubblesize/) { get; set; } | Represents a specified chart's data label percentage value display behavior. True displays the percentage value. False hides the percentage value. |
...
| [ShowCellRange](../../aspose.cells.charts/datalabels/showcellrange/) { get; set; } | Indicates whether to show cell range as the data labels. |
...
| [ShowSeriesName](../../aspose.cells.charts/datalabels/showseriesname/) { get; set; } | Indicates whether the series name displays on the data labels on a chart. True to show the series name. False to hide. |
...
| override [Text](../../aspose.cells.charts/datalabels/text/) { get; set; } | Gets or sets the text of the data label. |
...
| virtual [YPixel](../../aspose.cells.charts/chartframe/ypixel/) { get; set; } | Gets or sets the y coordinate of the upper left corner in units of pixels.(Inherited from [`ChartFrame`](../chartframe/).) |
| virtual [YRatioToChart](../../aspose.cells.charts/chartframe/yratiotochart/) { get; set; } | Gets or sets the y coordinate of the upper left corner in units of the ratio of the chart area.(Inherited from [`ChartFrame`](../chartframe/).) |
