...
description: DataLabels property. Indicates whether Datalabels never overlap when performing a Pie Chart to image. Note this property is only meaningful when a Pie Chart to image
type: docs
