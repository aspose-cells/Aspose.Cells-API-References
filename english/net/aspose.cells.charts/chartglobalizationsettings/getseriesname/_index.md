---
title: ChartGlobalizationSettings.GetSeriesName
second_title: Aspose.Cells for .NET API Reference
description: ChartGlobalizationSettings method. Gets the name of Series in the Chart
type: docs
...
```csharp
// Called: string seriesName = globalizationSettings.GetSeriesName();
public static void ChartGlobalizationSettings_Method_GetSeriesName()
        {
