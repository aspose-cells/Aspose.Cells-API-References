---
title: ChartGlobalizationSettings.GetLegendDecreaseName
second_title: Aspose.Cells for .NET API Reference
description: ChartGlobalizationSettings method. Gets the name of Decrease for Legend
type: docs
...
```csharp
// Called: string legendDecreaseName = globalizationSettings.GetLegendDecreaseName();
public static void ChartGlobalizationSettings_Method_GetLegendDecreaseName()
        {
