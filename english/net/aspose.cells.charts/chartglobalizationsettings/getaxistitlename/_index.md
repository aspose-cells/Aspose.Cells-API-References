---
title: ChartGlobalizationSettings.GetAxisTitleName
second_title: Aspose.Cells for .NET API Reference
description: ChartGlobalizationSettings method. Gets the name of Title for Axis
type: docs
...
```csharp
// Called: string axisTitleName = globalizationSettings.GetAxisTitleName();
public static void ChartGlobalizationSettings_Method_GetAxisTitleName()
        {
