...
```csharp
// Called: AssertHelper.AreEqual(cAxisSrc.TickLabels.ReadingOrder, cAxisDest.TickLabels.ReadingOrder, info + ".TickLabels.TextDirection");
public static void Property_ReadingOrder(Axis cAxisSrc, Axis cAxisDest, string info)
        {
            if (AssertHelper.checkNull(cAxisSrc, cAxisDest, info))
            {
                return;
            }
            TitleTest.Property_ReadingOrder(cAxisSrc.Title, cAxisDest.Title, info + ".Title");
            ...
            if (cAxisSrc.IsVisible && cAxisDest.IsVisible)
            {
                ...
                {
                    DisplayUnitLabelTest.Property_ReadingOrder(cAxisSrc.DisplayUnitLabel, cAxisDest.DisplayUnitLabel, info + ".DisplayUnitLabel");
                }
                ...
                //==============compare patterns==============//
                LineTest.Property_ReadingOrder(cAxisSrc.AxisLine, cAxisDest.AxisLine, info + ".AxisLine");

                //==============compare font================//
                FontTest.Property_ReadingOrder(cAxisSrc.TickLabels.Font, cAxisDest.TickLabels.Font, info + ".TickLabels.Font");
            ...
            LineTest.Property_ReadingOrder(cAxisSrc.MajorGridLines, cAxisDest.MajorGridLines, info+".MajorGridLines");
            LineTest.Property_ReadingOrder(cAxisSrc.MinorGridLines, cAxisDest.MinorGridLines, info+".MinorGridLines");
            //AssertHelper.AreEqual(cAxisSrc.CategoryType, cAxisDest.CategoryType, info + ".CategoryType");
        }
```
