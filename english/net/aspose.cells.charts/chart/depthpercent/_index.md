...
public static void Chart_Property_DepthPercent(Chart chartSrc, Chart chartDest, string info)
        {
            ...
            //=======================compare ChartArea======================//
            ChartAreaTest.Chart_Property_DepthPercent(chartSrc.ChartArea, chartDest.ChartArea, info + ".ChartArea");
            ...
            //=======================compare PlotArea======================//
            ChartFrameTest.Chart_Property_DepthPercent(chartSrc.PlotArea, chartDest.PlotArea, info + ".PlotArea");
            //=======================compare Legend======================//
            ...
            if (chartSrc.ShowLegend && chartDest.ShowLegend)
                LegendTest.Chart_Property_DepthPercent(chartSrc.Legend, chartDest.Legend, info + ".Legend");           
           //=======================compare axis=========================//
            AxisTest.Chart_Property_DepthPercent(chartSrc.CategoryAxis, chartDest.CategoryAxis, info + ".CategoryAxis");
            AxisTest.Chart_Property_DepthPercent(chartSrc.ValueAxis, chartDest.ValueAxis, info + ".ValueAxis");
            AxisTest.Chart_Property_DepthPercent(chartSrc.SeriesAxis, chartDest.SeriesAxis, info + ".SeriesAxis");
            AxisTest.Chart_Property_DepthPercent(chartSrc.SecondCategoryAxis, chartDest.SecondCategoryAxis, info + ".SecondCategoryAxis");
            AxisTest.Chart_Property_DepthPercent(chartSrc.SecondValueAxis, chartDest.SecondValueAxis, info + ".SecondValueAxis");
            //=======================compare ASeries======================//
            NSeriesTest.Chart_Property_DepthPercent(chartSrc.NSeries, chartDest.NSeries, info + ".NSeries");
            //====================compare options===============//
            //for column chart
            ...
            TitleTest.Chart_Property_DepthPercent(chartSrc.Title, chartDest.Title, info + ".Title");
            //compare axes
            ...
            {
                ChartDataTableTest.Chart_Property_DepthPercent(chartSrc.ChartDataTable, chartDest.ChartDataTable, info + ".ChartDataTable");
            }
            //=================compare for 3d================================//            
            ...
            WallsTest.Chart_Property_DepthPercent(chartSrc.Walls, chartDest.Walls, info + ".Walls");
            FloorTest.Chart_Property_DepthPercent(chartSrc.Floor, chartDest.Floor, info + ".Floor");
            ...
            //ChartShapeTest.Chart_Property_DepthPercent(chartSrc.ChartObject, chartDest.ChartObject, info + ".ChartObject");  
            //PageSetupTest.Chart_Property_DepthPercent(chartSrc.PageSetup, chartDest.PageSetup, info + ".PageSetup");
            ...
            //ShapesTest.Chart_Property_DepthPercent(chartSrc.Shapes, chartDest.Shapes, info + ".Shapes");
