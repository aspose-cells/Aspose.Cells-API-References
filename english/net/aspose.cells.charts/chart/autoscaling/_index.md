...
```csharp
// Called: AssertHelper.AreEqual(chartSrc.AutoScaling, chartDest.AutoScaling, info + &amp;quot;.AutoScaling&amp;quot;);
public static void Property_AutoScaling(Chart chartSrc, Chart chartDest, string info)
        {
            ...
            //=======================compare ChartArea======================//
            ChartAreaTest.Property_AutoScaling(chartSrc.ChartArea, chartDest.ChartArea, info + &quot;.ChartArea&quot;);
            ...
            //=======================compare PlotArea======================//
            ChartFrameTest.Property_AutoScaling(chartSrc.PlotArea, chartDest.PlotArea, info + &quot;.PlotArea&quot;);
            //=======================compare Legend======================//
            ...
            if (chartSrc.ShowLegend &amp;&amp; chartDest.ShowLegend)
                LegendTest.Property_AutoScaling(chartSrc.Legend, chartDest.Legend, info + &quot;.Legend&quot;);           
           //=======================compare axis=========================//
            AxisTest.Property_AutoScaling(chartSrc.CategoryAxis, chartDest.CategoryAxis, info + &quot;.CategoryAxis&quot;);
            AxisTest.Property_AutoScaling(chartSrc.ValueAxis, chartDest.ValueAxis, info + &quot;.ValueAxis&quot;);
            AxisTest.Property_AutoScaling(chartSrc.SeriesAxis, chartDest.SeriesAxis, info + &quot;.SeriesAxis&quot;);
            AxisTest.Property_AutoScaling(chartSrc.SecondCategoryAxis, chartDest.SecondCategoryAxis, info + &quot;.SecondCategoryAxis&quot;);
            AxisTest.Property_AutoScaling(chartSrc.SecondValueAxis, chartDest.SecondValueAxis, info + &quot;.SecondValueAxis&quot;);
            //=======================compare ASeries======================//
            NSeriesTest.Property_AutoScaling(chartSrc.NSeries, chartDest.NSeries, info + &quot;.NSeries&quot;);
            //====================compare options===============//
            //for column chart
            ...
            TitleTest.Property_AutoScaling(chartSrc.Title, chartDest.Title, info + &quot;.Title&quot;);
            //compare axes
            ...
            {
                ChartDataTableTest.Property_AutoScaling(chartSrc.ChartDataTable, chartDest.ChartDataTable, info + &quot;.ChartDataTable&quot;);
            }
            //=================compare for 3d================================//            
            ...
            WallsTest.Property_AutoScaling(chartSrc.Walls, chartDest.Walls, info + &quot;.Walls&quot;);
            FloorTest.Property_AutoScaling(chartSrc.Floor, chartDest.Floor, info + &quot;.Floor&quot;);
            ...
            //ChartShapeTest.Property_AutoScaling(chartSrc.ChartObject, chartDest.ChartObject, info + &quot;.ChartObject&quot;);  
            //PageSetupTest.Property_AutoScaling(chartSrc.PageSetup, chartDest.PageSetup, info + &quot;.PageSetup&quot;);
            ...
            //ShapesTest.Property_AutoScaling(chartSrc.Shapes, chartDest.Shapes, info + &quot;.Shapes&quot;);
