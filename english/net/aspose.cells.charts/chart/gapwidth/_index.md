...
```csharp
// Called: AssertHelper.AreEqual(chartSrc.GapWidth, chartDest.GapWidth, info + &amp;quot;.GapWidth&amp;quot;);
public static void Property_GapWidth(Chart chartSrc, Chart chartDest, string info)
        {
            ...
            //=======================compare ChartArea======================//
            ChartAreaTest.Property_GapWidth(chartSrc.ChartArea, chartDest.ChartArea, info + &quot;.ChartArea&quot;);
            ...
            //=======================compare PlotArea======================//
            ChartFrameTest.Property_GapWidth(chartSrc.PlotArea, chartDest.PlotArea, info + &quot;.PlotArea&quot;);
            //=======================compare Legend======================//
            ...
            if (chartSrc.ShowLegend &amp;&amp; chartDest.ShowLegend)
                LegendTest.Property_GapWidth(chartSrc.Legend, chartDest.Legend, info + &quot;.Legend&quot;);           
           //=======================compare axis=========================//
            AxisTest.Property_GapWidth(chartSrc.CategoryAxis, chartDest.CategoryAxis, info + &quot;.CategoryAxis&quot;);
            AxisTest.Property_GapWidth(chartSrc.ValueAxis, chartDest.ValueAxis, info + &quot;.ValueAxis&quot;);
            AxisTest.Property_GapWidth(chartSrc.SeriesAxis, chartDest.SeriesAxis, info + &quot;.SeriesAxis&quot;);
            AxisTest.Property_GapWidth(chartSrc.SecondCategoryAxis, chartDest.SecondCategoryAxis, info + &quot;.SecondCategoryAxis&quot;);
            AxisTest.Property_GapWidth(chartSrc.SecondValueAxis, chartDest.SecondValueAxis, info + &quot;.SecondValueAxis&quot;);
            //=======================compare ASeries======================//
            NSeriesTest.Property_GapWidth(chartSrc.NSeries, chartDest.NSeries, info + &quot;.NSeries&quot;);
            //====================compare options===============//
            //for column chart
            ...
            TitleTest.Property_GapWidth(chartSrc.Title, chartDest.Title, info + &quot;.Title&quot;);
            //compare axes
            ...
            {
                ChartDataTableTest.Property_GapWidth(chartSrc.ChartDataTable, chartDest.ChartDataTable, info + &quot;.ChartDataTable&quot;);
            }
            //=================compare for 3d================================//            
            ...
            WallsTest.Property_GapWidth(chartSrc.Walls, chartDest.Walls, info + &quot;.Walls&quot;);
            FloorTest.Property_GapWidth(chartSrc.Floor, chartDest.Floor, info + &quot;.Floor&quot;);
            ...
            //ChartShapeTest.Property_GapWidth(chartSrc.ChartObject, chartDest.ChartObject, info + &quot;.ChartObject&quot;);  
            //PageSetupTest.Property_GapWidth(chartSrc.PageSetup, chartDest.PageSetup, info + &quot;.PageSetup&quot;);
            ...
            //ShapesTest.Property_GapWidth(chartSrc.Shapes, chartDest.Shapes, info + &quot;.Shapes&quot;);
