...
public static void Property_SecondValueAxis(Chart chartSrc, Chart chartDest, string info)
        {
            ...
            //=======================compare ChartArea======================//
            ChartAreaTest.Property_SecondValueAxis(chartSrc.ChartArea, chartDest.ChartArea, info + &quot;.ChartArea&quot;);
            ...
            //=======================compare PlotArea======================//
            ChartFrameTest.Property_SecondValueAxis(chartSrc.PlotArea, chartDest.PlotArea, info + &quot;.PlotArea&quot;);
            //=======================compare Legend======================//
            ...
            if (chartSrc.ShowLegend &amp;&amp; chartDest.ShowLegend)
                LegendTest.Property_SecondValueAxis(chartSrc.Legend, chartDest.Legend, info + &quot;.Legend&quot;);           
           //=======================compare axis=========================//
            AxisTest.Property_SecondValueAxis(chartSrc.CategoryAxis, chartDest.CategoryAxis, info + &quot;.CategoryAxis&quot;);
            AxisTest.Property_SecondValueAxis(chartSrc.ValueAxis, chartDest.ValueAxis, info + &quot;.ValueAxis&quot;);
            AxisTest.Property_SecondValueAxis(chartSrc.SeriesAxis, chartDest.SeriesAxis, info + &quot;.SeriesAxis&quot;);
            AxisTest.Property_SecondValueAxis(chartSrc.SecondCategoryAxis, chartDest.SecondCategoryAxis, info + &quot;.SecondCategoryAxis&quot;);
            AxisTest.Property_SecondValueAxis(chartSrc.SecondValueAxis, chartDest.SecondValueAxis, info + &quot;.SecondValueAxis&quot;);
            //=======================compare ASeries======================//
            NSeriesTest.Property_SecondValueAxis(chartSrc.NSeries, chartDest.NSeries, info + &quot;.NSeries&quot;);
            //====================compare options===============//
            //for column chart
            ...
            TitleTest.Property_SecondValueAxis(chartSrc.Title, chartDest.Title, info + &quot;.Title&quot;);
            //compare axes
            ...
            {
                ChartDataTableTest.Property_SecondValueAxis(chartSrc.ChartDataTable, chartDest.ChartDataTable, info + &quot;.ChartDataTable&quot;);
            }
            //=================compare for 3d================================//            
            ...
            WallsTest.Property_SecondValueAxis(chartSrc.Walls, chartDest.Walls, info + &quot;.Walls&quot;);
            FloorTest.Property_SecondValueAxis(chartSrc.Floor, chartDest.Floor, info + &quot;.Floor&quot;);
            ...
            //ChartShapeTest.Property_SecondValueAxis(chartSrc.ChartObject, chartDest.ChartObject, info + &quot;.ChartObject&quot;);  
            //PageSetupTest.Property_SecondValueAxis(chartSrc.PageSetup, chartDest.PageSetup, info + &quot;.PageSetup&quot;);
            ...
            //ShapesTest.Property_SecondValueAxis(chartSrc.Shapes, chartDest.Shapes, info + &quot;.Shapes&quot;);
