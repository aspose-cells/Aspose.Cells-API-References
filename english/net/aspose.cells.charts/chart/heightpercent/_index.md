...
public static void Property_HeightPercent(Chart chartSrc, Chart chartDest, string info)
        {
            ...
            //=======================compare ChartArea======================//
            ChartAreaTest.Property_HeightPercent(chartSrc.ChartArea, chartDest.ChartArea, info + &quot;.ChartArea&quot;);
            ...
            //=======================compare PlotArea======================//
            ChartFrameTest.Property_HeightPercent(chartSrc.PlotArea, chartDest.PlotArea, info + &quot;.PlotArea&quot;);
            //=======================compare Legend======================//
            ...
            if (chartSrc.ShowLegend &amp;&amp; chartDest.ShowLegend)
                LegendTest.Property_HeightPercent(chartSrc.Legend, chartDest.Legend, info + &quot;.Legend&quot;);           
           //=======================compare axis=========================//
            AxisTest.Property_HeightPercent(chartSrc.CategoryAxis, chartDest.CategoryAxis, info + &quot;.CategoryAxis&quot;);
            AxisTest.Property_HeightPercent(chartSrc.ValueAxis, chartDest.ValueAxis, info + &quot;.ValueAxis&quot;);
            AxisTest.Property_HeightPercent(chartSrc.SeriesAxis, chartDest.SeriesAxis, info + &quot;.SeriesAxis&quot;);
            AxisTest.Property_HeightPercent(chartSrc.SecondCategoryAxis, chartDest.SecondCategoryAxis, info + &quot;.SecondCategoryAxis&quot;);
            AxisTest.Property_HeightPercent(chartSrc.SecondValueAxis, chartDest.SecondValueAxis, info + &quot;.SecondValueAxis&quot;);
            //=======================compare ASeries======================//
            NSeriesTest.Property_HeightPercent(chartSrc.NSeries, chartDest.NSeries, info + &quot;.NSeries&quot;);
            //====================compare options===============//
            //for column chart
            ...
            TitleTest.Property_HeightPercent(chartSrc.Title, chartDest.Title, info + &quot;.Title&quot;);
            //compare axes
            ...
            {
                ChartDataTableTest.Property_HeightPercent(chartSrc.ChartDataTable, chartDest.ChartDataTable, info + &quot;.ChartDataTable&quot;);
            }
            //=================compare for 3d================================//            
            ...
            WallsTest.Property_HeightPercent(chartSrc.Walls, chartDest.Walls, info + &quot;.Walls&quot;);
            FloorTest.Property_HeightPercent(chartSrc.Floor, chartDest.Floor, info + &quot;.Floor&quot;);
            ...
            //ChartShapeTest.Property_HeightPercent(chartSrc.ChartObject, chartDest.ChartObject, info + &quot;.ChartObject&quot;);  
            //PageSetupTest.Property_HeightPercent(chartSrc.PageSetup, chartDest.PageSetup, info + &quot;.PageSetup&quot;);
            ...
            //ShapesTest.Property_HeightPercent(chartSrc.Shapes, chartDest.Shapes, info + &quot;.Shapes&quot;);
