---
title: Class NumbersLoadOptions
second_title: Aspose.Cells for .NET API Reference
description: Aspose.Cells.Numbers.NumbersLoadOptions class. Represents the options of loading Apple Numbers files
type: docs
...
| [PreserveTableName](../../aspose.cells.numbers/numbersloadoptions/preservetablename/) { get; set; } | Indicates whether to preserve table names when exporting from Numbers. |
