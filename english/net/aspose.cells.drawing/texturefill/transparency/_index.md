---
title: TextureFill.Transparency
second_title: Aspose.Cells for .NET API Reference
description: TextureFill property. Returns or sets the degree of transparency of the area as a value from 0.0 opaque through 1.0 clear
type: docs
...
```csharp
namespace AsposeCellsExamples.TextureFillPropertyTransparencyDemo
{
    using Aspose.Cells;
