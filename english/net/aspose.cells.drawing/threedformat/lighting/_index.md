---
title: ThreeDFormat.Lighting
second_title: Aspose.Cells for .NET API Reference
description: ThreeDFormat property. Gets and sets type of light rig
type: docs
...
```csharp
namespace AsposeCellsExamples.ThreeDFormatPropertyLightingDemo
{
    using Aspose.Cells;
