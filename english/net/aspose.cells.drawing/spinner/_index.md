...
description: Aspose.Cells.Drawing.Spinner class. Represents the Forms control Spinner
type: docs
...
{
    public class DrawingClassSpinnerDemo
    {
        public static void Run()
        {
            ...
            // Add a spinner control to the worksheet
            ...
            // Set some common shape properties
            spinner.Placement = PlacementType.FreeFloating;
            spinner.IsPrintable = true;
            spinner.AlternativeText = "Sample Spinner Control";

            // Save the workbook
            workbook.Save("SpinnerDemo.xlsx");

            Console.WriteLine("Spinner demo created successfully.");
        }
    }
}
```
