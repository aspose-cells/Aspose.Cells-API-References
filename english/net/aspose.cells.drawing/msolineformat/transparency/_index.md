...
```csharp
// Called: AssertHelper.AreEqual(arcSrc.LineFormat.Transparency, arcDest.LineFormat.Transparency, info+".Transparency");
public static void MsoLineFormat_Property_Transparency(ArcShape arcSrc, ArcShape arcDest, string info)
        {
            ...
            {
                AssertHelper.MsoLineFormat_Property_Transparency(arcSrc.FillFormat.BackColor, arcDest.FillFormat.BackColor, info + ".FillFormat.BackColor");
                AssertHelper.MsoLineFormat_Property_Transparency(arcSrc.FillFormat.ForeColor, arcDest.FillFormat.ForeColor, info + ".FillFormat.ForeColor");
                AssertHelper.AreEqual(arcSrc.FillFormat.Transparency, arcDest.FillFormat.Transparency, info + ".FillFormat.Transparency");  
                AssertHelper.MsoLineFormat_Property_Transparency(arcSrc.FillFormat.ImageData, arcDest.FillFormat.ImageData, info+".ImageData");
            ...
            {
                AssertHelper.MsoLineFormat_Property_Transparency(arcSrc.LineFormat.BackColor, arcDest.LineFormat.BackColor, info + ".LineFormat.BackColor");
                AssertHelper.MsoLineFormat_Property_Transparency(arcSrc.LineFormat.ForeColor, arcDest.LineFormat.ForeColor, info + ".LineFormat.ForeColor");
            ...
            //===============compare protection===========//
            AssertHelper.AreEqual(arcSrc.IsLocked, arcDest.IsLocked, info + ".IsLocked");
            HyperlinksTest.MsoLineFormat_Property_Transparency(arcSrc.Hyperlink, arcDest.Hyperlink, info + ".Hyperlink");
            CellsColorTest.MsoLineFormat_Property_Transparency(arcSrc.FormatPicture.TransparentColor, arcSrc.FormatPicture.TransparentColor, info + ".TransparentColor");        
