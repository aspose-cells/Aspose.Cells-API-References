...
```csharp
// Called: AssertHelper.AreEqual(picSrc.LineFormat.DashStyle, picDest.LineFormat.DashStyle, info + &amp;quot;.LineFormat.DashStyle&amp;quot;);
public static void Property_DashStyle(Picture picSrc, Picture picDest, string info)
        {
