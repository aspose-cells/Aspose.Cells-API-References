...
```csharp
// Called: aChart.NSeries[K].Area.FillFormat.SetOneColorGradient(Color.FromArgb(0, 236, 102, 102), 0.9, GradientStyleType.DiagonalDown, 2);
public void FillFormat_Method_SetOneColorGradient()
{
    Console.WriteLine("FillFormat_Method_SetOneColorGradient()");
