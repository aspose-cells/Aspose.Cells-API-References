...
public static void ArcShape_Property_EndArrowheadStyle(ArcShape arcSrc, ArcShape arcDest, string info)
        {
            ...
            {
                AssertHelper.ArcShape_Property_EndArrowheadStyle(arcSrc.FillFormat.BackColor, arcDest.FillFormat.BackColor, info + ".FillFormat.BackColor");
                AssertHelper.ArcShape_Property_EndArrowheadStyle(arcSrc.FillFormat.ForeColor, arcDest.FillFormat.ForeColor, info + ".FillFormat.ForeColor");
                AssertHelper.AreEqual(arcSrc.FillFormat.Transparency, arcDest.FillFormat.Transparency, info + ".FillFormat.Transparency");  
                AssertHelper.ArcShape_Property_EndArrowheadStyle(arcSrc.FillFormat.ImageData, arcDest.FillFormat.ImageData, info+".ImageData");
            ...
            {
                AssertHelper.ArcShape_Property_EndArrowheadStyle(arcSrc.LineFormat.BackColor, arcDest.LineFormat.BackColor, info + ".LineFormat.BackColor");
                AssertHelper.ArcShape_Property_EndArrowheadStyle(arcSrc.LineFormat.ForeColor, arcDest.LineFormat.ForeColor, info + ".LineFormat.ForeColor");
            ...
            //===============compare protection===========//
            AssertHelper.AreEqual(arcSrc.IsLocked, arcDest.IsLocked, info + ".IsLocked");
            HyperlinksTest.ArcShape_Property_EndArrowheadStyle(arcSrc.Hyperlink, arcDest.Hyperlink, info + ".Hyperlink");
            CellsColorTest.ArcShape_Property_EndArrowheadStyle(arcSrc.FormatPicture.TransparentColor, arcSrc.FormatPicture.TransparentColor, info + ".TransparentColor");        
