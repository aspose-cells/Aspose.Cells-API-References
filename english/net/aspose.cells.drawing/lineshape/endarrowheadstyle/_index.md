...
```csharp
// Called: AssertHelper.AreEqual(lineshapeSrc.EndArrowheadStyle, lineshapeDest.EndArrowheadStyle, info + ".EndArrowheadStyle");
public static void LineShape_Property_EndArrowheadStyle(LineShape lineshapeSrc, LineShape lineshapeDest, string info)
        {
            ...
            //===colors and lines===//
            MsoFillFormatTest.LineShape_Property_EndArrowheadStyle(lineshapeSrc.FillFormat, lineshapeDest.FillFormat, info+".FillFormat");
            MsoLineFormatTest.LineShape_Property_EndArrowheadStyle(lineshapeSrc.LineFormat, lineshapeDest.LineFormat, info+".LineFormat");
            ...
            HyperlinksTest.LineShape_Property_EndArrowheadStyle(lineshapeSrc.Hyperlink, lineshapeDest.Hyperlink, info + ".Hyperlink");
        }
```
