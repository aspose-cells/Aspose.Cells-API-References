...
public static void LineShape_Property_BeginArrowheadLength(LineShape lineshapeSrc, LineShape lineshapeDest, string info)
        {
            ...
            //===colors and lines===//
            MsoFillFormatTest.LineShape_Property_BeginArrowheadLength(lineshapeSrc.FillFormat, lineshapeDest.FillFormat, info+".FillFormat");
            MsoLineFormatTest.LineShape_Property_BeginArrowheadLength(lineshapeSrc.LineFormat, lineshapeDest.LineFormat, info+".LineFormat");
            ...
            HyperlinksTest.LineShape_Property_BeginArrowheadLength(lineshapeSrc.Hyperlink, lineshapeDest.Hyperlink, info + ".Hyperlink");
        }
```
