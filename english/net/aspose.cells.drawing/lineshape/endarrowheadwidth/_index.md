---
title: LineShape.EndArrowheadWidth
second_title: Aspose.Cells for .NET API Reference
description: LineShape property. Gets and sets the end arrow head width of the line
type: docs
url: /net/aspose.cells.drawing/lineshape/endarrowheadwidth/
---
...
```csharp
// Called: AssertHelper.AreEqual(lineshapeSrc.EndArrowheadWidth, lineshapeDest.EndArrowheadWidth, info + ".EndArrowheadWidth");
public static void LineShape_Property_EndArrowheadWidth(LineShape lineshapeSrc, LineShape lineshapeDest, string info)
        {
            ...
            //===colors and lines===//
            MsoFillFormatTest.LineShape_Property_EndArrowheadWidth(lineshapeSrc.FillFormat, lineshapeDest.FillFormat, info+".FillFormat");
            MsoLineFormatTest.LineShape_Property_EndArrowheadWidth(lineshapeSrc.LineFormat, lineshapeDest.LineFormat, info+".LineFormat");
            ...
            HyperlinksTest.LineShape_Property_EndArrowheadWidth(lineshapeSrc.Hyperlink, lineshapeDest.Hyperlink, info + ".Hyperlink");
        }
```
