---
title: GlobalizationSettings.GetStandardFunctionName
second_title: Aspose.Cells for .NET API Reference
description: GlobalizationSettings method. Gets the standard function name according to given locale dependent function name
type: docs
...
```csharp
namespace AsposeCellsExamples.GlobalizationSettingsMethodGetStandardFunctionNameWithStringDemo
{
    using Aspose.Cells;
    using System;
