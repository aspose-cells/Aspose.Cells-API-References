---
title: GlobalizationSettings.GetDataFieldHeaderNameOfPivotTable
second_title: Aspose.Cells for .NET API Reference
description: GlobalizationSettings method. Gets the the name of the value area field header in the PivotTable
type: docs
...
```csharp
namespace AsposeCellsExamples.GlobalizationSettingsMethodGetDataFieldHeaderNameOfPivotTableDemo
{
    using Aspose.Cells;
