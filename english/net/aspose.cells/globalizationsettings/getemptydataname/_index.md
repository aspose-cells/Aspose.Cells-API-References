---
title: GlobalizationSettings.GetEmptyDataName
second_title: Aspose.Cells for .NET API Reference
description: GlobalizationSettings method. Gets the name of blank label in the PivotTable
type: docs
...
```csharp
namespace AsposeCellsExamples.GlobalizationSettingsMethodGetEmptyDataNameDemo
{
    using Aspose.Cells;
