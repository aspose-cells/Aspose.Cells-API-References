---
title: GlobalizationSettings.GetBooleanValueString
second_title: Aspose.Cells for .NET API Reference
description: GlobalizationSettings method. Gets the display string value for cells boolean value
type: docs
...
```csharp
namespace AsposeCellsExamples.GlobalizationSettingsMethodGetBooleanValueStringWithBooleanDemo
{
    using Aspose.Cells;
    using System;
