---
title: GlobalizationSettings.GetGrandTotalName
second_title: Aspose.Cells for .NET API Reference
description: GlobalizationSettings method. Gets the grand total name of the function
type: docs
...
```csharp
namespace AsposeCellsExamples.GlobalizationSettingsMethodGetGrandTotalNameWithConsolidationFunctionDemo
{
    using Aspose.Cells;
