---
title: GlobalizationSettings.GetSubTotalName
second_title: Aspose.Cells for .NET API Reference
description: GlobalizationSettings method. Gets the name of PivotFieldSubtotalType type in the PivotTable
type: docs
...
```csharp
namespace AsposeCellsExamples.GlobalizationSettingsMethodGetSubTotalNameWithPivotFieldSubtotalTypeDemo
{
    using Aspose.Cells;
