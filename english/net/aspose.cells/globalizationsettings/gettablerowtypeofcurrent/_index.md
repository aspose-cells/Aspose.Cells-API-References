...
description: GlobalizationSettings method. Gets the type name of table rows that consists of the current row in referenced table. Default is This Row so in formula This Row represents the current row in referenced table
type: docs
...
```csharp
namespace AsposeCellsExamples.GlobalizationSettingsMethodGetTableRowTypeOfCurrentDemo
{
    using Aspose.Cells;
