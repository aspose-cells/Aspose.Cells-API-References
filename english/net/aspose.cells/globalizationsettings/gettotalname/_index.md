---
title: GlobalizationSettings.GetTotalName
second_title: Aspose.Cells for .NET API Reference
description: GlobalizationSettings method. Gets the total name of the function
type: docs
...
```csharp
namespace AsposeCellsExamples.GlobalizationSettingsMethodGetTotalNameWithConsolidationFunctionDemo
{
    using Aspose.Cells;
