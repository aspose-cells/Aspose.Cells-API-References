...
| [CalcMode](../../aspose.cells/workbooksettings/calcmode) { get; set; } | It specifies whether to calculate formulas manually, automatically or automatically except for multiple table operations. |
| [CalcStackSize](../../aspose.cells/workbooksettings/calcstacksize) { get; set; } | Specifies the stack size for calculating cells recursively. The large value for this size will give better performance when there are lots of cells need to be calculated recursively. On the other hand, larger value will raise the risk of StackOverflowException. If user gets StackOverflowException when calculating formulas, this value should be decreased. |
| [CalculationId](../../aspose.cells/workbooksettings/calculationid) { get; set; } | Specifies the version of the calculation engine used to calculate values in the workbook. |
...
| [CreateCalcChain](../../aspose.cells/workbooksettings/createcalcchain) { get; set; } | Whether creates calculated formulas chain. Default is false. |
...
| [ForceFullCalculate](../../aspose.cells/workbooksettings/forcefullcalculate) { get; set; } | Fully calculates every time when a calculation is triggered. |
...
| [Iteration](../../aspose.cells/workbooksettings/iteration) { get; set; } | Indicates whether enable iterative calculation to resolve circular references. |
...
| [MaxChange](../../aspose.cells/workbooksettings/maxchange) { get; set; } | Returns or sets the maximum number of change to resolve a circular reference. |
| [MaxColumn](../../aspose.cells/workbooksettings/maxcolumn) { get; } | Gets the max column index, zero-based. |
| [MaxIteration](../../aspose.cells/workbooksettings/maxiteration) { get; set; } | Returns or sets the maximum number of iterations to resolve a circular reference. |
...
| [ParsingFormulaOnOpen](../../aspose.cells/workbooksettings/parsingformulaonopen) { get; set; } | Indicates whether parsing the formula when reading the file. |
| [Password](../../aspose.cells/workbooksettings/password) { get; set; } | Represents Workbook file encryption password. |
| [PrecisionAsDisplayed](../../aspose.cells/workbooksettings/precisionasdisplayed) { get; set; } | True if calculations in this workbook will be done using only the precision of the numbers as they're displayed |
...
| [RecalculateBeforeSave](../../aspose.cells/workbooksettings/recalculatebeforesave) { get; set; } | Indicates whether to recalculate before saving the document. |
| [ReCalculateOnOpen](../../aspose.cells/workbooksettings/recalculateonopen) { get; set; } | Indicates whether re-calculate all formulas on opening file. |
...
| [StreamProvider](../../aspose.cells/workbooksettings/streamprovider) { get; set; } | Gets and sets the stream provider for external resource. |
