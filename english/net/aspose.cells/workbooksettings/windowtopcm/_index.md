---
title: WorkbookSettings.WindowTopCM
second_title: Aspose.Cells for .NET API Reference
description: WorkbookSettings property. The distance from the top edge of the client area to the top edge of the window in unit of centimeter
type: docs
...
```csharp
// Called: AssertHelper.AreEqual(expected.WindowTopCM, result.WindowTopCM, delta, info + ".WindowTopCM");
private static void WorkbookSettings_Property_WindowTopCM(WorkbookSettings expected, WorkbookSettings result, string info)
        {
