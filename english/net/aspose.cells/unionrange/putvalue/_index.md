---
title: UnionRange.PutValue
second_title: Aspose.Cells for .NET API Reference
description: UnionRange method. Puts a value into the range if appropriate the value will be converted to other data type and cells number format will be reset
type: docs
