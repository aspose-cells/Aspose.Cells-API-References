---
title: UnionRange.CellCount
second_title: Aspose.Cells for .NET API Reference
description: UnionRange property. Gets all cell count in the range
type: docs
...
```csharp
namespace AsposeCellsExamples.UnionRangePropertyCellCountDemo
{
    using Aspose.Cells;
    using System;
