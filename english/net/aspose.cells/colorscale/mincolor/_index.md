---
title: ColorScale.MinColor
second_title: Aspose.Cells for .NET API Reference
description: ColorScale property. Get or set the gradient color for the minimum value in the range
type: docs
...
```csharp
// Called: Console.WriteLine(&amp;quot;Conditional Formatting ColorScale Min Color: &amp;quot; + (colorScale != null ? colorScale.MinColor.ToString() : &amp;quot;No ColorScale&amp;quot;));
public static void Property_MinColor()
        {
