...
description: Gets and sets the prefix of the type css name such as trcoltd and so on they are contained in the table element which has the specific TableCssId attribute. The default value is .
type: docs
weight: 520
