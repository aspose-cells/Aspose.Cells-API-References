...
| [MergeEmptyTdType](../../aspose.cells/htmlsaveoptions/mergeemptytdtype/) { get; set; } | Indicates if empty TD element will be merged in the same way as MS Excel when saving an Excel file in html format. The default value is MergeEmptyTdType.Default. |
