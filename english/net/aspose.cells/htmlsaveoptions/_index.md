...
| [ParseHtmlTagInCell](../../aspose.cells/htmlsaveoptions/parsehtmltagincell/) { get; set; } | Parse html tag in cell &lt;div&gt;&lt;/div&gt;,like ,as cell value,or as html tag,default is true |
...
| [WidthScalable](../../aspose.cells/htmlsaveoptions/widthscalable/) { get; set; } | Indicates whether using scalable unit to describe the column width when exporting file to html. The default value is false. |
