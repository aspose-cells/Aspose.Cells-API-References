---
title: HtmlSaveOptions.FormatDataIgnoreColumnWidth
second_title: Aspose.Cells for .NET API Reference
description: HtmlSaveOptions property. Indicating whether show the whole formatted data of cell when overflowing the column. If true then ignore the column width and the whole data of cell will be exported. If false then the data will be exported same as Excel. The default value is false
type: docs
url: /net/aspose.cells/htmlsaveoptions/formatdataignorecolumnwidth/
---
...
```csharp
// Called: FormatDataIgnoreColumnWidth = false,
