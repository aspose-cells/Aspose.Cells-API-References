---
title: Enum TxtValueQuoteType
second_title: Aspose.Cells for .NET API Reference
description: Aspose.Cells.TxtValueQuoteType enum. Specifies the type of using quotation marks for values in text format files
type: docs
