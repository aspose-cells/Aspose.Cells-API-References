---
title: ThreadedComment.Row
second_title: Aspose.Cells for .NET API Reference
description: ThreadedComment property. Gets the row index of the comment
type: docs
...
```csharp
namespace AsposeCellsExamples.ThreadedCommentPropertyRowDemo
{
    using Aspose.Cells;
    using System;
