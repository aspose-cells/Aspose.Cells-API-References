---
title: SettableGlobalizationSettings.SetStandardFunctionName
second_title: Aspose.Cells for .NET API Reference
description: SettableGlobalizationSettings method. Sets the locale dependent function name according to given standard function name
type: docs
url: /net/aspose.cells/settableglobalizationsettings/setstandardfunctionname/
---
...
```csharp
namespace AsposeCellsExamples.SettableGlobalizationSettingsMethodSetStandardFunctionNameWithStringStringBooleanDemo
{
    using Aspose.Cells;
    using System;
