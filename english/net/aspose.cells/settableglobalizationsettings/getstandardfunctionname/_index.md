---
title: SettableGlobalizationSettings.GetStandardFunctionName
second_title: Aspose.Cells for .NET API Reference
description: SettableGlobalizationSettings method. Gets the standard function name according to given locale dependent function name
type: docs
url: /net/aspose.cells/settableglobalizationsettings/getstandardfunctionname/
---
...
```csharp
namespace AsposeCellsExamples.SettableGlobalizationSettingsMethodGetStandardFunctionNameWithStringDemo
{
    using Aspose.Cells;
    using System;
