---
title: SettableGlobalizationSettings.GetStandardBuiltInName
second_title: Aspose.Cells for .NET API Reference
description: SettableGlobalizationSettings method. Gets the standard text of builtin Name according to given locale dependent text
type: docs
url: /net/aspose.cells/settableglobalizationsettings/getstandardbuiltinname/
---
...
```csharp
namespace AsposeCellsExamples.SettableGlobalizationSettingsMethodGetStandardBuiltInNameWithStringDemo
{
    using Aspose.Cells;
    using System;
