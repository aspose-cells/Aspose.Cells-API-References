---
title: SettableGlobalizationSettings.GetTableRowTypeOfData
second_title: Aspose.Cells for .NET API Reference
description: SettableGlobalizationSettings method. Gets the type name of table rows that consists of data region of referenced table. Default is Data so in formula Data represents the data region of the table
type: docs
url: /net/aspose.cells/settableglobalizationsettings/gettablerowtypeofdata/
---
...
```csharp
namespace AsposeCellsExamples.SettableGlobalizationSettingsMethodGetTableRowTypeOfDataDemo
{
    using Aspose.Cells;
