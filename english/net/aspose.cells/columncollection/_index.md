...
| Name | Description |
| --- | --- |
| [Item](item) { get; } | Gets a  object by column index. The Column object of given column index will be instantiated if it does not exist before. |

## Methods

| Name | Description |
| --- | --- |
| [GetColumnByIndex](getcolumnbyindex)(int) | Gets the [`Column`](../column) object by the position in the list. |
