---
title: PageSetup.HeaderMargin
second_title: Aspose.Cells for .NET API Reference
description: PageSetup property. Represents the distance from the top of the page to the header in unit of centimeters
type: docs
...
```csharp
// Called: AssertHelper.AreEqual(pagesetupSrc.HeaderMargin, pagesetupDest.HeaderMargin, delta, info + ".HeaderMargin");
public static void Property_HeaderMargin(PageSetup pagesetupSrc, PageSetup pagesetupDest, string info)
        {
