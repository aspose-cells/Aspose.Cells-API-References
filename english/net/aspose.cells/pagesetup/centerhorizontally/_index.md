...
```csharp
// Called: AssertHelper.AreEqual(pagesetupSrc.CenterHorizontally, pagesetupDest.CenterHorizontally, info + &amp;quot;.CenterHorizontally&amp;quot;);
public static void Property_CenterHorizontally(PageSetup pagesetupSrc, PageSetup pagesetupDest, string info)
        {
