...
```csharp
// Called: AssertHelper.AreEqual(pagesetupSrc.FooterMargin, pagesetupDest.FooterMargin, delta, info + &amp;quot;.FooterMargin&amp;quot;);
public static void Property_FooterMargin(PageSetup pagesetupSrc, PageSetup pagesetupDest, string info)
        {
