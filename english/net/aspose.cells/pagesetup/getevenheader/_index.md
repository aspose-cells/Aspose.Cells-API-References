...
```csharp
// Called: AssertHelper.AreEqual(pagesetupSrc.GetEvenHeader(0), pagesetupDest.GetEvenHeader(0), info + ".GetEvenHeader(0)");
public static void PageSetup_Method_GetEvenHeader(PageSetup pagesetupSrc, PageSetup pagesetupDest, string info)
        {
