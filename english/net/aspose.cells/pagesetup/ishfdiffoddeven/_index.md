...
```csharp
// Called: AssertHelper.AreEqual(pagesetupSrc.IsHFDiffOddEven, pagesetupDest.IsHFDiffOddEven, info + ".IsHFDiffOddEven");
public static void Property_IsHFDiffOddEven(PageSetup pagesetupSrc, PageSetup pagesetupDest, string info)
        {
