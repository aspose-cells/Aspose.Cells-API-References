---
title: PageSetup.SetFooterPicture
second_title: Aspose.Cells for .NET API Reference
description: PageSetup method. Sets an image in the footer of a worksheet
type: docs
...
```csharp
namespace AsposeCellsExamples.PageSetupMethodSetFooterPictureWithInt32ByteArrayDemo
{
    using Aspose.Cells;
