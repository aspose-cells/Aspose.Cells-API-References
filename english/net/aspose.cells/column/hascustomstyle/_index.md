---
title: Column.HasCustomStyle
second_title: Aspose.Cells for .NET API Reference
description: Column property. Indicates whether this column has custom style settingsdifferent from the default one inherited from workbook
type: docs
...
```csharp
namespace AsposeCellsExamples.ColumnPropertyHasCustomStyleDemo
{
    using Aspose.Cells;
    using System;
