...
description: CustomFunctionDefinition method. Gets the indices of given custom functions parameters that need to be calculated in array mode
type: docs
url: /net/aspose.cells/customfunctiondefinition/getarraymodeparameters/
---
