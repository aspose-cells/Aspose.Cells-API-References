---
title: AbstractCalculationEngine.ProcessBuiltInFunctions
second_title: Aspose.Cells for .NET API Reference
description: AbstractCalculationEngine property. Whether builtin functions that have been supported by the builtin engine should be checked and processed by this implementation. Default is false. If user needs to change the calculation logic of some builtin functions this property should be set as true
type: docs
