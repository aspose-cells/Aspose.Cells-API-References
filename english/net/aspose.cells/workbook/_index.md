...
| [CalculateFormula](../../aspose.cells/workbook/calculateformula)() | Calculates the result of formulas. |
| [CalculateFormula](../../aspose.cells/workbook/calculateformula)(bool) | Calculates the result of formulas. |
| [CalculateFormula](../../aspose.cells/workbook/calculateformula)(CalculationOptions) | Calculating formulas in this workbook. |
...
| [Copy](../../aspose.cells/workbook/copy)(Workbook) | Copies data from a source Workbook object. |
| [Copy](../../aspose.cells/workbook/copy)(Workbook, CopyOptions) | Copies data from a source Workbook object. |
...
| [ExportXml](../../aspose.cells/workbook/exportxml)(string, Stream) | Export XML data. |
| [ExportXml](../../aspose.cells/workbook/exportxml)(string, string) | Export XML data linked by the specified XML map. |
...
| [ImportXml](../../aspose.cells/workbook/importxml)(Stream, string, int, int) | Imports/Updates an XML data file into the workbook. |
| [ImportXml](../../aspose.cells/workbook/importxml)(string, string, int, int) | Imports/Updates an XML data file into the workbook. |
...
| [Replace](../../aspose.cells/workbook/replace)(bool, object) | Replaces cells' values with new data. |
| [Replace](../../aspose.cells/workbook/replace)(int, object) | Replaces cells' values with new data. |
| [Replace](../../aspose.cells/workbook/replace)(string, DataTable) | Replaces cells' values with data from a DataTable. |
| [Replace](../../aspose.cells/workbook/replace)(string, double) | Replaces a cell's value with a new double. |
| [Replace](../../aspose.cells/workbook/replace)(string, int) | Replaces a cell's value with a new integer. |
| [Replace](../../aspose.cells/workbook/replace)(string, string) | Replaces a cell's value with a new string. |
| [Replace](../../aspose.cells/workbook/replace)(string, double[], bool) | Replaces cells' values with a double array. |
| [Replace](../../aspose.cells/workbook/replace)(string, int[], bool) | Replaces cells' values with an integer array. |
| [Replace](../../aspose.cells/workbook/replace)(string, string, ReplaceOptions) | Replaces a cell's value with a new string. |
| [Replace](../../aspose.cells/workbook/replace)(string, string[], bool) | Replaces a cell's value with a new string array. |
| [Save](../../aspose.cells/workbook/save)(string) | Save the workbook to the disk. |
| [Save](../../aspose.cells/workbook/save)(Stream, SaveFormat) | Saves the workbook to the stream. |
| [Save](../../aspose.cells/workbook/save)(Stream, SaveOptions) | Saves the workbook to the stream. |
| [Save](../../aspose.cells/workbook/save)(string, SaveFormat) | Saves the workbook to the disk. |
| [Save](../../aspose.cells/workbook/save)(string, SaveOptions) | Saves the workbook to the disk. |
| [Save](../../aspose.cells/workbook/save)(HttpResponse, string, ContentDisposition, SaveOptions) | Creates the result spreadsheet and transfer it to the client then open it in the browser or MS Workbook. |
| [Save](../../aspose.cells/workbook/save)(HttpResponse, string, ContentDisposition, SaveOptions, bool) | Creates the result spreadsheet and transfer it to the client then open it in the browser or MS Workbook. |
