...
description: Aspose.Cells.Workbook class. Represents a root object to create an Excel spreadsheet
type: docs
...
| [Workbook](workbook/#constructor_5)(string) | Initializes a new instance of the `Workbook` class and open a file. |
