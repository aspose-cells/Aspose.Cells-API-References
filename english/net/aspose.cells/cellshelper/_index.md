...
| static [SignificantDigitsType](../../aspose.cells/cellshelper/significantdigitstype/) { get; set; } | Gets and sets the default type of significant digits for outputting numeric values. Default value is G17. |
