...
| [HyperlinkLoadMode](../../aspose.cells/htmlloadoptions/hyperlinkloadmode/) { get; set; } | Specifies how hyperlinks are loaded when loading HTML. |
...
| [ParagrahLayoutMode](../../aspose.cells/htmlloadoptions/paragrahlayoutmode/) { get; set; } | (**Obsolete.**) Specifies how HTML &lt;p&gt; elements are rendered when loading HTML. The default value is Normal. |
| [ParagraphLayoutMode](../../aspose.cells/htmlloadoptions/paragraphlayoutmode/) { get; set; } | Specifies how HTML &lt;p&gt; elements are rendered when loading HTML. The default value is Normal. |
