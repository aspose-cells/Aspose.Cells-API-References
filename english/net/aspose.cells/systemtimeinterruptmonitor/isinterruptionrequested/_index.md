---
title: SystemTimeInterruptMonitor.IsInterruptionRequested
second_title: Aspose.Cells for .NET API Reference
description: SystemTimeInterruptMonitor property. This implementation just checks whether the time costfrom the time when starting this monitor to now is greater than user specified limit
type: docs
url: /net/aspose.cells/systemtimeinterruptmonitor/isinterruptionrequested/
---
...
```csharp
namespace AsposeCellsExamples.SystemTimeInterruptMonitorPropertyIsInterruptionRequestedDemo
{
    using Aspose.Cells;
    using System;
