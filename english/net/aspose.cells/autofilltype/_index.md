---
title: Enum AutoFillType
second_title: Aspose.Cells for .NET API Reference
description: Aspose.Cells.AutoFillType enum. Represents the auto fill type
type: docs
...
| Series | `2` | Extend the value in the source area to the target area in the form of a series and copy the format to the target area. |
