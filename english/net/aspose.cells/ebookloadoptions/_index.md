...
| [ParagrahLayoutMode](../../aspose.cells/htmlloadoptions/paragrahlayoutmode/) { get; set; } | (**Obsolete.**) Specifies how HTML &lt;p&gt; elements are rendered when loading HTML. The default value is Normal.(Inherited from [`HtmlLoadOptions`](../htmlloadoptions/).) |
| [ParagraphLayoutMode](../../aspose.cells/htmlloadoptions/paragraphlayoutmode/) { get; set; } | Specifies how HTML &lt;p&gt; elements are rendered when loading HTML. The default value is Normal.(Inherited from [`HtmlLoadOptions`](../htmlloadoptions/).) |
