---
title: Validation.SetFormula2
second_title: Aspose.Cells for .NET API Reference
description: Validation method. Sets the value or expression associated with this validation
type: docs
...
```csharp
namespace AsposeCellsExamples.ValidationMethodSetFormula2WithStringBooleanBooleanDemo
{
    using Aspose.Cells;
    using System;
