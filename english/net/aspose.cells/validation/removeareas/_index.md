---
title: Validation.RemoveAreas
second_title: Aspose.Cells for .NET API Reference
description: Validation method. Removes this validation from given areas
type: docs
...
```csharp
namespace AsposeCellsExamples.ValidationMethodRemoveAreasWithCellAreaArrayDemo
{
    using Aspose.Cells;
    using System;
