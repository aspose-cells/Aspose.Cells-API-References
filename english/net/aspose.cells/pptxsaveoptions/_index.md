...
| [ExportViewType](../../aspose.cells/pptxsaveoptions/exportviewtype/) { get; set; } | Gets and sets the display type when exporting to Excel. The default exporting type is working as printing. |
