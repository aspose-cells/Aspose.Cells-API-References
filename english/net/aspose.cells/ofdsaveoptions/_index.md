---
title: Class OfdSaveOptions
second_title: Aspose.Cells for .NET API Reference
description: Aspose.Cells.OfdSaveOptions class. Represents the options for saving a OFDOpen Fixedlayout Document file
type: docs
url: /net/aspose.cells/ofdsaveoptions/
---
...
```csharp
public class OfdSaveOptions : PaginatedSaveOptions
```
