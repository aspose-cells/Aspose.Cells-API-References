...
```csharp
// Called: AssertHelper.AreEqual(protectionSrc.AllowEditingScenario, protectionDest.AllowEditingScenario, info + ".AllowEditingScenario");
public static void Property_AllowEditingScenario(Protection protectionSrc, Protection protectionDest, string info)
        {
