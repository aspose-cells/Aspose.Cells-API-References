---
title: LightCellsDataProvider.NextRow
second_title: Aspose.Cells for .NET API Reference
description: LightCellsDataProvider method. Gets the next row to be saved
type: docs
...
```csharp
namespace AsposeCellsExamples.LightCellsDataProviderMethodNextRowDemo
{
    using Aspose.Cells;
    using System;
