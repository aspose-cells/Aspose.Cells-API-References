...
description: FileFormatUtil method. Converts a file name extension into a SaveFormat value
type: docs
...
```csharp
namespace AsposeCellsExamples.FileFormatUtilMethodExtensionToSaveFormatWithStringDemo
{
    using Aspose.Cells;
    using System;
