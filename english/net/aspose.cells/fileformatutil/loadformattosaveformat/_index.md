...
description: FileFormatUtil method. Converts a LoadFormat value to a SaveFormat value if possible
type: docs
...
```csharp
namespace AsposeCellsExamples.FileFormatUtilMethodLoadFormatToSaveFormatWithLoadFormatDemo
{
    using Aspose.Cells;
    using System;
