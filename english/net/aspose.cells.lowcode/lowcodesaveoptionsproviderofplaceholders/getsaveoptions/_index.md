---
title: LowCodeSaveOptionsProviderOfPlaceHolders.GetSaveOptions
second_title: Aspose.Cells for .NET API Reference
description: LowCodeSaveOptionsProviderOfPlaceHolders method. Gets the save options from which to get the output settings for currently split part
type: docs
url: /net/aspose.cells.lowcode/lowcodesaveoptionsproviderofplaceholders/getsaveoptions/
---
...
```csharp
namespace AsposeCellsExamples.LowCodeSaveOptionsProviderOfPlaceHoldersMethodGetSaveOptionsWithSplitPartInfoDemo
{
    using Aspose.Cells;
