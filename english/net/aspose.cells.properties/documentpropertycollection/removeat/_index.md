...
description: DocumentPropertyCollection method. Removes a property at the specified index
type: docs
...
```csharp
namespace AsposeCellsExamples.DocumentPropertyCollectionMethodRemoveAtWithInt32Demo
{
    using Aspose.Cells;
