...
The string names of the properties correspond to the names of the typed properties available from [`BuiltInDocumentPropertyCollection`](../../builtindocumentpropertycollection).
