...
description: PivotGlobalizationSettings method. Gets the local text of Minutes
type: docs
url: /net/aspose.cells.settings/pivotglobalizationsettings/gettextofminutes/
---
...
```csharp
// Called: Console.WriteLine("Text of Minutes: " + globalizationSettings.GetTextOfMinutes());
public static void PivotGlobalizationSettings_Method_GetTextOfMinutes()
        {
