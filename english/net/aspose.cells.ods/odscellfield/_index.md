...
| Name | Description |
| --- | --- |
| [Column](../../aspose.cells.ods/odscellfield/column/) { get; set; } | Gets and sets the column index of the cell. |
...
| [Row](../../aspose.cells.ods/odscellfield/row/) { get; set; } | Gets and sets the row index of the cell. |
