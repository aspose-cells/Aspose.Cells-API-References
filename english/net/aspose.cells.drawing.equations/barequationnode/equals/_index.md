---
title: BarEquationNode.Equals
second_title: Aspose.Cells for .NET API Reference
description: BarEquationNode method. Determine whether the current equation node is equal to the specified node
type: docs
...
```csharp
namespace AsposeCellsExamples.BarEquationNodeMethodEqualsWithObjectDemo
{
    using Aspose.Cells;
