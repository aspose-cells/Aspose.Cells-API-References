---
title: BoxEquationNode.Equals
second_title: Aspose.Cells for .NET API Reference
description: BoxEquationNode method. Determine whether the current equation node is equal to the specified node
type: docs
...
```csharp
namespace AsposeCellsExamples.BoxEquationNodeMethodEqualsWithObjectDemo
{
    using Aspose.Cells;
