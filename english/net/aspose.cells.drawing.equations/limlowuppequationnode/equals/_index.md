---
title: LimLowUppEquationNode.Equals
second_title: Aspose.Cells for .NET API Reference
description: LimLowUppEquationNode method. Determine whether the current equation node is equal to the specified node
type: docs
url: /net/aspose.cells.drawing.equations/limlowuppequationnode/equals/
---
...
```csharp
namespace AsposeCellsExamples.LimLowUppEquationNodeMethodEqualsWithObjectDemo
{
    using Aspose.Cells;
