---
title: FractionEquationNode.Equals
second_title: Aspose.Cells for .NET API Reference
description: FractionEquationNode method. Determine whether the current equation node is equal to the specified node
type: docs
...
```csharp
namespace AsposeCellsExamples.FractionEquationNodeMethodEqualsWithObjectDemo
{
    using Aspose.Cells;
