---
title: ArrayEquationNode.Equals
second_title: Aspose.Cells for .NET API Reference
description: ArrayEquationNode method. Determine whether the current equation node is equal to the specified node
type: docs
url: /net/aspose.cells.drawing.equations/arrayequationnode/equals/
---
...
```csharp
namespace AsposeCellsExamples.ArrayEquationNodeMethodEqualsWithObjectDemo
{
    using Aspose.Cells;
