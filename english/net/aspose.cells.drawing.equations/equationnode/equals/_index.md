---
title: EquationNode.Equals
second_title: Aspose.Cells for .NET API Reference
description: EquationNode method. Determine whether the current equation node is equal to the specified node
type: docs
url: /net/aspose.cells.drawing.equations/equationnode/equals/
---
...
```csharp
namespace AsposeCellsExamples.EquationNodeMethodEqualsWithObjectDemo
{
    using Aspose.Cells;
