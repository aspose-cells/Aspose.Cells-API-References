---
title: EquationNode.InsertAfter
second_title: Aspose.Cells for .NET API Reference
description: EquationNode method. Inserts the specified node after the current node
type: docs
url: /net/aspose.cells.drawing.equations/equationnode/insertafter/
---
...
```csharp
namespace AsposeCellsExamples.EquationNodeMethodInsertAfterWithEquationNodeTypeDemo
{
    using Aspose.Cells;
