---
title: UnknowEquationNode.Equals
second_title: Aspose.Cells for .NET API Reference
description: UnknowEquationNode method. Determine whether the current equation node is equal to the specified node
type: docs
...
```csharp
namespace AsposeCellsExamples.UnknowEquationNodeMethodEqualsWithObjectDemo
{
    using Aspose.Cells;
