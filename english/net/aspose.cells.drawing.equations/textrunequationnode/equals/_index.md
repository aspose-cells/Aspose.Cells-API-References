---
title: TextRunEquationNode.Equals
second_title: Aspose.Cells for .NET API Reference
description: TextRunEquationNode method. Determine whether the current equation node is equal to the specified node
type: docs
url: /net/aspose.cells.drawing.equations/textrunequationnode/equals/
---
...
```csharp
namespace AsposeCellsExamples.TextRunEquationNodeMethodEqualsWithObjectDemo
{
    using Aspose.Cells;
