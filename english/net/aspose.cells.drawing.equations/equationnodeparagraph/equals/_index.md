---
title: EquationNodeParagraph.Equals
second_title: Aspose.Cells for .NET API Reference
description: EquationNodeParagraph method. Determine whether the current equation node is equal to the specified node
type: docs
url: /net/aspose.cells.drawing.equations/equationnodeparagraph/equals/
---
...
```csharp
namespace AsposeCellsExamples.EquationNodeParagraphMethodEqualsWithObjectDemo
{
    using Aspose.Cells;
