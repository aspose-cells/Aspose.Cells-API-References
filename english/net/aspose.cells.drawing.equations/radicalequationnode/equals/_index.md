---
title: RadicalEquationNode.Equals
second_title: Aspose.Cells for .NET API Reference
description: RadicalEquationNode method. Determine whether the current equation node is equal to the specified node
type: docs
url: /net/aspose.cells.drawing.equations/radicalequationnode/equals/
---
...
```csharp
namespace AsposeCellsExamples.RadicalEquationNodeMethodEqualsWithObjectDemo
{
