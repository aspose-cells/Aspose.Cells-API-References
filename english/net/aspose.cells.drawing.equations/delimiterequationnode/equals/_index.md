---
title: DelimiterEquationNode.Equals
second_title: Aspose.Cells for .NET API Reference
description: DelimiterEquationNode method. Determine whether the current equation node is equal to the specified node
type: docs
...
```csharp
namespace AsposeCellsExamples.DelimiterEquationNodeMethodEqualsWithObjectDemo
{
    using Aspose.Cells;
