---
title: GroupCharacterEquationNode.Equals
second_title: Aspose.Cells for .NET API Reference
description: GroupCharacterEquationNode method. Determine whether the current equation node is equal to the specified node
type: docs
url: /net/aspose.cells.drawing.equations/groupcharacterequationnode/equals/
---
...
```csharp
namespace AsposeCellsExamples.GroupCharacterEquationNodeMethodEqualsWithObjectDemo
{
    using Aspose.Cells;
