---
title: MatrixEquationNode.Equals
second_title: Aspose.Cells for .NET API Reference
description: MatrixEquationNode method. Determine whether the current equation node is equal to the specified node
type: docs
url: /net/aspose.cells.drawing.equations/matrixequationnode/equals/
---
...
```csharp
namespace AsposeCellsExamples.MatrixEquationNodeMethodEqualsWithObjectDemo
{
    using Aspose.Cells;
