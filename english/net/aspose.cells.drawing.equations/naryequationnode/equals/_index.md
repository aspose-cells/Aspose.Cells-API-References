---
title: NaryEquationNode.Equals
second_title: Aspose.Cells for .NET API Reference
description: NaryEquationNode method. Determine whether the current equation node is equal to the specified node
type: docs
url: /net/aspose.cells.drawing.equations/naryequationnode/equals/
---
...
```csharp
namespace AsposeCellsExamples.NaryEquationNodeMethodEqualsWithObjectDemo
{
    using Aspose.Cells;
