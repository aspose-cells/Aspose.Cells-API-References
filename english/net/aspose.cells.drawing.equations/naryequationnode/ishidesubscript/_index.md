---
title: NaryEquationNode.IsHideSubscript
second_title: Aspose.Cells for .NET API Reference
description: NaryEquationNode property. Whether to display the lower bound
type: docs
...
```csharp
// Called: node.IsHideSubscript = true;//"Sub"objects are not written to the file
[Test]
        public void Property_IsHideSubscript()
        {
