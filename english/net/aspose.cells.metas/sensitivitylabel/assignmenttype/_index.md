---
title: SensitivityLabel.AssignmentType
second_title: Aspose.Cells for .NET API Reference
description: SensitivityLabel property. Gets and sets the assignment method for the sensitivity label
type: docs
url: /net/aspose.cells.metas/sensitivitylabel/assignmenttype/
---
...
```csharp
namespace AsposeCellsExamples.SensitivityLabelPropertyAssignmentTypeDemo
{
    using Aspose.Cells;
