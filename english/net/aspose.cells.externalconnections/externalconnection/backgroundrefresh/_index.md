---
title: ExternalConnection.BackgroundRefresh
second_title: Aspose.Cells for .NET API Reference
description: ExternalConnection property. Indicates whether the connection can be refreshed in the background asynchronously. true if preferred usage of the connection is to refresh asynchronously in the background false if preferred usage of the connection is to refresh synchronously in the foreground
type: docs
...
```csharp
namespace AsposeCellsExamples.ExternalConnectionPropertyBackgroundRefreshDemo
{
    using Aspose.Cells;
