---
title: ExternalConnection.SaveData
second_title: Aspose.Cells for .NET API Reference
description: ExternalConnection property. True if the external data fetched over the connection to populate a table is to be saved with the workbook otherwise false
type: docs
