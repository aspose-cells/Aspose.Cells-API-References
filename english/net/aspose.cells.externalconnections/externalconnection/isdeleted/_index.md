---
title: ExternalConnection.IsDeleted
second_title: Aspose.Cells for .NET API Reference
description: ExternalConnection property. Indicates whether the associated workbook connection has been deleted. true if the connection has been deleted otherwise false
type: docs
...
```csharp
namespace AsposeCellsExamples.ExternalConnectionPropertyIsDeletedDemo
{
    using Aspose.Cells;
