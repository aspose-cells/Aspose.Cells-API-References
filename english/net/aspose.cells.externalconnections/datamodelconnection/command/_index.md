---
title: DataModelConnection.Command
second_title: Aspose.Cells for .NET API Reference
description: DataModelConnection property. The string containing the database command to pass to the data provider API that will interact with the external source in order to retrieve data
type: docs
url: /net/aspose.cells.externalconnections/datamodelconnection/command/
---
...
```csharp
namespace AsposeCellsExamples.DataModelConnectionPropertyCommandDemo
{
    using Aspose.Cells;
