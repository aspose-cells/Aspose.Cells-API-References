---
title: WebQueryConnection.IsConsecutive
second_title: Aspose.Cells for .NET API Reference
description: WebQueryConnection property. Flag indicating whether consecutive delimiters should be treated as just one delimiter
type: docs
...
```csharp
namespace AsposeCellsExamples.WebQueryConnectionPropertyIsConsecutiveDemo
{
    using Aspose.Cells;
