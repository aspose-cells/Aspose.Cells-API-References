---
title: WebQueryConnection.IsSameSettings
second_title: Aspose.Cells for .NET API Reference
description: WebQueryConnection property. Flag indicating whether to parse all tables inside a PRE block with the same width settings as the first row
type: docs
...
```csharp
namespace AsposeCellsExamples.WebQueryConnectionPropertyIsSameSettingsDemo
{
    using Aspose.Cells;
