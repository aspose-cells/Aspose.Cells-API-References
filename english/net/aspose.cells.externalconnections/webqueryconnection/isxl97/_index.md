---
title: WebQueryConnection.IsXl97
second_title: Aspose.Cells for .NET API Reference
description: WebQueryConnection property. This flag exists for backward compatibility with older existing spreadsheet files and is set to true if this web query was created in Microsoft Excel 97. This is an optional attribute that can be ignored
type: docs
