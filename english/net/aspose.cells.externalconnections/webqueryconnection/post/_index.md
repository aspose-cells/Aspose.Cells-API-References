---
title: WebQueryConnection.Post
second_title: Aspose.Cells for .NET API Reference
description: WebQueryConnection property. Returns or sets the string used with the post method of inputting data into a web server to return data from a web query
type: docs
...
```csharp
namespace AsposeCellsExamples.WebQueryConnectionPropertyPostDemo
{
    using Aspose.Cells;
