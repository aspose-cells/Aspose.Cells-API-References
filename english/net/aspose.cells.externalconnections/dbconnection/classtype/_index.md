---
title: DBConnection.ClassType
second_title: Aspose.Cells for .NET API Reference
description: DBConnection property. Gets the type of this ExternalConnection object
type: docs
url: /net/aspose.cells.externalconnections/dbconnection/classtype/
---
...
```csharp
namespace AsposeCellsExamples.DBConnectionPropertyClassTypeDemo
{
    using Aspose.Cells;
