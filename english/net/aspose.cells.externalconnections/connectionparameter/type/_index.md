---
title: ConnectionParameter.Type
second_title: Aspose.Cells for .NET API Reference
description: ConnectionParameter property. Type of parameter used. If the parameterTypevalue then the value from boolean double integer or string will be used. In this case it is expected that only one of boolean double integer or string will be specified
type: docs
...
```csharp
namespace AsposeCellsExamples.ConnectionParameterPropertyTypeDemo
{
    using Aspose.Cells;
