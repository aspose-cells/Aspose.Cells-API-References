---
title: TextBoxActiveXControl.IsAutoWordSelected
second_title: Aspose.Cells for .NET API Reference
description: TextBoxActiveXControl property. Specifies the basic unit used to extend a selection. True specifies that the basic unit is a single character. false specifies that the basic unit is a whole word
type: docs
