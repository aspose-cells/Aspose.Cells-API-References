---
title: JsonLayoutOptions.IgnoreObjectTitle
second_title: Aspose.Cells for .NET API Reference
description: JsonLayoutOptions property. Indicates whether ignore title if object is a property of object
type: docs
...
```csharp
namespace AsposeCellsExamples.JsonLayoutOptionsPropertyIgnoreObjectTitleDemo
{
    using Aspose.Cells;
