...
description: Occurs when user is trying to delete a column from the clientside menu. You may handle this event and set the cancel parameter to True to cancel a deleting operation.
type: docs
