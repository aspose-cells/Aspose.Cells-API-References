---
title: MainWeb.CellClientUpdate
second_title: Aspose.Cells for .NET API Reference
description: MainWeb event. Occurs when a client cell update happen . When this event is fired its parameter e.Argument contains the commands name
type: docs
