---
title: MainWeb.MinRow
second_title: Aspose.Cells for .NET API Reference
description: MainWeb property. Gets or sets the minimum display row indexzero based of the web sheet. The control uses the smaller value of MinRow and sheet datas min row
type: docs
