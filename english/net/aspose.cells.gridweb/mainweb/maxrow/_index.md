---
title: MainWeb.MaxRow
second_title: Aspose.Cells for .NET API Reference
description: MainWeb property. Gets or sets the maximum display row indexzero based of the web sheet. The control uses the greater value of MaxRow and sheet datas max row
type: docs
