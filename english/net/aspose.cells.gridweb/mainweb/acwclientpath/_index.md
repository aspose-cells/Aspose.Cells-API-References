---
title: MainWeb.ACWClientPath
second_title: Aspose.Cells for .NET API Reference
description: MainWeb property. Gets or sets the web path of the script/image files of the control. For example http//localhost/acw_client. You may also set this value in the web.config file. Add this section to the configuration sectionappSettingsadd keyaspose.cells.gridweb.acw_client_path value/acw_client/ //appSettings
type: docs
