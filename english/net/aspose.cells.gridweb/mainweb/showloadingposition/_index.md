---
title: MainWeb.ShowLoadingPosition
second_title: Aspose.Cells for .NET API Reference
description: MainWeb property. Specifies the lefttop postionin px to show the loading dialogbox while postbacking to server etc. 100200 means the loading dialogboxs lefttop postion is at 100px200px 
type: docs
