...
description: Inherited from WebWorksheet. Used in design-time only.
type: docs
weight: 1170
...
| [Cells](../../aspose.cells.gridweb.data/webworksheet/cells) { get; } | Gets the [`WebCells`](../../aspose.cells.gridweb.data/webcells). |
...
| [Index](../../aspose.cells.gridweb.data/webworksheet/index) { get; } | Gets the index of itself within the [`WebWorksheets`](../../aspose.cells.gridweb.data/webworksheets). |
...
| Name | Description |
| --- | --- |
| [AutoFitColumn](../../aspose.cells.gridweb.data/webworksheet/autofitcolumn)(int) | Autofits the column width. |
| [AutoFitColumn](../../aspose.cells.gridweb.data/webworksheet/autofitcolumn)(int, int, int) | Autofits the column width. This method autofits a column based on content in a range of cells within the column from startRow to endRow. AutoFitColumn is an imprecise function. |
...
| [GroupRows](../../aspose.cells.gridweb.data/webworksheet/grouprows)(int, int) | Groups rows. |
| [GroupRows](../../aspose.cells.gridweb.data/webworksheet/grouprows)(int, int, bool) | Groups rows. |
