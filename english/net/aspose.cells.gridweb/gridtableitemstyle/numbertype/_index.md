...
description: GridTableItemStyle property. Gets or sets the display format of numbers and dates. The formatting patterns are different for different regions
type: docs
