---
title: PivotFilter.Value1
second_title: Aspose.Cells for .NET API Reference
description: PivotFilter property. Gets the string value1 of the label pivot filter
type: docs
...
```csharp
// Called: filter.Value1 = "SampleValue1";
public static void PivotFilter_Property_Value1()
        {
