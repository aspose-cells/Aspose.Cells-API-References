...
```csharp
// Called: AssertHelper.AreEqual(pfieldSrc.ShowValuesSetting.BaseItemIndex, pfieldDest.ShowValuesSetting.BaseItemIndex, info + &amp;quot;.BaseItem&amp;quot;);
public static void Property_BaseItemIndex(PivotField pfieldSrc, PivotField pfieldDest, string info)
        {
