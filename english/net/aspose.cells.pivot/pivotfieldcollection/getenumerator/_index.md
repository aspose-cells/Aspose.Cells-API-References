---
title: PivotFieldCollection.GetEnumerator
second_title: Aspose.Cells for .NET API Reference
description: PivotFieldCollection method. Gets an enumerator over the elements in this collection in proper sequence
type: docs
...
```csharp
namespace AsposeCellsExamples.PivotFieldCollectionMethodGetEnumeratorDemo
{
    using Aspose.Cells;
