---
title: PivotField.DragToData
second_title: Aspose.Cells for .NET API Reference
description: PivotField property. Indicates whether the specified field can be dragged to the data position. The default value is true
type: docs
...
```csharp
// Called: rowField.DragToData = true;
public static void PivotField_Property_DragToData()
        {
