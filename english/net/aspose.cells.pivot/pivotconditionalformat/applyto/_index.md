---
title: PivotConditionalFormat.ApplyTo
second_title: Aspose.Cells for .NET API Reference
description: PivotConditionalFormat method. Applies the conditional format to range. Only for the data region
type: docs
url: /net/aspose.cells.pivot/pivotconditionalformat/applyto/
---
...
```csharp
// Called: pcf.ApplyTo(5, 9, PivotConditionFormatScopeType.Field);
[Test]
        public void Method_PivotConditionFormatScopeType_()
        {
            ...
            pcf.ApplyTo(5, 9, PivotConditionFormatScopeType.Field);
            PivotArea pivotArea = pcf.PivotAreas[0];
            ...
            workbook.Save(Constants.destPath + "CellsNet57749.xlsx");
        }
```
