---
title: PivotDiscreteGroupSettings.Items
second_title: Aspose.Cells for .NET API Reference
description: PivotDiscreteGroupSettings property. Gets the discrete items
type: docs
url: /net/aspose.cells.pivot/pivotdiscretegroupsettings/items/
---
...
```csharp
namespace AsposeCellsExamples.PivotDiscreteGroupSettingsPropertyItemsDemo
{
    using Aspose.Cells;
