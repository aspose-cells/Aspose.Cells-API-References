---
title: Class PivotAreaFilterCollection
second_title: Aspose.Cells for .NET API Reference
description: Aspose.Cells.Pivot.PivotAreaFilterCollection class. Represents the list of filters for PivotArea
type: docs
...
```csharp
namespace AsposeCellsExamples.PivotClassPivotAreaFilterCollectionDemo
{
    using Aspose.Cells;
