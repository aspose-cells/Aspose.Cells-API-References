---
title: Class PivotAreaFilter
second_title: Aspose.Cells for .NET API Reference
description: Aspose.Cells.Pivot.PivotAreaFilter class. Represents the filter of PivotArea for PivotTable
type: docs
...
| Name | Description |
| --- | --- |
| [FieldIndex](../../aspose.cells.pivot/pivotareafilter/fieldindex/) { get; } | Gets the index of the field in the source fields which this filter refers to. A value of -2 indicates the values field. |
