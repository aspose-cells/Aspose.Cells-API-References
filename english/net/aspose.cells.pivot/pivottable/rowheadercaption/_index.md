...
```csharp
// Called: pivotTable.RowHeaderCaption = "State";
public void PivotTable_Property_RowHeaderCaption()
{
    ...
    workbook.Save(Constants.PivotTableDestPath + @"example.xlsx", SaveFormat.Xlsx);
}
```
