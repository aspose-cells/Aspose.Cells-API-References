...
```csharp
// Called: AssertHelper.AreEqual(ptableSrc.PageFieldWrapCount, ptableDest.PageFieldWrapCount, info + &amp;quot;.PageFieldWrapCount&amp;quot;);
public static void Property_PageFieldWrapCount(PivotTable ptableSrc, PivotTable ptableDest, string info)
        {
            ...
            PivotFieldsTest.Property_PageFieldWrapCount(ptableSrc.BaseFields, ptableDest.BaseFields, info + &quot;.BaseFields&quot;);
            PivotFieldsTest.Property_PageFieldWrapCount(ptableSrc.ColumnFields, ptableDest.ColumnFields, info + &quot;.ColumnFields&quot;);
            AssertHelper.AreEqual(ptableSrc.ShowColumnGrandTotals, ptableDest.ShowColumnGrandTotals, info + &quot;.ColumnGrand&quot;);
            CellAreaTest.Property_PageFieldWrapCount(ptableSrc.ColumnRange, ptableDest.ColumnRange, info + &quot;.ColumnRange&quot;);
            CellAreaTest.Property_PageFieldWrapCount(ptableSrc.DataBodyRange, ptableDest.DataBodyRange, info + &quot;.DataBordyRange&quot;);
            PivotFieldsTest.Property_PageFieldWrapCount(ptableSrc.DataField, ptableDest.DataField, info + &quot;.DataField&quot;);
            PivotFieldsTest.Property_PageFieldWrapCount(ptableSrc.DataFields, ptableDest.DataFields, info + &quot;.DataFields&quot;);
            ...
            PivotFieldsTest.Property_PageFieldWrapCount(ptableSrc.PageFields, ptableDest.PageFields, info + &quot;.PageFields&quot;);
            ...
            PivotFieldsTest.Property_PageFieldWrapCount(ptableSrc.RowFields, ptableDest.RowFields, info + &quot;.RowFields&quot;);
            AssertHelper.AreEqual(ptableSrc.ShowRowGrandTotals, ptableDest.ShowRowGrandTotals, info + &quot;.RowGrand&quot;);
            CellAreaTest.Property_PageFieldWrapCount(ptableSrc.RowRange, ptableDest.RowRange, info + &quot;.RowRange&quot;);
            ...
            CellAreaTest.Property_PageFieldWrapCount(ptableSrc.TableRange1, ptableDest.TableRange1, info + &quot;.TableRange1&quot;);
            CellAreaTest.Property_PageFieldWrapCount(ptableSrc.TableRange2, ptableDest.TableRange2, info + &quot;.TableRange2&quot;);
