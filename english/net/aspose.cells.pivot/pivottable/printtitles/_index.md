---
title: PivotTable.PrintTitles
second_title: Aspose.Cells for .NET API Reference
description: PivotTable property. Indicates whether the print titles for the worksheet are set based on the PivotTable report. The default value is false
type: docs
...
```csharp
// Called: AssertHelper.AreEqual(ptableSrc.PrintTitles, ptableDest.PrintTitles, info + ".PrintTitles");
public static void Property_PrintTitles(PivotTable ptableSrc, PivotTable ptableDest, string info)
        {
            ...
            PivotFieldsTest.Property_PrintTitles(ptableSrc.BaseFields, ptableDest.BaseFields, info + ".BaseFields");
            PivotFieldsTest.Property_PrintTitles(ptableSrc.ColumnFields, ptableDest.ColumnFields, info + ".ColumnFields");
            AssertHelper.AreEqual(ptableSrc.ShowColumnGrandTotals, ptableDest.ShowColumnGrandTotals, info + ".ColumnGrand");
            CellAreaTest.Property_PrintTitles(ptableSrc.ColumnRange, ptableDest.ColumnRange, info + ".ColumnRange");
            CellAreaTest.Property_PrintTitles(ptableSrc.DataBodyRange, ptableDest.DataBodyRange, info + ".DataBordyRange");
            PivotFieldsTest.Property_PrintTitles(ptableSrc.DataField, ptableDest.DataField, info + ".DataField");
            PivotFieldsTest.Property_PrintTitles(ptableSrc.DataFields, ptableDest.DataFields, info + ".DataFields");
            ...
            PivotFieldsTest.Property_PrintTitles(ptableSrc.PageFields, ptableDest.PageFields, info + ".PageFields");
            ...
            PivotFieldsTest.Property_PrintTitles(ptableSrc.RowFields, ptableDest.RowFields, info + ".RowFields");
            AssertHelper.AreEqual(ptableSrc.ShowRowGrandTotals, ptableDest.ShowRowGrandTotals, info + ".RowGrand");
            CellAreaTest.Property_PrintTitles(ptableSrc.RowRange, ptableDest.RowRange, info + ".RowRange");
            ...
            CellAreaTest.Property_PrintTitles(ptableSrc.TableRange1, ptableDest.TableRange1, info + ".TableRange1");
            CellAreaTest.Property_PrintTitles(ptableSrc.TableRange2, ptableDest.TableRange2, info + ".TableRange2");
