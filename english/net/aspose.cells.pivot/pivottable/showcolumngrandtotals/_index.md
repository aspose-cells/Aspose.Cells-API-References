...
```csharp
// Called: AssertHelper.AreEqual(ptableSrc.ShowColumnGrandTotals, ptableDest.ShowColumnGrandTotals, info + &amp;quot;.ColumnGrand&amp;quot;);
public static void Property_ShowColumnGrandTotals(PivotTable ptableSrc, PivotTable ptableDest, string info)
        {
            ...
            PivotFieldsTest.Property_ShowColumnGrandTotals(ptableSrc.BaseFields, ptableDest.BaseFields, info + &quot;.BaseFields&quot;);
            PivotFieldsTest.Property_ShowColumnGrandTotals(ptableSrc.ColumnFields, ptableDest.ColumnFields, info + &quot;.ColumnFields&quot;);
            AssertHelper.AreEqual(ptableSrc.ShowColumnGrandTotals, ptableDest.ShowColumnGrandTotals, info + &quot;.ColumnGrand&quot;);
            CellAreaTest.Property_ShowColumnGrandTotals(ptableSrc.ColumnRange, ptableDest.ColumnRange, info + &quot;.ColumnRange&quot;);
            CellAreaTest.Property_ShowColumnGrandTotals(ptableSrc.DataBodyRange, ptableDest.DataBodyRange, info + &quot;.DataBordyRange&quot;);
            PivotFieldsTest.Property_ShowColumnGrandTotals(ptableSrc.DataField, ptableDest.DataField, info + &quot;.DataField&quot;);
            PivotFieldsTest.Property_ShowColumnGrandTotals(ptableSrc.DataFields, ptableDest.DataFields, info + &quot;.DataFields&quot;);
            ...
            PivotFieldsTest.Property_ShowColumnGrandTotals(ptableSrc.PageFields, ptableDest.PageFields, info + &quot;.PageFields&quot;);
            ...
            PivotFieldsTest.Property_ShowColumnGrandTotals(ptableSrc.RowFields, ptableDest.RowFields, info + &quot;.RowFields&quot;);
            AssertHelper.AreEqual(ptableSrc.ShowRowGrandTotals, ptableDest.ShowRowGrandTotals, info + &quot;.RowGrand&quot;);
            CellAreaTest.Property_ShowColumnGrandTotals(ptableSrc.RowRange, ptableDest.RowRange, info + &quot;.RowRange&quot;);
            ...
            CellAreaTest.Property_ShowColumnGrandTotals(ptableSrc.TableRange1, ptableDest.TableRange1, info + &quot;.TableRange1&quot;);
            CellAreaTest.Property_ShowColumnGrandTotals(ptableSrc.TableRange2, ptableDest.TableRange2, info + &quot;.TableRange2&quot;);
