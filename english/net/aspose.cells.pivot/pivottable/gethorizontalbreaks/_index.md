---
title: PivotTable.GetHorizontalBreaks
second_title: Aspose.Cells for .NET API Reference
description: PivotTable method. Gets pivot table row index list of horizontal page breaks
type: docs
...
```csharp
namespace AsposeCellsExamples.PivotTableExamples.PivotTableMethodGetHorizontalBreaksDemo
{
    using Aspose.Cells;
