---
title: PivotTable.ShowEmptyCol
second_title: Aspose.Cells for .NET API Reference
description: PivotTable property. Indicates whether to include empty columns in the table
type: docs
...
```csharp
namespace AsposeCellsExamples.PivotTablePropertyShowEmptyColDemo
{
    using Aspose.Cells;
