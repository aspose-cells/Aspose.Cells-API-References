---
title: Enum PivotTableSelectionType
second_title: Aspose.Cells for .NET API Reference
description: Aspose.Cells.Pivot.PivotTableSelectionType enum. Specifies what can be selected in a PivotTable during a structured selection. These constants can be combined to select multiple types
type: docs
