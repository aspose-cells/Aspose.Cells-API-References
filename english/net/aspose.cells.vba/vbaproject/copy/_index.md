---
title: VbaProject.Copy
second_title: Aspose.Cells for .NET API Reference
description: VbaProject method. Copy VBA project from other file
type: docs
...
```csharp
namespace AsposeCellsExamples.VbaProjectMethodCopyWithVbaProjectDemo
{
    using Aspose.Cells;
