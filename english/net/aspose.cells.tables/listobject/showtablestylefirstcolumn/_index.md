...
```csharp
// Called: AssertHelper.AreEqual(false, listObject.ShowTableStyleFirstColumn, "listObject.ShowTableStyleFirstColumn");
[Test]
        public void Property_ShowTableStyleFirstColumn()
        {
