...
```csharp
// Called: AssertHelper.AreEqual(true, listObject.ShowTableStyleColumnStripes, "listObject.ShowTableStyleColumnStripes");
[Test]
        public void Property_ShowTableStyleColumnStripes()
        {
            ...
            listObjects[0].ShowTableStyleColumnStripes = true;
            ...
            AssertHelper.AreEqual(true, listObject.ShowTableStyleColumnStripes, "listObject.ShowTableStyleColumnStripes");
        }
```
