...
```csharp
// Called: AssertHelper.AreEqual(false, listObject.ShowTableStyleLastColumn, "listObject.ShowTableStyleLastColumn");
[Test]
        public void Property_ShowTableStyleLastColumn()
        {
            ...
            listObjects[0].ShowTableStyleLastColumn = false;
            ...
            AssertHelper.AreEqual(false, listObject.ShowTableStyleLastColumn, "listObject.ShowTableStyleLastColumn");
        }
```
