...
|[Add_String_Bool](./add_string_bool/) | Adds the <see cref="Series"/> collection to a chart. | 
|[Add_String_Bool_Bool](./add_string_bool_bool/) | Adds the <see cref="Series"/> collection to a chart. | 
