...
|[Get_Int](./get_int/) | Gets the <see cref="Comment"/> element at the specified index. | 
|[Get_String](./get_string/) | Gets the <see cref="Comment"/> element at the specified cell. | 
|[Get_Int_Int](./get_int_int/) | Gets the <see cref="Comment"/> element at the specified row index and column index. | 
