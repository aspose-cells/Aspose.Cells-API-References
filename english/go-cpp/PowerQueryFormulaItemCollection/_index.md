...
type: docs
weight: 200
url: /go-cpp/powerqueryformulaitemcollection/
---
...
|[Get_Int](./get_int/) | Gets <see cref=" PowerQueryFormulaItem"/> by the index in the list. | 
|[Get_String](./get_string/) | Gets <see cref=" PowerQueryFormulaItem"/> by the name of the item. | 
|[GetCount](./getcount/) |  | 
