...
|[SetUpdateInvalidReferencesToTargetSheet](./setupdateinvalidreferencestotargetsheet/) | Indicates whether to refer to target worksheet if the referred worksheet is not copied. | 
