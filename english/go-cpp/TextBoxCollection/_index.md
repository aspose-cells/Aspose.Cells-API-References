...
|[Get_Int](./get_int/) | Gets the <see cref="TextBox"/> element at the specified index. | 
|[Get_String](./get_string/) | Gets the <see cref="TextBox"/> element by the name. | 
