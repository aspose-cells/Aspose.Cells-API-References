...
|[GetCellArea_Bool](./getcellarea_bool/) | Gets the Aspose.Cells.CellArea where the specified AutoFilter applies. | 
...
|[FilterTop10](./filtertop10/) | Filter the top 10 items in the list | 
...
|[MatchBlanks](./matchblanks/) | Match all blank cells in the list. | 
|[MatchNonBlanks](./matchnonblanks/) | Match all not-blank cells in the list. | 
|[Custom_Int_FilterOperatorType_Object](./custom_int_filteroperatortype_object/) | Filters a list with a custom criterion. | 
