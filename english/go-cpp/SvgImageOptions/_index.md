...
description: 'SvgImageOptions class. Encapsulates the object that represents svgimageoptions in Go.'
type: docs
weight: 200
url: /go-cpp/svgimageoptions/
---
...
| Method | Description |
| --- | --- |
|[NewSvgImageOptions](./newsvgimageoptions/) | Ctor. | 
|[NewSvgImageOptions_ImageOrPrintOptions](./newsvgimageoptions_imageorprintoptions/) | Constructs from a parent object. | 
...
|[SetFitToViewPort](./setfittoviewport/) | if this property is true, the generated svg will fit to view port. | 
|[GetCssPrefix](./getcssprefix/) | Gets and sets the prefix of the css name in svg,the default value is empty string. | 
|[SetCssPrefix](./setcssprefix/) | Gets and sets the prefix of the css name in svg,the default value is empty string. | 
|[GetEmbeddedFontType](./getembeddedfonttype/) | Gets or sets the type of font that embedded in Svg. | 
|[SetEmbeddedFontType](./setembeddedfonttype/) | Gets or sets the type of font that embedded in Svg. | 
