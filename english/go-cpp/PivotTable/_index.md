...
|[GetColumnHeaderCaption](./getcolumnheadercaption/) | Gets and sets the custom Caption of the Column Header of the PivotTable. | 
|[SetColumnHeaderCaption](./setcolumnheadercaption/) | Gets and sets the custom Caption of the Column Header of the PivotTable. | 
...
|[SetTag](./settag/) | Gets and sets a user-defined string that is associated with this PivotTable view. | 
...
|[Format_Int_Int_Style](./format_int_int_style/) | Formats the cell in the pivottable area | 
...
|[SetRepeatItemsOnEachPrintedPage](./setrepeatitemsoneachprintedpage/) | Indicates whether captions of pivot item  on the row area are repeated on each printed page for pivot fields in tabular form. | 
