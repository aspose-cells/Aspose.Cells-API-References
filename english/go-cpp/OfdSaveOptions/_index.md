...
description: 'OfdSaveOptions class. Encapsulates the object that represents ofdsaveoptions in Go.'
type: docs
weight: 200
url: /go-cpp/ofdsaveoptions/
---
...
| Method | Description |
| --- | --- |
|[NewOfdSaveOptions](./newofdsaveoptions/) | Creates the options for saving OFD file. | 
|[NewOfdSaveOptions_PaginatedSaveOptions](./newofdsaveoptions_paginatedsaveoptions/) | Constructs from a parent object. | 
