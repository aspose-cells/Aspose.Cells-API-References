...
weight: 20
url: /js-cpp/
description: Aspose.Cells for JavaScript via C++ API Reference provides classes, interfaces, enumeration types, and other API details.
is_root: true
---
...
| [AbstractLowCodeSaveOptionsProvider](./abstractlowcodesaveoptionsprovider) | Implementation to provide multiple save options for processes that require multiple outputs. For example, [SpreadsheetSplitter](../js-cpp/spreadsheetsplitter/) feature requires multiple destinations to save the split files. |
...
| [BorderCollection](./bordercollection) | Encapsulates a collection of [Border](../js-cpp/border/) objects. |
...
| [Cells](./cells) | Encapsulates a collection of cell relevant objects, such as [Cell](../js-cpp/cell/), [Row](../js-cpp/row/), ...etc. |
...
| [ChartCollection](./chartcollection) | Encapsulates a collection of [Chart](../js-cpp/chart/) objects. |
...
| [CheckBoxCollection](./checkboxcollection) | Represents a collection of [CheckBox](../js-cpp/checkbox/) objects in a worksheet. |
...
| [CommentCollection](./commentcollection) | Encapsulates a collection of [Comment](../js-cpp/comment/) objects. |
| [CommentShape](./commentshape) | Represents the shape of the comment. |
| [ConditionalFormattingCollection](./conditionalformattingcollection) | Encapsulates a collection of [FormatCondition](../js-cpp/formatcondition/) objects. |
| [ConditionalFormattingIcon](./conditionalformattingicon) | Represents  the custom  icon of conditional formatting rule. |
| [ConditionalFormattingIconCollection](./conditionalformattingiconcollection) | Represents  a collection of [ConditionalFormattingIcon](../js-cpp/conditionalformattingicon/) objects. |
...
| [ConnectionParameterCollection](./connectionparametercollection) | Specifies the [ConnectionParameter](../js-cpp/connectionparameter/) collection |
| [ContentTypeProperty](./contenttypeproperty) | Represents identifier information. |
| [ContentTypePropertyCollection](./contenttypepropertycollection) | A collection of [ContentTypeProperty](../js-cpp/contenttypeproperty/) objects that represent additional information. |
...
| [CustomPropertyCollection](./custompropertycollection) | A collection of [CustomProperty](../js-cpp/customproperty/) objects that represent additional information. |
...
| [DocumentPropertyCollection](./documentpropertycollection) | Base class for [BuiltInDocumentPropertyCollection](../js-cpp/builtindocumentpropertycollection/) and [CustomDocumentPropertyCollection](../js-cpp/customdocumentpropertycollection/) collections. |
...
| [ExternalConnectionCollection](./externalconnectioncollection) | Specifies the [ExternalConnection](../js-cpp/externalconnection/) collection |
...
| [FileFormatInfo](./fileformatinfo) | Contains data returned by [FileFormatUtil](../js-cpp/fileformatutil/) file format detection methods. |
...
| [FontSettingCollection](./fontsettingcollection) | Represents the list of [FontSetting](../js-cpp/fontsetting/). |
...
| [HorizontalPageBreakCollection](./horizontalpagebreakcollection) | Encapsulates a collection of [HorizontalPageBreak](../js-cpp/horizontalpagebreak/) objects. |
...
| [HyperlinkCollection](./hyperlinkcollection) | Encapsulates a collection of [Hyperlink](../js-cpp/hyperlink/) objects. |
...
| [ImageSaveOptions](./imagesaveoptions) | Represents image save options. For advanced usage, please use [WorkbookRender](../js-cpp/workbookrender/) or [SheetRender](../js-cpp/sheetrender/). |
| [ImportTableOptions](./importtableoptions) | Represents the options of importing data into cells. |
| [IndividualFontConfigs](./individualfontconfigs) | Font configs for each [Workbook](../js-cpp/workbook/) object. |
...
| [LegendEntryCollection](./legendentrycollection) | Represents a collection of all the [LegendEntry](../js-cpp/legendentry/) objects in the specified chart legend. |
...
| [ListColumnCollection](./listcolumncollection) | Represents A collection of all the [ListColumn](../js-cpp/listcolumn/) objects in the specified ListObject object. |
...
| [ListObjectCollection](./listobjectcollection) | Represents a collection of [ListObject](../js-cpp/listobject/) objects in the worksheet. |
...
| [LowCodeSaveOptionsProviderOfAssembling](./lowcodesaveoptionsproviderofassembling) | Implementation to provide save options which save split parts to files and the path of resultant file are named as(it may contains directories): [PathHeader](../js-cpp/pathheader/)+[SheetPrefix](../js-cpp/sheetprefix/)+SheetIndex(or SheetName) +[SplitPartPrefix](../js-cpp/splitpartprefix/)+SplitPartIndex+[PathTail](../js-cpp/pathtail/). |
...
| [NameCollection](./namecollection) | Represents a collection of all the [Name](../js-cpp/name/) objects in the spreadsheet. |
...
| [PictureCollection](./picturecollection) | Encapsulates a collection of [Picture](../js-cpp/picture/) objects. |
...
| [PivotAreaFilter](./pivotareafilter) | Represents the filter of [PivotArea](../js-cpp/pivotarea/) for [PivotTable](../js-cpp/pivottable/). |
| [PivotAreaFilterCollection](./pivotareafiltercollection) | Represents the list of filters for [PivotArea](../js-cpp/pivotarea/) |
...
| [PivotItemCollection](./pivotitemcollection) | Represents all the [PivotItem](../js-cpp/pivotitem/) objects in the PivotField. |
...
| [ProtectedRangeCollection](./protectedrangecollection) | Encapsulates a collection of [ProtectedRange](../js-cpp/protectedrange/) objects. |
...
| [QueryTableCollection](./querytablecollection) | A collection of [QueryTableCollection](../js-cpp/querytablecollection/) objects that represent QueryTable collection information. |
...
| [RangeCollection](./rangecollection) | Encapsulates a collection of [Range](../js-cpp/range/) objects. |
...
| [RowCollection](./rowcollection) | Collects the [Row](../js-cpp/row/) objects that represent the individual rows in a worksheet. |
...
| [SeriesCollection](./seriescollection) | Encapsulates a collection of [Series](../js-cpp/series/) objects. |
...
| [SmartTagSetting](./smarttagsetting) | Represents all [SmartTagCollection](../js-cpp/smarttagcollection/) object in the worksheet. |
...
| [SparklineCollection](./sparklinecollection) | Encapsulates a collection of [Sparkline](../js-cpp/sparkline/) objects. |
| [SparklineGroup](./sparklinegroup) | [Sparkline](../js-cpp/sparkline/) is organized into sparkline group. A SparklineGroup contains a variable number of sparkline items. A sparkline group specifies the type, display settings and axis settings for the sparklines. |
| [SparklineGroupCollection](./sparklinegroupcollection) | Encapsulates a collection of [SparklineGroup](../js-cpp/sparklinegroup/) objects. |
...
| [SystemTimeInterruptMonitor](./systemtimeinterruptmonitor) | Simple implementation of [AbstractInterruptMonitor](../js-cpp/abstractinterruptmonitor/) by checking and comparing current system time with user specified limit. |
...
| [TextBoxCollection](./textboxcollection) | Encapsulates a collection of [TextBox](../js-cpp/textbox/) objects. |
...
| [TrendlineCollection](./trendlinecollection) | Represents a collection of all the [Trendline](../js-cpp/trendline/) objects for the specified data series. |
...
| [Utils](./utils) | Provides utility functions for loading font data and ICU data. |
...
| [VbaModuleCollection](./vbamodulecollection) | Represents the list of [VbaModule](../js-cpp/vbamodule/) |
...
| [VerticalPageBreakCollection](./verticalpagebreakcollection) | Encapsulates a collection of [VerticalPageBreak](../js-cpp/verticalpagebreak/) objects. |
...
| [WorksheetCollection](./worksheetcollection) | Encapsulates a collection of [Worksheet](../js-cpp/worksheet/) objects. |
...
| [XmlMapCollection](./xmlmapcollection) | A collection of [XmlMap](../js-cpp/xmlmap/) objects that represent XmlMap information. |
...
| [EncodingType](./encodingtype) | Represents supported encoding types. |
...
| [FormattingType](./formattingtype) | Represents the type of formatting applied to an [Area](../js-cpp/area/) object or a [Line](../js-cpp/line/) object. |
...
| [LineType](./linetype) | Enumerates the type of [Picture](../js-cpp/picture/) border or [Chart](../js-cpp/chart/) line. |
...
| [MsoArrowheadWidth](./msoarrowheadwidth) | Enumerates the line end width of the shape border line. |
...
| [PdfCustomPropertiesExport](./pdfcustompropertiesexport) | Specifies the way [CustomDocumentPropertyCollection](../js-cpp/customdocumentpropertycollection/) are exported to PDF file. |
...
| [VObjectType](./vobjecttype) | Represents the type of the vobject. |
...
| --- | --- |
| [CellEnumerator](./cellenumerator) | Iterator of Cell objects. |
...
| --- | --- |
| [onReady](./onready) | Initializes Aspose.Cells WebAssembly module with the given options and returns a Promise that resolves when the module is ready. |
