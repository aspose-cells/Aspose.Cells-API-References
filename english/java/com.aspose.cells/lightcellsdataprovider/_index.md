...
Gets the next row to be saved. It will be called at the beginning of saving a row and its cells data(before [startRow(Row)](../../com.aspose.cells/lightcellsdataprovider\#startRow-Row-)).
