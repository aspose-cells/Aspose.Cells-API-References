...
| [setSmallChange(int value)](#setSmallChange-int-) | For the description of this property, please see \#getSmallChange().getSmallChange() |
...
For the description of this property, please see \#getSmallChange().getSmallChange()
