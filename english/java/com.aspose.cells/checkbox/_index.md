...
| [setCheckValue(int value)](#setCheckValue-int-) | For the description of this property, please see \#getCheckValue().getCheckValue() |
| [setCheckedValue(int value)](#setCheckedValue-int-) | For the description of this property, please see \#getCheckedValue().getCheckedValue() |
...
| [setValue(boolean value)](#setValue-boolean-) | For the description of this property, please see \#getValue().getValue() |
...
For the description of this property, please see \#getCheckValue().getCheckValue()
...
For the description of this property, please see \#getCheckedValue().getCheckedValue()
