...
| [setLoadTableType(int value)](#setLoadTableType-int-) | For the description of this property, please see \#getLoadTableType().getLoadTableType() |
...
For the description of this property, please see \#getLoadTableType().getLoadTableType()
