...
| [getLoadTableType()](#getLoadTableType--) | Gets the type of loading multiple tables in one worksheet. |
...
| [setLoadTableType(int value)](#setLoadTableType-int-) | Sets the type of loading multiple tables in one worksheet. |
...
See [LoadNumbersTableType](../../com.aspose.cells/loadnumberstabletype).
