...
| [setExportColumnIndexOfCell(boolean value)](#setExportColumnIndexOfCell-boolean-) | For the description of this property, please see \#getExportColumnIndexOfCell().getExportColumnIndexOfCell() |
| [setIndentedFormatting(boolean value)](#setIndentedFormatting-boolean-) | For the description of this property, please see \#isIndentedFormatting().isIndentedFormatting() |
| [setLimitAsXls(boolean value)](#setLimitAsXls-boolean-) | For the description of this property, please see \#getLimitAsXls().getLimitAsXls() |
...
For the description of this property, please see \#getExportColumnIndexOfCell().getExportColumnIndexOfCell()
...
For the description of this property, please see \#isIndentedFormatting().isIndentedFormatting()
...
For the description of this property, please see \#getLimitAsXls().getLimitAsXls()
