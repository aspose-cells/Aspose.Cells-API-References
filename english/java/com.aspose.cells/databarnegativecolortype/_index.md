...
type: docs
url: /java/com.aspose.cells/databarnegativecolortype/
---
...
| Field | Description |
| --- | --- |
| [COLOR](#COLOR) | Use the color specified in the Negative Value and Axis Setting dialog box or by using the ColorType and BorderColorType properties of the NegativeBarFormat object. |
| [SAME_AS_POSITIVE](#SAME-AS-POSITIVE) | Use the same color as positive data bars. |
## Methods
...
### SAME_AS_POSITIVE {#SAME-AS-POSITIVE}
```
