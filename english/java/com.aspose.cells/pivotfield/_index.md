...
Represents the item in the base field for a custom calculation. Valid only for data fields. Because PivotItemPosition.Custom is only for read,if you need to set PivotItemPosition.Custom, please set PivotField.BaseItemIndex attribute. See [PivotItemPosition](../../com.aspose.cells/pivotitemposition).
...
Represents how to display the values contained in a data field. See [PivotFieldDataDisplayFormat](../../com.aspose.cells/pivotfielddatadisplayformat).
...
Represents the function used to summarize the PivotTable data field. See [ConsolidationFunction](../../com.aspose.cells/consolidationfunction).
