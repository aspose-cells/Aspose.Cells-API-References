...
type: docs
url: /java/com.aspose.cells/subsupequationnode/
---
...
This class specifies an equation that can optionally be superscript or subscript. There are four main forms of this equation, superscript\\u951b\\u5bbbubscript\\u951b\\u5bbbuperscript and subscript placed to the left of the base, superscript and subscript placed to the right of the base.
## Methods
