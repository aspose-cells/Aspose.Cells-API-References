...
type: docs
url: /java/com.aspose.cells/matrixequationnode/
---
...
| [isHidePlaceholder()](#isHidePlaceholder--) | This attribute specifies the Hide Placeholders property on a matrix. |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
| [setBaseJc(int value)](#setBaseJc-int-) | This attribute specifies the justification of the matrix. |
| [setHidePlaceholder(boolean value)](#setHidePlaceholder-boolean-) | This attribute specifies the Hide Placeholders property on a matrix. |
...
This attribute specifies the justification of the matrix. Text outside of the matrix can be aligned with the bottom, top, or center of a matrix function. Default, the matrix assumes center justification. [EquationVerticalJustificationType](../../com.aspose.cells/equationverticaljustificationtype).
...
### setBaseJc(int value) {#setBaseJc-int-}
```
...
### setHidePlaceholder(boolean value) {#setHidePlaceholder-boolean-}
```
