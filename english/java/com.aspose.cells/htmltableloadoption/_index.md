...
type: docs
url: /java/com.aspose.cells/htmltableloadoption/
---
...
| [getClass()](#getClass--) |  |
| [getId()](#getId--) | Gets the id of table to import from html |
...
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [setId(String value)](#setId-java.lang.String-) | Sets the id of table to import from html |
...
### setOriginalSheetIndex(int value) {#setOriginalSheetIndex-int-}
```
...
### setTableIndex(int value) {#setTableIndex-int-}
```
