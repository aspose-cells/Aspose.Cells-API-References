...
| [getCurrentValue()](#getCurrentValue--) | the current value. |
...
| [getIncrementalChange()](#getIncrementalChange--) | the amount that the scroll bar or spinner is incremented a line scroll. |
...
| [getMax()](#getMax--) | the maximum value of a scroll bar or spinner range. |
| [getMin()](#getMin--) | the minimum value of a scroll bar or spinner range. |
| [getMsoDrawingType()](#getMsoDrawingType--) | Gets mso drawing type. |
| [getName()](#getName--) | the name of the shape. |
| [getPageChange()](#getPageChange--) | page change |
...
| [setCurrentValue(int value)](#setCurrentValue-int-) | For the description of this property, please see [getCurrentValue()](../../com.aspose.cells/scrollbar\#getCurrentValue--) |
...
| [setHorizontal(boolean value)](#setHorizontal-boolean-) | For the description of this property, please see [isHorizontal()](../../com.aspose.cells/scrollbar\#isHorizontal--) |
...
| [setIncrementalChange(int value)](#setIncrementalChange-int-) | For the description of this property, please see [getIncrementalChange()](../../com.aspose.cells/scrollbar\#getIncrementalChange--) |
...
| [setMax(int value)](#setMax-int-) | For the description of this property, please see [getMax()](../../com.aspose.cells/scrollbar\#getMax--) |
| [setMin(int value)](#setMin-int-) | For the description of this property, please see [getMin()](../../com.aspose.cells/scrollbar\#getMin--) |
...
| [setPageChange(int value)](#setPageChange-int-) | For the description of this property, please see [getPageChange()](../../com.aspose.cells/scrollbar\#getPageChange--) |
...
| [setShadow(boolean value)](#setShadow-boolean-) | For the description of this property, please see [getShadow()](../../com.aspose.cells/scrollbar\#getShadow--) |
...
For the description of this property, please see [getCurrentValue()](../../com.aspose.cells/scrollbar\#getCurrentValue--)
...
For the description of this property, please see [isHorizontal()](../../com.aspose.cells/scrollbar\#isHorizontal--)
...
For the description of this property, please see [getIncrementalChange()](../../com.aspose.cells/scrollbar\#getIncrementalChange--)
...
For the description of this property, please see [getMax()](../../com.aspose.cells/scrollbar\#getMax--)
...
For the description of this property, please see [getMin()](../../com.aspose.cells/scrollbar\#getMin--)
...
For the description of this property, please see [getPageChange()](../../com.aspose.cells/scrollbar\#getPageChange--)
...
For the description of this property, please see [getShadow()](../../com.aspose.cells/scrollbar\#getShadow--)
