...
| [getCurrentValue()](#getCurrentValue--) | Gets the current value. |
...
| [getIncrementalChange()](#getIncrementalChange--) | Gets the amount that the scroll bar or spinner is incremented a line scroll. |
...
| [getMax()](#getMax--) | Gets the maximum value of a scroll bar or spinner range. |
| [getMin()](#getMin--) | Gets the minimum value of a scroll bar or spinner range. |
| [getMsoDrawingType()](#getMsoDrawingType--) | Gets mso drawing type. |
| [getName()](#getName--) | Gets the name of the shape. |
| [getPageChange()](#getPageChange--) | Gets page change |
...
| [setHorizontal(boolean value)](#setHorizontal-boolean-) | Indicates whether this is a horizontal scroll bar. |
...
| [setIncrementalChange(int value)](#setIncrementalChange-int-) | Sets the amount that the scroll bar or spinner is incremented a line scroll. |
...
| [setMax(int value)](#setMax-int-) | Sets the maximum value of a scroll bar or spinner range. |
| [setMin(int value)](#setMin-int-) | Sets the minimum value of a scroll bar or spinner range. |
| [setName(String value)](#setName-java.lang.String-) | Sets the name of the shape. |
| [setPageChange(int value)](#setPageChange-int-) | Sets page change |
...
| [setShadow(boolean value)](#setShadow-boolean-) | Indicates whether the shape has 3-D shading. |
...
### setCurrentValue(int value) {#setCurrentValue-int-}
```
...
### setIncrementalChange(int value) {#setIncrementalChange-int-}
```
