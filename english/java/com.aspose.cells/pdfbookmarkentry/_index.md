...
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [setCollapse(boolean value)](#setCollapse-boolean-) | For the description of this property, please see \#isCollapse().isCollapse() |
| [setDestination(Cell value)](#setDestination-com.aspose.cells.Cell-) | For the description of this property, please see \#getDestination().getDestination() |
| [setDestinationName(String value)](#setDestinationName-java.lang.String-) | For the description of this property, please see \#getDestinationName().getDestinationName() |
| [setOpen(boolean value)](#setOpen-boolean-) | For the description of this property, please see \#isOpen().isOpen() |
| [setSubEntry(ArrayList value)](#setSubEntry-java.util.ArrayList-) | For the description of this property, please see \#getSubEntry().getSubEntry() |
...
For the description of this property, please see \#isCollapse().isCollapse()
...
For the description of this property, please see \#getDestination().getDestination()
...
For the description of this property, please see \#getDestinationName().getDestinationName()
...
For the description of this property, please see \#isOpen().isOpen()
...
For the description of this property, please see \#getSubEntry().getSubEntry()
