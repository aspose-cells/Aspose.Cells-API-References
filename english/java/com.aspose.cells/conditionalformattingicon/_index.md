...
**Returns:**
java.lang.Class<?>
### getIconImageData(int type, int index) {#getIconImageData-int-int-}
```
...
**Returns:**
byte[]
### getImageData(Cell cell) {#getImageData-com.aspose.cells.Cell-}
```
...
| Parameter | Type | Description |
| --- | --- | --- |
| cell | [Cell](../../com.aspose.cells/cell) | The setting of cell. |

**Returns:**
byte[] - Returns the image data of icon.
### getIndex() {#getIndex--}
```
public int getIndex()
```
...
Gets the icon set type. See [IconSetType](../../com.aspose.cells/iconsettype).
...
Sets the icon set type. See [IconSetType](../../com.aspose.cells/iconsettype).
