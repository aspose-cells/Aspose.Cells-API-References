...
| [getSignificantDigitsType()](#getSignificantDigitsType--) | Gets the default type of significant digits for outputting numeric values. |
...
| [setSignificantDigitsType(int value)](#setSignificantDigitsType-int-) | Sets the default type of significant digits for outputting numeric values. |
...
Only could be 15 or 17 now. NOTE: This member is now obsolete. Instead, please use [getSignificantDigitsType()](../../com.aspose.cells/cellshelper\#getSignificantDigitsType--). This property will be removed 12 months later since June 2025. Aspose apologizes for any inconvenience you may have experienced.
...
Gets the default type of significant digits for outputting numeric values. Default value is [SignificantDigitsType.G\_17](../../com.aspose.cells/significantdigitstype\#G-17).
...
Sets the default type of significant digits for outputting numeric values. Default value is [SignificantDigitsType.G\_17](../../com.aspose.cells/significantdigitstype\#G-17).
