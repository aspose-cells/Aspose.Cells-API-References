---
title: DataModelTableCollection
second_title: Aspose.Cells for Java API Reference
description: Represents the list of the data model table.
type: docs
url: /java/com.aspose.cells/datamodeltablecollection/
---
...
```
public DataModelTable get(int index)
```
