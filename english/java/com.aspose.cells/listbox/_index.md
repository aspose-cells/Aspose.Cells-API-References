...
| [getItemCount()](#getItemCount--) | Gets the number of items in the list box. |
...
| [getPageChange()](#getPageChange--) | Specifies the amount by which the control's value is changed when the user clicks on the scrollbar's page up or page down region. |
...
| [getSelectedCells()](#getSelectedCells--) | Gets the selected cells. |
| [getSelectedIndex()](#getSelectedIndex--) | Gets the index number of the currently selected item in a list box or combo box. |
| [getSelectionType()](#getSelectionType--) | Gets the selection mode of the specified list box. |
...
| [isSelected(int itemIndex)](#isSelected-int-) | Indicates whether the item is selected. |
...
| [selectedItem(int itemIndex, boolean isSelected)](#selectedItem-int-boolean-) | Sets whether the item is selected |
...
| [setPageChange(int value)](#setPageChange-int-) | Specifies the amount by which the control's value is changed when the user clicks on the scrollbar's page up or page down region. |
...
| [setSelectedIndex(int value)](#setSelectedIndex-int-) | Sets the index number of the currently selected item in a list box or combo box. |
| [setSelectionType(int value)](#setSelectionType-int-) | Sets the selection mode of the specified list box. |
| [setShadow(boolean value)](#setShadow-boolean-) | Indicates whether the combobox has 3-D shading. |
...
Gets the index number of the currently selected item in a list box or combo box. Zero-based. -1 presents no item is selected.
...
Gets the selection mode of the specified list box. See [SelectionType](../../com.aspose.cells/selectiontype).
...
**Returns:**
boolean - 
### isSelected(int itemIndex) {#isSelected-int-}
```
...
### selectedItem(int itemIndex, boolean isSelected) {#selectedItem-int-boolean-}
```
...
### setPageChange(int value) {#setPageChange-int-}
```
...
Sets the index number of the currently selected item in a list box or combo box. Zero-based. -1 presents no item is selected.
...
Sets the selection mode of the specified list box. See [SelectionType](../../com.aspose.cells/selectiontype).
