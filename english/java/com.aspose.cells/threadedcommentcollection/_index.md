...
type: docs
url: /java/com.aspose.cells/threadedcommentcollection/
---
...
| [get(int index)](#get-int-) | Gets the threaded comment by the specific index. |
| [getClass()](#getClass--) |  |
...
### add(String text, ThreadedCommentAuthor author) {#add-java.lang.String-com.aspose.cells.ThreadedCommentAuthor-}
```
...
| Parameter | Type | Description |
| --- | --- | --- |
| text | java.lang.String | The text of the threaded comment. |
| author | [ThreadedCommentAuthor](../../com.aspose.cells/threadedcommentauthor) | The author of the threaded comment |
...
**Returns:**
[ThreadedComment](../../com.aspose.cells/threadedcomment) - 
### getClass() {#getClass--}
```
