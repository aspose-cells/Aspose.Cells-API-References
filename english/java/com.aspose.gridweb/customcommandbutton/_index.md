...
Gets the rendering type of the command. The type can be command button or context menu item. See [CustomCommandButtonType](../../com.aspose.gridweb/customcommandbuttontype).
...
Sets the rendering type of the command. The type can be command button or context menu item. See [CustomCommandButtonType](../../com.aspose.gridweb/customcommandbuttontype).
