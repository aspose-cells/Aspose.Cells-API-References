...
| [SurfaceMaterialType](#surfacematerialtype) | Number | Gets and sets the material type which is combined with the lighting properties to give the final look and feel of a shap |
| [SurfaceLightingType](#surfacelightingtype) | Number | Gets and sets the lighting type which is to be applied to the scene of the shape. Default value is LightRigType.ThreePoi |
