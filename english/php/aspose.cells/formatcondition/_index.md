...
type: docs
weight: 2540
url: /cells/php/aspose.cells/formatcondition/
---
...
| [Operator](#operator) | Number | Gets and sets the conditional format operator type. The value of the property is OperatorType integer constant. |
...
| [Priority](#priority) | Number | The priority of this conditional formatting rule. This value is used to determine which format should be evaluated and r |
| [Style](#style) | Style | Gets or setts style of conditional formatted cell ranges. |
| [Type](#type) | Number | Gets and sets whether the conditional format Type. The value of the property is FormatConditionType integer constant. |
...
| [TimePeriod](#timeperiod) | Number | The applicable time period in a "date occurring…" conditional formatting rule. Valid only for type = timePeriod. The def |
