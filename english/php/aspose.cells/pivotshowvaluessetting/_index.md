...
| --- | --- | --- |
| [CalculationType](#calculationtype) | Number | Represents how to show values of a data field in the pivot report. The value of the property is PivotFieldDataDisplayFor |
...
| [BaseItemPositionType](#baseitempositiontype) | Number | Represents type of the base pivot item in the base field when the ShowDataAs calculation is in use. Valid only for data  |
| [BaseItemIndex](#baseitemindex) | Number | Represents the custom index of the pivot item in the base field when the ShowDataAs calculation is in use. Valid only fo |
