...
articleTitle: "AbstractTextLoadOptions"
...
### AbstractTextLoadOptions.Encoding property {#encoding}

Gets and sets the default encoding. Only applies for csv file.

**Type:** Encoding

### AbstractTextLoadOptions.LoadStyleStrategy property {#loadstylestrategy}
...
### AbstractTextLoadOptions.ConvertNumericData property {#convertnumericdata}

Gets or sets a value that indicates whether the string in text file is converted to numeric data.

**Type:** boolean

### AbstractTextLoadOptions.ConvertDateTimeData property {#convertdatetimedata}

Gets or sets a value that indicates whether the string in text file is converted to date data.

**Type:** boolean

### AbstractTextLoadOptions.KeepPrecision property {#keepprecision}

Indicates whether not parsing a string value if the length is 15.

**Type:** boolean

### AbstractTextLoadOptions.LoadFormat property {#loadformat}

Gets the load format. The value of the property is LoadFormat integer constant.

**Type:** Number

### AbstractTextLoadOptions.Password property {#password}

Gets and set the password of the workbook.

**Type:** String

### AbstractTextLoadOptions.ParsingFormulaOnOpen property {#parsingformulaonopen}
...
### AbstractTextLoadOptions.ParsingPivotCachedRecords property {#parsingpivotcachedrecords}
...
### AbstractTextLoadOptions.LanguageCode property {#languagecode}
...
### AbstractTextLoadOptions.Region property {#region}
...
### AbstractTextLoadOptions.Locale property {#locale}

Gets and sets the Locale used for workbook at the time the file was loaded.

**Type:** Locale

### AbstractTextLoadOptions.DefaultStyleSettings property {#defaultstylesettings}

Gets the default style settings for initializing styles of the workbook

**Type:** DefaultStyleSettings

### AbstractTextLoadOptions.StandardFont property {#standardfont}
...
### AbstractTextLoadOptions.StandardFontSize property {#standardfontsize}
...
### AbstractTextLoadOptions.InterruptMonitor property {#interruptmonitor}

Gets and sets the interrupt monitor.

**Type:** AbstractInterruptMonitor

### AbstractTextLoadOptions.IgnoreNotPrinted property {#ignorenotprinted}

Ignore the data which are not printed if directly printing the file Only for xlsx file.

**Type:** boolean

### AbstractTextLoadOptions.CheckDataValid property {#checkdatavalid}

Check whether data is valid in the template file.

**Type:** boolean

### AbstractTextLoadOptions.CheckExcelRestriction property {#checkexcelrestriction}
...
### AbstractTextLoadOptions.KeepUnparsedData property {#keepunparseddata}
...
### AbstractTextLoadOptions.LoadFilter property {#loadfilter}

The filter to denote how to load data.

**Type:** LoadFilter

### AbstractTextLoadOptions.LightCellsDataHandler property {#lightcellsdatahandler}

The data handler for processing cells data when reading template file.

**Type:** LightCellsDataHandler

### AbstractTextLoadOptions.MemorySetting property {#memorysetting}

Gets or sets the memory usage options. The value of the property is MemorySetting integer constant.

**Type:** Number

### AbstractTextLoadOptions.WarningCallback property {#warningcallback}

Gets or sets warning callback.

**Type:** IWarningCallback

### AbstractTextLoadOptions.AutoFitterOptions property {#autofitteroptions}

Gets and sets the auto fitter options Only for xlsx ,spreadsheetML file now.

**Type:** AutoFitterOptions

### AbstractTextLoadOptions.AutoFilter property {#autofilter}
...
### AbstractTextLoadOptions.FontConfigs property {#fontconfigs}
...
### AbstractTextLoadOptions.IgnoreUselessShapes property {#ignoreuselessshapes}
...
### AbstractTextLoadOptions.PreservePaddingSpacesInFormula property {#preservepaddingspacesinformula}
