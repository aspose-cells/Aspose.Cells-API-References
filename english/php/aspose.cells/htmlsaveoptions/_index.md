...
type: docs
weight: 2960
url: /cells/php/aspose.cells/htmlsaveoptions/
---
...
| --- | --- | --- |
| saveFormat | Number | A SaveFormat value. The file format. It should be one of following types: SaveFormat.HTML , SaveFormat.M_HTML , or SaveFormat.X_HTML , otherwise the saved format will be set as SaveFormat.HTML automatically. |
