...
type: docs
weight: 460
url: /cells/php/aspose.cells/button/
---
...
### Button.MacroName property {#macroname}

Gets and sets the name of macro.

**Type:** String

### Button.IsEquation property {#isequation}

Indicates whether the shape only contains an equation.

**Type:** boolean

### Button.IsSmartArt property {#issmartart}

Indicates whether the shape is a smart art. Only for ooxml file.

**Type:** boolean

### Button.ZOrderPosition property {#zorderposition}
...
### Button.AlternativeText property {#alternativetext}
...
### Button.LineFormat property {#lineformat}
...
### Button.FillFormat property {#fillformat}
...
### Button.Glow property {#glow}

Represents a GlowEffect object that specifies glow effect for the chart element or shape.

**Type:** GlowEffect

### Button.SoftEdges property {#softedges}

Gets and sets the radius of blur to apply to the edges, in unit of points.

**Type:** Number

### Button.ThreeDFormat property {#threedformat}

Gets and sets 3d format of the shape.

**Type:** ThreeDFormat

### Button.FormatPicture property {#formatpicture}

Gets and sets the options of the picture format.

**Type:** MsoFormatPicture

### Button.IsHidden property {#ishidden}

Indicates whether the object is visible.

**Type:** boolean

### Button.IsLockAspectRatio property {#islockaspectratio}
...
### Button.IsAspectRatioLocked property {#isaspectratiolocked}

True means that aspect ratio of the shape is locked. Only for pictures and Ole Objects.

**Type:** boolean

### Button.RotationAngle property {#rotationangle}

Gets and sets the rotation of the shape.

**Type:** Number

### Button.Hyperlink property {#hyperlink}
...
### Button.IsLocked property {#islocked}
...
### Button.UpperLeftRow property {#upperleftrow}

Represents the top row index. If the shape is in the shape or in the group , UpperLeftRow will be ignored.

**Type:** Number

### Button.UpperDeltaY property {#upperdeltay}

Gets or sets the shape's vertical offset from its upper left corner row. The range of value is 0 to 256.

**Type:** Number

### Button.UpperLeftColumn property {#upperleftcolumn}

Represents upper left corner column index.

**Type:** Number

### Button.UpperDeltaX property {#upperdeltax}

Gets or sets the shape's horizontal offset from its upper left corner column. The range of value is 0 to 1024.

**Type:** Number

### Button.LowerRightRow property {#lowerrightrow}

Represents lower right corner row index.

**Type:** Number

### Button.LowerDeltaY property {#lowerdeltay}

Gets or sets the shape's vertical offset from its lower right corner row. The range of value is 0 to 256.

**Type:** Number

### Button.LowerRightColumn property {#lowerrightcolumn}

Represents lower right corner column index.

**Type:** Number

### Button.LowerDeltaX property {#lowerdeltax}

Gets or sets the shape's horizontal offset from its lower right corner column. The range of value is 0 to 1024.

**Type:** Number

### Button.Right property {#right}

Represents the width of the shape's horizontal offset from its lower right corner column, in unit of pixels.

**Type:** Number

### Button.Bottom property {#bottom}

Represents the width of the shape's vertical offset from its lower bottom corner row, in unit of pixels.

**Type:** Number

### Button.Width property {#width}

Represents the width of shape, in unit of pixels.

**Type:** Number

### Button.WidthInch property {#widthinch}

Represents the width of the shape, in unit of inch.

**Type:** Number

### Button.WidthPt property {#widthpt}

Represents the width of the shape, in unit of point.

**Type:** Number

### Button.WidthCM property {#widthcm}

Represents the width of the shape, in unit of centimeters.

**Type:** Number

### Button.Height property {#height}

Represents the height of shape, in unit of pixel.

**Type:** Number

### Button.HeightInch property {#heightinch}

Represents the height of the shape, in unit of inches.

**Type:** Number

### Button.HeightPt property {#heightpt}

Represents the height of the shape, in unit of points.

**Type:** Number

### Button.HeightCM property {#heightcm}

Represents the height of the shape, in unit of centimeters.

**Type:** Number

### Button.Left property {#left}

Represents the horizontal offset of shape from its left column, in unit of pixels.

**Type:** Number

### Button.LeftInch property {#leftinch}

Represents the horizontal offset of shape from its left column, in unit of inches.

**Type:** Number

### Button.LeftCM property {#leftcm}

Represents the horizontal offset of shape from its left column, in unit of centimeters.

**Type:** Number

### Button.Top property {#top}
...
### Button.TopInch property {#topinch}

Represents the vertical offset of shape from its top row, in unit of inches.

**Type:** Number

### Button.TopCM property {#topcm}

Represents the vertical offset of shape from its top row, in unit of centimeters.

**Type:** Number

### Button.TopToCorner property {#toptocorner}

Gets and sets the vertical offset of shape from worksheet top border, in unit of pixels.

**Type:** Number

### Button.LeftToCorner property {#lefttocorner}
...
### Button.WidthScale property {#widthscale}
...
### Button.HeightScale property {#heightscale}
...
### Button.TopInShape property {#topinshape}
...
### Button.LeftInShape property {#leftinshape}
...
### Button.WidthInShape property {#widthinshape}
...
### Button.HeightInShape property {#heightinshape}

Represents the vertical offset of shape from the top border of the parent shape, in unit of 1/4000 of height of the parent shape.. Only Applies when this shape in the group or chart.

**Type:** Number

### Button.Group property {#group}

Gets the group shape which contains this shape.

**Type:** GroupShape

### Button.Type property {#type}

Gets the auto shape type. The value of the property is AutoShapeType integer constant.

**Type:** Number

### Button.HasLine property {#hasline}

Gets and sets the line border of the shape is visible.

**Type:** boolean

### Button.IsFilled property {#isfilled}

Indicates whether the fill format is visible.

**Type:** boolean

### Button.IsFlippedHorizontally property {#isflippedhorizontally}

Gets and sets whether shape is horizontally flipped .

**Type:** boolean

### Button.IsFlippedVertically property {#isflippedvertically}

Gets and sets whether shape is vertically flipped .

**Type:** boolean

### Button.ActualLowerRightRow property {#actuallowerrightrow}

Get the actual bottom row.

**Type:** Number

### Button.RelativeToOriginalPictureSize property {#relativetooriginalpicturesize}

Indicates whether shape is relative to original picture size.

**Type:** boolean

### Button.LinkedCell property {#linkedcell}

Gets or sets the worksheet range linked to the control's value.

**Type:** String

### Button.InputRange property {#inputrange}

Gets or sets the worksheet range used to fill the specified combo box.

**Type:** String

### Button.TextShapeType property {#textshapetype}

Gets and sets the preset text shape type. The value of the property is AutoShapeType integer constant.

**Type:** Number

### Button.TextBody property {#textbody}
...
### Button.TextOptions property {#textoptions}
...
### Button.IsRichText property {#isrichtext}

Whether or not the text is rich text.

**Type:** boolean

### Button.HtmlText property {#htmltext}

Gets and sets the html string which contains data and some formats in this textbox.

**Type:** String

### Button.TextVerticalOverflow property {#textverticaloverflow}
...
### Button.TextHorizontalOverflow property {#texthorizontaloverflow}
...
### Button.IsTextWrapped property {#istextwrapped}

Gets and sets the text wrapped type of the shape which contains text.

**Type:** boolean

### Button.TextOrientationType property {#textorientationtype}

Gets and sets the text orientation type of the shape. The value of the property is TextOrientationType integer constant.

**Type:** Number

### Button.TextHorizontalAlignment property {#texthorizontalalignment}
...
### Button.TextVerticalAlignment property {#textverticalalignment}
...
### Button.TextDirection property {#textdirection}

Gets/Sets the direction of the text flow for this object. The value of the property is TextDirectionType integer constant.

**Type:** Number

### Button.TextBoxOptions property {#textboxoptions}

**Type:** TextBoxOptions

### Button.ControlData property {#controldata}

Gets the data of control.

**Type:** byte[]

### Button.Paths property {#paths}

Gets the paths of a custom geometric shape.

**Type:** ShapePathCollection

### Button.Geometry property {#geometry}

Gets the geometry

**Type:** Geometry

### Button.CreateId property {#createid}

Gets and sets create id for this shape.

**Type:** UUID

### Button.IsDecorative property {#isdecorative}
