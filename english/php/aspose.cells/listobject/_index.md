...
type: docs
weight: 3440
url: /cells/php/aspose.cells/listobject/
---
...
| --- | --- | --- |
| [StartRow](#startrow) | Number | Gets the start row of the range. |
| [StartColumn](#startcolumn) | Number | Gets the start column of the range. |
| [EndRow](#endrow) | Number | Gets the end row of the range. |
| [EndColumn](#endcolumn) | Number | Gets the end column of the range. |
...
| [DataSourceType](#datasourcetype) | Number | Gets the data source type of the table. The value of the property is TableDataSourceType integer constant. |
...
| [TableStyleType](#tablestyletype) | Number | Gets and the built-in table style. The value of the property is TableStyleType integer constant. |
