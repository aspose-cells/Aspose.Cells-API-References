...
| --- | --- | --- |
| [BarPosition](#barposition) | Number | This attribute specifies the position of the bar in the bar object The value of the property is EquationCharacterPositio |
...
### BarEquationNode.BarPosition property {#barposition}

This attribute specifies the position of the bar in the bar object The value of the property is EquationCharacterPositionType integer constant.

**Type:** Number

### BarEquationNode.ParentNode property {#parentnode}

Specifies the parent node of the current node

**Type:** EquationNode

### BarEquationNode.Type property {#type}

Represents the type of the node. The value of the property is TextNodeType integer constant.

**Type:** Number

### BarEquationNode.EquationType property {#equationtype}

Get the equation type of the current node The value of the property is EquationNodeType integer constant.

**Type:** Number

### BarEquationNode.StartIndex property {#startindex}

Gets the start index of the characters.

**Type:** Number

### BarEquationNode.Length property {#length}

Gets the length of the characters.

**Type:** Number

### BarEquationNode.Font property {#font}

Returns the font of this object.

**Type:** Font

### BarEquationNode.TextOptions property {#textoptions}
