...
| --- | --- | --- |
| [SortOrderType](#sortordertype) | Number | The value of the property is SortOrder integer constant. |
| [ShowMissing](#showmissing) | boolean |  |
| [ShowTypeOfItemsWithNoData](#showtypeofitemswithnodata) | Number | The value of the property is ItemsWithNoDataShowMode integer constant. |
...
| [StyleType](#styletype) | Number | Specify the type of Built-in slicer style the default type is SlicerStyleLight1 The value of the property is SlicerStyle |
...
| [FirstItemIndex](#firstitemindex) | Number |  |
...
| [ColumnWidthPixel](#columnwidthpixel) | Number | Gets or sets the width in unit of pixels for each column of the slicer. |
