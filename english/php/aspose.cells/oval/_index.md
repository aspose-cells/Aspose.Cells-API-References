...
type: docs
weight: 4130
url: /cells/php/aspose.cells/oval/
---
...
### Oval.MacroName property {#macroname}

Gets and sets the name of macro.

**Type:** String

### Oval.IsEquation property {#isequation}

Indicates whether the shape only contains an equation.

**Type:** boolean

### Oval.IsSmartArt property {#issmartart}

Indicates whether the shape is a smart art. Only for ooxml file.

**Type:** boolean

### Oval.ZOrderPosition property {#zorderposition}

Returns the position of a shape in the z-order.

**Type:** Number

### Oval.Name property {#name}

Gets and sets the name of the shape.

**Type:** String

### Oval.AlternativeText property {#alternativetext}

Returns or sets the descriptive (alternative) text string of the Shape object.

**Type:** String

### Oval.Title property {#title}

Specifies the title (caption) of the current shape object.

**Type:** String

### Oval.LineFormat property {#lineformat}
...
### Oval.FillFormat property {#fillformat}
...
### Oval.Glow property {#glow}

Represents a GlowEffect object that specifies glow effect for the chart element or shape.

**Type:** GlowEffect

### Oval.SoftEdges property {#softedges}

Gets and sets the radius of blur to apply to the edges, in unit of points.

**Type:** Number

### Oval.ThreeDFormat property {#threedformat}

Gets and sets 3d format of the shape.

**Type:** ThreeDFormat

### Oval.FormatPicture property {#formatpicture}

Gets and sets the options of the picture format.

**Type:** MsoFormatPicture

### Oval.IsHidden property {#ishidden}

Indicates whether the object is visible.

**Type:** boolean

### Oval.IsLockAspectRatio property {#islockaspectratio}
...
### Oval.IsAspectRatioLocked property {#isaspectratiolocked}

True means that aspect ratio of the shape is locked. Only for pictures and Ole Objects.

**Type:** boolean

### Oval.RotationAngle property {#rotationangle}

Gets and sets the rotation of the shape.

**Type:** Number

### Oval.Hyperlink property {#hyperlink}
...
### Oval.IsLocked property {#islocked}
...
### Oval.TopInch property {#topinch}

Represents the vertical offset of shape from its top row, in unit of inches.

**Type:** Number

### Oval.TopCM property {#topcm}

Represents the vertical offset of shape from its top row, in unit of centimeters.

**Type:** Number

### Oval.TopToCorner property {#toptocorner}

Gets and sets the vertical offset of shape from worksheet top border, in unit of pixels.

**Type:** Number

### Oval.LeftToCorner property {#lefttocorner}
...
### Oval.WidthScale property {#widthscale}
...
### Oval.HeightScale property {#heightscale}
...
### Oval.TopInShape property {#topinshape}
...
### Oval.LeftInShape property {#leftinshape}
...
### Oval.WidthInShape property {#widthinshape}
...
### Oval.HeightInShape property {#heightinshape}

Represents the vertical offset of shape from the top border of the parent shape, in unit of 1/4000 of height of the parent shape.. Only Applies when this shape in the group or chart.

**Type:** Number

### Oval.Group property {#group}

Gets the group shape which contains this shape.

**Type:** GroupShape

### Oval.Type property {#type}

Gets the auto shape type. The value of the property is AutoShapeType integer constant.

**Type:** Number

### Oval.HasLine property {#hasline}

Gets and sets the line border of the shape is visible.

**Type:** boolean

### Oval.IsFilled property {#isfilled}

Indicates whether the fill format is visible.

**Type:** boolean

### Oval.IsFlippedHorizontally property {#isflippedhorizontally}

Gets and sets whether shape is horizontally flipped .

**Type:** boolean

### Oval.IsFlippedVertically property {#isflippedvertically}

Gets and sets whether shape is vertically flipped .

**Type:** boolean

### Oval.ActualLowerRightRow property {#actuallowerrightrow}

Get the actual bottom row.

**Type:** Number

### Oval.RelativeToOriginalPictureSize property {#relativetooriginalpicturesize}

Indicates whether shape is relative to original picture size.

**Type:** boolean

### Oval.LinkedCell property {#linkedcell}

Gets or sets the worksheet range linked to the control's value.

**Type:** String

### Oval.InputRange property {#inputrange}

Gets or sets the worksheet range used to fill the specified combo box.

**Type:** String

### Oval.TextShapeType property {#textshapetype}

Gets and sets the preset text shape type. The value of the property is AutoShapeType integer constant.

**Type:** Number

### Oval.TextBody property {#textbody}

Gets and sets the setting of the shape's text.

**Type:** FontSettingCollection

### Oval.Font property {#font}

Represents the font of shape.

**Type:** Font

### Oval.TextOptions property {#textoptions}

Represents the text options of the shape.

**Type:** TextOptions

### Oval.Text property {#text}

Gets and sets the text of this shape.

**Type:** String

### Oval.IsRichText property {#isrichtext}

Whether or not the text is rich text.

**Type:** boolean

### Oval.HtmlText property {#htmltext}

Gets and sets the html string which contains data and some formats in this textbox.

**Type:** String

### Oval.TextVerticalOverflow property {#textverticaloverflow}
...
### Oval.TextHorizontalOverflow property {#texthorizontaloverflow}
...
### Oval.IsTextWrapped property {#istextwrapped}

Gets and sets the text wrapped type of the shape which contains text.

**Type:** boolean

### Oval.TextOrientationType property {#textorientationtype}

Gets and sets the text orientation type of the shape. The value of the property is TextOrientationType integer constant.

**Type:** Number

### Oval.TextHorizontalAlignment property {#texthorizontalalignment}
...
### Oval.TextVerticalAlignment property {#textverticalalignment}
...
### Oval.TextDirection property {#textdirection}

Gets/Sets the direction of the text flow for this object. The value of the property is TextDirectionType integer constant.

**Type:** Number

### Oval.TextBoxOptions property {#textboxoptions}

**Type:** TextBoxOptions

### Oval.ControlData property {#controldata}

Gets the data of control.

**Type:** byte[]

### Oval.Paths property {#paths}

Gets the paths of a custom geometric shape.

**Type:** ShapePathCollection

### Oval.Geometry property {#geometry}

Gets the geometry

**Type:** Geometry

### Oval.CreateId property {#createid}

Gets and sets create id for this shape.

**Type:** UUID

### Oval.IsDecorative property {#isdecorative}
