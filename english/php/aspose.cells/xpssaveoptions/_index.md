...
| [XpsSaveOptions](#constructor) | Creates options for saving xps file. NOTE: This constructor is now obsolete. Instead, please use XpsSaveOptions() constr |
...
### XpsSaveOptions() (1 of 2) {#constructor}

Creates options for saving xps file.

---

### XpsSaveOptions(saveFormat) (2 of 2) {#constructor-1}
...
| --- | --- | --- |
| saveFormat | Number | A SaveFormat value. The save format, it must be xps format. |

### XpsSaveOptions.DefaultFont property {#defaultfont}

When characters in the Excel are Unicode and not be set with correct font in cell style, They may appear as block in pdf,image. Set the DefaultFont such as MingLiu or MS Gothic to show these characters. If this property is not set, Aspose.Cells will use system default font to show these unicode characters.

**Type:** String

### XpsSaveOptions.CheckWorkbookDefaultFont property {#checkworkbookdefaultfont}
...
### XpsSaveOptions.CheckFontCompatibility property {#checkfontcompatibility}
...
### XpsSaveOptions.IsFontSubstitutionCharGranularity property {#isfontsubstitutionchargranularity}
...
### XpsSaveOptions.OnePagePerSheet property {#onepagepersheet}

If OnePagePerSheet is true , all content of one sheet will output to only one page in result. The paper size of pagesetup will be invalid, and the other settings of pagesetup will still take effect.

**Type:** boolean

### XpsSaveOptions.AllColumnsInOnePagePerSheet property {#allcolumnsinonepagepersheet}
...
### XpsSaveOptions.GridlineType property {#gridlinetype}

Gets or sets gridline type. The value of the property is GridlineType integer constant. Default is Dotted type.

**Type:** Number

### XpsSaveOptions.GridlineColor property {#gridlinecolor}

**Type:** Color

### XpsSaveOptions.TextCrossType property {#textcrosstype}
...
### XpsSaveOptions.DefaultEditLanguage property {#defaulteditlanguage}
...
### XpsSaveOptions.SheetSet property {#sheetset}

Gets or sets the sheets to render. Default is all visible sheets in the workbook: SheetSet.Visible .

**Type:** SheetSet

### XpsSaveOptions.DrawObjectEventHandler property {#drawobjecteventhandler}

Implements this interface to get DrawObject and Bound when rendering.

**Type:** DrawObjectEventHandler

### XpsSaveOptions.PageSavingCallback property {#pagesavingcallback}

Control/Indicate progress of page saving process.

**Type:** IPageSavingCallback

### XpsSaveOptions.EmfRenderSetting property {#emfrendersetting}
...
### XpsSaveOptions.CustomRenderSettings property {#customrendersettings}

**Type:** CustomRenderSettings

### XpsSaveOptions.SaveFormat property {#saveformat}

Gets the save file format. The value of the property is SaveFormat integer constant.

**Type:** Number

### XpsSaveOptions.ClearData property {#cleardata}

Make the workbook empty after saving the file.

**Type:** boolean

### XpsSaveOptions.CachedFileFolder property {#cachedfilefolder}

The cached file folder is used to store some large data.

**Type:** String

### XpsSaveOptions.ValidateMergedAreas property {#validatemergedareas}

Indicates whether validate merged cells before saving the file. The default value is false.

**Type:** boolean

### XpsSaveOptions.MergeAreas property {#mergeareas}

Indicates whether merge the areas of conditional formatting and validation before saving the file. The default value is false.

**Type:** boolean

### XpsSaveOptions.CreateDirectory property {#createdirectory}

If true and the directory does not exist, the directory will be automatically created before saving the file. The default value is false.

**Type:** boolean

### XpsSaveOptions.SortNames property {#sortnames}

Indicates whether sorting defined names before saving file.

**Type:** boolean

### XpsSaveOptions.SortExternalNames property {#sortexternalnames}

Indicates whether sorting external defined names before saving file.

**Type:** boolean

### XpsSaveOptions.RefreshChartCache property {#refreshchartcache}

Indicates whether refreshing chart cache data

**Type:** boolean

### XpsSaveOptions.CheckExcelRestriction property {#checkexcelrestriction}

**Type:** boolean

### XpsSaveOptions.UpdateSmartArt property {#updatesmartart}

Indicates whether updating smart art setting. The default value is false. Only effects after calling Shape.GetResultOfSmartArt() method and the cached shapes exist in the template file.

**Type:** boolean

### XpsSaveOptions.EncryptDocumentProperties property {#encryptdocumentproperties}
