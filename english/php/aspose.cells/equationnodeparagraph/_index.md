...
| --- | --- | --- |
| [Justification](#justification) | Number | This specifies justification of the math paragraph (a series of adjacent equations within the same paragraph). A math pa |
...
### EquationNodeParagraph.Justification property {#justification}
...
### EquationNodeParagraph.ParentNode property {#parentnode}

Specifies the parent node of the current node

**Type:** EquationNode

### EquationNodeParagraph.Type property {#type}

Represents the type of the node. The value of the property is TextNodeType integer constant.

**Type:** Number

### EquationNodeParagraph.EquationType property {#equationtype}

Get the equation type of the current node The value of the property is EquationNodeType integer constant.

**Type:** Number

### EquationNodeParagraph.StartIndex property {#startindex}

Gets the start index of the characters.

**Type:** Number

### EquationNodeParagraph.Length property {#length}

Gets the length of the characters.

**Type:** Number

### EquationNodeParagraph.Font property {#font}

Returns the font of this object.

**Type:** Font

### EquationNodeParagraph.TextOptions property {#textoptions}
