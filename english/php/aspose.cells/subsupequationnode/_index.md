...
articleTitle: "SubSupEquationNode"
...
### SubSupEquationNode.ParentNode property {#parentnode}

Specifies the parent node of the current node

**Type:** EquationNode

### SubSupEquationNode.Type property {#type}

Represents the type of the node. The value of the property is TextNodeType integer constant.

**Type:** Number

### SubSupEquationNode.EquationType property {#equationtype}

Get the equation type of the current node The value of the property is EquationNodeType integer constant.

**Type:** Number

### SubSupEquationNode.StartIndex property {#startindex}

Gets the start index of the characters.

**Type:** Number

### SubSupEquationNode.Length property {#length}

Gets the length of the characters.

**Type:** Number

### SubSupEquationNode.Font property {#font}

Returns the font of this object.

**Type:** Font

### SubSupEquationNode.TextOptions property {#textoptions}
