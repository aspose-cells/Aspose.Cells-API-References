...
| [RowCount](#rowcount) | Number | Gets the count of rows in the range. |
| [ColumnCount](#columncount) | Number | Gets the count of columns in the range. |
...
| [Left](#left) | Number | Gets the distance, in points, from the left edge of column A to the left edge of the range. |
| [Top](#top) | Number | Gets the distance, in points, from the top edge of row 1 to the top edge of the range. |
| [Width](#width) | Number | Gets the width of a range in points. |
| [Height](#height) | Number | Gets the width of a range in points. |
| [FirstRow](#firstrow) | Number | Gets the index of the first row of the range. |
| [FirstColumn](#firstcolumn) | Number | Gets the index of the first column of the range. |
