...
articleTitle: "MatrixEquationNode"
...
| --- | --- | --- |
| [BaseJc](#basejc) | Number | This attribute specifies the justification of the matrix. Text outside of the matrix can be aligned with the bottom, top |
| [IsHidePlaceholder](#ishideplaceholder) | boolean | This attribute specifies the Hide Placeholders property on a matrix. When this property is on, placeholders do not appea |
...
### MatrixEquationNode.BaseJc property {#basejc}
...
### MatrixEquationNode.IsHidePlaceholder property {#ishideplaceholder}
...
### MatrixEquationNode.ParentNode property {#parentnode}

Specifies the parent node of the current node

**Type:** EquationNode

### MatrixEquationNode.Type property {#type}

Represents the type of the node. The value of the property is TextNodeType integer constant.

**Type:** Number

### MatrixEquationNode.EquationType property {#equationtype}

Get the equation type of the current node The value of the property is EquationNodeType integer constant.

**Type:** Number

### MatrixEquationNode.StartIndex property {#startindex}

Gets the start index of the characters.

**Type:** Number

### MatrixEquationNode.Length property {#length}

Gets the length of the characters.

**Type:** Number

### MatrixEquationNode.Font property {#font}

Returns the font of this object.

**Type:** Font

### MatrixEquationNode.TextOptions property {#textoptions}
