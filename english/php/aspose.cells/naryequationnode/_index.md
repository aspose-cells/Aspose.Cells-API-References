...
| [LimitLocation](#limitlocation) | Number | This attribute specifies the location of limits in n-ary operators. Limits can be either centered above and below the n- |
...
| [NaryOperatorType](#naryoperatortype) | Number | an n-ary operator.e.g "∑" The value of the property is EquationMathematicalOperatorType integer constant. |
