---
title: "SlicerShape Class"
linktitle: "SlicerShape"
articleTitle: "SlicerShape"
second_title: "Aspose.Cells for PHP via Java"
description: "Represents the slicer shape."
type: docs
weight: 6130
url: /cells/php/aspose.cells/slicershape/
---
...
### SlicerShape.MacroName property {#macroname}

Gets and sets the name of macro.

**Type:** String

### SlicerShape.IsEquation property {#isequation}

Indicates whether the shape only contains an equation.

**Type:** boolean

### SlicerShape.IsSmartArt property {#issmartart}

Indicates whether the shape is a smart art. Only for ooxml file.

**Type:** boolean

### SlicerShape.ZOrderPosition property {#zorderposition}

Returns the position of a shape in the z-order.

**Type:** Number

### SlicerShape.Name property {#name}

Gets and sets the name of the shape.

**Type:** String

### SlicerShape.AlternativeText property {#alternativetext}

Returns or sets the descriptive (alternative) text string of the Shape object.

**Type:** String

### SlicerShape.Title property {#title}

Specifies the title (caption) of the current shape object.

**Type:** String

### SlicerShape.LineFormat property {#lineformat}
...
### SlicerShape.FillFormat property {#fillformat}
...
### SlicerShape.Glow property {#glow}

Represents a GlowEffect object that specifies glow effect for the chart element or shape.

**Type:** GlowEffect

### SlicerShape.SoftEdges property {#softedges}

Gets and sets the radius of blur to apply to the edges, in unit of points.

**Type:** Number

### SlicerShape.ThreeDFormat property {#threedformat}

Gets and sets 3d format of the shape.

**Type:** ThreeDFormat

### SlicerShape.FormatPicture property {#formatpicture}

Gets and sets the options of the picture format.

**Type:** MsoFormatPicture

### SlicerShape.IsHidden property {#ishidden}

Indicates whether the object is visible.

**Type:** boolean

### SlicerShape.IsLockAspectRatio property {#islockaspectratio}
...
### SlicerShape.IsAspectRatioLocked property {#isaspectratiolocked}

True means that aspect ratio of the shape is locked. Only for pictures and Ole Objects.

**Type:** boolean

### SlicerShape.RotationAngle property {#rotationangle}

Gets and sets the rotation of the shape.

**Type:** Number

### SlicerShape.Hyperlink property {#hyperlink}

Gets the hyperlink of the shape.

**Type:** Hyperlink

### SlicerShape.Id property {#id}

Gets the identifier of this shape.

**Type:** Number

### SlicerShape.Spid property {#spid}

Specifies an optional string identifier that an application can use to identify the particular shape.

**Type:** String

### SlicerShape.Spt property {#spt}

Specifies an optional number that an application can use to associate the particular shape with a defined shape type.

**Type:** Number

### SlicerShape.Worksheet property {#worksheet}

Gets the Worksheet object which contains this shape.

**Type:** Worksheet

### SlicerShape.IsGroup property {#isgroup}

Indicates whether this shape is a group shape.

**Type:** boolean

### SlicerShape.IsInGroup property {#isingroup}

Indicates whether the shape is grouped.

**Type:** boolean

### SlicerShape.IsWordArt property {#iswordart}

Indicates whether this shape is a word art. Only for the Legacy Shape of xls file.

**Type:** boolean

### SlicerShape.TextEffect property {#texteffect}
...
### SlicerShape.IsLocked property {#islocked}
...
### SlicerShape.UpperLeftRow property {#upperleftrow}

Represents the top row index. If the shape is in the shape or in the group , UpperLeftRow will be ignored.

**Type:** Number

### SlicerShape.UpperDeltaY property {#upperdeltay}

Gets or sets the shape's vertical offset from its upper left corner row. The range of value is 0 to 256.

**Type:** Number

### SlicerShape.UpperLeftColumn property {#upperleftcolumn}

Represents upper left corner column index.

**Type:** Number

### SlicerShape.UpperDeltaX property {#upperdeltax}

Gets or sets the shape's horizontal offset from its upper left corner column. The range of value is 0 to 1024.

**Type:** Number

### SlicerShape.LowerRightRow property {#lowerrightrow}

Represents lower right corner row index.

**Type:** Number

### SlicerShape.LowerDeltaY property {#lowerdeltay}

Gets or sets the shape's vertical offset from its lower right corner row. The range of value is 0 to 256.

**Type:** Number

### SlicerShape.LowerRightColumn property {#lowerrightcolumn}

Represents lower right corner column index.

**Type:** Number

### SlicerShape.LowerDeltaX property {#lowerdeltax}

Gets or sets the shape's horizontal offset from its lower right corner column. The range of value is 0 to 1024.

**Type:** Number

### SlicerShape.Right property {#right}

Represents the width of the shape's horizontal offset from its lower right corner column, in unit of pixels.

**Type:** Number

### SlicerShape.Bottom property {#bottom}

Represents the width of the shape's vertical offset from its lower bottom corner row, in unit of pixels.

**Type:** Number

### SlicerShape.Width property {#width}

Represents the width of shape, in unit of pixels.

**Type:** Number

### SlicerShape.WidthInch property {#widthinch}

Represents the width of the shape, in unit of inch.

**Type:** Number

### SlicerShape.WidthPt property {#widthpt}

Represents the width of the shape, in unit of point.

**Type:** Number

### SlicerShape.WidthCM property {#widthcm}

Represents the width of the shape, in unit of centimeters.

**Type:** Number

### SlicerShape.Height property {#height}

Represents the height of shape, in unit of pixel.

**Type:** Number

### SlicerShape.HeightInch property {#heightinch}

Represents the height of the shape, in unit of inches.

**Type:** Number

### SlicerShape.HeightPt property {#heightpt}

Represents the height of the shape, in unit of points.

**Type:** Number

### SlicerShape.HeightCM property {#heightcm}

Represents the height of the shape, in unit of centimeters.

**Type:** Number

### SlicerShape.Left property {#left}

Represents the horizontal offset of shape from its left column, in unit of pixels.

**Type:** Number

### SlicerShape.LeftInch property {#leftinch}

Represents the horizontal offset of shape from its left column, in unit of inches.

**Type:** Number

### SlicerShape.LeftCM property {#leftcm}

Represents the horizontal offset of shape from its left column, in unit of centimeters.

**Type:** Number

### SlicerShape.Top property {#top}
...
### SlicerShape.TopInch property {#topinch}

Represents the vertical offset of shape from its top row, in unit of inches.

**Type:** Number

### SlicerShape.TopCM property {#topcm}

Represents the vertical offset of shape from its top row, in unit of centimeters.

**Type:** Number

### SlicerShape.TopToCorner property {#toptocorner}

Gets and sets the vertical offset of shape from worksheet top border, in unit of pixels.

**Type:** Number

### SlicerShape.LeftToCorner property {#lefttocorner}

Gets and sets the horizonal offset of shape from worksheet left border.

**Type:** Number

### SlicerShape.X property {#x}

Gets and sets the horizontal offset of shape from worksheet left border,in unit of pixels.

**Type:** Number

### SlicerShape.Y property {#y}

Gets and sets the vertical offset of shape from worksheet top border,in unit of pixels.

**Type:** Number

### SlicerShape.WidthScale property {#widthscale}
...
### SlicerShape.HeightScale property {#heightscale}
...
### SlicerShape.TopInShape property {#topinshape}
...
### SlicerShape.LeftInShape property {#leftinshape}
...
### SlicerShape.WidthInShape property {#widthinshape}
...
### SlicerShape.HeightInShape property {#heightinshape}

Represents the vertical offset of shape from the top border of the parent shape, in unit of 1/4000 of height of the parent shape.. Only Applies when this shape in the group or chart.

**Type:** Number

### SlicerShape.Group property {#group}

Gets the group shape which contains this shape.

**Type:** GroupShape

### SlicerShape.Type property {#type}

Gets the auto shape type. The value of the property is AutoShapeType integer constant.

**Type:** Number

### SlicerShape.HasLine property {#hasline}

Gets and sets the line border of the shape is visible.

**Type:** boolean

### SlicerShape.IsFilled property {#isfilled}

Indicates whether the fill format is visible.

**Type:** boolean

### SlicerShape.IsFlippedHorizontally property {#isflippedhorizontally}

Gets and sets whether shape is horizontally flipped .

**Type:** boolean

### SlicerShape.IsFlippedVertically property {#isflippedvertically}

Gets and sets whether shape is vertically flipped .

**Type:** boolean

### SlicerShape.ActualLowerRightRow property {#actuallowerrightrow}

Get the actual bottom row.

**Type:** Number

### SlicerShape.RelativeToOriginalPictureSize property {#relativetooriginalpicturesize}

Indicates whether shape is relative to original picture size.

**Type:** boolean

### SlicerShape.LinkedCell property {#linkedcell}

Gets or sets the worksheet range linked to the control's value.

**Type:** String

### SlicerShape.InputRange property {#inputrange}

Gets or sets the worksheet range used to fill the specified combo box.

**Type:** String

### SlicerShape.TextShapeType property {#textshapetype}

Gets and sets the preset text shape type. The value of the property is AutoShapeType integer constant.

**Type:** Number

### SlicerShape.TextBody property {#textbody}

Gets and sets the setting of the shape's text.

**Type:** FontSettingCollection

### SlicerShape.Font property {#font}

Represents the font of shape.

**Type:** Font

### SlicerShape.TextOptions property {#textoptions}

Represents the text options of the shape.

**Type:** TextOptions

### SlicerShape.Text property {#text}

Gets and sets the text of this shape.

**Type:** String

### SlicerShape.IsRichText property {#isrichtext}

Whether or not the text is rich text.

**Type:** boolean

### SlicerShape.HtmlText property {#htmltext}

Gets and sets the html string which contains data and some formats in this textbox.

**Type:** String

### SlicerShape.TextVerticalOverflow property {#textverticaloverflow}
...
### SlicerShape.TextHorizontalOverflow property {#texthorizontaloverflow}
...
### SlicerShape.IsTextWrapped property {#istextwrapped}

Gets and sets the text wrapped type of the shape which contains text.

**Type:** boolean

### SlicerShape.TextOrientationType property {#textorientationtype}

Gets and sets the text orientation type of the shape. The value of the property is TextOrientationType integer constant.

**Type:** Number

### SlicerShape.TextHorizontalAlignment property {#texthorizontalalignment}
...
### SlicerShape.TextVerticalAlignment property {#textverticalalignment}
...
### SlicerShape.TextDirection property {#textdirection}

Gets/Sets the direction of the text flow for this object. The value of the property is TextDirectionType integer constant.

**Type:** Number

### SlicerShape.TextBoxOptions property {#textboxoptions}

**Type:** TextBoxOptions

### SlicerShape.ControlData property {#controldata}

Gets the data of control.

**Type:** byte[]

### SlicerShape.ActiveXControl property {#activexcontrol}

Gets the ActiveX control.

**Type:** ActiveXControl

### SlicerShape.Paths property {#paths}

Gets the paths of a custom geometric shape.

**Type:** ShapePathCollection

### SlicerShape.Geometry property {#geometry}

Gets the geometry

**Type:** Geometry

### SlicerShape.CreateId property {#createid}

Gets and sets create id for this shape.

**Type:** UUID

### SlicerShape.IsDecorative property {#isdecorative}
