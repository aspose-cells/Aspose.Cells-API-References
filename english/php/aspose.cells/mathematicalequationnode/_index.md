...
articleTitle: "MathematicalEquationNode"
second_title: "Aspose.Cells for PHP via Java"
description: "This class specifies an equation or mathematical expression."
type: docs
weight: 3590
url: /cells/php/aspose.cells/mathematicalequationnode/
---
...
### MathematicalEquationNode.ParentNode property {#parentnode}

Specifies the parent node of the current node

**Type:** EquationNode

### MathematicalEquationNode.Type property {#type}

Represents the type of the node. The value of the property is TextNodeType integer constant.

**Type:** Number

### MathematicalEquationNode.EquationType property {#equationtype}

Get the equation type of the current node The value of the property is EquationNodeType integer constant.

**Type:** Number

### MathematicalEquationNode.StartIndex property {#startindex}

Gets the start index of the characters.

**Type:** Number

### MathematicalEquationNode.Length property {#length}

Gets the length of the characters.

**Type:** Number

### MathematicalEquationNode.Font property {#font}

Returns the font of this object.

**Type:** Font

### MathematicalEquationNode.TextOptions property {#textoptions}
