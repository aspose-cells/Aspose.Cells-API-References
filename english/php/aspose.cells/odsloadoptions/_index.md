...
articleTitle: "OdsLoadOptions"
second_title: "Aspose.Cells for PHP via Java"
description: "Represents the options of loading ods file."
type: docs
weight: 3980
url: /cells/php/aspose.cells/odsloadoptions/
---
...
| --- | --- | --- |
| [ApplyExcelDefaultStyleToHyperlink](#applyexceldefaultstyletohyperlink) | boolean | Indicates whether applying the default style of the Excel to hyperlink. |
| [RefreshPivotTables](#refreshpivottables) | boolean | Indicates whether refresh pivot tables when loading file. |
| [IsClassicPivotTable](#isclassicpivottable) | boolean |  |
...
### OdsLoadOptions() (1 of 2) {#constructor}

Represents the options of loading ods file.

---

### OdsLoadOptions(type) (2 of 2) {#constructor-1}

Represents the options of loading ods file.

| Parameter | Type | Description |
| --- | --- | --- |
| type | Number | A LoadFormat value. The load format type. |

### OdsLoadOptions.ApplyExcelDefaultStyleToHyperlink property {#applyexceldefaultstyletohyperlink}

Indicates whether applying the default style of the Excel to hyperlink.

**Type:** boolean

### OdsLoadOptions.RefreshPivotTables property {#refreshpivottables}

Indicates whether refresh pivot tables when loading file.

**Type:** boolean

### OdsLoadOptions.IsClassicPivotTable property {#isclassicpivottable}

**Type:** boolean

### OdsLoadOptions.LoadFormat property {#loadformat}

Gets the load format. The value of the property is LoadFormat integer constant.

**Type:** Number

### OdsLoadOptions.Password property {#password}

Gets and set the password of the workbook.

**Type:** String

### OdsLoadOptions.ParsingFormulaOnOpen property {#parsingformulaonopen}
...
### OdsLoadOptions.ParsingPivotCachedRecords property {#parsingpivotcachedrecords}
...
### OdsLoadOptions.LanguageCode property {#languagecode}
...
### OdsLoadOptions.Region property {#region}
...
### OdsLoadOptions.Locale property {#locale}

Gets and sets the Locale used for workbook at the time the file was loaded.

**Type:** Locale

### OdsLoadOptions.DefaultStyleSettings property {#defaultstylesettings}

Gets the default style settings for initializing styles of the workbook

**Type:** DefaultStyleSettings

### OdsLoadOptions.StandardFont property {#standardfont}
...
### OdsLoadOptions.StandardFontSize property {#standardfontsize}
...
### OdsLoadOptions.InterruptMonitor property {#interruptmonitor}

Gets and sets the interrupt monitor.

**Type:** AbstractInterruptMonitor

### OdsLoadOptions.IgnoreNotPrinted property {#ignorenotprinted}

Ignore the data which are not printed if directly printing the file Only for xlsx file.

**Type:** boolean

### OdsLoadOptions.CheckDataValid property {#checkdatavalid}

Check whether data is valid in the template file.

**Type:** boolean

### OdsLoadOptions.CheckExcelRestriction property {#checkexcelrestriction}
...
### OdsLoadOptions.KeepUnparsedData property {#keepunparseddata}
...
### OdsLoadOptions.LoadFilter property {#loadfilter}

The filter to denote how to load data.

**Type:** LoadFilter

### OdsLoadOptions.LightCellsDataHandler property {#lightcellsdatahandler}

The data handler for processing cells data when reading template file.

**Type:** LightCellsDataHandler

### OdsLoadOptions.MemorySetting property {#memorysetting}

Gets or sets the memory usage options. The value of the property is MemorySetting integer constant.

**Type:** Number

### OdsLoadOptions.WarningCallback property {#warningcallback}

Gets or sets warning callback.

**Type:** IWarningCallback

### OdsLoadOptions.AutoFitterOptions property {#autofitteroptions}

Gets and sets the auto fitter options Only for xlsx ,spreadsheetML file now.

**Type:** AutoFitterOptions

### OdsLoadOptions.AutoFilter property {#autofilter}
...
### OdsLoadOptions.FontConfigs property {#fontconfigs}
...
### OdsLoadOptions.IgnoreUselessShapes property {#ignoreuselessshapes}
...
### OdsLoadOptions.PreservePaddingSpacesInFormula property {#preservepaddingspacesinformula}
