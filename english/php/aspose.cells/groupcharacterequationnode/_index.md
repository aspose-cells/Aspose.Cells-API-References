...
articleTitle: "GroupCharacterEquationNode"
...
| --- | --- | --- |
| [GroupChr](#groupchr) | String | Specifies a symbol(default U+23DF). It is strongly recommended to use attribute ChrType to set accent character. Use thi |
| [ChrType](#chrtype) | Number | Specify combining characters by type value. The value of the property is EquationCombiningCharacterType integer constant |
| [Position](#position) | Number | This attribute specifies the position of the character in the object The value of the property is EquationCharacterPosit |
| [VertJc](#vertjc) | Number | This attribute, combined with pos of groupChrPr, specifies the vertical layout of the groupChr object. Where pos specifi |
...
### GroupCharacterEquationNode.GroupChr property {#groupchr}
...
### GroupCharacterEquationNode.VertJc property {#vertjc}
...
### GroupCharacterEquationNode.ParentNode property {#parentnode}

Specifies the parent node of the current node

**Type:** EquationNode

### GroupCharacterEquationNode.Type property {#type}

Represents the type of the node. The value of the property is TextNodeType integer constant.

**Type:** Number

### GroupCharacterEquationNode.EquationType property {#equationtype}

Get the equation type of the current node The value of the property is EquationNodeType integer constant.

**Type:** Number

### GroupCharacterEquationNode.StartIndex property {#startindex}

Gets the start index of the characters.

**Type:** Number

### GroupCharacterEquationNode.Length property {#length}

Gets the length of the characters.

**Type:** Number

### GroupCharacterEquationNode.Font property {#font}

Returns the font of this object.

**Type:** Font

### GroupCharacterEquationNode.TextOptions property {#textoptions}
