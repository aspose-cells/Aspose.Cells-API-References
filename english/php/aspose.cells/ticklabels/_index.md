...
type: docs
weight: 6960
url: /cells/php/aspose.cells/ticklabels/
---
...
| [RotationAngle](#rotationangle) | Number | Represents text rotation angle in clockwise. 0: Not rotated. 255: Top to Bottom. -90: Downward. 90: Upward. |
...
| [Offset](#offset) | Number | Gets and sets the distance between the axis labels and the axis line. The default distance is 100 percent, which represe |
...
| [AlignmentType](#alignmenttype) | Number | Gets and sets the text alignment for the tick labels on the axis. The value of the property is TickLabelAlignmentType in |
