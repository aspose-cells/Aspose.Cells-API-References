---
title: "UnknowEquationNode Class"
linktitle: "UnknowEquationNode"
articleTitle: "UnknowEquationNode"
second_title: "Aspose.Cells for PHP via Java"
description: "Equation node class of unknown type"
type: docs
weight: 7200
url: /cells/php/aspose.cells/unknowequationnode/
---
...
### UnknowEquationNode.ParentNode property {#parentnode}

Specifies the parent node of the current node

**Type:** EquationNode

### UnknowEquationNode.Type property {#type}

Represents the type of the node. The value of the property is TextNodeType integer constant.

**Type:** Number

### UnknowEquationNode.EquationType property {#equationtype}

Get the equation type of the current node The value of the property is EquationNodeType integer constant.

**Type:** Number

### UnknowEquationNode.StartIndex property {#startindex}

Gets the start index of the characters.

**Type:** Number

### UnknowEquationNode.Length property {#length}

Gets the length of the characters.

**Type:** Number

### UnknowEquationNode.Font property {#font}

Returns the font of this object.

**Type:** Font

### UnknowEquationNode.TextOptions property {#textoptions}
