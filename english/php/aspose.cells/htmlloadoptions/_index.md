...
type: docs
weight: 2930
url: /cells/php/aspose.cells/htmlloadoptions/
---
...
| [ParagrahLayoutMode](#paragrahlayoutmode) | Number | The value of the property is HtmlParagraphLayoutMode integer constant. |
| [HyperlinkLoadMode](#hyperlinkloadmode) | Number | The value of the property is HyperlinkLoadMode integer constant. |
...
### HtmlLoadOptions() (1 of 2) {#constructor}

Creates an options of loading the file.

---

### HtmlLoadOptions(loadFormat) (2 of 2) {#constructor-1}
...
### HtmlLoadOptions.AttachedFilesDirectory property {#attachedfilesdirectory}
...
### HtmlLoadOptions.HasFormula property {#hasformula}

Indicates whether the text is formula if it starts with "=".

**Type:** boolean

### HtmlLoadOptions.ProgId property {#progid}

Gets the program id of creating the file. Only for MHT files.

**Type:** String

### HtmlLoadOptions.TableLoadOptions property {#tableloadoptions}

Get the HtmlTableLoadOptionCollection instance

**Type:** HtmlTableLoadOptionCollection

### HtmlLoadOptions.DetectLaTeX property {#detectlatex}

**Type:** boolean

### HtmlLoadOptions.ParagrahLayoutMode property {#paragrahlayoutmode}

The value of the property is HtmlParagraphLayoutMode integer constant.

**Type:** Number

### HtmlLoadOptions.HyperlinkLoadMode property {#hyperlinkloadmode}

The value of the property is HyperlinkLoadMode integer constant.

**Type:** Number

### HtmlLoadOptions.Encoding property {#encoding}

Gets and sets the default encoding. Only applies for csv file.

**Type:** Encoding

### HtmlLoadOptions.LoadStyleStrategy property {#loadstylestrategy}
...
### HtmlLoadOptions.ConvertNumericData property {#convertnumericdata}

Gets or sets a value that indicates whether the string in text file is converted to numeric data.

**Type:** boolean

### HtmlLoadOptions.ConvertDateTimeData property {#convertdatetimedata}

Gets or sets a value that indicates whether the string in text file is converted to date data.

**Type:** boolean

### HtmlLoadOptions.KeepPrecision property {#keepprecision}

Indicates whether not parsing a string value if the length is 15.

**Type:** boolean

### HtmlLoadOptions.LoadFormat property {#loadformat}

Gets the load format. The value of the property is LoadFormat integer constant.

**Type:** Number

### HtmlLoadOptions.Password property {#password}

Gets and set the password of the workbook.

**Type:** String

### HtmlLoadOptions.ParsingFormulaOnOpen property {#parsingformulaonopen}
...
### HtmlLoadOptions.ParsingPivotCachedRecords property {#parsingpivotcachedrecords}
...
### HtmlLoadOptions.LanguageCode property {#languagecode}
...
### HtmlLoadOptions.Region property {#region}
...
### HtmlLoadOptions.Locale property {#locale}

Gets and sets the Locale used for workbook at the time the file was loaded.

**Type:** Locale

### HtmlLoadOptions.DefaultStyleSettings property {#defaultstylesettings}

Gets the default style settings for initializing styles of the workbook

**Type:** DefaultStyleSettings

### HtmlLoadOptions.StandardFont property {#standardfont}
...
### HtmlLoadOptions.StandardFontSize property {#standardfontsize}
...
### HtmlLoadOptions.InterruptMonitor property {#interruptmonitor}

Gets and sets the interrupt monitor.

**Type:** AbstractInterruptMonitor

### HtmlLoadOptions.IgnoreNotPrinted property {#ignorenotprinted}

Ignore the data which are not printed if directly printing the file Only for xlsx file.

**Type:** boolean

### HtmlLoadOptions.CheckDataValid property {#checkdatavalid}

Check whether data is valid in the template file.

**Type:** boolean

### HtmlLoadOptions.CheckExcelRestriction property {#checkexcelrestriction}
...
### HtmlLoadOptions.KeepUnparsedData property {#keepunparseddata}
...
### HtmlLoadOptions.LoadFilter property {#loadfilter}

The filter to denote how to load data.

**Type:** LoadFilter

### HtmlLoadOptions.LightCellsDataHandler property {#lightcellsdatahandler}

The data handler for processing cells data when reading template file.

**Type:** LightCellsDataHandler

### HtmlLoadOptions.MemorySetting property {#memorysetting}

Gets or sets the memory usage options. The value of the property is MemorySetting integer constant.

**Type:** Number

### HtmlLoadOptions.WarningCallback property {#warningcallback}

Gets or sets warning callback.

**Type:** IWarningCallback

### HtmlLoadOptions.AutoFitterOptions property {#autofitteroptions}

Gets and sets the auto fitter options Only for xlsx ,spreadsheetML file now.

**Type:** AutoFitterOptions

### HtmlLoadOptions.AutoFilter property {#autofilter}
...
### HtmlLoadOptions.FontConfigs property {#fontconfigs}
...
### HtmlLoadOptions.IgnoreUselessShapes property {#ignoreuselessshapes}
...
### HtmlLoadOptions.PreservePaddingSpacesInFormula property {#preservepaddingspacesinformula}
