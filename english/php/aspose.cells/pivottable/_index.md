...
type: docs
weight: 4820
url: /cells/php/aspose.cells/pivottable/
---
...
| [PivotTableStyleType](#pivottablestyletype) | Number | Gets and sets the built-in pivot table style. The value of the property is PivotTableStyleType integer constant. |
...
| [AutoFormatType](#autoformattype) | Number | Gets and sets the auto format type of PivotTable. The value of the property is PivotTableAutoFormatType integer constant |
...
| [MissingItemsLimit](#missingitemslimit) | Number | Specifies a boolean value that indicates whether the fields of a PivotTable can have multiple filters set on them. The v |
...
| [PageFieldOrder](#pagefieldorder) | Number | Gets the order in which page fields are added to the PivotTable report's layout. The value of the property is PrintOrder |
