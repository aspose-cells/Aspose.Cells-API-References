...
| --- | --- | --- |
| [SaveAsEditableShaps](#saveaseditableshaps) | boolean |  |
...
| [SaveElementType](#saveelementtype) | Number | The value of the property is SaveElementType integer constant. |
| [AsNormalView](#asnormalview) | boolean |  |
...
### DocxSaveOptions() (1 of 2) {#constructor}

Represents options of saving .docx file.

---

### DocxSaveOptions(saveAsImage) (2 of 2) {#constructor-1}
...
### DocxSaveOptions.SaveAsEditableShaps property {#saveaseditableshaps}

**Type:** boolean

### DocxSaveOptions.SaveAsEditableShapes property {#saveaseditableshapes}

**Type:** boolean

### DocxSaveOptions.EmbedXlsxAsChartDataSource property {#embedxlsxaschartdatasource}

**Type:** boolean

### DocxSaveOptions.AsFlatOpc property {#asflatopc}

**Type:** boolean

### DocxSaveOptions.SaveElementType property {#saveelementtype}

The value of the property is SaveElementType integer constant.

**Type:** Number

### DocxSaveOptions.AsNormalView property {#asnormalview}

**Type:** boolean

### DocxSaveOptions.DefaultFont property {#defaultfont}

When characters in the Excel are Unicode and not be set with correct font in cell style, They may appear as block in pdf,image. Set the DefaultFont such as MingLiu or MS Gothic to show these characters. If this property is not set, Aspose.Cells will use system default font to show these unicode characters.

**Type:** String

### DocxSaveOptions.CheckWorkbookDefaultFont property {#checkworkbookdefaultfont}
...
### DocxSaveOptions.CheckFontCompatibility property {#checkfontcompatibility}
...
### DocxSaveOptions.IsFontSubstitutionCharGranularity property {#isfontsubstitutionchargranularity}
...
### DocxSaveOptions.OnePagePerSheet property {#onepagepersheet}

If OnePagePerSheet is true , all content of one sheet will output to only one page in result. The paper size of pagesetup will be invalid, and the other settings of pagesetup will still take effect.

**Type:** boolean

### DocxSaveOptions.AllColumnsInOnePagePerSheet property {#allcolumnsinonepagepersheet}
...
### DocxSaveOptions.GridlineType property {#gridlinetype}

Gets or sets gridline type. The value of the property is GridlineType integer constant. Default is Dotted type.

**Type:** Number

### DocxSaveOptions.GridlineColor property {#gridlinecolor}

**Type:** Color

### DocxSaveOptions.TextCrossType property {#textcrosstype}
...
### DocxSaveOptions.DefaultEditLanguage property {#defaulteditlanguage}
...
### DocxSaveOptions.SheetSet property {#sheetset}

Gets or sets the sheets to render. Default is all visible sheets in the workbook: SheetSet.Visible .

**Type:** SheetSet

### DocxSaveOptions.DrawObjectEventHandler property {#drawobjecteventhandler}

Implements this interface to get DrawObject and Bound when rendering.

**Type:** DrawObjectEventHandler

### DocxSaveOptions.PageSavingCallback property {#pagesavingcallback}

Control/Indicate progress of page saving process.

**Type:** IPageSavingCallback

### DocxSaveOptions.EmfRenderSetting property {#emfrendersetting}
...
### DocxSaveOptions.CustomRenderSettings property {#customrendersettings}

**Type:** CustomRenderSettings

### DocxSaveOptions.SaveFormat property {#saveformat}

Gets the save file format. The value of the property is SaveFormat integer constant.

**Type:** Number

### DocxSaveOptions.ClearData property {#cleardata}

Make the workbook empty after saving the file.

**Type:** boolean

### DocxSaveOptions.CachedFileFolder property {#cachedfilefolder}

The cached file folder is used to store some large data.

**Type:** String

### DocxSaveOptions.ValidateMergedAreas property {#validatemergedareas}

Indicates whether validate merged cells before saving the file. The default value is false.

**Type:** boolean

### DocxSaveOptions.MergeAreas property {#mergeareas}

Indicates whether merge the areas of conditional formatting and validation before saving the file. The default value is false.

**Type:** boolean

### DocxSaveOptions.CreateDirectory property {#createdirectory}

If true and the directory does not exist, the directory will be automatically created before saving the file. The default value is false.

**Type:** boolean

### DocxSaveOptions.SortNames property {#sortnames}

Indicates whether sorting defined names before saving file.

**Type:** boolean

### DocxSaveOptions.SortExternalNames property {#sortexternalnames}

Indicates whether sorting external defined names before saving file.

**Type:** boolean

### DocxSaveOptions.RefreshChartCache property {#refreshchartcache}

Indicates whether refreshing chart cache data

**Type:** boolean

### DocxSaveOptions.WarningCallback property {#warningcallback}

Gets or sets warning callback.

**Type:** IWarningCallback

### DocxSaveOptions.CheckExcelRestriction property {#checkexcelrestriction}

**Type:** boolean

### DocxSaveOptions.UpdateSmartArt property {#updatesmartart}

Indicates whether updating smart art setting. The default value is false. Only effects after calling Shape.GetResultOfSmartArt() method and the cached shapes exist in the template file.

**Type:** boolean

### DocxSaveOptions.EncryptDocumentProperties property {#encryptdocumentproperties}
