...
type: docs
weight: 7190
url: /cells/php/aspose.cells/unionrange/
---
...
| --- | --- | --- |
| [FirstRow](#firstrow) | Number | Gets the index of the first row of the range. Only effects when it only contains one range. |
| [FirstColumn](#firstcolumn) | Number | Gets the index of the first column of the range. Only effects when it only contains one range. |
| [RowCount](#rowcount) | Number | Gets the count of rows in the range. Only effects when it only contains one range. |
| [ColumnCount](#columncount) | Number | Gets the count of rows in the range. Only effects when it only contains one range. |
...
| [CellCount](#cellcount) | Number | Gets all cell count in the range. |
| [RangeCount](#rangecount) | Number | Gets the count of the ranges. |
