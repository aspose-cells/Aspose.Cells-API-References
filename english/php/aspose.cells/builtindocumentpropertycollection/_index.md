...
type: docs
weight: 410
url: /cells/php/aspose.cells/builtindocumentpropertycollection/
---
...
| [Bytes](#bytes) | Number | Represents an estimate of the number of bytes in the document. |
| [Characters](#characters) | Number | Represents an estimate of the number of characters in the document. |
| [CharactersWithSpaces](#characterswithspaces) | Number | Represents an estimate of the number of characters (including spaces) in the document. |
...
| [Lines](#lines) | Number | Represents an estimate of the number of lines in the document. Aspose.Cells does not update this property when you modif |
...
| [Paragraphs](#paragraphs) | Number | Represents an estimate of the number of paragraphs in the document. |
