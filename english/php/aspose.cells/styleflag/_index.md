...
### StyleFlag.All property {#all}

All properties will be applied.

**Type:** boolean

### StyleFlag.Borders property {#borders}

All borders settings will be applied.

**Type:** boolean

### StyleFlag.LeftBorder property {#leftborder}

Left border settings will be applied.

**Type:** boolean

### StyleFlag.RightBorder property {#rightborder}

Right border settings will be applied.

**Type:** boolean

### StyleFlag.TopBorder property {#topborder}

Top border settings will be applied.

**Type:** boolean

### StyleFlag.BottomBorder property {#bottomborder}

Bottom border settings will be applied.

**Type:** boolean

### StyleFlag.DiagonalDownBorder property {#diagonaldownborder}

Diagonal down border settings will be applied.

**Type:** boolean

### StyleFlag.DiagonalUpBorder property {#diagonalupborder}

Diagonal up border settings will be applied.

**Type:** boolean

### StyleFlag.Font property {#font}

Font settings will be applied.

**Type:** boolean

### StyleFlag.FontSize property {#fontsize}

Font size setting will be applied.

**Type:** boolean

### StyleFlag.FontName property {#fontname}

Font name setting will be applied.

**Type:** boolean

### StyleFlag.FontColor property {#fontcolor}

Font color setting will be applied.

**Type:** boolean

### StyleFlag.FontBold property {#fontbold}

Font bold setting will be applied.

**Type:** boolean

### StyleFlag.FontItalic property {#fontitalic}

Font italic setting will be applied.

**Type:** boolean

### StyleFlag.FontUnderline property {#fontunderline}

Font underline setting will be applied.

**Type:** boolean

### StyleFlag.FontStrike property {#fontstrike}

Font strikeout setting will be applied.

**Type:** boolean

### StyleFlag.FontScript property {#fontscript}

Font script setting will be applied.

**Type:** boolean

### StyleFlag.NumberFormat property {#numberformat}

Number format setting will be applied.

**Type:** boolean

### StyleFlag.Alignments property {#alignments}

Alignment setting will be applied.

**Type:** boolean

### StyleFlag.HorizontalAlignment property {#horizontalalignment}

Horizontal alignment setting will be applied.

**Type:** boolean

### StyleFlag.VerticalAlignment property {#verticalalignment}

Vertical alignment setting will be applied.

**Type:** boolean

### StyleFlag.Indent property {#indent}

Indent level setting will be applied.

**Type:** boolean

### StyleFlag.Rotation property {#rotation}

Rotation setting will be applied.

**Type:** boolean

### StyleFlag.WrapText property {#wraptext}

Wrap text setting will be applied.

**Type:** boolean

### StyleFlag.ShrinkToFit property {#shrinktofit}

Shrink to fit setting will be applied.

**Type:** boolean

### StyleFlag.TextDirection property {#textdirection}

Text direction setting will be applied.

**Type:** boolean

### StyleFlag.CellShading property {#cellshading}

Cell shading setting will be applied.

**Type:** boolean

### StyleFlag.Locked property {#locked}

Locked setting will be applied.

**Type:** boolean

### StyleFlag.HideFormula property {#hideformula}

Hide formula setting will be applied.

**Type:** boolean

### StyleFlag.QuotePrefix property {#quoteprefix}
