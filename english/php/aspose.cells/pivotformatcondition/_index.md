...
| --- | --- | --- |
| [ScopeType](#scopetype) | Number | Get and set scope type for the pivot table condition format . The value of the property is PivotConditionFormatScopeType |
| [RuleType](#ruletype) | Number | Get and set rule type for the pivot table condition format . The value of the property is PivotConditionFormatRuleType i |
