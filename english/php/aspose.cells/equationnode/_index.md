...
### EquationNode.ParentNode property {#parentnode}

Specifies the parent node of the current node

**Type:** EquationNode

### EquationNode.Type property {#type}

Represents the type of the node. The value of the property is TextNodeType integer constant.

**Type:** Number

### EquationNode.EquationType property {#equationtype}

Get the equation type of the current node The value of the property is EquationNodeType integer constant.

**Type:** Number

### EquationNode.StartIndex property {#startindex}

Gets the start index of the characters.

**Type:** Number

### EquationNode.Length property {#length}

Gets the length of the characters.

**Type:** Number

### EquationNode.Font property {#font}

Returns the font of this object.

**Type:** Font

### EquationNode.TextOptions property {#textoptions}
...
### createNode(equationType, workbook, parent) {#createnode}
