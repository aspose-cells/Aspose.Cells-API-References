...
articleTitle: "ChartPointCollection"
...
| --- | --- | --- |
| [Count](#count) | Number | Gets the count of the chart point. |
| [Item (int)](#itemint) | ChartPoint | Gets the ChartPoint element at the specified index in the series. |

## Methods

| Name | Description |
| --- | --- |
| [iterator](#iterator) | Returns an enumerator for the entire ChartPointCollection . |
| [clear](#clear) | Remove all setting of the chart points. |
| [removeAt](#removeat) | Removes point at the index of the series.. |

### ChartPointCollection.Count property {#count}

Gets the count of the chart point.

**Type:** Number

### ChartPointCollection.Item (int) property {#itemint}
