...
### BoxEquationNode.ParentNode property {#parentnode}

Specifies the parent node of the current node

**Type:** EquationNode

### BoxEquationNode.Type property {#type}

Represents the type of the node. The value of the property is TextNodeType integer constant.

**Type:** Number

### BoxEquationNode.EquationType property {#equationtype}

Get the equation type of the current node The value of the property is EquationNodeType integer constant.

**Type:** Number

### BoxEquationNode.StartIndex property {#startindex}

Gets the start index of the characters.

**Type:** Number

### BoxEquationNode.Length property {#length}

Gets the length of the characters.

**Type:** Number

### BoxEquationNode.Font property {#font}

Returns the font of this object.

**Type:** Font

### BoxEquationNode.TextOptions property {#textoptions}
