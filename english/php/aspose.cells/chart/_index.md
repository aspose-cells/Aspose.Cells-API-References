...
type: docs
weight: 710
url: /cells/php/aspose.cells/chart/
---
...
| --- | --- | --- |
| [Style](#style) | Number | Gets and sets the builtin style. It should be between 1 and 48. Return -1 if it's not be set. |
...
| [PlotBy](#plotby) | Number | Gets and sets whether plot by row or column. The value of the property is PlotDataByType integer constant. |
| [PlotEmptyCellsType](#plotemptycellstype) | Number | Gets and sets how to plot the empty cells. The value of the property is PlotEmptyCellsType integer constant. |
...
| [PrintSize](#printsize) | Number | Gets and sets the printed chart size. The value of the property is PrintSizeType integer constant. |
| [Type](#type) | Number | Gets or sets a chart's type. The value of the property is ChartType integer constant. |
...
| [GapDepth](#gapdepth) | Number | Gets or sets the distance between the data series in a 3-D chart, as a percentage of the marker width. The value of this |
...
| [RotationAngle](#rotationangle) | Number | Represents the rotation of the 3-D chart view (the rotation of the plot area around the z-axis, in degrees). The value o |
| [Elevation](#elevation) | Number | Represents the elevation of the 3-D chart view, in degrees. The chart elevation is the height at which you view the char |
...
| [Perspective](#perspective) | Number | Returns or sets the perspective for the 3-D chart view. Must be between 0 and 100. This property is ignored if the Right |
...
| [Placement](#placement) | Number | Represents the way the chart is attached to the cells below it. The value of the property is PlacementType integer const |
