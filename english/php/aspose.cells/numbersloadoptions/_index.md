...
articleTitle: "NumbersLoadOptions"
...
| --- | --- | --- |
| [PreserveTableName](#preservetablename) | boolean |  |
| [LoadTableType](#loadtabletype) | Number | Gets and sets the type of loading multiple tables in one worksheet. The value of the property is LoadNumbersTableType in |
...
### NumbersLoadOptions.PreserveTableName property {#preservetablename}

**Type:** boolean

### NumbersLoadOptions.LoadTableType property {#loadtabletype}

Gets and sets the type of loading multiple tables in one worksheet. The value of the property is LoadNumbersTableType integer constant.

**Type:** Number

### NumbersLoadOptions.LoadFormat property {#loadformat}

Gets the load format. The value of the property is LoadFormat integer constant.

**Type:** Number

### NumbersLoadOptions.Password property {#password}

Gets and set the password of the workbook.

**Type:** String

### NumbersLoadOptions.ParsingFormulaOnOpen property {#parsingformulaonopen}
...
### NumbersLoadOptions.ParsingPivotCachedRecords property {#parsingpivotcachedrecords}
...
### NumbersLoadOptions.LanguageCode property {#languagecode}
...
### NumbersLoadOptions.Region property {#region}
...
### NumbersLoadOptions.Locale property {#locale}

Gets and sets the Locale used for workbook at the time the file was loaded.

**Type:** Locale

### NumbersLoadOptions.DefaultStyleSettings property {#defaultstylesettings}

Gets the default style settings for initializing styles of the workbook

**Type:** DefaultStyleSettings

### NumbersLoadOptions.StandardFont property {#standardfont}
...
### NumbersLoadOptions.StandardFontSize property {#standardfontsize}
...
### NumbersLoadOptions.InterruptMonitor property {#interruptmonitor}

Gets and sets the interrupt monitor.

**Type:** AbstractInterruptMonitor

### NumbersLoadOptions.IgnoreNotPrinted property {#ignorenotprinted}

Ignore the data which are not printed if directly printing the file Only for xlsx file.

**Type:** boolean

### NumbersLoadOptions.CheckDataValid property {#checkdatavalid}

Check whether data is valid in the template file.

**Type:** boolean

### NumbersLoadOptions.CheckExcelRestriction property {#checkexcelrestriction}
...
### NumbersLoadOptions.KeepUnparsedData property {#keepunparseddata}
...
### NumbersLoadOptions.LoadFilter property {#loadfilter}

The filter to denote how to load data.

**Type:** LoadFilter

### NumbersLoadOptions.LightCellsDataHandler property {#lightcellsdatahandler}

The data handler for processing cells data when reading template file.

**Type:** LightCellsDataHandler

### NumbersLoadOptions.MemorySetting property {#memorysetting}

Gets or sets the memory usage options. The value of the property is MemorySetting integer constant.

**Type:** Number

### NumbersLoadOptions.WarningCallback property {#warningcallback}

Gets or sets warning callback.

**Type:** IWarningCallback

### NumbersLoadOptions.AutoFitterOptions property {#autofitteroptions}

Gets and sets the auto fitter options Only for xlsx ,spreadsheetML file now.

**Type:** AutoFitterOptions

### NumbersLoadOptions.AutoFilter property {#autofilter}
...
### NumbersLoadOptions.FontConfigs property {#fontconfigs}
...
### NumbersLoadOptions.IgnoreUselessShapes property {#ignoreuselessshapes}
...
### NumbersLoadOptions.PreservePaddingSpacesInFormula property {#preservepaddingspacesinformula}
