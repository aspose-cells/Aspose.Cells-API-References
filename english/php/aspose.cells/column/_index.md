...
| --- | --- | --- |
| [Index](#index) | Number | Gets the index of this column. |
| [Width](#width) | Number | Gets and sets the column width in unit of characters. For spreadsheet, column width is measured as the number of charact |
