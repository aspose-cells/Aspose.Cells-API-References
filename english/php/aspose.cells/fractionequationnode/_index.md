...
articleTitle: "FractionEquationNode"
...
type: docs
weight: 2620
url: /cells/php/aspose.cells/fractionequationnode/
---
...
| --- | --- | --- |
| [FractionType](#fractiontype) | Number | This specifies the type of fraction ; the default is 'Bar'. The value of the property is EquationFractionType integer co |
...
### FractionEquationNode.FractionType property {#fractiontype}

This specifies the type of fraction ; the default is 'Bar'. The value of the property is EquationFractionType integer constant.

**Type:** Number

### FractionEquationNode.ParentNode property {#parentnode}

Specifies the parent node of the current node

**Type:** EquationNode

### FractionEquationNode.Type property {#type}

Represents the type of the node. The value of the property is TextNodeType integer constant.

**Type:** Number

### FractionEquationNode.EquationType property {#equationtype}

Get the equation type of the current node The value of the property is EquationNodeType integer constant.

**Type:** Number

### FractionEquationNode.StartIndex property {#startindex}

Gets the start index of the characters.

**Type:** Number

### FractionEquationNode.Length property {#length}

Gets the length of the characters.

**Type:** Number

### FractionEquationNode.Font property {#font}

Returns the font of this object.

**Type:** Font

### FractionEquationNode.TextOptions property {#textoptions}
