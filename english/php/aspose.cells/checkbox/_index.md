...
| --- | --- | --- |
| [Value](#value) | boolean | Indicates if the checkbox is checked or not. |
| [CheckedValue](#checkedvalue) | Number | Gets or set checkbox' value. The value of the property is CheckValueType integer constant. |
...
### CheckBox.Value property {#value}

Indicates if the checkbox is checked or not.

**Type:** boolean

### CheckBox.CheckedValue property {#checkedvalue}

Gets or set checkbox' value. The value of the property is CheckValueType integer constant.

**Type:** Number

### CheckBox.Shadow property {#shadow}

Indicates whether the combobox has 3-D shading.

**Type:** boolean

### CheckBox.MacroName property {#macroname}

Gets and sets the name of macro.

**Type:** String

### CheckBox.IsEquation property {#isequation}

Indicates whether the shape only contains an equation.

**Type:** boolean

### CheckBox.IsSmartArt property {#issmartart}

Indicates whether the shape is a smart art. Only for ooxml file.

**Type:** boolean

### CheckBox.ZOrderPosition property {#zorderposition}
...
### CheckBox.AlternativeText property {#alternativetext}

Returns or sets the descriptive (alternative) text string of the Shape object.

**Type:** String

### CheckBox.Title property {#title}

Specifies the title (caption) of the current shape object.

**Type:** String

### CheckBox.LineFormat property {#lineformat}
...
### CheckBox.FillFormat property {#fillformat}
...
### CheckBox.Glow property {#glow}

Represents a GlowEffect object that specifies glow effect for the chart element or shape.

**Type:** GlowEffect

### CheckBox.SoftEdges property {#softedges}

Gets and sets the radius of blur to apply to the edges, in unit of points.

**Type:** Number

### CheckBox.ThreeDFormat property {#threedformat}

Gets and sets 3d format of the shape.

**Type:** ThreeDFormat

### CheckBox.FormatPicture property {#formatpicture}

Gets and sets the options of the picture format.

**Type:** MsoFormatPicture

### CheckBox.IsHidden property {#ishidden}

Indicates whether the object is visible.

**Type:** boolean

### CheckBox.IsLockAspectRatio property {#islockaspectratio}
...
### CheckBox.IsAspectRatioLocked property {#isaspectratiolocked}

True means that aspect ratio of the shape is locked. Only for pictures and Ole Objects.

**Type:** boolean

### CheckBox.RotationAngle property {#rotationangle}

Gets and sets the rotation of the shape.

**Type:** Number

### CheckBox.Hyperlink property {#hyperlink}
...
### CheckBox.IsLocked property {#islocked}
...
### CheckBox.UpperLeftRow property {#upperleftrow}

Represents the top row index. If the shape is in the shape or in the group , UpperLeftRow will be ignored.

**Type:** Number

### CheckBox.UpperDeltaY property {#upperdeltay}

Gets or sets the shape's vertical offset from its upper left corner row. The range of value is 0 to 256.

**Type:** Number

### CheckBox.UpperLeftColumn property {#upperleftcolumn}

Represents upper left corner column index.

**Type:** Number

### CheckBox.UpperDeltaX property {#upperdeltax}

Gets or sets the shape's horizontal offset from its upper left corner column. The range of value is 0 to 1024.

**Type:** Number

### CheckBox.LowerRightRow property {#lowerrightrow}

Represents lower right corner row index.

**Type:** Number

### CheckBox.LowerDeltaY property {#lowerdeltay}

Gets or sets the shape's vertical offset from its lower right corner row. The range of value is 0 to 256.

**Type:** Number

### CheckBox.LowerRightColumn property {#lowerrightcolumn}

Represents lower right corner column index.

**Type:** Number

### CheckBox.LowerDeltaX property {#lowerdeltax}

Gets or sets the shape's horizontal offset from its lower right corner column. The range of value is 0 to 1024.

**Type:** Number

### CheckBox.Right property {#right}

Represents the width of the shape's horizontal offset from its lower right corner column, in unit of pixels.

**Type:** Number

### CheckBox.Bottom property {#bottom}

Represents the width of the shape's vertical offset from its lower bottom corner row, in unit of pixels.

**Type:** Number

### CheckBox.Width property {#width}

Represents the width of shape, in unit of pixels.

**Type:** Number

### CheckBox.WidthInch property {#widthinch}

Represents the width of the shape, in unit of inch.

**Type:** Number

### CheckBox.WidthPt property {#widthpt}

Represents the width of the shape, in unit of point.

**Type:** Number

### CheckBox.WidthCM property {#widthcm}

Represents the width of the shape, in unit of centimeters.

**Type:** Number

### CheckBox.Height property {#height}

Represents the height of shape, in unit of pixel.

**Type:** Number

### CheckBox.HeightInch property {#heightinch}

Represents the height of the shape, in unit of inches.

**Type:** Number

### CheckBox.HeightPt property {#heightpt}

Represents the height of the shape, in unit of points.

**Type:** Number

### CheckBox.HeightCM property {#heightcm}

Represents the height of the shape, in unit of centimeters.

**Type:** Number

### CheckBox.Left property {#left}

Represents the horizontal offset of shape from its left column, in unit of pixels.

**Type:** Number

### CheckBox.LeftInch property {#leftinch}

Represents the horizontal offset of shape from its left column, in unit of inches.

**Type:** Number

### CheckBox.LeftCM property {#leftcm}

Represents the horizontal offset of shape from its left column, in unit of centimeters.

**Type:** Number

### CheckBox.Top property {#top}
...
### CheckBox.TopInch property {#topinch}

Represents the vertical offset of shape from its top row, in unit of inches.

**Type:** Number

### CheckBox.TopCM property {#topcm}

Represents the vertical offset of shape from its top row, in unit of centimeters.

**Type:** Number

### CheckBox.TopToCorner property {#toptocorner}

Gets and sets the vertical offset of shape from worksheet top border, in unit of pixels.

**Type:** Number

### CheckBox.LeftToCorner property {#lefttocorner}

Gets and sets the horizonal offset of shape from worksheet left border.

**Type:** Number

### CheckBox.X property {#x}

Gets and sets the horizontal offset of shape from worksheet left border,in unit of pixels.

**Type:** Number

### CheckBox.Y property {#y}

Gets and sets the vertical offset of shape from worksheet top border,in unit of pixels.

**Type:** Number

### CheckBox.WidthScale property {#widthscale}
...
### CheckBox.HeightScale property {#heightscale}
...
### CheckBox.TopInShape property {#topinshape}
...
### CheckBox.LeftInShape property {#leftinshape}
...
### CheckBox.WidthInShape property {#widthinshape}
...
### CheckBox.HeightInShape property {#heightinshape}

Represents the vertical offset of shape from the top border of the parent shape, in unit of 1/4000 of height of the parent shape.. Only Applies when this shape in the group or chart.

**Type:** Number

### CheckBox.Group property {#group}

Gets the group shape which contains this shape.

**Type:** GroupShape

### CheckBox.Type property {#type}

Gets the auto shape type. The value of the property is AutoShapeType integer constant.

**Type:** Number

### CheckBox.HasLine property {#hasline}

Gets and sets the line border of the shape is visible.

**Type:** boolean

### CheckBox.IsFilled property {#isfilled}

Indicates whether the fill format is visible.

**Type:** boolean

### CheckBox.IsFlippedHorizontally property {#isflippedhorizontally}

Gets and sets whether shape is horizontally flipped .

**Type:** boolean

### CheckBox.IsFlippedVertically property {#isflippedvertically}

Gets and sets whether shape is vertically flipped .

**Type:** boolean

### CheckBox.ActualLowerRightRow property {#actuallowerrightrow}

Get the actual bottom row.

**Type:** Number

### CheckBox.RelativeToOriginalPictureSize property {#relativetooriginalpicturesize}

Indicates whether shape is relative to original picture size.

**Type:** boolean

### CheckBox.LinkedCell property {#linkedcell}

Gets or sets the worksheet range linked to the control's value.

**Type:** String

### CheckBox.InputRange property {#inputrange}

Gets or sets the worksheet range used to fill the specified combo box.

**Type:** String

### CheckBox.TextShapeType property {#textshapetype}

Gets and sets the preset text shape type. The value of the property is AutoShapeType integer constant.

**Type:** Number

### CheckBox.TextBody property {#textbody}

Gets and sets the setting of the shape's text.

**Type:** FontSettingCollection

### CheckBox.Font property {#font}

Represents the font of shape.

**Type:** Font

### CheckBox.TextOptions property {#textoptions}

Represents the text options of the shape.

**Type:** TextOptions

### CheckBox.Text property {#text}

Gets and sets the text of this shape.

**Type:** String

### CheckBox.IsRichText property {#isrichtext}

Whether or not the text is rich text.

**Type:** boolean

### CheckBox.HtmlText property {#htmltext}

Gets and sets the html string which contains data and some formats in this textbox.

**Type:** String

### CheckBox.TextVerticalOverflow property {#textverticaloverflow}
...
### CheckBox.TextHorizontalOverflow property {#texthorizontaloverflow}
...
### CheckBox.IsTextWrapped property {#istextwrapped}

Gets and sets the text wrapped type of the shape which contains text.

**Type:** boolean

### CheckBox.TextOrientationType property {#textorientationtype}

Gets and sets the text orientation type of the shape. The value of the property is TextOrientationType integer constant.

**Type:** Number

### CheckBox.TextHorizontalAlignment property {#texthorizontalalignment}
...
### CheckBox.TextVerticalAlignment property {#textverticalalignment}
...
### CheckBox.TextDirection property {#textdirection}

Gets/Sets the direction of the text flow for this object. The value of the property is TextDirectionType integer constant.

**Type:** Number

### CheckBox.TextBoxOptions property {#textboxoptions}

**Type:** TextBoxOptions

### CheckBox.ControlData property {#controldata}

Gets the data of control.

**Type:** byte[]

### CheckBox.Paths property {#paths}

Gets the paths of a custom geometric shape.

**Type:** ShapePathCollection

### CheckBox.Geometry property {#geometry}

Gets the geometry

**Type:** Geometry

### CheckBox.CreateId property {#createid}

Gets and sets create id for this shape.

**Type:** UUID

### CheckBox.IsDecorative property {#isdecorative}
