...
articleTitle: "ExternalConnection"
...
| [CommandType](#commandtype) | Number | The value of the property is OLEDBCommandType integer constant. |
| [ConnectionString](#connectionstring) | String |  |
| [SecondCommand](#secondcommand) | String |  |

### ExternalConnection.Id property {#id}

Gets the id of the connection.

**Type:** Number

### ExternalConnection.ConnectionId property {#connectionid}

Specifies The unique identifier of this connection.

**Type:** Number

### ExternalConnection.ClassType property {#classtype}

The value of the property is ExternalConnectionClassType integer constant.

**Type:** Number

### ExternalConnection.PowerQueryFormula property {#powerqueryformula}

Gets the definition of power query formula.

**Type:** PowerQueryFormula

### ExternalConnection.Type property {#type}

Gets or Sets the external connection DataSource type.

**Type:** ConnectionDataSourceType

### ExternalConnection.SourceType property {#sourcetype}

**Type:** ConnectionDataSourceType

### ExternalConnection.SSOId property {#ssoid}
...
### ExternalConnection.SavePassword property {#savepassword}

True if the password is to be saved as part of the connection string; otherwise, False.

**Type:** boolean

### ExternalConnection.SaveData property {#savedata}
...
### ExternalConnection.RefreshOnLoad property {#refreshonload}

True if this connection should be refreshed when opening the file; otherwise, false.

**Type:** boolean

### ExternalConnection.ReconnectionMethodType property {#reconnectionmethodtype}
...
### ExternalConnection.ReconnectionMethod property {#reconnectionmethod}
...
### ExternalConnection.OnlyUseConnectionFile property {#onlyuseconnectionfile}
...
### ExternalConnection.OdcFile property {#odcfile}
...
### ExternalConnection.SourceFile property {#sourcefile}
...
### ExternalConnection.ConnectionFile property {#connectionfile}

**Type:** String

### ExternalConnection.IsNew property {#isnew}
...
### ExternalConnection.Name property {#name}

Specifies the name of the connection. Each connection must have a unique name.

**Type:** String

### ExternalConnection.KeepAlive property {#keepalive}
...
### ExternalConnection.RefreshInternal property {#refreshinternal}

Specifies the number of minutes between automatic refreshes of the connection.

**Type:** Number

### ExternalConnection.ConnectionDescription property {#connectiondescription}

Specifies the user description for this connection

**Type:** String

### ExternalConnection.IsDeleted property {#isdeleted}
...
### ExternalConnection.CredentialsMethodType property {#credentialsmethodtype}
...
### ExternalConnection.Credentials property {#credentials}
...
### ExternalConnection.BackgroundRefresh property {#backgroundrefresh}
...
### ExternalConnection.Parameters property {#parameters}

Gets ConnectionParameterCollection for an ODBC or web query.

**Type:** ConnectionParameterCollection

### ExternalConnection.Command property {#command}

**Type:** String

### ExternalConnection.CommandType property {#commandtype}

The value of the property is OLEDBCommandType integer constant.

**Type:** Number

### ExternalConnection.ConnectionString property {#connectionstring}

**Type:** String

### ExternalConnection.SecondCommand property {#secondcommand}
