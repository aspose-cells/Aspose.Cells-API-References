---
title: "TimelineShape Class"
linktitle: "TimelineShape"
articleTitle: "TimelineShape"
second_title: "Aspose.Cells for PHP via Java"
description: "Represents the Timeline msodrawing object."
type: docs
weight: 7050
url: /cells/php/aspose.cells/timelineshape/
---
...
### TimelineShape.MacroName property {#macroname}

Gets and sets the name of macro.

**Type:** String

### TimelineShape.IsEquation property {#isequation}

Indicates whether the shape only contains an equation.

**Type:** boolean

### TimelineShape.IsSmartArt property {#issmartart}

Indicates whether the shape is a smart art. Only for ooxml file.

**Type:** boolean

### TimelineShape.ZOrderPosition property {#zorderposition}

Returns the position of a shape in the z-order.

**Type:** Number

### TimelineShape.Name property {#name}

Gets and sets the name of the shape.

**Type:** String

### TimelineShape.AlternativeText property {#alternativetext}

Returns or sets the descriptive (alternative) text string of the Shape object.

**Type:** String

### TimelineShape.Title property {#title}

Specifies the title (caption) of the current shape object.

**Type:** String

### TimelineShape.LineFormat property {#lineformat}
...
### TimelineShape.FillFormat property {#fillformat}
...
### TimelineShape.Glow property {#glow}

Represents a GlowEffect object that specifies glow effect for the chart element or shape.

**Type:** GlowEffect

### TimelineShape.SoftEdges property {#softedges}

Gets and sets the radius of blur to apply to the edges, in unit of points.

**Type:** Number

### TimelineShape.ThreeDFormat property {#threedformat}

Gets and sets 3d format of the shape.

**Type:** ThreeDFormat

### TimelineShape.FormatPicture property {#formatpicture}

Gets and sets the options of the picture format.

**Type:** MsoFormatPicture

### TimelineShape.IsHidden property {#ishidden}

Indicates whether the object is visible.

**Type:** boolean

### TimelineShape.IsLockAspectRatio property {#islockaspectratio}
...
### TimelineShape.IsAspectRatioLocked property {#isaspectratiolocked}

True means that aspect ratio of the shape is locked. Only for pictures and Ole Objects.

**Type:** boolean

### TimelineShape.RotationAngle property {#rotationangle}

Gets and sets the rotation of the shape.

**Type:** Number

### TimelineShape.Hyperlink property {#hyperlink}

Gets the hyperlink of the shape.

**Type:** Hyperlink

### TimelineShape.Id property {#id}

Gets the identifier of this shape.

**Type:** Number

### TimelineShape.Spid property {#spid}

Specifies an optional string identifier that an application can use to identify the particular shape.

**Type:** String

### TimelineShape.Spt property {#spt}

Specifies an optional number that an application can use to associate the particular shape with a defined shape type.

**Type:** Number

### TimelineShape.Worksheet property {#worksheet}

Gets the Worksheet object which contains this shape.

**Type:** Worksheet

### TimelineShape.IsGroup property {#isgroup}

Indicates whether this shape is a group shape.

**Type:** boolean

### TimelineShape.IsInGroup property {#isingroup}

Indicates whether the shape is grouped.

**Type:** boolean

### TimelineShape.IsWordArt property {#iswordart}

Indicates whether this shape is a word art. Only for the Legacy Shape of xls file.

**Type:** boolean

### TimelineShape.TextEffect property {#texteffect}
...
### TimelineShape.IsLocked property {#islocked}
...
### TimelineShape.UpperLeftRow property {#upperleftrow}

Represents the top row index. If the shape is in the shape or in the group , UpperLeftRow will be ignored.

**Type:** Number

### TimelineShape.UpperDeltaY property {#upperdeltay}

Gets or sets the shape's vertical offset from its upper left corner row. The range of value is 0 to 256.

**Type:** Number

### TimelineShape.UpperLeftColumn property {#upperleftcolumn}

Represents upper left corner column index.

**Type:** Number

### TimelineShape.UpperDeltaX property {#upperdeltax}

Gets or sets the shape's horizontal offset from its upper left corner column. The range of value is 0 to 1024.

**Type:** Number

### TimelineShape.LowerRightRow property {#lowerrightrow}

Represents lower right corner row index.

**Type:** Number

### TimelineShape.LowerDeltaY property {#lowerdeltay}

Gets or sets the shape's vertical offset from its lower right corner row. The range of value is 0 to 256.

**Type:** Number

### TimelineShape.LowerRightColumn property {#lowerrightcolumn}

Represents lower right corner column index.

**Type:** Number

### TimelineShape.LowerDeltaX property {#lowerdeltax}

Gets or sets the shape's horizontal offset from its lower right corner column. The range of value is 0 to 1024.

**Type:** Number

### TimelineShape.Right property {#right}

Represents the width of the shape's horizontal offset from its lower right corner column, in unit of pixels.

**Type:** Number

### TimelineShape.Bottom property {#bottom}

Represents the width of the shape's vertical offset from its lower bottom corner row, in unit of pixels.

**Type:** Number

### TimelineShape.Width property {#width}

Represents the width of shape, in unit of pixels.

**Type:** Number

### TimelineShape.WidthInch property {#widthinch}

Represents the width of the shape, in unit of inch.

**Type:** Number

### TimelineShape.WidthPt property {#widthpt}

Represents the width of the shape, in unit of point.

**Type:** Number

### TimelineShape.WidthCM property {#widthcm}

Represents the width of the shape, in unit of centimeters.

**Type:** Number

### TimelineShape.Height property {#height}

Represents the height of shape, in unit of pixel.

**Type:** Number

### TimelineShape.HeightInch property {#heightinch}

Represents the height of the shape, in unit of inches.

**Type:** Number

### TimelineShape.HeightPt property {#heightpt}

Represents the height of the shape, in unit of points.

**Type:** Number

### TimelineShape.HeightCM property {#heightcm}

Represents the height of the shape, in unit of centimeters.

**Type:** Number

### TimelineShape.Left property {#left}

Represents the horizontal offset of shape from its left column, in unit of pixels.

**Type:** Number

### TimelineShape.LeftInch property {#leftinch}

Represents the horizontal offset of shape from its left column, in unit of inches.

**Type:** Number

### TimelineShape.LeftCM property {#leftcm}

Represents the horizontal offset of shape from its left column, in unit of centimeters.

**Type:** Number

### TimelineShape.Top property {#top}
...
### TimelineShape.TopInch property {#topinch}

Represents the vertical offset of shape from its top row, in unit of inches.

**Type:** Number

### TimelineShape.TopCM property {#topcm}

Represents the vertical offset of shape from its top row, in unit of centimeters.

**Type:** Number

### TimelineShape.TopToCorner property {#toptocorner}

Gets and sets the vertical offset of shape from worksheet top border, in unit of pixels.

**Type:** Number

### TimelineShape.LeftToCorner property {#lefttocorner}

Gets and sets the horizonal offset of shape from worksheet left border.

**Type:** Number

### TimelineShape.X property {#x}

Gets and sets the horizontal offset of shape from worksheet left border,in unit of pixels.

**Type:** Number

### TimelineShape.Y property {#y}

Gets and sets the vertical offset of shape from worksheet top border,in unit of pixels.

**Type:** Number

### TimelineShape.WidthScale property {#widthscale}
...
### TimelineShape.HeightScale property {#heightscale}
...
### TimelineShape.TopInShape property {#topinshape}
...
### TimelineShape.LeftInShape property {#leftinshape}
...
### TimelineShape.WidthInShape property {#widthinshape}
...
### TimelineShape.HeightInShape property {#heightinshape}

Represents the vertical offset of shape from the top border of the parent shape, in unit of 1/4000 of height of the parent shape.. Only Applies when this shape in the group or chart.

**Type:** Number

### TimelineShape.Group property {#group}

Gets the group shape which contains this shape.

**Type:** GroupShape

### TimelineShape.Type property {#type}

Gets the auto shape type. The value of the property is AutoShapeType integer constant.

**Type:** Number

### TimelineShape.HasLine property {#hasline}

Gets and sets the line border of the shape is visible.

**Type:** boolean

### TimelineShape.IsFilled property {#isfilled}

Indicates whether the fill format is visible.

**Type:** boolean

### TimelineShape.IsFlippedHorizontally property {#isflippedhorizontally}

Gets and sets whether shape is horizontally flipped .

**Type:** boolean

### TimelineShape.IsFlippedVertically property {#isflippedvertically}

Gets and sets whether shape is vertically flipped .

**Type:** boolean

### TimelineShape.ActualLowerRightRow property {#actuallowerrightrow}

Get the actual bottom row.

**Type:** Number

### TimelineShape.RelativeToOriginalPictureSize property {#relativetooriginalpicturesize}

Indicates whether shape is relative to original picture size.

**Type:** boolean

### TimelineShape.LinkedCell property {#linkedcell}

Gets or sets the worksheet range linked to the control's value.

**Type:** String

### TimelineShape.InputRange property {#inputrange}

Gets or sets the worksheet range used to fill the specified combo box.

**Type:** String

### TimelineShape.TextShapeType property {#textshapetype}

Gets and sets the preset text shape type. The value of the property is AutoShapeType integer constant.

**Type:** Number

### TimelineShape.TextBody property {#textbody}

Gets and sets the setting of the shape's text.

**Type:** FontSettingCollection

### TimelineShape.Font property {#font}

Represents the font of shape.

**Type:** Font

### TimelineShape.TextOptions property {#textoptions}

Represents the text options of the shape.

**Type:** TextOptions

### TimelineShape.Text property {#text}

Gets and sets the text of this shape.

**Type:** String

### TimelineShape.IsRichText property {#isrichtext}

Whether or not the text is rich text.

**Type:** boolean

### TimelineShape.HtmlText property {#htmltext}

Gets and sets the html string which contains data and some formats in this textbox.

**Type:** String

### TimelineShape.TextVerticalOverflow property {#textverticaloverflow}
...
### TimelineShape.TextHorizontalOverflow property {#texthorizontaloverflow}
...
### TimelineShape.IsTextWrapped property {#istextwrapped}

Gets and sets the text wrapped type of the shape which contains text.

**Type:** boolean

### TimelineShape.TextOrientationType property {#textorientationtype}

Gets and sets the text orientation type of the shape. The value of the property is TextOrientationType integer constant.

**Type:** Number

### TimelineShape.TextHorizontalAlignment property {#texthorizontalalignment}
...
### TimelineShape.TextVerticalAlignment property {#textverticalalignment}
...
### TimelineShape.TextDirection property {#textdirection}

Gets/Sets the direction of the text flow for this object. The value of the property is TextDirectionType integer constant.

**Type:** Number

### TimelineShape.TextBoxOptions property {#textboxoptions}

**Type:** TextBoxOptions

### TimelineShape.ControlData property {#controldata}

Gets the data of control.

**Type:** byte[]

### TimelineShape.ActiveXControl property {#activexcontrol}

Gets the ActiveX control.

**Type:** ActiveXControl

### TimelineShape.Paths property {#paths}

Gets the paths of a custom geometric shape.

**Type:** ShapePathCollection

### TimelineShape.Geometry property {#geometry}

Gets the geometry

**Type:** Geometry

### TimelineShape.CreateId property {#createid}

Gets and sets create id for this shape.

**Type:** UUID

### TimelineShape.IsDecorative property {#isdecorative}
