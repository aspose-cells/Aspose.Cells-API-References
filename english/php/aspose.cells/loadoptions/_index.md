...
type: docs
weight: 3500
url: /cells/php/aspose.cells/loadoptions/
---
...
### LoadOptions(loadFormat) (2 of 2) {#constructor-1}
...
### LoadOptions.Password property {#password}

Gets and set the password of the workbook.

**Type:** String

### LoadOptions.ParsingFormulaOnOpen property {#parsingformulaonopen}
...
### LoadOptions.ParsingPivotCachedRecords property {#parsingpivotcachedrecords}
...
### LoadOptions.LanguageCode property {#languagecode}
...
### LoadOptions.Region property {#region}
...
### LoadOptions.DefaultStyleSettings property {#defaultstylesettings}

Gets the default style settings for initializing styles of the workbook

**Type:** DefaultStyleSettings

### LoadOptions.StandardFont property {#standardfont}
...
### LoadOptions.StandardFontSize property {#standardfontsize}
...
### LoadOptions.IgnoreNotPrinted property {#ignorenotprinted}

Ignore the data which are not printed if directly printing the file Only for xlsx file.

**Type:** boolean

### LoadOptions.CheckDataValid property {#checkdatavalid}

Check whether data is valid in the template file.

**Type:** boolean

### LoadOptions.CheckExcelRestriction property {#checkexcelrestriction}
...
### LoadOptions.KeepUnparsedData property {#keepunparseddata}
...
### LoadOptions.IgnoreUselessShapes property {#ignoreuselessshapes}
...
### LoadOptions.PreservePaddingSpacesInFormula property {#preservepaddingspacesinformula}
