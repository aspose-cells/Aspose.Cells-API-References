...
### CustomXmlShape.MacroName property {#macroname}

Gets and sets the name of macro.

**Type:** String

### CustomXmlShape.IsEquation property {#isequation}

Indicates whether the shape only contains an equation.

**Type:** boolean

### CustomXmlShape.IsSmartArt property {#issmartart}

Indicates whether the shape is a smart art. Only for ooxml file.

**Type:** boolean

### CustomXmlShape.ZOrderPosition property {#zorderposition}

Returns the position of a shape in the z-order.

**Type:** Number

### CustomXmlShape.Name property {#name}

Gets and sets the name of the shape.

**Type:** String

### CustomXmlShape.AlternativeText property {#alternativetext}

Returns or sets the descriptive (alternative) text string of the Shape object.

**Type:** String

### CustomXmlShape.Title property {#title}

Specifies the title (caption) of the current shape object.

**Type:** String

### CustomXmlShape.LineFormat property {#lineformat}
...
### CustomXmlShape.FillFormat property {#fillformat}
...
### CustomXmlShape.Glow property {#glow}

Represents a GlowEffect object that specifies glow effect for the chart element or shape.

**Type:** GlowEffect

### CustomXmlShape.SoftEdges property {#softedges}

Gets and sets the radius of blur to apply to the edges, in unit of points.

**Type:** Number

### CustomXmlShape.ThreeDFormat property {#threedformat}

Gets and sets 3d format of the shape.

**Type:** ThreeDFormat

### CustomXmlShape.FormatPicture property {#formatpicture}

Gets and sets the options of the picture format.

**Type:** MsoFormatPicture

### CustomXmlShape.IsHidden property {#ishidden}

Indicates whether the object is visible.

**Type:** boolean

### CustomXmlShape.IsLockAspectRatio property {#islockaspectratio}
...
### CustomXmlShape.IsAspectRatioLocked property {#isaspectratiolocked}

True means that aspect ratio of the shape is locked. Only for pictures and Ole Objects.

**Type:** boolean

### CustomXmlShape.RotationAngle property {#rotationangle}

Gets and sets the rotation of the shape.

**Type:** Number

### CustomXmlShape.Hyperlink property {#hyperlink}

Gets the hyperlink of the shape.

**Type:** Hyperlink

### CustomXmlShape.Id property {#id}

Gets the identifier of this shape.

**Type:** Number

### CustomXmlShape.Spid property {#spid}

Specifies an optional string identifier that an application can use to identify the particular shape.

**Type:** String

### CustomXmlShape.Spt property {#spt}

Specifies an optional number that an application can use to associate the particular shape with a defined shape type.

**Type:** Number

### CustomXmlShape.Worksheet property {#worksheet}

Gets the Worksheet object which contains this shape.

**Type:** Worksheet

### CustomXmlShape.IsGroup property {#isgroup}

Indicates whether this shape is a group shape.

**Type:** boolean

### CustomXmlShape.IsInGroup property {#isingroup}

Indicates whether the shape is grouped.

**Type:** boolean

### CustomXmlShape.IsWordArt property {#iswordart}

Indicates whether this shape is a word art. Only for the Legacy Shape of xls file.

**Type:** boolean

### CustomXmlShape.TextEffect property {#texteffect}
...
### CustomXmlShape.IsLocked property {#islocked}
...
### CustomXmlShape.UpperLeftRow property {#upperleftrow}

Represents the top row index. If the shape is in the shape or in the group , UpperLeftRow will be ignored.

**Type:** Number

### CustomXmlShape.UpperDeltaY property {#upperdeltay}

Gets or sets the shape's vertical offset from its upper left corner row. The range of value is 0 to 256.

**Type:** Number

### CustomXmlShape.UpperLeftColumn property {#upperleftcolumn}

Represents upper left corner column index.

**Type:** Number

### CustomXmlShape.UpperDeltaX property {#upperdeltax}

Gets or sets the shape's horizontal offset from its upper left corner column. The range of value is 0 to 1024.

**Type:** Number

### CustomXmlShape.LowerRightRow property {#lowerrightrow}

Represents lower right corner row index.

**Type:** Number

### CustomXmlShape.LowerDeltaY property {#lowerdeltay}

Gets or sets the shape's vertical offset from its lower right corner row. The range of value is 0 to 256.

**Type:** Number

### CustomXmlShape.LowerRightColumn property {#lowerrightcolumn}

Represents lower right corner column index.

**Type:** Number

### CustomXmlShape.LowerDeltaX property {#lowerdeltax}

Gets or sets the shape's horizontal offset from its lower right corner column. The range of value is 0 to 1024.

**Type:** Number

### CustomXmlShape.Right property {#right}

Represents the width of the shape's horizontal offset from its lower right corner column, in unit of pixels.

**Type:** Number

### CustomXmlShape.Bottom property {#bottom}

Represents the width of the shape's vertical offset from its lower bottom corner row, in unit of pixels.

**Type:** Number

### CustomXmlShape.Width property {#width}

Represents the width of shape, in unit of pixels.

**Type:** Number

### CustomXmlShape.WidthInch property {#widthinch}

Represents the width of the shape, in unit of inch.

**Type:** Number

### CustomXmlShape.WidthPt property {#widthpt}

Represents the width of the shape, in unit of point.

**Type:** Number

### CustomXmlShape.WidthCM property {#widthcm}

Represents the width of the shape, in unit of centimeters.

**Type:** Number

### CustomXmlShape.Height property {#height}

Represents the height of shape, in unit of pixel.

**Type:** Number

### CustomXmlShape.HeightInch property {#heightinch}

Represents the height of the shape, in unit of inches.

**Type:** Number

### CustomXmlShape.HeightPt property {#heightpt}

Represents the height of the shape, in unit of points.

**Type:** Number

### CustomXmlShape.HeightCM property {#heightcm}

Represents the height of the shape, in unit of centimeters.

**Type:** Number

### CustomXmlShape.Left property {#left}

Represents the horizontal offset of shape from its left column, in unit of pixels.

**Type:** Number

### CustomXmlShape.LeftInch property {#leftinch}

Represents the horizontal offset of shape from its left column, in unit of inches.

**Type:** Number

### CustomXmlShape.LeftCM property {#leftcm}

Represents the horizontal offset of shape from its left column, in unit of centimeters.

**Type:** Number

### CustomXmlShape.Top property {#top}
...
### CustomXmlShape.TopInch property {#topinch}

Represents the vertical offset of shape from its top row, in unit of inches.

**Type:** Number

### CustomXmlShape.TopCM property {#topcm}

Represents the vertical offset of shape from its top row, in unit of centimeters.

**Type:** Number

### CustomXmlShape.TopToCorner property {#toptocorner}

Gets and sets the vertical offset of shape from worksheet top border, in unit of pixels.

**Type:** Number

### CustomXmlShape.LeftToCorner property {#lefttocorner}

Gets and sets the horizonal offset of shape from worksheet left border.

**Type:** Number

### CustomXmlShape.X property {#x}

Gets and sets the horizontal offset of shape from worksheet left border,in unit of pixels.

**Type:** Number

### CustomXmlShape.Y property {#y}

Gets and sets the vertical offset of shape from worksheet top border,in unit of pixels.

**Type:** Number

### CustomXmlShape.WidthScale property {#widthscale}
...
### CustomXmlShape.HeightScale property {#heightscale}
...
### CustomXmlShape.TopInShape property {#topinshape}
...
### CustomXmlShape.LeftInShape property {#leftinshape}
...
### CustomXmlShape.WidthInShape property {#widthinshape}
...
### CustomXmlShape.HeightInShape property {#heightinshape}

Represents the vertical offset of shape from the top border of the parent shape, in unit of 1/4000 of height of the parent shape.. Only Applies when this shape in the group or chart.

**Type:** Number

### CustomXmlShape.Group property {#group}

Gets the group shape which contains this shape.

**Type:** GroupShape

### CustomXmlShape.Type property {#type}

Gets the auto shape type. The value of the property is AutoShapeType integer constant.

**Type:** Number

### CustomXmlShape.HasLine property {#hasline}

Gets and sets the line border of the shape is visible.

**Type:** boolean

### CustomXmlShape.IsFilled property {#isfilled}

Indicates whether the fill format is visible.

**Type:** boolean

### CustomXmlShape.IsFlippedHorizontally property {#isflippedhorizontally}

Gets and sets whether shape is horizontally flipped .

**Type:** boolean

### CustomXmlShape.IsFlippedVertically property {#isflippedvertically}

Gets and sets whether shape is vertically flipped .

**Type:** boolean

### CustomXmlShape.ActualLowerRightRow property {#actuallowerrightrow}

Get the actual bottom row.

**Type:** Number

### CustomXmlShape.RelativeToOriginalPictureSize property {#relativetooriginalpicturesize}

Indicates whether shape is relative to original picture size.

**Type:** boolean

### CustomXmlShape.LinkedCell property {#linkedcell}

Gets or sets the worksheet range linked to the control's value.

**Type:** String

### CustomXmlShape.InputRange property {#inputrange}

Gets or sets the worksheet range used to fill the specified combo box.

**Type:** String

### CustomXmlShape.TextShapeType property {#textshapetype}

Gets and sets the preset text shape type. The value of the property is AutoShapeType integer constant.

**Type:** Number

### CustomXmlShape.TextBody property {#textbody}

Gets and sets the setting of the shape's text.

**Type:** FontSettingCollection

### CustomXmlShape.Font property {#font}

Represents the font of shape.

**Type:** Font

### CustomXmlShape.TextOptions property {#textoptions}

Represents the text options of the shape.

**Type:** TextOptions

### CustomXmlShape.Text property {#text}

Gets and sets the text of this shape.

**Type:** String

### CustomXmlShape.IsRichText property {#isrichtext}

Whether or not the text is rich text.

**Type:** boolean

### CustomXmlShape.HtmlText property {#htmltext}

Gets and sets the html string which contains data and some formats in this textbox.

**Type:** String

### CustomXmlShape.TextVerticalOverflow property {#textverticaloverflow}
...
### CustomXmlShape.TextHorizontalOverflow property {#texthorizontaloverflow}
...
### CustomXmlShape.IsTextWrapped property {#istextwrapped}

Gets and sets the text wrapped type of the shape which contains text.

**Type:** boolean

### CustomXmlShape.TextOrientationType property {#textorientationtype}

Gets and sets the text orientation type of the shape. The value of the property is TextOrientationType integer constant.

**Type:** Number

### CustomXmlShape.TextHorizontalAlignment property {#texthorizontalalignment}
...
### CustomXmlShape.TextVerticalAlignment property {#textverticalalignment}
...
### CustomXmlShape.TextDirection property {#textdirection}

Gets/Sets the direction of the text flow for this object. The value of the property is TextDirectionType integer constant.

**Type:** Number

### CustomXmlShape.TextBoxOptions property {#textboxoptions}

**Type:** TextBoxOptions

### CustomXmlShape.ControlData property {#controldata}

Gets the data of control.

**Type:** byte[]

### CustomXmlShape.ActiveXControl property {#activexcontrol}

Gets the ActiveX control.

**Type:** ActiveXControl

### CustomXmlShape.Paths property {#paths}

Gets the paths of a custom geometric shape.

**Type:** ShapePathCollection

### CustomXmlShape.Geometry property {#geometry}

Gets the geometry

**Type:** Geometry

### CustomXmlShape.CreateId property {#createid}

Gets and sets create id for this shape.

**Type:** UUID

### CustomXmlShape.IsDecorative property {#isdecorative}
