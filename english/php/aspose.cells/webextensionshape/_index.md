...
articleTitle: "WebExtensionShape"
...
| --- | --- | --- |
| [WebExtension](#webextension) | WebExtension | Gets and set the web extension. |
...
### WebExtensionShape.WebExtension property {#webextension}

Gets and set the web extension.

**Type:** WebExtension

### WebExtensionShape.MacroName property {#macroname}

Gets and sets the name of macro.

**Type:** String

### WebExtensionShape.IsEquation property {#isequation}

Indicates whether the shape only contains an equation.

**Type:** boolean

### WebExtensionShape.IsSmartArt property {#issmartart}

Indicates whether the shape is a smart art. Only for ooxml file.

**Type:** boolean

### WebExtensionShape.ZOrderPosition property {#zorderposition}

Returns the position of a shape in the z-order.

**Type:** Number

### WebExtensionShape.Name property {#name}

Gets and sets the name of the shape.

**Type:** String

### WebExtensionShape.AlternativeText property {#alternativetext}

Returns or sets the descriptive (alternative) text string of the Shape object.

**Type:** String

### WebExtensionShape.Title property {#title}

Specifies the title (caption) of the current shape object.

**Type:** String

### WebExtensionShape.LineFormat property {#lineformat}
...
### WebExtensionShape.FillFormat property {#fillformat}
...
### WebExtensionShape.Glow property {#glow}

Represents a GlowEffect object that specifies glow effect for the chart element or shape.

**Type:** GlowEffect

### WebExtensionShape.SoftEdges property {#softedges}

Gets and sets the radius of blur to apply to the edges, in unit of points.

**Type:** Number

### WebExtensionShape.ThreeDFormat property {#threedformat}

Gets and sets 3d format of the shape.

**Type:** ThreeDFormat

### WebExtensionShape.FormatPicture property {#formatpicture}

Gets and sets the options of the picture format.

**Type:** MsoFormatPicture

### WebExtensionShape.IsHidden property {#ishidden}

Indicates whether the object is visible.

**Type:** boolean

### WebExtensionShape.IsLockAspectRatio property {#islockaspectratio}
...
### WebExtensionShape.IsAspectRatioLocked property {#isaspectratiolocked}

True means that aspect ratio of the shape is locked. Only for pictures and Ole Objects.

**Type:** boolean

### WebExtensionShape.RotationAngle property {#rotationangle}

Gets and sets the rotation of the shape.

**Type:** Number

### WebExtensionShape.Hyperlink property {#hyperlink}

Gets the hyperlink of the shape.

**Type:** Hyperlink

### WebExtensionShape.Id property {#id}

Gets the identifier of this shape.

**Type:** Number

### WebExtensionShape.Spid property {#spid}

Specifies an optional string identifier that an application can use to identify the particular shape.

**Type:** String

### WebExtensionShape.Spt property {#spt}

Specifies an optional number that an application can use to associate the particular shape with a defined shape type.

**Type:** Number

### WebExtensionShape.Worksheet property {#worksheet}

Gets the Worksheet object which contains this shape.

**Type:** Worksheet

### WebExtensionShape.IsGroup property {#isgroup}

Indicates whether this shape is a group shape.

**Type:** boolean

### WebExtensionShape.IsInGroup property {#isingroup}

Indicates whether the shape is grouped.

**Type:** boolean

### WebExtensionShape.IsWordArt property {#iswordart}

Indicates whether this shape is a word art. Only for the Legacy Shape of xls file.

**Type:** boolean

### WebExtensionShape.TextEffect property {#texteffect}
...
### WebExtensionShape.IsLocked property {#islocked}
...
### WebExtensionShape.UpperLeftRow property {#upperleftrow}

Represents the top row index. If the shape is in the shape or in the group , UpperLeftRow will be ignored.

**Type:** Number

### WebExtensionShape.UpperDeltaY property {#upperdeltay}

Gets or sets the shape's vertical offset from its upper left corner row. The range of value is 0 to 256.

**Type:** Number

### WebExtensionShape.UpperLeftColumn property {#upperleftcolumn}

Represents upper left corner column index.

**Type:** Number

### WebExtensionShape.UpperDeltaX property {#upperdeltax}

Gets or sets the shape's horizontal offset from its upper left corner column. The range of value is 0 to 1024.

**Type:** Number

### WebExtensionShape.LowerRightRow property {#lowerrightrow}

Represents lower right corner row index.

**Type:** Number

### WebExtensionShape.LowerDeltaY property {#lowerdeltay}

Gets or sets the shape's vertical offset from its lower right corner row. The range of value is 0 to 256.

**Type:** Number

### WebExtensionShape.LowerRightColumn property {#lowerrightcolumn}

Represents lower right corner column index.

**Type:** Number

### WebExtensionShape.LowerDeltaX property {#lowerdeltax}

Gets or sets the shape's horizontal offset from its lower right corner column. The range of value is 0 to 1024.

**Type:** Number

### WebExtensionShape.Right property {#right}

Represents the width of the shape's horizontal offset from its lower right corner column, in unit of pixels.

**Type:** Number

### WebExtensionShape.Bottom property {#bottom}

Represents the width of the shape's vertical offset from its lower bottom corner row, in unit of pixels.

**Type:** Number

### WebExtensionShape.Width property {#width}

Represents the width of shape, in unit of pixels.

**Type:** Number

### WebExtensionShape.WidthInch property {#widthinch}

Represents the width of the shape, in unit of inch.

**Type:** Number

### WebExtensionShape.WidthPt property {#widthpt}

Represents the width of the shape, in unit of point.

**Type:** Number

### WebExtensionShape.WidthCM property {#widthcm}

Represents the width of the shape, in unit of centimeters.

**Type:** Number

### WebExtensionShape.Height property {#height}

Represents the height of shape, in unit of pixel.

**Type:** Number

### WebExtensionShape.HeightInch property {#heightinch}

Represents the height of the shape, in unit of inches.

**Type:** Number

### WebExtensionShape.HeightPt property {#heightpt}

Represents the height of the shape, in unit of points.

**Type:** Number

### WebExtensionShape.HeightCM property {#heightcm}

Represents the height of the shape, in unit of centimeters.

**Type:** Number

### WebExtensionShape.Left property {#left}

Represents the horizontal offset of shape from its left column, in unit of pixels.

**Type:** Number

### WebExtensionShape.LeftInch property {#leftinch}

Represents the horizontal offset of shape from its left column, in unit of inches.

**Type:** Number

### WebExtensionShape.LeftCM property {#leftcm}

Represents the horizontal offset of shape from its left column, in unit of centimeters.

**Type:** Number

### WebExtensionShape.Top property {#top}
...
### WebExtensionShape.TopInch property {#topinch}

Represents the vertical offset of shape from its top row, in unit of inches.

**Type:** Number

### WebExtensionShape.TopCM property {#topcm}

Represents the vertical offset of shape from its top row, in unit of centimeters.

**Type:** Number

### WebExtensionShape.TopToCorner property {#toptocorner}

Gets and sets the vertical offset of shape from worksheet top border, in unit of pixels.

**Type:** Number

### WebExtensionShape.LeftToCorner property {#lefttocorner}

Gets and sets the horizonal offset of shape from worksheet left border.

**Type:** Number

### WebExtensionShape.X property {#x}

Gets and sets the horizontal offset of shape from worksheet left border,in unit of pixels.

**Type:** Number

### WebExtensionShape.Y property {#y}

Gets and sets the vertical offset of shape from worksheet top border,in unit of pixels.

**Type:** Number

### WebExtensionShape.WidthScale property {#widthscale}
...
### WebExtensionShape.HeightScale property {#heightscale}
...
### WebExtensionShape.TopInShape property {#topinshape}
...
### WebExtensionShape.LeftInShape property {#leftinshape}
...
### WebExtensionShape.WidthInShape property {#widthinshape}
...
### WebExtensionShape.HeightInShape property {#heightinshape}

Represents the vertical offset of shape from the top border of the parent shape, in unit of 1/4000 of height of the parent shape.. Only Applies when this shape in the group or chart.

**Type:** Number

### WebExtensionShape.Group property {#group}

Gets the group shape which contains this shape.

**Type:** GroupShape

### WebExtensionShape.Type property {#type}

Gets the auto shape type. The value of the property is AutoShapeType integer constant.

**Type:** Number

### WebExtensionShape.HasLine property {#hasline}

Gets and sets the line border of the shape is visible.

**Type:** boolean

### WebExtensionShape.IsFilled property {#isfilled}

Indicates whether the fill format is visible.

**Type:** boolean

### WebExtensionShape.IsFlippedHorizontally property {#isflippedhorizontally}

Gets and sets whether shape is horizontally flipped .

**Type:** boolean

### WebExtensionShape.IsFlippedVertically property {#isflippedvertically}

Gets and sets whether shape is vertically flipped .

**Type:** boolean

### WebExtensionShape.ActualLowerRightRow property {#actuallowerrightrow}

Get the actual bottom row.

**Type:** Number

### WebExtensionShape.RelativeToOriginalPictureSize property {#relativetooriginalpicturesize}

Indicates whether shape is relative to original picture size.

**Type:** boolean

### WebExtensionShape.LinkedCell property {#linkedcell}

Gets or sets the worksheet range linked to the control's value.

**Type:** String

### WebExtensionShape.InputRange property {#inputrange}

Gets or sets the worksheet range used to fill the specified combo box.

**Type:** String

### WebExtensionShape.TextShapeType property {#textshapetype}

Gets and sets the preset text shape type. The value of the property is AutoShapeType integer constant.

**Type:** Number

### WebExtensionShape.TextBody property {#textbody}

Gets and sets the setting of the shape's text.

**Type:** FontSettingCollection

### WebExtensionShape.Font property {#font}

Represents the font of shape.

**Type:** Font

### WebExtensionShape.TextOptions property {#textoptions}

Represents the text options of the shape.

**Type:** TextOptions

### WebExtensionShape.Text property {#text}

Gets and sets the text of this shape.

**Type:** String

### WebExtensionShape.IsRichText property {#isrichtext}

Whether or not the text is rich text.

**Type:** boolean

### WebExtensionShape.HtmlText property {#htmltext}

Gets and sets the html string which contains data and some formats in this textbox.

**Type:** String

### WebExtensionShape.TextVerticalOverflow property {#textverticaloverflow}
...
### WebExtensionShape.TextHorizontalOverflow property {#texthorizontaloverflow}
...
### WebExtensionShape.IsTextWrapped property {#istextwrapped}

Gets and sets the text wrapped type of the shape which contains text.

**Type:** boolean

### WebExtensionShape.TextOrientationType property {#textorientationtype}

Gets and sets the text orientation type of the shape. The value of the property is TextOrientationType integer constant.

**Type:** Number

### WebExtensionShape.TextHorizontalAlignment property {#texthorizontalalignment}
...
### WebExtensionShape.TextVerticalAlignment property {#textverticalalignment}
...
### WebExtensionShape.TextDirection property {#textdirection}

Gets/Sets the direction of the text flow for this object. The value of the property is TextDirectionType integer constant.

**Type:** Number

### WebExtensionShape.TextBoxOptions property {#textboxoptions}

**Type:** TextBoxOptions

### WebExtensionShape.ControlData property {#controldata}

Gets the data of control.

**Type:** byte[]

### WebExtensionShape.ActiveXControl property {#activexcontrol}

Gets the ActiveX control.

**Type:** ActiveXControl

### WebExtensionShape.Paths property {#paths}

Gets the paths of a custom geometric shape.

**Type:** ShapePathCollection

### WebExtensionShape.Geometry property {#geometry}

Gets the geometry

**Type:** Geometry

### WebExtensionShape.CreateId property {#createid}

Gets and sets create id for this shape.

**Type:** UUID

### WebExtensionShape.IsDecorative property {#isdecorative}
