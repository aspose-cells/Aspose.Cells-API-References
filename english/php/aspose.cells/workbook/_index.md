...
type: docs
weight: 7540
url: /cells/php/aspose.cells/workbook/
---
...
| [CountOfStylesInPool](#countofstylesinpool) | Number | Gets number of the styles in the style pool. |
...
| [FileFormat](#fileformat) | Number | Gets and sets the file format. The value of the property is FileFormatType integer constant. |
