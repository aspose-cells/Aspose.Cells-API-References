...
| [CalcStackSize](#calcstacksize) | Number | The stack size for calculating cells recursively. Default value is 200. When there are large amount of cells need to be  |
| [PrecisionStrategy](#precisionstrategy) | Number | Specifies the strategy for processing precision of calculation. The value of the property is CalculationPrecisionStrateg |
