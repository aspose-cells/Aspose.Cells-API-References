...
articleTitle: "CellsDrawing"
second_title: "Aspose.Cells for PHP via Java"
description: "Represents the auto shape and drawing object."
type: docs
weight: 650
url: /cells/php/aspose.cells/cellsdrawing/
---
...
### CellsDrawing.MacroName property {#macroname}

Gets and sets the name of macro.

**Type:** String

### CellsDrawing.IsEquation property {#isequation}

Indicates whether the shape only contains an equation.

**Type:** boolean

### CellsDrawing.IsSmartArt property {#issmartart}

Indicates whether the shape is a smart art. Only for ooxml file.

**Type:** boolean

### CellsDrawing.ZOrderPosition property {#zorderposition}

Returns the position of a shape in the z-order.

**Type:** Number

### CellsDrawing.Name property {#name}

Gets and sets the name of the shape.

**Type:** String

### CellsDrawing.AlternativeText property {#alternativetext}

Returns or sets the descriptive (alternative) text string of the Shape object.

**Type:** String

### CellsDrawing.Title property {#title}

Specifies the title (caption) of the current shape object.

**Type:** String

### CellsDrawing.LineFormat property {#lineformat}
...
### CellsDrawing.FillFormat property {#fillformat}
...
### CellsDrawing.Glow property {#glow}

Represents a GlowEffect object that specifies glow effect for the chart element or shape.

**Type:** GlowEffect

### CellsDrawing.SoftEdges property {#softedges}

Gets and sets the radius of blur to apply to the edges, in unit of points.

**Type:** Number

### CellsDrawing.ThreeDFormat property {#threedformat}

Gets and sets 3d format of the shape.

**Type:** ThreeDFormat

### CellsDrawing.FormatPicture property {#formatpicture}

Gets and sets the options of the picture format.

**Type:** MsoFormatPicture

### CellsDrawing.IsHidden property {#ishidden}

Indicates whether the object is visible.

**Type:** boolean

### CellsDrawing.IsLockAspectRatio property {#islockaspectratio}
...
### CellsDrawing.IsAspectRatioLocked property {#isaspectratiolocked}

True means that aspect ratio of the shape is locked. Only for pictures and Ole Objects.

**Type:** boolean

### CellsDrawing.RotationAngle property {#rotationangle}

Gets and sets the rotation of the shape.

**Type:** Number

### CellsDrawing.Hyperlink property {#hyperlink}

Gets the hyperlink of the shape.

**Type:** Hyperlink

### CellsDrawing.Id property {#id}

Gets the identifier of this shape.

**Type:** Number

### CellsDrawing.Spid property {#spid}

Specifies an optional string identifier that an application can use to identify the particular shape.

**Type:** String

### CellsDrawing.Spt property {#spt}

Specifies an optional number that an application can use to associate the particular shape with a defined shape type.

**Type:** Number

### CellsDrawing.Worksheet property {#worksheet}

Gets the Worksheet object which contains this shape.

**Type:** Worksheet

### CellsDrawing.IsGroup property {#isgroup}

Indicates whether this shape is a group shape.

**Type:** boolean

### CellsDrawing.IsInGroup property {#isingroup}

Indicates whether the shape is grouped.

**Type:** boolean

### CellsDrawing.IsWordArt property {#iswordart}

Indicates whether this shape is a word art. Only for the Legacy Shape of xls file.

**Type:** boolean

### CellsDrawing.TextEffect property {#texteffect}
...
### CellsDrawing.IsLocked property {#islocked}
...
### CellsDrawing.UpperLeftRow property {#upperleftrow}

Represents the top row index. If the shape is in the shape or in the group , UpperLeftRow will be ignored.

**Type:** Number

### CellsDrawing.UpperDeltaY property {#upperdeltay}

Gets or sets the shape's vertical offset from its upper left corner row. The range of value is 0 to 256.

**Type:** Number

### CellsDrawing.UpperLeftColumn property {#upperleftcolumn}

Represents upper left corner column index.

**Type:** Number

### CellsDrawing.UpperDeltaX property {#upperdeltax}

Gets or sets the shape's horizontal offset from its upper left corner column. The range of value is 0 to 1024.

**Type:** Number

### CellsDrawing.LowerRightRow property {#lowerrightrow}

Represents lower right corner row index.

**Type:** Number

### CellsDrawing.LowerDeltaY property {#lowerdeltay}

Gets or sets the shape's vertical offset from its lower right corner row. The range of value is 0 to 256.

**Type:** Number

### CellsDrawing.LowerRightColumn property {#lowerrightcolumn}

Represents lower right corner column index.

**Type:** Number

### CellsDrawing.LowerDeltaX property {#lowerdeltax}

Gets or sets the shape's horizontal offset from its lower right corner column. The range of value is 0 to 1024.

**Type:** Number

### CellsDrawing.Right property {#right}

Represents the width of the shape's horizontal offset from its lower right corner column, in unit of pixels.

**Type:** Number

### CellsDrawing.Bottom property {#bottom}

Represents the width of the shape's vertical offset from its lower bottom corner row, in unit of pixels.

**Type:** Number

### CellsDrawing.Width property {#width}

Represents the width of shape, in unit of pixels.

**Type:** Number

### CellsDrawing.WidthInch property {#widthinch}

Represents the width of the shape, in unit of inch.

**Type:** Number

### CellsDrawing.WidthPt property {#widthpt}

Represents the width of the shape, in unit of point.

**Type:** Number

### CellsDrawing.WidthCM property {#widthcm}

Represents the width of the shape, in unit of centimeters.

**Type:** Number

### CellsDrawing.Height property {#height}

Represents the height of shape, in unit of pixel.

**Type:** Number

### CellsDrawing.HeightInch property {#heightinch}

Represents the height of the shape, in unit of inches.

**Type:** Number

### CellsDrawing.HeightPt property {#heightpt}

Represents the height of the shape, in unit of points.

**Type:** Number

### CellsDrawing.HeightCM property {#heightcm}

Represents the height of the shape, in unit of centimeters.

**Type:** Number

### CellsDrawing.Left property {#left}

Represents the horizontal offset of shape from its left column, in unit of pixels.

**Type:** Number

### CellsDrawing.LeftInch property {#leftinch}

Represents the horizontal offset of shape from its left column, in unit of inches.

**Type:** Number

### CellsDrawing.LeftCM property {#leftcm}

Represents the horizontal offset of shape from its left column, in unit of centimeters.

**Type:** Number

### CellsDrawing.Top property {#top}
...
### CellsDrawing.TopInch property {#topinch}

Represents the vertical offset of shape from its top row, in unit of inches.

**Type:** Number

### CellsDrawing.TopCM property {#topcm}

Represents the vertical offset of shape from its top row, in unit of centimeters.

**Type:** Number

### CellsDrawing.TopToCorner property {#toptocorner}

Gets and sets the vertical offset of shape from worksheet top border, in unit of pixels.

**Type:** Number

### CellsDrawing.LeftToCorner property {#lefttocorner}

Gets and sets the horizonal offset of shape from worksheet left border.

**Type:** Number

### CellsDrawing.X property {#x}

Gets and sets the horizontal offset of shape from worksheet left border,in unit of pixels.

**Type:** Number

### CellsDrawing.Y property {#y}

Gets and sets the vertical offset of shape from worksheet top border,in unit of pixels.

**Type:** Number

### CellsDrawing.WidthScale property {#widthscale}
...
### CellsDrawing.HeightScale property {#heightscale}
...
### CellsDrawing.TopInShape property {#topinshape}
...
### CellsDrawing.LeftInShape property {#leftinshape}
...
### CellsDrawing.WidthInShape property {#widthinshape}
...
### CellsDrawing.HeightInShape property {#heightinshape}

Represents the vertical offset of shape from the top border of the parent shape, in unit of 1/4000 of height of the parent shape.. Only Applies when this shape in the group or chart.

**Type:** Number

### CellsDrawing.Group property {#group}

Gets the group shape which contains this shape.

**Type:** GroupShape

### CellsDrawing.Type property {#type}

Gets the auto shape type. The value of the property is AutoShapeType integer constant.

**Type:** Number

### CellsDrawing.HasLine property {#hasline}

Gets and sets the line border of the shape is visible.

**Type:** boolean

### CellsDrawing.IsFilled property {#isfilled}

Indicates whether the fill format is visible.

**Type:** boolean

### CellsDrawing.IsFlippedHorizontally property {#isflippedhorizontally}

Gets and sets whether shape is horizontally flipped .

**Type:** boolean

### CellsDrawing.IsFlippedVertically property {#isflippedvertically}

Gets and sets whether shape is vertically flipped .

**Type:** boolean

### CellsDrawing.ActualLowerRightRow property {#actuallowerrightrow}

Get the actual bottom row.

**Type:** Number

### CellsDrawing.RelativeToOriginalPictureSize property {#relativetooriginalpicturesize}

Indicates whether shape is relative to original picture size.

**Type:** boolean

### CellsDrawing.LinkedCell property {#linkedcell}

Gets or sets the worksheet range linked to the control's value.

**Type:** String

### CellsDrawing.InputRange property {#inputrange}

Gets or sets the worksheet range used to fill the specified combo box.

**Type:** String

### CellsDrawing.TextShapeType property {#textshapetype}

Gets and sets the preset text shape type. The value of the property is AutoShapeType integer constant.

**Type:** Number

### CellsDrawing.TextBody property {#textbody}

Gets and sets the setting of the shape's text.

**Type:** FontSettingCollection

### CellsDrawing.Font property {#font}

Represents the font of shape.

**Type:** Font

### CellsDrawing.TextOptions property {#textoptions}

Represents the text options of the shape.

**Type:** TextOptions

### CellsDrawing.Text property {#text}

Gets and sets the text of this shape.

**Type:** String

### CellsDrawing.IsRichText property {#isrichtext}

Whether or not the text is rich text.

**Type:** boolean

### CellsDrawing.HtmlText property {#htmltext}

Gets and sets the html string which contains data and some formats in this textbox.

**Type:** String

### CellsDrawing.TextVerticalOverflow property {#textverticaloverflow}
...
### CellsDrawing.TextHorizontalOverflow property {#texthorizontaloverflow}
...
### CellsDrawing.IsTextWrapped property {#istextwrapped}

Gets and sets the text wrapped type of the shape which contains text.

**Type:** boolean

### CellsDrawing.TextOrientationType property {#textorientationtype}

Gets and sets the text orientation type of the shape. The value of the property is TextOrientationType integer constant.

**Type:** Number

### CellsDrawing.TextHorizontalAlignment property {#texthorizontalalignment}
...
### CellsDrawing.TextVerticalAlignment property {#textverticalalignment}
...
### CellsDrawing.TextDirection property {#textdirection}

Gets/Sets the direction of the text flow for this object. The value of the property is TextDirectionType integer constant.

**Type:** Number

### CellsDrawing.TextBoxOptions property {#textboxoptions}

**Type:** TextBoxOptions

### CellsDrawing.ControlData property {#controldata}

Gets the data of control.

**Type:** byte[]

### CellsDrawing.Paths property {#paths}

Gets the paths of a custom geometric shape.

**Type:** ShapePathCollection

### CellsDrawing.Geometry property {#geometry}

Gets the geometry

**Type:** Geometry

### CellsDrawing.CreateId property {#createid}

Gets and sets create id for this shape.

**Type:** UUID

### CellsDrawing.IsDecorative property {#isdecorative}
