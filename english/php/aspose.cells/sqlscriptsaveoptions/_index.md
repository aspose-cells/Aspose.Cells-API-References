...
| [OperatorType](#operatortype) | Number | Gets and sets the operator type of sql. The value of the property is SqlScriptOperatorType integer constant. |
...
| [StartId](#startid) | Number | Gets and sets the start id. Only works when IdName is set. |
