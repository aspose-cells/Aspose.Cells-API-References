...
type: docs
weight: 200
url: /go/aspose.cells.charts/chart/
---
...
|[Calculate](./calculate/) | Calculates the custom position of plot area, axes if the position of them are auto assigned, with Chart Calculate Options. | 
...
|[ToImage](./toimage/) | Creates the chart image and saves it to a file in the specified image type. | 
|[ToImage](./toimage/) | Creates the chart image and saves it to a file in the Jpeg format. | 
