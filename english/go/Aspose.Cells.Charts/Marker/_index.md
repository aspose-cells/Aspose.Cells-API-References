...
type: docs
weight: 200
url: /go/aspose.cells.charts/marker/
---
...
|[SetForegroundColorSetType](./setforegroundcolorsettype/) | Gets or sets the marker foreground color set type. | 
...
|[SetBackgroundColorSetType](./setbackgroundcolorsettype/) | Gets or sets the marker background color set type. | 
