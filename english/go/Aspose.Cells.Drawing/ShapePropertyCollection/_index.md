...
description: 'ShapePropertyCollection class. Encapsulates the object that represents shapepropertycollection in Go.'
type: docs
weight: 200
url: /go/aspose.cells.drawing/shapepropertycollection/
---
...
|[GetGlowEffect](./getgloweffect/) | Represents a <see cref="GlowEffect"/> object that specifies glow effect for the chart element or shape. | 
...
|[GetFormat3D](./getformat3d/) | Represents a <see cref="Format3D"/> object that specifies 3D shape properties for the chart element or shape. | 
...
|[GetShadowEffect](./getshadoweffect/) | Represents a <see cref="ShadowEffect"/> object that specifies shadow effect for the chart element or shape. | 
