...
type: docs
weight: 200
url: /go/aspose.cells.querytables/powerqueryformulaparametercollection/
---
...
|[Get](./get/) | Gets <see cref=" PowerQueryFormulaParameter"/> by the index in the list. | 
|[Get](./get/) | Gets <see cref=" PowerQueryFormulaParameter"/> by the name of the item. | 
|[GetCount](./getcount/) |  | 
