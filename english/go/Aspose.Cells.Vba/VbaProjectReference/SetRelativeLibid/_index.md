...
type: docs
weight: 200
url: /go/aspose.cells.vba/vbaprojectreference/setrelativelibid/
---

## SetRelativeLibid function

Gets and sets the referenced VBA project's identifier with an relative path.

```go

func (instance *VbaProjectReference) SetRelativeLibid_String(value string)  error
