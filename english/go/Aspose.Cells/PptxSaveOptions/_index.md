...
type: docs
weight: 200
url: /go/aspose.cells/pptxsaveoptions/
---
...
|[SetAdjustFontSizeForRowType](./setadjustfontsizeforrowtype/) | Represents what type of line needs to be adjusted size of font if height of row is small. | 
...
|[SetExportViewType](./setexportviewtype/) | Gets and sets the display type when exporting to PowerPoint.The default exporting type is working as printing. | 
