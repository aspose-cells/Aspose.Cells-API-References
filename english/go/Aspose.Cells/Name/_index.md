...
|[GetR1C1RefersTo](./getr1c1refersto/) | Gets or sets a R1C1 reference of the <see cref="Name"/>. | 
|[SetR1C1RefersTo](./setr1c1refersto/) | Gets or sets a R1C1 reference of the <see cref="Name"/>. | 
|[GetRefersTo](./getrefersto/) | Get the reference of this Name. | 
|[GetRefersTo](./getrefersto/) | Get the reference of this Name based on specified cell. | 
...
|[GetRange](./getrange/) | Gets the range if this name refers to a range | 
|[GetRange](./getrange/) | Gets the range if this name refers to a range.If the reference of this name is not absolute, the range may be different for different cell. | 
