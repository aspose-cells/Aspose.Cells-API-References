...
type: docs
weight: 200
url: /go/aspose.cells/settablepivotglobalizationsettings/settextoftotal/
---

## SetTextOfTotal function

Sets the text of "Total" label in the PivotTable.

```go

func (instance *SettablePivotGlobalizationSettings) SetTextOfTotal_String(text string)  error
