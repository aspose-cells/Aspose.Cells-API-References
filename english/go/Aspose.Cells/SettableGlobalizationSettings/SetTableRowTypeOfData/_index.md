...
type: docs
weight: 200
url: /go/aspose.cells/settableglobalizationsettings/settablerowtypeofdata/
---

## SetTableRowTypeOfData function

Sets the type name of table rows that consists of data region of referenced table.

```go

func (instance *SettableGlobalizationSettings) SetTableRowTypeOfData_String(name string)  error
