...
type: docs
weight: 200
url: /go/aspose.cells/settableglobalizationsettings/settablerowtypeofcurrent/
---

## SetTableRowTypeOfCurrent function

Sets the type name of table rows that consists of the current row in referenced table.

```go

func (instance *SettableGlobalizationSettings) SetTableRowTypeOfCurrent_String(name string)  error
