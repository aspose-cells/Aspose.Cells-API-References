...
type: docs
weight: 200
url: /go/aspose.cells/settableglobalizationsettings/settablerowtypeofheaders/
---

## SetTableRowTypeOfHeaders function

Sets the type name of table rows that consists of the table header.

```go

func (instance *SettableGlobalizationSettings) SetTableRowTypeOfHeaders_String(name string)  error
