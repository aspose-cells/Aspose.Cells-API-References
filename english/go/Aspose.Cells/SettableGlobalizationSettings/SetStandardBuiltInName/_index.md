...
type: docs
weight: 200
url: /go/aspose.cells/settableglobalizationsettings/setstandardbuiltinname/
---

## SetStandardBuiltInName function

Sets the locale dependent function name according to given standard function name.

```go

func (instance *SettableGlobalizationSettings) SetStandardBuiltInName_String_String_Bool(localname string, standardname string, bidirectional bool)  error
