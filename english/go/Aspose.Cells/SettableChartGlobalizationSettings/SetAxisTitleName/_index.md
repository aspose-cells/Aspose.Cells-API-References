...
type: docs
weight: 200
url: /go/aspose.cells/settablechartglobalizationsettings/setaxistitlename/
---

## SetAxisTitleName function

Sets the name of Title for Axis.

```go

func (instance *SettableChartGlobalizationSettings) SetAxisTitleName_String(name string)  error
