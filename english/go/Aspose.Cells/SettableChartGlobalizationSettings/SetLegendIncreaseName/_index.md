...
type: docs
weight: 200
url: /go/aspose.cells/settablechartglobalizationsettings/setlegendincreasename/
---

## SetLegendIncreaseName function

Sets the name of increase for Legend.

```go

func (instance *SettableChartGlobalizationSettings) SetLegendIncreaseName_String(name string)  error
