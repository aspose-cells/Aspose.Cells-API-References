...
| [AbstractLowCodeSaveOptionsProvider](./abstractlowcodesaveoptionsprovider) | Implementation to provide multiple save options for processes that require multiple outputs. For example, [SpreadsheetSplitter](../javascript-cpp/spreadsheetsplitter/) feature requires multiple destinations to save the split files. |
...
| [BorderCollection](./bordercollection) | Encapsulates a collection of [Border](../javascript-cpp/border/) objects. |
...
| [CommentCollection](./commentcollection) | Encapsulates a collection of [Comment](../javascript-cpp/comment/) objects. |
| [CommentShape](./commentshape) | Represents the shape of the comment. |
| [ConditionalFormattingCollection](./conditionalformattingcollection) | Encapsulates a collection of [FormatCondition](../javascript-cpp/formatcondition/) objects. |
| [ConditionalFormattingIcon](./conditionalformattingicon) | Represents  the custom  icon of conditional formatting rule. |
| [ConditionalFormattingIconCollection](./conditionalformattingiconcollection) | Represents  a collection of [ConditionalFormattingIcon](../javascript-cpp/conditionalformattingicon/) objects. |
...
| [ConnectionParameterCollection](./connectionparametercollection) | Specifies the [ConnectionParameter](../javascript-cpp/connectionparameter/) collection |
| [ContentTypeProperty](./contenttypeproperty) | Represents identifier information. |
| [ContentTypePropertyCollection](./contenttypepropertycollection) | A collection of [ContentTypeProperty](../javascript-cpp/contenttypeproperty/) objects that represent additional information. |
...
| [DocumentPropertyCollection](./documentpropertycollection) | Base class for [BuiltInDocumentPropertyCollection](../javascript-cpp/builtindocumentpropertycollection/) and [CustomDocumentPropertyCollection](../javascript-cpp/customdocumentpropertycollection/) collections. |
...
| [ExternalConnectionCollection](./externalconnectioncollection) | Specifies the [ExternalConnection](../javascript-cpp/externalconnection/) collection |
...
| [ImageSaveOptions](./imagesaveoptions) | Represents image save options. For advanced usage, please use [WorkbookRender](../javascript-cpp/workbookrender/) or [SheetRender](../javascript-cpp/sheetrender/). |
| [ImportTableOptions](./importtableoptions) | Represents the options of importing data into cells. |
| [IndividualFontConfigs](./individualfontconfigs) | Font configs for each [Workbook](../javascript-cpp/workbook/) object. |
...
| [LegendEntryCollection](./legendentrycollection) | Represents a collection of all the [LegendEntry](../javascript-cpp/legendentry/) objects in the specified chart legend. |
...
| [LowCodeSaveOptionsProviderOfAssembling](./lowcodesaveoptionsproviderofassembling) | Implementation to provide save options which save split parts to files and the path of resultant file are named as(it may contains directories): [PathHeader](../javascript-cpp/pathheader/)+[SheetPrefix](../javascript-cpp/sheetprefix/)+SheetIndex(or SheetName) +[SplitPartPrefix](../javascript-cpp/splitpartprefix/)+SplitPartIndex+[PathTail](../javascript-cpp/pathtail/). |
...
| [NameCollection](./namecollection) | Represents a collection of all the [Name](../javascript-cpp/name/) objects in the spreadsheet. |
...
| [PictureCollection](./picturecollection) | Encapsulates a collection of [Picture](../javascript-cpp/picture/) objects. |
...
| [PivotAreaFilter](./pivotareafilter) | Represents the filter of [PivotArea](../javascript-cpp/pivotarea/) for [PivotTable](../javascript-cpp/pivottable/). |
| [PivotAreaFilterCollection](./pivotareafiltercollection) | Represents the list of filters for [PivotArea](../javascript-cpp/pivotarea/) |
...
| [ProtectedRangeCollection](./protectedrangecollection) | Encapsulates a collection of [ProtectedRange](../javascript-cpp/protectedrange/) objects. |
...
| [QueryTableCollection](./querytablecollection) | A collection of [QueryTableCollection](../javascript-cpp/querytablecollection/) objects that represent QueryTable collection information. |
...
| [RangeCollection](./rangecollection) | Encapsulates a collection of [Range](../javascript-cpp/range/) objects. |
...
| [RowCollection](./rowcollection) | Collects the [Row](../javascript-cpp/row/) objects that represent the individual rows in a worksheet. |
...
| [SeriesCollection](./seriescollection) | Encapsulates a collection of [Series](../javascript-cpp/series/) objects. |
...
| [SmartTagSetting](./smarttagsetting) | Represents all [SmartTagCollection](../javascript-cpp/smarttagcollection/) object in the worksheet. |
...
| [TextBoxCollection](./textboxcollection) | Encapsulates a collection of [TextBox](../javascript-cpp/textbox/) objects. |
...
| [VbaModuleCollection](./vbamodulecollection) | Represents the list of [VbaModule](../javascript-cpp/vbamodule/) |
...
| [VerticalPageBreakCollection](./verticalpagebreakcollection) | Encapsulates a collection of [VerticalPageBreak](../javascript-cpp/verticalpagebreak/) objects. |
...
| [WorksheetCollection](./worksheetcollection) | Encapsulates a collection of [Worksheet](../javascript-cpp/worksheet/) objects. |
...
| [XmlMapCollection](./xmlmapcollection) | A collection of [XmlMap](../javascript-cpp/xmlmap/) objects that represent XmlMap information. |
...
| [FormattingType](./formattingtype) | Represents the type of formatting applied to an [Area](../javascript-cpp/area/) object or a [Line](../javascript-cpp/line/) object. |
...
| [LineType](./linetype) | Enumerates the type of [Picture](../javascript-cpp/picture/) border or [Chart](../javascript-cpp/chart/) line. |
...
| [PdfCustomPropertiesExport](./pdfcustompropertiesexport) | Specifies the way [CustomDocumentPropertyCollection](../javascript-cpp/customdocumentpropertycollection/) are exported to PDF file. |
