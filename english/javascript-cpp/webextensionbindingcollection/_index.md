...
description: Represents the list of binding relationships between an Office Addin and the data in the document.
type: docs
url: /javascript-cpp/webextensionbindingcollection/
---
