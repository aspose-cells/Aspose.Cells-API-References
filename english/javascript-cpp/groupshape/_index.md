...
### Example
```javascript
const { Workbook, PlacementType, FillType, Color, MsoLineStyle, MsoLineDashStyle, SaveFormat } = AsposeCells;
...
//Save the excel file.
var uint8Array = excelbook.save(SaveFormat.Xlsx);
```
## Constructors
...
| Method | Description |
| --- | --- |
| [get(number)](#get-number-)| Gets the child shape by index. |
