...
type: docs
url: /javascript-cpp/pdfcustompropertiesexport/
---

## PdfCustomPropertiesExport enumeration
Specifies the way [CustomDocumentPropertyCollection](../customdocumentpropertycollection/) are exported to PDF file.
### Values
