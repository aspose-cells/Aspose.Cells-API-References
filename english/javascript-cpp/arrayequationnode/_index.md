---
title: ArrayEquationNode
second_title: Aspose.Cells for JavaScript via C++ API Reference
description: Specifies the EquationArray function an object consisting of one or more equations.
type: docs
url: /javascript-cpp/arrayequationnode/
---
...
```javascript
class ArrayEquationNode extends EquationNode;
```
