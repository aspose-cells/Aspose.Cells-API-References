...
| [constructor(string)](#constructor-string-)| Constructs a Color object according to the specified color name (red, yellow, green, etc.). |
...
Constructs a Color object according to the specified color name (red, yellow, green, etc.).
