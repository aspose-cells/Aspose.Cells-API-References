...
| Hundreds | 1 | <br>Specifies that the values on the chart shall be divided by 100. |
| Thousands | 2 | <br>Specifies the values on the chart shall be divided by 1,000. |
| TenThousands | 3 | <br>Specifies that the values on the chart shall be divided by 10,000. |
| HundredThousands | 4 | <br>Specifies the values on the chart shall be divided by 100,000. |
| Millions | 5 | <br>Specifies that the values on the chart shall be divided by 1,000,000. |
| TenMillions | 6 | <br>Specifies the values on the chart shall be divided by 10,000,000. |
| HundredMillions | 7 | <br>Specifies that the values on the chart shall be divided by 100,000,000. |
| Billions | 8 | <br>Specifies the values on the chart shall be divided by 1,000,000,000. |
| Trillions | 9 | <br>Specifies that the values on the chart shall be divided by 1,000,000,000,000. |
