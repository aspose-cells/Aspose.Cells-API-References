...
description: 'Aspose::Cells::Charts::SeriesCollection::SetSecondCategoryData method. Gets or sets the range of second category Axis values. It can be a range of cells (such as, "d1:e10"), or a sequence of values (such as,"{2,6,8,10}"). Only effects when some ASerieses plot on the second axis in C++.'
type: docs
weight: 1200
url: /cpp/aspose.cells.charts/seriescollection/setsecondcategorydata/
---
