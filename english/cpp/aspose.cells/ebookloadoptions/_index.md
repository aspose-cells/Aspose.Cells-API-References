...
| [GetParagrahLayoutMode()](../htmlloadoptions/getparagrahlayoutmode/) |  **(Deprecated)** Specifies how HTML <p> elements are rendered when loading HTML. The default value is HtmlParagraphLayoutMode.Normal. |
| [GetParagraphLayoutMode()](../htmlloadoptions/getparagraphlayoutmode/) | Specifies how HTML <p> elements are rendered when loading HTML. The default value is HtmlParagraphLayoutMode.Normal. |
...
| [SetParagrahLayoutMode(HtmlParagraphLayoutMode value)](../htmlloadoptions/setparagrahlayoutmode/) |  **(Deprecated)** Specifies how HTML <p> elements are rendered when loading HTML. The default value is HtmlParagraphLayoutMode.Normal. |
| [SetParagraphLayoutMode(HtmlParagraphLayoutMode value)](../htmlloadoptions/setparagraphlayoutmode/) | Specifies how HTML <p> elements are rendered when loading HTML. The default value is HtmlParagraphLayoutMode.Normal. |
