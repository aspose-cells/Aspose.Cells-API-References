---
title: Aspose::Cells::CellsHelper class
...
| static [GetSignificantDigitsType()](./getsignificantdigitstype/) | Gets and sets the default type of significant digits for outputting numeric values. Default value is [SignificantDigitsType.G17](../significantdigitstype/). |
...
| static [SetSignificantDigitsType(SignificantDigitsType value)](./setsignificantdigitstype/) | Gets and sets the default type of significant digits for outputting numeric values. Default value is [SignificantDigitsType.G17](../significantdigitstype/). |
