...
| [Select(const Date\& start, const Date\& end, bool calculate)](./select/) | Select item between the date time. |
...
| [SetShowHeader(bool value)](./setshowheader/) | Indicates whether to display the header of this timeline. |
| [SetShowHorizontalScrollbar(bool value)](./setshowhorizontalscrollbar/) | Indicates whether to display the horizontal scroll bar. |
| [SetShowSelectionLabel(bool value)](./setshowselectionlabel/) | Indicates whether to display the selction label. |
| [SetShowTimeLevel(bool value)](./setshowtimelevel/) | Indicates whether to display the drop-down selection box of the time level. |
