...
| [GetMergeEmptyTdType()](../../aspose.cells/htmlsaveoptions/getmergeemptytdtype/) | Indicates if empty TD element will be merged in the same way as MS Excel when saving an Excel file in html format. The default value is [MergeEmptyTdType.Default](../../aspose.cells/mergeemptytdtype/). |
...
| [SetMergeEmptyTdType(MergeEmptyTdType value)](../../aspose.cells/htmlsaveoptions/setmergeemptytdtype/) | Indicates if empty TD element will be merged in the same way as MS Excel when saving an Excel file in html format. The default value is [MergeEmptyTdType.Default](../../aspose.cells/mergeemptytdtype/). |
