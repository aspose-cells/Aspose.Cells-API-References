---
title: Aspose::Cells::ExternalConnections::DBConnection class
linktitle: DBConnection
second_title: Aspose.Cells for C++ API Reference
description: 'Aspose::Cells::ExternalConnections::DBConnection class. Specifies all properties associated with an ODBC or OLE DB external data connection in C++.'
type: docs
weight: 400
url: /cpp/aspose.cells.externalconnections/dbconnection/
---
## DBConnection class
...
| [GetConnectionId()](../externalconnection/getconnectionid/) | Specifies The unique identifier of this connection. |
...
| [GetType()](../externalconnection/gettype/) | Gets or Sets the external connection DataSource type. |
...
| [SetConnectionInfo(const U16String\& value)](./setconnectioninfo/) | The connection information string is used to make contact with an OLE DB or ODBC data source. |
| [SetConnectionInfo(const char16_t* value)](./setconnectioninfo/) | The connection information string is used to make contact with an OLE DB or ODBC data source. |
...
| [SetSeverCommand(const U16String\& value)](./setsevercommand/) | Specifies a second command text string that is persisted when PivotTable server-based page fields are in use. For ODBC connections, serverCommand is usually a broader query than command (no WHERE clause is present in the former). Based on these 2 commands(Command and ServerCommand), parameter UI can be populated and parameterized queries can be constructed. |
| [SetSeverCommand(const char16_t* value)](./setsevercommand/) | Specifies a second command text string that is persisted when PivotTable server-based page fields are in use. For ODBC connections, serverCommand is usually a broader query than command (no WHERE clause is present in the former). Based on these 2 commands(Command and ServerCommand), parameter UI can be populated and parameterized queries can be constructed. |
...
| [SetType(ConnectionDataSourceType value)](../externalconnection/settype/) | Gets or Sets the external connection DataSource type. |
