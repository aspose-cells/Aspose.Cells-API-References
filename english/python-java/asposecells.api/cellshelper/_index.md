...
| --- | --- | --- |
| [SignificantDigits](#significantdigits) | int | Gets and sets the number of significant digits. The default value is 17. Only could be 15 or 17 now. |
| [SignificantDigitsType](#significantdigitstype) | int | The value of the property is SignificantDigitsType integer constant. |
| [DPI](#dpi) | float | Gets the DPI of the machine. |
