...
type: docs
weight: 5730
url: /cells/python-java/asposecells.api/series/
---
...
| [CountOfDataValues](#countofdatavalues) | int | Gets the number of the data values. |
...
| [Bar3DShapeType](#bar3dshapetype) | int | Gets or sets the 3D shape type used with the 3-D bar or column chart. The value of the property is Bar3DShapeType intege |
| [DataLabels](#datalabels) | DataLabels | Represents the DataLabels object for the specified ASeries. |
| [Type](#type) | int | Gets or sets a data series' type. The value of the property is ChartType integer constant. |
...
| [Overlap](#overlap) | int | Specifies how bars and columns are positioned. Can be a value between – 100 and 100. Applies only to 2-D bar and 2-D col |
| [SecondPlotSize](#secondplotsize) | int | Returns or sets the size of the secondary section of either a pie of pie chart or a bar of pie chart, as a percentage of |
| [SplitType](#splittype) | int | Returns or sets a value that how to determine which data points are in the second pie or bar on a pie of pie or bar of p |
| [SplitValue](#splitvalue) | float | Returns or sets a value that shall be used to determine which data points are in the second pie or bar on a pie of pie o |
| [IsAutoSplit](#isautosplit) | boolean | Indicates whether the threshold value is automatic. |
| [BubbleScale](#bubblescale) | int | Gets or sets the scale factor for bubbles in the specified chart group. It can be an integer value from 0 (zero) to 300, |
| [SizeRepresents](#sizerepresents) | int | Gets or sets what the bubble size represents on a bubble chart. The value of the property is BubbleSizeRepresents intege |
...
| [DoughnutHoleSize](#doughnutholesize) | int | Returns or sets the size of the hole in a doughnut chart group. The hole size is expressed as a percentage of the chart  |
...
| [BubbleSizeRepresents](#bubblesizerepresents) | int | Gets what the bubble size represents on a bubble chart. The value of the property is BubbleSizeRepresents integer consta |
