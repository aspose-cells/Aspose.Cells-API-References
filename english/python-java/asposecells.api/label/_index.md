...
type: docs
weight: 3220
url: /cells/python-java/asposecells.api/label/
---
...
### Label.MacroName property {#macroname}

Gets and sets the name of macro.

**Type:** String

### Label.IsEquation property {#isequation}

Indicates whether the shape only contains an equation.

**Type:** boolean

### Label.IsSmartArt property {#issmartart}

Indicates whether the shape is a smart art. Only for ooxml file.

**Type:** boolean

### Label.ZOrderPosition property {#zorderposition}
...
### Label.AlternativeText property {#alternativetext}
...
### Label.LineFormat property {#lineformat}
...
### Label.FillFormat property {#fillformat}
...
### Label.Glow property {#glow}

Represents a GlowEffect object that specifies glow effect for the chart element or shape.

**Type:** GlowEffect

### Label.SoftEdges property {#softedges}

Gets and sets the radius of blur to apply to the edges, in unit of points.

**Type:** float

### Label.ThreeDFormat property {#threedformat}

Gets and sets 3d format of the shape.

**Type:** ThreeDFormat

### Label.FormatPicture property {#formatpicture}

Gets and sets the options of the picture format.

**Type:** MsoFormatPicture

### Label.IsHidden property {#ishidden}

Indicates whether the object is visible.

**Type:** boolean

### Label.IsLockAspectRatio property {#islockaspectratio}
...
### Label.IsAspectRatioLocked property {#isaspectratiolocked}

True means that aspect ratio of the shape is locked. Only for pictures and Ole Objects.

**Type:** boolean

### Label.RotationAngle property {#rotationangle}

Gets and sets the rotation of the shape.

**Type:** float

### Label.Hyperlink property {#hyperlink}
...
### Label.IsLocked property {#islocked}
...
### Label.WidthInch property {#widthinch}

Represents the width of the shape, in unit of inch.

**Type:** float

### Label.WidthPt property {#widthpt}

Represents the width of the shape, in unit of point.

**Type:** float

### Label.WidthCM property {#widthcm}
...
### Label.HeightInch property {#heightinch}

Represents the height of the shape, in unit of inches.

**Type:** float

### Label.HeightPt property {#heightpt}

Represents the height of the shape, in unit of points.

**Type:** float

### Label.HeightCM property {#heightcm}
...
### Label.LeftInch property {#leftinch}

Represents the horizontal offset of shape from its left column, in unit of inches.

**Type:** float

### Label.LeftCM property {#leftcm}
...
### Label.TopInch property {#topinch}

Represents the vertical offset of shape from its top row, in unit of inches.

**Type:** float

### Label.TopCM property {#topcm}

Represents the vertical offset of shape from its top row, in unit of centimeters.

**Type:** float

### Label.TopToCorner property {#toptocorner}

Gets and sets the vertical offset of shape from worksheet top border, in unit of pixels.

**Type:** int

### Label.LeftToCorner property {#lefttocorner}
...
### Label.WidthScale property {#widthscale}
...
### Label.HeightScale property {#heightscale}
...
### Label.TopInShape property {#topinshape}
...
### Label.LeftInShape property {#leftinshape}
...
### Label.WidthInShape property {#widthinshape}
...
### Label.HeightInShape property {#heightinshape}
...
### Label.HasLine property {#hasline}

Gets and sets the line border of the shape is visible.

**Type:** boolean

### Label.IsFilled property {#isfilled}

Indicates whether the fill format is visible.

**Type:** boolean

### Label.IsFlippedHorizontally property {#isflippedhorizontally}

Gets and sets whether shape is horizontally flipped .

**Type:** boolean

### Label.IsFlippedVertically property {#isflippedvertically}

Gets and sets whether shape is vertically flipped .

**Type:** boolean

### Label.ActualLowerRightRow property {#actuallowerrightrow}

Get the actual bottom row.

**Type:** int

### Label.RelativeToOriginalPictureSize property {#relativetooriginalpicturesize}

Indicates whether shape is relative to original picture size.

**Type:** boolean

### Label.LinkedCell property {#linkedcell}

Gets or sets the worksheet range linked to the control's value.

**Type:** String

### Label.InputRange property {#inputrange}

Gets or sets the worksheet range used to fill the specified combo box.

**Type:** String

### Label.TextShapeType property {#textshapetype}

Gets and sets the preset text shape type. The value of the property is AutoShapeType integer constant.

**Type:** int

### Label.TextBody property {#textbody}
...
### Label.TextOptions property {#textoptions}
...
### Label.IsRichText property {#isrichtext}

Whether or not the text is rich text.

**Type:** boolean

### Label.HtmlText property {#htmltext}

Gets and sets the html string which contains data and some formats in this textbox.

**Type:** String

### Label.TextVerticalOverflow property {#textverticaloverflow}
...
### Label.TextHorizontalOverflow property {#texthorizontaloverflow}
...
### Label.IsTextWrapped property {#istextwrapped}

Gets and sets the text wrapped type of the shape which contains text.

**Type:** boolean

### Label.TextOrientationType property {#textorientationtype}

Gets and sets the text orientation type of the shape. The value of the property is TextOrientationType integer constant.

**Type:** int

### Label.TextHorizontalAlignment property {#texthorizontalalignment}
...
### Label.TextVerticalAlignment property {#textverticalalignment}
...
### Label.TextDirection property {#textdirection}

Gets/Sets the direction of the text flow for this object. The value of the property is TextDirectionType integer constant.

**Type:** int

### Label.TextBoxOptions property {#textboxoptions}

**Type:** TextBoxOptions

### Label.ControlData property {#controldata}

Gets the data of control.

**Type:** byte[]

### Label.Paths property {#paths}

Gets the paths of a custom geometric shape.

**Type:** ShapePathCollection

### Label.Geometry property {#geometry}

Gets the geometry

**Type:** Geometry

### Label.CreateId property {#createid}

Gets and sets create id for this shape.

**Type:** UUID

### Label.IsDecorative property {#isdecorative}
