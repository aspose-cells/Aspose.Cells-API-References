...
articleTitle: "DifLoadOptions"
second_title: "Aspose.Cells for Python via Java"
description: ""
type: docs
weight: 1750
url: /cells/python-java/asposecells.api/difloadoptions/
---
...
### DifLoadOptions.LoadFormat property {#loadformat}

Gets the load format. The value of the property is LoadFormat integer constant.

**Type:** int

### DifLoadOptions.Password property {#password}

Gets and set the password of the workbook.

**Type:** String

### DifLoadOptions.ParsingFormulaOnOpen property {#parsingformulaonopen}
...
### DifLoadOptions.ParsingPivotCachedRecords property {#parsingpivotcachedrecords}
...
### DifLoadOptions.LanguageCode property {#languagecode}
...
### DifLoadOptions.Region property {#region}
...
### DifLoadOptions.Locale property {#locale}

Gets and sets the Locale used for workbook at the time the file was loaded.

**Type:** Locale

### DifLoadOptions.DefaultStyleSettings property {#defaultstylesettings}

Gets the default style settings for initializing styles of the workbook

**Type:** DefaultStyleSettings

### DifLoadOptions.StandardFont property {#standardfont}
...
### DifLoadOptions.StandardFontSize property {#standardfontsize}
...
### DifLoadOptions.InterruptMonitor property {#interruptmonitor}

Gets and sets the interrupt monitor.

**Type:** AbstractInterruptMonitor

### DifLoadOptions.IgnoreNotPrinted property {#ignorenotprinted}

Ignore the data which are not printed if directly printing the file Only for xlsx file.

**Type:** boolean

### DifLoadOptions.CheckDataValid property {#checkdatavalid}

Check whether data is valid in the template file.

**Type:** boolean

### DifLoadOptions.CheckExcelRestriction property {#checkexcelrestriction}
...
### DifLoadOptions.KeepUnparsedData property {#keepunparseddata}
...
### DifLoadOptions.LoadFilter property {#loadfilter}

The filter to denote how to load data.

**Type:** LoadFilter

### DifLoadOptions.LightCellsDataHandler property {#lightcellsdatahandler}

The data handler for processing cells data when reading template file.

**Type:** LightCellsDataHandler

### DifLoadOptions.MemorySetting property {#memorysetting}

Gets or sets the memory usage options. The value of the property is MemorySetting integer constant.

**Type:** int

### DifLoadOptions.WarningCallback property {#warningcallback}

Gets or sets warning callback.

**Type:** IWarningCallback

### DifLoadOptions.AutoFitterOptions property {#autofitteroptions}

Gets and sets the auto fitter options Only for xlsx ,spreadsheetML file now.

**Type:** AutoFitterOptions

### DifLoadOptions.AutoFilter property {#autofilter}
...
### DifLoadOptions.FontConfigs property {#fontconfigs}
...
### DifLoadOptions.IgnoreUselessShapes property {#ignoreuselessshapes}
...
### DifLoadOptions.PreservePaddingSpacesInFormula property {#preservepaddingspacesinformula}
