...
| [TotalsCalculation](#totalscalculation) | int | Gets and sets the type of calculation in the Totals row of the list column. The value of the property is TotalsCalculati |
