...
| [Pattern](#pattern) | int | Gets or sets the cell background pattern type. The value of the property is BackgroundType integer constant. |
...
| [BackgroundArgbColor](#backgroundargbcolor) | int | Gets and sets the background color with a 32-bit ARGB value. |
...
| [ForegroundArgbColor](#foregroundargbcolor) | int | Gets and sets the foreground color with a 32-bit ARGB value. |
...
| [IndentLevel](#indentlevel) | int | Represents the indent level for the cell or range. Can only be an integer from 0 to 250. If text horizontal alignment ty |
| [Font](#font) | Font | Gets a Font object. |
| [RotationAngle](#rotationangle) | int | Represents text rotation angle. 0: Not rotated. 255: Top to Bottom. -90: Downward. 90: Upward. You can set 255 or value  |
| [HorizontalAlignment](#horizontalalignment) | int | Gets or sets the horizontal alignment type of the text in a cell. The value of the property is TextAlignmentType integer |
| [VerticalAlignment](#verticalalignment) | int | Gets or sets the vertical alignment type of the text in a cell. The value of the property is TextAlignmentType integer c |
| [IsTextWrapped](#istextwrapped) | boolean | Gets or sets a value indicating whether the text within a cell is wrapped. |
| [Number](#number) | int | Gets or sets the display format of numbers and dates. The formatting patterns are different for different regions. For e |
...
| [TextDirection](#textdirection) | int | Represents text reading order. The value of the property is TextDirectionType integer constant. |
