...
| [CalculationMode](#calculationmode) | int | Gets or sets the mode for workbook calculation in ms excel. The value of the property is CalcModeType integer constant.  |
...
| [MaxIteration](#maxiteration) | int | The maximum iterations to resolve a circular reference. |
| [MaxChange](#maxchange) | float | The maximum change to resolve a circular reference. |
