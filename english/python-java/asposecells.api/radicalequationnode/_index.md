...
articleTitle: "RadicalEquationNode"
...
type: docs
weight: 5240
url: /cells/python-java/asposecells.api/radicalequationnode/
---
...
| --- | --- | --- |
| [IsDegHide](#isdeghide) | boolean | Whether to hide the degree of radicals. |
...
### RadicalEquationNode.IsDegHide property {#isdeghide}

Whether to hide the degree of radicals.

**Type:** boolean

### RadicalEquationNode.ParentNode property {#parentnode}

Specifies the parent node of the current node

**Type:** EquationNode

### RadicalEquationNode.Type property {#type}

Represents the type of the node. The value of the property is TextNodeType integer constant.

**Type:** int

### RadicalEquationNode.EquationType property {#equationtype}

Get the equation type of the current node The value of the property is EquationNodeType integer constant.

**Type:** int

### RadicalEquationNode.StartIndex property {#startindex}

Gets the start index of the characters.

**Type:** int

### RadicalEquationNode.Length property {#length}

Gets the length of the characters.

**Type:** int

### RadicalEquationNode.Font property {#font}

Returns the font of this object.

**Type:** Font

### RadicalEquationNode.TextOptions property {#textoptions}
