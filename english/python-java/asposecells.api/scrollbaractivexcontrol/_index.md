...
type: docs
weight: 5710
url: /cells/python-java/asposecells.api/scrollbaractivexcontrol/
---
...
| [LargeChange](#largechange) | int | Gets and sets the amount by which the Position property changes |
| [Min](#min) | int | Gets and sets the minimum acceptable value. |
| [Max](#max) | int | Gets and sets the maximum acceptable value. |
| [Position](#position) | int | Gets and sets the value. |
| [SmallChange](#smallchange) | int | Gets and sets the amount by which the Position property changes |
| [Orientation](#orientation) | int | Gets and sets whether the SpinButton or ScrollBar is oriented vertically or horizontally. The value of the property is C |
