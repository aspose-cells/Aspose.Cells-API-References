...
| [SelectedValue](#selectedvalue) | String | Gets the selected value of the combox box. |
| [SelectedCell](#selectedcell) | Cell | Gets the selected cell in the input range of the combo box. |
| [Shadow](#shadow) | boolean | Indicates whether the combobox has 3-D shading. |
| [DropDownLines](#dropdownlines) | int | Gets or sets the number of list lines displayed in the drop-down portion of a combo box. |
...
### ComboBox.SelectedIndex property {#selectedindex}
...
### ComboBox.SelectedValue property {#selectedvalue}

Gets the selected value of the combox box.

**Type:** String

### ComboBox.SelectedCell property {#selectedcell}

Gets the selected cell in the input range of the combo box.

**Type:** Cell

### ComboBox.Shadow property {#shadow}

Indicates whether the combobox has 3-D shading.

**Type:** boolean

### ComboBox.DropDownLines property {#dropdownlines}

Gets or sets the number of list lines displayed in the drop-down portion of a combo box.

**Type:** int

### ComboBox.MacroName property {#macroname}

Gets and sets the name of macro.

**Type:** String

### ComboBox.IsEquation property {#isequation}

Indicates whether the shape only contains an equation.

**Type:** boolean

### ComboBox.IsSmartArt property {#issmartart}

Indicates whether the shape is a smart art. Only for ooxml file.

**Type:** boolean

### ComboBox.ZOrderPosition property {#zorderposition}
...
### ComboBox.AlternativeText property {#alternativetext}

Returns or sets the descriptive (alternative) text string of the Shape object.

**Type:** String

### ComboBox.Title property {#title}

Specifies the title (caption) of the current shape object.

**Type:** String

### ComboBox.LineFormat property {#lineformat}
...
### ComboBox.FillFormat property {#fillformat}
...
### ComboBox.Glow property {#glow}

Represents a GlowEffect object that specifies glow effect for the chart element or shape.

**Type:** GlowEffect

### ComboBox.SoftEdges property {#softedges}

Gets and sets the radius of blur to apply to the edges, in unit of points.

**Type:** float

### ComboBox.ThreeDFormat property {#threedformat}

Gets and sets 3d format of the shape.

**Type:** ThreeDFormat

### ComboBox.FormatPicture property {#formatpicture}

Gets and sets the options of the picture format.

**Type:** MsoFormatPicture

### ComboBox.IsHidden property {#ishidden}

Indicates whether the object is visible.

**Type:** boolean

### ComboBox.IsLockAspectRatio property {#islockaspectratio}
...
### ComboBox.IsLocked property {#islocked}
...
### ComboBox.UpperLeftRow property {#upperleftrow}

Represents the top row index. If the shape is in the shape or in the group , UpperLeftRow will be ignored.

**Type:** int

### ComboBox.UpperDeltaY property {#upperdeltay}

Gets or sets the shape's vertical offset from its upper left corner row. The range of value is 0 to 256.

**Type:** int

### ComboBox.UpperLeftColumn property {#upperleftcolumn}

Represents upper left corner column index.

**Type:** int

### ComboBox.UpperDeltaX property {#upperdeltax}

Gets or sets the shape's horizontal offset from its upper left corner column. The range of value is 0 to 1024.

**Type:** int

### ComboBox.LowerRightRow property {#lowerrightrow}

Represents lower right corner row index.

**Type:** int

### ComboBox.LowerDeltaY property {#lowerdeltay}

Gets or sets the shape's vertical offset from its lower right corner row. The range of value is 0 to 256.

**Type:** int

### ComboBox.LowerRightColumn property {#lowerrightcolumn}

Represents lower right corner column index.

**Type:** int

### ComboBox.LowerDeltaX property {#lowerdeltax}

Gets or sets the shape's horizontal offset from its lower right corner column. The range of value is 0 to 1024.

**Type:** int

### ComboBox.Right property {#right}

Represents the width of the shape's horizontal offset from its lower right corner column, in unit of pixels.

**Type:** int

### ComboBox.Bottom property {#bottom}

Represents the width of the shape's vertical offset from its lower bottom corner row, in unit of pixels.

**Type:** int

### ComboBox.Width property {#width}

Represents the width of shape, in unit of pixels.

**Type:** int

### ComboBox.WidthInch property {#widthinch}

Represents the width of the shape, in unit of inch.

**Type:** float

### ComboBox.WidthPt property {#widthpt}

Represents the width of the shape, in unit of point.

**Type:** float

### ComboBox.WidthCM property {#widthcm}

Represents the width of the shape, in unit of centimeters.

**Type:** float

### ComboBox.Height property {#height}

Represents the height of shape, in unit of pixel.

**Type:** int

### ComboBox.HeightInch property {#heightinch}

Represents the height of the shape, in unit of inches.

**Type:** float

### ComboBox.HeightPt property {#heightpt}

Represents the height of the shape, in unit of points.

**Type:** float

### ComboBox.HeightCM property {#heightcm}

Represents the height of the shape, in unit of centimeters.

**Type:** float

### ComboBox.Left property {#left}

Represents the horizontal offset of shape from its left column, in unit of pixels.

**Type:** int

### ComboBox.LeftInch property {#leftinch}

Represents the horizontal offset of shape from its left column, in unit of inches.

**Type:** float

### ComboBox.LeftCM property {#leftcm}

Represents the horizontal offset of shape from its left column, in unit of centimeters.

**Type:** float

### ComboBox.Top property {#top}
...
### ComboBox.TopInch property {#topinch}

Represents the vertical offset of shape from its top row, in unit of inches.

**Type:** float

### ComboBox.TopCM property {#topcm}

Represents the vertical offset of shape from its top row, in unit of centimeters.

**Type:** float

### ComboBox.TopToCorner property {#toptocorner}

Gets and sets the vertical offset of shape from worksheet top border, in unit of pixels.

**Type:** int

### ComboBox.LeftToCorner property {#lefttocorner}

Gets and sets the horizonal offset of shape from worksheet left border.

**Type:** int

### ComboBox.X property {#x}

Gets and sets the horizontal offset of shape from worksheet left border,in unit of pixels.

**Type:** int

### ComboBox.Y property {#y}

Gets and sets the vertical offset of shape from worksheet top border,in unit of pixels.

**Type:** int

### ComboBox.WidthScale property {#widthscale}
...
### ComboBox.HeightScale property {#heightscale}
...
### ComboBox.TopInShape property {#topinshape}
...
### ComboBox.LeftInShape property {#leftinshape}
...
### ComboBox.WidthInShape property {#widthinshape}
...
### ComboBox.HeightInShape property {#heightinshape}

Represents the vertical offset of shape from the top border of the parent shape, in unit of 1/4000 of height of the parent shape.. Only Applies when this shape in the group or chart.

**Type:** int

### ComboBox.Group property {#group}

Gets the group shape which contains this shape.

**Type:** GroupShape

### ComboBox.Type property {#type}

Gets the auto shape type. The value of the property is AutoShapeType integer constant.

**Type:** int

### ComboBox.HasLine property {#hasline}

Gets and sets the line border of the shape is visible.

**Type:** boolean

### ComboBox.IsFilled property {#isfilled}

Indicates whether the fill format is visible.

**Type:** boolean

### ComboBox.IsFlippedHorizontally property {#isflippedhorizontally}

Gets and sets whether shape is horizontally flipped .

**Type:** boolean

### ComboBox.IsFlippedVertically property {#isflippedvertically}

Gets and sets whether shape is vertically flipped .

**Type:** boolean

### ComboBox.ActualLowerRightRow property {#actuallowerrightrow}

Get the actual bottom row.

**Type:** int

### ComboBox.RelativeToOriginalPictureSize property {#relativetooriginalpicturesize}

Indicates whether shape is relative to original picture size.

**Type:** boolean

### ComboBox.LinkedCell property {#linkedcell}

Gets or sets the worksheet range linked to the control's value.

**Type:** String

### ComboBox.InputRange property {#inputrange}

Gets or sets the worksheet range used to fill the specified combo box.

**Type:** String

### ComboBox.TextShapeType property {#textshapetype}

Gets and sets the preset text shape type. The value of the property is AutoShapeType integer constant.

**Type:** int

### ComboBox.TextBody property {#textbody}
...
### ComboBox.TextOptions property {#textoptions}

Represents the text options of the shape.

**Type:** TextOptions

### ComboBox.Text property {#text}

Gets and sets the text of this shape.

**Type:** String

### ComboBox.IsRichText property {#isrichtext}

Whether or not the text is rich text.

**Type:** boolean

### ComboBox.HtmlText property {#htmltext}

Gets and sets the html string which contains data and some formats in this textbox.

**Type:** String

### ComboBox.TextVerticalOverflow property {#textverticaloverflow}
...
### ComboBox.TextHorizontalOverflow property {#texthorizontaloverflow}
...
### ComboBox.IsTextWrapped property {#istextwrapped}

Gets and sets the text wrapped type of the shape which contains text.

**Type:** boolean

### ComboBox.TextOrientationType property {#textorientationtype}

Gets and sets the text orientation type of the shape. The value of the property is TextOrientationType integer constant.

**Type:** int

### ComboBox.TextHorizontalAlignment property {#texthorizontalalignment}
...
### ComboBox.TextVerticalAlignment property {#textverticalalignment}
...
### ComboBox.TextDirection property {#textdirection}

Gets/Sets the direction of the text flow for this object. The value of the property is TextDirectionType integer constant.

**Type:** int

### ComboBox.TextBoxOptions property {#textboxoptions}

**Type:** TextBoxOptions

### ComboBox.ControlData property {#controldata}

Gets the data of control.

**Type:** byte[]

### ComboBox.Paths property {#paths}

Gets the paths of a custom geometric shape.

**Type:** ShapePathCollection

### ComboBox.Geometry property {#geometry}

Gets the geometry

**Type:** Geometry

### ComboBox.CreateId property {#createid}

Gets and sets create id for this shape.

**Type:** UUID

### ComboBox.IsDecorative property {#isdecorative}
