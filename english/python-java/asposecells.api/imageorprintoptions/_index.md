...
articleTitle: "ImageOrPrintOptions"
...
| --- | --- | --- |
| [SaveFormat](#saveformat) | int | Gets or sets the output file format type Support Tiff/XPS The value of the property is SaveFormat integer constant. NOTE |
...
| [HorizontalResolution](#horizontalresolution) | int | Gets or sets the horizontal resolution for generated images, in dots per inch. Applies generating image method except Em |
| [VerticalResolution](#verticalresolution) | int | Gets or sets the vertical resolution for generated images, in dots per inch. Applies generating image method except Emf  |
| [TiffCompression](#tiffcompression) | int | Gets or sets the type of compression to apply only when saving pages to the Tiff format. The value of the property is Ti |
| [TiffColorDepth](#tiffcolordepth) | int | Gets or sets bit depth to apply only when saving pages to the Tiff format. The value of the property is ColorDepth integ |
| [PrintingPage](#printingpage) | int | Indicates which pages will not be printed. The value of the property is PrintingPageType integer constant. |
| [Quality](#quality) | int | Gets or sets a value determining the quality of the generated images to apply only when saving pages to the Jpeg format. |
| [ImageType](#imagetype) | int | Gets or sets the format of the generated images. default value: PNG. The value of the property is ImageType integer cons |
...
### ImageOrPrintOptions.SaveFormat property {#saveformat}
...
### ImageOrPrintOptions.PrintWithStatusDialog property {#printwithstatusdialog}

If PrintWithStatusDialog = true , there will be a dialog that shows current print status. else no such dialog will show.

**Type:** boolean

### ImageOrPrintOptions.HorizontalResolution property {#horizontalresolution}
...
### ImageOrPrintOptions.VerticalResolution property {#verticalresolution}
...
### ImageOrPrintOptions.TiffCompression property {#tiffcompression}
...
### ImageOrPrintOptions.TiffColorDepth property {#tiffcolordepth}
...
### ImageOrPrintOptions.ImageType property {#imagetype}
...
### ImageOrPrintOptions.IsCellAutoFit property {#iscellautofit}
...
### ImageOrPrintOptions.OnePagePerSheet property {#onepagepersheet}

If OnePagePerSheet is true , all content of one sheet will output to only one page in result. The paper size of pagesetup will be invalid, and the other settings of pagesetup will still take effect.

**Type:** boolean

### ImageOrPrintOptions.AllColumnsInOnePagePerSheet property {#allcolumnsinonepagepersheet}
...
### ImageOrPrintOptions.DrawObjectEventHandler property {#drawobjecteventhandler}

Implements this interface to get DrawObject and Bound when rendering.

**Type:** DrawObjectEventHandler

### ImageOrPrintOptions.ChartImageType property {#chartimagetype}
...
### ImageOrPrintOptions.EmbededImageNameInSvg property {#embededimagenameinsvg}

Indicate the filename of embedded image in svg. This should be full path with directory like "c:\\xpsEmbedded"

**Type:** String

### ImageOrPrintOptions.SVGFitToViewPort property {#svgfittoviewport}

if this property is true, the generated svg will fit to view port.

**Type:** boolean

### ImageOrPrintOptions.SvgCssPrefix property {#svgcssprefix}

**Type:** String

### ImageOrPrintOptions.OnlyArea property {#onlyarea}

If this property is true , one Area will be output, and no scale will take effect.

**Type:** boolean

### ImageOrPrintOptions.Transparent property {#transparent}
...
### ImageOrPrintOptions.PageSavingCallback property {#pagesavingcallback}

Control/Indicate progress of page saving process.

**Type:** IPageSavingCallback

### ImageOrPrintOptions.IsFontSubstitutionCharGranularity property {#isfontsubstitutionchargranularity}
...
### ImageOrPrintOptions.DefaultFont property {#defaultfont}

When characters in the Excel are Unicode and not be set with correct font in cell style, They may appear as block in pdf,image. Set the DefaultFont such as MingLiu or MS Gothic to show these characters. If this property is not set, Aspose.Cells will use system default font to show these unicode characters.

**Type:** String

### ImageOrPrintOptions.CheckWorkbookDefaultFont property {#checkworkbookdefaultfont}
...
### ImageOrPrintOptions.OutputBlankPageWhenNothingToPrint property {#outputblankpagewhennothingtoprint}

Indicates whether to output a blank page when there is nothing to print. Default is false.

**Type:** boolean

### ImageOrPrintOptions.GridlineType property {#gridlinetype}

Gets or sets gridline type. The value of the property is GridlineType integer constant. Default is Dotted type.

**Type:** int

### ImageOrPrintOptions.GridlineColor property {#gridlinecolor}

**Type:** Color

### ImageOrPrintOptions.TextCrossType property {#textcrosstype}
...
### ImageOrPrintOptions.DefaultEditLanguage property {#defaulteditlanguage}
...
### ImageOrPrintOptions.SheetSet property {#sheetset}
...
### ImageOrPrintOptions.EmfRenderSetting property {#emfrendersetting}
...
### ImageOrPrintOptions.CustomRenderSettings property {#customrendersettings}
