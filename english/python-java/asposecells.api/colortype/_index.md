...
type: docs
weight: 990
url: /cells/python-java/asposecells.api/colortype/
---
...
| AUTOMATIC_INDEX | It's automatic color,but the displayed color depends the setting of the OS System. Not supported. |
| RGB | The RGB color. |
