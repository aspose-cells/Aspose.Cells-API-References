...
articleTitle: "FunctionEquationNode"
...
type: docs
weight: 2630
url: /cells/python-java/asposecells.api/functionequationnode/
---
...
### FunctionEquationNode.ParentNode property {#parentnode}

Specifies the parent node of the current node

**Type:** EquationNode

### FunctionEquationNode.Type property {#type}

Represents the type of the node. The value of the property is TextNodeType integer constant.

**Type:** int

### FunctionEquationNode.EquationType property {#equationtype}

Get the equation type of the current node The value of the property is EquationNodeType integer constant.

**Type:** int

### FunctionEquationNode.StartIndex property {#startindex}

Gets the start index of the characters.

**Type:** int

### FunctionEquationNode.Length property {#length}

Gets the length of the characters.

**Type:** int

### FunctionEquationNode.Font property {#font}

Returns the font of this object.

**Type:** Font

### FunctionEquationNode.TextOptions property {#textoptions}
