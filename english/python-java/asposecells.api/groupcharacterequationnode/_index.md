...
| [ChrType](#chrtype) | int | Specify combining characters by type value. The value of the property is EquationCombiningCharacterType integer constant |
| [Position](#position) | int | This attribute specifies the position of the character in the object The value of the property is EquationCharacterPosit |
| [VertJc](#vertjc) | int | This attribute, combined with pos of groupChrPr, specifies the vertical layout of the groupChr object. Where pos specifi |
