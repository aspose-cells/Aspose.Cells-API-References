...
| [toImageBytes](#toimagebytes) | Saves the shape to a byte array. |

### Shape.MacroName property {#macroname}

Gets and sets the name of macro.

**Type:** String

### Shape.IsEquation property {#isequation}

Indicates whether the shape only contains an equation.

**Type:** boolean

### Shape.IsSmartArt property {#issmartart}

Indicates whether the shape is a smart art. Only for ooxml file.

**Type:** boolean

### Shape.ZOrderPosition property {#zorderposition}
...
### Shape.AlternativeText property {#alternativetext}

Returns or sets the descriptive (alternative) text string of the Shape object.

**Type:** String

### Shape.Title property {#title}

Specifies the title (caption) of the current shape object.

**Type:** String

### Shape.LineFormat property {#lineformat}
...
### Shape.FillFormat property {#fillformat}
...
### Shape.FormatPicture property {#formatpicture}

Gets and sets the options of the picture format.

**Type:** MsoFormatPicture

### Shape.IsHidden property {#ishidden}

Indicates whether the object is visible.

**Type:** boolean

### Shape.IsLockAspectRatio property {#islockaspectratio}
...
### Shape.IsAspectRatioLocked property {#isaspectratiolocked}

True means that aspect ratio of the shape is locked. Only for pictures and Ole Objects.

**Type:** boolean

### Shape.RotationAngle property {#rotationangle}

Gets and sets the rotation of the shape.

**Type:** float

### Shape.Hyperlink property {#hyperlink}
...
### Shape.IsLocked property {#islocked}
...
### Shape.UpperLeftRow property {#upperleftrow}

Represents the top row index. If the shape is in the shape or in the group , UpperLeftRow will be ignored.

**Type:** int

### Shape.UpperDeltaY property {#upperdeltay}

Gets or sets the shape's vertical offset from its upper left corner row. The range of value is 0 to 256.

**Type:** int

### Shape.UpperLeftColumn property {#upperleftcolumn}

Represents upper left corner column index.

**Type:** int

### Shape.UpperDeltaX property {#upperdeltax}

Gets or sets the shape's horizontal offset from its upper left corner column. The range of value is 0 to 1024.

**Type:** int

### Shape.LowerRightRow property {#lowerrightrow}

Represents lower right corner row index.

**Type:** int

### Shape.LowerDeltaY property {#lowerdeltay}

Gets or sets the shape's vertical offset from its lower right corner row. The range of value is 0 to 256.

**Type:** int

### Shape.LowerRightColumn property {#lowerrightcolumn}

Represents lower right corner column index.

**Type:** int

### Shape.LowerDeltaX property {#lowerdeltax}

Gets or sets the shape's horizontal offset from its lower right corner column. The range of value is 0 to 1024.

**Type:** int

### Shape.Right property {#right}

Represents the width of the shape's horizontal offset from its lower right corner column, in unit of pixels.

**Type:** int

### Shape.Bottom property {#bottom}

Represents the width of the shape's vertical offset from its lower bottom corner row, in unit of pixels.

**Type:** int

### Shape.Width property {#width}

Represents the width of shape, in unit of pixels.

**Type:** int

### Shape.WidthInch property {#widthinch}

Represents the width of the shape, in unit of inch.

**Type:** float

### Shape.WidthPt property {#widthpt}

Represents the width of the shape, in unit of point.

**Type:** float

### Shape.WidthCM property {#widthcm}

Represents the width of the shape, in unit of centimeters.

**Type:** float

### Shape.Height property {#height}

Represents the height of shape, in unit of pixel.

**Type:** int

### Shape.HeightInch property {#heightinch}

Represents the height of the shape, in unit of inches.

**Type:** float

### Shape.HeightPt property {#heightpt}

Represents the height of the shape, in unit of points.

**Type:** float

### Shape.HeightCM property {#heightcm}

Represents the height of the shape, in unit of centimeters.

**Type:** float

### Shape.Left property {#left}

Represents the horizontal offset of shape from its left column, in unit of pixels.

**Type:** int

### Shape.LeftInch property {#leftinch}

Represents the horizontal offset of shape from its left column, in unit of inches.

**Type:** float

### Shape.LeftCM property {#leftcm}

Represents the horizontal offset of shape from its left column, in unit of centimeters.

**Type:** float

### Shape.Top property {#top}
...
### Shape.TopInch property {#topinch}

Represents the vertical offset of shape from its top row, in unit of inches.

**Type:** float

### Shape.TopCM property {#topcm}

Represents the vertical offset of shape from its top row, in unit of centimeters.

**Type:** float

### Shape.TopToCorner property {#toptocorner}

Gets and sets the vertical offset of shape from worksheet top border, in unit of pixels.

**Type:** int

### Shape.LeftToCorner property {#lefttocorner}
...
### Shape.WidthScale property {#widthscale}
...
### Shape.HeightScale property {#heightscale}
...
### Shape.TopInShape property {#topinshape}
...
### Shape.LeftInShape property {#leftinshape}
...
### Shape.WidthInShape property {#widthinshape}
...
### Shape.HeightInShape property {#heightinshape}
...
### Shape.HasLine property {#hasline}

Gets and sets the line border of the shape is visible.

**Type:** boolean

### Shape.IsFilled property {#isfilled}

Indicates whether the fill format is visible.

**Type:** boolean

### Shape.IsFlippedHorizontally property {#isflippedhorizontally}

Gets and sets whether shape is horizontally flipped .

**Type:** boolean

### Shape.IsFlippedVertically property {#isflippedvertically}

Gets and sets whether shape is vertically flipped .

**Type:** boolean

### Shape.ActualLowerRightRow property {#actuallowerrightrow}

Get the actual bottom row.

**Type:** int

### Shape.RelativeToOriginalPictureSize property {#relativetooriginalpicturesize}

Indicates whether shape is relative to original picture size.

**Type:** boolean

### Shape.LinkedCell property {#linkedcell}

Gets or sets the worksheet range linked to the control's value.

**Type:** String

### Shape.InputRange property {#inputrange}

Gets or sets the worksheet range used to fill the specified combo box.

**Type:** String

### Shape.TextShapeType property {#textshapetype}

Gets and sets the preset text shape type. The value of the property is AutoShapeType integer constant.

**Type:** int

### Shape.TextBody property {#textbody}

Gets and sets the setting of the shape's text.

**Type:** FontSettingCollection

### Shape.Font property {#font}

Represents the font of shape.

**Type:** Font

### Shape.TextOptions property {#textoptions}
...
### Shape.IsRichText property {#isrichtext}

Whether or not the text is rich text.

**Type:** boolean

### Shape.HtmlText property {#htmltext}

Gets and sets the html string which contains data and some formats in this textbox.

**Type:** String

### Shape.TextVerticalOverflow property {#textverticaloverflow}
...
### Shape.TextHorizontalOverflow property {#texthorizontaloverflow}
...
### Shape.IsTextWrapped property {#istextwrapped}

Gets and sets the text wrapped type of the shape which contains text.

**Type:** boolean

### Shape.TextOrientationType property {#textorientationtype}

Gets and sets the text orientation type of the shape. The value of the property is TextOrientationType integer constant.

**Type:** int

### Shape.TextHorizontalAlignment property {#texthorizontalalignment}
...
### Shape.TextVerticalAlignment property {#textverticalalignment}
...
### Shape.Paths property {#paths}

Gets the paths of a custom geometric shape.

**Type:** ShapePathCollection

### Shape.Geometry property {#geometry}

Gets the geometry

**Type:** Geometry

### Shape.CreateId property {#createid}

Gets and sets create id for this shape.

**Type:** UUID

### Shape.IsDecorative property {#isdecorative}
...
### toImageBytes(options) (1 of 2) {#toimagebytes}

Saves the shape to a byte array.
...
shape = wb.getWorksheets().get("Shape").getShapes().get(0)
imgOptions = ImageOrPrintOptions()
imgOptions.setHorizontalResolution(200)
imgOptions.setVerticalResolution(300)
imgOptions.setImageFormat(ImageFormat.getJpeg())
with open("shape1.jpeg", "wb") as w:
    content = shape.toImageBytes(imgOptions)
    w.write(content)
...
### toImageBytes(imageFormat) (2 of 2) {#toimagebytes-1}

Creates the shape image and saves it to a byte array in the specified format.
...
wb = Workbook("Book2.xlsx")
imangeFormatJpeg = ImageFormat.getJpeg()
shape = wb.getWorksheets().get("Shape").getShapes().get(1)
with open("shape2.jpeg", "wb") as w:
    content = shape.toImageBytes(imangeFormatJpeg)
    w.write(content)
