...
articleTitle: "TableStyleElement"
second_title: "Aspose.Cells for Python via Java"
description: "Represents the element of the table style."
type: docs
weight: 6540
url: /cells/python-java/asposecells.api/tablestyleelement/
---
...
| --- | --- | --- |
| [Size](#size) | int | Number of rows or columns in a single band of striping. Applies only when type is firstRowStripe, secondRowStripe, first |
| [Type](#type) | int | Gets the element type. The value of the property is TableStyleElementType integer constant. |
...
### TableStyleElement.Size property {#size}
...
### TableStyleElement.Type property {#type}
...
### setElementStyle(style) {#setelementstyle}
