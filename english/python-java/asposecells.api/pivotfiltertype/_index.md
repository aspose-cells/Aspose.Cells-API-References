...
articleTitle: "PivotFilterType"
second_title: "Aspose.Cells for Python via Java"
description: "Utility class containing constants."
type: docs
weight: 4660
url: /cells/python-java/asposecells.api/pivotfiltertype/
---
...
| M_1 | Indicates the "January" filter for date values. |
| JANUARY |  |
| M_2 | Indicates the "February" filter for date values. |
| FEBRUARY |  |
| M_3 | Indicates the "March" filter for date values. |
| MARCH |  |
| M_4 | Indicates the "April" filter for date values. |
| APRIL |  |
| M_5 | Indicates the "May" filter for date values. |
| MAY |  |
| M_6 | Indicates the "June" filter for date values. |
| JUNE |  |
| M_7 | Indicates the "July" filter for date values. |
| JULY |  |
| M_8 | Indicates the "August" filter for date values. |
| AUGUST |  |
| M_9 | Indicates the "September" filter for date values. |
| SEPTEMBER |  |
| M_10 | Indicates the "October" filter for date values. |
| OCTOBER |  |
| M_11 | Indicates the "November" filter for date values. |
| NOVEMBER |  |
| M_12 | Indicates the "December" filter for date values. |
| DECEMBER |  |
...
| Q_1 | Indicates the "first quarter" filter for date values. |
| QUARTER_1 |  |
| Q_2 | Indicates the "second quarter" filter for date values. |
| QUARTER_2 |  |
| Q_3 | Indicates the "third quarter" filter for date values. |
| QUARTER_3 |  |
| Q_4 | Indicates the "fourth quarter" filter for date values. |
| QUARTER_4 |  |
