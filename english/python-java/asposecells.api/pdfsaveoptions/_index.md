...
| [Compliance](#compliance) | int | Gets or sets the PDF standards compliance level for output documents. The value of the property is PdfCompliance integer |
...
| [PdfCompression](#pdfcompression) | int | Indicate the compression algorithm The value of the property is PdfCompressionCore integer constant. |
...
| [OptimizationType](#optimizationtype) | int | Gets and sets pdf optimization type. The value of the property is PdfOptimizationType integer constant. Default value is |
| [CustomPropertiesExport](#custompropertiesexport) | int | Gets or sets a value determining the way CustomDocumentPropertyCollection are exported to PDF file. Default value is Non |
...
| [FontEncoding](#fontencoding) | int | Gets or sets embedded font encoding in pdf. The value of the property is PdfFontEncoding integer constant. Default value |
...
| [ZoomBehavior](#zoombehavior) | int | The value of the property is PdfZoomBehavior integer constant. |
| [ZoomFactor](#zoomfactor) | int |  |
