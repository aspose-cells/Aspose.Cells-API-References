...
type: docs
weight: 2260
url: /cells/python-java/asposecells.api/fileformatutil/
---
...
| [detectFileFormatFromBytes](#detectfileformatfrombytes) | Detects and returns the information about a format of an excel stored in a byte array. |
...
### detectFileFormatFromBytes(byte_array) {#detectfileformatfrombytes}
