...
| --- | --- | --- |
| [IconSetType](#iconsettype) | int | Gets and sets which icon set is used in the filter criteria. The value of the property is IconSetType integer constant. |
| [IconId](#iconid) | int | Gets and sets Zero-based index of an icon in an icon set. |

### IconFilter.IconSetType property {#iconsettype}

Gets and sets which icon set is used in the filter criteria. The value of the property is IconSetType integer constant.

**Type:** int

### IconFilter.IconId property {#iconid}
