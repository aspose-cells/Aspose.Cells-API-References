...
| [CellRow](#cellrow) | int | Gets the row index of the cell where the function is in. |
| [CellColumn](#cellcolumn) | int | Gets the column index of the cell where the function is in. |
...
| [ParamCount](#paramcount) | int | Gets the count of parameters |
