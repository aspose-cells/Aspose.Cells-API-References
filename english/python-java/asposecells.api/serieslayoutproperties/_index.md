...
| [QuartileCalculation](#quartilecalculation) | int | Represents the statistical properties for the series. The value of the property is QuartileCalculationType integer const |
| [MapLabelLayout](#maplabellayout) | int | Gets and sets the layout of map labels. The value of the property is MapChartLabelLayout integer constant. |
| [IsIntervalLeftClosed](#isintervalleftclosed) | boolean | Indicates whether the interval is closed on the left side. |
| [MapChartRegionType](#mapchartregiontype) | int | Gets and sets the region type of the map. The value of the property is MapChartRegionType integer constant. |
| [MapChartProjectionType](#mapchartprojectiontype) | int | Gets and sets the projection type of the map. The value of the property is MapChartProjectionType integer constant. |
