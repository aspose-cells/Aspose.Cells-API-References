...
articleTitle: "ArrayEquationNode"
second_title: "Aspose.Cells for Python via Java"
description: ""
type: docs
weight: 150
url: /cells/python-java/asposecells.api/arrayequationnode/
---
...
### ArrayEquationNode.ParentNode property {#parentnode}

Specifies the parent node of the current node

**Type:** EquationNode

### ArrayEquationNode.Type property {#type}

Represents the type of the node. The value of the property is TextNodeType integer constant.

**Type:** int

### ArrayEquationNode.EquationType property {#equationtype}

Get the equation type of the current node The value of the property is EquationNodeType integer constant.

**Type:** int

### ArrayEquationNode.StartIndex property {#startindex}

Gets the start index of the characters.

**Type:** int

### ArrayEquationNode.Length property {#length}

Gets the length of the characters.

**Type:** int

### ArrayEquationNode.Font property {#font}

Returns the font of this object.

**Type:** Font

### ArrayEquationNode.TextOptions property {#textoptions}
