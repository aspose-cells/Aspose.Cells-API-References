...
type: docs
weight: 5320
url: /cells/python-java/asposecells.api/referredarea/
---
...
| [EndColumn](#endcolumn) | int | The end column of the area. |
| [StartColumn](#startcolumn) | int | The start column of the area. |
| [EndRow](#endrow) | int | The end row of the area. |
| [StartRow](#startrow) | int | The start row of the area. |
