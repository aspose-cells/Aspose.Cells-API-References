...
articleTitle: "GradientPresetType"
second_title: "Aspose.Cells for Python via Java"
description: "Utility class containing constants."
type: docs
weight: 2710
url: /cells/python-java/asposecells.api/gradientpresettype/
---
...
| UNKNOWN | Unknown preset color. Only for the preset color (which is not same as any known preset color) in the template workbook. |
