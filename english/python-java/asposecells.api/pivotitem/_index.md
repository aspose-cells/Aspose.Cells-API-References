...
| [Position](#position) | int | Specifying the position index in all the PivotItems,not the PivotItems under the same parent node. |
| [PositionInSameParentNode](#positioninsameparentnode) | int | Specifying the position index in the PivotItems under the same parent node. |
...
| [Index](#index) | int | Gets the index of the pivot item in cache field. |
