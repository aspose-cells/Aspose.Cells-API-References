...
| [ReserveMissingPivotItemType](#reservemissingpivotitemtype) | int | Represents how to reserve missing pivot items. The value of the property is ReserveMissingPivotItemType integer constant |
