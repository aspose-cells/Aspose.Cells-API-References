...
| [Type](#type) | int | Represents worksheet type. The value of the property is SheetType integer constant. |
...
| [PaneState](#panestate) | int | Indicates whether the pane has horizontal or vertical splits, and whether those splits are frozen. The value of the prop |
...
| [TabId](#tabid) | int | Specifies the internal identifier for the sheet. |
...
| [VisibilityType](#visibilitytype) | int | Indicates the visible state for this sheet. The value of the property is VisibilityType integer constant. |
...
| [Index](#index) | int | Gets the index of sheet in the worksheet collection. |
...
| [FirstVisibleRow](#firstvisiblerow) | int | Represents first visible row index. |
| [FirstVisibleColumn](#firstvisiblecolumn) | int | Represents first visible column index. |
| [Zoom](#zoom) | int | Represents the scaling factor in percentage. It should be between 10 and 400. Please set the view type first. |
| [ViewType](#viewtype) | int | Gets and sets the view type. The value of the property is ViewType integer constant. |
