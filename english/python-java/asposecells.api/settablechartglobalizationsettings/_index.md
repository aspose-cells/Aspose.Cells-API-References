---
title: "SettableChartGlobalizationSettings Class"
linktitle: "SettableChartGlobalizationSettings"
articleTitle: "SettableChartGlobalizationSettings"
second_title: "Aspose.Cells for Python via Java"
description: "Implementation of PivotGlobalizationSettings that supports user to set/change pre-defined texts."
type: docs
weight: 5760
url: /cells/python-java/asposecells.api/settablechartglobalizationsettings/
---
...
| Name | Description |
| --- | --- |
| [SettableChartGlobalizationSettings](#constructor) |  |
...
| [setSeriesName](#setseriesname) | Sets the name of Series in the Chart. |
| [getChartTitleName](#getcharttitlename) | Gets the name of Chart Title. |
| [setChartTitleName](#setcharttitlename) | Sets the name of Chart Title. |
| [getLegendIncreaseName](#getlegendincreasename) | Gets the name of increase for Legend. |
| [setLegendIncreaseName](#setlegendincreasename) | Sets the name of increase for Legend. |
| [getLegendDecreaseName](#getlegenddecreasename) | Gets the name of Decrease for Legend. |
| [setLegendDecreaseName](#setlegenddecreasename) | Sets the name of Decrease for Legend. |
| [getLegendTotalName](#getlegendtotalname) | Gets the name of Total for Legend. |
| [setLegendTotalName](#setlegendtotalname) | Sets the name of Total for Legend. |
| [getAxisTitleName](#getaxistitlename) | Gets the name of Title for Axis. |
| [setAxisTitleName](#setaxistitlename) | Sets the name of Title for Axis. |
| [getOtherName](#getothername) | Gets the name of "Other" labels for Chart. |
| [setOtherName](#setothername) | Sets the name of "Other" labels for Chart. |
| [getAxisUnitName](#getaxisunitname) | Gets the Name of Axis Unit. |
| [setAxisUnitName](#setaxisunitname) | Sets the Name of Axis Unit. |
...
### setSeriesName(name) {#setseriesname}
...
### setChartTitleName(name) {#setcharttitlename}
...
### setLegendIncreaseName(name) {#setlegendincreasename}
...
### setLegendDecreaseName(name) {#setlegenddecreasename}
...
### setLegendTotalName(name) {#setlegendtotalname}
...
### setAxisTitleName(name) {#setaxistitlename}
...
### setOtherName(name) {#setothername}
...
### getAxisUnitName(type) {#getaxisunitname}

Gets the Name of Axis Unit.

### setAxisUnitName(type, name) {#setaxisunitname}
