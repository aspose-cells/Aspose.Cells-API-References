...
type: docs
weight: 4430
url: /cells/python-java/asposecells.api/pivotarea/
---
...
| [AxisType](#axistype) | int | Gets and sets the region of the PivotTable to which this rule applies. The value of the property is PivotFieldType integ |
| [RuleType](#ruletype) | int | Gets and sets the type of selection rule. The value of the property is PivotAreaType integer constant. |
