...
type: docs
weight: 3740
url: /cells/python-java/asposecells.api/msofillformathelper/
---
...
| [ForeColorTransparency](#forecolortransparency) | float | Returns or sets the degree of fore color of the specified fill as a value from 0.0 (opaque) through 1.0 (clear). |
