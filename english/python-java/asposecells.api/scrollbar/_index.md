...
linktitle: "ScrollBar"
articleTitle: "ScrollBar"
second_title: "Aspose.Cells for Python via Java"
description: "Represents a scroll bar object."
type: docs
weight: 5700
url: /cells/python-java/asposecells.api/scrollbar/
---
...
| [PageChange](#pagechange) | int | Gets or sets page change |
...
### ScrollBar.CurrentValue property {#currentvalue}

Gets or sets the current value.

**Type:** int

### ScrollBar.Min property {#min}

Gets or sets the minimum value of a scroll bar or spinner range.

**Type:** int

### ScrollBar.Max property {#max}

Gets or sets the maximum value of a scroll bar or spinner range.

**Type:** int

### ScrollBar.IncrementalChange property {#incrementalchange}

Gets or sets the amount that the scroll bar or spinner is incremented a line scroll.

**Type:** int

### ScrollBar.PageChange property {#pagechange}

Gets or sets page change

**Type:** int

### ScrollBar.Shadow property {#shadow}

Indicates whether the shape has 3-D shading.

**Type:** boolean

### ScrollBar.IsHorizontal property {#ishorizontal}

Indicates whether this is a horizontal scroll bar.

**Type:** boolean

### ScrollBar.MacroName property {#macroname}

Gets and sets the name of macro.

**Type:** String

### ScrollBar.IsEquation property {#isequation}

Indicates whether the shape only contains an equation.

**Type:** boolean

### ScrollBar.IsSmartArt property {#issmartart}

Indicates whether the shape is a smart art. Only for ooxml file.

**Type:** boolean

### ScrollBar.ZOrderPosition property {#zorderposition}

Returns the position of a shape in the z-order.

**Type:** int

### ScrollBar.Name property {#name}

Gets and sets the name of the shape.

**Type:** String

### ScrollBar.AlternativeText property {#alternativetext}

Returns or sets the descriptive (alternative) text string of the Shape object.

**Type:** String

### ScrollBar.Title property {#title}

Specifies the title (caption) of the current shape object.

**Type:** String

### ScrollBar.LineFormat property {#lineformat}
...
### ScrollBar.FillFormat property {#fillformat}
...
### ScrollBar.Glow property {#glow}

Represents a GlowEffect object that specifies glow effect for the chart element or shape.

**Type:** GlowEffect

### ScrollBar.SoftEdges property {#softedges}

Gets and sets the radius of blur to apply to the edges, in unit of points.

**Type:** float

### ScrollBar.ThreeDFormat property {#threedformat}

Gets and sets 3d format of the shape.

**Type:** ThreeDFormat

### ScrollBar.FormatPicture property {#formatpicture}

Gets and sets the options of the picture format.

**Type:** MsoFormatPicture

### ScrollBar.IsHidden property {#ishidden}

Indicates whether the object is visible.

**Type:** boolean

### ScrollBar.IsLockAspectRatio property {#islockaspectratio}
...
### ScrollBar.IsLocked property {#islocked}
...
### ScrollBar.WidthInch property {#widthinch}

Represents the width of the shape, in unit of inch.

**Type:** float

### ScrollBar.WidthPt property {#widthpt}

Represents the width of the shape, in unit of point.

**Type:** float

### ScrollBar.WidthCM property {#widthcm}

Represents the width of the shape, in unit of centimeters.

**Type:** float

### ScrollBar.Height property {#height}

Represents the height of shape, in unit of pixel.

**Type:** int

### ScrollBar.HeightInch property {#heightinch}

Represents the height of the shape, in unit of inches.

**Type:** float

### ScrollBar.HeightPt property {#heightpt}

Represents the height of the shape, in unit of points.

**Type:** float

### ScrollBar.HeightCM property {#heightcm}

Represents the height of the shape, in unit of centimeters.

**Type:** float

### ScrollBar.Left property {#left}

Represents the horizontal offset of shape from its left column, in unit of pixels.

**Type:** int

### ScrollBar.LeftInch property {#leftinch}

Represents the horizontal offset of shape from its left column, in unit of inches.

**Type:** float

### ScrollBar.LeftCM property {#leftcm}

Represents the horizontal offset of shape from its left column, in unit of centimeters.

**Type:** float

### ScrollBar.Top property {#top}
...
### ScrollBar.TopInch property {#topinch}

Represents the vertical offset of shape from its top row, in unit of inches.

**Type:** float

### ScrollBar.TopCM property {#topcm}

Represents the vertical offset of shape from its top row, in unit of centimeters.

**Type:** float

### ScrollBar.TopToCorner property {#toptocorner}

Gets and sets the vertical offset of shape from worksheet top border, in unit of pixels.

**Type:** int

### ScrollBar.LeftToCorner property {#lefttocorner}

Gets and sets the horizonal offset of shape from worksheet left border.

**Type:** int

### ScrollBar.X property {#x}

Gets and sets the horizontal offset of shape from worksheet left border,in unit of pixels.

**Type:** int

### ScrollBar.Y property {#y}

Gets and sets the vertical offset of shape from worksheet top border,in unit of pixels.

**Type:** int

### ScrollBar.WidthScale property {#widthscale}
...
### ScrollBar.HeightScale property {#heightscale}
...
### ScrollBar.TopInShape property {#topinshape}
...
### ScrollBar.LeftInShape property {#leftinshape}
...
### ScrollBar.WidthInShape property {#widthinshape}
...
### ScrollBar.HeightInShape property {#heightinshape}

Represents the vertical offset of shape from the top border of the parent shape, in unit of 1/4000 of height of the parent shape.. Only Applies when this shape in the group or chart.

**Type:** int

### ScrollBar.Group property {#group}

Gets the group shape which contains this shape.

**Type:** GroupShape

### ScrollBar.Type property {#type}

Gets the auto shape type. The value of the property is AutoShapeType integer constant.

**Type:** int

### ScrollBar.HasLine property {#hasline}

Gets and sets the line border of the shape is visible.

**Type:** boolean

### ScrollBar.IsFilled property {#isfilled}

Indicates whether the fill format is visible.

**Type:** boolean

### ScrollBar.IsFlippedHorizontally property {#isflippedhorizontally}

Gets and sets whether shape is horizontally flipped .

**Type:** boolean

### ScrollBar.IsFlippedVertically property {#isflippedvertically}

Gets and sets whether shape is vertically flipped .

**Type:** boolean

### ScrollBar.ActualLowerRightRow property {#actuallowerrightrow}

Get the actual bottom row.

**Type:** int

### ScrollBar.RelativeToOriginalPictureSize property {#relativetooriginalpicturesize}

Indicates whether shape is relative to original picture size.

**Type:** boolean

### ScrollBar.LinkedCell property {#linkedcell}

Gets or sets the worksheet range linked to the control's value.

**Type:** String

### ScrollBar.InputRange property {#inputrange}

Gets or sets the worksheet range used to fill the specified combo box.

**Type:** String

### ScrollBar.TextShapeType property {#textshapetype}

Gets and sets the preset text shape type. The value of the property is AutoShapeType integer constant.

**Type:** int

### ScrollBar.TextBody property {#textbody}

Gets and sets the setting of the shape's text.

**Type:** FontSettingCollection

### ScrollBar.Font property {#font}

Represents the font of shape.

**Type:** Font

### ScrollBar.TextOptions property {#textoptions}

Represents the text options of the shape.

**Type:** TextOptions

### ScrollBar.Text property {#text}

Gets and sets the text of this shape.

**Type:** String

### ScrollBar.IsRichText property {#isrichtext}

Whether or not the text is rich text.

**Type:** boolean

### ScrollBar.HtmlText property {#htmltext}

Gets and sets the html string which contains data and some formats in this textbox.

**Type:** String

### ScrollBar.TextVerticalOverflow property {#textverticaloverflow}
...
### ScrollBar.TextHorizontalOverflow property {#texthorizontaloverflow}
...
### ScrollBar.IsTextWrapped property {#istextwrapped}

Gets and sets the text wrapped type of the shape which contains text.

**Type:** boolean

### ScrollBar.TextOrientationType property {#textorientationtype}

Gets and sets the text orientation type of the shape. The value of the property is TextOrientationType integer constant.

**Type:** int

### ScrollBar.TextHorizontalAlignment property {#texthorizontalalignment}
...
### ScrollBar.TextVerticalAlignment property {#textverticalalignment}
...
### ScrollBar.TextDirection property {#textdirection}

Gets/Sets the direction of the text flow for this object. The value of the property is TextDirectionType integer constant.

**Type:** int

### ScrollBar.TextBoxOptions property {#textboxoptions}

**Type:** TextBoxOptions

### ScrollBar.ControlData property {#controldata}

Gets the data of control.

**Type:** byte[]

### ScrollBar.Paths property {#paths}

Gets the paths of a custom geometric shape.

**Type:** ShapePathCollection

### ScrollBar.Geometry property {#geometry}

Gets the geometry

**Type:** Geometry

### ScrollBar.CreateId property {#createid}

Gets and sets create id for this shape.

**Type:** UUID

### ScrollBar.IsDecorative property {#isdecorative}
