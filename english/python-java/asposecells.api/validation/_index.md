...
type: docs
weight: 7230
url: /cells/python-java/asposecells.api/validation/
---
...
| --- | --- | --- |
| [Operator](#operator) | int | Represents the operator for the data validation. The value of the property is OperatorType integer constant. |
| [AlertStyle](#alertstyle) | int | Represents the validation alert style. The value of the property is ValidationAlertType integer constant. |
| [Type](#type) | int | Represents the data validation type. The value of the property is ValidationType integer constant. |
