...
type: docs
weight: 4030
url: /cells/python-java/asposecells.api/odssaveoptions/
---
...
| --- | --- | --- |
| [GeneratorType](#generatortype) | int | Gets and sets the generator of the ods file. The value of the property is OdsGeneratorType integer constant. |
...
| [OdfStrictVersion](#odfstrictversion) | int | Gets and sets the ODF version. The value of the property is OpenDocumentFormatVersionType integer constant. |
