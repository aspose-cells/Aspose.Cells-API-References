...
| --- | --- | --- |
| [Type](#type) | int | Represents error bar amount type. The value of the property is ErrorBarType integer constant. |
| [DisplayType](#displaytype) | int | Represents the display type of error bar. The value of the property is ErrorBarDisplayType integer constant. |
| [Amount](#amount) | float | Represents amount of error bar. The amount must be greater than or equal to zero. |
