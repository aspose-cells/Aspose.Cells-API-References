...
type: docs
weight: 5380
url: /cells/python-java/asposecells.api/renderingwatermark/
---
...
| --- | --- | --- |
| [Rotation](#rotation) | float | Gets or sets roation of the watermark in degrees. |
| [ScaleToPagePercent](#scaletopagepercent) | int | Gets or sets scale relative to target page in percent. |
| [Opacity](#opacity) | float | Gets or sets opacity of the watermark in range [0, 1]. |
...
| [HAlignment](#halignment) | int | Gets or sets horizontal alignment of the watermark to the page. The value of the property is TextAlignmentType integer c |
| [VAlignment](#valignment) | int | Gets or sets vertical alignment of the watermark to the page. The value of the property is TextAlignmentType integer con |
| [OffsetX](#offsetx) | float | Gets or sets offset value to HAlignment |
| [OffsetY](#offsety) | float | Gets or sets offset value to VAlignment |
