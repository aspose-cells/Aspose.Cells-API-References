...
| [QuoteType](#quotetype) | int | Gets or sets how to quote values in the exported text file. The value of the property is TxtValueQuoteType integer const |
...
| --- | --- | --- |
| saveFormat | int | A SaveFormat value. The file format. It should be SaveFormat.CSV or SaveFormat.TSV , otherwise the saved format will be set as SaveFormat.CSV automatically. |
