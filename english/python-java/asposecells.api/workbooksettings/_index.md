...
| [ProtectionType](#protectiontype) | int | Gets the protection type of the workbook. The value of the property is ProtectionType integer constant. |
| [DisplayDrawingObjects](#displaydrawingobjects) | int | Indicates whether and how to show objects in the workbook. The value of the property is DisplayDrawingObjects integer co |
| [SheetTabBarWidth](#sheettabbarwidth) | int | Width of worksheet tab bar (in 1/1000 of window width). |
| [ShowTabs](#showtabs) | boolean | Get or sets a value whether the Workbook tabs are displayed. The default value is true. |
| [FirstVisibleTab](#firstvisibletab) | int | Gets or sets the first visible worksheet tab. |
...
| [Region](#region) | int | Gets or sets the regional settings for workbook. The value of the property is CountryCode integer constant. 1. Regional  |
...
| [ShapeDisplayType](#shapedisplaytype) | int | The value of the property is ShapeDisplayType integer constant. |
| [HidePivotFieldList](#hidepivotfieldlist) | boolean | Gets and sets whether hide the field list for the PivotTable. |
| [MaxUniqueItemsPerField](#maxuniqueitemsperfield) | int |  |
| [UpdateLinksType](#updatelinkstype) | int | Gets and sets how updates external links when the workbook is opened. The value of the property is UpdateLinksType integ |
| [MaxRow](#maxrow) | int | Gets the max row index, zero-based. Returns 65535 if the file format is Excel97-2003; |
| [MaxColumn](#maxcolumn) | int | Gets the max column index, zero-based. Returns 255 if the file format is Excel97-2003; |
...
| [WindowLeft](#windowleft) | float | The distance from the left edge of the client area to the left edge of the window, in unit of point. |
| [WindowLeftInch](#windowleftinch) | float | The distance from the left edge of the client area to the left edge of the window. In unit of inch. |
| [WindowLeftCM](#windowleftcm) | float | The distance from the left edge of the client area to the left edge of the window. In unit of centimeter. |
| [WindowTop](#windowtop) | float | The distance from the top edge of the client area to the top edge of the window, in unit of point. |
| [WindowTopInch](#windowtopinch) | float | The distance from the top edge of the client area to the top edge of the window, in unit of inch. |
| [WindowTopCM](#windowtopcm) | float | The distance from the top edge of the client area to the top edge of the window, in unit of centimeter. |
| [WindowWidth](#windowwidth) | float | The width of the window, in unit of point. |
| [WindowWidthInch](#windowwidthinch) | float | The width of the window, in unit of inch. |
| [WindowWidthCM](#windowwidthcm) | float | The width of the window, in unit of centimeter. |
| [WindowHeight](#windowheight) | float | The height of the window, in unit of point. |
| [WindowHeightInch](#windowheightinch) | float | The height of the window, in unit of inch. |
| [WindowHeightCM](#windowheightcm) | float | The height of the window, in unit of centimeter. |
...
| [SignificantDigits](#significantdigits) | int | Gets and sets the number of significant digits. The default value is CellsHelper.SignificantDigits . Only could be 15 or |
| [SignificantDigitsType](#significantdigitstype) | int | The value of the property is SignificantDigitsType integer constant. |
...
| [MemorySetting](#memorysetting) | int | Gets or sets the memory usage options. The new option will be taken as the default option for newly created worksheets b |
| [PaperSize](#papersize) | int | Gets and sets the default print paper size. The value of the property is PaperSizeType integer constant. If there is no  |
| [MaxRowsOfSharedFormula](#maxrowsofsharedformula) | int | Gets and sets the max row number of shared formula. If the number is too large, the autofilter works very slow in MS Exc |
| [Compliance](#compliance) | int | Specifies the OOXML version for the output document. The default value is Ecma376_2006. The value of the property is Oox |
...
| [DefaultImageResolution](#defaultimageresolution) | int |  |
