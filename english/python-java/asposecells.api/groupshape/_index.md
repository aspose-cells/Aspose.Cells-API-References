...
| [Item (int)](#itemint) | Shape | Gets the child shape by index. |
...
| [getGroupedShapes](#getgroupedshapes) | Gets the shapes grouped by this shape. |
...
### GroupShape.MacroName property {#macroname}

Gets and sets the name of macro.

**Type:** String

### GroupShape.IsEquation property {#isequation}

Indicates whether the shape only contains an equation.

**Type:** boolean

### GroupShape.IsSmartArt property {#issmartart}

Indicates whether the shape is a smart art. Only for ooxml file.

**Type:** boolean

### GroupShape.ZOrderPosition property {#zorderposition}

Returns the position of a shape in the z-order.

**Type:** int

### GroupShape.Name property {#name}

Gets and sets the name of the shape.

**Type:** String

### GroupShape.AlternativeText property {#alternativetext}

Returns or sets the descriptive (alternative) text string of the Shape object.

**Type:** String

### GroupShape.Title property {#title}

Specifies the title (caption) of the current shape object.

**Type:** String

### GroupShape.LineFormat property {#lineformat}
...
### GroupShape.FillFormat property {#fillformat}
...
### GroupShape.Glow property {#glow}

Represents a GlowEffect object that specifies glow effect for the chart element or shape.

**Type:** GlowEffect

### GroupShape.SoftEdges property {#softedges}

Gets and sets the radius of blur to apply to the edges, in unit of points.

**Type:** float

### GroupShape.ThreeDFormat property {#threedformat}

Gets and sets 3d format of the shape.

**Type:** ThreeDFormat

### GroupShape.FormatPicture property {#formatpicture}

Gets and sets the options of the picture format.

**Type:** MsoFormatPicture

### GroupShape.IsHidden property {#ishidden}

Indicates whether the object is visible.

**Type:** boolean

### GroupShape.IsLockAspectRatio property {#islockaspectratio}
...
### GroupShape.IsAspectRatioLocked property {#isaspectratiolocked}

True means that aspect ratio of the shape is locked. Only for pictures and Ole Objects.

**Type:** boolean

### GroupShape.RotationAngle property {#rotationangle}

Gets and sets the rotation of the shape.

**Type:** float

### GroupShape.Hyperlink property {#hyperlink}

Gets the hyperlink of the shape.

**Type:** Hyperlink

### GroupShape.Id property {#id}

Gets the identifier of this shape.

**Type:** int

### GroupShape.Spid property {#spid}

Specifies an optional string identifier that an application can use to identify the particular shape.

**Type:** String

### GroupShape.Spt property {#spt}

Specifies an optional number that an application can use to associate the particular shape with a defined shape type.

**Type:** int

### GroupShape.Worksheet property {#worksheet}

Gets the Worksheet object which contains this shape.

**Type:** Worksheet

### GroupShape.IsGroup property {#isgroup}

Indicates whether this shape is a group shape.

**Type:** boolean

### GroupShape.IsInGroup property {#isingroup}

Indicates whether the shape is grouped.

**Type:** boolean

### GroupShape.IsWordArt property {#iswordart}

Indicates whether this shape is a word art. Only for the Legacy Shape of xls file.

**Type:** boolean

### GroupShape.TextEffect property {#texteffect}
...
### GroupShape.IsLocked property {#islocked}
...
### GroupShape.UpperLeftRow property {#upperleftrow}

Represents the top row index. If the shape is in the shape or in the group , UpperLeftRow will be ignored.

**Type:** int

### GroupShape.UpperDeltaY property {#upperdeltay}

Gets or sets the shape's vertical offset from its upper left corner row. The range of value is 0 to 256.

**Type:** int

### GroupShape.UpperLeftColumn property {#upperleftcolumn}

Represents upper left corner column index.

**Type:** int

### GroupShape.UpperDeltaX property {#upperdeltax}

Gets or sets the shape's horizontal offset from its upper left corner column. The range of value is 0 to 1024.

**Type:** int

### GroupShape.LowerRightRow property {#lowerrightrow}

Represents lower right corner row index.

**Type:** int

### GroupShape.LowerDeltaY property {#lowerdeltay}

Gets or sets the shape's vertical offset from its lower right corner row. The range of value is 0 to 256.

**Type:** int

### GroupShape.LowerRightColumn property {#lowerrightcolumn}

Represents lower right corner column index.

**Type:** int

### GroupShape.LowerDeltaX property {#lowerdeltax}

Gets or sets the shape's horizontal offset from its lower right corner column. The range of value is 0 to 1024.

**Type:** int

### GroupShape.Right property {#right}

Represents the width of the shape's horizontal offset from its lower right corner column, in unit of pixels.

**Type:** int

### GroupShape.Bottom property {#bottom}

Represents the width of the shape's vertical offset from its lower bottom corner row, in unit of pixels.

**Type:** int

### GroupShape.Width property {#width}

Represents the width of shape, in unit of pixels.

**Type:** int

### GroupShape.WidthInch property {#widthinch}

Represents the width of the shape, in unit of inch.

**Type:** float

### GroupShape.WidthPt property {#widthpt}

Represents the width of the shape, in unit of point.

**Type:** float

### GroupShape.WidthCM property {#widthcm}

Represents the width of the shape, in unit of centimeters.

**Type:** float

### GroupShape.Height property {#height}

Represents the height of shape, in unit of pixel.

**Type:** int

### GroupShape.HeightInch property {#heightinch}

Represents the height of the shape, in unit of inches.

**Type:** float

### GroupShape.HeightPt property {#heightpt}

Represents the height of the shape, in unit of points.

**Type:** float

### GroupShape.HeightCM property {#heightcm}

Represents the height of the shape, in unit of centimeters.

**Type:** float

### GroupShape.Left property {#left}

Represents the horizontal offset of shape from its left column, in unit of pixels.

**Type:** int

### GroupShape.LeftInch property {#leftinch}

Represents the horizontal offset of shape from its left column, in unit of inches.

**Type:** float

### GroupShape.LeftCM property {#leftcm}

Represents the horizontal offset of shape from its left column, in unit of centimeters.

**Type:** float

### GroupShape.Top property {#top}
...
### GroupShape.TopInch property {#topinch}

Represents the vertical offset of shape from its top row, in unit of inches.

**Type:** float

### GroupShape.TopCM property {#topcm}

Represents the vertical offset of shape from its top row, in unit of centimeters.

**Type:** float

### GroupShape.TopToCorner property {#toptocorner}

Gets and sets the vertical offset of shape from worksheet top border, in unit of pixels.

**Type:** int

### GroupShape.LeftToCorner property {#lefttocorner}

Gets and sets the horizonal offset of shape from worksheet left border.

**Type:** int

### GroupShape.X property {#x}

Gets and sets the horizontal offset of shape from worksheet left border,in unit of pixels.

**Type:** int

### GroupShape.Y property {#y}

Gets and sets the vertical offset of shape from worksheet top border,in unit of pixels.

**Type:** int

### GroupShape.WidthScale property {#widthscale}
...
### GroupShape.HeightScale property {#heightscale}
...
### GroupShape.TopInShape property {#topinshape}
...
### GroupShape.LeftInShape property {#leftinshape}
...
### GroupShape.WidthInShape property {#widthinshape}
...
### GroupShape.HeightInShape property {#heightinshape}

Represents the vertical offset of shape from the top border of the parent shape, in unit of 1/4000 of height of the parent shape.. Only Applies when this shape in the group or chart.

**Type:** int

### GroupShape.Group property {#group}

Gets the group shape which contains this shape.

**Type:** GroupShape

### GroupShape.Type property {#type}

Gets the auto shape type. The value of the property is AutoShapeType integer constant.

**Type:** int

### GroupShape.HasLine property {#hasline}

Gets and sets the line border of the shape is visible.

**Type:** boolean

### GroupShape.IsFilled property {#isfilled}

Indicates whether the fill format is visible.

**Type:** boolean

### GroupShape.IsFlippedHorizontally property {#isflippedhorizontally}

Gets and sets whether shape is horizontally flipped .

**Type:** boolean

### GroupShape.IsFlippedVertically property {#isflippedvertically}

Gets and sets whether shape is vertically flipped .

**Type:** boolean

### GroupShape.ActualLowerRightRow property {#actuallowerrightrow}

Get the actual bottom row.

**Type:** int

### GroupShape.RelativeToOriginalPictureSize property {#relativetooriginalpicturesize}

Indicates whether shape is relative to original picture size.

**Type:** boolean

### GroupShape.LinkedCell property {#linkedcell}

Gets or sets the worksheet range linked to the control's value.

**Type:** String

### GroupShape.InputRange property {#inputrange}

Gets or sets the worksheet range used to fill the specified combo box.

**Type:** String

### GroupShape.TextShapeType property {#textshapetype}

Gets and sets the preset text shape type. The value of the property is AutoShapeType integer constant.

**Type:** int

### GroupShape.TextBody property {#textbody}

Gets and sets the setting of the shape's text.

**Type:** FontSettingCollection

### GroupShape.Font property {#font}

Represents the font of shape.

**Type:** Font

### GroupShape.TextOptions property {#textoptions}

Represents the text options of the shape.

**Type:** TextOptions

### GroupShape.Text property {#text}

Gets and sets the text of this shape.

**Type:** String

### GroupShape.IsRichText property {#isrichtext}

Whether or not the text is rich text.

**Type:** boolean

### GroupShape.HtmlText property {#htmltext}

Gets and sets the html string which contains data and some formats in this textbox.

**Type:** String

### GroupShape.TextVerticalOverflow property {#textverticaloverflow}
...
### GroupShape.TextHorizontalOverflow property {#texthorizontaloverflow}
...
### GroupShape.IsTextWrapped property {#istextwrapped}

Gets and sets the text wrapped type of the shape which contains text.

**Type:** boolean

### GroupShape.TextOrientationType property {#textorientationtype}

Gets and sets the text orientation type of the shape. The value of the property is TextOrientationType integer constant.

**Type:** int

### GroupShape.TextHorizontalAlignment property {#texthorizontalalignment}
...
### GroupShape.TextVerticalAlignment property {#textverticalalignment}
...
### GroupShape.TextDirection property {#textdirection}

Gets/Sets the direction of the text flow for this object. The value of the property is TextDirectionType integer constant.

**Type:** int

### GroupShape.TextBoxOptions property {#textboxoptions}

**Type:** TextBoxOptions

### GroupShape.ControlData property {#controldata}

Gets the data of control.

**Type:** byte[]

### GroupShape.Paths property {#paths}

Gets the paths of a custom geometric shape.

**Type:** ShapePathCollection

### GroupShape.Geometry property {#geometry}

Gets the geometry

**Type:** Geometry

### GroupShape.CreateId property {#createid}

Gets and sets create id for this shape.

**Type:** UUID

### GroupShape.IsDecorative property {#isdecorative}

Indicates whether the object is decorative.

**Type:** boolean

### GroupShape.Item (int) property {#itemint}
...
### getGroupedShapes() {#getgroupedshapes}
