...
type: docs
weight: 4400
url: /cells/python-java/asposecells.api/picture/
---
...
| [OriginalHeight](#originalheight) | int | Gets the original height of the picture. |
| [OriginalWidth](#originalwidth) | int | Gets the original width of the picture. |
| [BorderLineColor](#borderlinecolor) | Color | Represents the com.aspose.cells.Color of the border line of a picture. |
| [BorderWeight](#borderweight) | float | Gets or sets the weight of the border line of a picture in units of pt. |
...
| [ImageType](#imagetype) | int | Gets the image format of the picture. The value of the property is ImageType integer constant. |
| [OriginalHeightCM](#originalheightcm) | float | Gets the original height of picture, in unit of centimeters. |
| [OriginalWidthCM](#originalwidthcm) | float | Gets the original width of picture, in unit of centimeters. |
| [OriginalHeightInch](#originalheightinch) | float | Gets the original height of picture, in unit of inches. |
| [OriginalWidthInch](#originalwidthinch) | float | Gets the original width of picture, in unit of inches. |
