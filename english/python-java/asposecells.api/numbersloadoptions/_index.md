...
| [LoadTableType](#loadtabletype) | int | Gets and sets the type of loading multiple tables in one worksheet. The value of the property is LoadNumbersTableType in |
