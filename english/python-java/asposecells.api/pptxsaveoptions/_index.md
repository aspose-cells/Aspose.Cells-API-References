...
| [AdjustFontSizeForRowType](#adjustfontsizeforrowtype) | int | Represents what type of line needs to be adjusted size of font if height of row is small. The value of the property is A |
| [ExportViewType](#exportviewtype) | int | Gets and sets the display type when exporting to PowerPoint. The default exporting type is working as printing. The valu |
