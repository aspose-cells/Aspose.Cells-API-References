...
articleTitle: "EquationComponentNode"
...
### EquationComponentNode.ParentNode property {#parentnode}

Specifies the parent node of the current node

**Type:** EquationNode

### EquationComponentNode.Type property {#type}

Represents the type of the node. The value of the property is TextNodeType integer constant.

**Type:** int

### EquationComponentNode.EquationType property {#equationtype}

Get the equation type of the current node The value of the property is EquationNodeType integer constant.

**Type:** int

### EquationComponentNode.StartIndex property {#startindex}

Gets the start index of the characters.

**Type:** int

### EquationComponentNode.Length property {#length}

Gets the length of the characters.

**Type:** int

### EquationComponentNode.Font property {#font}

Returns the font of this object.

**Type:** Font

### EquationComponentNode.TextOptions property {#textoptions}
