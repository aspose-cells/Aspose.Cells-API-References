...
type: docs
weight: 10
url: /cells/python-java/asposecells.api/aboveaverage/
---
...
| [StdDev](#stddev) | int | Get or set the number of standard deviations to include above or below the average in the conditional formatting rule. T |
