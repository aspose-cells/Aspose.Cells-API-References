...
title: "ListBox Class"
linktitle: "ListBox"
articleTitle: "ListBox"
second_title: "Aspose.Cells for Python via Java"
description: "Represents a list box object."
type: docs
weight: 3400
url: /cells/python-java/asposecells.api/listbox/
---
...
| --- | --- | --- |
| [ItemCount](#itemcount) | int | Gets the number of items in the list box. |
| [SelectedIndex](#selectedindex) | int | Gets or sets the index number of the currently selected item in a list box or combo box. Zero-based. -1 presents no item |
| [SelectedCells](#selectedcells) | Cell[] | Gets the selected cells. Returns null if the input range is not set or no item is selected |
| [Shadow](#shadow) | boolean | Indicates whether the combobox has 3-D shading. |
| [SelectionType](#selectiontype) | int | Gets or sets the selection mode of the specified list box. The value of the property is SelectionType integer constant. |
| [PageChange](#pagechange) | int | Specifies the amount by which the control's value is changed when the user clicks on the scrollbar's page up or page dow |
...
| Name | Description |
| --- | --- |
| [selectedItem](#selecteditem) | Sets whether the item is selected |
| [isSelected](#isselected) | Indicates whether the item is selected. |
...
### ListBox.ItemCount property {#itemcount}

Gets the number of items in the list box.

**Type:** int

### ListBox.SelectedIndex property {#selectedindex}
...
### ListBox.MacroName property {#macroname}

Gets and sets the name of macro.

**Type:** String

### ListBox.IsEquation property {#isequation}

Indicates whether the shape only contains an equation.

**Type:** boolean

### ListBox.IsSmartArt property {#issmartart}

Indicates whether the shape is a smart art. Only for ooxml file.

**Type:** boolean

### ListBox.ZOrderPosition property {#zorderposition}
...
### ListBox.AlternativeText property {#alternativetext}

Returns or sets the descriptive (alternative) text string of the Shape object.

**Type:** String

### ListBox.Title property {#title}

Specifies the title (caption) of the current shape object.

**Type:** String

### ListBox.LineFormat property {#lineformat}
...
### ListBox.FillFormat property {#fillformat}
...
### ListBox.Glow property {#glow}

Represents a GlowEffect object that specifies glow effect for the chart element or shape.

**Type:** GlowEffect

### ListBox.SoftEdges property {#softedges}

Gets and sets the radius of blur to apply to the edges, in unit of points.

**Type:** float

### ListBox.ThreeDFormat property {#threedformat}

Gets and sets 3d format of the shape.

**Type:** ThreeDFormat

### ListBox.FormatPicture property {#formatpicture}

Gets and sets the options of the picture format.

**Type:** MsoFormatPicture

### ListBox.IsHidden property {#ishidden}

Indicates whether the object is visible.

**Type:** boolean

### ListBox.IsLockAspectRatio property {#islockaspectratio}
...
### ListBox.IsLocked property {#islocked}
...
### ListBox.UpperLeftRow property {#upperleftrow}

Represents the top row index. If the shape is in the shape or in the group , UpperLeftRow will be ignored.

**Type:** int

### ListBox.UpperDeltaY property {#upperdeltay}

Gets or sets the shape's vertical offset from its upper left corner row. The range of value is 0 to 256.

**Type:** int

### ListBox.UpperLeftColumn property {#upperleftcolumn}

Represents upper left corner column index.

**Type:** int

### ListBox.UpperDeltaX property {#upperdeltax}

Gets or sets the shape's horizontal offset from its upper left corner column. The range of value is 0 to 1024.

**Type:** int

### ListBox.LowerRightRow property {#lowerrightrow}

Represents lower right corner row index.

**Type:** int

### ListBox.LowerDeltaY property {#lowerdeltay}

Gets or sets the shape's vertical offset from its lower right corner row. The range of value is 0 to 256.

**Type:** int

### ListBox.LowerRightColumn property {#lowerrightcolumn}

Represents lower right corner column index.

**Type:** int

### ListBox.LowerDeltaX property {#lowerdeltax}

Gets or sets the shape's horizontal offset from its lower right corner column. The range of value is 0 to 1024.

**Type:** int

### ListBox.Right property {#right}

Represents the width of the shape's horizontal offset from its lower right corner column, in unit of pixels.

**Type:** int

### ListBox.Bottom property {#bottom}

Represents the width of the shape's vertical offset from its lower bottom corner row, in unit of pixels.

**Type:** int

### ListBox.Width property {#width}

Represents the width of shape, in unit of pixels.

**Type:** int

### ListBox.WidthInch property {#widthinch}

Represents the width of the shape, in unit of inch.

**Type:** float

### ListBox.WidthPt property {#widthpt}

Represents the width of the shape, in unit of point.

**Type:** float

### ListBox.WidthCM property {#widthcm}

Represents the width of the shape, in unit of centimeters.

**Type:** float

### ListBox.Height property {#height}

Represents the height of shape, in unit of pixel.

**Type:** int

### ListBox.HeightInch property {#heightinch}

Represents the height of the shape, in unit of inches.

**Type:** float

### ListBox.HeightPt property {#heightpt}

Represents the height of the shape, in unit of points.

**Type:** float

### ListBox.HeightCM property {#heightcm}

Represents the height of the shape, in unit of centimeters.

**Type:** float

### ListBox.Left property {#left}

Represents the horizontal offset of shape from its left column, in unit of pixels.

**Type:** int

### ListBox.LeftInch property {#leftinch}

Represents the horizontal offset of shape from its left column, in unit of inches.

**Type:** float

### ListBox.LeftCM property {#leftcm}

Represents the horizontal offset of shape from its left column, in unit of centimeters.

**Type:** float

### ListBox.Top property {#top}
...
### ListBox.TopInch property {#topinch}

Represents the vertical offset of shape from its top row, in unit of inches.

**Type:** float

### ListBox.TopCM property {#topcm}

Represents the vertical offset of shape from its top row, in unit of centimeters.

**Type:** float

### ListBox.TopToCorner property {#toptocorner}

Gets and sets the vertical offset of shape from worksheet top border, in unit of pixels.

**Type:** int

### ListBox.LeftToCorner property {#lefttocorner}

Gets and sets the horizonal offset of shape from worksheet left border.

**Type:** int

### ListBox.X property {#x}

Gets and sets the horizontal offset of shape from worksheet left border,in unit of pixels.

**Type:** int

### ListBox.Y property {#y}

Gets and sets the vertical offset of shape from worksheet top border,in unit of pixels.

**Type:** int

### ListBox.WidthScale property {#widthscale}
...
### ListBox.HeightScale property {#heightscale}
...
### ListBox.TopInShape property {#topinshape}
...
### ListBox.LeftInShape property {#leftinshape}
...
### ListBox.WidthInShape property {#widthinshape}
...
### ListBox.HeightInShape property {#heightinshape}

Represents the vertical offset of shape from the top border of the parent shape, in unit of 1/4000 of height of the parent shape.. Only Applies when this shape in the group or chart.

**Type:** int

### ListBox.Group property {#group}

Gets the group shape which contains this shape.

**Type:** GroupShape

### ListBox.Type property {#type}

Gets the auto shape type. The value of the property is AutoShapeType integer constant.

**Type:** int

### ListBox.HasLine property {#hasline}

Gets and sets the line border of the shape is visible.

**Type:** boolean

### ListBox.IsFilled property {#isfilled}

Indicates whether the fill format is visible.

**Type:** boolean

### ListBox.IsFlippedHorizontally property {#isflippedhorizontally}

Gets and sets whether shape is horizontally flipped .

**Type:** boolean

### ListBox.IsFlippedVertically property {#isflippedvertically}

Gets and sets whether shape is vertically flipped .

**Type:** boolean

### ListBox.ActualLowerRightRow property {#actuallowerrightrow}

Get the actual bottom row.

**Type:** int

### ListBox.RelativeToOriginalPictureSize property {#relativetooriginalpicturesize}

Indicates whether shape is relative to original picture size.

**Type:** boolean

### ListBox.LinkedCell property {#linkedcell}

Gets or sets the worksheet range linked to the control's value.

**Type:** String

### ListBox.InputRange property {#inputrange}

Gets or sets the worksheet range used to fill the specified combo box.

**Type:** String

### ListBox.TextShapeType property {#textshapetype}

Gets and sets the preset text shape type. The value of the property is AutoShapeType integer constant.

**Type:** int

### ListBox.TextBody property {#textbody}

Gets and sets the setting of the shape's text.

**Type:** FontSettingCollection

### ListBox.Font property {#font}

Represents the font of shape.

**Type:** Font

### ListBox.TextOptions property {#textoptions}

Represents the text options of the shape.

**Type:** TextOptions

### ListBox.Text property {#text}

Gets and sets the text of this shape.

**Type:** String

### ListBox.IsRichText property {#isrichtext}

Whether or not the text is rich text.

**Type:** boolean

### ListBox.HtmlText property {#htmltext}

Gets and sets the html string which contains data and some formats in this textbox.

**Type:** String

### ListBox.TextVerticalOverflow property {#textverticaloverflow}
...
### ListBox.TextHorizontalOverflow property {#texthorizontaloverflow}
...
### ListBox.IsTextWrapped property {#istextwrapped}

Gets and sets the text wrapped type of the shape which contains text.

**Type:** boolean

### ListBox.TextOrientationType property {#textorientationtype}

Gets and sets the text orientation type of the shape. The value of the property is TextOrientationType integer constant.

**Type:** int

### ListBox.TextHorizontalAlignment property {#texthorizontalalignment}
...
### ListBox.TextVerticalAlignment property {#textverticalalignment}
...
### ListBox.TextDirection property {#textdirection}

Gets/Sets the direction of the text flow for this object. The value of the property is TextDirectionType integer constant.

**Type:** int

### ListBox.TextBoxOptions property {#textboxoptions}

**Type:** TextBoxOptions

### ListBox.ControlData property {#controldata}

Gets the data of control.

**Type:** byte[]

### ListBox.Paths property {#paths}

Gets the paths of a custom geometric shape.

**Type:** ShapePathCollection

### ListBox.Geometry property {#geometry}

Gets the geometry

**Type:** Geometry

### ListBox.CreateId property {#createid}

Gets and sets create id for this shape.

**Type:** UUID

### ListBox.IsDecorative property {#isdecorative}

Indicates whether the object is decorative.

**Type:** boolean

### selectedItem(itemIndex, isSelected) {#selecteditem}

Sets whether the item is selected

| Parameter | Type | Description |
| --- | --- | --- |
| itemIndex | int | The item index |
...
### isSelected(itemIndex) {#isselected}
