...
| [FontSize](#fontsize) | float | Gets/Sets the default standard font size for the workbook. |
| [HorizontalAlignment](#horizontalalignment) | int | Gets/Sets the default value for horizontal alignment The value of the property is TextAlignmentType integer constant. |
| [VerticalAlignment](#verticalalignment) | int | Gets/Sets the default value for vertical alignment The value of the property is TextAlignmentType integer constant. |
