...
|picture_size_mode|Gets and sets how to display the picture.|
|special_effect|Gets and sets the special effect of the control.|
|picture|Gets and sets the data of the picture.|
|picture_alignment|Gets and sets the alignment of the picture inside the Form or Image.|
|is_tiled|Indicates whether the picture is tiled across the background.|
