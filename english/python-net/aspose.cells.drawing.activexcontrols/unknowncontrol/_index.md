...
type: docs
weight: 140
url: /cells/python-net/aspose.cells.drawing.activexcontrols/unknowncontrol/
---
...
|persistence_type|Gets the persistence method to persist an ActiveX control.|
## Methods
| Name | Description |
| :- | :- |
|get_relationship_data(rel_id)|Gets the related data.|
