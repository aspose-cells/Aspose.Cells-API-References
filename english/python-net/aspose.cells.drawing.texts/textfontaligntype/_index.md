...
type: docs
weight: 170
url: /cells/python-net/aspose.cells.drawing.texts/textfontaligntype/
---
...
| :- | :- |
|AUTOMATIC|When the text flow is horizontal or simple vertical same as fontBaseline <br/>            but for other vertical modes same as fontCenter.|
