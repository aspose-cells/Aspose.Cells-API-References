...
|get_cube_point_x_px(index)|Gets x-coordinate of the apex point of walls cube after calls Chart.Calculate() method.<br/>            The number of apex points of walls cube is eight|
|get_cube_point_y_px(index)|Gets y-coordinate of the apex point of walls cube after calls Chart.Calculate() method.<br/>            The number of apex points of walls cube is eight.|
