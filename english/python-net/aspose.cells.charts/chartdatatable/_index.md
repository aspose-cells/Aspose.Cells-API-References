...
|has_border_horizontal|True if the chart data table has horizontal cell borders|
|has_border_vertical|True if the chart data table has vertical cell borders|
|has_border_outline|True if the chart data table has outline borders|
|show_legend_key|True if the data label legend key is visible.|
