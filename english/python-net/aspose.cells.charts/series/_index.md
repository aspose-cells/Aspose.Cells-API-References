...
| [hi_lo_lines](/cells/python-net/aspose.cells.charts/series/hi_lo_lines) | Returns a HiLoLines object that represents the high-low lines for a series on a line chart. <br/>Applies only to line charts. |
...
| [split_value](/cells/python-net/aspose.cells.charts/series/split_value) | Returns or sets a value that shall be used to determine which data points are in the second pie or bar on<br/>a pie of pie or bar of pie chart. |
| [is_auto_split](/cells/python-net/aspose.cells.charts/series/is_auto_split) | Indicates whether the threshold value is automatic. |
| [bubble_scale](/cells/python-net/aspose.cells.charts/series/bubble_scale) | Gets or sets the scale factor for bubbles in the specified chart group. <br/>It can be an integer value from 0 (zero) to 300, <br/>corresponding to a percentage of the default size.<br/>Applies only to bubble charts. |
| [size_represents](/cells/python-net/aspose.cells.charts/series/size_represents) | Gets or sets what the bubble size represents on a bubble chart. |
| [show_negative_bubbles](/cells/python-net/aspose.cells.charts/series/show_negative_bubbles) | True if negative bubbles are shown for the chart group. Valid only for bubble charts. |
| [doughnut_hole_size](/cells/python-net/aspose.cells.charts/series/doughnut_hole_size) | Returns or sets the size of the hole in a doughnut chart group. <br/>The hole size is expressed as a percentage of the chart size, between 10 and 90 percent. |
...
| Method | Description |
| :- | :- |
| [move(count)](/cells/python-net/aspose.cells.charts/series/move/#int) | Moves the series up or down. |
