...
type: docs
weight: 470
url: /cells/python-net/aspose.cells.drawing/radiobutton/
---
...
|is_checked|Indicates if the radiobutton is checked or not.|
|shadow|Indicates whether the combobox has 3-D shading.|
|group_box|Gets the GroupBox that contains this RadioButton.|
## Methods
| Name | Description |
| :- | :- |
