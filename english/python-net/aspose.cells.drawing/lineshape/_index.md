...
type: docs
weight: 310
url: /cells/python-net/aspose.cells.drawing/lineshape/
---
...
|begin_arrowhead_style|Gets and sets the begin arrow head style of the line.|
|begin_arrowhead_width|Gets and sets the begin arrow head width of the line.|
|begin_arrowhead_length|Gets and sets the begin arrow head length of the line.|
|end_arrowhead_style|Gets and sets the end arrow head style of the line.|
|end_arrowhead_width|Gets and sets the end arrow head width of the line.|
|end_arrowhead_length|Gets and sets the end arrow head length of the line.|
## Methods
| Name | Description |
| :- | :- |
