...
type: docs
weight: 120
url: /cells/python-net/aspose.cells.drawing/combobox/
---
...
|selected_value|Gets the selected value of the combox box.|
|selected_cell|Gets the selected cell in the input range of the combo box.|
|shadow|Indicates whether the combobox has 3-D shading.|
|drop_down_lines|Gets or sets the number of list lines displayed in the drop-down portion of a combo box.|
## Methods
| Name | Description |
| :- | :- |
