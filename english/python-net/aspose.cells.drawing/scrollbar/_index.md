...
type: docs
weight: 500
url: /cells/python-net/aspose.cells.drawing/scrollbar/
---
...
|current_value|Gets or sets the current value.|
...
|incremental_change|Gets or sets the amount that the scroll bar or spinner is incremented a line scroll.|
|page_change|Gets or sets page change|
|shadow|Indicates whether the shape has 3-D shading.|
|is_horizontal|Indicates whether this is a horizontal scroll bar.|
## Methods
| Name | Description |
| :- | :- |
