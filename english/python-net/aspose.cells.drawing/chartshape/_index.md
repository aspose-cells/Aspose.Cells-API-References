...
type: docs
weight: 80
url: /cells/python-net/aspose.cells.drawing/chartshape/
---

## ChartShape class

Represents the shape of the chart.<br/>            Properties and methods for the ChartObject object control the appearance and size of the embedded chart on the worksheet.
