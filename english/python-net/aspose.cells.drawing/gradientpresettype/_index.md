...
type: docs
weight: 1150
url: /cells/python-net/aspose.cells.drawing/gradientpresettype/
---
...
|UNKNOWN|Unknown preset color.<br/>            Only for the preset color (which is not same as any known preset color) in the template workbook.|
