...
type: docs
weight: 90
url: /cells/python-net/aspose.cells.drawing/checkbox/
---
...
|value|Indicates if the checkbox is checked or not.|
|check_value|Gets or set checkbox' value.|
|checked_value|Gets or set checkbox' value.|
