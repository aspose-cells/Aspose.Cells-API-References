...
type: docs
weight: 520
url: /python-net/aspose.cells.drawing/shape/
is_root: false
---
...
| [spid](/cells/python-net/aspose.cells.drawing/shape/spid) | Specifies an optional string that an application can use to Identify the particular shape. |
