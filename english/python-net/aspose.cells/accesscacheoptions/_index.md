...
type: docs
weight: 4270
url: /cells/python-net/aspose.cells/accesscacheoptions/
---
...
|CELL_DISPLAY|Apply possible optimization for getting display-related results of<br/>            cells([display_string_value](/cells/python-net/aspose.cells/cell/), [None](/cells/python-net/aspose.cells/cell/), [None](/cells/python-net/aspose.cells/cell/), etc.).<br/>            Cells data and style-related objects(Cell/Row/Column styles, column width, etc.) should not be changed<br/>            during the optimized access.|
