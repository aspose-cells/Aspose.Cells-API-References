...
| [region](/cells/python-net/aspose.cells/xmlloadoptions/region) | Gets or sets the system regional settings based on CountryCode at the time the file was loaded. |
