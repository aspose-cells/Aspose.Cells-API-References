...
| Name | Description |
| :- | :- |
|WorkbookDesigner()|Initializes a new instance of the [WorkbookDesigner](/python-net/aspose.cells/workbookdesigner/) class.|
|WorkbookDesigner(workbook)|Initializes a new instance of the WorkbookDesigner class|
## Properties
| Name | Description |
| :- | :- |
|workbook|Gets and sets the [workbook](/python-net/aspose.cells/workbookdesigner/) object.|
...
| Name | Description |
| :- | :- |
|set_data_source(data_source, cells_data_table)|Sets data source of a [ICellsDataTable](/python-net/aspose.cells/icellsdatatable/) object.|
