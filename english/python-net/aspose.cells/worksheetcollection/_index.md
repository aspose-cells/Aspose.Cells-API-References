...
| Method | Description |
| :- | :- |
| [get(index)](/cells/python-net/aspose.cells/worksheetcollection/get/#int) | Add API for Python Via .Net.since this[int index] is unsupported |
| [get(sheet_name)](/cells/python-net/aspose.cells/worksheetcollection/get/#str) | Add API for Python Via .Net.since this[string sheetName] is unsupported |
| [add(type)](/cells/python-net/aspose.cells/worksheetcollection/add/#SheetType) | Adds a worksheet to the collection. |
| [add()](/cells/python-net/aspose.cells/worksheetcollection/add/#) | Adds a worksheet to the collection. |
| [add(sheet_name)](/cells/python-net/aspose.cells/worksheetcollection/add/#str) | Adds a worksheet to the collection. |
| [register_add_in_function(add_in_file, function_name, lib)](/cells/python-net/aspose.cells/worksheetcollection/register_add_in_function/#str-str-bool) | Adds addin function into the workbook |
| [register_add_in_function(id, function_name)](/cells/python-net/aspose.cells/worksheetcollection/register_add_in_function/#int-str) | Adds addin function into the workbook |
| [add_copy(sheet_name)](/cells/python-net/aspose.cells/worksheetcollection/add_copy/#str) | Adds a worksheet to the collection and copies data from an existed worksheet. |
...
| [swap_sheet(sheet_index1, sheet_index2)](/cells/python-net/aspose.cells/worksheetcollection/swap_sheet/#int-int) | Swaps the two sheets. |
| [remove_at(name)](/cells/python-net/aspose.cells/worksheetcollection/remove_at/#str) | Removes the element at a specified name. |
