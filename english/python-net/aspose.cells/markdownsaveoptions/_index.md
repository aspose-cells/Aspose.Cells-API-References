...
type: docs
weight: 1030
url: /python-net/aspose.cells/markdownsaveoptions/
is_root: false
---
...
| [cached_file_folder](/cells/python-net/aspose.cells/markdownsaveoptions/cached_file_folder) | The cached file folder is used to store some large data. |
