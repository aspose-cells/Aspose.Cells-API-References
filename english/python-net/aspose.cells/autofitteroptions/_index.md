...
type: docs
weight: 80
url: /cells/python-net/aspose.cells/autofitteroptions/
---
...
| Name | Description |
| :- | :- |
|AutoFitterOptions()|Initializes a new instance of the AutoFitterOptions class|
## Properties
| Name | Description |
| :- | :- |
|default_edit_language|Gets or sets default edit language.|
|auto_fit_merged_cells|Indicates whether auto fit row height when the cells is merged in a row.<br/>            The default value is false.|
