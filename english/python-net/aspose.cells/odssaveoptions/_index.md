...
|OdsSaveOptions(save_format)|Initializes a new instance of the OdsSaveOptions class|
## Properties
| Name | Description |
| :- | :- |
...
|generator_type|Gets and sets the generator of the ods file.|
|is_strict_schema11|Indicates whether the ods file should be saved as ODF format version 1.1. Default is false.|
