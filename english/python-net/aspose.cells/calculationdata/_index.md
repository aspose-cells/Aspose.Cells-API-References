...
type: docs
weight: 120
url: /python-net/aspose.cells/calculationdata/
---
...
| Name | Description |
| :- | :- |
|get_param_value(index)|Gets the represented value object of the parameter at given index.|
|get_param_text(index)|Gets the literal text of the parameter at given index.|
