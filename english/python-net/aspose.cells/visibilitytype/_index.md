...
type: docs
weight: 5190
url: /python-net/aspose.cells/visibilitytype/
---
...
|VERY_HIDDEN|Indicates the sheet is hidden and cannot be shown in the user interface (UI). <br/>            This state is only available programmatically.|
