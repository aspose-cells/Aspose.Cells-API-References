...
type: docs
weight: 60
url: /python-net/aspose.cells/rangecollection/last_index_of/
is_root: false
---
...
| :- | :- | :- |
| item | [Range](/cells/python-net/aspose.cells/range) | The object to locate in the array list. The value can be null. |
