...
| :- | :- |
| [ImageSaveOptions()](/cells/python-net/aspose.cells/imagesaveoptions/__init__/#) | Creates the options for saving image file. |
| [ImageSaveOptions(save_format)](/cells/python-net/aspose.cells/imagesaveoptions/__init__/#SaveFormat) | Creates the options for saving image file. |
...
| [cached_file_folder](/cells/python-net/aspose.cells/imagesaveoptions/cached_file_folder) | The cached file folder is used to store some large data. |
