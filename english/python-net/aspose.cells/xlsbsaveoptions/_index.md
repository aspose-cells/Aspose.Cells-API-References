...
type: docs
weight: 1650
url: /python-net/aspose.cells/xlsbsaveoptions/
---
...
The XlsbSaveOptions type exposes the following members:
## Constructors
| Name | Description |
| :- | :- |
|XlsbSaveOptions()|Creates xlsb file save options.|
|XlsbSaveOptions(save_format)|Initializes a new instance of the XlsbSaveOptions class|
## Properties
| Name | Description |
| :- | :- |
...
|export_all_column_indexes|Indicates whether exporting all column indexes for cells.|
