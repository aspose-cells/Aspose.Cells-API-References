...
|get_values(calculate_formulas)|Gets cell values in this area.|
|get_value(row_offset, col_offset)|Gets cell value with given offset from the top-left of this area.|
|get_value(row_offset, col_offset, calculate_formulas)|Gets cell value with given offset from the top-left of this area.|
