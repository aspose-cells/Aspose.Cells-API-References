...
|detect_file_format(file_path)|Detects and returns the information about a format of an excel stored in a stream.|
|detect_file_format(file_path, password)|Detects and returns the information about a format of an excel stored in a stream.|
