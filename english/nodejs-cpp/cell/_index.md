...
| [setEmbeddedImage(number[])](#setEmbeddedImage-number[]-)| Gets and sets the embeddedn image in the cell. |
...
| [setCharacters(FontSetting[])](#setCharacters-fontsetting[]-)| Sets rich text format of the cell. |
...
### setEmbeddedImage(number[]) {#setEmbeddedImage-number[]-}
...
### setCharacters(FontSetting[]) {#setCharacters-fontsetting[]-}
