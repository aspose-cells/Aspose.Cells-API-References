...
<b>@deprecated.</b> Please use the 'name' property instead. Gets the Range title. This is used as a descriptor, not as a named range definition.
...
<b>@deprecated.</b> Please use the 'cellArea' property instead. Gets the [CellArea](../cellarea/) object represents the cell area to be protected.
...
<b>@deprecated.</b> Please use the 'password' property instead. Represents the password to protect the range.
...
<b>@deprecated.</b> Please use the 'securityDescriptor' property instead. The security descriptor defines user accounts who may edit this range without providing a password to access the range.
