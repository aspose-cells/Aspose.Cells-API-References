...
| [set_IsLink(boolean)](#set_IsLink-boolean-)| Returns true if the OleObject links to the file. |
...
| [setImageData(number[])](#setImageData-number[]-)| Represents image of ole object as byte array. |
| [getObjectData()](#getObjectData--)| Represents embedded ole object data as byte array. |
| [setObjectData(number[])](#setObjectData-number[]-)| Represents embedded ole object data as byte array. |
...
| [setProgID(string)](#setProgID-string-)| Gets or sets the ProgID of the OLE object. |
| [getFileFormatType()](#getFileFormatType--)| Gets and sets the file type of the embedded ole object data |
| [setFileFormatType(FileFormatType)](#setFileFormatType-fileformattype-)| Gets and sets the file type of the embedded ole object data |
...
| [setObjectSourceFullName(string)](#setObjectSourceFullName-string-)| Returns the source full name of the source file for the linked OLE object. |
| [getLabel()](#getLabel--)| Gets and sets the display label of the linked ole object. |
| [setLabel(string)](#setLabel-string-)| Gets and sets the display label of the linked ole object. |
| [getAutoUpdate()](#getAutoUpdate--)| Specifies whether the link to the OleObject is automatically updated or not. |
| [setAutoUpdate(boolean)](#setAutoUpdate-boolean-)| Specifies whether the link to the OleObject is automatically updated or not. |
...
| [setClassIdentifier(number[])](#setClassIdentifier-number[]-)| Gets and sets the class identifier of the embedded object. It means which application opens the embedded file. |
| [getImageType()](#getImageType--)| Gets the image format of the ole object. |
| [setEmbeddedObject(boolean, number[], string, boolean, string)](#setEmbeddedObject-boolean-number[]-string-boolean-string-)| Sets embedded object data. |
| [setEmbeddedObject(boolean, number[], string, boolean, string, boolean)](#setEmbeddedObject-boolean-number[]-string-boolean-string-boolean-)| Sets embedded object data. |
...
### setObjectData(number[]) {#setObjectData-number[]-}
...
### setClassIdentifier(number[]) {#setClassIdentifier-number[]-}
...
### setEmbeddedObject(boolean, number[], string, boolean, string) {#setEmbeddedObject-boolean-number[]-string-boolean-string-}
...
### setEmbeddedObject(boolean, number[], string, boolean, string, boolean) {#setEmbeddedObject-boolean-number[]-string-boolean-string-boolean-}
