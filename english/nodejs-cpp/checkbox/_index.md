...
| [setValue(boolean)](#setValue-boolean-)| Indicates if the checkbox is checked or not. |
| [getCheckedValue()](#getCheckedValue--)| Gets or set checkbox' value. |
| [setCheckedValue(CheckValueType)](#setCheckedValue-checkvaluetype-)| Gets or set checkbox' value. |
