...
| [setFitToViewPort(boolean)](#setFitToViewPort-boolean-)| if this property is true, the generated svg will fit to view port. |
| [getCssPrefix()](#getCssPrefix--)| Gets and sets the prefix of the css name in svg,the default value is empty string. |
| [setCssPrefix(string)](#setCssPrefix-string-)| Gets and sets the prefix of the css name in svg,the default value is empty string. |
| [getEmbeddedFontType()](#getEmbeddedFontType--)| Gets or sets the type of font that embedded in Svg. |
| [setEmbeddedFontType(SvgEmbeddedFontType)](#setEmbeddedFontType-svgembeddedfonttype-)| Gets or sets the type of font that embedded in Svg. |
