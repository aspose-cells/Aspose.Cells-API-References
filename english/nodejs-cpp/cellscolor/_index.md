...
<b>@deprecated.</b> Please use the 'isShapeColor' property instead. Gets and set the color which should apply to cell or shape.
...
<b>@deprecated.</b> Please use the 'type' property instead. The color type.
...
<b>@deprecated.</b> Please use the 'themeColor' property instead. Gets the theme color. Only applies for theme color type.
...
<b>@deprecated.</b> Please use the 'colorIndex' property instead. Gets and sets the color index in the color palette. Only applies of indexed color.
...
<b>@deprecated.</b> Please use the 'color' property instead. Gets and sets the RGB color.
...
<b>@deprecated.</b> Please use the 'argb' property instead. Gets and sets the color from a 32-bit ARGB value.
...
<b>@deprecated.</b> Please use the 'transparency' property instead. Gets and sets transparency as a value from 0.0 (opaque) through 1.0 (clear).
