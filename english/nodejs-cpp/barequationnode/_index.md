...
```javascript
class BarEquationNode extends EquationNode;
```
...
| --- | --- | --- |
| [barPosition](#barPosition--)| EquationCharacterPositionType | This attribute specifies the position of the bar in the bar object |
...
| Method | Description |
| --- | --- |
| [getBarPosition()](#getBarPosition--)| <b>@deprecated.</b> Please use the 'barPosition' property instead. This attribute specifies the position of the bar in the bar object |
| [setBarPosition(EquationCharacterPositionType)](#setBarPosition-equationcharacterpositiontype-)| <b>@deprecated.</b> Please use the 'barPosition' property instead. This attribute specifies the position of the bar in the bar object |
...
```javascript
barPosition : EquationCharacterPositionType;
```
...
<b>@deprecated.</b> Please use the 'barPosition' property instead. This attribute specifies the position of the bar in the bar object
...
### setBarPosition(EquationCharacterPositionType) {#setBarPosition-equationcharacterpositiontype-}
