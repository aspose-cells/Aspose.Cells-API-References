...
description: Represents how the application displays shapes in this workbook. Shapes might include charts images and other object data that the application supports.
type: docs
url: /nodejs-cpp/shapedisplaytype/
---
