...
| [replace(string, string[], boolean)](#replace-string-string[]-boolean-)| Replaces a cell's value with a new string array. |
| [replace(string, number[], boolean)](#replace-string-number[]-boolean-)| Replaces cells' values with an integer array. |
| [replace(string, number[], boolean)](#replace-string-number[]-boolean-)| Replaces cells' values with a double array. |
...
| [customTheme(string, Color[])](#customTheme-string-color[]-)| Customs the theme. |
...
| [updateLinkedDataSource(Workbook[])](#updateLinkedDataSource-workbook[]-)| If this workbook contains external links to other data source, Aspose.Cells will attempt to retrieve the latest data from give sources. |
...
### replace(string, string[], boolean) {#replace-string-string[]-boolean-}
...
### replace(string, number[], boolean) {#replace-string-number[]-boolean-}
...
### customTheme(string, Color[]) {#customTheme-string-color[]-}
...
### updateLinkedDataSource(Workbook[]) {#updateLinkedDataSource-workbook[]-}
