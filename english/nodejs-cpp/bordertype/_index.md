...
| Vertical | `64` | Only for dynamic style, such as conditional formatting,pivot table. |
| Horizontal | `128` | Only for dynamic style, such as conditional formatting,pivot table. |
