...
type: docs
url: /nodejs-cpp/docxsaveoptions/
---
...
| --- | --- |
| [constructor()](#constructor--)| Represents options of saving .docx file. |
| [constructor(PaginatedSaveOptions)](#constructor-paginatedsaveoptions-)| Constructs from a parent object convertible to this. |
| [constructor(boolean)](#constructor-boolean-)| Represents options of saving .docx file. |
...
| Method | Description |
| --- | --- |
| [getSaveAsEditableShaps()](#getSaveAsEditableShaps--)| <b>@deprecated.</b> Please use the 'saveAsEditableShaps' property instead. Save all drawing objecgts as editable shapes in word file.So you can edit them in Word. |
...
### saveAsEditableShaps {#saveAsEditableShaps--}
...
<b>@deprecated.</b> Please use the 'saveAsEditableShaps' property instead. Save all drawing objecgts as editable shapes in word file.So you can edit them in Word.
...
<b>@deprecated.</b> Please use the 'saveAsEditableShapes' property instead. Save all drawing objects as editable shapes in the word file, so you can edit them in Word.
...
### setSaveAsEditableShapes(boolean) {#setSaveAsEditableShapes-boolean-}
