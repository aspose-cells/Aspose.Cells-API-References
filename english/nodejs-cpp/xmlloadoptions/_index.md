...
<b>@deprecated.</b> Please use the 'isXmlMap' property instead. Indicates whether mapping xml to Excel. The default value is false.
...
<b>@deprecated.</b> Please use the 'containsMultipleWorksheets' property instead. Indicates whether importing xml as multiple worksheets.
...
<b>@deprecated.</b> Please use the 'convertNumericOrDate' property instead. Indicates whether converting the value in xml file to numeric or date.
...
<b>@deprecated.</b> Please use the 'ignoreRootAttributes' property instead. Indicates whether ignore attributes of the root element.
