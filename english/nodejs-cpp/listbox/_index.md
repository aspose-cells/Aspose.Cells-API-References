...
| --- | --- | --- |
| [itemCount](#itemCount--)| number | Readonly. Gets the number of items in the list box. |
...
| [selectedCells](#selectedCells--)| Cell[] | Readonly. Gets the selected cells. Returns null if the input range is not set or no item is selected |
| [shadow](#shadow--)| boolean | Indicates whether the combobox has 3-D shading. |
| [selectionType](#selectionType--)| SelectionType | Gets or sets the selection mode of the specified list box. |
| [pageChange](#pageChange--)| number | Specifies the amount by which the control's value is changed when the user clicks on the scrollbar's page up or page down region. |
...
| Method | Description |
| --- | --- |
| [getItemCount()](#getItemCount--)| <b>@deprecated.</b> Please use the 'itemCount' property instead. Gets the number of items in the list box. |
...
| [getSelectedCells()](#getSelectedCells--)| <b>@deprecated.</b> Please use the 'selectedCells' property instead. Gets the selected cells. Returns null if the input range is not set or no item is selected |
...
| [getSelectionType()](#getSelectionType--)| <b>@deprecated.</b> Please use the 'selectionType' property instead. Gets or sets the selection mode of the specified list box. |
| [setSelectionType(SelectionType)](#setSelectionType-selectiontype-)| <b>@deprecated.</b> Please use the 'selectionType' property instead. Gets or sets the selection mode of the specified list box. |
| [getPageChange()](#getPageChange--)| <b>@deprecated.</b> Please use the 'pageChange' property instead. Specifies the amount by which the control's value is changed when the user clicks on the scrollbar's page up or page down region. |
| [setPageChange(number)](#setPageChange-number-)| <b>@deprecated.</b> Please use the 'pageChange' property instead. Specifies the amount by which the control's value is changed when the user clicks on the scrollbar's page up or page down region. |
...
Readonly. Gets the number of items in the list box.
...
Readonly. Gets the selected cells. Returns null if the input range is not set or no item is selected
...
<b>@deprecated.</b> Please use the 'itemCount' property instead. Gets the number of items in the list box.
...
<b>@deprecated.</b> Please use the 'selectedIndex' property instead. Gets or sets the index number of the currently selected item in a list box or combo box. Zero-based.
...
<b>@deprecated.</b> Please use the 'selectedCells' property instead. Gets the selected cells. Returns null if the input range is not set or no item is selected
...
<b>@deprecated.</b> Please use the 'shadow' property instead. Indicates whether the combobox has 3-D shading.
...
<b>@deprecated.</b> Please use the 'selectionType' property instead. Gets or sets the selection mode of the specified list box.
...
<b>@deprecated.</b> Please use the 'pageChange' property instead. Specifies the amount by which the control's value is changed when the user clicks on the scrollbar's page up or page down region.
...
### selectedItem(number, boolean) {#selectedItem-number-boolean-}
