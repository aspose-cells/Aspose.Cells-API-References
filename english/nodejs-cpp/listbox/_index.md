...
| [setSelectedIndex(number)](#setSelectedIndex-number-)| Gets or sets the index number of the currently selected item in a list box or combo box. Zero-based. |
...
| [setSelectionType(SelectionType)](#setSelectionType-selectiontype-)| Gets or sets the selection mode of the specified list box. |
