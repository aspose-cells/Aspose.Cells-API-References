...
| [setCurrentValue(number)](#setCurrentValue-number-)| Gets or sets the current value. |
| [getMin()](#getMin--)| Gets or sets the minimum value of a scroll bar or spinner range. |
| [setMin(number)](#setMin-number-)| Gets or sets the minimum value of a scroll bar or spinner range. |
| [getMax()](#getMax--)| Gets or sets the maximum value of a scroll bar or spinner range. |
| [setMax(number)](#setMax-number-)| Gets or sets the maximum value of a scroll bar or spinner range. |
...
| [setIncrementalChange(number)](#setIncrementalChange-number-)| Gets or sets the amount that the scroll bar or spinner is incremented a line scroll. |
| [getPageChange()](#getPageChange--)| Gets or sets page change |
| [setPageChange(number)](#setPageChange-number-)| Gets or sets page change |
| [getShadow()](#getShadow--)| Indicates whether the shape has 3-D shading. |
| [setShadow(boolean)](#setShadow-boolean-)| Indicates whether the shape has 3-D shading. |
| [isHorizontal()](#isHorizontal--)| Indicates whether this is a horizontal scroll bar. |
| [setIsHorizontal(boolean)](#setIsHorizontal-boolean-)| Indicates whether this is a horizontal scroll bar. |
