...
| --- | --- | --- |
| [fieldIndex](#fieldIndex--)| number | Readonly. Gets the index of the field in the source fields which this filter refers to. A value of -2 indicates the values field. |
...
| Method | Description |
| --- | --- |
| [getFieldIndex()](#getFieldIndex--)| <b>@deprecated.</b> Please use the 'fieldIndex' property instead. Gets the index of the field in the source fields which this filter refers to. A value of -2 indicates the values field. |
...
Readonly. Gets the index of the field in the source fields which this filter refers to. A value of -2 indicates the values field.
...
<b>@deprecated.</b> Please use the 'fieldIndex' property instead. Gets the index of the field in the source fields which this filter refers to. A value of -2 indicates the values field.
