...
<b>@deprecated.</b> Please use the 'selectedValue' property instead. Gets the selected value of the combox box.
...
<b>@deprecated.</b> Please use the 'selectedCell' property instead. Gets the selected cell in the input range of the combo box.
...
<b>@deprecated.</b> Please use the 'dropDownLines' property instead. Gets or sets the number of list lines displayed in the drop-down portion of a combo box.
