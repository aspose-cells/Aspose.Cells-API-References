...
weight: 20
url: /nodejs-cpp/
description: Aspose.Cells for Node.js via C++ API Reference provides classes, interfaces, enumeration types, and other API details.
is_root: true
---
...
| [TimelineCollection](./timelinecollection) | Specifies the collection of all the [Timeline](../nodejs-cpp/timeline/) objects on the worksheet. It was supported since Excel 2013. |
...
| [TimelineLevelType](./timelineleveltype) | Represents the level type of [Timeline](../nodejs-cpp/timeline/) |
