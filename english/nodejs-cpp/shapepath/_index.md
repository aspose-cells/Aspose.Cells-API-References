...
<b>@deprecated.</b> Please use the 'widthPixel' property instead. Gets the width of this path in unit of pixels.
...
<b>@deprecated.</b> Please use the 'heightPixel' property instead. Gets the height of this path in unit of pixels.
