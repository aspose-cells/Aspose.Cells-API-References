...
<b>@deprecated.</b> Please use the 'partIndex' property instead. Index of current part in sequence(0 based). -1 means there are no multiple parts so the result is single.
...
<b>@deprecated.</b> Please use the 'sheetIndex' property instead. Index of the sheet where current part is in. -1 denotes there is only one sheet.
...
<b>@deprecated.</b> Please use the 'sheetName' property instead. Name of the sheet where current part is in.
