...
<b>@deprecated.</b> Please use the 'calculateOnOpen' property instead. Indicates whether the application is required to perform a full calculation when the workbook is opened.
...
<b>@deprecated.</b> Please use the 'calculationId' property instead. Specifies the version of the calculation engine used to calculate values in the workbook.
...
<b>@deprecated.</b> Please use the 'maxIteration' property instead. The maximum iterations to resolve a circular reference.
...
<b>@deprecated.</b> Please use the 'maxChange' property instead. The maximum change to resolve a circular reference.
