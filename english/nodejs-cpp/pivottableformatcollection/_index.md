...
type: docs
url: /nodejs-cpp/pivottableformatcollection/
---
...
```javascript
class PivotTableFormatCollection implements Iterable<PivotTableFormat>;
```
...
## \[Symbol.iterator\](): Iterator\<PivotTableFormat\>
