...
<b>@deprecated.</b> Please use the 'author' property instead. Gets and sets the author.
...
<b>@deprecated.</b> Please use the 'recommendReadOnly' property instead. Indicates if the Read Only Recommended option is selected.
...
<b>@deprecated.</b> Please use the 'isWriteProtected' property instead. Indicates whether this workbook is write protected.
...
<b>@deprecated.</b> Please use the 'password' property instead. Sets the protected password to modify the file.
