...
| [getSaveAsEditableShapes()](#getSaveAsEditableShapes--)| <b>@deprecated.</b> Please use the 'saveAsEditableShapes' property instead. Save all drawing objects as editable shapes in the pptx file, so you can edit them in PowerPoint. |
| [setSaveAsEditableShapes(boolean)](#setSaveAsEditableShapes-boolean-)| <b>@deprecated.</b> Please use the 'saveAsEditableShapes' property instead. Save all drawing objects as editable shapes in the pptx file, so you can edit them in PowerPoint. |
...
<b>@deprecated.</b> Please use the 'saveAsEditableShapes' property instead. Save all drawing objects as editable shapes in the pptx file, so you can edit them in PowerPoint.
