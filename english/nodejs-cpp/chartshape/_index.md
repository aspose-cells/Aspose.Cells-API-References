...
| --- | --- | --- |
| [chart](#chart--)| Chart | Readonly. Returns a Chart object that represents the chart contained in the object. |
...
| Method | Description |
| --- | --- |
| [getChart()](#getChart--)| <b>@deprecated.</b> Please use the 'chart' property instead. Returns a Chart object that represents the chart contained in the object. |
...
Readonly. Returns a Chart object that represents the chart contained in the object.
...
<b>@deprecated.</b> Please use the 'chart' property instead. Returns a Chart object that represents the chart contained in the object.
