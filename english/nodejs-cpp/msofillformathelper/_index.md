...
| [setForeColorTransparency(number)](#setForeColorTransparency-number-)| Returns or sets the degree of fore color of the specified fill as a value from 0.0 (opaque) through 1.0 (clear). |
