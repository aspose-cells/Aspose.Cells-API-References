...
| Method | Description |
| --- | --- |
| [getPosition()](#getPosition--)| <b>@deprecated.</b> Please use the 'position' property instead. Gets or sets the legend position type. |
| [setPosition(LegendPositionType)](#setPosition-legendpositiontype-)| <b>@deprecated.</b> Please use the 'position' property instead. Gets or sets the legend position type. |
| [getLegendEntries()](#getLegendEntries--)| <b>@deprecated.</b> Please use the 'legendEntries' property instead. Gets a collection of all the LegendEntry objects in the specified chart legend. Setting the legend entries of the surface chart is not supported. So it will return null if the chart type is surface chart type. |
| [isOverLay()](#isOverLay--)| <b>@deprecated.</b> Please use the 'isOverLay' property instead. Gets or sets whether showing the legend without overlapping the chart. |
| [setIsOverLay(boolean)](#setIsOverLay-boolean-)| <b>@deprecated.</b> Please use the 'isOverLay' property instead. Gets or sets whether showing the legend without overlapping the chart. |
...
<b>@deprecated.</b> Please use the 'position' property instead. Gets or sets the legend position type.
...
<b>@deprecated.</b> Please use the 'legendEntries' property instead. Gets a collection of all the LegendEntry objects in the specified chart legend. Setting the legend entries of the surface chart is not supported. So it will return null if the chart type is surface chart type.
...
<b>@deprecated.</b> Please use the 'isOverLay' property instead. Gets or sets whether showing the legend without overlapping the chart.
