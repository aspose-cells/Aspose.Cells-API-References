...
'PptxSaveOptions class. Encapsulates the object that represents pptxsaveoptions in Go.'
## PptxSaveOptions class
...
|[SetSaveAsEditableShapes](./setsaveaseditableshapes/) | Save all drawing objects as editable shapes in the pptx file, so you can edit them in PowerPoint. |
