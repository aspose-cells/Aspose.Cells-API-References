...
'BoxEquationNode class. Encapsulates the object that represents boxequationnode in Go.'
## BoxEquationNode class
...
|[BoxEquationNode_CreateNode](./boxequationnode_createnode/) | Create a node of the specified type. |
