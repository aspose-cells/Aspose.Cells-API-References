...
'MathematicalEquationNode class. Encapsulates the object that represents mathematicalequationnode in Go.'
## MathematicalEquationNode class
...
|[MathematicalEquationNode_CreateNode](./mathematicalequationnode_createnode/) | Create a node of the specified type. |
