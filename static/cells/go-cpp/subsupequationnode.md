...
'SubSupEquationNode class. Encapsulates the object that represents subsupequationnode in Go.'
## SubSupEquationNode class
...
|[SubSupEquationNode_CreateNode](./subsupequationnode_createnode/) | Create a node of the specified type. |
