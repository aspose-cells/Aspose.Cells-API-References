##Picture Class
'Picture class. Encapsulates the object that represents picture in Go.'
## Picture class
...
|[SetBorderLineColor](./setborderlinecolor/) | Represents the Color of the border line of a picture. |
...
|[SetSourceFullName](./setsourcefullname/) | Gets or sets the path and name of the source file for the linked image. |
...
|[SetIsLink](./setislink/) | Returns true if the picture is linked to a file. |
|[IsDynamicDataExchange](./isdynamicdataexchange/) | Gets or sets whether dynamic data exchange |
|[SetIsDynamicDataExchange](./setisdynamicdataexchange/) | Gets or sets whether dynamic data exchange |
