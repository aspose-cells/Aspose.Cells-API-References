##FontConfigs Class
'FontConfigs class. Encapsulates the object that represents fontconfigs in Go.'
## FontConfigs class
...
|[FontConfigs_GetFontFileDataInfo](./fontconfigs_getfontfiledatainfo/) | Get data infomation of font file data. |
...
|[FontConfigs_GetFontSubstitutes](./fontconfigs_getfontsubstitutes/) | Returns array containing font substitute names to be used if original font is not presented. |
|[FontConfigs_SetFontFolder](./fontconfigs_setfontfolder/) | Sets the fonts folder |
|[FontConfigs_SetFontFolders](./fontconfigs_setfontfolders/) | Sets the fonts folders |
|[FontConfigs_SetFontSources](./fontconfigs_setfontsources/) | Sets the fonts sources. |
