...
| [SP_APP](#SP-APP) | Specifies that the store type is a SharePoint web application. |
| [SP_CATALOG](#SP-CATALOG) | Specifies that the store type is SharePoint corporate catalog. |
## Methods
| Method | Description |
| --- | --- |
