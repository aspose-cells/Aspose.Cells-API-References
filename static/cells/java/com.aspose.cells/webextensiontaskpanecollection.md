...
| [get(int index)](#get-int-) | Gets task pane by the specific index. |
| [getClass()](#getClass--) |  |
...
```
public WebExtensionTaskPane get(int index)
```
...
| index | int | The index. |
**Returns:**
[WebExtensionTaskPane](../../com.aspose.cells/webextensiontaskpane) - The task pane.
### getClass() {#getClass--}
```
