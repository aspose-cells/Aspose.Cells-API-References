...
| [get(int fieldIndex)](#get-int-) | Gets [FilterColumn](../../com.aspose.cells/filtercolumn) object at the special field. |
| [getByIndex(int index)](#getByIndex-int-) | Returns a single Filter object from a collection. |
| [getClass()](#getClass--) |  |
...
**Returns:**
boolean
### get(int fieldIndex) {#get-int-}
```
public FilterColumn get(int fieldIndex)
```
Gets [FilterColumn](../../com.aspose.cells/filtercolumn) object at the special field.
**Parameters:**
| Parameter | Type | Description |
| --- | --- | --- |
...
**Returns:**
[FilterColumn](../../com.aspose.cells/filtercolumn) - Returns [FilterColumn](../../com.aspose.cells/filtercolumn) object.
...
| index | int |  |
**Returns:**
[FilterColumn](../../com.aspose.cells/filtercolumn)
### getClass() {#getClass--}
```
