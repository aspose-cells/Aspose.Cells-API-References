...
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [process(LowCodeLoadOptions loadOptions, LowCodeSaveOptions saveOptions)](#process-com.aspose.cells.LowCodeLoadOptions-com.aspose.cells.LowCodeSaveOptions-) | Converts template file to pdf |
| [process(String templateFile, String resultFile)](#process-java.lang.String-java.lang.String-) | Converts given template file to pdf. |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
| resultFile | java.lang.String | The resultant file, it must be pdf file. |
### toString() {#toString--}
```
