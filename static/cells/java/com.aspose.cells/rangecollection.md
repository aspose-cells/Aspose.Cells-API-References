...
| [get(int index)](#get-int-) | Gets the [Range](../../com.aspose.cells/range) element at the specified index. |
| [getClass()](#getClass--) |  |
...
| --- | --- | --- |
| range | [Range](../../com.aspose.cells/range) | Range object |
**Returns:**
int -
...
```
Gets the [Range](../../com.aspose.cells/range) element at the specified index.
**Parameters:**
| Parameter | Type | Description |
| --- | --- | --- |
| index | int | The zero based index of the element. |
**Returns:**
[Range](../../com.aspose.cells/range) - The element at the specified index.
### getClass() {#getClass--}
```
