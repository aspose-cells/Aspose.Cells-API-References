...
| Field | Description |
| --- | --- |
| [COLOR_FILTER](#COLOR-FILTER) | Filter by fill color of the cell. |
| [CUSTOM_FILTERS](#CUSTOM-FILTERS) | Custom filter type. |
| [DYNAMIC_FILTER](#DYNAMIC-FILTER) | Dynamic filter type. |
| [ICON_FILTER](#ICON-FILTER) | Filter by icon of conditional formatting. |
