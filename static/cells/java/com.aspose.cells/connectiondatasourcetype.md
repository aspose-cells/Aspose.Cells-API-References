...
| Field | Description |
| --- | --- |
| [ADO_RECORD_SET](#ADO-RECORD-SET) | ADO record set |
| [DAO_BASED_SOURCE](#DAO-BASED-SOURCE) | DAO-based source |
| [DATA_FEED_DATA_MODEL](#DATA-FEED-DATA-MODEL) | Data feed data source created by the Spreadsheet Data Model. |
| [DSP](#DSP) | DSP |
| [FILE_BASED_DATA_BASE_SOURCE](#FILE-BASED-DATA-BASE-SOURCE) | File based database source |
| [ODBC_BASED_SOURCE](#ODBC-BASED-SOURCE) | ODBC-based source |
| [OLEDB_BASED_SOURCE](#OLEDB-BASED-SOURCE) | OLE DB-based source |
| [OLEDB_DATA_MODEL](#OLEDB-DATA-MODEL) | OLE DB data source created by the Spreadsheet Data Model. |
| [TABLE](#TABLE) | Worksheet data source created by the Spreadsheet Data Model. |
| [TEXT_BASED_SOURCE](#TEXT-BASED-SOURCE) | Text-based source |
| [TEXT_DATA_MODEL](#TEXT-DATA-MODEL) | Text data source created by the Spreadsheet Data Model. |
| [UNKNOWN](#UNKNOWN) | Text data source created by the Spreadsheet Data Model. |
| [WEB_QUERY](#WEB-QUERY) | Web query |
| [WORKSHEET_DATA_MODEL](#WORKSHEET-DATA-MODEL) | Worksheet data source created by the Spreadsheet Data Model. |
## Methods
| Method | Description |
| --- | --- |
...
```
DAO-based source
### DATA_FEED_DATA_MODEL {#DATA-FEED-DATA-MODEL}
```
...
```
DSP
### FILE_BASED_DATA_BASE_SOURCE {#FILE-BASED-DATA-BASE-SOURCE}
```
...
```
ODBC-based source
### OLEDB_BASED_SOURCE {#OLEDB-BASED-SOURCE}
```
public static final int OLEDB_BASED_SOURCE
```
OLE DB-based source
### OLEDB_DATA_MODEL {#OLEDB-DATA-MODEL}
```
...
```
Text-based source
### TEXT_DATA_MODEL {#TEXT-DATA-MODEL}
```
...
```
Web query
### WORKSHEET_DATA_MODEL {#WORKSHEET-DATA-MODEL}
```
