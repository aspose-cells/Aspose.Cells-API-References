...
java.lang.Object
```
public final class PrintingPageType
```
Indicates which pages will not be printed.
## Fields
| Field | Description |
...
| [IGNORE_BLANK](#IGNORE-BLANK) | Don't print the pages which the cells are blank. |
| [IGNORE_STYLE](#IGNORE-STYLE) | Don't print the pages which cells only contain styles. |
## Methods
| Method | Description |
| --- | --- |
