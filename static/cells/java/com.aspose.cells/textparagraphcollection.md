...
| [get(int index)](#get-int-) | Gets the [TextParagraph](../../com.aspose.cells/textparagraph) object at specific index. |
| [getClass()](#getClass--) |  |
...
```
Gets the [TextParagraph](../../com.aspose.cells/textparagraph) object at specific index.
**Parameters:**
| Parameter | Type | Description |
| --- | --- | --- |
| index | int | The index. |
**Returns:**
[TextParagraph](../../com.aspose.cells/textparagraph) -
### getClass() {#getClass--}
```
