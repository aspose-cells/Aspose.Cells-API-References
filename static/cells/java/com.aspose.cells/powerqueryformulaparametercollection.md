...
| [get(int index)](#get-int-) | Gets [PowerQueryFormulaParameter](../../com.aspose.cells/powerqueryformulaparameter) by the index in the list. |
| [get(String name)](#get-java.lang.String-) | Gets [PowerQueryFormulaParameter](../../com.aspose.cells/powerqueryformulaparameter) by the name of the item. |
| [getClass()](#getClass--) |  |
...
```
Gets [PowerQueryFormulaParameter](../../com.aspose.cells/powerqueryformulaparameter) by the index in the list.
**Parameters:**
| Parameter | Type | Description |
| --- | --- | --- |
| index | int | The index. |
**Returns:**
[PowerQueryFormulaParameter](../../com.aspose.cells/powerqueryformulaparameter) -
### get(String name) {#get-java.lang.String-}
```
public PowerQueryFormulaParameter get(String name)
```
Gets [PowerQueryFormulaParameter](../../com.aspose.cells/powerqueryformulaparameter) by the name of the item.
**Parameters:**
| Parameter | Type | Description |
| --- | --- | --- |
