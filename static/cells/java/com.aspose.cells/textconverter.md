...
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [process(LowCodeLoadOptions loadOptions, LowCodeSaveOptions saveOptions)](#process-com.aspose.cells.LowCodeLoadOptions-com.aspose.cells.LowCodeSaveOptions-) | Converts file format between text based formats and other spreadsheet file formats |
| [process(String templateFile, String resultFile)](#process-java.lang.String-java.lang.String-) | Converts given template file between text based files and other formats. |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
| Parameter | Type | Description |
| --- | --- | --- |
| templateFile | java.lang.String | The template file to be converted |
