...
| [get(int index)](#get-int-) | Gets web extension binding relationship by the specific index. |
| [getClass()](#getClass--) |  |
...
| index | int | The index. |
**Returns:**
[WebExtensionBinding](../../com.aspose.cells/webextensionbinding) - The web extension binding relationship
### getClass() {#getClass--}
```
