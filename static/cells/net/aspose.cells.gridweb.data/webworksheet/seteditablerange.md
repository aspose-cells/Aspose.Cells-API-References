...
WebWorksheet method. Makes a range of cells editable. http//docs.aspose.com8082/docs/display/cellsnet/ProtectingCells Make all cells read only by calling the SetAllCellsReadonly method. then call this method to Specify the range of cells that to be editable
