##ShapePropertyCollection.SoftEdgeRadius
ShapePropertyCollection property. Gets and sets the radius of blur to apply to the edges in unit of points
...
shapeProperties.SoftEdgeRadius = 20;
// Set series colors
