##DeleteBlankOptions.EmptyFormulaValueAsBlank
DeleteBlankOptions property. Whether one cell will be taken as blank when it is formula and the calculated result is null or empty string. Default value is false
