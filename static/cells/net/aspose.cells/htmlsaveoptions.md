...
Aspose.Cells.HtmlSaveOptions class. Represents the options for saving html file
...
| [EmbeddedFontType](../../aspose.cells/htmlsaveoptions/embeddedfonttype/) { get; set; } | Gets or sets the type of font that embedded in html. Default value is None which indicates that it will not embed font in html. |
