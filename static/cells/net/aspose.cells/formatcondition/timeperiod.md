...
FormatCondition property. The applicable time period in a date occurring conditional formatting rule. Valid only for type  timePeriod. The default value is TimePeriodType.Today
