##PivotField.IsIncludeNewItemsInFilter
PivotField property. Indicates whether including new items to the field in manual filter. The default value is false
