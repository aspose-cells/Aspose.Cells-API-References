##PivotField.IsMultipleItemSelectionAllowed
PivotField property. indicates whether the field can have multiple items selected in the page field The default value is false
