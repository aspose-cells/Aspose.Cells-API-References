...
CustomDocumentPropertyCollection method. Updates values of all custom properties that are linked to contentuse cell value of linked range to update value of custom property
