...
{
public class EquationsClassEquationComponentNodeDemo
{
...
// Save and verify
workbook.Save("EquationComponentNodeDemo.xlsx");
Console.WriteLine("Equation with component nodes created successfully.");
}
}
}
```
