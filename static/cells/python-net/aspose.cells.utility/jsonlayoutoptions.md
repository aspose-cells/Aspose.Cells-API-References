...
| :- | :- |
| [`__init__(self)`](/cells/python-net/aspose.cells.utility/jsonlayoutoptions/__init__/#) | Constructor of loading JSON layout options. |
### Properties
...
| [ignore_title](/cells/python-net/aspose.cells.utility/jsonlayoutoptions/ignore_title) | Ingores titles of attributes |
| [convert_numeric_or_date](/cells/python-net/aspose.cells.utility/jsonlayoutoptions/convert_numeric_or_date) | Indicates whether converting the string in json to numeric or date value. |
