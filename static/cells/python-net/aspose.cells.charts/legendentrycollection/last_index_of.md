...
## last_index_of(self, item) {#aspose.cells.charts.LegendEntry}
...
| :- | :- | :- |
| item | aspose.cells.charts.LegendEntry | The object to locate in the array list. The value can be null. |
## last_index_of(self, item, index) {#aspose.cells.charts.LegendEntry-int}
...
## last_index_of(self, item, index, count) {#aspose.cells.charts.LegendEntry-int-int}
