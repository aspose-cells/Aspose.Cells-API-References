...
## last_index_of(self, item) {#aspose.cells.charts.Chart}
...
| :- | :- | :- |
| item | aspose.cells.charts.Chart | The object to locate in the array list. The value can be null. |
## last_index_of(self, item, index) {#aspose.cells.charts.Chart-int}
...
## last_index_of(self, item, index, count) {#aspose.cells.charts.Chart-int-int}
