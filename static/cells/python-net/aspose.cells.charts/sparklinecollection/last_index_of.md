...
## last_index_of(self, item) {#aspose.cells.charts.Sparkline}
...
| :- | :- | :- |
| item | aspose.cells.charts.Sparkline | The object to locate in the array list. The value can be null. |
## last_index_of(self, item, index) {#aspose.cells.charts.Sparkline-int}
...
## last_index_of(self, item, index, count) {#aspose.cells.charts.Sparkline-int-int}
