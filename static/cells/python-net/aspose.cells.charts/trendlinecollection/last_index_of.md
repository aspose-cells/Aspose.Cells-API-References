...
## last_index_of(self, item) {#aspose.cells.charts.Trendline}
...
| :- | :- | :- |
| item | aspose.cells.charts.Trendline | The object to locate in the array list. The value can be null. |
## last_index_of(self, item, index) {#aspose.cells.charts.Trendline-int}
...
## last_index_of(self, item, index, count) {#aspose.cells.charts.Trendline-int-int}
