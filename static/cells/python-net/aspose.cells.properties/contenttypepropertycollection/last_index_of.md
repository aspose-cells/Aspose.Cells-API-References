...
## last_index_of(self, item) {#aspose.cells.properties.ContentTypeProperty}
...
| :- | :- | :- |
| item | aspose.cells.properties.ContentTypeProperty | The object to locate in the array list. The value can be null. |
## last_index_of(self, item, index) {#aspose.cells.properties.ContentTypeProperty-int}
...
## last_index_of(self, item, index, count) {#aspose.cells.properties.ContentTypeProperty-int-int}
