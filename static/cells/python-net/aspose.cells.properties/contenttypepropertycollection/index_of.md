##index_of method
## index_of(self, item, index) {#aspose.cells.properties.ContentTypeProperty-int}
...
## index_of(self, item, index, count) {#aspose.cells.properties.ContentTypeProperty-int-int}
