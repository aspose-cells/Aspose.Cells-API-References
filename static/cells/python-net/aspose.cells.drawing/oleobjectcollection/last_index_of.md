...
## last_index_of(self, item) {#aspose.cells.drawing.OleObject}
...
| :- | :- | :- |
| item | aspose.cells.drawing.OleObject | The object to locate in the array list. The value can be null. |
## last_index_of(self, item, index) {#aspose.cells.drawing.OleObject-int}
...
## last_index_of(self, item, index, count) {#aspose.cells.drawing.OleObject-int-int}
