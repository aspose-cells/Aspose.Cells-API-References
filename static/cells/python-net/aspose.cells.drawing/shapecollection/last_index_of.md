...
## last_index_of(self, item) {#aspose.cells.drawing.Shape}
...
| :- | :- | :- |
| item | aspose.cells.drawing.Shape | The object to locate in the array list. The value can be null. |
...
## last_index_of(self, item, index, count) {#aspose.cells.drawing.Shape-int-int}
