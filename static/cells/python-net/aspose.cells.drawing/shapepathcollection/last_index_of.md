...
## last_index_of(self, item) {#aspose.cells.drawing.ShapePath}
...
| :- | :- | :- |
| item | aspose.cells.drawing.ShapePath | The object to locate in the array list. The value can be null. |
## last_index_of(self, item, index) {#aspose.cells.drawing.ShapePath-int}
...
## last_index_of(self, item, index, count) {#aspose.cells.drawing.ShapePath-int-int}
