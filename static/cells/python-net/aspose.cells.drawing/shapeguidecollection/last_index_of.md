...
## last_index_of(self, item) {#aspose.cells.drawing.ShapeGuide}
...
| :- | :- | :- |
| item | aspose.cells.drawing.ShapeGuide | The object to locate in the array list. The value can be null. |
## last_index_of(self, item, index) {#aspose.cells.drawing.ShapeGuide-int}
...
## last_index_of(self, item, index, count) {#aspose.cells.drawing.ShapeGuide-int-int}
