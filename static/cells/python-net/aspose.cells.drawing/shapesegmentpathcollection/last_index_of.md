...
## last_index_of(self, item) {#aspose.cells.drawing.ShapeSegmentPath}
...
| :- | :- | :- |
| item | aspose.cells.drawing.ShapeSegmentPath | The object to locate in the array list. The value can be null. |
## last_index_of(self, item, index) {#aspose.cells.drawing.ShapeSegmentPath-int}
...
## last_index_of(self, item, index, count) {#aspose.cells.drawing.ShapeSegmentPath-int-int}
