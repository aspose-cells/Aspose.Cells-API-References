...
| [is_smart_art](/cells/python-net/aspose.cells.drawing/groupshape/is_smart_art) | Indicates whether the shape is a smart art. |
...
| [is_lock_aspect_ratio](/cells/python-net/aspose.cells.drawing/groupshape/is_lock_aspect_ratio) | True means that aspect ratio of the shape is locked. |
| [is_aspect_ratio_locked](/cells/python-net/aspose.cells.drawing/groupshape/is_aspect_ratio_locked) | True means that aspect ratio of the shape is locked. |
...
| [id](/cells/python-net/aspose.cells.drawing/groupshape/id) | Gets the identifier of this shape. |
| [spid](/cells/python-net/aspose.cells.drawing/groupshape/spid) | Specifies an optional string identifier that an application can use to identify the particular shape. |
...
| [is_group](/cells/python-net/aspose.cells.drawing/groupshape/is_group) | Indicates whether this shape is a group shape. |
...
| [is_locked](/cells/python-net/aspose.cells.drawing/groupshape/is_locked) | True means the object can not be modified when the sheet is protected.
| [is_printable](/cells/python-net/aspose.cells.drawing/groupshape/is_printable) | Indicates whether the object is printable.
| [mso_drawing_type](/cells/python-net/aspose.cells.drawing/groupshape/mso_drawing_type) | Gets drawing type. |
| [auto_shape_type](/cells/python-net/aspose.cells.drawing/groupshape/auto_shape_type) | Gets and sets the auto shape type. |
| [anchor_type](/cells/python-net/aspose.cells.drawing/groupshape/anchor_type) | Gets and set the type of the shape anchor placeholder. |
...
| [upper_left_row](/cells/python-net/aspose.cells.drawing/groupshape/upper_left_row) | Represents the top row index. |
...
| [top_inch](/cells/python-net/aspose.cells.drawing/groupshape/top_inch) | Represents the vertical offset of shape from its top row, in unit of inches. |
...
| [text](/cells/python-net/aspose.cells.drawing/groupshape/text) | Gets and sets the text of this shape. |
...
| [is_decorative](/cells/python-net/aspose.cells.drawing/groupshape/is_decorative) | Indicates whether the object is decorative. |
...
| Method | Description |
| :- | :- |
| [`to_image(self, stream, image_type)`](/cells/python-net/aspose.cells.drawing/groupshape/to_image/#io.rawiobase-aspose.cells.drawing.imagetype) | Creates the shape image and saves it to a stream in the specified format. |
| [`to_image(self, image_file, options)`](/cells/python-net/aspose.cells.drawing/groupshape/to_image/#system.string-aspose.cells.rendering.imageorprintoptions) | Saves the shape to a file. |
| [`to_image(self, stream, options)`](/cells/python-net/aspose.cells.drawing/groupshape/to_image/#io.rawiobase-aspose.cells.rendering.imageorprintoptions) | Saves the shape to a stream. |
| [`get_result_of_smart_art(self)`](/cells/python-net/aspose.cells.drawing/groupshape/get_result_of_smart_art/#) | Converting smart art to grouped shapes. |
| [`to_front_or_back(self, orders)`](/cells/python-net/aspose.cells.drawing/groupshape/to_front_or_back/#int) | Brings the shape to the front or sends the shape to back. |
| [`get_locked_property(self, type)`](/cells/python-net/aspose.cells.drawing/groupshape/get_locked_property/#aspose.cells.drawing.shapelocktype) | Gets the value of locked property. |
...
| [`set_linked_cell(self, formula, is_r1c1, is_local)`](/cells/python-net/aspose.cells.drawing/groupshape/set_linked_cell/#system.string-bool-bool) | Sets the range linked to the control's value. |
| [`get_input_range(self, is_r1c1, is_local)`](/cells/python-net/aspose.cells.drawing/groupshape/get_input_range/#bool-bool) | Gets the range used to fill the control. |
| [`set_input_range(self, formula, is_r1c1, is_local)`](/cells/python-net/aspose.cells.drawing/groupshape/set_input_range/#system.string-bool-bool) | Sets the range used to fill the control. |
| [`update_selected_value(self)`](/cells/python-net/aspose.cells.drawing/groupshape/update_selected_value/#) | Update the selected value by the value of the linked cell. |
| [`calculate_text_size(self)`](/cells/python-net/aspose.cells.drawing/groupshape/calculate_text_size/#) | Recalculate the text area |
| [`format_characters(self, start_index, length, font, flag)`](/cells/python-net/aspose.cells.drawing/groupshape/format_characters/#int-int-aspose.cells.font-aspose.cells.styleflag) | Formats some characters with the font setting. |
| [`characters(self, start_index, length)`](/cells/python-net/aspose.cells.drawing/groupshape/characters/#int-int) | Returns a Characters object that represents a range of characters within the text. |
| [`get_characters(self)`](/cells/python-net/aspose.cells.drawing/groupshape/get_characters/#) | Returns all Characters objects
| [`get_rich_formattings(self)`](/cells/python-net/aspose.cells.drawing/groupshape/get_rich_formattings/#) | Returns all Characters objects
| [`remove_active_x_control(self)`](/cells/python-net/aspose.cells.drawing/groupshape/remove_active_x_control/#) | Remove activeX control. |
| [`is_same_setting(self, obj)`](/cells/python-net/aspose.cells.drawing/groupshape/is_same_setting/#system.object) | Returns whether the shape is same. |
| [`get_actual_box(self)`](/cells/python-net/aspose.cells.drawing/groupshape/get_actual_box/#) | Get the actual position and size of the shape (after applying rotation, flip, etc.) |
| [`fit_to_text_size(self)`](/cells/python-net/aspose.cells.drawing/groupshape/fit_to_text_size/#) | Recalculate a text area suitable for displaying all text content. |
| [`ungroup(self)`](/cells/python-net/aspose.cells.drawing/groupshape/ungroup/#) | Ungroups the shape items. |
| [`get_grouped_shapes(self)`](/cells/python-net/aspose.cells.drawing/groupshape/get_grouped_shapes/#) | Gets the shapes grouped by this shape. |
### Example
```python
