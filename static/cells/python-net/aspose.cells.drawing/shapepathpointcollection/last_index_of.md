...
## last_index_of(self, item) {#aspose.cells.drawing.ShapePathPoint}
...
## last_index_of(self, item, index) {#aspose.cells.drawing.ShapePathPoint-int}
...
## last_index_of(self, item, index, count) {#aspose.cells.drawing.ShapePathPoint-int-int}
