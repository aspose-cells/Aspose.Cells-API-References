...
## last_index_of(self, item) {#aspose.cells.drawing.CheckBox}
...
| :- | :- | :- |
| item | aspose.cells.drawing.CheckBox | The object to locate in the array list. The value can be null. |
## last_index_of(self, item, index) {#aspose.cells.drawing.CheckBox-int}
...
## last_index_of(self, item, index, count) {#aspose.cells.drawing.CheckBox-int-int}
