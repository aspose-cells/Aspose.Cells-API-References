...
| Method | Description |
| :- | :- |
| [`process(, template_file, result_file)`](/cells/python-net/aspose.cells.lowcode/spreadsheetconverter/process/#system.string-system.string) | Converts given template file between spreadsheet file formats. |
