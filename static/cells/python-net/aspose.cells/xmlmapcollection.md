...
| [`add(self, url)`](/cells/python-net/aspose.cells/xmlmapcollection/add/#system.string) | Add a [`XmlMap`](/cells/python-net/aspose.cells/xmlmap) by the url/path of a xml/xsd file. |
