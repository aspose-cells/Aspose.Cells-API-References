...
## last_index_of(self, item) {#aspose.cells.Style}
...
| :- | :- | :- |
| item | aspose.cells.Style | The object to locate in the array list. The value can be null. |
## last_index_of(self, item, index) {#aspose.cells.Style-int}
...
## last_index_of(self, item, index, count) {#aspose.cells.Style-int-int}
