...
## last_index_of(self, item) {#aspose.cells.ThreadedCommentAuthor}
...
| :- | :- | :- |
| item | aspose.cells.ThreadedCommentAuthor | The object to locate in the array list. The value can be null. |
## last_index_of(self, item, index) {#aspose.cells.ThreadedCommentAuthor-int}
...
## last_index_of(self, item, index, count) {#aspose.cells.ThreadedCommentAuthor-int-int}
