...
## last_index_of(self, item) {#aspose.cells.ErrorCheckOption}
...
| :- | :- | :- |
| item | aspose.cells.ErrorCheckOption | The object to locate in the array list. The value can be null. |
## last_index_of(self, item, index) {#aspose.cells.ErrorCheckOption-int}
...
## last_index_of(self, item, index, count) {#aspose.cells.ErrorCheckOption-int-int}
