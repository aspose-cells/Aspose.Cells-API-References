...
## last_index_of(self, item) {#aspose.cells.FilterColumn}
...
| :- | :- | :- |
| item | aspose.cells.FilterColumn | The object to locate in the array list. The value can be null. |
## last_index_of(self, item, index) {#aspose.cells.FilterColumn-int}
...
## last_index_of(self, item, index, count) {#aspose.cells.FilterColumn-int-int}
