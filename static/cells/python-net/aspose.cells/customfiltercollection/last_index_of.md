...
## last_index_of(self, item) {#aspose.cells.CustomFilter}
...
| :- | :- | :- |
| item | aspose.cells.CustomFilter | The object to locate in the array list. The value can be null. |
## last_index_of(self, item, index) {#aspose.cells.CustomFilter-int}
...
## last_index_of(self, item, index, count) {#aspose.cells.CustomFilter-int-int}
