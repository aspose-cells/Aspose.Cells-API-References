...
| [date1904](/cells/python-net/aspose.cells/workbooksettings/date1904) | Gets or sets a value which represents if the workbook uses the 1904 date system. |
| [protection_type](/cells/python-net/aspose.cells/workbooksettings/protection_type) | Gets the protection type of the workbook. |
| [display_drawing_objects](/cells/python-net/aspose.cells/workbooksettings/display_drawing_objects) | Indicates whether and how to show objects in the workbook. |
| [sheet_tab_bar_width](/cells/python-net/aspose.cells/workbooksettings/sheet_tab_bar_width) | Width of worksheet tab bar (in 1/1000 of window width). |
| [show_tabs](/cells/python-net/aspose.cells/workbooksettings/show_tabs) | Get or sets a value whether the Workbook tabs are displayed. |
| [first_visible_tab](/cells/python-net/aspose.cells/workbooksettings/first_visible_tab) | Gets or sets the first visible worksheet tab. |
| [is_h_scroll_bar_visible](/cells/python-net/aspose.cells/workbooksettings/is_h_scroll_bar_visible) | Gets or sets a value indicating whether the generated spreadsheet will contain a horizontal scroll bar. |
| [is_v_scroll_bar_visible](/cells/python-net/aspose.cells/workbooksettings/is_v_scroll_bar_visible) | Gets or sets a value indicating whether the generated spreadsheet will contain a vertical scroll bar. |
| [shared](/cells/python-net/aspose.cells/workbooksettings/shared) | Gets or sets a value that indicates whether the Workbook is shared. |
| [language_code](/cells/python-net/aspose.cells/workbooksettings/language_code) | Gets or sets the user interface language of the Workbook version based on CountryCode that has saved the file. |
| [region](/cells/python-net/aspose.cells/workbooksettings/region) | Gets or sets the regional settings for workbook. |
| [globalization_settings](/cells/python-net/aspose.cells/workbooksettings/globalization_settings) | Gets and sets the globalization settings. |
| [number_decimal_separator](/cells/python-net/aspose.cells/workbooksettings/number_decimal_separator) | Gets or sets the decimal separator for formatting/parsing numeric values. Default is the decimal separator of current Region. |
| [number_group_separator](/cells/python-net/aspose.cells/workbooksettings/number_group_separator) | Gets or sets the character that separates groups of digits to the left of the decimal in numeric values. Default is the group separator of current Region. |
| [password](/cells/python-net/aspose.cells/workbooksettings/password) | Represents Workbook file encryption password. |
| [write_protection](/cells/python-net/aspose.cells/workbooksettings/write_protection) | Provides access to the workbook write protection options. |
| [is_encrypted](/cells/python-net/aspose.cells/workbooksettings/is_encrypted) | Gets a value that indicates whether a password is required to open this workbook. |
| [is_protected](/cells/python-net/aspose.cells/workbooksettings/is_protected) | Gets a value that indicates whether the structure or window of the Workbook is protected. |
| [is_default_encrypted](/cells/python-net/aspose.cells/workbooksettings/is_default_encrypted) | Indicates whether encrypting the workbook with default password if Structure and Windows of the workbook are locked. |
| [is_minimized](/cells/python-net/aspose.cells/workbooksettings/is_minimized) | Represents whether the generated spreadsheet will be opened Minimized. |
...
| [window_top](/cells/python-net/aspose.cells/workbooksettings/window_top) | The distance from the top edge of the client area to the top edge of the window, in unit of point. |
| [window_top_inch](/cells/python-net/aspose.cells/workbooksettings/window_top_inch) | The distance from the top edge of the client area to the top edge of the window, in unit of inch. |
| [window_top_cm](/cells/python-net/aspose.cells/workbooksettings/window_top_cm) | The distance from the top edge of the client area to the top edge of the window, in unit of centimeter. |
| [window_width](/cells/python-net/aspose.cells/workbooksettings/window_width) | The width of the window, in unit of point. |
| [window_width_inch](/cells/python-net/aspose.cells/workbooksettings/window_width_inch) | The width of the window, in unit of inch. |
| [window_width_cm](/cells/python-net/aspose.cells/workbooksettings/window_width_cm) | The width of the window, in unit of centimeter. |
| [window_height](/cells/python-net/aspose.cells/workbooksettings/window_height) | The height of the window, in unit of point. |
