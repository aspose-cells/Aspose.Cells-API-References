...
## add_add_in_function(, function, min_count_of_parameters, max_count_of_parameters, paramers_type, function_value_type) {#System.String-int-int-list-aspose.cells.ParameterType}
Add addin function.
```python
@staticmethod
...
| :- | :- | :- |
| function | System.String | The function name. |
...
| function_value_type | aspose.cells.ParameterType | The function value type. |
### Remarks
