...
## last_index_of(self, item) {#aspose.cells.HtmlTableLoadOption}
...
| :- | :- | :- |
| item | aspose.cells.HtmlTableLoadOption | The object to locate in the array list. The value can be null. |
## last_index_of(self, item, index) {#aspose.cells.HtmlTableLoadOption-int}
...
## last_index_of(self, item, index, count) {#aspose.cells.HtmlTableLoadOption-int-int}
...
### See Also
* module [`aspose.cells`](../../)
* class [`HtmlTableLoadOptionCollection`](/cells/python-net/aspose.cells/htmltableloadoptioncollection)
