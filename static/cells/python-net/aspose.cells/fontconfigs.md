...
| [`get_font_file_data_info(, font_name, is_bold, is_italic, is_exact_style)`](/cells/python-net/aspose.cells/fontconfigs/get_font_file_data_info/#system.string-bool-bool-bool) | Get data infomation of font file data. |
...
| [`get_font_substitutes(, original_font_name)`](/cells/python-net/aspose.cells/fontconfigs/get_font_substitutes/#system.string) | Returns array containing font substitute names to be used if original font is not presented. |
