...
## last_index_of(self, item) {#aspose.cells.DataSorterKey}
...
| :- | :- | :- |
| item | aspose.cells.DataSorterKey | The object to locate in the array list. The value can be null. |
## last_index_of(self, item, index) {#aspose.cells.DataSorterKey-int}
...
## last_index_of(self, item, index, count) {#aspose.cells.DataSorterKey-int-int}
