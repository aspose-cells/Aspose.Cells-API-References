...
## last_index_of(self, item) {#aspose.cells.XmlMap}
...
| :- | :- | :- |
| item | aspose.cells.XmlMap | The object to locate in the array list. The value can be null. |
## last_index_of(self, item, index) {#aspose.cells.XmlMap-int}
...
## last_index_of(self, item, index, count) {#aspose.cells.XmlMap-int-int}
