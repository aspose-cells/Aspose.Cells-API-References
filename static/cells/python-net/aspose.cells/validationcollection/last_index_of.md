...
## last_index_of(self, item) {#aspose.cells.Validation}
...
| :- | :- | :- |
| item | aspose.cells.Validation | The object to locate in the array list. The value can be null. |
## last_index_of(self, item, index) {#aspose.cells.Validation-int}
...
## last_index_of(self, item, index, count) {#aspose.cells.Validation-int-int}
