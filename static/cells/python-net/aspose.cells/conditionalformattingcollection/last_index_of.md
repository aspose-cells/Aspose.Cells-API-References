...
## last_index_of(self, item) {#aspose.cells.FormatConditionCollection}
...
| :- | :- | :- |
| item | aspose.cells.FormatConditionCollection | The object to locate in the array list. The value can be null. |
## last_index_of(self, item, index) {#aspose.cells.FormatConditionCollection-int}
...
## last_index_of(self, item, index, count) {#aspose.cells.FormatConditionCollection-int-int}
