...
## last_index_of(self, item) {#aspose.cells.CellWatch}
...
| :- | :- | :- |
| item | aspose.cells.CellWatch | The object to locate in the array list. The value can be null. |
## last_index_of(self, item, index) {#aspose.cells.CellWatch-int}
...
## last_index_of(self, item, index, count) {#aspose.cells.CellWatch-int-int}
