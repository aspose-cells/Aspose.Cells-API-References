...
## last_index_of(self, item) {#aspose.cells.Hyperlink}
...
| :- | :- | :- |
| item | aspose.cells.Hyperlink | The object to locate in the array list. The value can be null. |
## last_index_of(self, item, index) {#aspose.cells.Hyperlink-int}
...
## last_index_of(self, item, index, count) {#aspose.cells.Hyperlink-int-int}
