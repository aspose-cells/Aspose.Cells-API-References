...
## last_index_of(self, item) {#aspose.cells.Column}
...
| :- | :- | :- |
| item | aspose.cells.Column | The object to locate in the array list. The value can be null. |
## last_index_of(self, item, index) {#aspose.cells.Column-int}
...
## last_index_of(self, item, index, count) {#aspose.cells.Column-int-int}
