...
## last_index_of(self, item) {#aspose.cells.QueryTable}
...
| :- | :- | :- |
| item | aspose.cells.QueryTable | The object to locate in the array list. The value can be null. |
## last_index_of(self, item, index) {#aspose.cells.QueryTable-int}
...
## last_index_of(self, item, index, count) {#aspose.cells.QueryTable-int-int}
