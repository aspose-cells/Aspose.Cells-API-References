...
## last_index_of(self, item) {#aspose.cells.ThreadedComment}
...
| :- | :- | :- |
| item | aspose.cells.ThreadedComment | The object to locate in the array list. The value can be null. |
## last_index_of(self, item, index) {#aspose.cells.ThreadedComment-int}
...
## last_index_of(self, item, index, count) {#aspose.cells.ThreadedComment-int-int}
