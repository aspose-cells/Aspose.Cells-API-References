...
## last_index_of(self, item) {#aspose.cells.Name}
...
| :- | :- | :- |
| item | aspose.cells.Name | The object to locate in the array list. The value can be null. |
## last_index_of(self, item, index) {#aspose.cells.Name-int}
...
## last_index_of(self, item, index, count) {#aspose.cells.Name-int-int}
