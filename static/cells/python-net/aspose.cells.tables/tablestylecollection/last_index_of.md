...
## last_index_of(self, item) {#aspose.cells.tables.TableStyle}
...
| :- | :- | :- |
| item | aspose.cells.tables.TableStyle | The object to locate in the array list. The value can be null. |
## last_index_of(self, item, index) {#aspose.cells.tables.TableStyle-int}
...
## last_index_of(self, item, index, count) {#aspose.cells.tables.TableStyle-int-int}
