...
## last_index_of(self, item) {#aspose.cells.tables.ListObject}
...
| :- | :- | :- |
| item | aspose.cells.tables.ListObject | The object to locate in the array list. The value can be null. |
## last_index_of(self, item, index) {#aspose.cells.tables.ListObject-int}
...
## last_index_of(self, item, index, count) {#aspose.cells.tables.ListObject-int-int}
