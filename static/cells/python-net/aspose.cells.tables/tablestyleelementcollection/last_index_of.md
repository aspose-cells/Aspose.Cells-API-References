...
## last_index_of(self, item) {#aspose.cells.tables.TableStyleElement}
...
| :- | :- | :- |
| item | aspose.cells.tables.TableStyleElement | The object to locate in the array list. The value can be null. |
## last_index_of(self, item, index) {#aspose.cells.tables.TableStyleElement-int}
...
## last_index_of(self, item, index, count) {#aspose.cells.tables.TableStyleElement-int-int}
