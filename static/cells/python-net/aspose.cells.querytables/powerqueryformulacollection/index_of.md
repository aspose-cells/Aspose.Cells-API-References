##index_of method
## index_of(self, item, index) {#aspose.cells.querytables.PowerQueryFormula-int}
...
## index_of(self, item, index, count) {#aspose.cells.querytables.PowerQueryFormula-int-int}
