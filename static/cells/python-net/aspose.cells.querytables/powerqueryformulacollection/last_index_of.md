...
## last_index_of(self, item) {#aspose.cells.querytables.PowerQueryFormula}
...
| :- | :- | :- |
| item | aspose.cells.querytables.PowerQueryFormula | The object to locate in the array list. The value can be null. |
## last_index_of(self, item, index) {#aspose.cells.querytables.PowerQueryFormula-int}
...
## last_index_of(self, item, index, count) {#aspose.cells.querytables.PowerQueryFormula-int-int}
