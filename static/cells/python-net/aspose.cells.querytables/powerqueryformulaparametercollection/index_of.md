##index_of method
## index_of(self, item, index) {#aspose.cells.querytables.PowerQueryFormulaParameter-int}
...
## index_of(self, item, index, count) {#aspose.cells.querytables.PowerQueryFormulaParameter-int-int}
