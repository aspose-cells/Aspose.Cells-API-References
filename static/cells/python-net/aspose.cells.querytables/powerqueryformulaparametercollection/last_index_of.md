...
## last_index_of(self, item) {#aspose.cells.querytables.PowerQueryFormulaParameter}
...
| :- | :- | :- |
| item | aspose.cells.querytables.PowerQueryFormulaParameter | The object to locate in the array list. The value can be null. |
## last_index_of(self, item, index) {#aspose.cells.querytables.PowerQueryFormulaParameter-int}
...
## last_index_of(self, item, index, count) {#aspose.cells.querytables.PowerQueryFormulaParameter-int-int}
