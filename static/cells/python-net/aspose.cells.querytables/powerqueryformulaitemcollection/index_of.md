##index_of method
## index_of(self, item, index) {#aspose.cells.querytables.PowerQueryFormulaItem-int}
...
| :- | :- | :- |
| item | aspose.cells.querytables.PowerQueryFormulaItem | The object to locate in the array list. The value can be null. |
| index | int | The zero-based starting index of the search. 0 (zero) is valid in an empty list. |
## index_of(self, item, index, count) {#aspose.cells.querytables.PowerQueryFormulaItem-int-int}
