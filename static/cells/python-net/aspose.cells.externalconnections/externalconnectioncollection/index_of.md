##index_of method
## index_of(self, item, index) {#Aspose.Cells.ExternalConnections.ExternalConnection-int}
...
## index_of(self, item, index, count) {#Aspose.Cells.ExternalConnections.ExternalConnection-int-int}
