##index_of method
## index_of(self, item, index) {#aspose.cells.externalconnections.ConnectionParameter-int}
...
## index_of(self, item, index, count) {#aspose.cells.externalconnections.ConnectionParameter-int-int}
