...
| :- | :- | :- |
| item | aspose.cells.FontSetting | The object to locate in the array list. The value can be null. |
## last_index_of(self, item, index) {#aspose.cells.FontSetting-int}
...
## last_index_of(self, item, index, count) {#aspose.cells.FontSetting-int-int}
