...
| :- | :- | :- |
| item | aspose.cells.vba.VbaProjectReference | The object to locate in the array list. The value can be null. |
## last_index_of(self, item, index) {#aspose.cells.vba.VbaProjectReference-int}
...
## last_index_of(self, item, index, count) {#aspose.cells.vba.VbaProjectReference-int-int}
