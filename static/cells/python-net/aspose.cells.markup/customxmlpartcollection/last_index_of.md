...
## last_index_of(self, item) {#aspose.cells.markup.CustomXmlPart}
...
| :- | :- | :- |
| item | aspose.cells.markup.CustomXmlPart | The object to locate in the array list. The value can be null. |
## last_index_of(self, item, index) {#aspose.cells.markup.CustomXmlPart-int}
...
## last_index_of(self, item, index, count) {#aspose.cells.markup.CustomXmlPart-int-int}
