...
| [`add(self, id, is_enabled, method_type, site_id, mark_type)`](/cells/python-net/aspose.cells.metas/sensitivitylabelcollection/add/#system.string-bool-aspose.cells.metas.sensitivitylabelassignmenttype-system.string-aspose.cells.metas.sensitivitylabelmarktype) | Adds a sensitivity label. |
