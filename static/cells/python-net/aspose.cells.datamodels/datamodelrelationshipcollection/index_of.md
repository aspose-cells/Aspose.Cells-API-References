##index_of method
## index_of(self, item, index) {#aspose.cells.datamodels.DataModelRelationship-int}
...
## index_of(self, item, index, count) {#aspose.cells.datamodels.DataModelRelationship-int-int}
