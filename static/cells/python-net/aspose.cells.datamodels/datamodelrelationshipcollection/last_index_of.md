...
## last_index_of(self, item) {#aspose.cells.datamodels.DataModelRelationship}
...
| :- | :- | :- |
| item | aspose.cells.datamodels.DataModelRelationship | The object to locate in the array list. The value can be null. |
## last_index_of(self, item, index) {#aspose.cells.datamodels.DataModelRelationship-int}
...
## last_index_of(self, item, index, count) {#aspose.cells.datamodels.DataModelRelationship-int-int}
