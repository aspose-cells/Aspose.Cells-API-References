...
## last_index_of(self, item) {#aspose.cells.datamodels.DataModelTable}
...
| :- | :- | :- |
| item | aspose.cells.datamodels.DataModelTable | The object to locate in the array list. The value can be null. |
## last_index_of(self, item, index) {#aspose.cells.datamodels.DataModelTable-int}
...
## last_index_of(self, item, index, count) {#aspose.cells.datamodels.DataModelTable-int-int}
