...
## last_index_of(self, item) {#aspose.cells.pivot.PivotFormatCondition}
...
| :- | :- | :- |
| item | aspose.cells.pivot.PivotFormatCondition | The object to locate in the array list. The value can be null. |
## last_index_of(self, item, index) {#aspose.cells.pivot.PivotFormatCondition-int}
...
## last_index_of(self, item, index, count) {#aspose.cells.pivot.PivotFormatCondition-int-int}
