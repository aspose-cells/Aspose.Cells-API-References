...
## last_index_of(self, item) {#aspose.cells.pivot.PivotTableFormat}
...
| :- | :- | :- |
| item | aspose.cells.pivot.PivotTableFormat | The object to locate in the array list. The value can be null. |
## last_index_of(self, item, index) {#aspose.cells.pivot.PivotTableFormat-int}
...
## last_index_of(self, item, index, count) {#aspose.cells.pivot.PivotTableFormat-int-int}
