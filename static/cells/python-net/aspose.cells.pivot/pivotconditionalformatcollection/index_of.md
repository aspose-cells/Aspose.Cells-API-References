##index_of method
## index_of(self, item, index) {#aspose.cells.pivot.PivotConditionalFormat-int}
...
## index_of(self, item, index, count) {#aspose.cells.pivot.PivotConditionalFormat-int-int}
