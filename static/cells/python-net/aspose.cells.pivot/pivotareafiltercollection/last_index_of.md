...
## last_index_of(self, item) {#aspose.cells.pivot.PivotAreaFilter}
...
| :- | :- | :- |
| item | aspose.cells.pivot.PivotAreaFilter | The object to locate in the array list. The value can be null. |
## last_index_of(self, item, index) {#aspose.cells.pivot.PivotAreaFilter-int}
...
## last_index_of(self, item, index, count) {#aspose.cells.pivot.PivotAreaFilter-int-int}
...
* class [`PivotAreaFilterCollection`](/cells/python-net/aspose.cells.pivot/pivotareafiltercollection)
