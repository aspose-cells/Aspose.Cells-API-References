...
## last_index_of(self, item) {#aspose.cells.pivot.PivotTable}
...
| :- | :- | :- |
| item | aspose.cells.pivot.PivotTable | The object to locate in the array list. The value can be null. |
## last_index_of(self, item, index) {#aspose.cells.pivot.PivotTable-int}
...
## last_index_of(self, item, index, count) {#aspose.cells.pivot.PivotTable-int-int}
