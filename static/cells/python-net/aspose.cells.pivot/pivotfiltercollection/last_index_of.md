...
| :- | :- | :- |
| item | aspose.cells.pivot.PivotFilter | The object to locate in the array list. The value can be null. |
## last_index_of(self, item, index) {#aspose.cells.pivot.PivotFilter-int}
...
## last_index_of(self, item, index, count) {#aspose.cells.pivot.PivotFilter-int-int}
