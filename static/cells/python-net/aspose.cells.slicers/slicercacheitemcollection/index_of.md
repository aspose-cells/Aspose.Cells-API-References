##index_of method
## index_of(self, item, index) {#aspose.cells.slicers.SlicerCacheItem-int}
...
| :- | :- | :- |
| item | aspose.cells.slicers.SlicerCacheItem | The object to locate in the array list. The value can be null. |
| index | int | The zero-based starting index of the search. 0 (zero) is valid in an empty list. |
## index_of(self, item, index, count) {#aspose.cells.slicers.SlicerCacheItem-int-int}
