...
## last_index_of(self, item) {#aspose.cells.slicers.Slicer}
...
| :- | :- | :- |
| item | aspose.cells.slicers.Slicer | The object to locate in the array list. The value can be null. |
## last_index_of(self, item, index) {#aspose.cells.slicers.Slicer-int}
...
## last_index_of(self, item, index, count) {#aspose.cells.slicers.Slicer-int-int}
