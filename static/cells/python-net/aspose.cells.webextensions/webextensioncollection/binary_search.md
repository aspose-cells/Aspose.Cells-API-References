...
## binary_search(self, item) {#aspose.cells.webextensions.WebExtension}
...
| :- | :- | :- |
| item | aspose.cells.webextensions.WebExtension | The System.Object to locate. The value can be null. |
### See Also
