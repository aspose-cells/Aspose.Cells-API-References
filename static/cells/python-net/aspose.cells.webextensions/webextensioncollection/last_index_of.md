...
## last_index_of(self, item) {#aspose.cells.webextensions.WebExtension}
...
| :- | :- | :- |
| item | aspose.cells.webextensions.WebExtension | The object to locate in the array list. The value can be null. |
## last_index_of(self, item, index) {#aspose.cells.webextensions.WebExtension-int}
...
## last_index_of(self, item, index, count) {#aspose.cells.webextensions.WebExtension-int-int}
