...
## binary_search(self, item) {#aspose.cells.webextensions.WebExtensionReference}
...
| :- | :- | :- |
| item | aspose.cells.webextensions.WebExtensionReference | The System.Object to locate. The value can be null. |
### See Also
