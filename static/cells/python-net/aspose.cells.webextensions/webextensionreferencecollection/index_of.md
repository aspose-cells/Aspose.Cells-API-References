##index_of method
## index_of(self, item, index) {#aspose.cells.webextensions.WebExtensionReference-int}
...
## index_of(self, item, index, count) {#aspose.cells.webextensions.WebExtensionReference-int-int}
