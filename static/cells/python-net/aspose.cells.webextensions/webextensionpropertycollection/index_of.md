##index_of method
## index_of(self, item, index) {#aspose.cells.webextensions.WebExtensionProperty-int}
...
## index_of(self, item, index, count) {#aspose.cells.webextensions.WebExtensionProperty-int-int}
