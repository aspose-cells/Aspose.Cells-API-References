...
## last_index_of(self, item) {#aspose.cells.webextensions.WebExtensionTaskPane}
...
| :- | :- | :- |
| item | aspose.cells.webextensions.WebExtensionTaskPane | The object to locate in the array list. The value can be null. |
## last_index_of(self, item, index) {#aspose.cells.webextensions.WebExtensionTaskPane-int}
...
## last_index_of(self, item, index, count) {#aspose.cells.webextensions.WebExtensionTaskPane-int-int}
