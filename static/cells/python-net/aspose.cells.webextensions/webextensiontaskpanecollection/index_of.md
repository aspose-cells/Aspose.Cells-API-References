##index_of method
## index_of(self, item, index) {#aspose.cells.webextensions.WebExtensionTaskPane-int}
...
## index_of(self, item, index, count) {#aspose.cells.webextensions.WebExtensionTaskPane-int-int}
