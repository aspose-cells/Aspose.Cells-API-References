##index_of method
## index_of(self, item, index) {#aspose.cells.webextensions.WebExtensionBinding-int}
...
## index_of(self, item, index, count) {#aspose.cells.webextensions.WebExtensionBinding-int-int}
