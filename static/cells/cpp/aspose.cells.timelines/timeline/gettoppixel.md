##Aspose::Cells::Timelines::Timeline::GetTopPixel method
'Aspose::Cells::Timelines::Timeline::GetTopPixel method. Returns or sets the vertical offset of timeline shape from its top row, in pixels in C++.'
...
```cpp
int32_t Aspose::Cells::Timelines::Timeline::GetTopPixel()
```
## Remarks
