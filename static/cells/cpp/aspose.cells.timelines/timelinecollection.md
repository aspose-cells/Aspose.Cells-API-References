...
'Aspose::Cells::Timelines::TimelineCollection class. Specifies the collection of all the Timeline objects on the specified worksheet. Due to MS Excel, Excel 2003 does not support Timeline in C++.'
