##Aspose::Cells::DigitalSignatures::DigitalSignature::SetProviderId method
'Aspose::Cells::DigitalSignatures::DigitalSignature::SetProviderId method. Specifies the class ID of the signature provider. Default value is Empty (all zeroes) Guid in C++.'
