...
'Aspose::Cells::Charts::ChartFrame::SetXRatioToChart method. Gets or sets the x coordinate of the upper left corner in units of ratio of the chart area in C++.'
