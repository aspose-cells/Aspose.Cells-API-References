...
'Aspose::Cells::Charts::ChartArea::GetHeight method. Gets or sets the vertical offset from its lower right corner row, in units of 1/4000 of the chart area in C++.'
