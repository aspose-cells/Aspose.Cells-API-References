##Aspose::Cells::Charts::PlotArea::SetInnerY method
'Aspose::Cells::Charts::PlotArea::SetInnerY method. Gets or gets the x coordinate of the upper top corner of plot area in units of 1/4000 of the chart area in C++.'
...
```cpp
void Aspose::Cells::Charts::PlotArea::SetInnerY(int32_t value)
```
## Remarks
