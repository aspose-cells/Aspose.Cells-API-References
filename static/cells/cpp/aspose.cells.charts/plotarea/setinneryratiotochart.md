...
'Aspose::Cells::Charts::PlotArea::SetInnerYRatioToChart method. Gets or gets the x coordinate of the upper top corner of plot area in units of ratio of the chart area in C++.'
