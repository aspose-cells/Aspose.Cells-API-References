##Aspose::Cells::Drawing::Equations::EquationNodeParagraph class
'Aspose::Cells::Drawing::Equations::EquationNodeParagraph class. This class specifies a mathematical paragraph containing one or more MathEquationNode(OMath) elements in C++.'
...
```cpp
class EquationNodeParagraph : public Aspose::Cells::Drawing::Equations::EquationNode
```
## Methods
| Method | Description |
| --- | --- |
...
| [EquationNodeParagraph(EquationNodeParagraph_Impl* impl)](./equationnodeparagraph/) | Constructs from an implementation object. |
| [EquationNodeParagraph(const EquationNodeParagraph\& src)](./equationnodeparagraph/) | Copy constructor. |
| [EquationNodeParagraph(const EquationNode\& src)](./equationnodeparagraph/) | Constructs from a parent object. |
...
| [operator=(const EquationNodeParagraph\& src)](./operator_asm/) | operator= |
