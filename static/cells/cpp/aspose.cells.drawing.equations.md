...
'How to use Aspose::Cells::Drawing::Equations namespace in C++.'
## Classes
| Class | Description |
| --- | --- |
...
| [BorderBoxEquationNode](./borderboxequationnode/) | This class specifies the [Border](../aspose.cells/border/) Box function, consisting of a border drawn around an equation. |
...
| [RadicalEquationNode](./radicalequationnode/) | This class specifies the radical equation, consisting of an optional degree deg([EquationNodeType.Degree](./equationnodetype/)) and a base. |
