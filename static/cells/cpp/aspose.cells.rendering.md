...
'How to use Aspose::Cells::Rendering namespace in C++.'
## Classes
| Class | Description |
| --- | --- |
...
| [PdfBookmarkEntry](./pdfbookmarkentry/) | [PdfBookmarkEntry](./pdfbookmarkentry/) is an entry in pdf bookmark. if Text property of current instance is null or "", current instance will be hidden and children will be inserted on current level. |
| [RenderingFont](./renderingfont/) | [Font](../aspose.cells/font/) for rendering. |
