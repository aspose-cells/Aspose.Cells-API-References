##Aspose::Cells::TxtSaveOptions::SetTrimLeadingBlankRowAndColumn method
'Aspose::Cells::TxtSaveOptions::SetTrimLeadingBlankRowAndColumn method. Indicates whether leading blank rows and columns should be trimmed like what ms excel does. Default is true in C++.'
