...
'Aspose::Cells::AbstractCalculationEngine::ForceRecalculate method. Whether force given function to be recalculated always when calculating shared formulas in C++.'
