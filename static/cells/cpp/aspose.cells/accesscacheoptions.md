##Aspose::Cells::AccessCacheOptions enum
'Aspose::Cells::AccessCacheOptions enum. Cache options for data access. Can be combined with | operator for multiple options together in C++.'
