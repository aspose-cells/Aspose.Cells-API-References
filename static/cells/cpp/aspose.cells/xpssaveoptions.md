##Aspose::Cells::XpsSaveOptions class
'Aspose::Cells::XpsSaveOptions class. Represents the additional options when saving the file as the Xps in C++.'
## XpsSaveOptions class
Represents the additional options when saving the file as the Xps.
```cpp
class XpsSaveOptions : public Aspose::Cells::PaginatedSaveOptions
```
## Methods
| Method | Description |
| --- | --- |
...
| [operator=(const XpsSaveOptions\& src)](./operator_asm/) | operator= |
...
| [XpsSaveOptions(XpsSaveOptions_Impl* impl)](./xpssaveoptions/) | Constructs from an implementation object. |
| [XpsSaveOptions(const XpsSaveOptions\& src)](./xpssaveoptions/) | Copy constructor. |
| [XpsSaveOptions(const PaginatedSaveOptions\& src)](./xpssaveoptions/) | Constructs from a parent object. |
| [~PaginatedSaveOptions()](../paginatedsaveoptions/~paginatedsaveoptions/) | Destructor. |
| [~SaveOptions()](../saveoptions/~saveoptions/) | Destructor. |
| [~XpsSaveOptions()](./~xpssaveoptions/) | Destructor. |
## Fields
| Field | Description |
| --- | --- |
