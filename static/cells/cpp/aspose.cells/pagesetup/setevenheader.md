...
'Aspose::Cells::PageSetup::SetEvenHeader method. Sets a script formatting the even page header of an Excel file. Only effect in Excel 2007 when IsHFDiffOddEven is true in C++.'
