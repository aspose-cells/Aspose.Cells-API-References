...
'Aspose::Cells::PdfSaveOptions class. Represents the options for saving pdf file in C++.'
...
| [operator=(const PdfSaveOptions\& src)](./operator_asm/) | operator= |
...
| [PdfSaveOptions(PdfSaveOptions_Impl* impl)](./pdfsaveoptions/) | Constructs from an implementation object. |
| [PdfSaveOptions(const PdfSaveOptions\& src)](./pdfsaveoptions/) | Copy constructor. |
| [PdfSaveOptions(const PaginatedSaveOptions\& src)](./pdfsaveoptions/) | Constructs from a parent object. |
...
| [SetCompliance(PdfCompliance value)](./setcompliance/) | Gets or sets the PDF standards compliance level for output documents. |
...
| [SetOptimizationType(PdfOptimizationType value)](./setoptimizationtype/) | Gets and sets pdf optimization type. |
...
| [SetPdfCompression(PdfCompressionCore value)](./setpdfcompression/) | Indicate the compression algorithm. |
