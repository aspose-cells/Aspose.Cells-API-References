##Aspose::Cells::FormulaSettings::SetCalculateOnOpen method
'Aspose::Cells::FormulaSettings::SetCalculateOnOpen method. Indicates whether the application is required to perform a full calculation when the workbook is opened in C++.'
