...
'Aspose::Cells::FontConfigs class. Specifies font settings in C++.'
## FontConfigs class
...
| static [SetFontFolders(const Vector \<U16String\>\& fontFolders, bool recursive)](./setfontfolders/) | Sets the fonts folders. |
| static [SetFontSources(const Vector \<FontSourceBase\>\& sources)](./setfontsources/) | Sets the fonts sources. |
