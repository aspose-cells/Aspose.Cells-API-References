##Aspose::Cells::Drawing::ShapeCollection::AddButton method
'Aspose::Cells::Drawing::ShapeCollection::AddButton method. Adds a Button to the worksheet in C++.'
## ShapeCollection::AddButton method
Adds a [Button](../../button/) to the worksheet.
```cpp
Button Aspose::Cells::Drawing::ShapeCollection::AddButton(int32_t upperLeftRow, int32_t top, int32_t upperLeftColumn, int32_t left, int32_t height, int32_t width)
```
