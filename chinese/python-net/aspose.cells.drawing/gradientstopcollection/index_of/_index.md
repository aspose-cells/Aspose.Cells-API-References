...
type: docs
weight: 50
url: /zh/python-net/aspose.cells.drawing/gradientstopcollection/index_of/
is_root: false
---
...
|范围|类型|描述|
| :- | :- | :- |
| item | [GradientStop](/cells/zh/python-net/aspose.cells.drawing/gradientstop) |要在数组列表中定位的对象。该值可以为空。|
...
* 类 [GradientStopCollection](/cells/zh/python-net/aspose.cells.drawing/gradientstopcollection)
