---
title: background_cells_color 属性
second_title: Aspose.Cells for Python via .NET API 参考资料
description:
type: docs
weight: 40
url: /zh/python-net/aspose.cells.drawing/patternfill/background_cells_color/
is_root: false
---
## background_cells_color 属性

获取和设置前景 [CellsColor](/cells/zh/python-net/aspose.cells/cellscolor) 对象。
### 定义：
```python
@property
