...
| [brightness](/cells/zh/python-net/aspose.cells.drawing/msoformatpicture/brightness) |表示对图片的亮度修改，单位为百分比。|
| [gamma](/cells/zh/python-net/aspose.cells.drawing/msoformatpicture/gamma) |代表图片的伽玛值。|
| [is_bi_level](/cells/zh/python-net/aspose.cells.drawing/msoformatpicture/is_bi_level) |指示此图片是否应以黑白双色显示。|
| [is_gray](/cells/zh/python-net/aspose.cells.drawing/msoformatpicture/is_gray) |指示此图片是否应该以灰度显示。|
