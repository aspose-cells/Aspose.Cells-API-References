...
|属性|描述|
| :- | :- |
| [is_visible](/cells/zh/python-net/aspose.cells.drawing/msolineformat/is_visible) |指示对象是否可见。|
| [style](/cells/zh/python-net/aspose.cells.drawing/msolineformat/style) |返回表示指定范围样式的 Style 对象。|
| [fore_color](/cells/zh/python-net/aspose.cells.drawing/msolineformat/fore_color) |获取和设置边框线前景色。|
| [back_color](/cells/zh/python-net/aspose.cells.drawing/msolineformat/back_color) |获取和设置边框线背景色。|
