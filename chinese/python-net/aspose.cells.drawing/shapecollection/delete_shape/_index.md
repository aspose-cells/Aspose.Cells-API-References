...
type: docs
weight: 410
url: /zh/python-net/aspose.cells.drawing/shapecollection/delete_shape/
is_root: false
---
##  delete_shape(shape) {#Shape}
删除形状，如果形状在组内或者是评论形状，则不会被删除。
...
|参数|类型|描述|
| :- | :- | :- |
| shape | [Shape](/cells/zh/python-net/aspose.cells.drawing/shape) |  |
