...
type: docs
weight: 340
url: /zh/python-net/aspose.cells.drawing/shapecollection/add_text_effect_in_chart/
is_root: false
---
...
| left | int |表示形状相对于图表区域左上角的垂直偏移量，以图表区域的 1/4000 为单位。|
| height | int |表示形状的高度，以图表区域的 1/4000 为单位。|
| width | int |表示形状的宽度，以图表区域的 1/4000 为单位。|
