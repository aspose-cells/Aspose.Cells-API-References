...
type: docs
weight: 370
url: /zh/python-net/aspose.cells.drawing/shapecollection/copy_comments_in_range/
is_root: false
---
...
|范围|类型|描述|
| :- | :- | :- |
| shapes | [ShapeCollection](/cells/zh/python-net/aspose.cells.drawing/shapecollection) |源形状。|
| ca | [CellArea](/cells/zh/python-net/aspose.cells/cellarea) |来源范围。|
| dest_row | int |目标范围开始行。|
| dest_column | int |目标范围开始列。|
