...
type: docs
weight: 20
url: /zh/python-net/aspose.cells.drawing/checkboxcollection/add/
is_root: false
---
...
[CheckBox](/cells/zh/python-net/aspose.cells.drawing/checkbox) 对象索引。
...
| height | int |复选框的高度，以像素为单位。|
| width | int |复选框的宽度，以像素为单位。|
