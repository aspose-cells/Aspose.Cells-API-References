...
type: docs
weight: 200
url: /zh/python-net/aspose.cells.drawing/lineformat/gradient_fill/
is_root: false
---
## gradient_fill 属性

获取 [FillFormat.gradient_fill](/cells/zh/python-net/aspose.cells.drawing/fillformat#gradient_fill) 对象。
### 定义：
```python
@property
