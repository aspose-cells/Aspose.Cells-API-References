...
type: docs
weight: 330
url: /zh/python-net/aspose.cells.drawing/lineformat/texture_fill/
is_root: false
---
## texture_fill 属性

获取 [FillFormat.texture_fill](/cells/zh/python-net/aspose.cells.drawing/fillformat#texture_fill) 对象。
### 定义：
```python
@property
