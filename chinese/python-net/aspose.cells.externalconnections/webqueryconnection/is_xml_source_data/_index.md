---
title: is_xml_source_data 属性
second_title: Aspose.Cells for Python via .NET API 参考文献
description:
type: docs
weight: 220
url: /zh/python-net/aspose.cells.externalconnections/webqueryconnection/is_xml_source_data/
is_root: false
---
## is_xml_source_data 属性

指示应该导入 XML 源数据而不是 HTML 表本身的标志。
### 定义：
```python
@property
