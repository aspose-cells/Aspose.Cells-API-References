...
type: docs
weight: 50
url: /zh/python-net/aspose.cells.externalconnections/connectionparametercollection/last_index_of/
is_root: false
---
...
|范围|类型|描述|
| :- | :- | :- |
| item | [ConnectionParameter](/cells/zh/python-net/aspose.cells.externalconnections/connectionparameter) |要在数组列表中定位的对象。该值可以为空。|
