...
type: docs
weight: 70
url: /zh/python-net/aspose.cells.pivot/pivotfiltercollection/last_index_of/
is_root: false
---
...
|范围|类型|描述|
| :- | :- | :- |
| item | [PivotFilter](/cells/zh/python-net/aspose.cells.pivot/pivotfilter) |要在数组列表中定位的对象。该值可以为空。|
...
* 类 [PivotFilterCollection](/cells/zh/python-net/aspose.cells.pivot/pivotfiltercollection)
