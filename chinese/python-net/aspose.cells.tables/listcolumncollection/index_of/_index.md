...
type: docs
weight: 40
url: /zh/python-net/aspose.cells.tables/listcolumncollection/index_of/
is_root: false
---
...
|范围|类型|描述|
| :- | :- | :- |
| item | [ListColumn](/cells/zh/python-net/aspose.cells.tables/listcolumn) |要在数组列表中定位的对象。该值可以为空。|
...
* 类 [ListColumnCollection](/cells/zh/python-net/aspose.cells.tables/listcolumncollection)
