...
type: docs
weight: 40
url: /zh/python-net/aspose.cells.revisions/revisioncollection/index_of/
is_root: false
---
...
|范围|类型|描述|
| :- | :- | :- |
| item | [Revision](/cells/zh/python-net/aspose.cells.revisions/revision) |要在数组列表中定位的对象。该值可以为空。|
...
* 类 [RevisionCollection](/cells/zh/python-net/aspose.cells.revisions/revisioncollection)
