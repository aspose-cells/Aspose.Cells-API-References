---
title: extract_content_permission_obsolete 属性
second_title: Aspose.Cells for Python via .NET API 参考文献
description:
type: docs
weight: 70
url: /zh/python-net/aspose.cells.rendering.pdfsecurity/pdfsecurityoptions/extract_content_permission_obsolete/
is_root: false
---
## extract_content_permission_obsolete 属性

根据 PDF 参考，复制或提取内容已废弃的权限。
### 定义：
```python
@property
