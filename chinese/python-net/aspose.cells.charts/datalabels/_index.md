...
**继承：** [DataLabels](/cells/python-net/aspose.cells.charts/datalabels) → 
...
DataLabels 类型公开了以下成员：

### 特性
|属性|描述|
| :- | :- |
| [is_inner_mode](/cells/zh/python-net/aspose.cells.charts/datalabels/is_inner_mode) |指示绘图区域大小是否包括刻度线和轴标签。<br/> False 指定大小应确定绘图区域、刻度线和轴标签的大小。|
| [border](/cells/zh/python-net/aspose.cells.charts/datalabels/border) |获取 [Line](/cells/zh/python-net/aspose.cells.drawing/line)。|
| [area](/cells/zh/python-net/aspose.cells.charts/datalabels/area) |获取 [DataLabels.area](/cells/zh/python-net/aspose.cells.charts/datalabels#area)。|
...
| [x](/cells/zh/python-net/aspose.cells.charts/datalabels/x) |获取或设置图表区域左上角的 x 坐标，单位为 1/4000。|
| [y](/cells/zh/python-net/aspose.cells.charts/datalabels/y) |获取或设置图表区域左上角的y坐标，单位为1/4000。|
| [height](/cells/zh/python-net/aspose.cells.charts/datalabels/height) |获取或设置以图表区域的 1/4000 为单位的框架高度。|
| [width](/cells/zh/python-net/aspose.cells.charts/datalabels/width) |获取或设置以图表区域的 1/4000 为单位的框架宽度。|
| [shadow](/cells/zh/python-net/aspose.cells.charts/datalabels/shadow) |如果框架有阴影，则为真。|
| [shape_properties](/cells/zh/python-net/aspose.cells.charts/datalabels/shape_properties) |获取 [ChartFrame.shape_properties](/cells/zh/python-net/aspose.cells.charts/chartframe#shape_properties) 对象。|
| [is_default_pos_be_set](/cells/zh/python-net/aspose.cells.charts/datalabels/is_default_pos_be_set) |指示是否设置了默认位置（DefaultX、DefaultY、DefaultWidth 和 DefaultHeight）。|
| [default_x](/cells/zh/python-net/aspose.cells.charts/datalabels/default_x) |表示默认位置的x|
| [default_y](/cells/zh/python-net/aspose.cells.charts/datalabels/default_y) |代表默认位置的y|
| [default_width](/cells/zh/python-net/aspose.cells.charts/datalabels/default_width) |表示默认位置的宽度|
| [default_height](/cells/zh/python-net/aspose.cells.charts/datalabels/default_height) |表示默认位置的高度|
| [is_auto_text](/cells/zh/python-net/aspose.cells.charts/datalabels/is_auto_text) |表示文本是自动生成的。|
| [is_deleted](/cells/zh/python-net/aspose.cells.charts/datalabels/is_deleted) |指示是否删除此数据标签。|
| [text_horizontal_alignment](/cells/zh/python-net/aspose.cells.charts/datalabels/text_horizontal_alignment) |获取和设置文本水平对齐方式。|
| [text_vertical_alignment](/cells/zh/python-net/aspose.cells.charts/datalabels/text_vertical_alignment) |获取或设置文本的文本垂直对齐方式。|
| [rotation_angle](/cells/zh/python-net/aspose.cells.charts/datalabels/rotation_angle) |表示文本旋转角度。|
| [is_automatic_rotation](/cells/zh/python-net/aspose.cells.charts/datalabels/is_automatic_rotation) |指示图表的文本是否自动旋转。|
| [text](/cells/zh/python-net/aspose.cells.charts/datalabels/text) |获取或设置数据标签的文本。|
| [linked_source](/cells/zh/python-net/aspose.cells.charts/datalabels/linked_source) |获取和设置对工作表的引用。|
| [text_direction](/cells/zh/python-net/aspose.cells.charts/datalabels/text_direction) |表示文本阅读顺序。|
...
| [number_format_linked](/cells/zh/python-net/aspose.cells.charts/datalabels/number_format_linked) |如果数字格式链接到单元格则为真<br/>（这样当单元格中的数字格式发生变化时，标签中的数字格式也会发生变化）。|
| [separator](/cells/zh/python-net/aspose.cells.charts/datalabels/separator) |获取或设置用于图表上数据标签的分隔符类型。|
...
|方法|描述|
| :- | :- |
| [set_position_auto()](/cells/zh/python-net/aspose.cells.charts/datalabels/set_position_auto/#) |将框架的位置设置为自动|
| [characters(start_index, length)](/cells/zh/python-net/aspose.cells.charts/datalabels/characters/#int-int) |返回一个 Characters 对象，该对象表示文本中的一系列字符。|
