...
type: docs
weight: 80
url: /zh/python-net/aspose.cells.charts/chartcollection/last_index_of/
is_root: false
---
...
|范围|类型|描述|
| :- | :- | :- |
| item | [Chart](/cells/zh/python-net/aspose.cells.charts/chart) |要在数组列表中定位的对象。该值可以为空。|
...
* 类 [ChartCollection](/cells/zh/python-net/aspose.cells.charts/chartcollection)
