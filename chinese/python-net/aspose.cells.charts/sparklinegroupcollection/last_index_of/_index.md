...
type: docs
weight: 80
url: /zh/python-net/aspose.cells.charts/sparklinegroupcollection/last_index_of/
is_root: false
---
...
|范围|类型|描述|
| :- | :- | :- |
| item | [SparklineGroup](/cells/zh/python-net/aspose.cells.charts/sparklinegroup) |要在数组列表中定位的对象。该值可以为空。|
