...
type: docs
weight: 130
url: /zh/python-net/aspose.cells.charts/chart/to_pdf/
is_root: false
---
...
| h_alignment_type | [PageLayoutAlignmentType](/cells/zh/python-net/aspose.cells/pagelayoutalignmenttype) |输出页面中的图表水平对齐类型。|
| v_alignment_type | [PageLayoutAlignmentType](/cells/zh/python-net/aspose.cells/pagelayoutalignmenttype) |输出页面中的图表垂直对齐类型。|
