...
type: docs
weight: 330
url: /zh/python-net/aspose.cells.charts/chartpoint/shape_properties/
is_root: false
---
## shape_properties 属性

获取 [ShapePropertyCollection](/cells/zh/python-net/aspose.cells.drawing/shapepropertycollection) 对象，该对象保存 ChartPoint 的可视形状属性。
### 定义：
```python
@property
