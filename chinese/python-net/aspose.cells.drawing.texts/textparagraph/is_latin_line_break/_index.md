---
title: is_latin_line_break 属性
second_title: Aspose.Cells for Python via .NET API 参考资料
description:
type: docs
weight: 130
url: /zh/python-net/aspose.cells.drawing.texts/textparagraph/is_latin_line_break/
is_root: false
---
## is_latin_line_break 属性

指定是否可以在不添加连字符的情况下将拉丁词分成两半并换行到下一行。
### 定义：
```python
@property
