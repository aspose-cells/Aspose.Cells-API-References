...
type: docs
weight: 30
url: /zh/python-net/aspose.cells/autofilter/add_fill_color_filter/
is_root: false
---
...
| pattern | [BackgroundType](/cells/zh/python-net/aspose.cells/backgroundtype) |背景图案类型。|
| foreground_color | [CellsColor](/cells/zh/python-net/aspose.cells/cellscolor) |前景色。|
| background_color | [CellsColor](/cells/zh/python-net/aspose.cells/cellscolor) |背景色。|
