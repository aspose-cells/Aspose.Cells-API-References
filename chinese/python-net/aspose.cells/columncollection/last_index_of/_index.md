...
type: docs
weight: 70
url: /zh/python-net/aspose.cells/columncollection/last_index_of/
is_root: false
---
...
|范围|类型|描述|
| :- | :- | :- |
| item | [Column](/cells/zh/python-net/aspose.cells/column) |要在数组列表中定位的对象。该值可以为空。|
...
### 也可以看看
* 模块 [aspose.cells](../../)
* 类 [ColumnCollection](/cells/zh/python-net/aspose.cells/columncollection)
