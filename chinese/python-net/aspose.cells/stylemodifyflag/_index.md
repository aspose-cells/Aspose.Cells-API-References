...
StyleModifyFlag 类型公开了以下成员：

### 字段
|场地|描述|
| :- | :- |
| LEFT_BORDER |指示是否已为样式修改左边框。|
...
| NUMBER_FORMAT |指示 numberformat 是否已被修改。|
| HORIZONTAL_ALIGNMENT |指示是否已修改水平对齐方式。|
| VERTICAL_ALIGNMENT |指示是否已修改垂直对齐方式。|
| INDENT |指示缩进属性是否已被修改。|
...
| HIDE_FORMULA |指示是否已修改隐藏公式。|
| PROTECTION_SETTINGS |指示一个或多个与保护相关的属性（[StyleModifyFlag.LOCKED](/cells/zh/python-net/aspose.cells/stylemodifyflag#LOCKED)，<br/> [StyleModifyFlag.HIDE_FORMULA](/cells/zh/python-net/aspose.cells/stylemodifyflag#HIDE_FORMULA)) 已被修改。|
| FONT_SIZE |指示字体大小是否已修改。|
| FONT_NAME |指示字体名称是否已被修改。|
| FONT_COLOR |指示字体颜色是否已被修改。|
| FONT_WEIGHT |指示字体粗细是否已被修改。|
| FONT_ITALIC |指示字体的斜体属性是否已被修改。|
| FONT_UNDERLINE |指示字体的下划线属性是否已被修改。|
| FONT_STRIKE |指示 strike 属性字体是否已被修改。|
...
| FONT_EQUALIZE |没用过。|
| FONT_CAP |没用过。|
| FONT |指示是否已为样式的字体修改了一个或多个属性。|
| ALL |指示是否已为样式修改了一个或多个属性。|
