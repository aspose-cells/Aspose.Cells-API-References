...
type: docs
weight: 590
url: /zh/python-net/aspose.cells/workbooksettings/significant_digits/
is_root: false
---
## significant_digits 属性

获取和设置有效位数。
默认值为 [CellsHelper.significant_digits](/cells/zh/python-net/aspose.cells/cellshelper#significant_digits)。
