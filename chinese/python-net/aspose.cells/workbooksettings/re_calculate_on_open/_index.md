---
title: re_calculate_on_open 属性
second_title: Aspose.Cells for Python via .NET API 参考资料
description:
type: docs
weight: 500
url: /zh/python-net/aspose.cells/workbooksettings/re_calculate_on_open/
is_root: false
---
## re_calculate_on_open 属性

指示是否在打开文件时重新计算所有公式。

### 评论

注意：该成员现已过时。相反，请使用 FormulaSettings.CalculateOnOpen。
