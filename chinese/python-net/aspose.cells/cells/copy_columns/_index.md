...
type: docs
weight: 160
url: /zh/python-net/aspose.cells/cells/copy_columns/
is_root: false
---
...
| destination_column_index | int |目标列索引。|
| column_number | int |复制的列号。|
...
| destination_column_index | int |目标列索引。|
| column_number | int |复制的列号。|
| paste_options | [PasteOptions](/cells/zh/python-net/aspose.cells/pasteoptions) |粘贴的选项。|
...
| source_column_index | int |源列索引。|
| source_total_columns | int |源列的数量。|
| destination_column_index | int |目标列索引。|
| destination_total_columns | int |目标列的数量。|
