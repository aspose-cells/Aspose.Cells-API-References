---
title: export_frame_scripts_and_properties 属性
second_title: Aspose.Cells for Python via .NET API 参考资料
description:
type: docs
weight: 230
url: /zh/python-net/aspose.cells/htmlsaveoptions/export_frame_scripts_and_properties/
is_root: false
---
## export_frame_scripts_and_properties 属性

指示是否导出框架脚本和文档属性。默认值为true。如果要导入html或mht文件
excel，请保持默认值。
### 定义：
```python
@property
