...
type: docs
weight: 60
url: /zh/python-net/aspose.cells/scenariocollection/last_index_of/
is_root: false
---
...
|范围|类型|描述|
| :- | :- | :- |
| item | [Scenario](/cells/zh/python-net/aspose.cells/scenario) |要在数组列表中定位的对象。该值可以为空。|
...
### 也可以看看
* 模块 [aspose.cells](../../)
* 类 [ScenarioCollection](/cells/zh/python-net/aspose.cells/scenariocollection)
