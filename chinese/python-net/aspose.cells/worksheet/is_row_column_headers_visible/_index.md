---
title: is_row_column_headers_visible 属性
second_title: Aspose.Cells for Python via .NET API 参考文献
description:
type: docs
weight: 580
url: /zh/python-net/aspose.cells/worksheet/is_row_column_headers_visible/
is_root: false
---
## is_row_column_headers_visible 属性

获取或设置一个值，该值指示工作表是否显示行标题和列标题。
默认为真。
### 定义：
```python
@property
