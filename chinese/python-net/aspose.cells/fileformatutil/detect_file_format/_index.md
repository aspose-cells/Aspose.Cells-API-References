...
type: docs
weight: 20
url: /zh/python-net/aspose.cells/fileformatutil/detect_file_format/
is_root: false
---
...
包含检测到的信息的 [FileFormatInfo](/cells/zh/python-net/aspose.cells/fileformatinfo) 对象。
...
### 也可以看看
* 模块 [aspose.cells](../../)
* 类 [FileFormatInfo](/cells/zh/python-net/aspose.cells/fileformatinfo)
