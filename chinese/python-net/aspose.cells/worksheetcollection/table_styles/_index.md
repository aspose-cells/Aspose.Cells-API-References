...
type: docs
weight: 340
url: /zh/python-net/aspose.cells/worksheetcollection/table_styles/
is_root: false
---
## table_styles 属性

获取 [WorksheetCollection.table_styles](/cells/zh/python-net/aspose.cells/worksheetcollection#table_styles) 对象。
### 定义：
```python
@property
