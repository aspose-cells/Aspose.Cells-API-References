...
type: docs
weight: 50
url: /zh/python-net/aspose.cells/dxfcollection/last_index_of/
is_root: false
---
...
|范围|类型|描述|
| :- | :- | :- |
| item | [Style](/cells/zh/python-net/aspose.cells/style) |要在数组列表中定位的对象。该值可以为空。|
...
### 也可以看看
* 模块 [aspose.cells](../../)
* 类 [DxfCollection](/cells/zh/python-net/aspose.cells/dxfcollection)
