...
type: docs
weight: 60
url: /zh/python-net/aspose.cells.properties/custompropertycollection/last_index_of/
is_root: false
---
...
|范围|类型|描述|
| :- | :- | :- |
| item | [CustomProperty](/cells/zh/python-net/aspose.cells.properties/customproperty) |要在数组列表中定位的对象。该值可以为空。|
