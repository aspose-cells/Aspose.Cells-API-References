...
type: docs
weight: 40
url: /zh/python-net/aspose.cells.metadata/workbookmetadata/built_in_document_properties/
is_root: false
---
## built_in_document_properties 属性

返回代表电子表格所有内置文档属性的 [DocumentProperty](/cells/zh/python-net/aspose.cells.properties/documentproperty) 集合。
### 定义：
```python
@property
...
* 类 [WorkbookMetadata](/cells/zh/python-net/aspose.cells.metadata/workbookmetadata)
