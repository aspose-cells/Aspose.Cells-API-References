...
type: docs
weight: 50
url: /zh/python-net/aspose.cells.querytables/powerqueryformulacollection/last_index_of/
is_root: false
---
...
|范围|类型|描述|
| :- | :- | :- |
| item | [PowerQueryFormula](/cells/zh/python-net/aspose.cells.querytables/powerqueryformula) |要在数组列表中定位的对象。该值可以为空。|
...
* 类 [PowerQueryFormulaCollection](/cells/zh/python-net/aspose.cells.querytables/powerqueryformulacollection)
