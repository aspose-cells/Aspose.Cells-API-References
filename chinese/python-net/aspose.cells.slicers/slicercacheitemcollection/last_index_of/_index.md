...
type: docs
weight: 50
url: /zh/python-net/aspose.cells.slicers/slicercacheitemcollection/last_index_of/
is_root: false
---
...
|范围|类型|描述|
| :- | :- | :- |
| item | [SlicerCacheItem](/cells/zh/python-net/aspose.cells.slicers/slicercacheitem) |要在数组列表中定位的对象。该值可以为空。|
...
* 类 [SlicerCacheItemCollection](/cells/zh/python-net/aspose.cells.slicers/slicercacheitemcollection)
