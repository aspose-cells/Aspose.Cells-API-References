...
type: docs
weight: 70
url: /zh/python-net/aspose.cells.webextensions/webextensioncollection/last_index_of/
is_root: false
---
...
|范围|类型|描述|
| :- | :- | :- |
| item | [WebExtension](/cells/zh/python-net/aspose.cells.webextensions/webextension) |要在数组列表中定位的对象。该值可以为空。|
...
* 类 [WebExtensionCollection](/cells/zh/python-net/aspose.cells.webextensions/webextensioncollection)
