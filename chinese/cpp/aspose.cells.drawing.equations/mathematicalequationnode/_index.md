---
title: Aspose::Cells::Drawing::Equations::MathematicalEquationNode class
linktitle: MathematicalEquationNode
second_title: Aspose.Cells for C++ API Reference
description: 'Aspose::Cells::Drawing::Equations::MathematicalEquationNode class. This class specifies an equation or mathematical expression. All mathematical text of equations or mathematical expressions are contained by this class in C++.'
type: docs
weight: 1400
url: /zh/cpp/aspose.cells.drawing.equations/mathematicalequationnode/
---
...
```cpp
class MathematicalEquationNode : public Aspose::Cells::Drawing::Equations::EquationNode
```
...
| [MathematicalEquationNode(MathematicalEquationNode_Impl* impl)](./mathematicalequationnode/) | Constructs from an implementation object. |
| [MathematicalEquationNode(const MathematicalEquationNode\& src)](./mathematicalequationnode/) | Copy constructor. |
| [MathematicalEquationNode(const EquationNode\& src)](./mathematicalequationnode/) | Constructs from a parent object. |
| explicit [operator bool()](./operator_bool/) const | operator bool() |
| [operator=(const MathematicalEquationNode\& src)](./operator_asm/) | operator= |
...
| [~MathematicalEquationNode()](./~mathematicalequationnode/) | Destructor. |
## Fields
