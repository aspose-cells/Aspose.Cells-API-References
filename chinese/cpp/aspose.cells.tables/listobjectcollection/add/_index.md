---
title: Aspose::Cells::Tables::ListObjectCollection::Add method
linktitle: Add
second_title: Aspose.Cells for C++ API Reference
description: 'Aspose::Cells::Tables::ListObjectCollection::Add method. Adds a ListObject to the worksheet in C++.'
type: docs
weight: 700
url: /zh/cpp/aspose.cells.tables/listobjectcollection/add/
---
## ListObjectCollection::Add(int32_t, int32_t, int32_t, int32_t, bool) method


Adds a [ListObject](../../listobject/) to the worksheet.
...
The index of the new [ListObject](../../listobject/)
