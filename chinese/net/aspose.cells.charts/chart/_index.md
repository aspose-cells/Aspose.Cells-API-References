...
| [BackWall](../../aspose.cells.charts/chart/backwall) { get; } | 返回一个[`Walls`](./walls)表示 3-D 图表后壁的对象。 |
...
| [ChartDataTable](../../aspose.cells.charts/chart/chartdatatable) { get; } | 代表图表数据表。 |
| [ChartObject](../../aspose.cells.charts/chart/chartobject) { get; } | 代表图表形状； |
| [DepthPercent](../../aspose.cells.charts/chart/depthpercent) { get; set; } | 将 3-D 图表的深度表示为图表宽度的百分比（介于 20% 和 2000% 之间）。 |
| [DisplayNaAsBlank](../../aspose.cells.charts/chart/displaynaasblank) { get; set; } | 表示是否将#N/A 显示为空白值。 |
...
| [Floor](../../aspose.cells.charts/chart/floor) { get; } | 返回一个[`Floor`](./floor)表示 3-D 图表墙壁的对象。 |
| [GapDepth](../../aspose.cells.charts/chart/gapdepth) { get; set; } | 获取或设置 3-D 图表中数据系列之间的距离，以标记宽度的百分比表示。 此属性的值必须介于 0 和 500 之间。 |
| [GapWidth](../../aspose.cells.charts/chart/gapwidth) { get; set; } | 返回或设置条形或列簇之间的间距，以条形或列宽的百分比表示。 此属性的值必须介于 0 和 500 之间。 |
| [HeightPercent](../../aspose.cells.charts/chart/heightpercent) { get; set; } | 返回或设置 3-D 图表的高度，作为图表宽度的百分比（介于 5% 和 500% 之间）。 |
...
| [IsRectangularCornered](../../aspose.cells.charts/chart/isrectangularcornered) { get; set; } | 获取或设置一个值，指示图表区域是否为矩形角。 默认为true。 |
| [Legend](../../aspose.cells.charts/chart/legend) { get; } | 获取图表图例。 |
| [Line](../../aspose.cells.charts/chart/line) { get; } | 获取线。 |
| [Name](../../aspose.cells.charts/chart/name) { get; set; } | 获取和设置图表的名称。 |
| [NSeries](../../aspose.cells.charts/chart/nseries) { get; } | 得到一个[`SeriesCollection`](../seriescollection)表示图表中数据系列的集合。 |
...
| [PivotOptions](../../aspose.cells.charts/chart/pivotoptions) { get; } | 指定出现在图表上的枢轴控件 |
| [PivotSource](../../aspose.cells.charts/chart/pivotsource) { get; set; } | 来源为数据透视表的数据。 如果PivotSource不为空，则图表为PivotChart。 |
...
| [SideWall](../../aspose.cells.charts/chart/sidewall) { get; } | 返回一个[`Walls`](./walls)表示 3-D 图表侧壁的对象。 |
...
| [Walls](../../aspose.cells.charts/chart/walls) { get; } | 返回一个[`Walls`](./walls)表示 3-D 图表墙壁的对象。 |
...
| [ToImage](../../aspose.cells.charts/chart/toimage#toimage)() | 获取 32 位`位图`图表对象. |
| [ToImage](../../aspose.cells.charts/chart/toimage#toimage_1)(ImageOrPrintOptions) | 获取 32 位`位图`图表对象. `ImageOrPrintOptions.ImageFormat` , ImageOrPrintOptions.TiffCompression 和 ImageOrPrintOptions.Quality 属性被忽略。 |
| [ToImage](../../aspose.cells.charts/chart/toimage#toimage_6)(string) | 创建图表图像并将其保存到文件中。 文件名的扩展名决定图像的格式。 |
| [ToImage](../../aspose.cells.charts/chart/toimage#toimage_3)(Stream, ImageOrPrintOptions) | 创建图表图像并将其保存到指定格式的流中。 |
| [ToImage](../../aspose.cells.charts/chart/toimage#toimage_2)(Stream, ImageType) | 创建图表图像并将其保存到指定格式的流中。 |
| [ToImage](../../aspose.cells.charts/chart/toimage#toimage_4)(Stream, long) | 创建图表图像并将其保存到 Jpeg 格式的流中。 |
| [ToImage](../../aspose.cells.charts/chart/toimage#toimage_8)(string, ImageOrPrintOptions) | 创建图表图像并将其保存到文件中。 文件名的扩展名决定图像的格式。 |
| [ToImage](../../aspose.cells.charts/chart/toimage#toimage_7)(string, ImageType) | 创建图表图像并将其保存到指定图像类型的文件中。 |
| [ToImage](../../aspose.cells.charts/chart/toimage#toimage_9)(string, long) | 创建图表图像并将其保存到 Jpeg 格式的文件中。 |
