...
| [ChartArea](./chartarea) | 封装代表工作表中图表区域的对象。 |
| [ChartCollection](./chartcollection) | 封装了一个集合[`Chart`](../aspose.cells.charts/chart)对象. |
| [ChartDataTable](./chartdatatable) | 表示一个图表数据表。 |
| [ChartFrame](./chartframe) | 封装表示图表中框架对象的对象。 |
| [ChartGlobalizationSettings](./chartglobalizationsettings) | 代表图表的全球化设置。 |
...
| [DataLabels](./datalabels) | 封装指定 Series 的所有 DataLabel 对象的集合。 |
| [DisplayUnitLabel](./displayunitlabel) | 表示显示单元标签。 |
| [DropBars](./dropbars) | 表示图表中的向上/向下柱。 |
| [ErrorBar](./errorbar) | 代表数据系列的误差条。 |
| [Floor](./floor) | 封装表示 3-D 图表地板的对象。 |
| [Legend](./legend) | 封装表示图表图例的对象。 |
| [LegendEntry](./legendentry) | 表示图表图例中的图例条目。 |
| [LegendEntryCollection](./legendentrycollection) | 代表所有的集合[`LegendEntry`](../aspose.cells.charts/legendentry)指定图表图例中的对象。 |
...
| [SeriesCollection](./seriescollection) | 封装了一个集合[`Series`](../aspose.cells.charts/series)对象. |
| [SeriesLayoutProperties](./serieslayoutproperties) |  |
| [Sparkline](./sparkline) | 迷你图表示工作表单元格中的小图表或图形，提供数据的可视化表示。 |
| [SparklineCollection](./sparklinecollection) | 封装了一个集合[`Sparkline`](../aspose.cells.charts/sparkline)对象. |
...
| [SparklineGroupCollection](./sparklinegroupcollection) | 封装了一个集合[`SparklineGroup`](../aspose.cells.charts/sparklinegroup)对象. |
| [TickLabelItem](./ticklabelitem) | 包含一个 Ticklabel 项目的信息 |
| [TickLabels](./ticklabels) | 表示与图表轴上的刻度线相关的刻度线标签。 |
| [Title](./title) | 封装表示图表或轴标题的对象。 |
| [Trendline](./trendline) | 表示图表中的趋势线。 |
| [TrendlineCollection](./trendlinecollection) | 代表所有的集合[`Trendline`](../aspose.cells.charts/trendline)指定数据系列的对象。 |
...
| [BackgroundMode](./backgroundmode) | 代表背景的显示方式。 |
| [Bar3DShapeType](./bar3dshapetype) | 表示与 3-D 条形图或柱形图一起使用的形状。 |
| [BubbleSizeRepresents](./bubblesizerepresents) | 表示气泡图上的气泡大小。 |
...
| [ChartTextDirectionType](./charttextdirectiontype) | 代表图表的文字方向类型。 |
| [ChartType](./charttype) | 枚举 Excel 中使用的所有图表类型。 |
| [CrossType](./crosstype) | 表示轴交叉类型。 |
| [DataLabelsSeparatorType](./datalabelsseparatortype) | 表示 DataLabels 的分隔符类型。 |
| [DisplayUnitType](./displayunittype) | 表示显示单元的类型。 |
| [ErrorBarDisplayType](./errorbardisplaytype) | 表示误差条显示类型。 |
| [ErrorBarType](./errorbartype) | 表示误差条数量类型。 |
| [FormattingType](./formattingtype) | 表示应用于[`Area`](../aspose.cells.drawing/area)对象或[`Line`](../aspose.cells.drawing/line)对象. |
...
| [QuartileCalculationType](./quartilecalculationtype) | 代表四分位数的计算方法。 |
...
| [SparklineType](./sparklinetype) | 代表迷你图类型。 |
...
| [TrendlineType](./trendlinetype) | 代表趋势线类型。 |
