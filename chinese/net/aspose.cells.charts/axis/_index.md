...
| [AxisLabels](../../aspose.cells.charts/axis/axislabels) { get; } | 调用 Chart.Calculate() 方法后获取坐标轴的标签。 |
...
| [Bins](../../aspose.cells.charts/axis/bins) { get; } | 表示图表（直方图/帕累托）轴上的 bin |
...
| [CrossType](../../aspose.cells.charts/axis/crosstype) { get; set; } | 表示[`CrossType`](./crosstype)在另一个轴相交的指定轴上。 |
...
| [IsAutoTickLabelSpacing](../../aspose.cells.charts/axis/isautoticklabelspacing) { get; set; } | 表示刻度标签的间距是否自动 |
| [IsDisplayUnitLabelShown](../../aspose.cells.charts/axis/isdisplayunitlabelshown) { get; set; } | 表示显示单元标签是否显示在指定轴上。 |
...
| [MajorTickMark](../../aspose.cells.charts/axis/majortickmark) { get; set; } | 表示指定轴的主刻度线的类型。 |
...
| [TickLabels](../../aspose.cells.charts/axis/ticklabels) { get; } | 返回一个[`TickLabels`](./ticklabels)对象，该对象表示指定轴的刻度标记标签。 |
