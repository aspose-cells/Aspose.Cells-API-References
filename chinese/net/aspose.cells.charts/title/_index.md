...
| [OverLay](../../aspose.cells.charts/title/overlay) { get; set; } | 表示图表上覆盖居中的标题而不调整图表大小。 |
...
| override [X](../../aspose.cells.charts/title/x) { get; set; } | 获取或设置图表区域左上角的x坐标，单位为1/4000。 |
| override [Y](../../aspose.cells.charts/title/y) { get; set; } | 获取或设置图表区域左上角的y坐标，单位为1/4000。 |
