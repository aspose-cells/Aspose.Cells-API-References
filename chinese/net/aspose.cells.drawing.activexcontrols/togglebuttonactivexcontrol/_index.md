...
description: 表示一个 ToggleButton ActiveX 控件
type: docs
weight: 1730
url: /zh/net/aspose.cells.drawing.activexcontrols/togglebuttonactivexcontrol/
---
## ToggleButtonActiveXControl class

表示一个 ToggleButton ActiveX 控件。
...
| override [Type](../../aspose.cells.drawing.activexcontrols/togglebuttonactivexcontrol/type) { get; } | 获取 ActiveX 控件的类型。 |
