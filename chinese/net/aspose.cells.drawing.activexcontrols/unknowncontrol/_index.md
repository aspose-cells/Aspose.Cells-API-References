...
type: docs
weight: 1740
url: /zh/net/aspose.cells.drawing.activexcontrols/unknowncontrol/
---
...
| override [Data](../../aspose.cells.drawing.activexcontrols/unknowncontrol/data) { get; } | 获取和设置控件的二进制数据。 |
...
| [PersistenceType](../../aspose.cells.drawing.activexcontrols/unknowncontrol/persistencetype) { get; } | 获取持久化方法以持久化 ActiveX 控件。 |
...
| override [Type](../../aspose.cells.drawing.activexcontrols/unknowncontrol/type) { get; } | 获取 ActiveX 控件的类型。 |
...
| 姓名 | 描述 |
| --- | --- |
| [GetRelationshipData](../../aspose.cells.drawing.activexcontrols/unknowncontrol/getrelationshipdata)(string) | 获取相关数据。 |
