...
description: 表示 ScrollBar 控件
type: docs
weight: 1690
url: /zh/net/aspose.cells.drawing.activexcontrols/scrollbaractivexcontrol/
---
...
| [LargeChange](../../aspose.cells.drawing.activexcontrols/scrollbaractivexcontrol/largechange) { get; set; } | 获取和设置 Position 属性的变化量 |
...
| override [Type](../../aspose.cells.drawing.activexcontrols/scrollbaractivexcontrol/type) { get; } | 获取 ActiveX 控件的类型。 |
