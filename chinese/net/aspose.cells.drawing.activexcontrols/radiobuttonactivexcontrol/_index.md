...
| [IsTripleState](../../aspose.cells.drawing.activexcontrols/togglebuttonactivexcontrol/istriplestate) { get; set; } | 表示指定控件将如何显示 Null 值。 |
| virtual [IsVisible](../../aspose.cells.drawing.activexcontrols/activexcontrolbase/isvisible) { get; set; } | 表示这个控件是否可见。 |
| [IsWordWrapped](../../aspose.cells.drawing.activexcontrols/radiobuttonactivexcontrol/iswordwrapped) { get; set; } | 表示控件的内容是否在行尾自动换行。 |
