...
| [BorderOleColor](../../aspose.cells.drawing.activexcontrols/imageactivexcontrol/borderolecolor) { get; set; } | 获取和设置背景的ole颜色。 |
...
| [IsTiled](../../aspose.cells.drawing.activexcontrols/imageactivexcontrol/istiled) { get; set; } | 表示图片是否平铺在背景上。 |
...
| [PictureAlignment](../../aspose.cells.drawing.activexcontrols/imageactivexcontrol/picturealignment) { get; set; } | 获取并设置Form或Image中图片的对齐方式。 |
| [PictureSizeMode](../../aspose.cells.drawing.activexcontrols/imageactivexcontrol/picturesizemode) { get; set; } | 获取和设置图片的显示方式。 |
