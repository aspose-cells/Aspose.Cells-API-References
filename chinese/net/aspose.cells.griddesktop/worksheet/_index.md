...
| [BackgroundImage](../../aspose.cells.griddesktop/worksheet/backgroundimage) { get; set; } | 获取和设置工作表背景图像。 |
| [Cells](../../aspose.cells.griddesktop/worksheet/cells) { get; } |  |
| [CodeName](../../aspose.cells.griddesktop/worksheet/codename) { get; } | 表示工作表代码名称。 |
...
| [DataMember](../../aspose.cells.griddesktop/worksheet/datamember) { get; } | 获取 Worksheet 对象为其显示数据的数据源。 |
| [DataSource](../../aspose.cells.griddesktop/worksheet/datasource) { get; } | 获取 DataSource for Worksheet 对象中的特定列表。 |
| [DisplayRightToLeft](../../aspose.cells.griddesktop/worksheet/displayrighttoleft) { get; set; } |  |
| [DisplayZeros](../../aspose.cells.griddesktop/worksheet/displayzeros) { get; set; } | 如果显示零值，则为真。 |
...
| [FrozenCols](../../aspose.cells.griddesktop/worksheet/frozencols) { get; set; } | 获取或设置 Worksheet 的冻结列数。 Frozen 将从第一列开始。 |
| [FrozenRows](../../aspose.cells.griddesktop/worksheet/frozenrows) { get; set; } | 获取或设置 Worksheet 的冻结行数。 Frozen 将从第一行开始。 |
| [GridDesktop](../../aspose.cells.griddesktop/worksheet/griddesktop) { get; } | 获取 Sheet 的 GridDesktop 对象。 |
| [GridlinesVisible](../../aspose.cells.griddesktop/worksheet/gridlinesvisible) { get; set; } | 获取或设置一个值，指示网格线是否可见。默认为 true。 |
...
| [IsVeryHidden](../../aspose.cells.griddesktop/worksheet/isveryhidden) { get; set; } | 指示工作表是否隐藏且无法在用户界面 (UI) 中显示。 |
| [IsVisible](../../aspose.cells.griddesktop/worksheet/isvisible) { get; set; } |  |
| [MergesCount](../../aspose.cells.griddesktop/worksheet/mergescount) { get; } | 获取合并计数 |
| [Name](../../aspose.cells.griddesktop/worksheet/name) { get; set; } | 获取或设置工作表的名称。 |
| [OutlineShown](../../aspose.cells.griddesktop/worksheet/outlineshown) { get; set; } | 表示是否显示轮廓。 |
| [Pictures](../../aspose.cells.griddesktop/worksheet/pictures) { get; } | 获取[`Pictures`](./pictures)集合。 |
...
| [Shapes](../../aspose.cells.griddesktop/worksheet/shapes) { get; } | 获取[`Pictures`](./pictures)集合。 |
...
| 姓名 | 描述 |
| --- | --- |
| [AddAutoFilter](../../aspose.cells.griddesktop/worksheet/addautofilter)(int, int, int) | 设置指定自动筛选应用的范围。 |
| [AddColumn](../../aspose.cells.griddesktop/worksheet/addcolumn)() | 添加新列。 |
...
| [AddRow](../../aspose.cells.griddesktop/worksheet/addrow)() | 添加新行。 |
| [AddSelectedRange](../../aspose.cells.griddesktop/worksheet/addselectedrange)(CellRange) | 将新的选定范围添加到工作表。 |
...
| [AutoFitRow](../../aspose.cells.griddesktop/worksheet/autofitrow#autofitrow_2)(int, int, int, int) | 自动调整矩形范围内的行高。 |
...
| [CellRangeInMerge](../../aspose.cells.griddesktop/worksheet/cellrangeinmerge)(CellRange) | 获取一个值，该值指示指定单元格区域是否合并。 |
...
| [ColInMerged](../../aspose.cells.griddesktop/worksheet/colinmerged)(int) | 获取一个值，该值指示指定列是否合并。 |
| [ColInSelection](../../aspose.cells.griddesktop/worksheet/colinselection)(int) | 确定索引处的指定列是否处于选中状态。 |
...
| [DataBind](../../aspose.cells.griddesktop/worksheet/databind)(object, string) | 将来自数据源对象的数据与 Worksheet 对象绑定。 |
...
| [ExportDataTable](../../aspose.cells.griddesktop/worksheet/exportdatatable#exportdatatable)(int, int, int, int, bool, bool) | 将 Worksheet 的 Cells 集合中的数据导出到新的 DataTable 对象。 |
| [FilterString](../../aspose.cells.griddesktop/worksheet/filterstring)(int, string) | 为列设置过滤器。注意我们将在调用 filterString 过滤条件字符串之前调用 AddAutoFilter。注意我们使用逗号-&gt;"," 作为拆分字符，因此您要过滤的单元格值不应包含逗号 filterString(10,"123,456") 表示第 10 列应包含 123 或 456 , filterString(10,"123") 表示 column10 应包含 123  值，用逗号分隔，例如。 123,456,789 或 abc |
...
| [GetFocusedCellLocation](../../aspose.cells.griddesktop/worksheet/getfocusedcelllocation)() | 获取聚焦的单元格位置。 |
...
| [GetLastSelection](../../aspose.cells.griddesktop/worksheet/getlastselection)() | 获取最后选择的单元格范围。 |
| [GetMerge](../../aspose.cells.griddesktop/worksheet/getmerge)(int) | 获取指定索引处合并的单元格范围。 |
| [GetMergeByCell](../../aspose.cells.griddesktop/worksheet/getmergebycell)(int, int) | 获取包含行、列位置单元格的合并区域，如果所有合并区域都不包含此单元格位置，则返回 null |
| [GroupColumns](../../aspose.cells.griddesktop/worksheet/groupcolumns#groupcolumns)(int, int) | 分组列。 |
| [GroupColumns](../../aspose.cells.griddesktop/worksheet/groupcolumns#groupcolumns_1)(int, int, bool, bool) | 分组列。 |
| [GroupColumns](../../aspose.cells.griddesktop/worksheet/groupcolumns#groupcolumns_2)(int, int, int, bool) | 分组列。 |
| [GroupRows](../../aspose.cells.griddesktop/worksheet/grouprows#grouprows)(int, int) | 分组行。 |
| [GroupRows](../../aspose.cells.griddesktop/worksheet/grouprows#grouprows_1)(int, int, bool) | 分组行。 |
| [GroupRows](../../aspose.cells.griddesktop/worksheet/grouprows#grouprows_2)(int, int, bool, bool) | 分组行。 |
| [GroupRows](../../aspose.cells.griddesktop/worksheet/grouprows#grouprows_3)(int, int, int, bool) | 分组行。 |
| [GroupRows](../../aspose.cells.griddesktop/worksheet/grouprows#grouprows_4)(int, int, int, bool, bool) | 分组行。 |
| [ImportDataTable](../../aspose.cells.griddesktop/worksheet/importdatatable)(DataTable, bool, int, int) | 将 DataTable 对象导入工作表。 |
| [InSelection](../../aspose.cells.griddesktop/worksheet/inselection)(CellLocation) | 确定指定的单元格位置是否处于选中状态。 |
...
| [RowInMerged](../../aspose.cells.griddesktop/worksheet/rowinmerged)(int) | 获取表示指定行是否合并的值。 |
| [RowInSelection](../../aspose.cells.griddesktop/worksheet/rowinselection)(int) | 确定索引处的指定行是否处于选中状态。 |
...
| [SetColumnCaption](../../aspose.cells.griddesktop/worksheet/setcolumncaption)(int, string) | 设置列的标题。请注意这是扩展属性，不能保留在 Excel 文件中 |
...
| [SetIsReadonly](../../aspose.cells.griddesktop/worksheet/setisreadonly)(int, int, bool) | 设置单元格是否为只读。这是一个扩展属性，不会保留在实际的excel文件中 |
| [SetProtect](../../aspose.cells.griddesktop/worksheet/setprotect)() | 保护工作表。 |
| [SetProtected](../../aspose.cells.griddesktop/worksheet/setprotected)(CellRange, bool) | 设置 cellRange 是否受保护。这是仅在 Grid 中使用的扩展方法。 该方法与cell.Style.CellLocked属性无关 保存到excel文件后不会生效。 |
...
| [UngroupColumns](../../aspose.cells.griddesktop/worksheet/ungroupcolumns#ungroupcolumns)(int, int) | 取消分组列。 |
| [UngroupColumns](../../aspose.cells.griddesktop/worksheet/ungroupcolumns#ungroupcolumns_1)(int, int, bool) | 取消分组列。 |
...
| [Unmerge](../../aspose.cells.griddesktop/worksheet/unmerge#unmerge_1)(CellRange) | 将指定范围的单元格合并为一个单元格。 |
...
| static [CellIndexToR1C1](../../aspose.cells.griddesktop/worksheet/cellindextor1c1)(int, int) | 根据行和列索引获取单元格 r1c1 样式名称。 |
