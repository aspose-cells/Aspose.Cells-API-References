...
description: 继承自 GridWorksheet仅在设计时使用
type: docs
weight: 820
url: /zh/net/aspose.cells.gridweb/gridworksheetdesign/
---
## GridWorksheetDesign class

继承自 GridWorksheet。仅在设计时使用。
...
| 姓名 | 描述 |
| --- | --- |
| [GridWorksheetDesign](gridworksheetdesign#constructor)() | 默认构造函数。 |
...
| [Pictures](../../aspose.cells.gridweb.data/gridworksheet/pictures) { get; } | 得到一个[`Pictures`](../../aspose.cells.gridweb.data/gridworksheet/pictures)集合. |
...
| [Shapes](../../aspose.cells.gridweb.data/gridworksheet/shapes) { get; } | 得到一个[`Pictures`](../../aspose.cells.gridweb.data/gridworksheet/pictures)集合. |
...
| [AutoFitColumn](../../aspose.cells.gridweb.data/gridworksheet/autofitcolumn)(int) | 自动调整列宽。 |
| [AutoFitColumn](../../aspose.cells.gridweb.data/gridworksheet/autofitcolumn)(int, int, int) | 自动调整列宽。 |
| [AutoFitRow](../../aspose.cells.gridweb.data/gridworksheet/autofitrow)(int) | 自动调整行高。 |
| [AutoFitRow](../../aspose.cells.gridweb.data/gridworksheet/autofitrow)(int, int, int) | 自动调整行高。 |
| [AutoFitRow](../../aspose.cells.gridweb.data/gridworksheet/autofitrow)(int, int, int, int) | 在矩形范围内自动调整行高。 |
| [AutoFitRows](../../aspose.cells.gridweb.data/gridworksheet/autofitrows)() | 自动调整此工作表中的所有行。 |
| [AutoFitRows](../../aspose.cells.gridweb.data/gridworksheet/autofitrows)(bool) | 自动调整此工作表中的所有行。 |
| [AutoFitRows](../../aspose.cells.gridweb.data/gridworksheet/autofitrows)(int, int) | 自动调整范围内的行高。 |
...
| [CreateSubtotal](../../aspose.cells.gridweb.data/gridworksheet/createsubtotal)(int, int, int, SubtotalFunction, int[]) | 在工作表中创建小计。 |
| [CreateSubtotal](../../aspose.cells.gridweb.data/gridworksheet/createsubtotal)(int, int, int, SubtotalFunction, int[], string, GridTableItemStyle, GridTableItemStyle, NumberType, string) | 在工作表中创建小计。 |
...
| [FreezePanes](../../aspose.cells.gridweb.data/gridworksheet/freezepanes)(string, int, int) | 在工作表中的指定单元格处冻结窗格。 |
| [FreezePanes](../../aspose.cells.gridweb.data/gridworksheet/freezepanes)(int, int, int, int) | 在工作表中的指定单元格处冻结窗格。 |
