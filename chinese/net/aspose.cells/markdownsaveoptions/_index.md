...
| 姓名 | 描述 |
| --- | --- |
| [MarkdownSaveOptions](markdownsaveoptions)() | 创建用于保存降价文档的选项 |
...
| [Encoding](../../aspose.cells/markdownsaveoptions/encoding) { get; set; } | 获取并设置默认编码。 |
| [FormatStrategy](../../aspose.cells/markdownsaveoptions/formatstrategy) { get; set; } | 获取和设置单元格值导出为字符串时的格式策略。 |
| [LightCellsDataProvider](../../aspose.cells/markdownsaveoptions/lightcellsdataprovider) { get; set; } | 提供单元格数据以在轻量模式下保存工作簿的数据提供程序。 |
