...
| [AutoFitColsAndRows](../../aspose.cells/htmlloadoptions/autofitcolsandrows) { get; set; } | 指示是否自动适应列和行。默认值为假。 |
...
| [LoadFormulas](../../aspose.cells/htmlloadoptions/loadformulas) { get; set; } | 表示如果原始html文件包含公式，是否导入公式 |
...
| [ProgId](../../aspose.cells/htmlloadoptions/progid) { get; } | 获取创建文件的程序 id。 仅适用于 MHT 文件。 |
...
| [SupportDivTag](../../aspose.cells/htmlloadoptions/supportdivtag) { get; set; } | 表示当html文件包含&lt;div&gt;标签时是否支持&lt;div&gt;标签的布局。默认值为假。 |
