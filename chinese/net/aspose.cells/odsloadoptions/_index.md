...
| 姓名 | 描述 |
| --- | --- |
| [OdsLoadOptions](odsloadoptions#constructor)() | 代表加载ods文件的选项。 |
| [OdsLoadOptions](odsloadoptions#constructor_1)(LoadFormat) | 代表加载ods文件的选项。 |

## 特性

| 姓名 | 描述 |
| --- | --- |
| [ApplyExcelDefaultStyleToHyperlink](../../aspose.cells/odsloadoptions/applyexceldefaultstyletohyperlink) { get; set; } | 表示是否将Excel的默认样式应用到超链接。 |
