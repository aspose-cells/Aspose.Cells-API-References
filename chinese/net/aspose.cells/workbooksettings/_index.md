...
| [AutoCompressPictures](../../aspose.cells/workbooksettings/autocompresspictures) { get; set; } | 指定一个布尔值，表示应用程序自动压缩工作簿中的图片。 |
...
| [CheckCustomNumberFormat](../../aspose.cells/workbooksettings/checkcustomnumberformat) { get; set; } | 设置Style.Custom. 时是否检查自定义数字格式 |
| [CheckExcelRestriction](../../aspose.cells/workbooksettings/checkexcelrestriction) { get; set; } | 当用户修改单元格相关对象时是否检查excel文件的限制。 例如，excel不允许输入超过32K的字符串值。 当你输入一个超过32K的值时，例如通过Cell.PutValue(string)，如果这样属性为真，您将得到一个异常。 如果此属性为假，我们将接受您输入的字符串值作为单元格的值，以便稍后 您可以为其他文件格式输出完整的字符串值，例如 CSV. 但是，如果您设置的此类值对 excel 文件格式无效， 您以后不应将工作簿另存为 excel 文件格式。否则生成的excel文件可能会出现意外错误。 |
| [Compliance](../../aspose.cells/workbooksettings/compliance) { get; set; } | 指定输出文档的 OOXML 版本。默认值为 Ecma376_2006。 |
| [CrashSave](../../aspose.cells/workbooksettings/crashsave) { get; set; } | 表示应用程序是否在崩溃后最后保存了工作簿文件。 |
...
| [IsMinimized](../../aspose.cells/workbooksettings/isminimized) { get; set; } | 表示生成的电子表格是否会最小化打开。 |
...
| [MemorySetting](../../aspose.cells/workbooksettings/memorysetting) { get; set; } | 获取或设置内存使用选项。新选项将作为新建工作表的默认选项，但对现有工作表无效。 |
...
| [NumberGroupSeparator](../../aspose.cells/workbooksettings/numbergroupseparator) { get; set; } | 获取或设置将数字组分隔到数值中小数点左侧的字符。默认是当前 Region. 的组分隔符 |
...
| [QuotePrefixToStyle](../../aspose.cells/workbooksettings/quoteprefixtostyle) { get; set; } | 表示是否设置[`QuotePrefix`](../style/quoteprefix)将字符串值（以单引号开头）输入到单元格 时的属性 |
...
| [WindowHeight](../../aspose.cells/workbooksettings/windowheight) { get; set; } | 窗口的高度，以点为单位。 |
| [WindowHeightCM](../../aspose.cells/workbooksettings/windowheightcm) { get; set; } | 窗口的高度，单位为厘米。 |
| [WindowHeightInch](../../aspose.cells/workbooksettings/windowheightinch) { get; set; } | 窗口的高度，单位为英寸。 |
| [WindowLeft](../../aspose.cells/workbooksettings/windowleft) { get; set; } | 客户区左边缘到窗口左边缘的距离，以point为单位。 |
...
| [WindowTopInch](../../aspose.cells/workbooksettings/windowtopinch) { get; set; } | 客户区上边缘到窗口上边缘的距离，单位为英寸。 |
| [WindowWidth](../../aspose.cells/workbooksettings/windowwidth) { get; set; } | 窗口的宽度，以点为单位。 |
| [WindowWidthCM](../../aspose.cells/workbooksettings/windowwidthcm) { get; set; } | 窗口的宽度，单位为厘米。 |
| [WindowWidthInch](../../aspose.cells/workbooksettings/windowwidthinch) { get; set; } | 窗口的宽度，单位为英寸。 |
