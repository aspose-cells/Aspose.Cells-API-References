...
description: 封装了单元格相关对象的集合例如Cell./cell Row./row ...等
type: docs
weight: 300
...
封装了单元格相关对象的集合，例如[`Cell`](../cell) ,[`Row`](../row) ...等
...
| 姓名 | 描述 |
| --- | --- |
| [Columns](../../aspose.cells/cells/columns) { get; } | 获取集合[`Column`](../column)表示此工作表中各个列的对象。 |
| [Count](../../aspose.cells/cells/count) { get; } | 获取实例化 Cell 对象的总数。 |
| [CountLarge](../../aspose.cells/cells/countlarge) { get; } | 获取实例化 Cell 对象的总数。 |
...
| [IsDefaultRowHidden](../../aspose.cells/cells/isdefaultrowhidden) { get; set; } | 表示该行是否默认隐藏。 |
| [Item](../../aspose.cells/cells/item) { get; } | 获取[`Cell`](../cell)指定单元格行索引和列索引处的元素。 (2 indexers) |
| [LastCell](../../aspose.cells/cells/lastcell) { get; } | 获取此工作表中的最后一个单元格。 |
| [MaxColumn](../../aspose.cells/cells/maxcolumn) { get; } | 已在集合中实例化的那些单元格的最小列索引（不包括 column 其中为整个列定义了样式但其中没有实例化单元格）。 |
...
| [MaxDisplayRange](../../aspose.cells/cells/maxdisplayrange) { get; } | 获取包含数据、合并单元格和形状的最大范围。 |
...
| [MinColumn](../../aspose.cells/cells/mincolumn) { get; } | 已在集合中实例化的那些单元格的最小列索引（不包括 column 其中为整个列定义了样式但其中没有实例化单元格）。 |
...
| [Ranges](../../aspose.cells/cells/ranges) { get; } | 获取集合[`Range`](../range)在运行时创建的对象。 |
| [Rows](../../aspose.cells/cells/rows) { get; } | 获取集合[`Row`](../row)表示此工作表中各个行的对象。 |
| [StandardHeight](../../aspose.cells/cells/standardheight) { get; set; } | 获取或设置此工作表中的默认行高，以点为单位。 |
...
| 姓名 | 描述 |
| --- | --- |
| [AddRange](../../aspose.cells/cells/addrange)(Range) | 将范围对象引用添加到单元格 |
| [ApplyColumnStyle](../../aspose.cells/cells/applycolumnstyle)(int, Style, StyleFlag) | 为整列应用格式。 |
| [ApplyRowStyle](../../aspose.cells/cells/applyrowstyle)(int, Style, StyleFlag) | 为整行应用格式。 |
| [ApplyStyle](../../aspose.cells/cells/applystyle)(Style, StyleFlag) | 为整个工作表应用格式。 |
| [CheckCell](../../aspose.cells/cells/checkcell)(int, int) | 获取[`Cell`](../cell)指定单元格行索引和列索引处的元素或空值。 |
| [CheckColumn](../../aspose.cells/cells/checkcolumn)(int) | 获取[`Column`](../column)指定列索引处的元素或空值。 |
| [CheckRow](../../aspose.cells/cells/checkrow)(int) | 获取[`Row`](../row)元素或在指定的单元格行索引处。 |
...
| [CopyColumns](../../aspose.cells/cells/copycolumns#copycolumns_2)(Cells, int, int, int, int) | 复制整个列的数据和格式。 |
...
| [CreateRange](../../aspose.cells/cells/createrange#createrange_2)(string) | 创建一个[`Range`](../range)来自范围地址的对象。 |
| [CreateRange](../../aspose.cells/cells/createrange#createrange_3)(string, string) | 创建一个[`Range`](../range)来自一系列单元格的对象。 |
| [CreateRange](../../aspose.cells/cells/createrange#createrange)(int, int, bool) | 创建一个[`Range`](../range)来自单元格行或单元格列的对象。 |
| [CreateRange](../../aspose.cells/cells/createrange#createrange_1)(int, int, int, int) | 创建一个[`Range`](../range)来自一系列单元格的对象。 |
...
| [DeleteRange](../../aspose.cells/cells/deleterange)(int, int, int, int, ShiftType) | 删除一系列单元格并根据移位选项移位单元格。 |
...
| [EndCellInRow](../../aspose.cells/cells/endcellinrow#endcellinrow)(int) | 获取此行中的最后一个单元格。 |
| [EndCellInRow](../../aspose.cells/cells/endcellinrow#endcellinrow_1)(int, int, int, int) | 获取此范围内具有最大行索引的最后一个单元格。 |
| [ExportArray](../../aspose.cells/cells/exportarray)(int, int, int, int) | 导出数据[`Cells`](../cells)集合到一个二维数组对象. |
| [ExportDataTable](../../aspose.cells/cells/exportdatatable#exportdatatable)(int, int, int, int) | 导出数据[`Cells`](../cells)收集到DataTable对象. |
| [ExportDataTable](../../aspose.cells/cells/exportdatatable#exportdatatable_2)(int, int, int, int, bool) | 导出数据[`Cells`](../cells)收集到DataTable对象. |
| [ExportDataTable](../../aspose.cells/cells/exportdatatable#exportdatatable_1)(int, int, int, int, ExportTableOptions) | 导出数据[`Cells`](../cells)收集到DataTable对象. |
| [ExportDataTableAsString](../../aspose.cells/cells/exportdatatableasstring#exportdatatableasstring)(int, int, int, int) | 导出数据[`Cells`](../cells)收集到DataTable对象. |
| [ExportDataTableAsString](../../aspose.cells/cells/exportdatatableasstring#exportdatatableasstring_1)(int, int, int, int, bool) | 导出数据[`Cells`](../cells)收集到DataTable对象. |
| [ExportTypeArray](../../aspose.cells/cells/exporttypearray)(int, int, int, int) | 导出单元格值类型[`Cells`](../cells)集合到一个二维数组对象. |
...
| [GetCell](../../aspose.cells/cells/getcell)(int, int) | 获取[`Cell`](../cell)指定单元格行索引和列索引处的元素或空值。 |
...
| [GetDependents](../../aspose.cells/cells/getdependents)(bool, int, int) | 获取所有引用特定单元格的单元格。 |
| [GetDependentsInCalculation](../../aspose.cells/cells/getdependentsincalculation)(int, int, bool) | 获取计算结果依赖于特定单元格的所有单元格。 |
...
| [GetRow](../../aspose.cells/cells/getrow)(int) | 获取[`Row`](../row)指定单元格行索引处的元素。 |
| [GetRowEnumerator](../../aspose.cells/cells/getrowenumerator)() | 获取行枚举器。 |
| [GetRowHeight](../../aspose.cells/cells/getrowheight)(int) | 获取指定行的高度。 |
| [GetRowHeightInch](../../aspose.cells/cells/getrowheightinch)(int) | 以英寸为单位获取指定行的高度。 |
| [GetRowHeightPixel](../../aspose.cells/cells/getrowheightpixel)(int) | 以像素为单位获取指定行的高度。 |
| [GetRowOriginalHeightPoint](../../aspose.cells/cells/getroworiginalheightpoint)(int) | 如果行被隐藏，则以点为单位获取原始行的高度 |
...
| [GetViewRowHeightInch](../../aspose.cells/cells/getviewrowheightinch)(int) | 以英寸为单位获取指定行的高度。 |
| [GroupColumns](../../aspose.cells/cells/groupcolumns#groupcolumns)(int, int) | 对列进行分组。 |
| [GroupColumns](../../aspose.cells/cells/groupcolumns#groupcolumns_1)(int, int, bool) | 对列进行分组。 |
| [GroupRows](../../aspose.cells/cells/grouprows#grouprows)(int, int) | 对行进行分组。 |
| [GroupRows](../../aspose.cells/cells/grouprows#grouprows_1)(int, int, bool) | 对行进行分组。 |
| [HideColumn](../../aspose.cells/cells/hidecolumn)(int) | 隐藏一列。 |
| [HideColumns](../../aspose.cells/cells/hidecolumns)(int, int) | 隐藏多个列。 |
...
| [ImportData](../../aspose.cells/cells/importdata#importdata_3)(IDataReader, int, int) | 从IDataReader对象. |
...
| [ImportData](../../aspose.cells/cells/importdata#importdata_4)(IDataReader, int, int, ImportTableOptions) | 从IDataReader对象. |
| [ImportDataGrid](../../aspose.cells/cells/importdatagrid#importdatagrid)(DataGrid, int, int, bool) | 导入一个DataGrid进入工作表. |
| [ImportDataGrid](../../aspose.cells/cells/importdatagrid#importdatagrid_1)(DataGrid, int, int, int, int, bool) | 导入一个DataGrid进入工作表. |
| [ImportDataGrid](../../aspose.cells/cells/importdatagrid#importdatagrid_2)(DataGrid, int, int, int, int, bool, bool) | 导入一个DataGrid进入工作表. |
| [ImportDataGridAsString](../../aspose.cells/cells/importdatagridasstring)(DataGrid, int, int, bool) | 导入一个DataGrid到工作表中。此方法不会尝试将文本转换为数值。 |
| [ImportDataRow](../../aspose.cells/cells/importdatarow)(DataRow, int, int) | 将 DataRow 导入 Excel 文件。 |
| [ImportDataView](../../aspose.cells/cells/importdataview#importdataview_3)(DataView, int, int) | 导入一个DataView进入工作表. |
...
| [InsertRange](../../aspose.cells/cells/insertrange#insertrange)(CellArea, ShiftType) | 插入一系列单元格并根据移位选项移位单元格。 |
| [InsertRange](../../aspose.cells/cells/insertrange#insertrange_1)(CellArea, int, ShiftType) | 插入一系列单元格并根据移位选项移位单元格。 |
| [InsertRange](../../aspose.cells/cells/insertrange#insertrange_2)(CellArea, int, ShiftType, bool) | 插入一系列单元格并根据移位选项移位单元格。 |
...
| [SetColumnWidth](../../aspose.cells/cells/setcolumnwidth)(int, double) | 在普通视图中设置指定列的宽度。 |
...
| [UngroupColumns](../../aspose.cells/cells/ungroupcolumns)(int, int) | 取消组合列。 |
...
| [UnhideColumns](../../aspose.cells/cells/unhidecolumns)(int, int, double) | 取消隐藏多个列。 |
