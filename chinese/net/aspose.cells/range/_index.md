...
| [Item](../../aspose.cells/range/item) { get; } | 获取该范围内的[`Cell`](../cell)对象。 |
...
| [Worksheet](../../aspose.cells/range/worksheet) { get; } | 获取包含此范围的[`Worksheet`](./worksheet)对象。 |
...
| [GetCellOrNull](../../aspose.cells/range/getcellornull)(int, int) | 获取[`Cell`](../cell)对象或在此范围内为 null。 |
| [GetEnumerator](../../aspose.cells/range/getenumerator)() | 获取此 Range 中单元格的枚举器。 |
| [GetOffset](../../aspose.cells/range/getoffset)(int, int) | 通过偏移量获取[`Range`](../range)范围。 |
| [Intersect](../../aspose.cells/range/intersect)(Range) | 返回一个[`Range`](../range)对象，表示两个范围的矩形交集。 |
...
| [PutValue](../../aspose.cells/range/putvalue)(string, bool, bool) | 将一个值放入范围，如果合适，该值将转换为其他数据类型，并且单元格的数字格式将被重置。 |
| [SetInsideBorders](../../aspose.cells/range/setinsideborders)(BorderType, CellBorderType, CellsColor) | 设置范围的内部边界。 |
| [SetOutlineBorder](../../aspose.cells/range/setoutlineborder)(BorderType, CellBorderType, Color) | 围绕一系列单元格设置轮廓边框。 |
| [SetOutlineBorders](../../aspose.cells/range/setoutlineborders#setoutlineborders)(CellBorderType, Color) | 围绕具有相同边框样式和颜色的单元格范围设置轮廓边框。 |
| [SetOutlineBorders](../../aspose.cells/range/setoutlineborders#setoutlineborders_1)(CellBorderType[], Color[]) | 在一系列单元格周围设置线条边界。 |
| [SetStyle](../../aspose.cells/range/setstyle)(Style) | 设置范围的样式。 |
| override [ToString](../../aspose.cells/range/tostring)() | 返回代表当前 Range 对象的字符串。 |
