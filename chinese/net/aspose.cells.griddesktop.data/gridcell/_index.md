...
| [Formula](../../aspose.cells.griddesktop.data/gridcell/formula) { get; set; } | 获取或设置Cell的公式。 |
...
| [Protected](../../aspose.cells.griddesktop.data/gridcell/protected) { get; set; } | 指示单元格是否受保护。 如果值为“true”，则用户无法通过用户界面修改单元格。 该属性与 Style.CellLocked 属性 无关，并且在导出网格数据时不会保存到文件中。 默认值为“假”。 |
...
| 姓名 | 描述 |
| --- | --- |
| [ContainsExternalLink](../../aspose.cells.griddesktop.data/gridcell/containsexternallink)() | 表示此单元格是否包含外部链接。 仅当单元格是公式单元格时适用。 |
| [Copy](../../aspose.cells.griddesktop.data/gridcell/copy)(GridCell) | 从源单元格复制数据。 |
| [CopyStyle](../../aspose.cells.griddesktop.data/gridcell/copystyle)(Style) | 复制样式并设置单元格的样式 |
...
| [GetFont](../../aspose.cells.griddesktop.data/gridcell/getfont)() | 获取单元格字体。 更改字体时，应调用“SetFont”方法， 将字体设置为单元格。 |
| [GetFontColor](../../aspose.cells.griddesktop.data/gridcell/getfontcolor)() | 获取单元格字体颜色。 更改颜色时，应调用“SetFontColor”方法， 设置单元格的字体颜色。 |
| override [GetHashCode](../../aspose.cells.griddesktop.data/gridcell/gethashcode)() |  |
| [GetStyle](../../aspose.cells.griddesktop.data/gridcell/getstyle)() | 获取单元格样式。 更改样式时，应调用“SetStyle”方法， 将样式设置为单元格。 |
| [GetValidation](../../aspose.cells.griddesktop.data/gridcell/getvalidation)() | 获取应用于此单元格的验证。如果未设置，则返回 null。 |
| [GetWidthOfValue](../../aspose.cells.griddesktop.data/gridcell/getwidthofvalue)() | 获取值的宽度，以像素为单位。 |
...
| [PutValue](../../aspose.cells.griddesktop.data/gridcell/putvalue#putvalue_1)(double) | 将双精度值放入单元格。 |
| [PutValue](../../aspose.cells.griddesktop.data/gridcell/putvalue#putvalue_2)(int) | 将一个 int 值放入单元格中。 |
| [PutValue](../../aspose.cells.griddesktop.data/gridcell/putvalue#putvalue_4)(object) | 将对象值放入单元格。与 setValue(Object param_object) |
| [PutValue](../../aspose.cells.griddesktop.data/gridcell/putvalue#putvalue_5)(string) | 将字符串值放入单元格中。 |
| [PutValue](../../aspose.cells.griddesktop.data/gridcell/putvalue#putvalue_6)(string, bool) | 将字符串值放入单元格并在适当时将该值转换为其他数据类型。 |
...
| [SetCustom](../../aspose.cells.griddesktop.data/gridcell/setcustom)(string) | 设置自定义格式，null或空字符串表示没有自定义格式。 |
| [SetFont](../../aspose.cells.griddesktop.data/gridcell/setfont)(Font) | 将字体设置为单元格。 为了提高性能，实现“SetFont”方法， 不实现“Font”属性。 |
| [SetFontColor](../../aspose.cells.griddesktop.data/gridcell/setfontcolor)(Color) | 将字体颜色设置为单元格。 为提高性能，实现“SetFontColor”方法， 不实现“FontColor”属性。 |
...
| [SetStyle](../../aspose.cells.griddesktop.data/gridcell/setstyle)(Style) | 将样式设置为单元格。 为了提高性能，实现“SetStyle”方法， 不实现“Style”属性。 |
