...
| [Item](../../aspose.cells.tables/tablestyleelementcollection/item) { get; } | 通过索引获取表格样式的一个元素。 (2 indexers) |
...
| 姓名 | 描述 |
| --- | --- |
| [Add](../../aspose.cells.tables/tablestyleelementcollection/add)(TableStyleElementType) | 添加一个元素。 |
