...
| [Item](../../aspose.cells.properties/custompropertycollection/item) { get; } | 通过特定索引获取自定义属性。 (2 indexers) |
...
| 姓名 | 描述 |
| --- | --- |
| [Add](../../aspose.cells.properties/custompropertycollection/add)(string, string) | 添加自定义属性信息。 |
