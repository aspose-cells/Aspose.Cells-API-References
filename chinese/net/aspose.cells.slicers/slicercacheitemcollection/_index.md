...
| [Count](../../aspose.cells.slicers/slicercacheitemcollection/count) { get; } | 获取 SlicerCacheItem 的计数。 |
| [Item](../../aspose.cells.slicers/slicercacheitemcollection/item) { get; } | 通过索引获取 SlicerCacheItem 对象。 |
