...
| 姓名 | 描述 |
| --- | --- |
| [AutoShowCount](../../aspose.cells.pivot/pivotfield/autoshowcount) { get; set; } | 表示自动显示在指定数据透视表字段中的顶部或底部项目的数量 。 |
...
| [BaseIndex](../../aspose.cells.pivot/pivotfield/baseindex) { get; set; } | 表示基础数据透视字段中的数据透视字段索引。 |
| [BaseItemIndex](../../aspose.cells.pivot/pivotfield/baseitemindex) { get; set; } | 表示自定义计算的基本字段中的项目。 仅对数据字段有效。 |
| [BaseItemPosition](../../aspose.cells.pivot/pivotfield/baseitemposition) { get; set; } | 表示自定义计算的基本字段中的项目。 仅对数据字段有效。 因为 PivotItemPosition.Custom 是只读的，如果需要设置 PivotItemPosition.Custom, 请设置 PivotField.BaseItemIndex 属性。 |
| [CurrentPageItem](../../aspose.cells.pivot/pivotfield/currentpageitem) { get; set; } | 表示页面字段显示的当前页面项目（仅对页面字段有效）。 |
| [DataDisplayFormat](../../aspose.cells.pivot/pivotfield/datadisplayformat) { get; set; } | 表示如何显示数据字段中包含的值。 |
| [DisplayName](../../aspose.cells.pivot/pivotfield/displayname) { get; set; } | 表示数据透视字段显示名称。 |
| [DragToColumn](../../aspose.cells.pivot/pivotfield/dragtocolumn) { get; set; } | 表示指定字段是否可以拖到列位置。 默认值为真。 |
| [DragToData](../../aspose.cells.pivot/pivotfield/dragtodata) { get; set; } | 表示指定字段是否可以拖到数据位置。 默认值为真。 |
| [DragToHide](../../aspose.cells.pivot/pivotfield/dragtohide) { get; set; } | 表示指定字段是否可以拖到隐藏位置。 默认值为真。 |
| [DragToPage](../../aspose.cells.pivot/pivotfield/dragtopage) { get; set; } | 表示指定字段是否可以拖到页面位置。 默认值为真。 |
| [DragToRow](../../aspose.cells.pivot/pivotfield/dragtorow) { get; set; } | 表示指定字段是否可以拖到行位置。 默认值为真。 |
...
| [IsAutoSubtotals](../../aspose.cells.pivot/pivotfield/isautosubtotals) { get; set; } | 表示指定字段是否显示自动小计。默认为真。 |
...
| [IsInsertPageBreaksBetweenItems](../../aspose.cells.pivot/pivotfield/isinsertpagebreaksbetweenitems) { get; set; } | 表示字段是否可以在项目之间插入分页符 在每个项目之后插入分页符 默认值为false . |
| [IsMultipleItemSelectionAllowed](../../aspose.cells.pivot/pivotfield/ismultipleitemselectionallowed) { get; set; } | 表示该字段是否可以有多个项目 在页面字段中被选中 默认值为false。 |
| [IsRepeatItemLabels](../../aspose.cells.pivot/pivotfield/isrepeatitemlabels) { get; set; } | 表示字段是否可以重复项标签 默认值为false。 |
| [ItemCount](../../aspose.cells.pivot/pivotfield/itemcount) { get; } | 获取此数据透视字段的基本项目计数。 |
...
| [PivotItems](../../aspose.cells.pivot/pivotfield/pivotitems) { get; } | 获取pivot字段的pivot项 |
| [Position](../../aspose.cells.pivot/pivotfield/position) { get; } | 表示 PivotFields 中的 PivotField 索引。 |
| [Range](../../aspose.cells.pivot/pivotfield/range) { get; } | 获取数据透视字段的组范围 |
| [ShowAllItems](../../aspose.cells.pivot/pivotfield/showallitems) { get; set; } | 表示是否显示数据透视表中的所有项目， 即使它们不包含汇总数据。 显示没有数据的项目 默认值为 false。 |
| [ShowCompact](../../aspose.cells.pivot/pivotfield/showcompact) { get; set; } | 指示是否在数据透视表视图的同一列中显示来自下一个字段的标签 |
...
| [GetPivotFilterByType](../../aspose.cells.pivot/pivotfield/getpivotfilterbytype)(PivotFilterType) | 通过类型::47:: |
| [GetPivotFilters](../../aspose.cells.pivot/pivotfield/getpivotfilters)() | 获取枢轴字段的枢轴过滤器 |
| [GetSubtotals](../../aspose.cells.pivot/pivotfield/getsubtotals)(PivotFieldSubtotalType) | 获取指定字段是否显示小计。 |
| [HideDetail](../../aspose.cells.pivot/pivotfield/hidedetail)(bool) | 设置pivot字段中的PivotItems是否为隐藏细节。即折叠/展开该字段。 |
...
| [HideItemDetail](../../aspose.cells.pivot/pivotfield/hideitemdetail)(int, bool) | 设置透视字段中的特定 PivotItem 是否为隐藏细节。 |
