...
| [BeginArrowheadWidth](../../aspose.cells.drawing/lineformat/beginarrowheadwidth) { get; set; } | 获取和设置行的开始箭头宽度类型。 |
...
| [EndArrowheadLength](../../aspose.cells.drawing/lineformat/endarrowheadlength) { get; set; } | 获取和设置行的结束箭头长度类型。 |
| [EndArrowheadStyle](../../aspose.cells.drawing/lineformat/endarrowheadstyle) { get; set; } | 获取和设置行的结束箭头类型。 |
| [EndArrowheadWidth](../../aspose.cells.drawing/lineformat/endarrowheadwidth) { get; set; } | 获取和设置行的结束箭头宽度类型。 |
...
| 姓名 | 描述 |
| --- | --- |
| override [Equals](../../aspose.cells.drawing/lineformat/equals)(object) | 确定此实例是否与另一个指定的[`LineFormat`](../lineformat)对象具有相同的值。 |
