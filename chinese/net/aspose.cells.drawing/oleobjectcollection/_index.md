...
description: 表示嵌入的 OLE 对象
type: docs
weight: 2440
url: /zh/net/aspose.cells.drawing/oleobjectcollection/
---
...
| 姓名 | 描述 |
| --- | --- |
| [Add](../../aspose.cells.drawing/oleobjectcollection/add#add)(int, int, int, int, byte[]) | 将 OleObject 添加到集合中。 |
| [Add](../../aspose.cells.drawing/oleobjectcollection/add#add_1)(int, int, int, int, byte[], string) | 将链接的 OleObject 添加到集合中。 |
...
| [Clear](../../aspose.cells.drawing/oleobjectcollection/clear#clear)() | 删除所有嵌入的 OLE 对象。 (2 methods) |
...
| [RemoveAt](../../aspose.cells.drawing/oleobjectcollection/removeat#removeat)(int) | 删除指定索引处的元素。 (2 methods) |
