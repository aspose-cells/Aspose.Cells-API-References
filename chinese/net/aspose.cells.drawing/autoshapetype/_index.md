...
description: 表示所有内置的自动形状类型
type: docs
weight: 1770
url: /zh/net/aspose.cells.drawing/autoshapetype/
---
...
| HorizontalScroll | `98` |  |
| CircularArrow | `99` |  |
| NotchedCircularArrow | `100` | 不应使用的值。 |
| UTurnArrow | `101` |  |
...
| TextWave1 | `156` | 波浪形文本形状。 |
| TextWave2 | `157` | 波浪形文本形状。 |
| TextWave3 | `158` | 波浪形文本形状。 |
| TextWave4 | `159` | 波浪形文本形状。 |
...
| Sun | `183` |  |
| Moon | `184` |  |
| DoubleBracket | `185` | 括在括号中的形状。 |
| DoubleBrace | `186` | 用大括号括起来的形状。 |
| Star4 | `187` |  |
| DoubleWave | `188` |  |
