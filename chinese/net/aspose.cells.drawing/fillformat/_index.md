...
| [GradientColor2](../../aspose.cells.drawing/fillformat/gradientcolor2) { get; } | 返回指定填充的渐变色 2。 |
...
| [GradientVariant](../../aspose.cells.drawing/fillformat/gradientvariant) { get; } | 返回指定填充的渐变变体。 仅适用于 Excel 2007。 |
...
| [Transparency](../../aspose.cells.drawing/fillformat/transparency) { get; set; } | 以从 0.0（不透明）到 1.0（透明）的值返回或设置区域的透明度。 |
