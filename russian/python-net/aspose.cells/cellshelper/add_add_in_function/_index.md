...
type: docs
weight: 20
url: /ru/python-net/aspose.cells/cellshelper/add_add_in_function/
is_root: false
---
...
| max_count_of_parameters | int | Максимальное количество параметров, которое позволяет эта функция.|
