...
type: docs
weight: 50
url: /ru/python-net/aspose.cells/paginatedsaveoptions/check_font_compatibility/
is_root: false
---
...
В таких ситуациях пользователь должен оставить это свойство равным true, чтобы
