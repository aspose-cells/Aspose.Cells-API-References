...
type: docs
weight: 1200
url: /ru/python-net/aspose.cells/protectedrange/
is_root: false
---
##  ProtectedRange класс
Указанный диапазон, разрешенный для редактирования, когда защита листа включена.



Тип ProtectedRange предоставляет следующие члены:

###  Характеристики
| Свойство| Описание|
| :- | :- |
| [name](/cells/ru/python-net/aspose.cells/protectedrange/name) | Получает титул Range.|
...
| Метод| Описание|
| :- | :- |
| [get_areas()](/cells/ru/python-net/aspose.cells/protectedrange/get_areas/#) | Получает все указанные области.|
| [add_area(start_row, start_column, end_row, end_column)](/cells/ru/python-net/aspose.cells/protectedrange/add_area/#int-int-int-int) | Добавляет указанную область к этому|
