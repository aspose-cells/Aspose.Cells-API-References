...
type: docs
weight: 50
url: /ru/python-net/aspose.cells/filtercolumncollection/index_of/
is_root: false
---
...
| :- | :- | :- |
| item | [FilterColumn](/cells/ru/python-net/aspose.cells/filtercolumn) | Объект, который нужно найти в списке массивов. Значение может быть нулевым.|
