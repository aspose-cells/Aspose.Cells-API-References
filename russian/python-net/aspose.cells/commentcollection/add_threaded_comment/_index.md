...
type: docs
weight: 30
url: /ru/python-net/aspose.cells/commentcollection/add_threaded_comment/
is_root: false
---
...
[ThreadedComment](/cells/ru/python-net/aspose.cells/threadedcomment) индекс объекта.
...
| author | [ThreadedCommentAuthor](/cells/ru/python-net/aspose.cells/threadedcommentauthor) | Пользователь этого ветки комментария.|
...
* класс [ThreadedComment](/cells/ru/python-net/aspose.cells/threadedcomment)
