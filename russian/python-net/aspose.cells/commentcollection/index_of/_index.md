...
type: docs
weight: 70
url: /ru/python-net/aspose.cells/commentcollection/index_of/
is_root: false
---
...
| :- | :- | :- |
| item | [Comment](/cells/ru/python-net/aspose.cells/comment) | Объект, который нужно найти в списке массивов. Значение может быть нулевым.|
