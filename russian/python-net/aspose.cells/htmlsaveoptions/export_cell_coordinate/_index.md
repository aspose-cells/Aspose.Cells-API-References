...
type: docs
weight: 170
url: /ru/python-net/aspose.cells/htmlsaveoptions/export_cell_coordinate/
is_root: false
---
##  export_cell_coordinate недвижимость

Указывает, экспортируются ли координаты excel непустых ячеек при сохранении файла в html.
