...
type: docs
weight: 130
url: /ru/python-net/aspose.cells/calculationoptions/
is_root: false
---
...
Тип CalculationOptions предоставляет следующие члены:

###  Конструкторы
| Конструктор| Описание|
| :- | :- |
| [CalculationOptions()](/cells/ru/python-net/aspose.cells/calculationoptions/__init__/#) | Создает новый экземпляр CalculationOptions|
