...
type: docs
weight: 1170
url: /ru/python-net/aspose.cells/pasteoptions/
is_root: false
---
##  PasteOptions класс
...
Тип PasteOptions предоставляет следующие члены:

###  Конструкторы
| Конструктор| Описание|
| :- | :- |
| [PasteOptions()](/cells/ru/python-net/aspose.cells/pasteoptions/__init__/#) | Создает новый экземпляр PasteOptions|
