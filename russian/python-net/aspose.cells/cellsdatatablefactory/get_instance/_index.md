...
type: docs
weight: 20
url: /ru/python-net/aspose.cells/cellsdatatablefactory/get_instance/
is_root: false
---
...
| column_names | list | Имена столбцов таблицы.<br/>Его длина может быть только либо 1 (построить таблицу по двойным значениям по вертикали)<br/> или длина двойных значений (построить таблицу по двойным значениям по горизонтали)|
...
| :- | :- | :- |
| vals | list | двойные значения для построения таблицы|
| vertial | bool | строить ли таблицу по двойным значениям по вертикали (истина) или по горизонтали (ложь)|
...
| column_names | list | Имена столбцов таблицы.<br/>Его длина может быть только 1 (построить таблицу по объектам по вертикали)<br/> или длина объектов (строить таблицу по объектам по горизонтали)|
...
###  Смотрите также
* модуль [aspose.cells](../../)
* класс [CellsDataTableFactory](/cells/ru/python-net/aspose.cells/cellsdatatablefactory)
