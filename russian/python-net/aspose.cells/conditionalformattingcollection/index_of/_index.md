...
type: docs
weight: 50
url: /ru/python-net/aspose.cells/conditionalformattingcollection/index_of/
is_root: false
---
...
| :- | :- | :- |
| item | [FormatConditionCollection](/cells/ru/python-net/aspose.cells/formatconditioncollection) | Объект, который нужно найти в списке массивов. Значение может быть нулевым.|
