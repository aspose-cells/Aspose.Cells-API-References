...
type: docs
weight: 1140
url: /ru/python-net/aspose.cells/pagesetup/
is_root: false
---
##  PageSetup класс
 Инкапсулирует объект, представляющий описание настройки страницы.
Объект PageSetup содержит все параметры настройки страницы.
...
| [top_margin](/cells/ru/python-net/aspose.cells/pagesetup/top_margin) | Представляет размер верхнего поля в сантиметрах.|
| [top_margin_inch](/cells/ru/python-net/aspose.cells/pagesetup/top_margin_inch) | Представляет размер верхнего поля в дюймах.|
| [bottom_margin](/cells/ru/python-net/aspose.cells/pagesetup/bottom_margin) | Представляет размер нижнего поля в сантиметрах.|
| [bottom_margin_inch](/cells/ru/python-net/aspose.cells/pagesetup/bottom_margin_inch) | Представляет размер нижнего поля в дюймах.|
| [first_page_number](/cells/ru/python-net/aspose.cells/pagesetup/first_page_number) | Представляет номер первой страницы, которая будет использоваться при печати этого листа.|
...
| [paper_height](/cells/ru/python-net/aspose.cells/pagesetup/paper_height) | Получает высоту бумаги в дюймах с учетом ориентации страницы.|
| [orientation](/cells/ru/python-net/aspose.cells/pagesetup/orientation) | Представляет ориентацию печати страницы.|
| [print_comments](/cells/ru/python-net/aspose.cells/pagesetup/print_comments) | Представляет способ печати комментариев на листе.|
...
| Метод| Описание|
| :- | :- |
| [get_picture(is_header, section)](/cells/ru/python-net/aspose.cells/pagesetup/get_picture/#bool-int) | Получает объект [Picture](/cells/ru/python-net/aspose.cells.drawing/picture) верхнего/нижнего колонтитула.|
| [get_picture(is_first, is_even, is_header, section)](/cells/ru/python-net/aspose.cells/pagesetup/get_picture/#bool-bool-bool-int) | Получает объект [Picture](/cells/ru/python-net/aspose.cells.drawing/picture) верхнего/нижнего колонтитула.|
| [copy(source, copy_options)](/cells/ru/python-net/aspose.cells/pagesetup/copy/#PageSetup-CopyOptions) | Копирует настройку настройки страницы.|
