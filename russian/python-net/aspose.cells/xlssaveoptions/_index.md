...
| :- | :- |
| [XlsSaveOptions()](/cells/ru/python-net/aspose.cells/xlssaveoptions/__init__/#) | Создает параметры для сохранения файла Excel 97-2003 xls/xlt.|
| [XlsSaveOptions(format)](/cells/ru/python-net/aspose.cells/xlssaveoptions/__init__/#SaveFormat) | Создает параметры для сохранения файла Excel 97-2003 xls/xlt.|
