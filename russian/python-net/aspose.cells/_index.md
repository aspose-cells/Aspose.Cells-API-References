...
type: docs
weight: 10
url: /ru/python-net/aspose.cells/
is_root: false
---
**Aspose.Cells** namespace предоставляет фундаментальные и базовые классы для создания, преобразования, изменения, рендеринга и печати электронных таблиц без использования Microsoft Excel.
Например, класс [Workbook](/cells/ru/python-net/aspose.cells/workbook) является основной записью для создания или загрузки, а затем управления файлом электронной таблицы.
Класс [Cells](/cells/ru/python-net/aspose.cells/cells) — это основной класс для управления всеми данными и свойствами на листе и т. д.
...
| [Border](/cells/ru/python-net/aspose.cells/border) | Инкапсулирует объект, представляющий границу ячейки.|
| [BorderCollection](/cells/ru/python-net/aspose.cells/bordercollection) | Инкапсулирует коллекцию из [Border](/cells/ru/python-net/aspose.cells/border) объектов.|
| [CalculationCell](/cells/ru/python-net/aspose.cells/calculationcell) | Представляет релевантные для расчета данные об одной вычисляемой ячейке.|
...
| [CellsColor](/cells/ru/python-net/aspose.cells/cellscolor) | Представляет все типы цвета.|
| [CellsDataTableFactory](/cells/ru/python-net/aspose.cells/cellsdatatablefactory) |Утилита для создания ICellsDataTable из пользовательских объектов для удобства пользователя.|
| [CellsException](/cells/ru/python-net/aspose.cells/cellsexception) | Исключение, которое выдается при возникновении указанной ошибки Aspose.Cells.|
| [CellsFactory](/cells/ru/python-net/aspose.cells/cellsfactory) | Утилита для создания экземпляров классов модели Cells.|
| [CellsHelper](/cells/ru/python-net/aspose.cells/cellshelper) | Предоставляет вспомогательные функции.|
...
| [ConditionalFormattingIcon](/cells/ru/python-net/aspose.cells/conditionalformattingicon) | Представляет настраиваемый значок правила условного форматирования.|
...
| [ExternalLinkCollection](/cells/ru/python-net/aspose.cells/externallinkcollection) | Представляет коллекцию внешних ссылок в книге.|
...
| [FontConfigs](/cells/ru/python-net/aspose.cells/fontconfigs) | Задает настройки шрифта|
| [FontSetting](/cells/ru/python-net/aspose.cells/fontsetting) |Представляет диапазон символов в тексте ячейки.|
| [FontSourceBase](/cells/ru/python-net/aspose.cells/fontsourcebase) | Это абстрактный базовый класс для классов, которые позволяют пользователю указывать различные источники шрифтов.|
...
| [IStreamProvider](/cells/ru/python-net/aspose.cells/istreamprovider) | Представляет поставщика экспортированного потока.|
| [IWarningCallback](/cells/ru/python-net/aspose.cells/iwarningcallback) | Интерфейс обратного вызова предупреждения.|
| [IconFilter](/cells/ru/python-net/aspose.cells/iconfilter) | Представляет фильтр значков.|
| [IconSet](/cells/ru/python-net/aspose.cells/iconset) | Описать правило условного форматирования IconSet.<br/>Это правило условного форматирования применяет значки к ячейкам.<br/> в соответствии с их значениями.|
| [ImageSaveOptions](/cells/ru/python-net/aspose.cells/imagesaveoptions) | Представляет параметры сохранения изображения.<br/> Для расширенного использования используйте [WorkbookRender](/cells/ru/python-net/aspose.cells.rendering/workbookrender) или [SheetRender](/cells/ru/python-net/aspose.cells.rendering/sheetrender).|
...
| [LightCellsDataHandler](/cells/ru/python-net/aspose.cells/lightcellsdatahandler) | Представляет обработчик данных ячеек для чтения больших файлов электронных таблиц в облегченном режиме.|
| [LightCellsDataProvider](/cells/ru/python-net/aspose.cells/lightcellsdataprovider) | Представляет поставщика данных для сохранения больших файлов электронных таблиц в облегченном режиме.|
| [LoadFilter](/cells/ru/python-net/aspose.cells/loadfilter) | Представляет фильтр, предоставляющий параметры для загрузки данных при загрузке книги из шаблона.|
...
| [Protection](/cells/ru/python-net/aspose.cells/protection) | Представляет различные типы параметров защиты, доступные для рабочего листа.|
| [QueryTable](/cells/ru/python-net/aspose.cells/querytable) | Представляет информацию QueryTable.|
| [QueryTableCollection](/cells/ru/python-net/aspose.cells/querytablecollection) | Коллекция из [QueryTableCollection](/cells/ru/python-net/aspose.cells/querytablecollection) объектов, представляющих сведения о коллекции QueryTable.|
| [Range](/cells/ru/python-net/aspose.cells/range) | Инкапсулирует объект, представляющий диапазон ячеек в электронной таблице.|
| [RangeCollection](/cells/ru/python-net/aspose.cells/rangecollection) | Инкапсулирует коллекцию из [Range](/cells/ru/python-net/aspose.cells/range) объектов.|
| [ReferredArea](/cells/ru/python-net/aspose.cells/referredarea) | Представляет упомянутую область по формуле.|
| [ReferredAreaCollection](/cells/ru/python-net/aspose.cells/referredareacollection) | Представляет все упомянутые ячейки и области.|
| [ReplaceOptions](/cells/ru/python-net/aspose.cells/replaceoptions) | Представляют варианты замены.|
| [Row](/cells/ru/python-net/aspose.cells/row) | Представляет одну строку на листе.|
| [RowCollection](/cells/ru/python-net/aspose.cells/rowcollection) | Собирает объекты [Row](/cells/ru/python-net/aspose.cells/row), представляющие отдельные строки на листе.|
| [SaveOptions](/cells/ru/python-net/aspose.cells/saveoptions) | Представляет все варианты сохранения|
| [Scenario](/cells/ru/python-net/aspose.cells/scenario) | Представляет индивидуальный сценарий.|
...
| [Workbook](/cells/ru/python-net/aspose.cells/workbook) | Представляет корневой объект для создания электронной таблицы Excel.|
| [WorkbookDesigner](/cells/ru/python-net/aspose.cells/workbookdesigner) | Инкапсулирует объект, представляющий электронную таблицу конструктора.|
| [WorkbookSettings](/cells/ru/python-net/aspose.cells/workbooksettings) | Представляет все параметры рабочей книги.|
| [Worksheet](/cells/ru/python-net/aspose.cells/worksheet) | Инкапсулирует объект, представляющий один рабочий лист.|
...
| [XmlMap](/cells/ru/python-net/aspose.cells/xmlmap) | Представляет информацию карты XML.|
| [XmlMapCollection](/cells/ru/python-net/aspose.cells/xmlmapcollection) | Коллекция из [XmlMap](/cells/ru/python-net/aspose.cells/xmlmap) объектов, представляющих информацию XmlMap.|
| [XmlSaveOptions](/cells/ru/python-net/aspose.cells/xmlsaveoptions) | Представляет параметры сохранения книги в виде XML-файла.|
| [XpsSaveOptions](/cells/ru/python-net/aspose.cells/xpssaveoptions) | Представляет дополнительные параметры при сохранении файла как XPS.|
...
| [DataBarAxisPosition](/cells/ru/python-net/aspose.cells/databaraxisposition) |Задает положение оси для диапазона ячеек с условным форматированием в виде гистограмм.|
| [DataBarBorderType](/cells/ru/python-net/aspose.cells/databarbordertype) | Указывает тип границы гистограммы.|
| [DataBarFillType](/cells/ru/python-net/aspose.cells/databarfilltype) | Указывает, как панель данных заполняется цветом.|
| [DataBarNegativeColorType](/cells/ru/python-net/aspose.cells/databarnegativecolortype) | Указывает, следует ли использовать ту же границу и цвет заливки, что и положительные гистограммы.|
| [DateTimeGroupingType](/cells/ru/python-net/aspose.cells/datetimegroupingtype) | Указывает, как группировать значения dateTime.|
| [DefaultEditLanguage](/cells/ru/python-net/aspose.cells/defaulteditlanguage) | Представляет язык редактирования по умолчанию.|
| [DirectoryType](/cells/ru/python-net/aspose.cells/directorytype) | Представляет тип каталога имени файла.|
| [DisplayDrawingObjects](/cells/ru/python-net/aspose.cells/displaydrawingobjects) | Указывает, следует ли и как отображать объекты в книге.|
| [DynamicFilterType](/cells/ru/python-net/aspose.cells/dynamicfiltertype) | Тип динамического фильтра.|
| [EmfRenderSetting](/cells/ru/python-net/aspose.cells/emfrendersetting) | Настройка для рендеринга метафайла EMF.|
| [EncryptionType](/cells/ru/python-net/aspose.cells/encryptiontype) | Тип шифрования.<br/>Используется только excel2003.<br/> Мы будем шифровать книгу 2007/2010 с помощью SHA AES так же, как это делает Excel, и этот EncryptionType будет игнорироваться.|
| [ErrorCheckType](/cells/ru/python-net/aspose.cells/errorchecktype) | Представляет все типы проверки ошибок.|
| [ExceptionType](/cells/ru/python-net/aspose.cells/exceptiontype) | Представляет код пользовательского типа исключения.|
| [ExternalLinkType](/cells/ru/python-net/aspose.cells/externallinktype) | Представляет тип внешней ссылки.|
| [FileFormatType](/cells/ru/python-net/aspose.cells/fileformattype) | Представляет типы форматов файлов.|
| [FilterOperatorType](/cells/ru/python-net/aspose.cells/filteroperatortype) | Пользовательский тип оператора фильтра.|
| [FilterType](/cells/ru/python-net/aspose.cells/filtertype) | Тип фильтра.|
| [FontSchemeType](/cells/ru/python-net/aspose.cells/fontschemetype) | Представляет тип схемы шрифта.|
| [FontSourceType](/cells/ru/python-net/aspose.cells/fontsourcetype) | Указывает тип источника шрифта.|
...
| [HtmlLinkTargetType](/cells/ru/python-net/aspose.cells/htmllinktargettype) | Представляет тип целевого атрибута в теге HTML []().|
| [IconSetType](/cells/ru/python-net/aspose.cells/iconsettype) | Тип набора значков для условного форматирования.<br/>Пороговые значения для срабатывания различных значков в наборе:<br/> настраивается, а порядок значков можно изменить.|
| [LoadDataFilterOptions](/cells/ru/python-net/aspose.cells/loaddatafilteroptions) | Представляет параметры фильтрации данных при загрузке книги из шаблона.|
| [LoadFormat](/cells/ru/python-net/aspose.cells/loadformat) | Представляет формат файла загрузки.|
| [LookAtType](/cells/ru/python-net/aspose.cells/lookattype) | Представляет вид на тип.|
| [LookInType](/cells/ru/python-net/aspose.cells/lookintype) | Представляет вид в типе.|
| [MemorySetting](/cells/ru/python-net/aspose.cells/memorysetting) | Варианты использования памяти.|
| [NameScopeType](/cells/ru/python-net/aspose.cells/namescopetype) | Представляет тип области определенных имен.|
| [NumberCategoryType](/cells/ru/python-net/aspose.cells/numbercategorytype) | Представляет тип категории числового форматирования ячейки.|
| [OoxmlCompliance](/cells/ru/python-net/aspose.cells/ooxmlcompliance) |Позволяет указать, какая спецификация OOXML будет использоваться при сохранении в формате Xlsx.|
| [OoxmlCompressionType](/cells/ru/python-net/aspose.cells/ooxmlcompressiontype) | Тип сжатия Ooxml|
| [OperatorType](/cells/ru/python-net/aspose.cells/operatortype) | Представляет тип оператора условного формата и проверки данных.|
| [PageLayoutAlignmentType](/cells/ru/python-net/aspose.cells/pagelayoutalignmenttype) | Перечисляет типы выравнивания макета страницы.|
| [PageOrientationType](/cells/ru/python-net/aspose.cells/pageorientationtype) | Представляет константы ориентации печати.|
| [PaneStateType](/cells/ru/python-net/aspose.cells/panestatetype) | Представляет состояние панели листа.|
| [PaperSizeType](/cells/ru/python-net/aspose.cells/papersizetype) | Представляет константы размера бумаги.|
| [ParameterType](/cells/ru/python-net/aspose.cells/parametertype) | Представляет тип всех параметров или тип возвращаемого значения функции.|
...
| [ProtectionType](/cells/ru/python-net/aspose.cells/protectiontype) | Представляет тип защиты книги/листа.|
| [RenameStrategy](/cells/ru/python-net/aspose.cells/renamestrategy) | Опция стратегии для повторяющихся имен столбцов.|
| [ResourceLoadingType](/cells/ru/python-net/aspose.cells/resourceloadingtype) | Представляет, как загрузить связанный ресурс.|
| [SaveFormat](/cells/ru/python-net/aspose.cells/saveformat) | Представляет формат, в котором сохранена книга.|
| [SheetType](/cells/ru/python-net/aspose.cells/sheettype) | Задает тип рабочего листа.|
| [ShiftType](/cells/ru/python-net/aspose.cells/shifttype) |Представляют параметры сдвига при удалении диапазона ячеек.|
| [SortOnType](/cells/ru/python-net/aspose.cells/sortontype) | Тип отсортированного значения.|
| [SortOrder](/cells/ru/python-net/aspose.cells/sortorder) | Представляет порядок сортировки для диапазона данных.|
| [StyleModifyFlag](/cells/ru/python-net/aspose.cells/stylemodifyflag) | Стиль модифицированных флагов.|
| [TargetModeType](/cells/ru/python-net/aspose.cells/targetmodetype) | Представляет тип целевого режима.|
| [TextAlignmentType](/cells/ru/python-net/aspose.cells/textalignmenttype) | Перечисляет типы выравнивания текста.|
| [TextCapsType](/cells/ru/python-net/aspose.cells/textcapstype) | Этот тип определяет типы прописных букв текста.|
| [TextCrossType](/cells/ru/python-net/aspose.cells/textcrosstype) | Перечисляет отображаемый тип текста, когда ширина текста больше ширины ячейки.|
| [TextDirectionType](/cells/ru/python-net/aspose.cells/textdirectiontype) | Представляет направление потока текста для этого абзаца.|
| [TextOrientationType](/cells/ru/python-net/aspose.cells/textorientationtype) | Перечисляет типы ориентации текста.|
| [TextStrikeType](/cells/ru/python-net/aspose.cells/textstriketype) | Этот тип определяет тип удара.|
| [ThemeColorType](/cells/ru/python-net/aspose.cells/themecolortype) | Перечисляет типы цветов темы.|
| [TimePeriodType](/cells/ru/python-net/aspose.cells/timeperiodtype) | Используется в правиле условного форматирования FormatConditionType.TimePeriod.<br/>Это динамические периоды времени, которые меняются в зависимости от<br/> дата обновления/применения условного форматирования.|
| [TxtLoadStyleStrategy](/cells/ru/python-net/aspose.cells/txtloadstylestrategy) | Указывает, как применять стиль для проанализированных значений при преобразовании строкового значения в число или дату и время.|
| [TxtValueQuoteType](/cells/ru/python-net/aspose.cells/txtvaluequotetype) | Задает тип использования кавычек для значений в файлах текстового формата.|
| [UpdateLinksType](/cells/ru/python-net/aspose.cells/updatelinkstype) |Представляет, как обновлять ссылки на другие книги при открытии книги.|
| [ValidationAlertType](/cells/ru/python-net/aspose.cells/validationalerttype) | Представляет стиль оповещения о проверке данных.|
| [ValidationType](/cells/ru/python-net/aspose.cells/validationtype) | Представляет тип проверки данных.|
| [ViewType](/cells/ru/python-net/aspose.cells/viewtype) | Представляет тип представления рабочего листа.|
| [VisibilityType](/cells/ru/python-net/aspose.cells/visibilitytype) | Представляет состояния видимости листа.|
| [WarningType](/cells/ru/python-net/aspose.cells/warningtype) | ВарингТип|
