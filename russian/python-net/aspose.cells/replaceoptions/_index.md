...
type: docs
weight: 1290
url: /ru/python-net/aspose.cells/replaceoptions/
is_root: false
---
##  ReplaceOptions класс
Представляют варианты замены.



Тип ReplaceOptions предоставляет следующие члены:

###  Конструкторы
| Конструктор| Описание|
| :- | :- |
| [ReplaceOptions()](/cells/ru/python-net/aspose.cells/replaceoptions/__init__/#) | Создает новый экземпляр ReplaceOptions|
