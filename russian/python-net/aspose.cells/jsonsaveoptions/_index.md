...
type: docs
weight: 970
url: /ru/python-net/aspose.cells/jsonsaveoptions/
is_root: false
---
...
Тип JsonSaveOptions предоставляет следующие члены:
...
| Свойство| Описание|
| :- | :- |
| [save_format](/cells/ru/python-net/aspose.cells/jsonsaveoptions/save_format) | Получает формат файла сохранения.|
| [clear_data](/cells/ru/python-net/aspose.cells/jsonsaveoptions/clear_data) | Сделайте рабочую книгу пустой после сохранения файла.|
| [cached_file_folder](/cells/ru/python-net/aspose.cells/jsonsaveoptions/cached_file_folder) | Папка с кэшированными файлами используется для хранения больших данных.|
| [validate_merged_areas](/cells/ru/python-net/aspose.cells/jsonsaveoptions/validate_merged_areas) | Указывает, следует ли проверять объединенные ячейки перед сохранением файла.|
...
| [sheet_indexes](/cells/ru/python-net/aspose.cells/jsonsaveoptions/sheet_indexes) | Представляет индексы экспортированных листов.|
...
###  Смотрите также
* модуль [aspose.cells](..)
* класс [JsonSaveOptions](/cells/ru/python-net/aspose.cells/jsonsaveoptions)
