...
type: docs
weight: 1220
url: /ru/python-net/aspose.cells/protection/
is_root: false
---
##  Protection класс
...
Тип Protection предоставляет следующие члены:
...
| [is_using_pivot_tables_allowed](/cells/ru/python-net/aspose.cells/protection/is_using_pivot_tables_allowed) | Указывает, разрешено ли пользователю управлять сводными таблицами на защищенном листе.|
| [allow_editing_content](/cells/ru/python-net/aspose.cells/protection/allow_editing_content) | Указывает, разрешено ли пользователю редактировать содержимое заблокированных ячеек на защищенном листе.|
| [is_editing_contents_allowed](/cells/ru/python-net/aspose.cells/protection/is_editing_contents_allowed) | Указывает, разрешено ли пользователю редактировать содержимое заблокированных ячеек на защищенном листе.|
| [allow_editing_object](/cells/ru/python-net/aspose.cells/protection/allow_editing_object) | Указывает, разрешено ли пользователю манипулировать объектами чертежа на защищенном листе.|
| [is_editing_objects_allowed](/cells/ru/python-net/aspose.cells/protection/is_editing_objects_allowed) | Указывает, разрешено ли пользователю манипулировать объектами чертежа на защищенном листе.|
...
| Метод| Описание|
| :- | :- |
| [copy(source)](/cells/ru/python-net/aspose.cells/protection/copy/#Protection) | Информация о защите от копирования.|
| [get_password_hash()](/cells/ru/python-net/aspose.cells/protection/get_password_hash/#) | Получает хэш текущего пароля.|
| [verify_password(password)](/cells/ru/python-net/aspose.cells/protection/verify_password/#str) | Проверяет пароль.|
