...
type: docs
weight: 70
url: /ru/python-net/aspose.cells/worksheet/auto_fit_rows/
is_root: false
---
##  auto_fit_rows() {#}
...
| start_row | int | Индекс начальной строки.|
| end_row | int | Индекс конечной строки.|
| options | [AutoFitterOptions](/cells/ru/python-net/aspose.cells/autofitteroptions) | Варианты автослесаря.|
