...
type: docs
weight: 190
url: /ru/python-net/aspose.cells/workbook/get_style_in_pool/
is_root: false
---
...
Если возвращаемый стиль изменен, стиль всех ячеек (которые относятся к этому стилю) будут изменены.
