...
type: docs
weight: 660
url: /ru/python-net/aspose.cells/fontconfigs/
is_root: false
---
##  FontConfigs класс
...
Тип FontConfigs предоставляет следующие члены:

###  Конструкторы
| Конструктор| Описание|
| :- | :- |
| [FontConfigs()](/cells/ru/python-net/aspose.cells/fontconfigs/__init__/#) | Создает новый экземпляр FontConfigs|
