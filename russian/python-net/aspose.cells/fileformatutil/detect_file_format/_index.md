...
type: docs
weight: 20
url: /ru/python-net/aspose.cells/fileformatutil/detect_file_format/
is_root: false
---
...
Объект [FileFormatInfo](/cells/ru/python-net/aspose.cells/fileformatinfo), содержащий обнаруженную информацию.
...
###  Смотрите также
* модуль [aspose.cells](../../)
* класс [FileFormatInfo](/cells/ru/python-net/aspose.cells/fileformatinfo)
