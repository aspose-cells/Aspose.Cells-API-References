...
| [password](/cells/ru/python-net/aspose.cells/abstracttextloadoptions/password) | Получает и задает пароль книги.|
...
| [keep_unparsed_data](/cells/ru/python-net/aspose.cells/abstracttextloadoptions/keep_unparsed_data) | Сохранять ли непроанализированные данные в памяти для рабочей книги, когда она загружается из файла шаблона. По умолчанию — true.|
...
| [warning_callback](/cells/ru/python-net/aspose.cells/abstracttextloadoptions/warning_callback) | Получает или задает обратные вызовы предупреждения.|
...
| [encoding](/cells/ru/python-net/aspose.cells/abstracttextloadoptions/encoding) | Получает и задает кодировку по умолчанию.|
