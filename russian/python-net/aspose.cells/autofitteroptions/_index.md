---
title: AutoFitterOptions класс
second_title: Aspose.Cells for Python via .NET API
description:
type: docs
weight: 80
url: /ru/python-net/aspose.cells/autofitteroptions/
is_root: false
---
##  AutoFitterOptions класс
Представляет все параметры автоматической установки.



Тип AutoFitterOptions предоставляет следующие члены:

###  Конструкторы
| Конструктор| Описание|
| :- | :- |
| [AutoFitterOptions()](/cells/ru/python-net/aspose.cells/autofitteroptions/__init__/#) | Создает новый экземпляр AutoFitterOptions|
...
| [auto_fit_wrapped_text_type](/cells/ru/python-net/aspose.cells/autofitteroptions/auto_fit_wrapped_text_type) | Получает и задает тип автоподгонки обернутого текста.|
| [format_strategy](/cells/ru/python-net/aspose.cells/autofitteroptions/format_strategy) | Получает и задает отформатированную стратегию.|
