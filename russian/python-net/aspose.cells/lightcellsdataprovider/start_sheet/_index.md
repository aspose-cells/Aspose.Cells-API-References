...
type: docs
weight: 70
url: /ru/python-net/aspose.cells/lightcellsdataprovider/start_sheet/
is_root: false
---
...
Значение true, если этот поставщик предоставит данные для данного листа; значение false, если данный лист должен использовать свою обычную модель данных (Cells).
