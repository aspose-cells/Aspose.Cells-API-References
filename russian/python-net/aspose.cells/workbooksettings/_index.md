...
type: docs
weight: 1610
url: /ru/python-net/aspose.cells/workbooksettings/
is_root: false
---
##  WorkbookSettings класс
Представляет все параметры рабочей книги.



Тип WorkbookSettings предоставляет следующие члены:
...
| [enable_macros](/cells/ru/python-net/aspose.cells/workbooksettings/enable_macros) | Включить макросы;|
| [date1904](/cells/ru/python-net/aspose.cells/workbooksettings/date1904) | Получает или задает значение, указывающее, использует ли книга систему дат 1904 года.|
| [protection_type](/cells/ru/python-net/aspose.cells/workbooksettings/protection_type) | Получает тип защиты книги.|
| [display_drawing_objects](/cells/ru/python-net/aspose.cells/workbooksettings/display_drawing_objects) | Указывает, следует ли и как отображать объекты в книге.|
| [sheet_tab_bar_width](/cells/ru/python-net/aspose.cells/workbooksettings/sheet_tab_bar_width) | Ширина панели вкладок рабочего листа (в 1/1000 ширины окна).|
| [show_tabs](/cells/ru/python-net/aspose.cells/workbooksettings/show_tabs) | Получите или задайте значение, указывающее, отображаются ли вкладки рабочей книги.|
| [first_visible_tab](/cells/ru/python-net/aspose.cells/workbooksettings/first_visible_tab) | Получает или задает первую видимую вкладку рабочего листа.|
| [is_h_scroll_bar_visible](/cells/ru/python-net/aspose.cells/workbooksettings/is_h_scroll_bar_visible) | Получает или задает значение, указывающее, будет ли созданная электронная таблица содержать горизонтальную полосу прокрутки.|
...
| [is_protected](/cells/ru/python-net/aspose.cells/workbooksettings/is_protected) | Получает значение, указывающее, защищена ли структура или окно книги.|
| [is_default_encrypted](/cells/ru/python-net/aspose.cells/workbooksettings/is_default_encrypted) | Указывает, следует ли шифровать книгу с паролем по умолчанию, если структура и Windows книги заблокированы.|
| [is_minimized](/cells/ru/python-net/aspose.cells/workbooksettings/is_minimized) | Указывает, будет ли сгенерированная электронная таблица открыта в свернутом виде.|
| [is_hidden](/cells/ru/python-net/aspose.cells/workbooksettings/is_hidden) | Указывает, скрыта ли эта книга.|
| [auto_compress_pictures](/cells/ru/python-net/aspose.cells/workbooksettings/auto_compress_pictures) | Задает логическое значение, указывающее, что приложение автоматически сжимает изображения в книге.|
| [remove_personal_information](/cells/ru/python-net/aspose.cells/workbooksettings/remove_personal_information) | Значение true, если личную информацию можно удалить из указанной книги.|
| [hide_pivot_field_list](/cells/ru/python-net/aspose.cells/workbooksettings/hide_pivot_field_list) | Получает и задает, следует ли скрыть список полей для сводной таблицы.|
| [update_links_type](/cells/ru/python-net/aspose.cells/workbooksettings/update_links_type) | Получает и задает способ обновления внешних ссылок при открытии книги.|
| [max_row](/cells/ru/python-net/aspose.cells/workbooksettings/max_row) | Получает максимальный индекс строки, отсчитываемый от нуля.|
| [max_column](/cells/ru/python-net/aspose.cells/workbooksettings/max_column) | Получает максимальный индекс столбца, отсчитываемый от нуля.|
| [parsing_formula_on_open](/cells/ru/python-net/aspose.cells/workbooksettings/parsing_formula_on_open) | Указывает, выполняется ли разбор формулы при чтении файла.|
| [window_left](/cells/ru/python-net/aspose.cells/workbooksettings/window_left) |Расстояние от левого края клиентской области до левого края окна в пунктах.|
| [window_left_inch](/cells/ru/python-net/aspose.cells/workbooksettings/window_left_inch) | Расстояние от левого края клиентской области до левого края окна.<br/> В единицах дюйма.|
| [window_left_cm](/cells/ru/python-net/aspose.cells/workbooksettings/window_left_cm) | Расстояние от левого края клиентской области до левого края окна.<br/> В единицах сантиметра.|
| [window_top](/cells/ru/python-net/aspose.cells/workbooksettings/window_top) | Расстояние от верхнего края клиентской области до верхнего края окна в пунктах.|
| [window_top_inch](/cells/ru/python-net/aspose.cells/workbooksettings/window_top_inch) | Расстояние от верхнего края клиентской области до верхнего края окна в дюймах.|
| [window_top_cm](/cells/ru/python-net/aspose.cells/workbooksettings/window_top_cm) | Расстояние от верхнего края клиентской области до верхнего края окна в сантиметрах.|
| [window_width](/cells/ru/python-net/aspose.cells/workbooksettings/window_width) | Ширина окна в пунктах.|
| [window_width_inch](/cells/ru/python-net/aspose.cells/workbooksettings/window_width_inch) | Ширина окна в дюймах.|
| [window_width_cm](/cells/ru/python-net/aspose.cells/workbooksettings/window_width_cm) | Ширина окна в сантиметрах.|
| [window_height](/cells/ru/python-net/aspose.cells/workbooksettings/window_height) | Высота окна в пунктах.|
| [window_height_inch](/cells/ru/python-net/aspose.cells/workbooksettings/window_height_inch) | Высота окна в дюймах.|
...
| Метод| Описание|
| :- | :- |
| [get_theme_font(type)](/cells/ru/python-net/aspose.cells/workbooksettings/get_theme_font/#FontSchemeType) | Получает имя шрифта темы по умолчанию.|
| [set_page_orientation_type(page_orientation_type)](/cells/ru/python-net/aspose.cells/workbooksettings/set_page_orientation_type/#PageOrientationType) |Установите тип ориентации печати для всей книги.|
