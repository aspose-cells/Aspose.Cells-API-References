---
title: XmlSaveOptions класс
second_title: Aspose.Cells for Python via .NET API
description:
type: docs
weight: 1720
url: /ru/python-net/aspose.cells/xmlsaveoptions/
is_root: false
---
##  XmlSaveOptions класс
Представляет параметры сохранения книги в виде XML-файла.



**Наследование:** [XmlSaveOptions](/cells/python-net/aspose.cells/xmlsaveoptions) → 
[SaveOptions](/cells/ru/python-net/aspose.cells/saveoptions)



Тип XmlSaveOptions предоставляет следующие члены:
...
| Свойство| Описание|
| :- | :- |
| [save_format](/cells/ru/python-net/aspose.cells/xmlsaveoptions/save_format) | Получает формат файла сохранения.|
| [clear_data](/cells/ru/python-net/aspose.cells/xmlsaveoptions/clear_data) | Сделайте рабочую книгу пустой после сохранения файла.|
| [cached_file_folder](/cells/ru/python-net/aspose.cells/xmlsaveoptions/cached_file_folder) | Папка с кэшированными файлами используется для хранения больших данных.|
| [validate_merged_areas](/cells/ru/python-net/aspose.cells/xmlsaveoptions/validate_merged_areas) | Указывает, следует ли проверять объединенные ячейки перед сохранением файла.|
...
| [has_header_row](/cells/ru/python-net/aspose.cells/xmlsaveoptions/has_header_row) | Указывает, содержит ли диапазон строку заголовка.|
| [xml_map_name](/cells/ru/python-net/aspose.cells/xmlsaveoptions/xml_map_name) | Указывает, экспортируется ли карта xml в файл.|
...
* класс [XmlSaveOptions](/cells/ru/python-net/aspose.cells/xmlsaveoptions)
