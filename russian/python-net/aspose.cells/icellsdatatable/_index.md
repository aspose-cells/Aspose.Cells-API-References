...
type: docs
weight: 810
url: /ru/python-net/aspose.cells/icellsdatatable/
is_root: false
---
##  ICellsDataTable класс
...
| Метод| Описание|
| :- | :- |
| [before_first()](/cells/ru/python-net/aspose.cells/icellsdatatable/before_first/#) | Переместите курсор к передней части этого объекта, непосредственно перед первой строкой.|
| [next()](/cells/ru/python-net/aspose.cells/icellsdatatable/next/#) | Перемещает курсор вниз на одну строку от его текущей позиции.|
