...
вызвать плохую работу. Из соображений производительности пользователь должен вместо этого использовать [Cell.get_dependents_in_calculation(recursive)](/cells/ru/python-net/aspose.cells/cell/get_dependents_in_calculation).
