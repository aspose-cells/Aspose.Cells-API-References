...
type: docs
weight: 700
url: /ru/python-net/aspose.cells/cells/insert_cut_cells/
is_root: false
---
##  insert_cut_cells(cut_range, row, column, shift_type) {#Range-int-int-ShiftType}
Вставьте диапазон обрезки.
...
| row | int | Ряд.|
| column | int | Колонка.|
| shift_type | [ShiftType](/cells/ru/python-net/aspose.cells/shifttype) | Тип смены.|
