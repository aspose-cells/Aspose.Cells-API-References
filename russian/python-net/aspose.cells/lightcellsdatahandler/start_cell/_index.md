...
Он будет вызываться при достижении существующей ячейки в текущей строке. Текущая строка — это строка последнего звонка [LightCellsDataHandler.process_row(row)](/cells/ru/python-net/aspose.cells/lightcellsdatahandler/process_row).
