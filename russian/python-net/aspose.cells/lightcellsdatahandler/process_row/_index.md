...
type: docs
weight: 30
url: /ru/python-net/aspose.cells/lightcellsdatahandler/process_row/
is_root: false
---
##  process_row(row) {#Row}
...
| :- | :- | :- |
| row | [Row](/cells/ru/python-net/aspose.cells/row) | Объект строки, который обрабатывается в данный момент.|
###  Примечания
