...
type: docs
weight: 380
url: /ru/python-net/aspose.cells/txtloadoptions/treat_quote_prefix_as_value/
is_root: false
---
...
Значение по умолчанию — true. Если false, ведущая одинарная кавычка будет удалена из значения соответствующей ячейки.
и [Style.quote_prefix](/cells/ru/python-net/aspose.cells/style#quote_prefix) будет установлено как true для ячейки.
###  Определение:
```python
@property
