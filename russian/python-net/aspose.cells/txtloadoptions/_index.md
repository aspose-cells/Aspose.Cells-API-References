...
Представляет параметры загрузки текстовых файлов.
...
| :- | :- |
| [TxtLoadOptions()](/cells/ru/python-net/aspose.cells/txtloadoptions/__init__/#) | Создает параметры для загрузки текстовых файлов.|
| [TxtLoadOptions(load_format)](/cells/ru/python-net/aspose.cells/txtloadoptions/__init__/#LoadFormat) | Создает параметры для загрузки текстовых файлов.|
...
| [password](/cells/ru/python-net/aspose.cells/txtloadoptions/password) | Получает и задает пароль книги.|
...
| [keep_unparsed_data](/cells/ru/python-net/aspose.cells/txtloadoptions/keep_unparsed_data) | Сохранять ли непроанализированные данные в памяти для рабочей книги, когда она загружается из файла шаблона. По умолчанию — true.|
...
| [warning_callback](/cells/ru/python-net/aspose.cells/txtloadoptions/warning_callback) | Получает или задает обратные вызовы предупреждения.|
...
| [encoding](/cells/ru/python-net/aspose.cells/txtloadoptions/encoding) | Получает и задает кодировку по умолчанию.|
...
| [preferred_parsers](/cells/ru/python-net/aspose.cells/txtloadoptions/preferred_parsers) |Получает и задает анализаторы предпочтительных значений для загрузки текстовых файлов.|
...
| [has_text_qualifier](/cells/ru/python-net/aspose.cells/txtloadoptions/has_text_qualifier) | Есть ли квалификатор текста для значения ячейки. Значение по умолчанию — true.|
| [text_qualifier](/cells/ru/python-net/aspose.cells/txtloadoptions/text_qualifier) | Указывает квалификатор текста для значений ячеек. Квалификатор по умолчанию — """.|
