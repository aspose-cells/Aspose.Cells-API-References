...
type: docs
weight: 70
url: /ru/python-net/aspose.cells/globalizationsettings/get_data_field_header_name_of_pivot_table/
is_root: false
---
##  get_data_field_header_name_of_pivot_table() {#}
Получает имя заголовка поля области значений в сводной таблице.


###  Возвращает

Имя заголовка поля данных
