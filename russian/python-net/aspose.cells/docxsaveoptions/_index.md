...
type: docs
weight: 490
url: /ru/python-net/aspose.cells/docxsaveoptions/
is_root: false
---
...
Тип DocxSaveOptions предоставляет следующие члены:
...
| Свойство| Описание|
| :- | :- |
| [save_format](/cells/ru/python-net/aspose.cells/docxsaveoptions/save_format) | Получает формат файла сохранения.|
| [clear_data](/cells/ru/python-net/aspose.cells/docxsaveoptions/clear_data) | Сделайте рабочую книгу пустой после сохранения файла.|
| [cached_file_folder](/cells/ru/python-net/aspose.cells/docxsaveoptions/cached_file_folder) | Папка с кэшированными файлами используется для хранения больших данных.|
| [validate_merged_areas](/cells/ru/python-net/aspose.cells/docxsaveoptions/validate_merged_areas) | Указывает, следует ли проверять объединенные ячейки перед сохранением файла.|
...
###  Смотрите также
* модуль [aspose.cells](..)
* класс [DocxSaveOptions](/cells/ru/python-net/aspose.cells/docxsaveoptions)
