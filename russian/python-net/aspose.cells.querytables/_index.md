...
is_root: false
---
**Aspose.Cells.QueryTables** namespace предоставляет классы для доступа и обновления таблицы рабочего листа, созданной на основе данных, возвращенных из внешнего источника данных, например, сервера SQL или базы данных Access Microsoft.
