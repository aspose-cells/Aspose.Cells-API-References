...
type: docs
weight: 10
url: /ru/python-net/aspose.cells.querytables/
is_root: false
---
**Aspose.Cells.QueryTables** namespace предоставляет классы для доступа и обновления таблицы рабочего листа, построенной на основе данных, возвращенных из внешнего источника данных, такого как сервер SQL или база данных Microsoft Access.
