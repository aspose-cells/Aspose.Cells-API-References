...
type: docs
weight: 10
url: /ru/python-net/aspose.cells.utility/
is_root: false
---
**Aspose.Cells.Utility** namespace содержит служебные классы, обрабатывающие форматы JSON для файлов электронных таблиц Excel.
