...
type: docs
weight: 10
url: /ru/python-net/aspose.cells.utility/exportrangetojsonoptions/
is_root: false
---
##  ExportRangeToJsonOptions класс
Указывает параметры, которые экспортируют диапазон в json.



Тип ExportRangeToJsonOptions предоставляет следующие члены:

###  Конструкторы
| Конструктор| Описание|
| :- | :- |
| [ExportRangeToJsonOptions()](/cells/ru/python-net/aspose.cells.utility/exportrangetojsonoptions/__init__/#) | Создает новый экземпляр ExportRangeToJsonOptions.|
