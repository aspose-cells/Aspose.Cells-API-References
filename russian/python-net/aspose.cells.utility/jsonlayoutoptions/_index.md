...
type: docs
weight: 20
url: /ru/python-net/aspose.cells.utility/jsonlayoutoptions/
is_root: false
---
##  JsonLayoutOptions класс
Представляет параметры типа макета json.



Тип JsonLayoutOptions предоставляет следующие члены:

###  Конструкторы
| Конструктор| Описание|
| :- | :- |
| [JsonLayoutOptions()](/cells/ru/python-net/aspose.cells.utility/jsonlayoutoptions/__init__/#) | Создает новый экземпляр JsonLayoutOptions|
