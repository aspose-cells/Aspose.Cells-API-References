---
title: BuiltInDocumentPropertyCollection класс
second_title: Aspose.Cells for Python via .NET API
description:
type: docs
weight: 10
url: /ru/python-net/aspose.cells.properties/builtindocumentpropertycollection/
is_root: false
---
##  BuiltInDocumentPropertyCollection класс
Коллекция встроенных свойств документа.



**Наследование:** [BuiltInDocumentPropertyCollection](/cells/python-net/aspose.cells.properties/builtindocumentpropertycollection) → 
[DocumentPropertyCollection](/cells/ru/python-net/aspose.cells.properties/documentpropertycollection)



Тип BuiltInDocumentPropertyCollection предоставляет следующие члены:

###  Характеристики
| Свойство| Описание|
| :- | :- |
| [capacity](/cells/ru/python-net/aspose.cells.properties/builtindocumentpropertycollection/capacity) | Получает или задает количество элементов, которые может содержать список массивов.|
| [language](/cells/ru/python-net/aspose.cells.properties/builtindocumentpropertycollection/language) | Получает или задает язык документа.|
| [author](/cells/ru/python-net/aspose.cells.properties/builtindocumentpropertycollection/author) | Получает или задает имя автора документа.|
| [bytes](/cells/ru/python-net/aspose.cells.properties/builtindocumentpropertycollection/bytes) | Представляет оценку количества байтов в документе.|
| [characters](/cells/ru/python-net/aspose.cells.properties/builtindocumentpropertycollection/characters) | Представляет оценку количества символов в документе.|
| [characters_with_spaces](/cells/ru/python-net/aspose.cells.properties/builtindocumentpropertycollection/characters_with_spaces) | Представляет оценку количества символов (включая пробелы) в документе.|
| [comments](/cells/ru/python-net/aspose.cells.properties/builtindocumentpropertycollection/comments) | Получает или задает комментарии к документу.|
| [category](/cells/ru/python-net/aspose.cells.properties/builtindocumentpropertycollection/category) | Получает или задает категорию документа.|
...
| [last_saved_universal_time](/cells/ru/python-net/aspose.cells.properties/builtindocumentpropertycollection/last_saved_universal_time) | Получает или задает универсальное время последнего сохранения.|
| [lines](/cells/ru/python-net/aspose.cells.properties/builtindocumentpropertycollection/lines) | Представляет оценку количества строк в документе.|
| [manager](/cells/ru/python-net/aspose.cells.properties/builtindocumentpropertycollection/manager) | Получает или задает свойство менеджера.|
| [name_of_application](/cells/ru/python-net/aspose.cells.properties/builtindocumentpropertycollection/name_of_application) | Получает или задает имя приложения.|
| [pages](/cells/ru/python-net/aspose.cells.properties/builtindocumentpropertycollection/pages) | Представляет оценку количества страниц в документе.|
...
| [document_version](/cells/ru/python-net/aspose.cells.properties/builtindocumentpropertycollection/document_version) | Представляет версию файла.|
| [scale_crop](/cells/ru/python-net/aspose.cells.properties/builtindocumentpropertycollection/scale_crop) | Указывает режим отображения миниатюры документа.|
| [links_up_to_date](/cells/ru/python-net/aspose.cells.properties/builtindocumentpropertycollection/links_up_to_date) | Указывает, являются ли гиперссылки в документе актуальными.|
| [words](/cells/ru/python-net/aspose.cells.properties/builtindocumentpropertycollection/words) | Представляет оценку количества слов в документе.|


###  Методы
| Метод| Описание|
| :- | :- |
| [index_of(name)](/cells/ru/python-net/aspose.cells.properties/builtindocumentpropertycollection/index_of/#str) | Получает индекс свойства по имени.|
...
Предоставляет доступ к объектам [DocumentProperty](/cells/ru/python-net/aspose.cells.properties/documentproperty) по их именам (с помощью индексатора) и
через набор типизированных свойств, которые возвращают значения соответствующих типов.

###  Смотрите также
* модуль [aspose.cells.properties](..)
* класс [BuiltInDocumentPropertyCollection](/cells/ru/python-net/aspose.cells.properties/builtindocumentpropertycollection)
