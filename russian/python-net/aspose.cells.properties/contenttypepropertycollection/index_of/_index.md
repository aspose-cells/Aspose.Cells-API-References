...
type: docs
weight: 50
url: /ru/python-net/aspose.cells.properties/contenttypepropertycollection/index_of/
is_root: false
---
...
| :- | :- | :- |
| item | [ContentTypeProperty](/cells/ru/python-net/aspose.cells.properties/contenttypeproperty) | Объект, который нужно найти в списке массивов. Значение может быть нулевым.|
