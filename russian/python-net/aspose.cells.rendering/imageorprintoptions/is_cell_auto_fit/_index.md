...
type: docs
weight: 150
url: /ru/python-net/aspose.cells.rendering/imageorprintoptions/is_cell_auto_fit/
is_root: false
---
##  is_cell_auto_fit недвижимость

 Указывает, подгоняются ли ширина и высота ячеек автоматически по значению ячейки.
