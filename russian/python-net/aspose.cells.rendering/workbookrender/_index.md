...
| Свойство| Описание|
| :- | :- |
| [page_count](/cells/ru/python-net/aspose.cells.rendering/workbookrender/page_count) | Получает общее количество страниц книги.|
...
| [to_image(page_index, file_name)](/cells/ru/python-net/aspose.cells.rendering/workbookrender/to_image/#int-str) | Рендерить определенную страницу в файл.|
| [to_image(page_index, stream)](/cells/ru/python-net/aspose.cells.rendering/workbookrender/to_image/#int-io.RawIOBase) | Рендерить определенную страницу в поток.|
| [to_printer(printer_name)](/cells/ru/python-net/aspose.cells.rendering/workbookrender/to_printer/#str) | Рендеринг книги на принтер|
| [to_printer(printer_name, job_name)](/cells/ru/python-net/aspose.cells.rendering/workbookrender/to_printer/#str-str) | Рендеринг книги на принтер|
