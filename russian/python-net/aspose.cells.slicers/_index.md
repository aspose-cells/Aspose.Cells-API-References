...
type: docs
weight: 10
url: /ru/python-net/aspose.cells.slicers/
is_root: false
---
**Aspose.Cells.Slicers** namespace предоставляет все классы для параметров Pivot Table Slicer для файлов электронных таблиц Excel.
