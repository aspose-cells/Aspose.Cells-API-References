...
type: docs
weight: 10
url: /ru/python-net/aspose.cells.tables/
is_root: false
---
**Aspose.Cells.Tables** namespace содержит классы, представляющие таблицы, строки, ячейки и их форматирование для файлов электронных таблиц Excel.

###  Классы
| Сорт| Описание|
| :- | :- |
| [ListColumn](/cells/ru/python-net/aspose.cells.tables/listcolumn) | Представляет столбец в списке.|
| [ListColumnCollection](/cells/ru/python-net/aspose.cells.tables/listcolumncollection) | Представляет коллекцию всех объектов [ListColumn](/cells/ru/python-net/aspose.cells.tables/listcolumn) в указанном объекте ListObject.|
| [ListObject](/cells/ru/python-net/aspose.cells.tables/listobject) | Представляет объект списка на листе.<br/> Объект ListObject является членом коллекции ListObjects.<br/> Коллекция ListObjects содержит все объекты списка на листе.|
| [ListObjectCollection](/cells/ru/python-net/aspose.cells.tables/listobjectcollection) | Представляет коллекцию из [ListObject](/cells/ru/python-net/aspose.cells.tables/listobject) объектов на листе.|
