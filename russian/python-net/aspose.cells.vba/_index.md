...
type: docs
weight: 10
url: /ru/python-net/aspose.cells.vba/
is_root: false
---
**Aspose.Cells.Vba** namespace содержит классы для доступа к проектам и модулям Visual Basic Analysis в файлах электронных таблиц Excel.
...
| [VbaProjectReferenceCollection](/cells/ru/python-net/aspose.cells.vba/vbaprojectreferencecollection) | Представляет все ссылки на проекты VBA.|
