...
type: docs
weight: 160
url: /ru/python-net/aspose.cells.drawing.texts/textautonumberscheme/
is_root: false
---
...
Тип TextAutonumberScheme предоставляет следующие члены:

###  Поля
| Поле| Описание|
| :- | :- |
| NONE |  |
| ALPHA_LC_PAREN_BOTH | (а), (б), (в), …|
| ALPHA_LC_PAREN_R | а), б), в), …|
| ALPHA_LC_PERIOD | а, б, в, …|
| ALPHA_UC_PAREN_BOTH | (А), (Б), (С), …|
...
| ARABIC_PERIOD | 1., 2., 3., … |
| ARABIC_PLAIN | 1, 2, 3, … |
| CIRCLE_NUM_DB_PLAIN | Dbl-байтовые числа круга (1-10 круг[0x2460-], 11-арабские числа)|
| CIRCLE_NUM_WD_BLACK_PLAIN | Цифры черного круга Wingdings|
| CIRCLE_NUM_WD_WHITE_PLAIN | Цифры белого круга Wingdings (круг 0-10 [0x0080-], 11- арабские числа)|
...
| HEBREW_2_MINUS | Биди иврит 2 с символом минус ANSI|
| HINDI_ALPHA_1_PERIOD | Период алфавита хинди - согласные|
| HINDI_ALPHA_PERIOD | Период алфавита хинди - гласные|
| HINDI_NUM_PAREN_R | Цифровые скобки на хинди - правильно|
| HINDI_NUM_PERIOD | Числовой период хинди|
| ROMAN_LC_PAREN_BOTH | (i), (ii), (iii), …|
| ROMAN_LC_PAREN_R | и), ii), iii), …|
...
| THAI_NUM_PAREN_BOTH | Тайские числовые скобки - обе|
| THAI_NUM_PAREN_R | Тайские числовые скобки - справа|
| THAI_NUM_PERIOD | Тайский числовой период|
