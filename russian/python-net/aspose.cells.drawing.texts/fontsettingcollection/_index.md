...
type: docs
weight: 50
url: /ru/python-net/aspose.cells.drawing.texts/fontsettingcollection/
is_root: false
---
##  FontSettingCollection класс
Представляет список [FontSetting](/cells/ru/python-net/aspose.cells/fontsetting).



Тип FontSettingCollection предоставляет следующие члены:

###  Характеристики
| Свойство| Описание|
| :- | :- |
| [text_alignment](/cells/ru/python-net/aspose.cells.drawing.texts/fontsettingcollection/text_alignment) | Представляет параметр выравнивания основного текста.|
| [text_paragraphs](/cells/ru/python-net/aspose.cells.drawing.texts/fontsettingcollection/text_paragraphs) | Получает все абзацы.|
| [text](/cells/ru/python-net/aspose.cells.drawing.texts/fontsettingcollection/text) | Получает и задает текст фигуры.|
| [html_string](/cells/ru/python-net/aspose.cells.drawing.texts/fontsettingcollection/html_string) | Получает и задает строку html, содержащую данные и некоторые форматы в этой форме.|
| [capacity](/cells/ru/python-net/aspose.cells.drawing.texts/fontsettingcollection/capacity) | Получает или задает количество элементов, которые может содержать список массивов.|
...
* класс [FontSetting](/cells/ru/python-net/aspose.cells/fontsetting)
