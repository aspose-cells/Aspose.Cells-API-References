...
type: docs
weight: 100
url: /ru/python-net/aspose.cells.drawing.texts/textparagraph/
is_root: false
---
##  TextParagraph класс
...
**Наследование:** [TextParagraph](/cells/python-net/aspose.cells.drawing.texts/textparagraph) → 
[FontSetting](/cells/ru/python-net/aspose.cells/fontsetting)



Тип TextParagraph предоставляет следующие члены:
...
| Метод| Описание|
| :- | :- |
| [set_word_art_style(style)](/cells/ru/python-net/aspose.cells.drawing.texts/textparagraph/set_word_art_style/#PresetWordArtStyle) | Задает предустановленный стиль WordArt.|
...
* класс [TextParagraph](/cells/ru/python-net/aspose.cells.drawing.texts/textparagraph)
