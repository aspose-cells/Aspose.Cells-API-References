...
| [password](/cells/ru/python-net/aspose.cells.numbers/numbersloadoptions/password) | Получает и устанавливает пароль книги.|
...
| [keep_unparsed_data](/cells/ru/python-net/aspose.cells.numbers/numbersloadoptions/keep_unparsed_data) |Сохранять ли непроанализированные данные в памяти для рабочей книги, когда она загружается из файла шаблона. Значение по умолчанию верно.|
...
| [warning_callback](/cells/ru/python-net/aspose.cells.numbers/numbersloadoptions/warning_callback) | Получает или задает обратный вызов предупреждения.|
