...
type: docs
weight: 10
url: /ru/python-net/aspose.cells.revisions/
is_root: false
---
**Aspose.Cells.Revisions** namespace предоставляет классы для доступа к версиям файлов электронных таблиц Excel.

###  Классы
| Сорт| Описание|
| :- | :- |
| [Revision](/cells/ru/python-net/aspose.cells.revisions/revision) | Представляет редакцию.|
| [RevisionAutoFormat](/cells/ru/python-net/aspose.cells.revisions/revisionautoformat) | представляет собой запись ревизии информации об изменении форматирования.|
| [RevisionCellChange](/cells/ru/python-net/aspose.cells.revisions/revisioncellchange) | Представляет ревизию, изменяющую ячейки.|
| [RevisionCellComment](/cells/ru/python-net/aspose.cells.revisions/revisioncellcomment) | Представляет запись редакции изменения комментария к ячейке.|
