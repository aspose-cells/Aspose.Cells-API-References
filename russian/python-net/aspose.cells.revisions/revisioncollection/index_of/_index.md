...
type: docs
weight: 40
url: /ru/python-net/aspose.cells.revisions/revisioncollection/index_of/
is_root: false
---
...
| :- | :- | :- |
| item | [Revision](/cells/ru/python-net/aspose.cells.revisions/revision) | Объект, который нужно найти в списке массивов. Значение может быть нулевым.|
