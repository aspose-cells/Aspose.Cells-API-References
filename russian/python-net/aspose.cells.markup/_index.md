...
type: docs
weight: 10
url: /ru/python-net/aspose.cells.markup/
is_root: false
---
**Aspose.Cells.Markup** пространство имен содержит классы, которые представляют определяемую пользователем семантику в документе: смарт-теги, пользовательский XML и другие теги разметки.

###  Классы
| Сорт| Описание|
| :- | :- |
| [CustomXmlPart](/cells/ru/python-net/aspose.cells.markup/customxmlpart) | Представляет часть хранилища пользовательских данных XML (пользовательские данные XML в пакете).|
| [CustomXmlPartCollection](/cells/ru/python-net/aspose.cells.markup/customxmlpartcollection) | Представляет часть хранилища пользовательских данных XML (пользовательские данные XML в пакете).|
| [SmartTag](/cells/ru/python-net/aspose.cells.markup/smarttag) | Представляет смарт-тег.|
