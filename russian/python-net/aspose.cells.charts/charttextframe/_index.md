...
type: docs
weight: 110
url: /ru/python-net/aspose.cells.charts/charttextframe/
is_root: false
---
##  ChartTextFrame класс
Инкапсулирует объект, представляющий объект фрейма, содержащий текст.



**Наследование:** [ChartTextFrame](/cells/python-net/aspose.cells.charts/charttextframe) → 
[ChartFrame](/cells/ru/python-net/aspose.cells.charts/chartframe)



Тип ChartTextFrame предоставляет следующие члены:

###  Характеристики
| Свойство| Описание|
| :- | :- |
| [is_inner_mode](/cells/ru/python-net/aspose.cells.charts/charttextframe/is_inner_mode) | Указывает, включает ли размер области графика деления и метки осей.<br/> False указывает, что размер должен определять размер области графика, делений и меток осей.|
| [border](/cells/ru/python-net/aspose.cells.charts/charttextframe/border) | Получает [Line](/cells/ru/python-net/aspose.cells.drawing/line).|
| [area](/cells/ru/python-net/aspose.cells.charts/charttextframe/area) | Получает [ChartFrame.area](/cells/ru/python-net/aspose.cells.charts/chartframe#area).|
