...
type: docs
weight: 330
url: /ru/python-net/aspose.cells.charts/trendline/
is_root: false
---
##  Trendline класс
...
**Наследование:** [Trendline](/cells/python-net/aspose.cells.charts/trendline) → 
...
| [begin_arrow_width](/cells/ru/python-net/aspose.cells.charts/trendline/begin_arrow_width) | Определяет ширину стрелки для начала строки.|
| [end_arrow_width](/cells/ru/python-net/aspose.cells.charts/trendline/end_arrow_width) | Определяет ширину стрелки для конца строки.|
| [theme_color](/cells/ru/python-net/aspose.cells.charts/trendline/theme_color) | Получает и задает цвет темы.|
| [color](/cells/ru/python-net/aspose.cells.charts/trendline/color) | Представляет цвет линии.|
| [transparency](/cells/ru/python-net/aspose.cells.charts/trendline/transparency) | Возвращает или задает степень прозрачности линии в виде значения от 0,0 (непрозрачная) до 1,0 (прозрачная).|
| [style](/cells/ru/python-net/aspose.cells.charts/trendline/style) | Представляет стиль линии.|
| [weight](/cells/ru/python-net/aspose.cells.charts/trendline/weight) | Получает или задает [WeightType](/cells/ru/python-net/aspose.cells.drawing/weighttype) строки.|
