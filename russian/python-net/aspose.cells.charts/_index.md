...
type: docs
weight: 10
url: /ru/python-net/aspose.cells.charts/
is_root: false
---
**Aspose.Cells.Charts** namespace предоставляет классы, позволяющие получать доступ и рисовать диаграммы и спарклайны в электронных таблицах Excel Microsoft.

###  Классы
| Сорт| Описание|
| :- | :- |
| [Axis](/cells/ru/python-net/aspose.cells.charts/axis) | Инкапсулирует объект, представляющий ось диаграммы.|
...
| [DisplayUnitLabel](/cells/ru/python-net/aspose.cells.charts/displayunitlabel) | Представляет метку единицы отображения.|
| [DropBars](/cells/ru/python-net/aspose.cells.charts/dropbars) | Представляет столбцы вверх/вниз на диаграмме.|
| [ErrorBar](/cells/ru/python-net/aspose.cells.charts/errorbar) | Представляет планку погрешностей ряда данных.|
| [Floor](/cells/ru/python-net/aspose.cells.charts/floor) | Инкапсулирует объект, представляющий нижнюю часть трехмерной диаграммы.|
| [Legend](/cells/ru/python-net/aspose.cells.charts/legend) | Инкапсулирует объект, представляющий легенду диаграммы.|
| [LegendEntry](/cells/ru/python-net/aspose.cells.charts/legendentry) | Представляет запись легенды в легенде диаграммы.|
| [LegendEntryCollection](/cells/ru/python-net/aspose.cells.charts/legendentrycollection) | Представляет коллекцию всех объектов [LegendEntry](/cells/ru/python-net/aspose.cells.charts/legendentry) в указанной легенде диаграммы.|
...
| [Trendline](/cells/ru/python-net/aspose.cells.charts/trendline) | Представляет линию тренда на диаграмме.|
| [TrendlineCollection](/cells/ru/python-net/aspose.cells.charts/trendlinecollection) | Представляет коллекцию всех объектов [Trendline](/cells/ru/python-net/aspose.cells.charts/trendline) для указанного ряда данных.|
| [Walls](/cells/ru/python-net/aspose.cells.charts/walls) | Инкапсулирует объект, представляющий стены трехмерной диаграммы.|
...
| [ChartMarkerType](/cells/ru/python-net/aspose.cells.charts/chartmarkertype) | Представляет стиль маркера на линейной диаграмме, точечной диаграмме или лепестковой диаграмме.|
| [ChartSplitType](/cells/ru/python-net/aspose.cells.charts/chartsplittype) | Представляет способ разделения двух разделов круговой диаграммы или гистограммы круговой диаграммы.|
| [ChartTextDirectionType](/cells/ru/python-net/aspose.cells.charts/charttextdirectiontype) | Представляет тип направления текста диаграммы.|
| [ChartType](/cells/ru/python-net/aspose.cells.charts/charttype) | Перечисляет все типы диаграмм, используемые в Excel.|
| [CrossType](/cells/ru/python-net/aspose.cells.charts/crosstype) | Представляет собой ось перекрестного типа.|
| [DataLabelsSeparatorType](/cells/ru/python-net/aspose.cells.charts/datalabelsseparatortype) | Представляет тип разделителя DataLabels.|
...
| [TrendlineType](/cells/ru/python-net/aspose.cells.charts/trendlinetype) | Представляет тип линии тренда.|
