...
type: docs
weight: 230
url: /ru/python-net/aspose.cells.charts/series/
is_root: false
---
##  Series класс
...
| [count_of_data_values](/cells/ru/python-net/aspose.cells.charts/series/count_of_data_values) | Получает количество значений данных.|
| [is_vertical_values](/cells/ru/python-net/aspose.cells.charts/series/is_vertical_values) | Указывает, является ли источник данных вертикальным.|
...
| [split_type](/cells/ru/python-net/aspose.cells.charts/series/split_type) |Возвращает или задает значение, указывающее, как определить, какие точки данных находятся на втором круге или столбце на круге или столбце.<br/> круговая диаграмма.|
| [split_value](/cells/ru/python-net/aspose.cells.charts/series/split_value) | Возвращает или задает значение, которое должно использоваться для определения того, какие точки данных находятся на втором круге или столбце на<br/> круговая диаграмма или полоса круговой диаграммы.|
...
| Метод| Описание|
| :- | :- |
| [move(count)](/cells/ru/python-net/aspose.cells.charts/series/move/#int) | Перемещает серию вверх или вниз.|
...
* класс [DropBars](/cells/ru/python-net/aspose.cells.charts/dropbars)
