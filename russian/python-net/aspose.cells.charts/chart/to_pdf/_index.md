...
type: docs
weight: 130
url: /ru/python-net/aspose.cells.charts/chart/to_pdf/
is_root: false
---
...
| desired_page_height | float | Желаемая высота страницы в дюймах.|
| h_alignment_type | [PageLayoutAlignmentType](/cells/ru/python-net/aspose.cells/pagelayoutalignmenttype) | Тип горизонтального выравнивания диаграммы на выходной странице.|
| v_alignment_type | [PageLayoutAlignmentType](/cells/ru/python-net/aspose.cells/pagelayoutalignmenttype) | Тип вертикального выравнивания диаграммы на выходной странице.|
