...
type: docs
weight: 350
url: /ru/python-net/aspose.cells.charts/walls/
is_root: false
---
##  Walls класс
...
**Наследование:** [Walls](/cells/python-net/aspose.cells.charts/walls) → 
[Floor](/cells/python-net/aspose.cells.charts/floor) → 
[Area](/cells/ru/python-net/aspose.cells.drawing/area)



Тип Walls предоставляет следующие члены:

###  Характеристики
| Свойство| Описание|
| :- | :- |
| [background_color](/cells/ru/python-net/aspose.cells.charts/walls/background_color) | Получает или задает цвет фона объекта [Area](/cells/ru/python-net/aspose.cells.drawing/area).|
| [foreground_color](/cells/ru/python-net/aspose.cells.charts/walls/foreground_color) | Получает или задает цвет переднего плана.|
| [formatting](/cells/ru/python-net/aspose.cells.charts/walls/formatting) | Представляет форматирование области.|
| [invert_if_negative](/cells/ru/python-net/aspose.cells.charts/walls/invert_if_negative) | Если свойство истинно и значение точки диаграммы является отрицательным числом,<br/> цвет переднего плана и цвет фона будут заменены.|
| [fill_format](/cells/ru/python-net/aspose.cells.charts/walls/fill_format) | Представляет объект [Area.fill_format](/cells/ru/python-net/aspose.cells.drawing/area#fill_format), содержащий свойства форматирования заливки для указанной диаграммы или фигуры.|
| [transparency](/cells/ru/python-net/aspose.cells.charts/walls/transparency) | Возвращает или задает степень прозрачности области в виде значения от 0,0 (непрозрачная) до 1,0 (прозрачная).|
...
* класс [Area](/cells/ru/python-net/aspose.cells.drawing/area)
* класс [Floor](/cells/ru/python-net/aspose.cells.charts/floor)
* класс [Line](/cells/ru/python-net/aspose.cells.drawing/line)
* класс [Walls](/cells/ru/python-net/aspose.cells.charts/walls)
