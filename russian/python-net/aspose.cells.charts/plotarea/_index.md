...
type: docs
weight: 220
url: /ru/python-net/aspose.cells.charts/plotarea/
is_root: false
---
##  PlotArea класс
...
**Наследование:** [PlotArea](/cells/python-net/aspose.cells.charts/plotarea) → 
[ChartFrame](/cells/ru/python-net/aspose.cells.charts/chartframe)



Тип PlotArea предоставляет следующие члены:

###  Характеристики
| Свойство| Описание|
| :- | :- |
| [is_inner_mode](/cells/ru/python-net/aspose.cells.charts/plotarea/is_inner_mode) | Указывает, включает ли размер области графика деления и метки осей.<br/> False указывает, что размер должен определять размер области графика, делений и меток осей.|
| [border](/cells/ru/python-net/aspose.cells.charts/plotarea/border) | Получает [Line](/cells/ru/python-net/aspose.cells.drawing/line).|
| [area](/cells/ru/python-net/aspose.cells.charts/plotarea/area) | Получает [ChartFrame.area](/cells/ru/python-net/aspose.cells.charts/chartframe#area).|
...
| [is_default_pos_be_set](/cells/ru/python-net/aspose.cells.charts/plotarea/is_default_pos_be_set) | Указывает, задана ли позиция по умолчанию (DefaultX, DefaultY, DefaultWidth и DefaultHeight).|
...
| [inner_width](/cells/ru/python-net/aspose.cells.charts/plotarea/inner_width) | Получает или задает ширину области графика в единицах, равных 1/4000 области диаграммы.|


###  Методы
| Метод| Описание|
| :- | :- |
| [set_position_auto()](/cells/ru/python-net/aspose.cells.charts/plotarea/set_position_auto/#) | Установите положение области графика на автоматический|
