...
type: docs
weight: 120
url: /ru/python-net/aspose.cells.charts/datalabels/
is_root: false
---
##  DataLabels класс
...
**Наследование:** [DataLabels](/cells/python-net/aspose.cells.charts/datalabels) → 
...
| Свойство| Описание|
| :- | :- |
| [is_inner_mode](/cells/ru/python-net/aspose.cells.charts/datalabels/is_inner_mode) | Указывает, включает ли размер области графика деления и метки осей.<br/> False указывает, что размер должен определять размер области графика, делений и меток осей.|
| [border](/cells/ru/python-net/aspose.cells.charts/datalabels/border) | Получает [Line](/cells/ru/python-net/aspose.cells.drawing/line).|
| [area](/cells/ru/python-net/aspose.cells.charts/datalabels/area) | Получает [DataLabels.area](/cells/ru/python-net/aspose.cells.charts/datalabels#area).|
...
| [x](/cells/ru/python-net/aspose.cells.charts/datalabels/x) | Получает или задает координату x левого верхнего угла в единицах 1/4000 области диаграммы.|
| [y](/cells/ru/python-net/aspose.cells.charts/datalabels/y) | Получает или задает координату Y верхнего левого угла в единицах 1/4000 области диаграммы.|
| [height](/cells/ru/python-net/aspose.cells.charts/datalabels/height) | Получает или задает высоту рамки в единицах 1/4000 области диаграммы.|
| [width](/cells/ru/python-net/aspose.cells.charts/datalabels/width) |Получает или задает ширину рамки в единицах 1/4000 области диаграммы.|
| [shadow](/cells/ru/python-net/aspose.cells.charts/datalabels/shadow) | Истинно, если у кадра есть тень.|
| [shape_properties](/cells/ru/python-net/aspose.cells.charts/datalabels/shape_properties) | Получает объект [ChartFrame.shape_properties](/cells/ru/python-net/aspose.cells.charts/chartframe#shape_properties).|
| [is_default_pos_be_set](/cells/ru/python-net/aspose.cells.charts/datalabels/is_default_pos_be_set) | Указывает, задана ли позиция по умолчанию (DefaultX, DefaultY, DefaultWidth и DefaultHeight).|
| [default_x](/cells/ru/python-net/aspose.cells.charts/datalabels/default_x) | Представляет x позиции по умолчанию|
| [default_y](/cells/ru/python-net/aspose.cells.charts/datalabels/default_y) | Представляет y положения по умолчанию|
...
| [default_height](/cells/ru/python-net/aspose.cells.charts/datalabels/default_height) | Представляет высоту положения по умолчанию|
...
| [is_automatic_rotation](/cells/ru/python-net/aspose.cells.charts/datalabels/is_automatic_rotation) | Указывает, поворачивается ли текст диаграммы автоматически.|
| [text](/cells/ru/python-net/aspose.cells.charts/datalabels/text) | Получает или задает текст метки данных.|
| [linked_source](/cells/ru/python-net/aspose.cells.charts/datalabels/linked_source) |Получает и задает ссылку на рабочий лист.|
| [text_direction](/cells/ru/python-net/aspose.cells.charts/datalabels/text_direction) | Представляет порядок чтения текста.|
...
| [number_format_linked](/cells/ru/python-net/aspose.cells.charts/datalabels/number_format_linked) | Истинно, если числовой формат связан с ячейками<br/> (чтобы формат числа менялся в метках при изменении в ячейках).|
| [separator](/cells/ru/python-net/aspose.cells.charts/datalabels/separator) | Получает или задает тип разделителя, используемый для меток данных на диаграмме.|
...
| Метод| Описание|
| :- | :- |
| [set_position_auto()](/cells/ru/python-net/aspose.cells.charts/datalabels/set_position_auto/#) | Установите положение кадра на автоматический|
| [characters(start_index, length)](/cells/ru/python-net/aspose.cells.charts/datalabels/characters/#int-int) |Возвращает объект Characters, представляющий диапазон символов в тексте.|
...
* класс [ChartTextFrame](/cells/ru/python-net/aspose.cells.charts/charttextframe)
* класс [DataLabels](/cells/ru/python-net/aspose.cells.charts/datalabels)
