...
type: docs
weight: 80
url: /ru/python-net/aspose.cells.charts/chartglobalizationsettings/
is_root: false
---
...
Тип ChartGlobalizationSettings предоставляет следующие члены:

###  Конструкторы
| Конструктор| Описание|
| :- | :- |
| [ChartGlobalizationSettings()](/cells/ru/python-net/aspose.cells.charts/chartglobalizationsettings/__init__/#) | Создает новый экземпляр ChartGlobalizationSettings|
