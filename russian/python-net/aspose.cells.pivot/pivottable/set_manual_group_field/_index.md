...
type: docs
weight: 210
url: /ru/python-net/aspose.cells.pivot/pivottable/set_manual_group_field/
is_root: false
---
##  set_manual_group_field(base_field_index, start_val, end_val, group_by_list, interval_num) {#int-float-float-list-float}
Задает ручные группы полей по сводной таблице.
...
| group_by_list | list | Задает список типов группировки.|
...
| group_by_list | list | Задает список типов группировки.|
| interval_num | int | Указывает группу чисел интервала по дням группировки.Количество дней должно быть положительным целым числом, отличным от нуля.|
