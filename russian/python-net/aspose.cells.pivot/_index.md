...
type: docs
weight: 10
url: /ru/python-net/aspose.cells.pivot/
is_root: false
---
**Aspose.Cells.Pivot** namespace содержит все классы рендеринга и управления сводными таблицами в файлах электронных таблиц Excel.
...
| [PivotFormatCondition](/cells/ru/python-net/aspose.cells.pivot/pivotformatcondition) | Представляет условие формата сводной таблицы в коллекции PivotFormatCondition.|
| [PivotFormatConditionCollection](/cells/ru/python-net/aspose.cells.pivot/pivotformatconditioncollection) | Представляет условия формата сводной таблицы.|
| [PivotItem](/cells/ru/python-net/aspose.cells.pivot/pivotitem) | Представляет элемент в отчете PivotField.|
| [PivotItemCollection](/cells/ru/python-net/aspose.cells.pivot/pivotitemcollection) | Представляет коллекцию всех объектов PivotItem в поле PivotField.|
| [PivotPageFields](/cells/ru/python-net/aspose.cells.pivot/pivotpagefields) | Представляет элементы поля сводной страницы.<br/>если источником данных сводной таблицы являются диапазоны консолидации.<br/> Он может содержать не более 4 полей.|
| [PivotTable](/cells/ru/python-net/aspose.cells.pivot/pivottable) | Краткое описание сводной таблицы.|
| [PivotTableCollection](/cells/ru/python-net/aspose.cells.pivot/pivottablecollection) | Представляет коллекцию всех объектов сводной таблицы на указанном листе.|
| [SxRng](/cells/ru/python-net/aspose.cells.pivot/sxrng) | Представляет диапазон группы в PivotField.|
