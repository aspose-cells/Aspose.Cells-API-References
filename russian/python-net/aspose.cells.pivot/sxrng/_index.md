...
type: docs
weight: 120
url: /ru/python-net/aspose.cells.pivot/sxrng/
is_root: false
---
##  SxRng класс
Представляет диапазон группы в PivotField.



Тип SxRng предоставляет следующие члены:
...
| [by](/cells/ru/python-net/aspose.cells.pivot/sxrng/by) | Представляет объект интервала для диапазона группы.|
| [group_by_types](/cells/ru/python-net/aspose.cells.pivot/sxrng/group_by_types) | Представляет тип группы для диапазона групп.<br/> rangeofvalue Секунды Минуты Часы Дни Месяцы Кварталы Годы|
