...
type: docs
weight: 70
url: /ru/python-net/aspose.cells.pivot/pivotitem/
is_root: false
---
##  PivotItem класс
...
Тип PivotItem предоставляет следующие члены:

###  Характеристики
| Свойство| Описание|
| :- | :- |
| [is_hidden](/cells/ru/python-net/aspose.cells.pivot/pivotitem/is_hidden) | Получает и задает, скрыт ли элемент сводки.|
| [is_hide_detail](/cells/ru/python-net/aspose.cells.pivot/pivotitem/is_hide_detail) | Получает и задает, скрывает ли элемент сводки детали.|
| [value](/cells/ru/python-net/aspose.cells.pivot/pivotitem/value) | Получает значение элемента сводки|
| [name](/cells/ru/python-net/aspose.cells.pivot/pivotitem/name) | Получает имя элемента сводки.|
| [index](/cells/ru/python-net/aspose.cells.pivot/pivotitem/index) | Получает индекс элемента сводки в поле сводки|
