...
type: docs
weight: 90
url: /ru/python-net/aspose.cells.pivot/pivotpagefields/
is_root: false
---
...
Тип PivotPageFields предоставляет следующие члены:

###  Конструкторы
| Конструктор| Описание|
| :- | :- |
| [PivotPageFields()](/cells/ru/python-net/aspose.cells.pivot/pivotpagefields/__init__/#) | Представляет элементы поля сводной страницы.|


###  Характеристики
| Свойство| Описание|
| :- | :- |
| [page_field_count](/cells/ru/python-net/aspose.cells.pivot/pivotpagefields/page_field_count) | Получает количество полей страницы.|
