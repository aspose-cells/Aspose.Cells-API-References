...
type: docs
weight: 30
url: /ru/python-net/aspose.cells.pivot/pivotfilter/
is_root: false
---
##  PivotFilter класс
...
| [member_property_field_index](/cells/ru/python-net/aspose.cells.pivot/pivotfilter/member_property_field_index) | Получает индекс поля свойства члена сводного фильтра.|
| [name](/cells/ru/python-net/aspose.cells.pivot/pivotfilter/name) | Получает имя сводного фильтра.|
| [evaluation_order](/cells/ru/python-net/aspose.cells.pivot/pivotfilter/evaluation_order) | Получает порядок оценки сводного фильтра.|
