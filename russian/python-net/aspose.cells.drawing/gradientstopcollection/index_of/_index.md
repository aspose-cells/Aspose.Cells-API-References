...
type: docs
weight: 50
url: /ru/python-net/aspose.cells.drawing/gradientstopcollection/index_of/
is_root: false
---
...
| :- | :- | :- |
| item | [GradientStop](/cells/ru/python-net/aspose.cells.drawing/gradientstop) | Объект, который нужно найти в списке массивов. Значение может быть нулевым.|
