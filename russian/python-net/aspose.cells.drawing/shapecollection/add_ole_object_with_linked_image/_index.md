---
title: add_ole_object_with_linked_image метод
second_title: Aspose.Cells for Python via .NET API
description:
type: docs
weight: 190
url: /ru/python-net/aspose.cells.drawing/shapecollection/add_ole_object_with_linked_image/
is_root: false
---
##  add_ole_object_with_linked_image(upper_left_row, upper_left_column, height, width, source_full_name) {#int-int-int-int-str}
Добавьте связанное изображение.


###  Возвращает

[Picture](/cells/ru/python-net/aspose.cells.drawing/picture) Объект изображения.
