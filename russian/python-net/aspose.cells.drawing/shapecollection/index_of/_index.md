...
type: docs
weight: 430
url: /ru/python-net/aspose.cells.drawing/shapecollection/index_of/
is_root: false
---
...
| :- | :- | :- |
| item | [Shape](/cells/ru/python-net/aspose.cells.drawing/shape) | Объект, который нужно найти в списке массивов. Значение может быть нулевым.|
