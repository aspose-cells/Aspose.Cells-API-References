...
type: docs
weight: 610
url: /ru/python-net/aspose.cells.drawing/shapepropertycollection/
is_root: false
---
##  ShapePropertyCollection класс
Этот класс определяет свойства визуальной фигуры для элемента диаграммы или фигуры.



Тип ShapePropertyCollection предоставляет следующие члены:
...
| [clear_shadow_effect()](/cells/ru/python-net/aspose.cells.drawing/shapepropertycollection/clear_shadow_effect/#) | Удаляет эффект тени элемента или фигуры диаграммы.|
| [has_shadow_effect()](/cells/ru/python-net/aspose.cells.drawing/shapepropertycollection/has_shadow_effect/#) | Указывает, есть ли у фигуры данные эффекта тени.|
