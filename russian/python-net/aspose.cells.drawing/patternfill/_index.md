---
title: PatternFill класс
second_title: Aspose.Cells for Python via .NET API
description:
type: docs
weight: 430
url: /ru/python-net/aspose.cells.drawing/patternfill/
is_root: false
---
##  PatternFill класс
Инкапсулирует объект, представляющий формат заполнения узором.



**Наследование:** [PatternFill](/cells/python-net/aspose.cells.drawing/patternfill) → 
[Fill](/cells/ru/python-net/aspose.cells.drawing/fill)



Тип PatternFill предоставляет следующие члены:
...
* класс [PatternFill](/cells/ru/python-net/aspose.cells.drawing/patternfill)
