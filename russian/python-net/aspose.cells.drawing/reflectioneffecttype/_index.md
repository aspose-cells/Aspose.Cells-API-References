---
title: ReflectionEffectType перечисление
second_title: Aspose.Cells for Python via .NET API
description:
type: docs
weight: 1120
url: /ru/python-net/aspose.cells.drawing/reflectioneffecttype/
is_root: false
---
##  ReflectionEffectType перечисление
Представляет тип эффекта отражения.



Тип ReflectionEffectType предоставляет следующие члены:

###  Поля
| Поле| Описание|
| :- | :- |
| NONE | Нет эффекта отражения.|
| CUSTOM | Пользовательский эффект отражения.|
