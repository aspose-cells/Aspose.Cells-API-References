...
type: docs
weight: 270
url: /ru/python-net/aspose.cells.drawing/groupshape/
is_root: false
---
##  GroupShape класс
Представляет фигуру группы, которая содержит отдельные фигуры.
...
Тип GroupShape предоставляет следующие члены:

###  Характеристики
| Свойство| Описание|
| :- | :- |
| [macro_name](/cells/ru/python-net/aspose.cells.drawing/groupshape/macro_name) | Получает и задает имя макроса.|
...
| [placement](/cells/ru/python-net/aspose.cells.drawing/groupshape/placement) | Представляет способ прикрепления объекта рисования к ячейкам под ним.<br/> Свойство управляет размещением объекта на рабочем листе.|
| [upper_left_row](/cells/ru/python-net/aspose.cells.drawing/groupshape/upper_left_row) | Представляет индекс строки в верхнем левом углу.|
| [upper_delta_y](/cells/ru/python-net/aspose.cells.drawing/groupshape/upper_delta_y) | Получает или задает вертикальное смещение фигуры от ее верхнего левого углового ряда.|
| [upper_left_column](/cells/ru/python-net/aspose.cells.drawing/groupshape/upper_left_column) | Представляет индекс столбца в левом верхнем углу.|
| [upper_delta_x](/cells/ru/python-net/aspose.cells.drawing/groupshape/upper_delta_x) | Получает или задает смещение фигуры по горизонтали от ее верхнего левого углового столбца.|
| [lower_right_row](/cells/ru/python-net/aspose.cells.drawing/groupshape/lower_right_row) | Представляет индекс строки в правом нижнем углу.|
| [lower_delta_y](/cells/ru/python-net/aspose.cells.drawing/groupshape/lower_delta_y) | Получает или задает вертикальное смещение фигуры от ее нижнего правого углового ряда.|
...
| [height_pt](/cells/ru/python-net/aspose.cells.drawing/groupshape/height_pt) | Представляет высоту фигуры в точках.|
| [height_cm](/cells/ru/python-net/aspose.cells.drawing/groupshape/height_cm) | Представляет высоту фигуры в сантиметрах.|
| [left](/cells/ru/python-net/aspose.cells.drawing/groupshape/left) | Представляет горизонтальное смещение фигуры от ее левого столбца в единицах пикселей.|
...
| [has_line](/cells/ru/python-net/aspose.cells.drawing/groupshape/has_line) | Получает и задает видимую границу линии фигуры.|
| [is_filled](/cells/ru/python-net/aspose.cells.drawing/groupshape/is_filled) | Указывает, виден ли формат заполнения.|
| [is_flipped_horizontally](/cells/ru/python-net/aspose.cells.drawing/groupshape/is_flipped_horizontally) | Получает и задает, отражается ли фигура по горизонтали.|
| [is_flipped_vertically](/cells/ru/python-net/aspose.cells.drawing/groupshape/is_flipped_vertically) | Получает и задает, отражается ли фигура по вертикали.|
| [actual_lower_right_row](/cells/ru/python-net/aspose.cells.drawing/groupshape/actual_lower_right_row) | Получите фактическую нижнюю строку.|
| [connection_points](/cells/ru/python-net/aspose.cells.drawing/groupshape/connection_points) | Получите точки подключения|
...
| [text](/cells/ru/python-net/aspose.cells.drawing/groupshape/text) | Представляет строку в этом объекте TextBox.|
...
| [text_vertical_alignment](/cells/ru/python-net/aspose.cells.drawing/groupshape/text_vertical_alignment) | Получает и задает тип вертикального выравнивания текста фигуры.|
...
| [create_id](/cells/ru/python-net/aspose.cells.drawing/groupshape/create_id) | Получает и задает идентификатор создания для этой фигуры.|
...
| Метод| Описание|
| :- | :- |
| [to_image(stream, image_type)](/cells/ru/python-net/aspose.cells.drawing/groupshape/to_image/#io.RawIOBase-ImageType) | Создает изображение формы и сохраняет его в потоке в указанном формате.|
| [to_image(image_file, options)](/cells/ru/python-net/aspose.cells.drawing/groupshape/to_image/#str-aspose.cells.rendering.ImageOrPrintOptions) | Сохраняет форму в файл.|
| [to_image(stream, options)](/cells/ru/python-net/aspose.cells.drawing/groupshape/to_image/#io.RawIOBase-aspose.cells.rendering.ImageOrPrintOptions) | Сохраняет форму в поток.|
| [format_characters(start_index, length, font, flag)](/cells/ru/python-net/aspose.cells.drawing/groupshape/format_characters/#int-int-Font-StyleFlag) | Форматирует некоторые символы с настройкой шрифта.|
| [format_characters(start_index, length, font)](/cells/ru/python-net/aspose.cells.drawing/groupshape/format_characters/#int-int-Font) | Форматирует некоторые символы с настройкой шрифта.|
| [get_result_of_smart_art()](/cells/ru/python-net/aspose.cells.drawing/groupshape/get_result_of_smart_art/#) | Преобразование смарт-арта в сгруппированные фигуры.|
| [to_front_or_back(orders)](/cells/ru/python-net/aspose.cells.drawing/groupshape/to_front_or_back/#int) | Выводит фигуру на передний план или отправляет фигуру на задний план.|
| [get_locked_property(type)](/cells/ru/python-net/aspose.cells.drawing/groupshape/get_locked_property/#ShapeLockType) | Получает значение заблокированного свойства.|
| [set_locked_property(type, value)](/cells/ru/python-net/aspose.cells.drawing/groupshape/set_locked_property/#ShapeLockType-bool) | Установите заблокированное свойство.|
...
* класс [GroupShape](/cells/ru/python-net/aspose.cells.drawing/groupshape)
