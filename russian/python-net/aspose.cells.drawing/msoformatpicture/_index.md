---
title: MsoFormatPicture класс
second_title: Aspose.Cells for Python via .NET API
description:
type: docs
weight: 350
url: /ru/python-net/aspose.cells.drawing/msoformatpicture/
is_root: false
---
##  MsoFormatPicture класс
Представляет формат изображения.



Тип MsoFormatPicture предоставляет следующие члены:
...
| [brightness](/cells/ru/python-net/aspose.cells.drawing/msoformatpicture/brightness) | Представляет изменение яркости изображения в процентах.|
| [gamma](/cells/ru/python-net/aspose.cells.drawing/msoformatpicture/gamma) | Представляет гамму изображения.|
| [is_bi_level](/cells/ru/python-net/aspose.cells.drawing/msoformatpicture/is_bi_level) | Указывает, должно ли это изображение отображаться в двухцветном черно-белом режиме.|
| [is_gray](/cells/ru/python-net/aspose.cells.drawing/msoformatpicture/is_gray) | Указывает, ДОЛЖНО ли это изображение отображаться в оттенках серого.|
