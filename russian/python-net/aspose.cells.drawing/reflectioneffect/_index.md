...
type: docs
weight: 490
url: /ru/python-net/aspose.cells.drawing/reflectioneffect/
is_root: false
---
##  ReflectionEffect класс
Этот класс определяет эффект отражения.



Тип ReflectionEffect предоставляет следующие члены:
...
| [distance](/cells/ru/python-net/aspose.cells.drawing/reflectioneffect/distance) | Получает и задает расстояние до тени в точках.|
| [fade_direction](/cells/ru/python-net/aspose.cells.drawing/reflectioneffect/fade_direction) | Получает и задает направление смещения отражения.|
| [rot_with_shape](/cells/ru/python-net/aspose.cells.drawing/reflectioneffect/rot_with_shape) | Получает и задает, должно ли отражение вращаться вместе с фигурой.|
