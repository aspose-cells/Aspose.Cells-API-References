...
type: docs
weight: 50
url: /ru/python-net/aspose.cells.drawing/picturecollection/index_of/
is_root: false
---
...
| :- | :- | :- |
| item | [Picture](/cells/ru/python-net/aspose.cells.drawing/picture) | Объект, который нужно найти в списке массивов. Значение может быть нулевым.|
