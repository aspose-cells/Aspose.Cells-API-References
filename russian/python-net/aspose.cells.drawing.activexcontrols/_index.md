...
type: docs
weight: 10
url: /ru/python-net/aspose.cells.drawing.activexcontrols/
is_root: false
---
**Aspose.Cells.Drawing.ActiveXControls** namespace предоставляет классы, которые позволяют рисовать и получать доступ к ActiveXControl.

###  Классы
| Сорт| Описание|
| :- | :- |
| [ActiveXControl](/cells/ru/python-net/aspose.cells.drawing.activexcontrols/activexcontrol) | Представляет элемент управления ActiveX.|
| [ActiveXControlBase](/cells/ru/python-net/aspose.cells.drawing.activexcontrols/activexcontrolbase) | Представляет элемент управления ActiveX.|
...
| [ScrollBarActiveXControl](/cells/ru/python-net/aspose.cells.drawing.activexcontrols/scrollbaractivexcontrol) | Представляет элемент управления ScrollBar.|
| [SpinButtonActiveXControl](/cells/ru/python-net/aspose.cells.drawing.activexcontrols/spinbuttonactivexcontrol) | Представляет элемент управления SpinButton.|
| [TextBoxActiveXControl](/cells/ru/python-net/aspose.cells.drawing.activexcontrols/textboxactivexcontrol) | Представляет элемент управления ActiveX текстового поля.|
| [ToggleButtonActiveXControl](/cells/ru/python-net/aspose.cells.drawing.activexcontrols/togglebuttonactivexcontrol) | Представляет элемент управления ActiveX ToggleButton.|
| [UnknownControl](/cells/ru/python-net/aspose.cells.drawing.activexcontrols/unknowncontrol) | Неизвестный контроль.|
...
| [ControlType](/cells/ru/python-net/aspose.cells.drawing.activexcontrols/controltype) | Представляет все типы элементов управления ActiveX.|
| [DropButtonStyle](/cells/ru/python-net/aspose.cells.drawing.activexcontrols/dropbuttonstyle) | Представляет символ, отображаемый на раскрывающейся кнопке.|
| [InputMethodEditorMode](/cells/ru/python-net/aspose.cells.drawing.activexcontrols/inputmethodeditormode) | Представляет режим выполнения по умолчанию для редактора методов ввода.|
| [ShowDropButtonType](/cells/ru/python-net/aspose.cells.drawing.activexcontrols/showdropbuttontype) | Указывает, когда показывать кнопку сброса|
