...
type: docs
weight: 80
url: /ru/python-net/aspose.cells.drawing.activexcontrols/listboxactivexcontrol/
is_root: false
---
##  ListBoxActiveXControl класс
Представляет элемент управления ActiveX ListBox.



**Наследование:** [ListBoxActiveXControl](/cells/python-net/aspose.cells.drawing.activexcontrols/listboxactivexcontrol) → 
...
Тип ListBoxActiveXControl предоставляет следующие члены:
...
| [shadow](/cells/ru/python-net/aspose.cells.drawing.activexcontrols/listboxactivexcontrol/shadow) | Указывает, показывать ли тень.|
| [linked_cell](/cells/ru/python-net/aspose.cells.drawing.activexcontrols/listboxactivexcontrol/linked_cell) | Получает и задает связанную ячейку.|
| [list_fill_range](/cells/ru/python-net/aspose.cells.drawing.activexcontrols/listboxactivexcontrol/list_fill_range) | Получает и задает диапазон заполнения списка.|
...
| [special_effect](/cells/ru/python-net/aspose.cells.drawing.activexcontrols/listboxactivexcontrol/special_effect) | Получает и задает специальный эффект элемента управления.|
| [show_column_heads](/cells/ru/python-net/aspose.cells.drawing.activexcontrols/listboxactivexcontrol/show_column_heads) | Указывает, отображаются ли заголовки столбцов.|
| [integral_height](/cells/ru/python-net/aspose.cells.drawing.activexcontrols/listboxactivexcontrol/integral_height) | Указывает, будет ли элемент управления отображать только полные строки текста без отображения каких-либо частичных строк.|
| [column_widths](/cells/ru/python-net/aspose.cells.drawing.activexcontrols/listboxactivexcontrol/column_widths) | Получает и задает ширину столбца.|
...
* класс [ListBoxActiveXControl](/cells/ru/python-net/aspose.cells.drawing.activexcontrols/listboxactivexcontrol)
