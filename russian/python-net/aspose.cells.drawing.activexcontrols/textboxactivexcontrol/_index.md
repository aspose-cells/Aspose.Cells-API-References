...
type: docs
weight: 120
url: /ru/python-net/aspose.cells.drawing.activexcontrols/textboxactivexcontrol/
is_root: false
---
##  TextBoxActiveXControl класс
Представляет элемент управления ActiveX текстового поля.



**Наследование:** [TextBoxActiveXControl](/cells/python-net/aspose.cells.drawing.activexcontrols/textboxactivexcontrol) → 
...
Тип TextBoxActiveXControl предоставляет следующие члены:
...
| [shadow](/cells/ru/python-net/aspose.cells.drawing.activexcontrols/textboxactivexcontrol/shadow) | Указывает, показывать ли тень.|
| [linked_cell](/cells/ru/python-net/aspose.cells.drawing.activexcontrols/textboxactivexcontrol/linked_cell) | Получает и задает связанную ячейку.|
| [list_fill_range](/cells/ru/python-net/aspose.cells.drawing.activexcontrols/textboxactivexcontrol/list_fill_range) | Получает и задает диапазон заполнения списка.|
...
* класс [TextBoxActiveXControl](/cells/ru/python-net/aspose.cells.drawing.activexcontrols/textboxactivexcontrol)
