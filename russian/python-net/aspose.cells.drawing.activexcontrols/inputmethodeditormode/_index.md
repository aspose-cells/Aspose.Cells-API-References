...
type: docs
weight: 290
url: /ru/python-net/aspose.cells.drawing.activexcontrols/inputmethodeditormode/
is_root: false
---
##  InputMethodEditorMode перечисление
Представляет режим выполнения по умолчанию для редактора методов ввода.
...
| DISABLE | IME выключен. Пользователь не может включить IME с клавиатуры.|
...
| HANZI | IME включен в режиме половинной ширины Hanzi.|
