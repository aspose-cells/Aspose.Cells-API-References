...
type: docs
weight: 70
url: /ru/python-net/aspose.cells.drawing.activexcontrols/labelactivexcontrol/
is_root: false
---
##  LabelActiveXControl класс
Представляет метку элемента управления ActiveX.



**Наследование:** [LabelActiveXControl](/cells/python-net/aspose.cells.drawing.activexcontrols/labelactivexcontrol) → 
...
Тип LabelActiveXControl предоставляет следующие члены:
...
| [width](/cells/ru/python-net/aspose.cells.drawing.activexcontrols/labelactivexcontrol/width) |Получает и задает ширину элемента управления в точках.|
...
| [shadow](/cells/ru/python-net/aspose.cells.drawing.activexcontrols/labelactivexcontrol/shadow) | Указывает, показывать ли тень.|
| [linked_cell](/cells/ru/python-net/aspose.cells.drawing.activexcontrols/labelactivexcontrol/linked_cell) | Получает и задает связанную ячейку.|
| [list_fill_range](/cells/ru/python-net/aspose.cells.drawing.activexcontrols/labelactivexcontrol/list_fill_range) | Получает и задает диапазон заполнения списка.|
...
| [picture_position](/cells/ru/python-net/aspose.cells.drawing.activexcontrols/labelactivexcontrol/picture_position) | Получает и задает расположение изображения элемента управления относительно его заголовка.|
...
* класс [LabelActiveXControl](/cells/ru/python-net/aspose.cells.drawing.activexcontrols/labelactivexcontrol)
