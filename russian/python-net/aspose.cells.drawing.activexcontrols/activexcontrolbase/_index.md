---
title: ActiveXControlBase класс
second_title: Aspose.Cells for Python via .NET API
description:
type: docs
weight: 20
url: /ru/python-net/aspose.cells.drawing.activexcontrols/activexcontrolbase/
is_root: false
---
##  ActiveXControlBase класс
Представляет элемент управления ActiveX.



Тип ActiveXControlBase предоставляет следующие члены:
...
| [shadow](/cells/ru/python-net/aspose.cells.drawing.activexcontrols/activexcontrolbase/shadow) | Указывает, показывать ли тень.|
| [linked_cell](/cells/ru/python-net/aspose.cells.drawing.activexcontrols/activexcontrolbase/linked_cell) | Получает и задает связанную ячейку.|
| [list_fill_range](/cells/ru/python-net/aspose.cells.drawing.activexcontrols/activexcontrolbase/list_fill_range) | Получает и задает диапазон заполнения списка.|
| [data](/cells/ru/python-net/aspose.cells.drawing.activexcontrols/activexcontrolbase/data) | Получает и задает двоичные данные элемента управления.|
