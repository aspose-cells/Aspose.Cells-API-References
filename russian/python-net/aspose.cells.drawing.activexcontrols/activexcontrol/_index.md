...
type: docs
weight: 10
url: /ru/python-net/aspose.cells.drawing.activexcontrols/activexcontrol/
is_root: false
---
##  ActiveXControl класс
Представляет элемент управления ActiveX.



**Наследование:** [ActiveXControl](/cells/python-net/aspose.cells.drawing.activexcontrols/activexcontrol) → 
[ActiveXControlBase](/cells/ru/python-net/aspose.cells.drawing.activexcontrols/activexcontrolbase)



Тип ActiveXControl предоставляет следующие члены:
...
| [shadow](/cells/ru/python-net/aspose.cells.drawing.activexcontrols/activexcontrol/shadow) | Указывает, показывать ли тень.|
| [linked_cell](/cells/ru/python-net/aspose.cells.drawing.activexcontrols/activexcontrol/linked_cell) | Получает и задает связанную ячейку.|
| [list_fill_range](/cells/ru/python-net/aspose.cells.drawing.activexcontrols/activexcontrol/list_fill_range) | Получает и задает диапазон заполнения списка.|
