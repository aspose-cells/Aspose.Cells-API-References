...
type: docs
weight: 10
url: /ru/python-net/aspose.cells.externalconnections/
is_root: false
---
**Aspose.Cells.ExternalConnections** namespace предоставляет классы для внешних подключений для извлечения данных из внешних источников, таких как базы данных и Интернет.

###  Классы
| Сорт| Описание|
| :- | :- |
| [ConnectionParameter](/cells/ru/python-net/aspose.cells.externalconnections/connectionparameter) | Указывает свойства любых параметров, используемых с внешними подключениями к данным.<br/> Параметры действительны для ODBC и веб-запросов.|
| [ConnectionParameterCollection](/cells/ru/python-net/aspose.cells.externalconnections/connectionparametercollection) | Указывает коллекцию [ConnectionParameter](/cells/ru/python-net/aspose.cells.externalconnections/connectionparameter)|
| [DBConnection](/cells/ru/python-net/aspose.cells.externalconnections/dbconnection) | Задает все свойства, связанные с подключением к внешним данным ODBC или OLE DB.|
