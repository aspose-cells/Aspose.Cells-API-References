---
title: WebExtensionTaskPane класс
second_title: Aspose.Cells for Python via .NET API
description:
type: docs
weight: 90
url: /ru/python-net/aspose.cells.webextensions/webextensiontaskpane/
is_root: false
---
##  WebExtensionTaskPane класс
Представляет сохраняемый объект области задач.



Тип WebExtensionTaskPane предоставляет следующие члены:

###  Характеристики
| Свойство| Описание|
| :- | :- |
| [web_extension](/cells/ru/python-net/aspose.cells.webextensions/webextensiontaskpane/web_extension) | Получает и задает часть веб-расширения, связанную с экземпляром панели задач.|
