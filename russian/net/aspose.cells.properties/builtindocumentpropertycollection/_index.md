...
type: docs
weight: 4800
url: /ru/net/aspose.cells.properties/builtindocumentpropertycollection/
---
## BuiltInDocumentPropertyCollection class

Набор встроенных свойств документа.
...
| Имя | Описание |
| --- | --- |
| [Author](../../aspose.cells.properties/builtindocumentpropertycollection/author) { get; set; } | Получает или задает имя автора документа. |
| [Category](../../aspose.cells.properties/builtindocumentpropertycollection/category) { get; set; } | Получает или задает категорию документа. |
| [Comments](../../aspose.cells.properties/builtindocumentpropertycollection/comments) { get; set; } | Получает или задает комментарии к документу. |
| [Company](../../aspose.cells.properties/builtindocumentpropertycollection/company) { get; set; } | Получает или задает свойство компании. |
| [ContentStatus](../../aspose.cells.properties/builtindocumentpropertycollection/contentstatus) { get; set; } | Получает или задает статус содержимого документа. |
| [ContentType](../../aspose.cells.properties/builtindocumentpropertycollection/contenttype) { get; set; } | Получает или задает тип содержимого документа. |
| [Count](../../aspose.cells.properties/documentpropertycollection/count) { get; } | Получает количество элементов в коллекции. |
| [CreatedTime](../../aspose.cells.properties/builtindocumentpropertycollection/createdtime) { get; set; } | Получает или устанавливает дату создания документа в местном часовом поясе. |
...
| [Pages](../../aspose.cells.properties/builtindocumentpropertycollection/pages) { get; set; } | Представляет оценку количества страниц в документе. |
| [RevisionNumber](../../aspose.cells.properties/builtindocumentpropertycollection/revisionnumber) { get; set; } | Получает или задает номер редакции документа. |
| [ScaleCrop](../../aspose.cells.properties/builtindocumentpropertycollection/scalecrop) { get; set; } | Указывает режим отображения эскиза документа. |
| [Subject](../../aspose.cells.properties/builtindocumentpropertycollection/subject) { get; set; } | Получает или задает тему документа. |
| [Template](../../aspose.cells.properties/builtindocumentpropertycollection/template) { get; set; } | Получает или задает информационное имя шаблона документа. |
| [Title](../../aspose.cells.properties/builtindocumentpropertycollection/title) { get; set; } | Получает или задает заголовок документа. |
| [TotalEditingTime](../../aspose.cells.properties/builtindocumentpropertycollection/totaleditingtime) { get; set; } | Получает или задает общее время редактирования в минутах. |
| [Version](../../aspose.cells.properties/builtindocumentpropertycollection/version) { get; set; } | Представляет номер версии приложения, создавшего документ. |
| [Words](../../aspose.cells.properties/builtindocumentpropertycollection/words) { get; set; } | Представляет оценку количества слов в документе. |
