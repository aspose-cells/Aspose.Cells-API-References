...
| [Column](../../aspose.cells.griddesktop.data/gridcell/column) { get; } | Получает номер столбца (с нуля) ячейки. |
...
| [Protected](../../aspose.cells.griddesktop.data/gridcell/protected) { get; set; } | Указывает, защищена ли ячейка. Если значение равно "true", пользователь не может изменять ячейку через пользовательский интерфейс. Этот атрибут не имеет ничего общего со свойством Style.CellLocked и не будет сохранен в файл при экспорте данных сетки. Значение по умолчанию "false". |
...
| [Type](../../aspose.cells.griddesktop.data/gridcell/type) { get; } | вернуть тип значения ячейки, смысл можно увидеть GridCellValueType.java |
| [Value](../../aspose.cells.griddesktop.data/gridcell/value) { get; set; } | Получает значение, содержащееся в этой ячейке. |
| [Worksheet](../../aspose.cells.griddesktop.data/gridcell/worksheet) { get; } | Получает объект листа. |
...
| [GetFont](../../aspose.cells.griddesktop.data/gridcell/getfont)() | Получает шрифт ячейки. При изменении шрифта следует вызывать метод "SetFont", для установки шрифта в ячейку. |
| [GetFontColor](../../aspose.cells.griddesktop.data/gridcell/getfontcolor)() | Получает цвет шрифта ячейки. При изменении цвета следует вызывать метод "SetFontColor", для установки цвета шрифта в ячейку. |
| override [GetHashCode](../../aspose.cells.griddesktop.data/gridcell/gethashcode)() |  |
| [GetStyle](../../aspose.cells.griddesktop.data/gridcell/getstyle)() | Получает стиль ячейки. При изменении стиля следует вызывать метод "SetStyle", для установки стиля в ячейку. |
| [GetValidation](../../aspose.cells.griddesktop.data/gridcell/getvalidation)() | Получает проверку, которая применялась к этой ячейке. Если не установлено, возвращает значение null. |
...
| [PutValueAndSetFormatByValue](../../aspose.cells.griddesktop.data/gridcell/putvalueandsetformatbyvalue)(string) | Устанавливает значение ячейки строковым значением и устанавливает формат ячейки этим значением. |
...
| [SetCustom](../../aspose.cells.griddesktop.data/gridcell/setcustom)(string) | устанавливает пользовательский формат, ноль или пустая строка означает отсутствие пользовательского формата. |
...
| [SetFormula](../../aspose.cells.griddesktop.data/gridcell/setformula)(string, object) | Установите формулу и значение формулы. |
