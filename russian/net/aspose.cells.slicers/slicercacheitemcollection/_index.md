...
description: Представляет коллекцию SlicerCacheItem
type: docs
weight: 5670
url: /ru/net/aspose.cells.slicers/slicercacheitemcollection/
---
## SlicerCacheItemCollection class

Представляет коллекцию SlicerCacheItem
...
| [Count](../../aspose.cells.slicers/slicercacheitemcollection/count) { get; } | Получает количество SlicerCacheItem. |
| [Item](../../aspose.cells.slicers/slicercacheitemcollection/item) { get; } | Получает объект SlicerCacheItem по индексу. |
