...
description: Представляет переключатель.
type: docs
weight: 2550
url: /ru/net/aspose.cells.drawing/radiobutton/
---
## RadioButton class
...
| [GroupBox](../../aspose.cells.drawing/radiobutton/groupbox) { get; } | Получает GroupBox, содержащий этот RadioButton. |
...
| [IsChecked](../../aspose.cells.drawing/radiobutton/ischecked) { get; set; } | Указывает, отмечена ли радиокнопка или нет. |
...
| [Shadow](../../aspose.cells.drawing/radiobutton/shadow) { get; set; } | Указывает, имеет ли поле со списком трехмерное затенение. |
