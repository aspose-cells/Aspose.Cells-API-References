...
type: docs
weight: 2480
url: /ru/net/aspose.cells.drawing/picture/
---
## Picture class
...
| [BorderLineColor](../../aspose.cells.drawing/picture/borderlinecolor) { get; set; } | ПредставляетColor линии границы изображения. |
| [BorderWeight](../../aspose.cells.drawing/picture/borderweight) { get; set; } | Получает или задает вес линии границы изображения в единицах pt. |
...
| [Data](../../aspose.cells.drawing/picture/data) { get; set; } | Получает данные изображения. |
| [DisplayAsIcon](../../aspose.cells.drawing/picture/displayasicon) { get; set; } | Истинно, если указанный объект отображается в виде значка и изображение не будет автоматически изменено. |
...
| [Formula](../../aspose.cells.drawing/picture/formula) { get; set; } | Получает и задает данные формулы. |
...
| [ImageType](../../aspose.cells.drawing/picture/imagetype) { get; } | Получает формат изображения изображения. |
...
| [IsAutoSize](../../aspose.cells.drawing/picture/isautosize) { get; set; } | True указывает, что размер объекта ole будет автоматически изменен как размер снимка встроенного содержимого при активации объекта ole. |
| [IsDynamicDataExchange](../../aspose.cells.drawing/picture/isdynamicdataexchange) { get; set; } | Получает или устанавливает, будет ли динамический обмен данными |
...
| [IsLink](../../aspose.cells.drawing/picture/islink) { get; set; } | Возвращает true, если изображение связано с файлом. |
...
| [OriginalHeight](../../aspose.cells.drawing/picture/originalheight) { get; } | Получает исходную высоту изображения. |
| [OriginalHeightCM](../../aspose.cells.drawing/picture/originalheightcm) { get; } | Получает исходную высоту изображения в сантиметрах. |
| [OriginalHeightInch](../../aspose.cells.drawing/picture/originalheightinch) { get; } | Получает исходную высоту изображения в дюймах. |
| [OriginalWidth](../../aspose.cells.drawing/picture/originalwidth) { get; } | Получает исходную ширину изображения. |
| [OriginalWidthCM](../../aspose.cells.drawing/picture/originalwidthcm) { get; } | Получает исходную ширину изображения в сантиметрах. |
| [OriginalWidthInch](../../aspose.cells.drawing/picture/originalwidthinch) { get; } | Получает исходную ширину изображения в дюймах. |
...
| [SignatureLine](../../aspose.cells.drawing/picture/signatureline) { get; set; } | Получает и устанавливает строку подписи |
| [SoftEdges](../../aspose.cells.drawing/shape/softedges) { get; set; } | Получает и задает радиус размытия для краев в точках. |
| [SourceFullName](../../aspose.cells.drawing/picture/sourcefullname) { get; set; } | Получает или задает путь и имя исходного файла для связанного изображения. |
...
| [Copy](../../aspose.cells.drawing/picture/copy)(Picture, CopyOptions) | Скопируйте картинку. |
...
| override [IsSameSetting](../../aspose.cells.drawing/picture/issamesetting)(object) | Возвращает, совпадает ли форма. |
| [Move](../../aspose.cells.drawing/picture/move)(int, int) | Перемещает изображение в указанное место. |
