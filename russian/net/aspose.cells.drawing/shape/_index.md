...
| [Worksheet](../../aspose.cells.drawing/shape/worksheet) { get; } | Получает объект[`Worksheet`](./worksheet), содержащий эту фигуру. |
...
| [ToImage](../../aspose.cells.drawing/shape/toimage#toimage_2)(Stream, ImageFormat) | Создает изображение формы и сохраняет его в потоке в указанном формате. |
| [ToImage](../../aspose.cells.drawing/shape/toimage#toimage_1)(Stream, ImageOrPrintOptions) | Сохраняет форму в поток. |
| [ToImage](../../aspose.cells.drawing/shape/toimage#toimage_3)(string, ImageOrPrintOptions) | Сохраняет фигуру в файл. |
