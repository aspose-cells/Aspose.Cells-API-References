...
description: Представляет объект msodrawing.
type: docs
weight: 2630
url: /ru/net/aspose.cells.drawing/shape/
---
## Shape class
...
| [Worksheet](../../aspose.cells.drawing/shape/worksheet) { get; } | Получает[`Worksheet`](./worksheet) объект, который содержит эту форму. |
...
| [FormatCharacters](../../aspose.cells.drawing/shape/formatcharacters#formatcharacters_1)(int, int, Font, StyleFlag) | Форматирует некоторые символы с настройкой шрифта. |
...
| [ToImage](../../aspose.cells.drawing/shape/toimage#toimage)(ImageOrPrintOptions) | Возвращает растровый объект формы . |
| [ToImage](../../aspose.cells.drawing/shape/toimage#toimage_2)(Stream, ImageOrPrintOptions) | Сохраняет форму в поток. |
| [ToImage](../../aspose.cells.drawing/shape/toimage#toimage_1)(Stream, ImageType) | Создает изображение фигуры и сохраняет его в потоке в указанном формате. |
| [ToImage](../../aspose.cells.drawing/shape/toimage#toimage_4)(string, ImageOrPrintOptions) | Сохраняет фигуру в файл. |
...
//Добавить фигуру (например, прямоугольник)
