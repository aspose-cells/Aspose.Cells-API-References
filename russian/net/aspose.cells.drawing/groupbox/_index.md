...
description: Инкапсулирует объект представляющий групповой блок в электронной таблице.
type: docs
weight: 2130
url: /ru/net/aspose.cells.drawing/groupbox/
---
## GroupBox class
...
| [Shadow](../../aspose.cells.drawing/groupbox/shadow) { get; set; } | Указывает, есть ли тень у группового поля. |
