...
description: Представляет форму комментария.
type: docs
weight: 1910
url: /ru/net/aspose.cells.drawing/commentshape/
---
## CommentShape class
...
| [Comment](../../aspose.cells.drawing/commentshape/comment) { get; } | Получает объект комментария. |
...
ShapeCollection shapes = workbook.Worksheets[0].Shapes;
  ...
  //Проверяем, является ли фигура CommentShape
