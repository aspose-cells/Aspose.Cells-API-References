...
description: Представляет элемент управления Forms Spinner.
type: docs
weight: 2800
url: /ru/net/aspose.cells.drawing/spinner/
---
## Spinner class
...
| [CurrentValue](../../aspose.cells.drawing/spinner/currentvalue) { get; set; } | Получает или задает текущее значение. |
...
| [IncrementalChange](../../aspose.cells.drawing/spinner/incrementalchange) { get; set; } | Получает или задает величину, на которую полоса прокрутки или счетчик увеличивается при прокрутке строки. |
...
| [IsHorizontal](../../aspose.cells.drawing/spinner/ishorizontal) { get; set; } | Указывает, является ли это горизонтальной полосой прокрутки. |
...
| [Max](../../aspose.cells.drawing/spinner/max) { get; set; } | Получает или задает максимальное значение диапазона полосы прокрутки или счетчика. |
| [Min](../../aspose.cells.drawing/spinner/min) { get; set; } | Получает или задает минимальное значение диапазона полосы прокрутки или счетчика. |
...
| [Shadow](../../aspose.cells.drawing/spinner/shadow) { get; set; } | Указывает, имеет ли фигура трехмерное затенение. |
