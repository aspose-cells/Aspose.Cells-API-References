...
description: Инкапсулирует объект представляющий метку в электронной таблице.
type: docs
weight: 2170
url: /ru/net/aspose.cells.drawing/label/
---
## Label class
...
rksheet sheet = workbook.Worksheets[0];

//Добавить новую метку на лист.
pose.Cells.Drawing.Label label = sheet.Shapes.AddLabel(2, 0, 2, 0, 60, 120);

//Устанавливаем заголовок метки.
bel.Text = "This is a Label";

//Установите тип размещения, как the
//метка прикрепляется к ячейкам.
bel.Placement = PlacementType.FreeFloating;

//Задаем цвет заливки метки.
