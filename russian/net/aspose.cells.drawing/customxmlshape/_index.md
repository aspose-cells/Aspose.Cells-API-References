...
description: Представляет пользовательскую форму xml например Ink.
type: docs
weight: 1930
url: /ru/net/aspose.cells.drawing/customxmlshape/
---
...
//добавляем CustomXmlShape
//Shape shape = shape.AddShape(MsoDrawingType.CustomXml, 3, 0, 3, 0, 50, 150);

//Проверяем, является ли фигура CustomXmlShape
CustomXmlShape customXmlShape = shapes[0] as CustomXmlShape;
if (customXmlShape != null)
{
    //является CustomXmlShape
}
