...
description: Представляет форму управления ComboBox.
type: docs
weight: 1900
url: /ru/net/aspose.cells.drawing/combobox/
---
## ComboBox class
...
| [DropDownLines](../../aspose.cells.drawing/combobox/dropdownlines) { get; set; } | Получает или задает количество строк списка, отображаемых в раскрывающейся части поля со списком. |
...
| [SelectedCell](../../aspose.cells.drawing/combobox/selectedcell) { get; } | Получает выбранную ячейку в диапазоне ввода поля со списком. |
| [SelectedIndex](../../aspose.cells.drawing/combobox/selectedindex) { get; set; } | Получает или задает порядковый номер текущего выбранного элемента в списке или поле со списком. Начинается с нуля. |
| [SelectedValue](../../aspose.cells.drawing/combobox/selectedvalue) { get; } | Получает выбранное значение поля со списком. |
| [Shadow](../../aspose.cells.drawing/combobox/shadow) { get; set; } | Указывает, имеет ли поле со списком трехмерное затенение. |
