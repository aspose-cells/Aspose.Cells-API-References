...
description: Представляет форму линии.
type: docs
weight: 2240
url: /ru/net/aspose.cells.drawing/lineshape/
---
## LineShape class
...
//Установить стиль пунктира линии
...
'Установить стиль штриховой линии
line1.Line.DashStyle = MsoLineDashStyle.Solid
 
'Установите размещение.
line1.Placement = PlacementType.FreeFloating
 
'Добавьте еще одну строку на лист.
...
'Добавьте третью строку на лист.
