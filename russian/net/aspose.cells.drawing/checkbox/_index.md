...
description: Представляет объект флажка на листе.
type: docs
weight: 1860
url: /ru/net/aspose.cells.drawing/checkbox/
---
## CheckBox class
...
| [CheckedValue](../../aspose.cells.drawing/checkbox/checkedvalue) { get; set; } | Получает или устанавливает значение флажка. |
...
| [Shadow](../../aspose.cells.drawing/checkbox/shadow) { get; set; } | Указывает, имеет ли поле со списком трехмерное затенение. |
...
| [Value](../../aspose.cells.drawing/checkbox/value) { get; set; } | Указывает, установлен флажок или нет. |
