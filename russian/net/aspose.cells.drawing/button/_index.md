...
description: Представляет элемент управления FormsButton
type: docs
weight: 1830
url: /ru/net/aspose.cells.drawing/button/
---
## Button class
...
[C#]
 ...
 button.Text = "Aspose";
   ...
   //кнопка привязана к ячейкам.
 button.Placement = PlacementType.FreeFloating;
 
   //Установить имя шрифта.
 button.Font.Name = "Tahoma";
 
   //Выделите строку заголовка полужирным шрифтом.
 button.Font.IsBold = true;
 
   // Установите синий цвет.
 button.Font.Color = Color.Blue;
 
   //Устанавливаем гиперссылку для кнопки.
 ...
 'Выделите строку заголовка жирным шрифтом.
 button.Font.IsBold = True
