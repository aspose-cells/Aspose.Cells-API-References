...
| Имя | Описание |
| --- | --- |
| [BackColor](../../aspose.cells.drawing/msolineformathelper/backcolor) { get; set; } | Получает и задает задний цвет линии границы. |
| [DashStyle](../../aspose.cells.drawing/msolineformathelper/dashstyle) { get; set; } | Получает или задает стиль штриха для указанной строки. |
| [ForeColor](../../aspose.cells.drawing/msolineformathelper/forecolor) { get; set; } | Получает и задает передний цвет линии границы. |
