...
description: Представляет форму диаграммы. Свойства и методы объекта ChartObject управляют внешним видом и размером встроенной диаграммы на листе.
type: docs
weight: 1850
url: /ru/net/aspose.cells.drawing/chartshape/
---
## ChartShape class

Представляет форму диаграммы. Свойства и методы объекта ChartObject управляют внешним видом и размером встроенной диаграммы на листе.
...
| [Chart](../../aspose.cells.drawing/chartshape/chart) { get; } | Возвращает объект Chart, представляющий диаграмму, содержащуюся в объекте. |
...
//Получение формы графика
ChartShape chartShape = chart.ChartObject;

//Установить нижний правый столбец
chartShape.LowerRightColumn = 10;

//Установить нижнюю дельтуX
