...
description: Представляет форму диаграммы. Свойства и методы объекта ChartObject управляют внешним видом и размером встроенной диаграммы на рабочем листе.
type: docs
weight: 1850
...
'Добавление образца значения в "3" cell
worksheet.Cells("B3").PutValue(50)
