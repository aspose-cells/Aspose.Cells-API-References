...
description: Инкапсулирует объект представляющий текстовое поле в электронной таблице.
type: docs
weight: 2810
url: /ru/net/aspose.cells.drawing/textbox/
---
## TextBox class
...
textbox0.AddHyperlink("http:  //www.aspose.com/");
  //Получить формат текстового поля.
...
lineformat.Weight = 6;
  //Установите стиль тире на Squaredot.
