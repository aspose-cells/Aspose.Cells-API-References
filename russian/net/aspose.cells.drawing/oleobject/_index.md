...
description: Представляет OleObject на листе.
type: docs
weight: 2430
url: /ru/net/aspose.cells.drawing/oleobject/
---
## OleObject class
...
| [AutoLoad](../../aspose.cells.drawing/oleobject/autoload) { get; set; } | Указывает, должно ли основное приложение для внедренного объекта вызываться для автоматической загрузки данных объекта при открытии родительской книги. |
| [AutoShapeType](../../aspose.cells.drawing/shape/autoshapetype) { get; set; } | Получает и задает автоматический тип фигуры. |
| [AutoUpdate](../../aspose.cells.drawing/oleobject/autoupdate) { get; set; } | Указывает, будет ли автоматически обновляться ссылка на OleObject. |
...
| [ClassIdentifier](../../aspose.cells.drawing/oleobject/classidentifier) { get; set; } | Получает и задает идентификатор класса встроенного объекта. Это означает, какое приложение открывает встроенный файл. |
...
| [DisplayAsIcon](../../aspose.cells.drawing/oleobject/displayasicon) { get; set; } | Истинно, если указанный объект отображается в виде значка и изображение не будет автоматически изменено. |
| [FileFormatType](../../aspose.cells.drawing/oleobject/fileformattype) { get; set; } | Получает и задает тип файла данных встроенного объекта ole |
...
| [FullObjectBin](../../aspose.cells.drawing/oleobject/fullobjectbin) { get; } | Получает полные двоичные данные внедренного объекта ole в файле шаблона. |
...
| [HasLine](../../aspose.cells.drawing/shape/hasline) { get; set; } | Получает и устанавливает видимую границу линии фигуры. |
| [Height](../../aspose.cells.drawing/shape/height) { get; set; } | Представляет высоту фигуры в пикселях. |
| [HeightCM](../../aspose.cells.drawing/shape/heightcm) { get; set; } | Представляет высоту фигуры в сантиметрах. |
| [HeightInch](../../aspose.cells.drawing/shape/heightinch) { get; set; } | Представляет высоту фигуры в дюймах. |
...
| [ImageData](../../aspose.cells.drawing/oleobject/imagedata) { get; set; } | Представляет изображение объекта ole в виде массива байтов. |
| [ImageSourceFullName](../../aspose.cells.drawing/oleobject/imagesourcefullname) { get; set; } | Получает или задает путь и имя исходного файла для связанного изображения. |
| [ImageType](../../aspose.cells.drawing/oleobject/imagetype) { get; } | Получает формат изображения объекта ole. |
...
| [IsAutoSize](../../aspose.cells.drawing/oleobject/isautosize) { get; set; } | True указывает, что размер объекта ole будет автоматически изменен как размер снимка встроенного содержимого при активации объекта ole . |
...
| [IsLink](../../aspose.cells.drawing/oleobject/islink) { get; set; } | Возвращает true, если OleObject ссылается на файл. |
...
| [Label](../../aspose.cells.drawing/oleobject/label) { get; set; } | Получает и задает отображаемую метку связанного объекта ole. |
...
| [ObjectData](../../aspose.cells.drawing/oleobject/objectdata) { get; set; } | Представляет данные встроенного объекта ole в виде массива байтов. |
| [ObjectSourceFullName](../../aspose.cells.drawing/oleobject/objectsourcefullname) { get; set; } | Возвращает исходное полное имя исходного файла для связанного объекта OLE. |
...
| [ProgID](../../aspose.cells.drawing/oleobject/progid) { get; set; } | Получает или задает ProgID объекта OLE. |
...
| [TextBody](../../aspose.cells.drawing/shape/textbody) { get; } | Получает и задает настройку текста фигуры. |
| [TextDirection](../../aspose.cells.drawing/shape/textdirection) { get; set; } | Получает/устанавливает направление потока текста для этого объекта. |
| [TextEffect](../../aspose.cells.drawing/shape/texteffect) { get; } | Возвращает объект TextEffectFormat, содержащий свойства форматирования текстового эффекта для указанной фигуры. Применяется к объектам Shape, представляющим WordArt. |
| [TextHorizontalAlignment](../../aspose.cells.drawing/shape/texthorizontalalignment) { get; set; } | Получает и задает тип горизонтального выравнивания текста фигуры. |
| [TextHorizontalOverflow](../../aspose.cells.drawing/shape/texthorizontaloverflow) { get; set; } | Получает и задает тип горизонтального переполнения текста для фигуры, содержащей текст. |
| [TextOptions](../../aspose.cells.drawing/shape/textoptions) { get; set; } | Представляет параметры текста фигуры. |
| [TextOrientationType](../../aspose.cells.drawing/shape/textorientationtype) { get; set; } | Получает и задает тип ориентации текста фигуры. |
...
| virtual [GetResultOfSmartArt](../../aspose.cells.drawing/shape/getresultofsmartart)() | Преобразование смарт-арта в сгруппированные фигуры. |
| virtual [IsSameSetting](../../aspose.cells.drawing/shape/issamesetting)(object) | Возвращает, совпадает ли форма. |
...
| [SetEmbeddedObject](../../aspose.cells.drawing/oleobject/setembeddedobject#setembeddedobject)(bool, byte[], string, bool, string) | Устанавливает данные встроенного объекта. |
| [SetEmbeddedObject](../../aspose.cells.drawing/oleobject/setembeddedobject#setembeddedobject_1)(bool, byte[], string, bool, string, bool) | Устанавливает данные встроенного объекта. |
...
| [SetNativeSourceFullName](../../aspose.cells.drawing/oleobject/setnativesourcefullname)(string) | Устанавливает полное имя исходного файла с путем. |
