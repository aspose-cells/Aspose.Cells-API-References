...
description: Представляет объект полосы прокрутки.
type: docs
weight: 2600
url: /ru/net/aspose.cells.drawing/scrollbar/
---
## ScrollBar class
...
| [CurrentValue](../../aspose.cells.drawing/scrollbar/currentvalue) { get; set; } | Получает или задает текущее значение. |
...
| [IncrementalChange](../../aspose.cells.drawing/scrollbar/incrementalchange) { get; set; } | Получает или задает величину, на которую полоса прокрутки или счетчик увеличивается при прокрутке строки. |
...
| [IsHorizontal](../../aspose.cells.drawing/scrollbar/ishorizontal) { get; set; } | Указывает, является ли это горизонтальной полосой прокрутки. |
...
| [Max](../../aspose.cells.drawing/scrollbar/max) { get; set; } | Получает или задает максимальное значение диапазона полосы прокрутки или счетчика. |
| [Min](../../aspose.cells.drawing/scrollbar/min) { get; set; } | Получает или задает минимальное значение диапазона полосы прокрутки или счетчика. |
...
| [PageChange](../../aspose.cells.drawing/scrollbar/pagechange) { get; set; } | Получает или устанавливает изменение страницы |
...
| [Shadow](../../aspose.cells.drawing/scrollbar/shadow) { get; set; } | Указывает, имеет ли фигура трехмерное затенение. |
