...
| [IsOverLay](../../aspose.cells.charts/legend/isoverlay) { get; set; } | Получает или задает, разрешается ли другим элементам диаграммы перекрывать этот элемент диаграммы. |
...
| [LegendEntries](../../aspose.cells.charts/legend/legendentries) { get; } | Получает коллекцию всех объектов LegendEntry в указанной легенде диаграммы. Установка записей легенды поверхностной диаграммы не поддерживается. Таким образом, он вернет null, если тип диаграммы является типом поверхностной диаграммы. |
...
| [Position](../../aspose.cells.charts/legend/position) { get; set; } | Получает или задает тип положения легенды. |
...
//Легенда по умолчанию находится в правой части графика.
