...
| Имя | Описание |
| --- | --- |
| [Add](../../aspose.cells.charts/sparklinecollection/add)(string, int, int) | Добавить спарклайн. |
...
| [Remove](../../aspose.cells.charts/sparklinecollection/remove)(object) | Удаляет спарклайн |
