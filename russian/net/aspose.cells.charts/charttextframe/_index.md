...
description: Инкапсулирует объект представляющий объект кадра содержащий текст.
type: docs
weight: 550
url: /ru/net/aspose.cells.charts/charttextframe/
---
## ChartTextFrame class

Инкапсулирует объект, представляющий объект кадра, содержащий текст.
