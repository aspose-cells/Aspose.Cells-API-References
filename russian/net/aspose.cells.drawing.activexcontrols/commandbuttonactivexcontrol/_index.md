...
type: docs
weight: 1500
url: /ru/net/aspose.cells.drawing.activexcontrols/commandbuttonactivexcontrol/
---
...
| Имя | Описание |
| --- | --- |
| [Accelerator](../../aspose.cells.drawing.activexcontrols/commandbuttonactivexcontrol/accelerator) { get; set; } | Получает и задает клавишу быстрого доступа для элемента управления. |
...
| [Caption](../../aspose.cells.drawing.activexcontrols/commandbuttonactivexcontrol/caption) { get; set; } | Получает и задает описательный текст, отображаемый в элементе управления. |
...
| [IsWordWrapped](../../aspose.cells.drawing.activexcontrols/commandbuttonactivexcontrol/iswordwrapped) { get; set; } | Указывает, будет ли содержимое элемента управления автоматически переноситься в конце строки. |
...
| [Picture](../../aspose.cells.drawing.activexcontrols/commandbuttonactivexcontrol/picture) { get; set; } | Получает и устанавливает данные изображения. |
| [PicturePosition](../../aspose.cells.drawing.activexcontrols/commandbuttonactivexcontrol/pictureposition) { get; set; } | Получает и устанавливает расположение изображения элемента управления относительно его заголовка. |
| virtual [Shadow](../../aspose.cells.drawing.activexcontrols/activexcontrolbase/shadow) { get; set; } | Указывает, показывать ли тень. |
| [TakeFocusOnClick](../../aspose.cells.drawing.activexcontrols/commandbuttonactivexcontrol/takefocusonclick) { get; set; } | Указывает, получает ли элемент управления фокус при нажатии. |
...
| override [Type](../../aspose.cells.drawing.activexcontrols/commandbuttonactivexcontrol/type) { get; } | Получает тип элемента управления ActiveX. |
