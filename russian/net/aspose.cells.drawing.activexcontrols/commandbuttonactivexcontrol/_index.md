...
| [IsWordWrapped](../../aspose.cells.drawing.activexcontrols/commandbuttonactivexcontrol/iswordwrapped) { get; set; } | Указывает, переносится ли содержимое элемента управления автоматически в конце строки. |
...
| [TakeFocusOnClick](../../aspose.cells.drawing.activexcontrols/commandbuttonactivexcontrol/takefocusonclick) { get; set; } | Указывает, принимает ли элемент управления фокус при нажатии. |
