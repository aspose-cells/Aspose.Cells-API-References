...
type: docs
weight: 1690
url: /ru/net/aspose.cells.drawing.activexcontrols/scrollbaractivexcontrol/
---
...
| [LargeChange](../../aspose.cells.drawing.activexcontrols/scrollbaractivexcontrol/largechange) { get; set; } | Получает и задает величину, на которую изменяется свойство Position |
...
| override [Type](../../aspose.cells.drawing.activexcontrols/scrollbaractivexcontrol/type) { get; } | Получает тип элемента управления ActiveX. |
