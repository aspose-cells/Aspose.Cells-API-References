...
type: docs
weight: 1730
url: /ru/net/aspose.cells.drawing.activexcontrols/togglebuttonactivexcontrol/
---
...
| [SpecialEffect](../../aspose.cells.drawing.activexcontrols/togglebuttonactivexcontrol/specialeffect) { get; set; } | Получает и задает специальный эффект элемента управления. |
...
| override [Type](../../aspose.cells.drawing.activexcontrols/togglebuttonactivexcontrol/type) { get; } | Получает тип элемента управления ActiveX. |
