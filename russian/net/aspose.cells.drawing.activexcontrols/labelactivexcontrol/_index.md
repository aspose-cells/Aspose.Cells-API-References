...
description: Представляет метку элемента управления ActiveX.
type: docs
weight: 1660
url: /ru/net/aspose.cells.drawing.activexcontrols/labelactivexcontrol/
---
## LabelActiveXControl class

Представляет метку элемента управления ActiveX.
...
| Имя | Описание |
| --- | --- |
| [Accelerator](../../aspose.cells.drawing.activexcontrols/labelactivexcontrol/accelerator) { get; set; } | Получает и задает клавишу быстрого доступа для элемента управления. |
...
| [BorderOleColor](../../aspose.cells.drawing.activexcontrols/labelactivexcontrol/borderolecolor) { get; set; } | Получает и устанавливает цвет фона ole. |
| [BorderStyle](../../aspose.cells.drawing.activexcontrols/labelactivexcontrol/borderstyle) { get; set; } | Получает и устанавливает тип границы, используемой элементом управления. |
| [Caption](../../aspose.cells.drawing.activexcontrols/labelactivexcontrol/caption) { get; set; } | Получает и задает описательный текст, отображаемый в элементе управления. |
...
| [IsWordWrapped](../../aspose.cells.drawing.activexcontrols/labelactivexcontrol/iswordwrapped) { get; set; } | Указывает, будет ли содержимое элемента управления автоматически переноситься в конце строки. |
...
| [Picture](../../aspose.cells.drawing.activexcontrols/labelactivexcontrol/picture) { get; set; } | Получает и устанавливает данные изображения. |
| [PicturePosition](../../aspose.cells.drawing.activexcontrols/labelactivexcontrol/pictureposition) { get; set; } | Получает и устанавливает расположение изображения элемента управления относительно его заголовка. |
| virtual [Shadow](../../aspose.cells.drawing.activexcontrols/activexcontrolbase/shadow) { get; set; } | Указывает, показывать ли тень. |
| [SpecialEffect](../../aspose.cells.drawing.activexcontrols/labelactivexcontrol/specialeffect) { get; set; } | Получает и задает специальный эффект элемента управления. |
...
| override [Type](../../aspose.cells.drawing.activexcontrols/labelactivexcontrol/type) { get; } | Получает тип элемента управления ActiveX. |
