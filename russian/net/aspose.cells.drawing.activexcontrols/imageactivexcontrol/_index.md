...
type: docs
weight: 1640
url: /ru/net/aspose.cells.drawing.activexcontrols/imageactivexcontrol/
---
...
| [BorderOleColor](../../aspose.cells.drawing.activexcontrols/imageactivexcontrol/borderolecolor) { get; set; } | Получает и устанавливает цвет фона ole. |
| [BorderStyle](../../aspose.cells.drawing.activexcontrols/imageactivexcontrol/borderstyle) { get; set; } | Получает и устанавливает тип границы, используемой элементом управления. |
...
| override [IsAutoSize](../../aspose.cells.drawing.activexcontrols/imageactivexcontrol/isautosize) { get; set; } | Указывает, будет ли автоматически изменяться размер элемента управления для отображения всего его содержимого. |
...
| [IsTiled](../../aspose.cells.drawing.activexcontrols/imageactivexcontrol/istiled) { get; set; } | Указывает, расположено ли изображение на фоне фона. |
...
| [Picture](../../aspose.cells.drawing.activexcontrols/imageactivexcontrol/picture) { get; set; } | Получает и устанавливает данные изображения. |
| [PictureAlignment](../../aspose.cells.drawing.activexcontrols/imageactivexcontrol/picturealignment) { get; set; } | Получает и задает выравнивание изображения внутри формы или изображения. |
| [PictureSizeMode](../../aspose.cells.drawing.activexcontrols/imageactivexcontrol/picturesizemode) { get; set; } | Получает и задает способ отображения изображения. |
| virtual [Shadow](../../aspose.cells.drawing.activexcontrols/activexcontrolbase/shadow) { get; set; } | Указывает, показывать ли тень. |
| [SpecialEffect](../../aspose.cells.drawing.activexcontrols/imageactivexcontrol/specialeffect) { get; set; } | Получает и задает специальный эффект элемента управления. |
...
| override [Type](../../aspose.cells.drawing.activexcontrols/imageactivexcontrol/type) { get; } | Получает тип элемента управления ActiveX. |
