...
type: docs
weight: 1740
url: /ru/net/aspose.cells.drawing.activexcontrols/unknowncontrol/
---
...
| override [Data](../../aspose.cells.drawing.activexcontrols/unknowncontrol/data) { get; } | Получает и устанавливает двоичные данные элемента управления. |
...
| [PersistenceType](../../aspose.cells.drawing.activexcontrols/unknowncontrol/persistencetype) { get; } | Получает метод сохранения для сохранения элемента управления ActiveX. |
...
| override [Type](../../aspose.cells.drawing.activexcontrols/unknowncontrol/type) { get; } | Получает тип элемента управления ActiveX. |
...
| Имя | Описание |
| --- | --- |
| [GetRelationshipData](../../aspose.cells.drawing.activexcontrols/unknowncontrol/getrelationshipdata)(string) | Получает связанные данные. |
