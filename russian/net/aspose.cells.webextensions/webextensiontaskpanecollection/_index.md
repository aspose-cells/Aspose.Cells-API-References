...
description: Представляет список области задач.
type: docs
weight: 6470
url: /ru/net/aspose.cells.webextensions/webextensiontaskpanecollection/
---
...
| Имя | Описание |
| --- | --- |
| [Add](../../aspose.cells.webextensions/webextensiontaskpanecollection/add)() | Добавляет панель задач. |
