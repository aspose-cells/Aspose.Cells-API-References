...
description: Представляет коллекцию всех объектов PivotFilter
type: docs
weight: 4590
url: /ru/net/aspose.cells.pivot/pivotfiltercollection/
---
...
| [Item](../../aspose.cells.pivot/pivotfiltercollection/item) { get; } | Получает объект сводного фильтра по указанному индексу. |
...
| Имя | Описание |
| --- | --- |
| [Add](../../aspose.cells.pivot/pivotfiltercollection/add)(int, PivotFilterType) | Добавляет объект PivotFilter к определенному типу |
