...
description: Представляет коллекцию всех объектов сводной таблицы на указанном листе.
type: docs
weight: 4710
url: /ru/net/aspose.cells.pivot/pivottablecollection/
---
...
| [Item](../../aspose.cells.pivot/pivottablecollection/item) { get; } | Получает отчет сводной таблицы по индексу. (3 indexers) |
...
| [Clear](../../aspose.cells.pivot/pivottablecollection/clear#clear)() | Очистить все сводные таблицы. (2 methods) |
