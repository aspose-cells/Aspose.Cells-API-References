...
| [AutoCompressPictures](../../aspose.cells/workbooksettings/autocompresspictures) { get; set; } | Задает логическое значение, указывающее, что приложение автоматически сжимает изображения в книге. |
...
| [CheckCustomNumberFormat](../../aspose.cells/workbooksettings/checkcustomnumberformat) { get; set; } | Указывает, проверяется ли пользовательский формат номера при установке Style.Custom. |
...
| [Date1904](../../aspose.cells/workbooksettings/date1904) { get; set; } | Получает или задает значение, указывающее, использует ли книга систему дат 1904 года. |
| [DisplayDrawingObjects](../../aspose.cells/workbooksettings/displaydrawingobjects) { get; set; } | Указывает, следует ли отображать объекты в книге, и если да, то каким образом. |
...
| [LanguageCode](../../aspose.cells/workbooksettings/languagecode) { get; set; } | Получает или задает язык пользовательского интерфейса версии книги на основе CountryCode, в которой сохранен файл. |
...
| [Password](../../aspose.cells/workbooksettings/password) { get; set; } | Представляет пароль шифрования файла рабочей книги. |
| [ProtectionType](../../aspose.cells/workbooksettings/protectiontype) { get; } | Получает тип защиты книги. |
| [QuotePrefixToStyle](../../aspose.cells/workbooksettings/quoteprefixtostyle) { get; set; } | Указывает, установлена ли[`QuotePrefix`](../style/quoteprefix) свойство при вводе строкового значения (начинающегося с одинарной кавычки) в ячейку |
...
| [ShowTabs](../../aspose.cells/workbooksettings/showtabs) { get; set; } | Получить или установить значение, отображаемое ли вкладки рабочей книги. |
...
| [UpdateAdjacentCellsBorder](../../aspose.cells/workbooksettings/updateadjacentcellsborder) { get; set; } | Указывает, следует ли обновлять границу соседних ячеек. |
...
| [WarningCallback](../../aspose.cells/workbooksettings/warningcallback) { get; set; } | Получает или задает обратный вызов предупреждения. |
