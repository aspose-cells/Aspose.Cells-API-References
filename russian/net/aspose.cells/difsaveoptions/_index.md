...
description: Представляет параметры сохранения файла различий.
type: docs
weight: 1380
url: /ru/net/aspose.cells/difsaveoptions/
---
...
| Имя | Описание |
| --- | --- |
| [DifSaveOptions](difsaveoptions)() | Создает параметры для сохранения файла DIF. |
