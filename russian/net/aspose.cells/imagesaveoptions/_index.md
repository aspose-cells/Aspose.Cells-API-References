...
description: Представляет параметры сохранения изображения
type: docs
weight: 3870
url: /ru/net/aspose.cells/imagesaveoptions/
---
...
| Имя | Описание |
| --- | --- |
| [ImageSaveOptions](imagesaveoptions#constructor)() | Создает параметры для сохранения файла изображения. |
| [ImageSaveOptions](imagesaveoptions#constructor_1)(SaveFormat) | Создает параметры для сохранения файла изображения. |
