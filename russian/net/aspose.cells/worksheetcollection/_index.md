...
description: Инкапсулирует набор объектовWorksheet./worksheet.
type: docs
weight: 6520
...
Инкапсулирует набор объектов[`Worksheet`](../worksheet).
...
| [BuiltInDocumentProperties](../../aspose.cells/worksheetcollection/builtindocumentproperties) { get; } | Возвращает коллекцию[`DocumentProperty`](../../aspose.cells.properties/documentproperty), которая представляет все встроенные свойства документа электронной таблицы. |
| [Capacity](../../aspose.cells/collectionbase`1/capacity) { get; set; } |  |
| [Count](../../aspose.cells/collectionbase`1/count) { get; } |  |
| [CustomDocumentProperties](../../aspose.cells/worksheetcollection/customdocumentproperties) { get; } | Возвращает коллекцию[`DocumentProperty`](../../aspose.cells.properties/documentproperty), которая представляет все настраиваемые свойства документа электронной таблицы. |
...
| [IsRefreshAllConnections](../../aspose.cells/worksheetcollection/isrefreshallconnections) { get; set; } | Указывает, будут ли обновляться все соединения при открытии файла в MS Excel. |
| [Item](../../aspose.cells/worksheetcollection/item) { get; } | Получает элемент[`Worksheet`](../worksheet)по указанному индексу. (2 indexers) |
| [Item](../../aspose.cells/collectionbase`1/item) { get; set; } |  |
| [Names](../../aspose.cells/worksheetcollection/names) { get; } | Получает коллекцию всех объектов Name в электронной таблице. |
| [OleSize](../../aspose.cells/worksheetcollection/olesize) { get; set; } | Получает и устанавливает отображаемый размер, когда файл рабочей книги используется как объект Ole. |
| [RevisionLogs](../../aspose.cells/worksheetcollection/revisionlogs) { get; } | Представляет журналы изменений. |
| [TableStyles](../../aspose.cells/worksheetcollection/tablestyles) { get; } | Получает объект[`TableStyles`](./tablestyles). |
...
| [AddCopy](../../aspose.cells/worksheetcollection/addcopy#addcopy)(int) | Добавляет рабочий лист в коллекцию и копирует данные из существующего рабочего листа. |
| [AddCopy](../../aspose.cells/worksheetcollection/addcopy#addcopy_1)(string) | Добавляет рабочий лист в коллекцию и копирует данные из существующего рабочего листа. |
...
| [CreateRange](../../aspose.cells/worksheetcollection/createrange)(string, int) | Создает объект[`Range`](../range)из адреса диапазона. |
| [CreateUnionRange](../../aspose.cells/worksheetcollection/createunionrange)(string, int) | Создает объект[`Range`](../range)из адреса диапазона. |
...
| [Insert](../../aspose.cells/worksheetcollection/insert#insert)(int, SheetType) | Вставьте рабочий лист. |
| [Insert](../../aspose.cells/worksheetcollection/insert#insert_1)(int, SheetType, string) | Вставьте рабочий лист. |
...
| [RefreshPivotTables](../../aspose.cells/worksheetcollection/refreshpivottables)() | Обновляет все сводные таблицы в коллекции WorksheetCollection. |
| [RegisterAddInFunction](../../aspose.cells/worksheetcollection/registeraddinfunction#registeraddinfunction_1)(int, string) | Добавляет функцию надстройки в рабочую книгу |
| [RegisterAddInFunction](../../aspose.cells/worksheetcollection/registeraddinfunction#registeraddinfunction)(string, string, bool) | Добавляет функцию надстройки в рабочую книгу |
...
| [SetOleSize](../../aspose.cells/worksheetcollection/setolesize)(int, int, int, int) | Устанавливает отображаемый размер, когда файл рабочей книги используется как объект Ole. |
