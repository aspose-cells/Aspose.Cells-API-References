...
description: Представляет параметры загрузки файла.
type: docs
weight: 4000
url: /ru/net/aspose.cells/loadoptions/
---
## LoadOptions class
...
| Имя | Описание |
| --- | --- |
| [LoadOptions](loadoptions#constructor)() | Создает опции загрузки файла. |
| [LoadOptions](loadoptions#constructor_1)(LoadFormat) | Создает опции загрузки файла. |
