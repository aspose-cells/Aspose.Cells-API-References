...
description: Представляет список входных ячеек сценария.
type: docs
weight: 5600
url: /ru/net/aspose.cells/scenarioinputcellcollection/
---
...
| Имя | Описание |
| --- | --- |
| [Add](../../aspose.cells/scenarioinputcellcollection/add)(int, int, string) | Добавляет ячейку ввода. |
