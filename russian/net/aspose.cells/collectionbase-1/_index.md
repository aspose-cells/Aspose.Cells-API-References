...
type: docs
weight: 1020
url: /ru/net/aspose.cells/collectionbase-1/
---
...
| Имя | Описание |
| --- | --- |
| [Capacity](../../aspose.cells/collectionbase`1/capacity) { get; set; } | Получает или задает количество элементов, которые может содержать список. |
| [Count](../../aspose.cells/collectionbase`1/count) { get; } | Получает количество элементов. |
| [Item](../../aspose.cells/collectionbase`1/item) { get; set; } | Получает или задает элемент по указанному индексу. |
...
| [Clear](../../aspose.cells/collectionbase`1/clear)() | Удалить все элементы. |
...
| [RemoveAt](../../aspose.cells/collectionbase`1/removeat)(int) | Удаляет элемент по указанному индексу. |
