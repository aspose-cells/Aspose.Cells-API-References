...
| [Item](../../aspose.cells.markup/customxmlpartcollection/item) { get; } | Получает элемент по указанному индексу. |
...
| Имя | Описание |
| --- | --- |
| [Add](../../aspose.cells.markup/customxmlpartcollection/add)(byte[], byte[]) | Добавляет элемент в коллекцию. |
