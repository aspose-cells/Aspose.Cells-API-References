...
description: Представляет все смарт-теги в ячейке.
type: docs
weight: 4070
url: /ru/net/aspose.cells.markup/smarttagcollection/
---
...
| Имя | Описание |
| --- | --- |
| [Add](../../aspose.cells.markup/smarttagcollection/add)(string, string) | Добавляет смарт-тег. |
