...
type: docs
weight: 800
url: /ru/net/aspose.cells.gridweb/gridweb/
---
## GridWeb class
...
| Имя | Описание |
| --- | --- |
| [GridWeb](gridweb)() | Конструктор по умолчанию. |
...
| [SelectCells](../../aspose.cells.gridweb/gridweb/selectcells) { get; } | Получает коллекцию выбранных ячеек. |
...
| [ImportExcelFile](../../aspose.cells.gridweb/mainweb/importexcelfile)(Stream) | Импорт из потока файлов Excel, включая поток файлов на диске или поток памяти. |
| [ImportExcelFile](../../aspose.cells.gridweb/mainweb/importexcelfile)(string) | Импорт из файла Excel. |
| [LoadCSVFile](../../aspose.cells.gridweb/mainweb/loadcsvfile)(Stream) | Загружает данные из потока файла CSV. |
| [LoadCSVFile](../../aspose.cells.gridweb/mainweb/loadcsvfile)(string) | Загружает данные из файла CSV. |
| [LoadHTMLFile](../../aspose.cells.gridweb/mainweb/loadhtmlfile)(Stream) | Загружает данные из потока файла HTML. |
| [LoadHTMLFile](../../aspose.cells.gridweb/mainweb/loadhtmlfile)(string) | Загружает данные из файла HTML. |
| [LoadSpreadSheetMLFile](../../aspose.cells.gridweb/mainweb/loadspreadsheetmlfile)(Stream) | Загружает данные из файлового потока SpreadSheetML. |
| [LoadSpreadSheetMLFile](../../aspose.cells.gridweb/mainweb/loadspreadsheetmlfile)(string) | Загружает данные из файла SpreadSheetML. |
...
| [SaveCSVFile](../../aspose.cells.gridweb/mainweb/savecsvfile)(Stream) | Сохраняет данные в поток файла CSV. |
| [SaveCSVFile](../../aspose.cells.gridweb/mainweb/savecsvfile)(string) | Сохраняет данные в файл CSV. |
| [SaveCustomStyleFile](../../aspose.cells.gridweb/gridweb/savecustomstylefile#savecustomstylefile)(string) | Сохраняет данные текущего стиля элемента управления в XML-файл. Может использоваться для создания файла пользовательского стиля. (2 methods) |
| [SaveHTMLFile](../../aspose.cells.gridweb/mainweb/savehtmlfile)(Stream) | Сохраняет данные в файловый поток HTML. |
| [SaveHTMLFile](../../aspose.cells.gridweb/mainweb/savehtmlfile)(string) | Сохраняет данные в файл HTML. |
| [SaveSpreadSheetMLFile](../../aspose.cells.gridweb/mainweb/savespreadsheetmlfile)(Stream) | Сохраняет данные в файловый поток SpreadSheetML. |
| [SaveSpreadSheetMLFile](../../aspose.cells.gridweb/mainweb/savespreadsheetmlfile)(string) | Сохраняет данные в файл SpreadSheetML. |
| [SaveToExcelFile](../../aspose.cells.gridweb/mainweb/savetoexcelfile)(Stream) | Сохраняет рабочие листы в файл Excel. |
| [SaveToExcelFile](../../aspose.cells.gridweb/mainweb/savetoexcelfile)(string) | Сохраняет листы в файл Excel в формате Excel 2003. |
| [SaveToExcelFile](../../aspose.cells.gridweb/mainweb/savetoexcelfile)(Stream, GridSaveFormat) | Сохраняет рабочие листы в файл Excel. |
| [SaveToExcelFile](../../aspose.cells.gridweb/mainweb/savetoexcelfile)(Stream, GridSaveOptions) | Сохраняет рабочие листы в файл Excel. |
| [SaveToExcelFile](../../aspose.cells.gridweb/mainweb/savetoexcelfile)(string, GridSaveFormat) | Сохраняет рабочие листы в файл Excel. |
| [SaveToExcelFile](../../aspose.cells.gridweb/mainweb/savetoexcelfile)(string, GridSaveOptions) | Сохраняет рабочие листы в файл Excel. |
...
| static [GetVersion](../../aspose.cells.gridweb/gridweb/getversion)() | Получить релизную версию. |
| static [SetFontFolder](../../aspose.cells.gridweb/gridweb/setfontfolder)(string, bool) | Устанавливает папку шрифтов |
| static [SetFontFolders](../../aspose.cells.gridweb/gridweb/setfontfolders)(string[], bool) | Устанавливает папки шрифтов |
