...
description: Представляет все формулы мощного запроса в данных мэшапа.
type: docs
weight: 4970
url: /ru/net/aspose.cells.querytables/powerqueryformulacollection/
---
## PowerQueryFormulaCollection class

Представляет все формулы мощного запроса в данных мэшапа.
...
| [Item](../../aspose.cells.querytables/powerqueryformulacollection/item) { get; } | получает[`PowerQueryFormula`](../powerqueryformula) по индексу в списке. (2 indexers) |
