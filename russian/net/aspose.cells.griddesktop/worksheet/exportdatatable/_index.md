...
| isVertical | Boolean | True, если строка в элементе управления представляет строку в DataTable. False, если столбец в элементе управления представляет строку в DataTable. |
