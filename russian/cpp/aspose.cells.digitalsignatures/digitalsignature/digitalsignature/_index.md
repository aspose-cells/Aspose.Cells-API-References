...
type: docs
weight: 100
url: /ru/cpp/aspose.cells.digitalsignatures/digitalsignature/digitalsignature/
---
...
//коллекция signature содержит одну или несколько подписей, необходимых для подписи
...
dsc.Add(ds);
Workbook wb;
//установить все подписи в рабочую книгу
