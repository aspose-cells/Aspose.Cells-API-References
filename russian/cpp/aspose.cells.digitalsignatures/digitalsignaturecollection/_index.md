...
type: docs
weight: 200
url: /ru/cpp/aspose.cells.digitalsignatures/digitalsignaturecollection/
---
...
//wb.IsDigitallySigned равно true, когда рабочая книга уже подписана.
std::cout<<signedWorkbook.IsDigitallySigned() << std::endl;
//получить коллекцию digitalSignature из рабочей книги
