...
type: docs
weight: 100
url: /ru/cpp/aspose.cells.timelines/timeline/
---
## Timeline class
...
//Добавить новую шкалу времени, используя сводную таблицу в качестве источника данных
sheet.GetTimelines().Add(pivot, 10, 5, u"date");

//Получить объект шкалы времени
