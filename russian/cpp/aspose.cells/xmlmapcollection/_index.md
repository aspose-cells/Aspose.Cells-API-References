...
type: docs
weight: 17400
url: /ru/cpp/aspose.cells/xmlmapcollection/
---
...
//Следующий код добавляет два XmlMap с помощью файла xsd и файла xml.
Workbook wb;

XmlMapCollection xmlMapCollection = wb.GetWorksheets().GetXmlMaps();

//Добавить XmlMap с помощью файла xsd.
xmlMapCollection.Add(u"schema.xsd");

//Добавить XmlMap с помощью файла xml.
