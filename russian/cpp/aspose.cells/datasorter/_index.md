...
type: docs
weight: 4300
url: /ru/cpp/aspose.cells/datasorter/
---
## DataSorter class
...
//Получить объект datasorter книги.
DataSorter sorter = workbook.GetDataSorter();
//Установить первый порядок для объекта datasorter.
sorter.SetOrder1(SortOrder::Descending);
//Определить первый ключ.
sorter.SetKey1(0);
//Установить второй порядок для объекта datasorter.
sorter.SetOrder2(SortOrder::Ascending);
//Определить второй ключ.
sorter.SetKey2(1);
//Создать область ячеек (диапазон).
CellArea ca;
//Указать индекс начальной строки.
ca.StartRow = 0;
...
ca.EndColumn = 1;
//Сортировать данные в указанном диапазоне (A1:B14)
