...
type: docs
weight: 14400
url: /ru/cpp/aspose.cells/systemtimeinterruptmonitor/
---
...
//В следующем примере показано, как контролировать процесс загрузки и сохранения с указанным ограничением времени:
...
//если время загрузки файла шаблона превышает одну секунду, потребуется прерывание, и здесь будет выброшено исключение
//в противном случае начинается мониторинг процедуры сохранения
