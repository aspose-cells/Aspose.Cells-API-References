...
type: docs
weight: 12200
url: /ru/cpp/aspose.cells/protection/
---
## Protection class
...
//Разрешить пользователям выбирать заблокированные ячейки листа
worksheet.GetProtection().SetAllowSelectingLockedCell(true);
//Разрешить пользователям выбирать разблокированные ячейки листа
