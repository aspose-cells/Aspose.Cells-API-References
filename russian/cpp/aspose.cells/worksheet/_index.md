...
type: docs
weight: 16600
url: /ru/cpp/aspose.cells/worksheet/
---
## Worksheet class
...
//В следующем примере показано, как заморозить области и вставить гиперссылку в лист с помощью .Net или VB.
Workbook workbook;

Worksheet sheet = workbook.GetWorksheets().Get(0);

//Заморозить области в "AS40" с 10 строками и 10 столбцами
