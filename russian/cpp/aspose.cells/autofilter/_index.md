...
type: docs
weight: 700
url: /ru/cpp/aspose.cells/autofilter/
---
## AutoFilter class
...
//Создание файлового потока, содержащего файл Excel для открытия
//Создание экземпляра объекта Workbook
Workbook workbook(u"template.xlsx");
//Доступ к первому листу в файле Excel
Worksheet worksheet = workbook.GetWorksheets().Get(0);
//Создание AutoFilter, задавая диапазон ячеек строки заголовка
...
//Сохранение изменённого файла Excel.
