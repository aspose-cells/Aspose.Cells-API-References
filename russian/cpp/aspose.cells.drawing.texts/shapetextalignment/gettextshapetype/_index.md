...
type: docs
weight: 2200
url: /ru/cpp/aspose.cells.drawing.texts/shapetextalignment/gettextshapetype/
---
...
```cpp
//Обычно не изменяйте это значение, если только вы точно не знаете, к чему приведёт изменение.
