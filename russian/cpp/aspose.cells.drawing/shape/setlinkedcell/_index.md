...
type: docs
weight: 14600
url: /ru/cpp/aspose.cells.drawing/shape/setlinkedcell/
---
...
```cpp
//После выполнения кода ниже в сгенерированном файле создаётся объект ScrollBar. При перетаскивании ползунка значение отображается в ячейке A12.
