...
type: docs
weight: 14800
url: /ru/cpp/aspose.cells.drawing/shape/setinputrange/
---
...
```cpp
//После выполнения кода ниже в сгенерированном файле создаётся объект ListBox. При щелчке по выбранному пункту отображается выбранное значение в ячейке A12.
