---
title: Aspose::Cells::Drawing::TimelineShape class
linktitle: TimelineShape
second_title: Aspose.Cells for C++ API Reference
description: 'Aspose::Cells::Drawing::TimelineShape class. Represents the Timeline msodrawing object in C++.'
type: docs
weight: 7300
url: /ru/cpp/aspose.cells.drawing/timelineshape/
---
## TimelineShape class
...
```cpp
class TimelineShape : public Aspose::Cells::Drawing::Shape
```
...
| [operator=(const TimelineShape\& src)](./operator_asm/) | operator= |
...
| [TimelineShape(TimelineShape_Impl* impl)](./timelineshape/) | Constructs from an implementation object. |
| [TimelineShape(const TimelineShape\& src)](./timelineshape/) | Copy constructor. |
| [TimelineShape(const Shape\& src)](./timelineshape/) | Constructs from a parent object. |
...
| [~TimelineShape()](./~timelineshape/) | Destructor. |
## Fields
