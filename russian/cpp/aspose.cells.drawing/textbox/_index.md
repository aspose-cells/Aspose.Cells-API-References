...
type: docs
weight: 6700
url: /ru/cpp/aspose.cells.drawing/textbox/
---
## TextBox class
...
//Добавьте новый текстовый блок в коллекцию.
int textboxIndex = worksheet.GetTextBoxes().Add(2, 1, 160, 200);
//Получите объект текстового блока.
...
//Установите текстовое поле так, чтобы оно подстраивалось под своё содержимое.
...
//Вставьте в него некоторый текст.
