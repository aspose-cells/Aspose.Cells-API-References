---
title: Aspose::Cells::Drawing::CustomXmlShape class
linktitle: CustomXmlShape
second_title: Aspose.Cells for C++ API Reference
description: 'Aspose::Cells::Drawing::CustomXmlShape class. Represents Custom xml shape ,such as Ink in C++.'
type: docs
weight: 1500
url: /ru/cpp/aspose.cells.drawing/customxmlshape/
---
...
```cpp
class CustomXmlShape : public Aspose::Cells::Drawing::Shape
```
...
| [~CustomXmlShape()](./~customxmlshape/) | Destructor. |
...
//добавить CustomXmlShape
Shape shape = shapes.AddShape(MsoDrawingType::CustomXml, 3, 0, 3, 0, 50, 150);

//Проверьте, является ли фигура CustomXmlShape
if (shapes.Get(0).GetMsoDrawingType() == MsoDrawingType::CustomXml)
{
    //является CustomXmlShape
    CustomXmlShape customXmlShape = (CustomXmlShape)shapes.Get(0);
}
