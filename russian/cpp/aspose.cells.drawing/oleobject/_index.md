...
type: docs
weight: 3900
url: /ru/cpp/aspose.cells.drawing/oleobject/
---
## OleObject class
...
//Получить данные изображения в переменную "iconData". например: файл .jpg с именем "school.jpg"
//(Примечание: вам нужно прочитать данные в эту переменную.)
Vector<uint8_t> iconData{0};

//Получить данные OLE‑объекта в переменную "objectData". например: файл .xls с именем "Book1.xls"
//(Примечание: вам нужно прочитать данные в эту переменную.)
Vector<uint8_t> objectData{0};

//Добавить OLE‑объект в лист с изображением
//отображаемым в MS Excel.
