...
type: docs
weight: 2600
url: /ru/cpp/aspose.cells.drawing/groupshape/
---
## GroupShape class
...
//Установить толщину радиокнопки.
...
//Установить стиль штриха радиокнопки.
radio1.GetLine().SetDashStyle(MsoLineDashStyle::Solid);

//Добавить ещё одну радиокнопку.
