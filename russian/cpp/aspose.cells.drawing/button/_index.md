...
type: docs
weight: 600
url: /ru/cpp/aspose.cells.drawing/button/
---
## Button class
...
//Установить подпись кнопки.
button.SetText(u"Aspose");

//Установите тип размещения, способ, которым
