...
type: docs
weight: 800
url: /ru/cpp/aspose.cells.drawing.equations/equationnode/
---
## EquationNode class
...
// Добавляет объект уравнения в лист.
TextBox textBox = workbook.GetWorksheets().Get(0).GetShapes().AddEquation(1, 0, 1, 0, 100, 300);

// Получает начальный узел объекта уравнения
EquationNode mathNode = textBox.GetEquationParagraph().GetChild(0);

// Вставляет дробное уравнение.
