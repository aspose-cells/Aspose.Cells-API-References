---
title: Aspose::Cells::Charts::Chart class
linktitle: Chart
second_title: Aspose.Cells for C++ API Reference
description: 'Aspose::Cells::Charts::Chart class. Encapsulates the object that represents a single Excel chart in C++.'
type: docs
weight: 300
url: /ru/cpp/aspose.cells.charts/chart/
---
## Chart class
...
//Следующий код показывает, как создать диаграмму с помощью кода на c++.
