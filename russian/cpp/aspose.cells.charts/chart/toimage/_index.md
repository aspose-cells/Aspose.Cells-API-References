---
title: Aspose::Cells::Charts::Chart::ToImage method
linktitle: ToImage
second_title: Aspose.Cells for C++ API Reference
description: 'Aspose::Cells::Charts::Chart::ToImage method. Creates the chart image and saves it to a file. The extension of the file name determines the format of the image in C++.'
type: docs
weight: 8300
url: /ru/cpp/aspose.cells.charts/chart/toimage/
---
...
//Сохраняет в формат Tiff с разрешением 300 dpi и сжатие CCITT4.
...
//Сохраняет в формат Jpeg с разрешением 300 dpi и качеством изображения 80.
...
```cpp
Aspose::Cells::Startup();
//Получает объект bitmap с разрешением 200 dpi по оси X и 300 dpi по оси Y.
