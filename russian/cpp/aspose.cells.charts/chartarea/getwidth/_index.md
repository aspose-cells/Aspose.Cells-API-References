---
title: Aspose::Cells::Charts::ChartArea::GetWidth method
linktitle: GetWidth
second_title: Aspose.Cells for C++ API Reference
description: 'Aspose::Cells::Charts::ChartArea::GetWidth method. Gets or sets the horizontal offset from its lower right corner column, in units of 1/4000 of the chart area in C++.'
type: docs
weight: 1200
url: /ru/cpp/aspose.cells.charts/chartarea/getwidth/
---
## ChartArea::GetWidth method
...
```cpp
int32_t Aspose::Cells::Charts::ChartArea::GetWidth()
```
